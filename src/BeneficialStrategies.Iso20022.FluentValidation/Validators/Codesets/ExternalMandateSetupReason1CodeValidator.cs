...
/// <summary>
/// Validates <see cref="ExternalMandateSetupReason1Code"/> against the currently-acceptable
/// values of this external code set.
/// </summary>
/// <remarks>
/// <see cref="ExternalMandateSetupReason1Code"/>'s own constructor enforces only the structural
/// pattern (1-4 characters) — it does not know which codes are actually registered under the
/// external mandate setup reason code list. This validator adds that check via an injected
...
/// for the default registry's permissive-until-populated behavior (as of 2026-08-20, this type
/// declares no known-value members, so the default registry is permissive for this type until a
/// caller populates it).
/// </remarks>
