...
/// <summary>
/// Validates <see cref="AcceptorConfiguration6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration6Validator : AbstractValidator<AcceptorConfiguration6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration6"/>.
    /// </summary>
    public AcceptorConfiguration6Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration6.DataSet must contain at least one element (1..∞).");
    }
}
