...
/// <summary>
/// Validates <see cref="TransportByAir5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TransportByAir5Validator : AbstractValidator<TransportByAir5>
{
    public TransportByAir5Validator()
    {
        RuleFor(x => x.DestinationAirport)
            .NotEmpty()
            .WithMessage("TransportByAir5.DestinationAirport must contain at least one element (1..∞).");
    }
}
