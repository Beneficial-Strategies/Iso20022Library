...
/// <summary>
/// Validates <see cref="AccountNotification23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _93YgYTEsEe6GxLzpkVnWYg
...
/// </list>
/// </remarks>
public class AccountNotification23Validator : AbstractValidator<AccountNotification23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountNotification23"/>.
    /// </summary>
    public AccountNotification23Validator()
    {
        ...
        // Item: NotificationItem9, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification23.Item must contain at least one element (1..∞).");
        ...
        // BranchAndFinancialInstitutionIdentification8 (0..1) — no validator exists yet for
        // BranchAndFinancialInstitutionIdentification8; nested fields unvalidated.
        ...
        // AccountOwner, Debtor: Party50Choice_ (0..1). Both variants reviewed:
        ...
        //     validators yet.
        //   - Agent: Value (BranchAndFinancialInstitutionIdentification8) is already `required`
        //     in C# (matches the spec's Min=1,Max=1); no validator exists yet for
