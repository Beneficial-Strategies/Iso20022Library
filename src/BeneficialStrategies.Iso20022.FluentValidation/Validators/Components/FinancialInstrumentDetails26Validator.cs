...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails26"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails26Validator : AbstractValidator<FinancialInstrumentDetails26>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails26"/>.
    /// </summary>
    public FinancialInstrumentDetails26Validator()
    {
        RuleFor(x => x.SubBalance)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails26.SubBalance must contain at least one element (1..∞).");
    }
}
