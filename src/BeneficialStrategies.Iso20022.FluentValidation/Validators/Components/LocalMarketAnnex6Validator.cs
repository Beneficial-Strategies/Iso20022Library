...
/// <summary>
/// Validates <see cref="LocalMarketAnnex6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LocalMarketAnnex6Validator : AbstractValidator<LocalMarketAnnex6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LocalMarketAnnex6"/>.
    /// </summary>
    public LocalMarketAnnex6Validator()
    {
        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex6.Country must contain at least one element (1..∞).");
    }
}
