...
public class RedemptionBulkOrder4Validator : AbstractValidator<RedemptionBulkOrder4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionBulkOrder4"/>.
    /// </summary>
