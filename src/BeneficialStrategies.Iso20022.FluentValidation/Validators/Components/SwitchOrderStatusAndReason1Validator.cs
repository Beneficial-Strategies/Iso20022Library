...
/// <summary>
/// Validates <see cref="SwitchOrderStatusAndReason1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SwitchOrderStatusAndReason1Validator : AbstractValidator<SwitchOrderStatusAndReason1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SwitchOrderStatusAndReason1"/>.
    /// </summary>
    public SwitchOrderStatusAndReason1Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("SwitchOrderStatusAndReason1.Rejected must contain at least one element (1..10).");
    }
}
