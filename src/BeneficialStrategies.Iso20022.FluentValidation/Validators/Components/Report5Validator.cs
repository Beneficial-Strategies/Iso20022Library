...
/// <summary>
/// Validates <see cref="Report5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>SettlementObligationDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class Report5Validator : AbstractValidator<Report5>
{
    public Report5Validator()
    {
        RuleFor(x => x.SettlementObligationDetails)
            .NotEmpty()
            .WithMessage("Report5.SettlementObligationDetails must contain at least one element (1..∞).");
    }
}
