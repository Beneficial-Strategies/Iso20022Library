...
/// <summary>
/// Validates <see cref="RedemptionBulkOrder08"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class RedemptionBulkOrder08Validator : AbstractValidator<RedemptionBulkOrder08>
{
    public RedemptionBulkOrder08Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkOrder08.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
