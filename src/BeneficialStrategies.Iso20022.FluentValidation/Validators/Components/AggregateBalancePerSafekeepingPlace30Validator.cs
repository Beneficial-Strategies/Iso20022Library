...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace30"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalancePerSafekeepingPlace30Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace30>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace30"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace30Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace30.PriceDetails must contain at least one element (1..∞).");
    }
}
