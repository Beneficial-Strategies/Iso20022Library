...
/// <summary>
/// Validates <see cref="CardPaymentDataSet37"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet37Validator : AbstractValidator<CardPaymentDataSet37>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet37"/>.
    /// </summary>
    public CardPaymentDataSet37Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet37.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet37.TransactionTotals must contain at least one element (1..∞).");
    }
}
