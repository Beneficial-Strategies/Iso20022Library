...
/// <summary>
/// Validates <see cref="TradeData23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TradeData23Validator : AbstractValidator<TradeData23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeData23"/>.
    /// </summary>
    public TradeData23Validator()
    {
        RuleFor(x => x.CounterpartySpecificData)
            .NotEmpty()
            .WithMessage("TradeData23.CounterpartySpecificData must contain at least one element (1..2).");
    }
}
