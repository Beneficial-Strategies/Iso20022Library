...
/// <summary>
/// Validates <see cref="AuthenticatedData3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData3Validator : AbstractValidator<AuthenticatedData3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData3"/>.
    /// </summary>
    public AuthenticatedData3Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData3.Recipient must contain at least one element (1..∞).");
    }
}
