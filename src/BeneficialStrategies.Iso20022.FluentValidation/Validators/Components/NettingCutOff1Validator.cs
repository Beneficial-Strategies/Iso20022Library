...
/// <summary>
/// Validates <see cref="NettingCutOff1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NettingCutOff1"/>.
    /// </summary>
    public NettingCutOff1Validator()
    {
        RuleFor(x => x.NewCutOff)
            .NotEmpty()
            .WithMessage("NettingCutOff1.NewCutOff must contain at least one element (1..∞).");
    }
}
