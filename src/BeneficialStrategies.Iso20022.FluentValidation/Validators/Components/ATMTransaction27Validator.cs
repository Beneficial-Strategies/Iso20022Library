...
/// <summary>
/// Validates <see cref="ATMTransaction27"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Exception</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class ATMTransaction27Validator : AbstractValidator<ATMTransaction27>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMTransaction27"/>.
    /// </summary>
    public ATMTransaction27Validator()
    {
        RuleFor(x => x.Exception)
            .NotEmpty()
            .WithMessage("ATMTransaction27.Exception must contain at least one element (1..∞).");
    }
}
