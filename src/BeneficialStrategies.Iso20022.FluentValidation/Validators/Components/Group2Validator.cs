...
/// <summary>
/// Validates <see cref="Group2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Group2Validator : AbstractValidator<Group2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Group2"/>.
    /// </summary>
    public Group2Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group2.Party must contain at least one element (1..∞).");
    }
}
