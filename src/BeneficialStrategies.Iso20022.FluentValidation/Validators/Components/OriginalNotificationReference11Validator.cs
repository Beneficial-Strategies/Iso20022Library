...
/// <summary>
/// Validates <see cref="OriginalNotificationReference11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _b6SxjdcZEeqRFcf2R4bPBw
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItemAndStatus7"/>
/// (the type of <see cref="OriginalNotificationReference11.OriginalItemAndStatus"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public class OriginalNotificationReference11Validator : AbstractValidator<OriginalNotificationReference11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference11"/>.
    /// </summary>
    public OriginalNotificationReference11Validator()
    {
        ...
        // OriginalItemAndStatus: OriginalItemAndStatus7, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItemAndStatus)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference11.OriginalItemAndStatus must contain at least one element (1..∞).");
