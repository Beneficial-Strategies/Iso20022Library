...
/// <summary>
/// Validates <see cref="EnvelopedData5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData5Validator : AbstractValidator<EnvelopedData5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData5"/>.
    /// </summary>
    public EnvelopedData5Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData5.Recipient must contain at least one element (1..∞).");
    }
}
