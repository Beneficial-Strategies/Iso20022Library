...
/// <summary>
/// Validates <see cref="PaymentInstructionInformation1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstructionInformation1Validator : AbstractValidator<PaymentInstructionInformation1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstructionInformation1"/>.
    /// </summary>
    public PaymentInstructionInformation1Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstructionInformation1.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
