...
/// <summary>
/// Validates <see cref="MandateSuspensionReason3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _4TGJuzEyEe6g-ffJsqGiSA
/// Spec source: queried via ISO 20022 MCP server (2026-08-20).
///
/// Specifies the reason for the mandate suspension request.
/// <list type="table">
///   <item><term>Originator</term><description>PartyIdentification272 — optional (0..1)</description></item>
///   <item><term>Reason</term><description>MandateSuspensionReason1Choice_ — required (1..1)</description></item>
...
/// below.
/// </remarks>
public class MandateSuspensionReason3Validator : AbstractValidator<MandateSuspensionReason3>
{
    /// <summary>
    ...
    /// Validator for the required <c>Reason</c> building block
    /// (MandateSuspensionReason1Choice_, 1..1).
    /// </param>
    public MandateSuspensionReason3Validator(
        IValidator<PartyIdentification272> originatorValidator,
        IValidator<MandateSuspensionReason1Choice_> reasonValidator
    )
    {
    ...
    /// <see cref="MandateSuspensionReason1Choice_Validator"/>). Convenience constructor for
    /// callers not using a DI container.
    /// </summary>
    public MandateSuspensionReason3Validator()
        : this(new PartyIdentification272Validator(), new MandateSuspensionReason1Choice_Validator()) { }
}
