...
/// <summary>
/// Validates <see cref="ModificationScope45"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ModificationScope45Validator : AbstractValidator<ModificationScope45>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ModificationScope45"/>.
    /// </summary>
    public ModificationScope45Validator()
    {
        RuleFor(x => x.AdditionalInformation)
            .NotEmpty()
            .WithMessage("ModificationScope45.AdditionalInformation must contain at least one element (1..∞).");
    }
}
