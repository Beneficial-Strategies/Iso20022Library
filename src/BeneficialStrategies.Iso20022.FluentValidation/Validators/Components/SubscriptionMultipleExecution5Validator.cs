...
/// <summary>
/// Validates <see cref="SubscriptionMultipleExecution5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SubscriptionMultipleExecution5Validator : AbstractValidator<SubscriptionMultipleExecution5>
{
    public SubscriptionMultipleExecution5Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleExecution5.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
