...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalanceInformation17Validator : AbstractValidator<AggregateBalanceInformation17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalanceInformation17"/>.
    /// </summary>
    public AggregateBalanceInformation17Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation17.PriceDetails must contain at least one element (1..∞).");
    }
}
