...
/// <summary>
/// Validates <see cref="SwitchOrderConfirmation1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SwitchOrderConfirmation1"/>.
    /// </summary>
    public SwitchOrderConfirmation1Validator()
    {
        RuleFor(x => x.SwitchExecutionDetails)
            .NotEmpty()
            .WithMessage("SwitchOrderConfirmation1.SwitchExecutionDetails must contain at least one element (1..∞).");
    }
}
