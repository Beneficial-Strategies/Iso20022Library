...
/// <summary>
/// Validates <see cref="AvailableFinancialResourcesAmount2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AvailableFinancialResourcesAmount2Validator : AbstractValidator<AvailableFinancialResourcesAmount2>
{
    public AvailableFinancialResourcesAmount2Validator()
    {
        RuleFor(x => x.CCPSkinInTheGame)
            .NotEmpty()
            .WithMessage("AvailableFinancialResourcesAmount2.CCPSkinInTheGame must contain at least one element (1..∞).");
    }
}
