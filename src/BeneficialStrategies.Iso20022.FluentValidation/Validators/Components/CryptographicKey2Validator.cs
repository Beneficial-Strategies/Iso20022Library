...
/// <summary>
/// Validates <see cref="CryptographicKey2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey2Validator : AbstractValidator<CryptographicKey2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey2"/>.
    /// </summary>
    public CryptographicKey2Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey2.Function must contain at least one element (1..∞).");
    }
}
