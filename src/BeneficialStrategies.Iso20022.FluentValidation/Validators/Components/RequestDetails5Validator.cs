...
/// <summary>
/// Validates <see cref="RequestDetails5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequestDetails5"/>.
    /// </summary>
    public RequestDetails5Validator()
    {
        RuleFor(x => x.ReportKey)
            .NotEmpty()
            .WithMessage("RequestDetails5.ReportKey must contain at least one element (1..∞).");
    }
}
