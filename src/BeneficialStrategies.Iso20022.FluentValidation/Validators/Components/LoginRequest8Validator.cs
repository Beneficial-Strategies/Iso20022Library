...
/// <summary>
/// Validates <see cref="LoginRequest8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest8Validator : AbstractValidator<LoginRequest8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest8"/>.
    /// </summary>
    public LoginRequest8Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest8.SaleSoftware must contain at least one element (1..∞).");
    }
}
