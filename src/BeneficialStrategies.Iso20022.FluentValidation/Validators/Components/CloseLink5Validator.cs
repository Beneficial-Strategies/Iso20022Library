...
/// <summary>
/// Validates <see cref="CloseLink5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CloseLink5Validator : AbstractValidator<CloseLink5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CloseLink5"/>.
    /// </summary>
    public CloseLink5Validator()
    {
        RuleFor(x => x.SecurityIdentification)
            .NotEmpty()
            .WithMessage("CloseLink5.SecurityIdentification must contain at least one element (1..∞).");
    }
}
