...
/// <summary>
/// Validates <see cref="Meeting5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Meeting5Validator : AbstractValidator<Meeting5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Meeting5"/>.
    /// </summary>
    public Meeting5Validator()
    {
        RuleFor(x => x.Location)
            .NotEmpty()
            .WithMessage("Meeting5.Location must contain at least one element (1..5).");
    }
}
