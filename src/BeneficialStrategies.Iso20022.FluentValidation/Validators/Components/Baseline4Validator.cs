...
/// <summary>
/// Validates <see cref="Baseline4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Baseline4Validator : AbstractValidator<Baseline4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Baseline4"/>.
    /// </summary>
    public Baseline4Validator()
    {
        RuleFor(x => x.PaymentTerms)
            .NotEmpty()
            .WithMessage("Baseline4.PaymentTerms must contain at least one element (1..∞).");
    }
}
