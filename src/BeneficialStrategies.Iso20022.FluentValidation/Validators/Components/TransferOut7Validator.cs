...
/// <summary>
/// Validates <see cref="TransferOut7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut7"/>.
    /// </summary>
    public TransferOut7Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut7.TransferDetails must contain at least one element (1..∞).");
    }
}
