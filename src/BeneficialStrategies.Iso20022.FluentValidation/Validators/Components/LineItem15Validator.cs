...
/// <summary>
/// Validates <see cref="LineItem15"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CommercialLineItems</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class LineItem15Validator : AbstractValidator<LineItem15>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem15"/>.
    /// </summary>
    public LineItem15Validator()
    {
        RuleFor(x => x.CommercialLineItems)
            .NotEmpty()
            .WithMessage("LineItem15.CommercialLineItems must contain at least one element (1..∞).");
    }
}
