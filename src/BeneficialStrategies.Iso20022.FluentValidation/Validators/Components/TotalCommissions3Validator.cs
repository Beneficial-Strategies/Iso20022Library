...
/// <summary>
/// Validates <see cref="TotalCommissions3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TotalCommissions3Validator : AbstractValidator<TotalCommissions3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TotalCommissions3"/>.
    /// </summary>
    public TotalCommissions3Validator()
    {
        RuleFor(x => x.CommissionDetails)
            .NotEmpty()
            .WithMessage("TotalCommissions3.CommissionDetails must contain at least one element (1..∞).");
    }
}
