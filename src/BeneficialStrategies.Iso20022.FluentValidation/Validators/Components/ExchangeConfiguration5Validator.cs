...
/// <summary>
/// Validates <see cref="ExchangeConfiguration5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ExchangeConfiguration5Validator : AbstractValidator<ExchangeConfiguration5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ExchangeConfiguration5"/>.
    /// </summary>
    public ExchangeConfiguration5Validator()
    {
        RuleFor(x => x.ExchangePolicy)
            .NotEmpty()
            .WithMessage("ExchangeConfiguration5.ExchangePolicy must contain at least one element (1..∞).");
    }
}
