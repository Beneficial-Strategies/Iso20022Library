...
/// <summary>
/// Validates <see cref="LoginResponse2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>POISoftware</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class LoginResponse2Validator : AbstractValidator<LoginResponse2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginResponse2"/>.
    /// </summary>
    public LoginResponse2Validator()
    {
        RuleFor(x => x.POISoftware)
            .NotEmpty()
            .WithMessage("LoginResponse2.POISoftware must contain at least one element (1..∞).");
    }
}
