...
/// <summary>
/// Validates <see cref="ScenarioStressTestResult1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ScenarioStressTestResult1"/>.
    /// </summary>
    public ScenarioStressTestResult1Validator()
    {
        RuleFor(x => x.PortfolioStressTestResult)
            .NotEmpty()
            .WithMessage("ScenarioStressTestResult1.PortfolioStressTestResult must contain at least one element (1..∞).");
    }
}
