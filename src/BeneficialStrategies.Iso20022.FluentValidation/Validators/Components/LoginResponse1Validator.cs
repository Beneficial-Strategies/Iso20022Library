...
/// <summary>
/// Validates <see cref="LoginResponse1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class LoginResponse1Validator : AbstractValidator<LoginResponse1>
{
    public LoginResponse1Validator()
    {
        RuleFor(x => x.POISoftware)
            .NotEmpty()
            .WithMessage("LoginResponse1.POISoftware must contain at least one element (1..∞).");
    }
}
