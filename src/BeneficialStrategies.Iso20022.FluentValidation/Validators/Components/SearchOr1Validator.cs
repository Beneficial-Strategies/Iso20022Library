...
/// <summary>
/// Validates <see cref="SearchOr1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>SearchAnd</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class SearchOr1Validator : AbstractValidator<SearchOr1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SearchOr1"/>.
    /// </summary>
    public SearchOr1Validator()
    {
        RuleFor(x => x.SearchAnd)
            .NotEmpty()
            .WithMessage("SearchOr1.SearchAnd must contain at least one element (1..∞).");
    }
}
