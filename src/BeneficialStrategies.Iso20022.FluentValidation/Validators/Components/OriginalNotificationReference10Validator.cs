...
/// <summary>
/// Validates <see cref="OriginalNotificationReference10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _U-6n3W49EeiU9cctagi5ow
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItem6"/>
/// (the type of <see cref="OriginalNotificationReference10.OriginalItem"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public class OriginalNotificationReference10Validator : AbstractValidator<OriginalNotificationReference10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference10"/>.
    /// </summary>
    public OriginalNotificationReference10Validator()
    {
        ...
        // OriginalItem: OriginalItem6, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItem)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference10.OriginalItem must contain at least one element (1..∞).");
