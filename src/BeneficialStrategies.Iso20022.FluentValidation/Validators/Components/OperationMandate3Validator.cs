...
/// <summary>
/// Validates <see cref="OperationMandate3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class OperationMandate3Validator : AbstractValidator<OperationMandate3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OperationMandate3"/>.
    /// </summary>
    public OperationMandate3Validator()
    {
        RuleFor(x => x.ApplicableChannel)
            .NotEmpty()
            .WithMessage("OperationMandate3.ApplicableChannel must contain at least one element (1..∞).");

        RuleFor(x => x.BankOperation)
            .NotEmpty()
            .WithMessage("OperationMandate3.BankOperation must contain at least one element (1..∞).");
    }
}
