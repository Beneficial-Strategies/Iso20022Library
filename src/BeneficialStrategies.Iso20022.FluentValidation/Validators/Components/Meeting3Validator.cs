...
/// <summary>
/// Validates <see cref="Meeting3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class Meeting3Validator : AbstractValidator<Meeting3>
{
    public Meeting3Validator()
    {
        RuleFor(x => x.Location)
            .NotEmpty()
            .WithMessage("Meeting3.Location must contain at least one element (1..5).");
    }
}
