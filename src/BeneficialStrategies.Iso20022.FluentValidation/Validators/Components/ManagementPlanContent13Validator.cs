...
/// <summary>
/// Validates <see cref="ManagementPlanContent13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent13Validator : AbstractValidator<ManagementPlanContent13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent13"/>.
    /// </summary>
    public ManagementPlanContent13Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent13.Action must contain at least one element (1..∞).");
    }
}
