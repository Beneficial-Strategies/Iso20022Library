...
/// <summary>
/// Validates <see cref="DisplayCapabilities7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class DisplayCapabilities7Validator : AbstractValidator<DisplayCapabilities7>
{
    public DisplayCapabilities7Validator()
    {
        RuleFor(x => x.Destination)
            .NotEmpty()
            .WithMessage("DisplayCapabilities7.Destination must contain at least one element (1..∞).");
    }
}
