...
/// <summary>
/// Validates <see cref="CryptographicKey11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey11Validator : AbstractValidator<CryptographicKey11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey11"/>.
    /// </summary>
    public CryptographicKey11Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey11.Function must contain at least one element (1..∞).");
    }
}
