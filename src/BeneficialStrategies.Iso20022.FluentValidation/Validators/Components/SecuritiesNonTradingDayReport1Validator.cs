...
/// <summary>
/// Validates <see cref="SecuritiesNonTradingDayReport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>NonWorkingDay</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class SecuritiesNonTradingDayReport1Validator : AbstractValidator<SecuritiesNonTradingDayReport1>
{
    public SecuritiesNonTradingDayReport1Validator()
    {
        RuleFor(x => x.NonWorkingDay)
            .NotEmpty()
            .WithMessage("SecuritiesNonTradingDayReport1.NonWorkingDay must contain at least one element (1..∞).");
    }
}
