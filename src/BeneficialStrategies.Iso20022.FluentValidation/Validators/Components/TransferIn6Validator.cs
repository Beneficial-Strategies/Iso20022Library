...
/// <summary>
/// Validates <see cref="TransferIn6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn6Validator : AbstractValidator<TransferIn6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn6"/>.
    /// </summary>
    public TransferIn6Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn6.TransferDetails must contain at least one element (1..∞).");
    }
}
