...
/// <summary>
/// Validates <see cref="AcquirerHostConfiguration1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>MessageToSend</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class AcquirerHostConfiguration1Validator : AbstractValidator<AcquirerHostConfiguration1>
{
    public AcquirerHostConfiguration1Validator()
    {
        RuleFor(x => x.MessageToSend)
            .NotEmpty()
            .WithMessage("AcquirerHostConfiguration1.MessageToSend must contain at least one element (1..∞).");
    }
}
