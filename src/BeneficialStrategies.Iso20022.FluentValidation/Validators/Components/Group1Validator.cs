...
/// <summary>
/// Validates <see cref="Group1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Group1Validator : AbstractValidator<Group1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Group1"/>.
    /// </summary>
    public Group1Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group1.Party must contain at least one element (1..∞).");
    }
}
