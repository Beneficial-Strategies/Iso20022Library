...
/// <summary>
/// Validates <see cref="Organisation38"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class Organisation38Validator : AbstractValidator<Organisation38>
{
    public Organisation38Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("Organisation38.PostalAddress must contain at least one element (1..5).");
    }
}
