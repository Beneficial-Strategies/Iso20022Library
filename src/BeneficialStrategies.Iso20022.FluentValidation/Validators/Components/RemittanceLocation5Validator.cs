...
/// <summary>
/// Validates <see cref="RemittanceLocation5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class RemittanceLocation5Validator : AbstractValidator<RemittanceLocation5>
{
    public RemittanceLocation5Validator()
    {
        RuleFor(x => x.RemittanceLocationDetails)
            .NotEmpty()
            .WithMessage("RemittanceLocation5.RemittanceLocationDetails must contain at least one element (1..∞).");
    }
}
