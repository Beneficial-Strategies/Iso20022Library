...
/// <summary>
/// Validates <see cref="RequiredSubmission2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RequiredSubmission2Validator : AbstractValidator<RequiredSubmission2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequiredSubmission2"/>.
    /// </summary>
    public RequiredSubmission2Validator()
    {
        RuleFor(x => x.Submitter)
            .NotEmpty()
            .WithMessage("RequiredSubmission2.Submitter must contain at least one element (1..∞).");
    }
}
