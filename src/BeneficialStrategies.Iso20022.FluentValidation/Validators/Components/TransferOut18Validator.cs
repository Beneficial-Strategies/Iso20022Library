...
/// <summary>
/// Validates <see cref="TransferOut18"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferOut18Validator : AbstractValidator<TransferOut18>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut18"/>.
    /// </summary>
    public TransferOut18Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut18.TransferDetails must contain at least one element (1..∞).");
    }
}
