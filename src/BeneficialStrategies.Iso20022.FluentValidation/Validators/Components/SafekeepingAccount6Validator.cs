...
/// <summary>
/// Validates <see cref="SafekeepingAccount6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SafekeepingAccount6Validator : AbstractValidator<SafekeepingAccount6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SafekeepingAccount6"/>.
    /// </summary>
    public SafekeepingAccount6Validator()
    {
        RuleFor(x => x.InstructedBalance)
            .NotEmpty()
            .WithMessage("SafekeepingAccount6.InstructedBalance must contain at least one element (1..10).");
    }
}
