...
/// <summary>
/// Validates <see cref="CustomerAccountModification1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CustomerAccountModification1Validator : AbstractValidator<CustomerAccountModification1>
{
    public CustomerAccountModification1Validator()
    {
        RuleFor(x => x.Identification)
            .NotEmpty()
            .WithMessage("CustomerAccountModification1.Identification must contain at least one element (1..∞).");
    }
}
