...
/// <summary>
/// Validates <see cref="CryptographicKey20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey20Validator : AbstractValidator<CryptographicKey20>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey20"/>.
    /// </summary>
    public CryptographicKey20Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey20.Function must contain at least one element (1..∞).");
    }
}
