...
/// <summary>
/// Validates <see cref="ChargesPerType3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _4Hrj9zEyEe6g-ffJsqGiSA
...
/// </list>
/// </remarks>
public sealed class ChargesPerType3Validator : AbstractValidator<ChargesPerType3>
{
    public ChargesPerType3Validator()
    {
        ...
        // Record: ChargesPerTypeRecord3, 1..∞ — NEEDS NotEmpty RULE.
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("ChargesPerType3.Record must contain at least one element (1..*).");
    }
}
