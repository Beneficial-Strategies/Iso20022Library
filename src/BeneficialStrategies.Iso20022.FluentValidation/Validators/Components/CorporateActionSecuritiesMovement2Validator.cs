...
/// <summary>
/// Validates <see cref="CorporateActionSecuritiesMovement2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CorporateActionSecuritiesMovement2"/>.
    /// </summary>
    public CorporateActionSecuritiesMovement2Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("CorporateActionSecuritiesMovement2.AccountDetails must contain at least one element (1..2).");
    }
}
