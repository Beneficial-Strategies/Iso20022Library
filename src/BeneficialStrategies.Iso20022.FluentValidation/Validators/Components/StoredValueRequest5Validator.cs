...
/// <summary>
/// Validates <see cref="StoredValueRequest5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest5Validator : AbstractValidator<StoredValueRequest5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest5"/>.
    /// </summary>
    public StoredValueRequest5Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest5.Data must contain at least one element (1..∞).");
    }
}
