...
/// <summary>
/// Validates <see cref="IndividualOrderStatusAndReason2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Rejected</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..10</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class IndividualOrderStatusAndReason2Validator : AbstractValidator<IndividualOrderStatusAndReason2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IndividualOrderStatusAndReason2"/>.
    /// </summary>
    public IndividualOrderStatusAndReason2Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("IndividualOrderStatusAndReason2.Rejected must contain at least one element (1..10).");
    }
}
