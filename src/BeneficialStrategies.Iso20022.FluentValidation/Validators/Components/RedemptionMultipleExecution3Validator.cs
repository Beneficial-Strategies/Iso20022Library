...
/// <summary>
/// Validates <see cref="RedemptionMultipleExecution3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionMultipleExecution3Validator : AbstractValidator<RedemptionMultipleExecution3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionMultipleExecution3"/>.
    /// </summary>
    public RedemptionMultipleExecution3Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("RedemptionMultipleExecution3.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
