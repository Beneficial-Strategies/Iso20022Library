...
/// <summary>
/// Validates <see cref="DocumentNumber5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class DocumentNumber5Validator : AbstractValidator<DocumentNumber5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DocumentNumber5"/>.
    /// </summary>
    public DocumentNumber5Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber5.References must contain at least one element (1..∞).");
    }
}
