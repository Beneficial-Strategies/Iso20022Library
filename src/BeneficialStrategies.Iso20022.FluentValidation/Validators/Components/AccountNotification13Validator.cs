...
/// <summary>
/// Validates <see cref="AccountNotification13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _1Wl1lzq4EeWZFYSPlduMhw
...
/// </list>
/// </remarks>
public sealed class AccountNotification13Validator : AbstractValidator<AccountNotification13>
{
    public AccountNotification13Validator()
    {
        ...
        // Item: NotificationItem6, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification13.Item must contain at least one element (1..∞).");
