...
/// <summary>
/// Validates <see cref="TransferOut10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferOut10Validator : AbstractValidator<TransferOut10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut10"/>.
    /// </summary>
    public TransferOut10Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut10.TransferDetails must contain at least one element (1..∞).");
    }
}
