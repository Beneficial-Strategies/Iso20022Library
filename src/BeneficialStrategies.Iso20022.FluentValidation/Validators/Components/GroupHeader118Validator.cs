...
/// <summary>
/// Validates <see cref="GroupHeader118"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _2s4Z0TEyEe6g-ffJsqGiSA
...
///
/// Dependency injection: <c>Authorisation</c>, <c>ForwardingAgent</c>, and <c>InitiatingParty</c>
/// are each validated by an injected <see cref="IValidator{T}"/> rather than a hardcoded
/// <c>new</c> — see the two constructors below.
/// </remarks>
public class GroupHeader118Validator : AbstractValidator<GroupHeader118>
{
    /// <summary>
    /// Initializes a new instance using dependency injection: the caller supplies the validators
    /// — e.g. resolved from a DI container — instead of this type constructing its own.
    /// </summary>
    public GroupHeader118Validator(
