...
/// <summary>
/// Validates <see cref="ClassificationType4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public sealed class ClassificationType4Validator : AbstractValidator<ClassificationType4>
{
    public ClassificationType4Validator()
    {
        RuleFor(x => x.LegalFramework)
            .NotEmpty()
            .WithMessage("ClassificationType4.LegalFramework must contain at least one element (1..∞).");
    }
}
