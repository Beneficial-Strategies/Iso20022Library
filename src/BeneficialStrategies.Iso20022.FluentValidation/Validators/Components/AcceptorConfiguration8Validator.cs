...
/// <summary>
/// Validates <see cref="AcceptorConfiguration8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration8Validator : AbstractValidator<AcceptorConfiguration8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration8"/>.
    /// </summary>
    public AcceptorConfiguration8Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration8.DataSet must contain at least one element (1..∞).");
    }
}
