...
/// <summary>
/// Validates <see cref="Report7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class Report7Validator : AbstractValidator<Report7>
{
    public Report7Validator()
    {
        RuleFor(x => x.SettlementObligationDetails)
            .NotEmpty()
            .WithMessage("Report7.SettlementObligationDetails must contain at least one element (1..∞).");
    }
}
