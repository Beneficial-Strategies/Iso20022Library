...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AggregateBalanceInformation13Validator : AbstractValidator<AggregateBalanceInformation13>
{
    public AggregateBalanceInformation13Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation13.PriceDetails must contain at least one element (1..∞).");
    }
}
