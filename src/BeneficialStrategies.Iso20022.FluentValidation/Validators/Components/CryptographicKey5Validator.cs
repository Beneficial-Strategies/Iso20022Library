...
/// <summary>
/// Validates <see cref="CryptographicKey5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey5Validator : AbstractValidator<CryptographicKey5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey5"/>.
    /// </summary>
    public CryptographicKey5Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey5.Function must contain at least one element (1..∞).");
    }
}
