...
/// <summary>
/// Validates <see cref="SubscriptionBulkOrder4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkOrder4"/>.
    /// </summary>
    public SubscriptionBulkOrder4Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkOrder4.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
