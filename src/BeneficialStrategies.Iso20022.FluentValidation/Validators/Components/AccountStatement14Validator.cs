...
/// <summary>
/// Validates <see cref="AccountStatement14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _ELecaT3dEe-thIfLZ94a1w
...
/// </remarks>
public class AccountStatement14Validator : AbstractValidator<AccountStatement14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountStatement14"/>.
    /// </summary>
    public AccountStatement14Validator()
    {
        ...
        // fields unvalidated.
        // Interest (AccountInterest4) and Entry (ReportEntry15): 0..∞ collections — any
        ...
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountStatement14.Balance must contain at least one element (1..*).");
    }
}
