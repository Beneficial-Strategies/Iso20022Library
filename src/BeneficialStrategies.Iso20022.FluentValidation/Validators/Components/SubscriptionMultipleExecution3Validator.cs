...
/// <summary>
/// Validates <see cref="SubscriptionMultipleExecution3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionMultipleExecution3Validator : AbstractValidator<SubscriptionMultipleExecution3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionMultipleExecution3"/>.
    /// </summary>
    public SubscriptionMultipleExecution3Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleExecution3.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
