...
/// <summary>
/// Validates <see cref="CommercialDataSet5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Goods</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
public class CommercialDataSet5Validator : AbstractValidator<CommercialDataSet5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CommercialDataSet5"/>.
    /// </summary>
    public CommercialDataSet5Validator()
    {
        RuleFor(x => x.Goods)
            .NotEmpty()
            .WithMessage("CommercialDataSet5.Goods must contain at least one element (1..∞).");

        RuleFor(x => x.PaymentTerms)
            .NotEmpty()
            .WithMessage("CommercialDataSet5.PaymentTerms must contain at least one element (1..∞).");
    }
}
