...
/// <summary>
/// Validates <see cref="DigestedData3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class DigestedData3Validator : AbstractValidator<DigestedData3>
{
    public DigestedData3Validator()
    {
        RuleFor(x => x.DigestAlgorithm)
            .NotEmpty()
            .WithMessage("DigestedData3.DigestAlgorithm must contain at least one element (1..∞).");
    }
}
