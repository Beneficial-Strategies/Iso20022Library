...
/// <summary>
/// Validates <see cref="CardPaymentDataSet1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet1Validator : AbstractValidator<CardPaymentDataSet1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet1"/>.
    /// </summary>
    public CardPaymentDataSet1Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet1.TransactionTotals must contain at least one element (1..∞).");
    }
}
