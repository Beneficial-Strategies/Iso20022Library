...
/// <summary>
/// Validates <see cref="PaymentInstrument9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstrument9Validator : AbstractValidator<PaymentInstrument9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstrument9"/>.
    /// </summary>
    public PaymentInstrument9Validator()
    {
        RuleFor(x => x.CashAccountDetails)
            .NotEmpty()
            .WithMessage("PaymentInstrument9.CashAccountDetails must contain at least one element (1..3).");
    }
}
