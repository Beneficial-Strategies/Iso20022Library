...
/// <summary>
/// Validates <see cref="AcceptorConfiguration13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AcceptorConfiguration13Validator : AbstractValidator<AcceptorConfiguration13>
{
    public AcceptorConfiguration13Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration13.DataSet must contain at least one element (1..∞).");
    }
}
