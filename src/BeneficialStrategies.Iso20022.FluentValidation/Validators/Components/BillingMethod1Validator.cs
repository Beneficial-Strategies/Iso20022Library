...
/// <summary>
/// Validates <see cref="BillingMethod1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class BillingMethod1Validator : AbstractValidator<BillingMethod1>
{
    public BillingMethod1Validator()
    {
        RuleFor(x => x.TaxIdentification)
            .NotEmpty()
            .WithMessage("BillingMethod1.TaxIdentification must contain at least one element (1..3).");
    }
}
