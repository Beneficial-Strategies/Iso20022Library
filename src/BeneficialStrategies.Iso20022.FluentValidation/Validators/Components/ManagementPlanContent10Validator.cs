...
/// <summary>
/// Validates <see cref="ManagementPlanContent10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent10Validator : AbstractValidator<ManagementPlanContent10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent10"/>.
    /// </summary>
    public ManagementPlanContent10Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent10.Action must contain at least one element (1..∞).");
    }
}
