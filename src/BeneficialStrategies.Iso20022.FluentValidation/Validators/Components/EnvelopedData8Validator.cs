...
/// <summary>
/// Validates <see cref="EnvelopedData8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData8Validator : AbstractValidator<EnvelopedData8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData8"/>.
    /// </summary>
    public EnvelopedData8Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData8.Recipient must contain at least one element (1..∞).");
    }
}
