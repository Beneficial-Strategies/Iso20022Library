...
/// <summary>
/// Validates <see cref="SafekeepingAccount4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SafekeepingAccount4Validator : AbstractValidator<SafekeepingAccount4>
{
    public SafekeepingAccount4Validator()
    {
        RuleFor(x => x.InstructedBalance)
            .NotEmpty()
            .WithMessage("SafekeepingAccount4.InstructedBalance must contain at least one element (1..10).");
    }
}
