...
/// <summary>
/// Validates <see cref="PaymentInstruction17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CreditTransferTransaction</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2018-09-08.")]
public class PaymentInstruction17Validator : AbstractValidator<PaymentInstruction17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction17"/>.
    /// </summary>
    public PaymentInstruction17Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction17.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
