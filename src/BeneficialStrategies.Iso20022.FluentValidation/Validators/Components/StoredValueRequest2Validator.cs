...
/// <summary>
/// Validates <see cref="StoredValueRequest2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest2Validator : AbstractValidator<StoredValueRequest2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest2"/>.
    /// </summary>
    public StoredValueRequest2Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest2.Data must contain at least one element (1..∞).");
    }
}
