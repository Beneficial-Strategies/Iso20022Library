...
/// <summary>
/// Validates <see cref="SubscriptionBulkExecution05"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SubscriptionBulkExecution05Validator : AbstractValidator<SubscriptionBulkExecution05>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkExecution05"/>.
    /// </summary>
    public SubscriptionBulkExecution05Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkExecution05.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
