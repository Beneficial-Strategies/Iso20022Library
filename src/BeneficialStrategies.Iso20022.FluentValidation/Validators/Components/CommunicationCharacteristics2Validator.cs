...
/// <summary>
/// Validates <see cref="CommunicationCharacteristics2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CommunicationCharacteristics2Validator : AbstractValidator<CommunicationCharacteristics2>
{
    public CommunicationCharacteristics2Validator()
    {
        RuleFor(x => x.RemoteParty)
            .NotEmpty()
            .WithMessage("CommunicationCharacteristics2.RemoteParty must contain at least one element (1..∞).");
    }
}
