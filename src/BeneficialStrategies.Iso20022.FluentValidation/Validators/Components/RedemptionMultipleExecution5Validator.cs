...
/// <summary>
/// Validates <see cref="RedemptionMultipleExecution5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionMultipleExecution5Validator : AbstractValidator<RedemptionMultipleExecution5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionMultipleExecution5"/>.
    /// </summary>
    public RedemptionMultipleExecution5Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("RedemptionMultipleExecution5.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
