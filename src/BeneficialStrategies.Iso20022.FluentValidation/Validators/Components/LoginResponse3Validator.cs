...
/// <summary>
/// Validates <see cref="LoginResponse3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginResponse3Validator : AbstractValidator<LoginResponse3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginResponse3"/>.
    /// </summary>
    public LoginResponse3Validator()
    {
        RuleFor(x => x.POISoftware)
            .NotEmpty()
            .WithMessage("LoginResponse3.POISoftware must contain at least one element (1..∞).");
    }
}
