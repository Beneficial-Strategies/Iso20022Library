...
/// <summary>
/// Validates <see cref="Proxy3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Proxy3"/>.
    /// </summary>
    public Proxy3Validator()
    {
        RuleFor(x => x.ProxyType)
            .NotEmpty()
            .WithMessage("Proxy3.ProxyType must contain at least one element (1..2).");
    }
}
