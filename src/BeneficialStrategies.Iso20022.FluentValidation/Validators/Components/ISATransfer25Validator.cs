...
/// <summary>
/// Validates <see cref="ISATransfer25"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ISATransfer25Validator : AbstractValidator<ISATransfer25>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ISATransfer25"/>.
    /// </summary>
    public ISATransfer25Validator()
    {
        RuleFor(x => x.ProductTransfer)
            .NotEmpty()
            .WithMessage("ISATransfer25.ProductTransfer must contain at least one element (1..∞).");
    }
}
