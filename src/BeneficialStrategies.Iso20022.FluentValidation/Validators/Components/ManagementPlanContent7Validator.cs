...
/// <summary>
/// Validates <see cref="ManagementPlanContent7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent7Validator : AbstractValidator<ManagementPlanContent7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent7"/>.
    /// </summary>
    public ManagementPlanContent7Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent7.Action must contain at least one element (1..∞).");
    }
}
