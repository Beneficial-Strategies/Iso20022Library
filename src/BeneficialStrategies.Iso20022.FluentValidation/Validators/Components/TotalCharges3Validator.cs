...
/// <summary>
/// Validates <see cref="TotalCharges3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TotalCharges3Validator : AbstractValidator<TotalCharges3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TotalCharges3"/>.
    /// </summary>
    public TotalCharges3Validator()
    {
        RuleFor(x => x.ChargeDetails)
            .NotEmpty()
            .WithMessage("TotalCharges3.ChargeDetails must contain at least one element (1..∞).");
    }
}
