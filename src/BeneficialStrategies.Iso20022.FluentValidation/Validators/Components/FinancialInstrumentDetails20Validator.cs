...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails20Validator : AbstractValidator<FinancialInstrumentDetails20>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails20"/>.
    /// </summary>
    public FinancialInstrumentDetails20Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails20.Transaction must contain at least one element (1..∞).");
    }
}
