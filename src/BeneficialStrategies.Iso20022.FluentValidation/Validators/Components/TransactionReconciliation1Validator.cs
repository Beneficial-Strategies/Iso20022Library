...
/// <summary>
/// Validates <see cref="TransactionReconciliation1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransactionReconciliation1Validator : AbstractValidator<TransactionReconciliation1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransactionReconciliation1"/>.
    /// </summary>
    public TransactionReconciliation1Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("TransactionReconciliation1.TransactionTotals must contain at least one element (1..∞).");
    }
}
