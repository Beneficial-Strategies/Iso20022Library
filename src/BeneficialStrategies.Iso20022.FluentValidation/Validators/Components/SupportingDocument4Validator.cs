...
/// <summary>
/// Validates <see cref="SupportingDocument4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SupportingDocument4Validator : AbstractValidator<SupportingDocument4>
{
    public SupportingDocument4Validator()
    {
        RuleFor(x => x.Entry)
            .NotEmpty()
            .WithMessage("SupportingDocument4.Entry must contain at least one element (1..∞).");
    }
}
