...
/// <summary>
/// Validates <see cref="TradeLegStatement4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TradeLegStatement4Validator : AbstractValidator<TradeLegStatement4>
{
    public TradeLegStatement4Validator()
    {
        RuleFor(x => x.TradeLegsDetails)
            .NotEmpty()
            .WithMessage("TradeLegStatement4.TradeLegsDetails must contain at least one element (1..∞).");
    }
}
