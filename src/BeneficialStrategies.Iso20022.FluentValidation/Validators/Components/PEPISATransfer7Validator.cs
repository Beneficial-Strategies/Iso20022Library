...
/// <summary>
/// Validates <see cref="PEPISATransfer7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ProductTransfer</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class PEPISATransfer7Validator : AbstractValidator<PEPISATransfer7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PEPISATransfer7"/>.
    /// </summary>
    public PEPISATransfer7Validator()
    {
        RuleFor(x => x.ProductTransfer)
            .NotEmpty()
            .WithMessage("PEPISATransfer7.ProductTransfer must contain at least one element (1..∞).");
    }
}
