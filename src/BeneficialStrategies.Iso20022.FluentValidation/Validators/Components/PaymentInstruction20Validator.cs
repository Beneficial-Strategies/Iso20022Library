...
/// <summary>
/// Validates <see cref="PaymentInstruction20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction20Validator : AbstractValidator<PaymentInstruction20>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction20"/>.
    /// </summary>
    public PaymentInstruction20Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction20.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
