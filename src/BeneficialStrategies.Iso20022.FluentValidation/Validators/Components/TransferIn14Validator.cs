...
/// <summary>
/// Validates <see cref="TransferIn14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn14Validator : AbstractValidator<TransferIn14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn14"/>.
    /// </summary>
    public TransferIn14Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn14.TransferDetails must contain at least one element (1..∞).");
    }
}
