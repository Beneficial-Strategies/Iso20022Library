...
/// <summary>
/// Validates <see cref="PaymentInstruction19"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PaymentInstruction19Validator : AbstractValidator<PaymentInstruction19>
{
    public PaymentInstruction19Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction19.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
