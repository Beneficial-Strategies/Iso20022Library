...
/// <summary>
/// Validates <see cref="TransferIn15"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn15Validator : AbstractValidator<TransferIn15>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn15"/>.
    /// </summary>
    public TransferIn15Validator()
    {
        RuleFor(x => x.TransferAndReferences)
            .NotEmpty()
            .WithMessage("TransferIn15.TransferAndReferences must contain at least one element (1..∞).");
    }
}
