...
/// <summary>
/// Validates <see cref="LiquidityStressTestResult1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public sealed class LiquidityStressTestResult1Validator : AbstractValidator<LiquidityStressTestResult1>
{
    public LiquidityStressTestResult1Validator()
    {
        RuleFor(x => x.LiquidityRequiredAndAvailable)
            .NotEmpty()
            .WithMessage("LiquidityStressTestResult1.LiquidityRequiredAndAvailable must contain at least one element (6..6).");
    }
}
