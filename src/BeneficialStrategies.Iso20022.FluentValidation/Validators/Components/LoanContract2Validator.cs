...
/// <summary>
/// Validates <see cref="LoanContract2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoanContract2Validator : AbstractValidator<LoanContract2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoanContract2"/>.
    /// </summary>
    public LoanContract2Validator()
    {
        RuleFor(x => x.Buyer)
            .NotEmpty()
            .WithMessage("LoanContract2.Buyer must contain at least one element (1..∞).");

        RuleFor(x => x.Seller)
            .NotEmpty()
            .WithMessage("LoanContract2.Seller must contain at least one element (1..∞).");
    }
}
