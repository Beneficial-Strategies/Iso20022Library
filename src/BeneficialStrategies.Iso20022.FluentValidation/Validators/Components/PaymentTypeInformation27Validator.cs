...
/// <summary>
/// Validates <see cref="PaymentTypeInformation27"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _caAocXR0EeiH1ZOt2UD8vQ
...
///   <item><term>ClearingChannel</term><description>ClearingChannel2Code — optional (0..1), closed enum, fully enforced</description></item>
...
/// </remarks>
public class PaymentTypeInformation27Validator : AbstractValidator<PaymentTypeInformation27>
{
    /// <summary>
    /// Initializes a new instance using dependency injection: the caller supplies the validators
    /// — e.g. resolved from a DI container — instead of this type constructing its own.
    /// </summary>
    public PaymentTypeInformation27Validator(
