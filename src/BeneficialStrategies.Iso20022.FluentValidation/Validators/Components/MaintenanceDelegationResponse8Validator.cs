...
/// <summary>
/// Validates <see cref="MaintenanceDelegationResponse8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class MaintenanceDelegationResponse8Validator : AbstractValidator<MaintenanceDelegationResponse8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="MaintenanceDelegationResponse8"/>.
    /// </summary>
    public MaintenanceDelegationResponse8Validator()
    {
        RuleFor(x => x.DelegationResponse)
            .NotEmpty()
            .WithMessage("MaintenanceDelegationResponse8.DelegationResponse must contain at least one element (1..∞).");
    }
}
