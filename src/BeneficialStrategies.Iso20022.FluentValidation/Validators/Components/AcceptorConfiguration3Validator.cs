...
/// <summary>
/// Validates <see cref="AcceptorConfiguration3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration3Validator : AbstractValidator<AcceptorConfiguration3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration3"/>.
    /// </summary>
    public AcceptorConfiguration3Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration3.DataSet must contain at least one element (1..∞).");
    }
}
