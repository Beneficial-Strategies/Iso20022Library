...
/// <summary>
/// Validates <see cref="AmountAndTrigger1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AmountAndTrigger1"/>.
    /// </summary>
    public AmountAndTrigger1Validator()
    {
        RuleFor(x => x.Trigger)
            .NotEmpty()
            .WithMessage("AmountAndTrigger1.Trigger must contain at least one element (1..∞).");
    }
}
