...
/// <summary>
/// Validates <see cref="Clearing3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Clearing3Validator : AbstractValidator<Clearing3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Clearing3"/>.
    /// </summary>
    public Clearing3Validator()
    {
        RuleFor(x => x.ClearingMember)
            .NotEmpty()
            .WithMessage("Clearing3.ClearingMember must contain at least one element (1..∞).");
    }
}
