...
/// <summary>
/// Validates <see cref="ISATransfer20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ISATransfer20Validator : AbstractValidator<ISATransfer20>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ISATransfer20"/>.
    /// </summary>
    public ISATransfer20Validator()
    {
        RuleFor(x => x.ProductTransfer)
            .NotEmpty()
            .WithMessage("ISATransfer20.ProductTransfer must contain at least one element (1..∞).");
    }
}
