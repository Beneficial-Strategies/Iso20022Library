...
/// <summary>
/// Validates <see cref="AcceptorConfiguration1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration1Validator : AbstractValidator<AcceptorConfiguration1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration1"/>.
    /// </summary>
    public AcceptorConfiguration1Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration1.DataSet must contain at least one element (1..∞).");
    }
}
