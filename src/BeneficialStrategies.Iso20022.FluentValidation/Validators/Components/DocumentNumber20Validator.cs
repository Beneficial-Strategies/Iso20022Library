...
/// <summary>
/// Validates <see cref="DocumentNumber20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class DocumentNumber20Validator : AbstractValidator<DocumentNumber20>
{
    public DocumentNumber20Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber20.References must contain at least one element (1..∞).");
    }
}
