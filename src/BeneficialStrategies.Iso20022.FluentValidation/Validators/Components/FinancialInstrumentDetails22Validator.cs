...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails22"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails22Validator : AbstractValidator<FinancialInstrumentDetails22>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails22"/>.
    /// </summary>
    public FinancialInstrumentDetails22Validator()
    {
        RuleFor(x => x.SubBalance)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails22.SubBalance must contain at least one element (1..∞).");
    }
}
