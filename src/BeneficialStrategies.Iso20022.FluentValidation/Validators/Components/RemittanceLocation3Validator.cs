...
/// <summary>
/// Validates <see cref="RemittanceLocation3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RemittanceLocation3Validator : AbstractValidator<RemittanceLocation3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RemittanceLocation3"/>.
    /// </summary>
    public RemittanceLocation3Validator()
    {
        RuleFor(x => x.RemittanceLocationDetails)
            .NotEmpty()
            .WithMessage("RemittanceLocation3.RemittanceLocationDetails must contain at least one element (1..∞).");
    }
}
