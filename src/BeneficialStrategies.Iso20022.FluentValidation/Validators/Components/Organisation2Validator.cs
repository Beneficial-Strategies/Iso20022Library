...
/// <summary>
/// Validates <see cref="Organisation2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Organisation2"/>.
    /// </summary>
    public Organisation2Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("Organisation2.PostalAddress must contain at least one element (1..5).");
    }
}
