...
/// <summary>
/// Validates <see cref="ReconciliationCounterpartyPairStatistics7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ReconciliationCounterpartyPairStatistics7Validator : AbstractValidator<ReconciliationCounterpartyPairStatistics7>
{
    public ReconciliationCounterpartyPairStatistics7Validator()
    {
        RuleFor(x => x.ReconciliationReport)
            .NotEmpty()
            .WithMessage("ReconciliationCounterpartyPairStatistics7.ReconciliationReport must contain at least one element (1..∞).");
    }
}
