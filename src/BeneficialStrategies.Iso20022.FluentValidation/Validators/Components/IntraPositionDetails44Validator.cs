...
/// <summary>
/// Validates <see cref="IntraPositionDetails44"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class IntraPositionDetails44Validator : AbstractValidator<IntraPositionDetails44>
{
    public IntraPositionDetails44Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails44.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
