...
/// <summary>
/// Validates <see cref="InvestmentPlan10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan10Validator : AbstractValidator<InvestmentPlan10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan10"/>.
    /// </summary>
    public InvestmentPlan10Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan10.SecurityDetails must contain at least one element (1..50).");
    }
}
