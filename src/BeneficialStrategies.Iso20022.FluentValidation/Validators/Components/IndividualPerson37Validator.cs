...
/// <summary>
/// Validates <see cref="IndividualPerson37"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public sealed class IndividualPerson37Validator : AbstractValidator<IndividualPerson37>
{
    public IndividualPerson37Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("IndividualPerson37.PostalAddress must contain at least one element (1..10).");
    }
}
