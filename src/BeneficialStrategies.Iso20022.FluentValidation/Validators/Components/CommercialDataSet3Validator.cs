...
/// <summary>
/// Validates <see cref="CommercialDataSet3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CommercialDataSet3Validator : AbstractValidator<CommercialDataSet3>
{
    public CommercialDataSet3Validator()
    {
        RuleFor(x => x.Goods)
            .NotEmpty()
            .WithMessage("CommercialDataSet3.Goods must contain at least one element (1..∞).");

        RuleFor(x => x.PaymentTerms)
            .NotEmpty()
            .WithMessage("CommercialDataSet3.PaymentTerms must contain at least one element (1..∞).");
    }
}
