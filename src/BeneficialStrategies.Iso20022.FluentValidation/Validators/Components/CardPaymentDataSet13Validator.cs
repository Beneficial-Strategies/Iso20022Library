...
/// <summary>
/// Validates <see cref="CardPaymentDataSet13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet13Validator : AbstractValidator<CardPaymentDataSet13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet13"/>.
    /// </summary>
    public CardPaymentDataSet13Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet13.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet13.TransactionTotals must contain at least one element (1..∞).");
    }
}
