...
/// <summary>
/// Validates <see cref="ClearedProduct1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ClearedProduct1"/>.
    /// </summary>
    public ClearedProduct1Validator()
    {
        RuleFor(x => x.TradingVenue)
            .NotEmpty()
            .WithMessage("ClearedProduct1.TradingVenue must contain at least one element (1..∞).");
    }
}
