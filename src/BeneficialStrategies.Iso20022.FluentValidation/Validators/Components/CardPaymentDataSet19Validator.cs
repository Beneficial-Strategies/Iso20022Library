...
/// <summary>
/// Validates <see cref="CardPaymentDataSet19"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet19Validator : AbstractValidator<CardPaymentDataSet19>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet19"/>.
    /// </summary>
    public CardPaymentDataSet19Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet19.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet19.TransactionTotals must contain at least one element (1..∞).");
    }
}
