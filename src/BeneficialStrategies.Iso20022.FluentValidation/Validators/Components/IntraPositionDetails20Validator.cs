...
/// <summary>
/// Validates <see cref="IntraPositionDetails20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IntraPositionDetails20Validator : AbstractValidator<IntraPositionDetails20>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionDetails20"/>.
    /// </summary>
    public IntraPositionDetails20Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails20.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
