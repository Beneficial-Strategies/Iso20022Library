...
/// <summary>
/// Validates <see cref="PriceReport4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PriceReport4Validator : AbstractValidator<PriceReport4>
{
    public PriceReport4Validator()
    {
        RuleFor(x => x.PriceValuationDetails)
            .NotEmpty()
            .WithMessage("PriceReport4.PriceValuationDetails must contain at least one element (1..∞).");
    }
}
