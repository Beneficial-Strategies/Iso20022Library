...
/// <summary>
/// Validates <see cref="BillingMethod3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="BillingMethod3"/>.
    /// </summary>
    public BillingMethod3Validator()
    {
        RuleFor(x => x.TaxIdentification)
            .NotEmpty()
            .WithMessage("BillingMethod3.TaxIdentification must contain at least one element (1..3).");
    }
}
