...
/// <summary>
/// Validates <see cref="SupportingDocument2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SupportingDocument2Validator : AbstractValidator<SupportingDocument2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SupportingDocument2"/>.
    /// </summary>
    public SupportingDocument2Validator()
    {
        RuleFor(x => x.Entry)
            .NotEmpty()
            .WithMessage("SupportingDocument2.Entry must contain at least one element (1..∞).");
    }
}
