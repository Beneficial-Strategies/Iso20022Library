...
/// <summary>
/// Validates <see cref="NewAccount1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NewAccount1Validator : AbstractValidator<NewAccount1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NewAccount1"/>.
    /// </summary>
    public NewAccount1Validator()
    {
        RuleFor(x => x.AccountParty)
            .NotEmpty()
            .WithMessage("NewAccount1.AccountParty must contain at least one element (1..∞).");
    }
}
