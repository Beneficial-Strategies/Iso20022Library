...
/// <summary>
/// Validates <see cref="AcceptorConfiguration9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration9"/>.
    /// </summary>
    public AcceptorConfiguration9Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration9.DataSet must contain at least one element (1..∞).");
    }
}
