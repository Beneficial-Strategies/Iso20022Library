...
/// <summary>
/// Validates <see cref="NetworkParameters7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class NetworkParameters7Validator : AbstractValidator<NetworkParameters7>
{
    public NetworkParameters7Validator()
    {
        RuleFor(x => x.Address)
            .NotEmpty()
            .WithMessage("NetworkParameters7.Address must contain at least one element (1..∞).");
    }
}
