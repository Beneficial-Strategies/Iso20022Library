...
/// <summary>
/// Validates <see cref="SignedData1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SignedData1Validator : AbstractValidator<SignedData1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SignedData1"/>.
    /// </summary>
    public SignedData1Validator()
    {
        RuleFor(x => x.DigestAlgorithm)
            .NotEmpty()
            .WithMessage("SignedData1.DigestAlgorithm must contain at least one element (1..∞).");

        RuleFor(x => x.Signer)
            .NotEmpty()
            .WithMessage("SignedData1.Signer must contain at least one element (1..∞).");
    }
}
