...
/// <summary>
/// Validates <see cref="DocumentNumber6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DocumentNumber6"/>.
    /// </summary>
    public DocumentNumber6Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber6.References must contain at least one element (1..∞).");
    }
}
