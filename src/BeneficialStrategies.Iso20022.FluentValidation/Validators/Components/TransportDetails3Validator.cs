...
/// <summary>
/// Validates <see cref="TransportDetails3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TransportDocumentReference</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
///   <item><term>TransportedGoods</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class TransportDetails3Validator : AbstractValidator<TransportDetails3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransportDetails3"/>.
    /// </summary>
    public TransportDetails3Validator()
    {
        RuleFor(x => x.TransportDocumentReference)
            .NotEmpty()
            .WithMessage("TransportDetails3.TransportDocumentReference must contain at least one element (1..∞).");

        RuleFor(x => x.TransportedGoods)
            .NotEmpty()
            .WithMessage("TransportDetails3.TransportedGoods must contain at least one element (1..∞).");
    }
}
