...
/// <summary>
/// Validates <see cref="PaymentTypeInformation28"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _PK3cAYkMEei-69PNFxn_Ew
...
/// </remarks>
public class PaymentTypeInformation28Validator : AbstractValidator<PaymentTypeInformation28>
{
    /// <summary>
    /// Initializes a new instance using dependency injection: the caller supplies the validators
    /// — e.g. resolved from a DI container — instead of this type constructing its own.
    /// </summary>
    public PaymentTypeInformation28Validator(
