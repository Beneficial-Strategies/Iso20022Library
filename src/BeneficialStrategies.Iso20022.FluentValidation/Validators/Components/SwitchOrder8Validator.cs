...
/// <summary>
/// Validates <see cref="SwitchOrder8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SwitchOrder8Validator : AbstractValidator<SwitchOrder8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SwitchOrder8"/>.
    /// </summary>
    public SwitchOrder8Validator()
    {
        RuleFor(x => x.RedemptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchOrder8.RedemptionLegDetails must contain at least one element (1..∞).");

        RuleFor(x => x.SubscriptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchOrder8.SubscriptionLegDetails must contain at least one element (1..∞).");
    }
}
