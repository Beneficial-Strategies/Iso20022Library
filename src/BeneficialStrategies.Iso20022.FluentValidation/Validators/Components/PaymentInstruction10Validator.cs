...
/// <summary>
/// Validates <see cref="PaymentInstruction10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction10Validator : AbstractValidator<PaymentInstruction10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction10"/>.
    /// </summary>
    public PaymentInstruction10Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction10.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
