...
/// <summary>
/// Validates <see cref="EnvelopedData10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData10Validator : AbstractValidator<EnvelopedData10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData10"/>.
    /// </summary>
    public EnvelopedData10Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData10.Recipient must contain at least one element (1..∞).");
    }
}
