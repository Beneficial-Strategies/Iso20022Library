...
/// <summary>
/// Validates <see cref="EntitlementAdvice1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>AccountAndDistributionDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class EntitlementAdvice1Validator : AbstractValidator<EntitlementAdvice1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EntitlementAdvice1"/>.
    /// </summary>
    public EntitlementAdvice1Validator()
    {
        RuleFor(x => x.AccountAndDistributionDetails)
            .NotEmpty()
            .WithMessage("EntitlementAdvice1.AccountAndDistributionDetails must contain at least one element (1..∞).");
    }
}
