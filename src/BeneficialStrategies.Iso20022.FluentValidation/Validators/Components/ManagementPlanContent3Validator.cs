...
/// <summary>
/// Validates <see cref="ManagementPlanContent3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent3Validator : AbstractValidator<ManagementPlanContent3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent3"/>.
    /// </summary>
    public ManagementPlanContent3Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent3.Action must contain at least one element (1..∞).");
    }
}
