...
/// <summary>
/// Validates <see cref="AuthenticatedData5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData5Validator : AbstractValidator<AuthenticatedData5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData5"/>.
    /// </summary>
    public AuthenticatedData5Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData5.Recipient must contain at least one element (1..∞).");
    }
}
