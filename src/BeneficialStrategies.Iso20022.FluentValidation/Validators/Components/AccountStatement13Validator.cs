...
/// <summary>
/// Validates <see cref="AccountStatement13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _9wnKATEsEe6GxLzpkVnWYg
...
/// </remarks>
public class AccountStatement13Validator : AbstractValidator<AccountStatement13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountStatement13"/>.
    /// </summary>
    public AccountStatement13Validator()
    {
        ...
        // Account (CashAccount43): required (1..1) component, no validator yet — nested
        // fields unvalidated.
        // Interest (AccountInterest4) and Entry (ReportEntry14): 0..∞ collections — any
        ...
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountStatement13.Balance must contain at least one element (1..*).");
    }
}
