...
/// <summary>
/// Validates <see cref="PartyReferenceDataChange2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class PartyReferenceDataChange2Validator : AbstractValidator<PartyReferenceDataChange2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PartyReferenceDataChange2"/>.
    /// </summary>
    public PartyReferenceDataChange2Validator()
    {
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("PartyReferenceDataChange2.Record must contain at least one element (1..∞).");
    }
}
