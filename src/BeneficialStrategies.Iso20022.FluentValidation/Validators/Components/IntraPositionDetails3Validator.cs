...
/// <summary>
/// Validates <see cref="IntraPositionDetails3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IntraPositionDetails3Validator : AbstractValidator<IntraPositionDetails3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionDetails3"/>.
    /// </summary>
    public IntraPositionDetails3Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails3.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
