...
/// <summary>
/// Validates <see cref="ClearedProduct3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ClearedProduct3Validator : AbstractValidator<ClearedProduct3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ClearedProduct3"/>.
    /// </summary>
    public ClearedProduct3Validator()
    {
        RuleFor(x => x.TradingVenue)
            .NotEmpty()
            .WithMessage("ClearedProduct3.TradingVenue must contain at least one element (1..∞).");
    }
}
