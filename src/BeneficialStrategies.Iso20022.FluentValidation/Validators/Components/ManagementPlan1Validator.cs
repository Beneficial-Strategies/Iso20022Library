...
/// <summary>
/// Validates <see cref="ManagementPlan1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlan1Validator : AbstractValidator<ManagementPlan1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlan1"/>.
    /// </summary>
    public ManagementPlan1Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("ManagementPlan1.DataSet must contain at least one element (1..∞).");
    }
}
