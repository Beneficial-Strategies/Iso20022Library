...
/// <summary>
/// Validates <see cref="LineItem13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LineItem13Validator : AbstractValidator<LineItem13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem13"/>.
    /// </summary>
    public LineItem13Validator()
    {
        RuleFor(x => x.LineItemDetails)
            .NotEmpty()
            .WithMessage("LineItem13.LineItemDetails must contain at least one element (1..∞).");
    }
}
