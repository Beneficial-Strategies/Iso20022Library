...
/// <summary>
/// Validates <see cref="ManagementPlan3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlan3Validator : AbstractValidator<ManagementPlan3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlan3"/>.
    /// </summary>
    public ManagementPlan3Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("ManagementPlan3.DataSet must contain at least one element (1..∞).");
    }
}
