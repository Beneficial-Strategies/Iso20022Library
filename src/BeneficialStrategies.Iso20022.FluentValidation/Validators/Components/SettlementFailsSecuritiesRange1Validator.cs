...
/// <summary>
/// Validates <see cref="SettlementFailsSecuritiesRange1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SettlementFailsSecuritiesRange1Validator : AbstractValidator<SettlementFailsSecuritiesRange1>
{
    ...
    public SettlementFailsSecuritiesRange1Validator()
    {
        RuleFor(x => x.HighestInValue)
            .NotEmpty()
            .WithMessage("SettlementFailsSecuritiesRange1.HighestInValue must contain at least one element (1..∞).");

        RuleFor(x => x.HighestInVolume)
            .NotEmpty()
            .WithMessage("SettlementFailsSecuritiesRange1.HighestInVolume must contain at least one element (1..∞).");
    }
}
