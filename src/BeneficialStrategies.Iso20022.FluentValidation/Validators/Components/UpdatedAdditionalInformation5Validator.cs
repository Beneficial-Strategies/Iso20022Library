...
/// <summary>
/// Validates <see cref="UpdatedAdditionalInformation5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class UpdatedAdditionalInformation5Validator : AbstractValidator<UpdatedAdditionalInformation5>
{
    public UpdatedAdditionalInformation5Validator()
    {
        RuleFor(x => x.AdditionalInformation)
            .NotEmpty()
            .WithMessage("UpdatedAdditionalInformation5.AdditionalInformation must contain at least one element (1..∞).");
    }
}
