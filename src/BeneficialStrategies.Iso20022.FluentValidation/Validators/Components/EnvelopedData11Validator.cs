...
/// <summary>
/// Validates <see cref="EnvelopedData11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData11Validator : AbstractValidator<EnvelopedData11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData11"/>.
    /// </summary>
    public EnvelopedData11Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData11.Recipient must contain at least one element (1..∞).");
    }
}
