...
/// <summary>
/// Validates <see cref="AccountStatement10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _bU-d8dcZEeqRFcf2R4bPBw
...
/// </remarks>
public sealed class AccountStatement10Validator : AbstractValidator<AccountStatement10>
{
    public AccountStatement10Validator()
    {
        ...
        // fields unvalidated.
        // Interest (AccountInterest4) and Entry (ReportEntry11): 0..∞ collections — any
        ...
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountStatement10.Balance must contain at least one element (1..*).");
    }
}
