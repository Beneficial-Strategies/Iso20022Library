...
/// <summary>
/// Validates <see cref="EncryptedContent8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class EncryptedContent8Validator : AbstractValidator<EncryptedContent8>
{
    public EncryptedContent8Validator()
    {
        RuleFor(x => x.EncryptedDataElement)
            .NotEmpty()
            .WithMessage("EncryptedContent8.EncryptedDataElement must contain at least one element (1..∞).");
    }
}
