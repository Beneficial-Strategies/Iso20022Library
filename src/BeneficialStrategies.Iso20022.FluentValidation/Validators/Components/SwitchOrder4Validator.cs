...
/// <summary>
/// Validates <see cref="SwitchOrder4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SwitchOrder4Validator : AbstractValidator<SwitchOrder4>
{
    public SwitchOrder4Validator()
    {
        RuleFor(x => x.RedemptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchOrder4.RedemptionLegDetails must contain at least one element (1..∞).");

        RuleFor(x => x.SubscriptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchOrder4.SubscriptionLegDetails must contain at least one element (1..∞).");
    }
}
