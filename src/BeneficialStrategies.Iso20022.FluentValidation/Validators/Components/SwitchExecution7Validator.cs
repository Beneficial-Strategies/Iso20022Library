...
/// <summary>
/// Validates <see cref="SwitchExecution7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SwitchExecution7Validator : AbstractValidator<SwitchExecution7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SwitchExecution7"/>.
    /// </summary>
    public SwitchExecution7Validator()
    {
        RuleFor(x => x.RedemptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchExecution7.RedemptionLegDetails must contain at least one element (1..∞).");

        RuleFor(x => x.SubscriptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchExecution7.SubscriptionLegDetails must contain at least one element (1..∞).");
    }
}
