...
/// <summary>
/// Validates <see cref="Group3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Group3Validator : AbstractValidator<Group3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Group3"/>.
    /// </summary>
    public Group3Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group3.Party must contain at least one element (1..∞).");
    }
}
