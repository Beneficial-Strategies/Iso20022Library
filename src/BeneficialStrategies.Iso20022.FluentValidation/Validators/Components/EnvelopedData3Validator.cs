...
/// <summary>
/// Validates <see cref="EnvelopedData3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData3Validator : AbstractValidator<EnvelopedData3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData3"/>.
    /// </summary>
    public EnvelopedData3Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData3.Recipient must contain at least one element (1..∞).");
    }
}
