...
/// <summary>
/// Validates <see cref="CounterpartyAggregation3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public sealed class CounterpartyAggregation3Validator : AbstractValidator<CounterpartyAggregation3>
{
    public CounterpartyAggregation3Validator()
    {
        RuleFor(x => x.ValuationAmounts)
            .NotEmpty()
            .WithMessage("CounterpartyAggregation3.ValuationAmounts must contain at least one element (1..∞).");
    }
}
