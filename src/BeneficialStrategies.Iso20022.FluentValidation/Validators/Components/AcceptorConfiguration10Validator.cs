...
/// <summary>
/// Validates <see cref="AcceptorConfiguration10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration10Validator : AbstractValidator<AcceptorConfiguration10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration10"/>.
    /// </summary>
    public AcceptorConfiguration10Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration10.DataSet must contain at least one element (1..∞).");
    }
}
