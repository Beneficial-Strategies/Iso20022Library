...
/// <summary>
/// Validates <see cref="EnvelopedData2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData2Validator : AbstractValidator<EnvelopedData2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData2"/>.
    /// </summary>
    public EnvelopedData2Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData2.Recipient must contain at least one element (1..∞).");
    }
}
