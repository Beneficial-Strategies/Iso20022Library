...
/// <summary>
/// Validates <see cref="SubscriptionBulkExecution2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionBulkExecution2Validator : AbstractValidator<SubscriptionBulkExecution2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkExecution2"/>.
    /// </summary>
    public SubscriptionBulkExecution2Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkExecution2.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
