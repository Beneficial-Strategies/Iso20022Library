...
/// <summary>
/// Validates <see cref="DetailedInstructionStatus9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DetailedInstructionStatus9"/>.
    /// </summary>
    public DetailedInstructionStatus9Validator()
    {
        RuleFor(x => x.VotePerResolution)
            .NotEmpty()
            .WithMessage("DetailedInstructionStatus9.VotePerResolution must contain at least one element (1..1000).");
    }
}
