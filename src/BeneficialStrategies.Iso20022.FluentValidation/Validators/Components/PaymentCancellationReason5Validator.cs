...
/// Spec source: PaymentCancellationReason5 message component.
/// <list type="table">
...
///   <item><term>AdditionalInformation</term><description>Max105Text — optional, MaxLength=105</description></item>
/// </list>
/// </remarks>
public sealed class PaymentCancellationReason5Validator : AbstractValidator<PaymentCancellationReason5>
{
    ...
    {
        // AdditionalInformation: Max105Text — when present, MinLength=1, MaxLength=105
        RuleFor(x => x.AdditionalInformation)
            .MinimumLength(1)
            .MaximumLength(105)
                .WithMessage("PaymentCancellationReason5.AdditionalInformation must not exceed 105 characters (Max105Text).")
