...
/// <summary>
/// Validates <see cref="LocalMarketAnnex5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class LocalMarketAnnex5Validator : AbstractValidator<LocalMarketAnnex5>
{
    public LocalMarketAnnex5Validator()
    {
        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex5.Country must contain at least one element (1..∞).");
    }
}
