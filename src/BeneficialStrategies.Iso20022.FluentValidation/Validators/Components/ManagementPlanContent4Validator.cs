...
/// <summary>
/// Validates <see cref="ManagementPlanContent4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent4Validator : AbstractValidator<ManagementPlanContent4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent4"/>.
    /// </summary>
    public ManagementPlanContent4Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent4.Action must contain at least one element (1..∞).");
    }
}
