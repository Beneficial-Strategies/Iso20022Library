...
/// <summary>
/// Validates <see cref="Proxy5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Proxy5Validator : AbstractValidator<Proxy5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Proxy5"/>.
    /// </summary>
    public Proxy5Validator()
    {
        RuleFor(x => x.ProxyType)
            .NotEmpty()
            .WithMessage("Proxy5.ProxyType must contain at least one element (1..2).");
    }
}
