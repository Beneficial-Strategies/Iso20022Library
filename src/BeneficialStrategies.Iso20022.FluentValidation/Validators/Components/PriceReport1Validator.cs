...
/// <summary>
/// Validates <see cref="PriceReport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PriceReport1Validator : AbstractValidator<PriceReport1>
{
    public PriceReport1Validator()
    {
        RuleFor(x => x.PriceValuationDetails)
            .NotEmpty()
            .WithMessage("PriceReport1.PriceValuationDetails must contain at least one element (1..∞).");
    }
}
