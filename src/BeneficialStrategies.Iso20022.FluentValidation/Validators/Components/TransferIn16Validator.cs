...
/// <summary>
/// Validates <see cref="TransferIn16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TransferIn16Validator : AbstractValidator<TransferIn16>
{
    public TransferIn16Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn16.TransferDetails must contain at least one element (1..∞).");
    }
}
