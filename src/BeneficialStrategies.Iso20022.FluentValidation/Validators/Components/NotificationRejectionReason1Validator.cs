...
/// <summary>
/// Validates <see cref="NotificationRejectionReason1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NotificationRejectionReason1Validator : AbstractValidator<NotificationRejectionReason1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NotificationRejectionReason1"/>.
    /// </summary>
    public NotificationRejectionReason1Validator()
    {
        RuleFor(x => x.Reason)
            .NotEmpty()
            .WithMessage("NotificationRejectionReason1.Reason must contain at least one element (1..∞).");
    }
}
