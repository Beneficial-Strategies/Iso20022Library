...
/// <summary>
/// Validates <see cref="AcceptorConfiguration4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration4Validator : AbstractValidator<AcceptorConfiguration4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration4"/>.
    /// </summary>
    public AcceptorConfiguration4Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration4.DataSet must contain at least one element (1..∞).");
    }
}
