...
/// <summary>
/// Validates <see cref="InvestmentFundOrder1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class InvestmentFundOrder1Validator : AbstractValidator<InvestmentFundOrder1>
{
    public InvestmentFundOrder1Validator()
    {
        RuleFor(x => x.OrderReferences)
            .NotEmpty()
            .WithMessage("InvestmentFundOrder1.OrderReferences must contain at least one element (1..∞).");
    }
}
