...
/// <summary>
/// Validates <see cref="Baseline3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Baseline3Validator : AbstractValidator<Baseline3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Baseline3"/>.
    /// </summary>
    public Baseline3Validator()
    {
        RuleFor(x => x.PaymentTerms)
            .NotEmpty()
            .WithMessage("Baseline3.PaymentTerms must contain at least one element (1..∞).");
    }
}
