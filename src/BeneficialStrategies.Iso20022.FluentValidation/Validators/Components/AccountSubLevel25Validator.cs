...
/// <summary>
/// Validates <see cref="AccountSubLevel25"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AccountSubLevel25Validator : AbstractValidator<AccountSubLevel25>
{
    ...
    public AccountSubLevel25Validator()
    {
        RuleFor(x => x.ShareholdingBalance)
            .NotEmpty()
            .WithMessage("AccountSubLevel25.ShareholdingBalance must contain at least one element (1..∞).");
    }
}
