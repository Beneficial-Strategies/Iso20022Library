...
/// <summary>
/// Validates <see cref="StoredValueRequest8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest8Validator : AbstractValidator<StoredValueRequest8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest8"/>.
    /// </summary>
    public StoredValueRequest8Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest8.Data must contain at least one element (1..∞).");
    }
}
