...
/// <summary>
/// Validates <see cref="ProcessingCharacteristics3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ProcessingCharacteristics3"/>.
    /// </summary>
    public ProcessingCharacteristics3Validator()
    {
        RuleFor(x => x.DealingCurrencyAccepted)
            .NotEmpty()
            .WithMessage("ProcessingCharacteristics3.DealingCurrencyAccepted must contain at least one element (1..∞).");
    }
}
