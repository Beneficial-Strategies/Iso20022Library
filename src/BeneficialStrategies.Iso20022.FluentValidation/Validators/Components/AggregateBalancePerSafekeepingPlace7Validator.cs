...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalancePerSafekeepingPlace7Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace7"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace7Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace7.PriceDetails must contain at least one element (1..∞).");
    }
}
