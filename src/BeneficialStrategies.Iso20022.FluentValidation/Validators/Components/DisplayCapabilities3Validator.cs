...
/// <summary>
/// Validates <see cref="DisplayCapabilities3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DisplayCapabilities3"/>.
    /// </summary>
    public DisplayCapabilities3Validator()
    {
        RuleFor(x => x.AvailableFormat)
            .NotEmpty()
            .WithMessage("DisplayCapabilities3.AvailableFormat must contain at least one element (1..∞).");
    }
}
