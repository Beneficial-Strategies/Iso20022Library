...
/// <summary>
/// Validates <see cref="InvestmentPlan9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan9Validator : AbstractValidator<InvestmentPlan9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan9"/>.
    /// </summary>
    public InvestmentPlan9Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan9.SecurityDetails must contain at least one element (1..50).");
    }
}
