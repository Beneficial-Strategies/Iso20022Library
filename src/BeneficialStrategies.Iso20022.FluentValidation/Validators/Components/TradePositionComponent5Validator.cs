...
/// <summary>
/// Validates <see cref="TradePositionComponent5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradePositionComponent5"/>.
    /// </summary>
    public TradePositionComponent5Validator()
    {
        RuleFor(x => x.CounterpartySpecificData)
            .NotEmpty()
            .WithMessage("TradePositionComponent5.CounterpartySpecificData must contain at least one element (1..2).");
    }
}
