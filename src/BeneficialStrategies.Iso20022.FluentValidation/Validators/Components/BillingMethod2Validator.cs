...
/// <summary>
/// Validates <see cref="BillingMethod2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class BillingMethod2Validator : AbstractValidator<BillingMethod2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="BillingMethod2"/>.
    /// </summary>
    public BillingMethod2Validator()
    {
        RuleFor(x => x.TaxIdentification)
            .NotEmpty()
            .WithMessage("BillingMethod2.TaxIdentification must contain at least one element (1..3).");
    }
}
