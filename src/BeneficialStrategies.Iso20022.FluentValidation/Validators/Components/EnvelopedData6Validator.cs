...
/// <summary>
/// Validates <see cref="EnvelopedData6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData6Validator : AbstractValidator<EnvelopedData6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData6"/>.
    /// </summary>
    public EnvelopedData6Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData6.Recipient must contain at least one element (1..∞).");
    }
}
