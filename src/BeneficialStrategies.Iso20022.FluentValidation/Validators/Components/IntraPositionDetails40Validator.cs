...
/// <summary>
/// Validates <see cref="IntraPositionDetails40"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IntraPositionDetails40Validator : AbstractValidator<IntraPositionDetails40>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionDetails40"/>.
    /// </summary>
    public IntraPositionDetails40Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails40.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
