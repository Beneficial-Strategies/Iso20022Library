...
/// <summary>
/// Validates <see cref="CardPaymentDataSet14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet14"/>.
    /// </summary>
    public CardPaymentDataSet14Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet14.TransactionTotals must contain at least one element (1..∞).");
    }
}
