...
/// <summary>
/// Validates <see cref="NonFinancialResponseComponent3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class NonFinancialResponseComponent3Validator : AbstractValidator<NonFinancialResponseComponent3>
{
    public NonFinancialResponseComponent3Validator()
    {
        RuleFor(x => x.ResponseContent)
            .NotEmpty()
            .WithMessage("NonFinancialResponseComponent3.ResponseContent must contain at least one element (1..∞).");
    }
}
