...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails25"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails25Validator : AbstractValidator<FinancialInstrumentDetails25>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails25"/>.
    /// </summary>
    public FinancialInstrumentDetails25Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails25.Transaction must contain at least one element (1..∞).");
    }
}
