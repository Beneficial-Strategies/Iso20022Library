...
/// <summary>
/// Validates <see cref="StatusReport3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StatusReport3Validator : AbstractValidator<StatusReport3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StatusReport3"/>.
    /// </summary>
    public StatusReport3Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("StatusReport3.DataSet must contain at least one element (1..∞).");
    }
}
