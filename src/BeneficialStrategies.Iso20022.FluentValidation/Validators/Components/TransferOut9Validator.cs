...
/// <summary>
/// Validates <see cref="TransferOut9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TransferOut9Validator : AbstractValidator<TransferOut9>
{
    public TransferOut9Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut9.TransferDetails must contain at least one element (1..∞).");
    }
}
