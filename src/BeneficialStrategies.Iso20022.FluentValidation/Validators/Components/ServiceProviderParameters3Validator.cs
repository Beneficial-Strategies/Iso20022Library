...
/// <summary>
/// Validates <see cref="ServiceProviderParameters3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ServiceProviderParameters3Validator : AbstractValidator<ServiceProviderParameters3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ServiceProviderParameters3"/>.
    /// </summary>
    public ServiceProviderParameters3Validator()
    {
        RuleFor(x => x.ServiceProviderIdentification)
            .NotEmpty()
            .WithMessage("ServiceProviderParameters3.ServiceProviderIdentification must contain at least one element (1..∞).");
    }
}
