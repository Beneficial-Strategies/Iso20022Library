...
/// <summary>
/// Validates <see cref="LoginRequest5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class LoginRequest5Validator : AbstractValidator<LoginRequest5>
{
    public LoginRequest5Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest5.SaleSoftware must contain at least one element (1..∞).");
    }
}
