...
/// <summary>
/// Validates <see cref="AuthenticatedData8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData8Validator : AbstractValidator<AuthenticatedData8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData8"/>.
    /// </summary>
    public AuthenticatedData8Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData8.Recipient must contain at least one element (1..∞).");
    }
}
