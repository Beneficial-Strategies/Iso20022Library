...
/// <summary>
/// Validates <see cref="DefaultFundReport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CollateralDescription</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DefaultFundReport1"/>.
    /// </summary>
    public DefaultFundReport1Validator()
    {
        RuleFor(x => x.CollateralDescription)
            .NotEmpty()
            .WithMessage("DefaultFundReport1.CollateralDescription must contain at least one element (1..∞).");

        RuleFor(x => x.DefaultFundCalculation)
            .NotEmpty()
            .WithMessage("DefaultFundReport1.DefaultFundCalculation must contain at least one element (1..∞).");
    }
}
