...
/// <summary>
/// Validates <see cref="NotificationRejectionReason3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NotificationRejectionReason3Validator : AbstractValidator<NotificationRejectionReason3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NotificationRejectionReason3"/>.
    /// </summary>
    public NotificationRejectionReason3Validator()
    {
        RuleFor(x => x.Reason)
            .NotEmpty()
            .WithMessage("NotificationRejectionReason3.Reason must contain at least one element (1..∞).");
    }
}
