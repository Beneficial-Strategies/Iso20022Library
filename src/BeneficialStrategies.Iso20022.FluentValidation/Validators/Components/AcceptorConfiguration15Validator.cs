...
/// <summary>
/// Validates <see cref="AcceptorConfiguration15"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration15Validator : AbstractValidator<AcceptorConfiguration15>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration15"/>.
    /// </summary>
    public AcceptorConfiguration15Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration15.DataSet must contain at least one element (1..∞).");
    }
}
