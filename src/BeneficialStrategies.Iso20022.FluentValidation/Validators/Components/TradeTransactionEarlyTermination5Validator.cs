...
/// <summary>
/// Validates <see cref="TradeTransactionEarlyTermination5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TradeTransactionEarlyTermination5Validator : AbstractValidator<TradeTransactionEarlyTermination5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeTransactionEarlyTermination5"/>.
    /// </summary>
    public TradeTransactionEarlyTermination5Validator()
    {
        RuleFor(x => x.CounterpartySpecificData)
            .NotEmpty()
            .WithMessage("TradeTransactionEarlyTermination5.CounterpartySpecificData must contain at least one element (1..2).");
    }
}
