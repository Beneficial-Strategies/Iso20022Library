...
/// <summary>
/// Validates <see cref="CorporateActionAmendmentRejectionStatus1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CorporateActionAmendmentRejectionStatus1Validator : AbstractValidator<CorporateActionAmendmentRejectionStatus1>
{
    public CorporateActionAmendmentRejectionStatus1Validator()
    {
        RuleFor(x => x.Reason)
            .NotEmpty()
            .WithMessage("CorporateActionAmendmentRejectionStatus1.Reason must contain at least one element (1..∞).");
    }
}
