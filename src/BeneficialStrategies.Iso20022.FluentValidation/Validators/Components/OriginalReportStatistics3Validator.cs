...
/// <summary>
/// Validates <see cref="OriginalReportStatistics3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>NumberOfRecordsPerStatus</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class OriginalReportStatistics3Validator : AbstractValidator<OriginalReportStatistics3>
{
    public OriginalReportStatistics3Validator()
    {
        RuleFor(x => x.NumberOfRecordsPerStatus)
            .NotEmpty()
            .WithMessage("OriginalReportStatistics3.NumberOfRecordsPerStatus must contain at least one element (1..∞).");
    }
}
