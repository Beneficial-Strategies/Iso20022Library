...
/// <summary>
/// Validates <see cref="TradeTransactionStatusAndReason1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeTransactionStatusAndReason1"/>.
    /// </summary>
    public TradeTransactionStatusAndReason1Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("TradeTransactionStatusAndReason1.Rejected must contain at least one element (1..100).");
    }
}
