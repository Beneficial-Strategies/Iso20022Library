...
/// <summary>
/// Validates <see cref="UnderlyingSecurityMovement1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class UnderlyingSecurityMovement1Validator : AbstractValidator<UnderlyingSecurityMovement1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="UnderlyingSecurityMovement1"/>.
    /// </summary>
    public UnderlyingSecurityMovement1Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("UnderlyingSecurityMovement1.AccountDetails must contain at least one element (1..2).");
    }
}
