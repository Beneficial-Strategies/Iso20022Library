...
/// <summary>
/// Validates <see cref="CorporateActionSecuritiesMovement1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CorporateActionSecuritiesMovement1Validator : AbstractValidator<CorporateActionSecuritiesMovement1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CorporateActionSecuritiesMovement1"/>.
    /// </summary>
    public CorporateActionSecuritiesMovement1Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("CorporateActionSecuritiesMovement1.AccountDetails must contain at least one element (1..2).");
    }
}
