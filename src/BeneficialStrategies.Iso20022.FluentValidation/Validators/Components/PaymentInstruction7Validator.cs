...
/// <summary>
/// Validates <see cref="PaymentInstruction7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction7Validator : AbstractValidator<PaymentInstruction7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction7"/>.
    /// </summary>
    public PaymentInstruction7Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction7.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
