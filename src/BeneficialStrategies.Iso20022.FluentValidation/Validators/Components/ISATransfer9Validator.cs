...
/// <summary>
/// Validates <see cref="ISATransfer9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ISATransfer9Validator : AbstractValidator<ISATransfer9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ISATransfer9"/>.
    /// </summary>
    public ISATransfer9Validator()
    {
        RuleFor(x => x.ProductTransfer)
            .NotEmpty()
            .WithMessage("ISATransfer9.ProductTransfer must contain at least one element (1..∞).");
    }
}
