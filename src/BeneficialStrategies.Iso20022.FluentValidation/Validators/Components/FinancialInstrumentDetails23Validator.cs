...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails23Validator : AbstractValidator<FinancialInstrumentDetails23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails23"/>.
    /// </summary>
    public FinancialInstrumentDetails23Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails23.Transaction must contain at least one element (1..∞).");
    }
}
