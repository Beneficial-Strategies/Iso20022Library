...
/// <summary>
/// Validates <see cref="AuthenticatedData1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData1Validator : AbstractValidator<AuthenticatedData1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData1"/>.
    /// </summary>
    public AuthenticatedData1Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData1.Recipient must contain at least one element (1..∞).");
    }
}
