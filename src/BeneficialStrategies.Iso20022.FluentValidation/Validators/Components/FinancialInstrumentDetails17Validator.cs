...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails17Validator : AbstractValidator<FinancialInstrumentDetails17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails17"/>.
    /// </summary>
    public FinancialInstrumentDetails17Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails17.Transaction must contain at least one element (1..∞).");
    }
}
