...
/// <summary>
/// Validates <see cref="AcquirerProtocolParameters3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcquirerProtocolParameters3Validator : AbstractValidator<AcquirerProtocolParameters3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcquirerProtocolParameters3"/>.
    /// </summary>
    public AcquirerProtocolParameters3Validator()
    {
        RuleFor(x => x.AcquirerIdentification)
            .NotEmpty()
            .WithMessage("AcquirerProtocolParameters3.AcquirerIdentification must contain at least one element (1..∞).");
    }
}
