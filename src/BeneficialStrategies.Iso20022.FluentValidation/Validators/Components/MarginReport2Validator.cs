...
/// <summary>
/// Validates <see cref="MarginReport2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>MarginCalculation</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class MarginReport2Validator : AbstractValidator<MarginReport2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="MarginReport2"/>.
    /// </summary>
    public MarginReport2Validator()
    {
        RuleFor(x => x.MarginCalculation)
            .NotEmpty()
            .WithMessage("MarginReport2.MarginCalculation must contain at least one element (1..∞).");
    }
}
