...
/// <summary>
/// Validates <see cref="PaymentInstruction45"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class PaymentInstruction45Validator : AbstractValidator<PaymentInstruction45>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction45"/>.
    /// </summary>
    public PaymentInstruction45Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction45.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
