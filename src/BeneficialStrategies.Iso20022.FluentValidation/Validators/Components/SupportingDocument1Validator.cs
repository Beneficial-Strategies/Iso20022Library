...
/// <summary>
/// Validates <see cref="SupportingDocument1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SupportingDocument1Validator : AbstractValidator<SupportingDocument1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SupportingDocument1"/>.
    /// </summary>
    public SupportingDocument1Validator()
    {
        RuleFor(x => x.Entry)
            .NotEmpty()
            .WithMessage("SupportingDocument1.Entry must contain at least one element (1..∞).");
    }
}
