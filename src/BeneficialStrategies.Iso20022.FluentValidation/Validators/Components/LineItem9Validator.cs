...
/// <summary>
/// Validates <see cref="LineItem9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class LineItem9Validator : AbstractValidator<LineItem9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem9"/>.
    /// </summary>
    public LineItem9Validator()
    {
        RuleFor(x => x.CommercialLineItems)
            .NotEmpty()
            .WithMessage("LineItem9.CommercialLineItems must contain at least one element (1..∞).");
    }
}
