...
/// <summary>
/// Validates <see cref="DocumentNumber9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class DocumentNumber9Validator : AbstractValidator<DocumentNumber9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DocumentNumber9"/>.
    /// </summary>
    public DocumentNumber9Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber9.References must contain at least one element (1..∞).");
    }
}
