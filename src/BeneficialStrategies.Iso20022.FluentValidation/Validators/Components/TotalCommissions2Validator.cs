...
/// <summary>
/// Validates <see cref="TotalCommissions2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CommissionDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class TotalCommissions2Validator : AbstractValidator<TotalCommissions2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TotalCommissions2"/>.
    /// </summary>
    public TotalCommissions2Validator()
    {
        RuleFor(x => x.CommissionDetails)
            .NotEmpty()
            .WithMessage("TotalCommissions2.CommissionDetails must contain at least one element (1..∞).");
    }
}
