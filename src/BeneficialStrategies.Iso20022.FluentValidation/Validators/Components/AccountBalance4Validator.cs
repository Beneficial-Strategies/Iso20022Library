...
/// <summary>
/// Validates <see cref="AccountBalance4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AccountBalance4Validator : AbstractValidator<AccountBalance4>
{
    public AccountBalance4Validator()
    {
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountBalance4.Balance must contain at least one element (1..∞).");
    }
}
