...
/// <summary>
/// Validates <see cref="Transaction101"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ErrorDetail</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class Transaction101Validator : AbstractValidator<Transaction101>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transaction101"/>.
    /// </summary>
    public Transaction101Validator()
    {
        RuleFor(x => x.ErrorDetail)
            .NotEmpty()
            .WithMessage("Transaction101.ErrorDetail must contain at least one element (1..∞).");
    }
}
