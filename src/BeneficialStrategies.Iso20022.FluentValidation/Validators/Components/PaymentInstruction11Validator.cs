...
/// <summary>
/// Validates <see cref="PaymentInstruction11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction11Validator : AbstractValidator<PaymentInstruction11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction11"/>.
    /// </summary>
    public PaymentInstruction11Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction11.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
