...
/// <summary>
/// Validates <see cref="InvestmentPlan11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class InvestmentPlan11Validator : AbstractValidator<InvestmentPlan11>
{
    public InvestmentPlan11Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan11.SecurityDetails must contain at least one element (1..50).");
    }
}
