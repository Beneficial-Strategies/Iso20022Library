...
/// <summary>
/// Validates <see cref="NotificationCancellationRejectionReason2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class NotificationCancellationRejectionReason2Validator : AbstractValidator<NotificationCancellationRejectionReason2>
{
    public NotificationCancellationRejectionReason2Validator()
    {
        RuleFor(x => x.Reason)
            .NotEmpty()
            .WithMessage("NotificationCancellationRejectionReason2.Reason must contain at least one element (1..∞).");
    }
}
