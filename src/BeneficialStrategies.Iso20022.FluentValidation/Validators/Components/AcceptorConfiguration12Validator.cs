...
/// <summary>
/// Validates <see cref="AcceptorConfiguration12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration12Validator : AbstractValidator<AcceptorConfiguration12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration12"/>.
    /// </summary>
    public AcceptorConfiguration12Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration12.DataSet must contain at least one element (1..∞).");
    }
}
