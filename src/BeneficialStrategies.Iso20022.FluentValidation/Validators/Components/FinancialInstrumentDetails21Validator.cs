...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails21"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails21Validator : AbstractValidator<FinancialInstrumentDetails21>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails21"/>.
    /// </summary>
    public FinancialInstrumentDetails21Validator()
    {
        RuleFor(x => x.SubBalance)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails21.SubBalance must contain at least one element (1..∞).");
    }
}
