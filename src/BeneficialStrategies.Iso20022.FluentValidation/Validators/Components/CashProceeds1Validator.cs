...
/// <summary>
/// Validates <see cref="CashProceeds1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CashProceeds1Validator : AbstractValidator<CashProceeds1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CashProceeds1"/>.
    /// </summary>
    public CashProceeds1Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("CashProceeds1.AccountDetails must contain at least one element (1..2).");
    }
}
