...
/// <summary>
/// Validates <see cref="NonFinancialRequestContentComponent5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NonFinancialRequestContentComponent5Validator : AbstractValidator<NonFinancialRequestContentComponent5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NonFinancialRequestContentComponent5"/>.
    /// </summary>
    public NonFinancialRequestContentComponent5Validator()
    {
        RuleFor(x => x.NonFinancialRequestType)
            .NotEmpty()
            .WithMessage("NonFinancialRequestContentComponent5.NonFinancialRequestType must contain at least one element (1..∞).");
    }
}
