...
/// <summary>
/// Validates <see cref="LineItem11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LineItem11Validator : AbstractValidator<LineItem11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem11"/>.
    /// </summary>
    public LineItem11Validator()
    {
        RuleFor(x => x.LineItemDetails)
            .NotEmpty()
            .WithMessage("LineItem11.LineItemDetails must contain at least one element (1..∞).");
    }
}
