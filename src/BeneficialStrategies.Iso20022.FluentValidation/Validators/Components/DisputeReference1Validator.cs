...
/// <summary>
/// Validates <see cref="DisputeReference1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>DisputeIdentification</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class DisputeReference1Validator : AbstractValidator<DisputeReference1>
{
    public DisputeReference1Validator()
    {
        RuleFor(x => x.DisputeIdentification)
            .NotEmpty()
            .WithMessage("DisputeReference1.DisputeIdentification must contain at least one element (1..∞).");
    }
}
