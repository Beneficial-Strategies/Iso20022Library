...
/// <summary>
/// Validates <see cref="PositionAccount2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Position</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class PositionAccount2Validator : AbstractValidator<PositionAccount2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PositionAccount2"/>.
    /// </summary>
    public PositionAccount2Validator()
    {
        RuleFor(x => x.Position)
            .NotEmpty()
            .WithMessage("PositionAccount2.Position must contain at least one element (1..∞).");
    }
}
