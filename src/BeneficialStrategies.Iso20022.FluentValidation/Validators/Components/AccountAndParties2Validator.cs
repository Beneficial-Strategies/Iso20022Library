...
/// <summary>
/// Validates <see cref="AccountAndParties2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountAndParties2"/>.
    /// </summary>
    public AccountAndParties2Validator()
    {
        RuleFor(x => x.Role)
            .NotEmpty()
            .WithMessage("AccountAndParties2.Role must contain at least one element (1..∞).");
    }
}
