...
/// <summary>
/// Validates <see cref="AuthenticatedData10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData10Validator : AbstractValidator<AuthenticatedData10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData10"/>.
    /// </summary>
    public AuthenticatedData10Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData10.Recipient must contain at least one element (1..∞).");
    }
}
