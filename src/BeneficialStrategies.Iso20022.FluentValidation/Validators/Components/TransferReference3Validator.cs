...
/// <summary>
/// Validates <see cref="TransferReference3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TransferReference3Validator : AbstractValidator<TransferReference3>
{
    public TransferReference3Validator()
    {
        RuleFor(x => x.TransferReferences)
            .NotEmpty()
            .WithMessage("TransferReference3.TransferReferences must contain at least one element (1..∞).");
    }
}
