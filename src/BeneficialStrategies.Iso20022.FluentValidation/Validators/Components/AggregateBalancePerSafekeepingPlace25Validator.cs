...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace25"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalancePerSafekeepingPlace25Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace25>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace25"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace25Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace25.PriceDetails must contain at least one element (1..∞).");
    }
}
