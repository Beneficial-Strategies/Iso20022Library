...
/// <summary>
/// Validates <see cref="QualifiedPartyIdentification1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Party</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class QualifiedPartyIdentification1Validator : AbstractValidator<QualifiedPartyIdentification1>
{
    public QualifiedPartyIdentification1Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("QualifiedPartyIdentification1.Party must contain at least one element (1..∞).");
    }
}
