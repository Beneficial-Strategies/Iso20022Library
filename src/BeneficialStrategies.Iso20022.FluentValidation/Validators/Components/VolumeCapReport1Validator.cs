...
/// <summary>
/// Validates <see cref="VolumeCapReport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>InstrumentReport</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class VolumeCapReport1Validator : AbstractValidator<VolumeCapReport1>
{
    public VolumeCapReport1Validator()
    {
        RuleFor(x => x.InstrumentReport)
            .NotEmpty()
            .WithMessage("VolumeCapReport1.InstrumentReport must contain at least one element (1..∞).");
    }
}
