...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation32"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalanceInformation32Validator : AbstractValidator<AggregateBalanceInformation32>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalanceInformation32"/>.
    /// </summary>
    public AggregateBalanceInformation32Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation32.PriceDetails must contain at least one element (1..∞).");
    }
}
