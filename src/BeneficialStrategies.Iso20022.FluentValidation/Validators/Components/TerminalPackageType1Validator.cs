...
/// <summary>
/// Validates <see cref="TerminalPackageType1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TerminalPackageType1Validator : AbstractValidator<TerminalPackageType1>
{
    public TerminalPackageType1Validator()
    {
        RuleFor(x => x.Package)
            .NotEmpty()
            .WithMessage("TerminalPackageType1.Package must contain at least one element (1..∞).");
    }
}
