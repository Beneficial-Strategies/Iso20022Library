...
/// <summary>
/// Validates <see cref="TradeData21"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeData21"/>.
    /// </summary>
    public TradeData21Validator()
    {
        RuleFor(x => x.ReconciliationReport)
            .NotEmpty()
            .WithMessage("TradeData21.ReconciliationReport must contain at least one element (1..∞).");
    }
}
