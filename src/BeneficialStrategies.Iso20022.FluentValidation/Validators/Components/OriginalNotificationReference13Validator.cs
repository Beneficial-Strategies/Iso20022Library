...
/// <summary>
/// Validates <see cref="OriginalNotificationReference13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _8gGkYTEsEe6GxLzpkVnWYg
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItemAndStatus8"/>
/// (the type of <see cref="OriginalNotificationReference13.OriginalItemAndStatus"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public class OriginalNotificationReference13Validator : AbstractValidator<OriginalNotificationReference13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference13"/>.
    /// </summary>
    public OriginalNotificationReference13Validator()
    {
        ...
        // OriginalItemAndStatus: OriginalItemAndStatus8, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItemAndStatus)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference13.OriginalItemAndStatus must contain at least one element (1..∞).");
