...
/// <summary>
/// Validates <see cref="RecordTechnicalData1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ExchangeReason</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class RecordTechnicalData1Validator : AbstractValidator<RecordTechnicalData1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RecordTechnicalData1"/>.
    /// </summary>
    public RecordTechnicalData1Validator()
    {
        RuleFor(x => x.ExchangeReason)
            .NotEmpty()
            .WithMessage("RecordTechnicalData1.ExchangeReason must contain at least one element (1..∞).");
    }
}
