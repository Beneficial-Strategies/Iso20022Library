...
/// <summary>
/// Validates <see cref="IntraPositionDetails17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IntraPositionDetails17Validator : AbstractValidator<IntraPositionDetails17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionDetails17"/>.
    /// </summary>
    public IntraPositionDetails17Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails17.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
