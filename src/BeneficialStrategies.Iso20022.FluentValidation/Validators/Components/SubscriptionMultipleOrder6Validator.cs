...
/// <summary>
/// Validates <see cref="SubscriptionMultipleOrder6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionMultipleOrder6Validator : AbstractValidator<SubscriptionMultipleOrder6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionMultipleOrder6"/>.
    /// </summary>
    public SubscriptionMultipleOrder6Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleOrder6.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
