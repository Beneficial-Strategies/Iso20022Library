...
/// <summary>
/// Validates <see cref="TransferIn9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn9Validator : AbstractValidator<TransferIn9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn9"/>.
    /// </summary>
    public TransferIn9Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn9.TransferDetails must contain at least one element (1..∞).");
    }
}
