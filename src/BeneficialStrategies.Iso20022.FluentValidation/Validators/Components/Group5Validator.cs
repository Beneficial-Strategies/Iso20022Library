...
/// <summary>
/// Validates <see cref="Group5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Group5Validator : AbstractValidator<Group5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Group5"/>.
    /// </summary>
    public Group5Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group5.Party must contain at least one element (1..∞).");
    }
}
