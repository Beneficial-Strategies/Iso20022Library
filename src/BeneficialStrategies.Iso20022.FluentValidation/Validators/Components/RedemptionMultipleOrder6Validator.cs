...
/// <summary>
/// Validates <see cref="RedemptionMultipleOrder6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionMultipleOrder6Validator : AbstractValidator<RedemptionMultipleOrder6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionMultipleOrder6"/>.
    /// </summary>
    public RedemptionMultipleOrder6Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionMultipleOrder6.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
