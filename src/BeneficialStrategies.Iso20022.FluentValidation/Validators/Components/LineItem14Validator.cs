...
/// <summary>
/// Validates <see cref="LineItem14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LineItem14Validator : AbstractValidator<LineItem14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem14"/>.
    /// </summary>
    public LineItem14Validator()
    {
        RuleFor(x => x.LineItemDetails)
            .NotEmpty()
            .WithMessage("LineItem14.LineItemDetails must contain at least one element (1..∞).");
    }
}
