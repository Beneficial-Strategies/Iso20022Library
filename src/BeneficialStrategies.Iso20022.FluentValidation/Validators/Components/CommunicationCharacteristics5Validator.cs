...
/// <summary>
/// Validates <see cref="CommunicationCharacteristics5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CommunicationCharacteristics5Validator : AbstractValidator<CommunicationCharacteristics5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CommunicationCharacteristics5"/>.
    /// </summary>
    public CommunicationCharacteristics5Validator()
    {
        RuleFor(x => x.RemoteParty)
            .NotEmpty()
            .WithMessage("CommunicationCharacteristics5.RemoteParty must contain at least one element (1..∞).");
    }
}
