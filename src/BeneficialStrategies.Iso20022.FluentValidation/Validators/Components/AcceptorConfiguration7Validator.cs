...
/// <summary>
/// Validates <see cref="AcceptorConfiguration7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration7Validator : AbstractValidator<AcceptorConfiguration7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration7"/>.
    /// </summary>
    public AcceptorConfiguration7Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration7.DataSet must contain at least one element (1..∞).");
    }
}
