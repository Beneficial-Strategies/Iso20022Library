...
/// <summary>
/// Validates <see cref="Organisation24"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Organisation24Validator : AbstractValidator<Organisation24>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Organisation24"/>.
    /// </summary>
    public Organisation24Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("Organisation24.PostalAddress must contain at least one element (1..10).");
    }
}
