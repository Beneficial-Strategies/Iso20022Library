...
/// <summary>
/// Validates <see cref="ManagementPlanContent2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ManagementPlanContent2Validator : AbstractValidator<ManagementPlanContent2>
{
    public ManagementPlanContent2Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent2.Action must contain at least one element (1..∞).");
    }
}
