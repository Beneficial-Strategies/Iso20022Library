...
/// <summary>
/// Validates <see cref="DocumentNumber18"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class DocumentNumber18Validator : AbstractValidator<DocumentNumber18>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DocumentNumber18"/>.
    /// </summary>
    public DocumentNumber18Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber18.References must contain at least one element (1..∞).");
    }
}
