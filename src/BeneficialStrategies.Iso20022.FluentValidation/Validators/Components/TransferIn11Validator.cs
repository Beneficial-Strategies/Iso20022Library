...
/// <summary>
/// Validates <see cref="TransferIn11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn11Validator : AbstractValidator<TransferIn11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn11"/>.
    /// </summary>
    public TransferIn11Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn11.TransferDetails must contain at least one element (1..∞).");
    }
}
