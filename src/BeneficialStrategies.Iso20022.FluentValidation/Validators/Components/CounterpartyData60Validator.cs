...
/// <summary>
/// Validates <see cref="CounterpartyData60"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CounterpartyData</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..2</description></item>
/// </list>
/// </remarks>
public class CounterpartyData60Validator : AbstractValidator<CounterpartyData60>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CounterpartyData60"/>.
    /// </summary>
    public CounterpartyData60Validator()
    {
        RuleFor(x => x.CounterpartyData)
            .NotEmpty()
            .WithMessage("CounterpartyData60.CounterpartyData must contain at least one element (1..2).");
    }
}
