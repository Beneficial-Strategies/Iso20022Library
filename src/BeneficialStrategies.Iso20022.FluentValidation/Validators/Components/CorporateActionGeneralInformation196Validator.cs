...
/// <summary>
/// Validates <see cref="CorporateActionGeneralInformation196"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CorporateActionGeneralInformation196Validator : AbstractValidator<CorporateActionGeneralInformation196>
{
    public CorporateActionGeneralInformation196Validator()
    {
        RuleFor(x => x.UnderlyingSecurity)
            .NotEmpty()
            .WithMessage("CorporateActionGeneralInformation196.UnderlyingSecurity must contain at least one element (1..∞).");
    }
}
