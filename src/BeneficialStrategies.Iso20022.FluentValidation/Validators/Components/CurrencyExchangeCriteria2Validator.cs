...
/// </list>
/// </remarks>
public class CurrencyExchangeCriteria2Validator : AbstractValidator<CurrencyExchangeCriteria2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CurrencyExchangeCriteria2"/>.
    /// </summary>
