...
/// <summary>
/// Validates <see cref="TransferIn5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn5Validator : AbstractValidator<TransferIn5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn5"/>.
    /// </summary>
    public TransferIn5Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn5.TransferDetails must contain at least one element (1..∞).");
    }
}
