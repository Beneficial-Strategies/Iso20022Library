...
/// <summary>
/// Validates <see cref="CryptographicKey1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey1Validator : AbstractValidator<CryptographicKey1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey1"/>.
    /// </summary>
    public CryptographicKey1Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey1.Function must contain at least one element (1..∞).");
    }
}
