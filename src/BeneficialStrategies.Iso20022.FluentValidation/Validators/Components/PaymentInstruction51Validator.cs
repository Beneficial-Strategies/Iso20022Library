...
/// </list>
/// </remarks>
public sealed class PaymentInstruction51Validator : AbstractValidator<PaymentInstruction51>
{
    public PaymentInstruction51Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction51.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
