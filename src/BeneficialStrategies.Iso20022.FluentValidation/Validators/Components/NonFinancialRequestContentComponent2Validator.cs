...
/// <summary>
/// Validates <see cref="NonFinancialRequestContentComponent2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NonFinancialRequestContentComponent2"/>.
    /// </summary>
    public NonFinancialRequestContentComponent2Validator()
    {
        RuleFor(x => x.NonFinancialRequestType)
            .NotEmpty()
            .WithMessage("NonFinancialRequestContentComponent2.NonFinancialRequestType must contain at least one element (1..∞).");
    }
}
