...
/// <summary>
/// Validates <see cref="Group4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class Group4Validator : AbstractValidator<Group4>
{
    public Group4Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group4.Party must contain at least one element (1..∞).");
    }
}
