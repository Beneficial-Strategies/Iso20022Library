...
/// <summary>
/// Validates <see cref="RequestType1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Type</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class RequestType1Validator : AbstractValidator<RequestType1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequestType1"/>.
    /// </summary>
    public RequestType1Validator()
    {
        RuleFor(x => x.Type)
            .NotEmpty()
            .WithMessage("RequestType1.Type must contain at least one element (1..∞).");
    }
}
