...
/// <summary>
/// Validates <see cref="AccountNotification4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _Gr9k4BGeEd-Obe88IjNoEg
...
public class AccountNotification4Validator : AbstractValidator<AccountNotification4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountNotification4"/>.
    /// </summary>
    public AccountNotification4Validator()
    {
        ...
        // Item: NotificationItem3, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification4.Item must contain at least one element (1..∞).");

        // Account, RelatedAccount: CashAccount16 (0..1) — no validator exists yet for
        // CashAccount16; nested fields unvalidated.
