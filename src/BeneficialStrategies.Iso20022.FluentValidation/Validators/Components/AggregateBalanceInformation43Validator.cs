...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation43"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AggregateBalanceInformation43Validator : AbstractValidator<AggregateBalanceInformation43>
{
    public AggregateBalanceInformation43Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation43.PriceDetails must contain at least one element (1..∞).");
    }
}
