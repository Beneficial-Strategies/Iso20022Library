...
/// <summary>
/// Validates <see cref="TransportDetails4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TransportDetails4Validator : AbstractValidator<TransportDetails4>
{
    public TransportDetails4Validator()
    {
        RuleFor(x => x.TransportDocumentReference)
            .NotEmpty()
            .WithMessage("TransportDetails4.TransportDocumentReference must contain at least one element (1..∞).");

        RuleFor(x => x.TransportedGoods)
            .NotEmpty()
            .WithMessage("TransportDetails4.TransportedGoods must contain at least one element (1..∞).");
    }
}
