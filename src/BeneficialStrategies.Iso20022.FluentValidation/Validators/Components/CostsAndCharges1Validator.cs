...
/// <summary>
/// Validates <see cref="CostsAndCharges1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CostsAndCharges1Validator : AbstractValidator<CostsAndCharges1>
{
    public CostsAndCharges1Validator()
    {
        RuleFor(x => x.IndividualCostOrCharge)
            .NotEmpty()
            .WithMessage("CostsAndCharges1.IndividualCostOrCharge must contain at least one element (1..∞).");
    }
}
