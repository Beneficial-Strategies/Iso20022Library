...
/// <summary>
/// Validates <see cref="Clearing6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Clearing6Validator : AbstractValidator<Clearing6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Clearing6"/>.
    /// </summary>
    public Clearing6Validator()
    {
        RuleFor(x => x.ClearingMember)
            .NotEmpty()
            .WithMessage("Clearing6.ClearingMember must contain at least one element (1..∞).");
    }
}
