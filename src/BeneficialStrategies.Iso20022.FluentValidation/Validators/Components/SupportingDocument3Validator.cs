...
/// <summary>
/// Validates <see cref="SupportingDocument3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Entry</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class SupportingDocument3Validator : AbstractValidator<SupportingDocument3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SupportingDocument3"/>.
    /// </summary>
    public SupportingDocument3Validator()
    {
        RuleFor(x => x.Entry)
            .NotEmpty()
            .WithMessage("SupportingDocument3.Entry must contain at least one element (1..∞).");
    }
}
