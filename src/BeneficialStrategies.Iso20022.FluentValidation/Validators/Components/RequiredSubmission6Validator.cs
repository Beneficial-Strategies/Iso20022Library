...
/// <summary>
/// Validates <see cref="RequiredSubmission6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RequiredSubmission6Validator : AbstractValidator<RequiredSubmission6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequiredSubmission6"/>.
    /// </summary>
    public RequiredSubmission6Validator()
    {
        RuleFor(x => x.Submitter)
            .NotEmpty()
            .WithMessage("RequiredSubmission6.Submitter must contain at least one element (1..∞).");
    }
}
