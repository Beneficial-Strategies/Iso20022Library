...
/// <summary>
/// Validates <see cref="PaymentInstruction23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction23Validator : AbstractValidator<PaymentInstruction23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction23"/>.
    /// </summary>
    public PaymentInstruction23Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction23.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
