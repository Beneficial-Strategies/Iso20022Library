...
/// <summary>
/// Validates <see cref="SecuritiesReferenceDataReport6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SecuritiesReferenceDataReport6"/>.
    /// </summary>
    public SecuritiesReferenceDataReport6Validator()
    {
        RuleFor(x => x.TradingVenueRelatedAttributes)
            .NotEmpty()
            .WithMessage("SecuritiesReferenceDataReport6.TradingVenueRelatedAttributes must contain at least one element (1..∞).");
    }
}
