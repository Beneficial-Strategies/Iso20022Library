...
/// <summary>
/// Validates <see cref="NonClearingReason2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NonClearingReason2"/>.
    /// </summary>
    public NonClearingReason2Validator()
    {
        RuleFor(x => x.ClearingExemptionException)
            .NotEmpty()
            .WithMessage("NonClearingReason2.ClearingExemptionException must contain at least one element (1..∞).");
    }
}
