...
/// <summary>
/// Validates <see cref="OriginalNotificationReference12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _fjhiC9cZEeqRFcf2R4bPBw
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItem7"/>
/// (the type of <see cref="OriginalNotificationReference12.OriginalItem"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public class OriginalNotificationReference12Validator : AbstractValidator<OriginalNotificationReference12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference12"/>.
    /// </summary>
    public OriginalNotificationReference12Validator()
    {
        ...
        // OriginalItem: OriginalItem7, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItem)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference12.OriginalItem must contain at least one element (1..∞).");
