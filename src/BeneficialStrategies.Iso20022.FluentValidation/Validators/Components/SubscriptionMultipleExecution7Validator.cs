...
/// <summary>
/// Validates <see cref="SubscriptionMultipleExecution7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SubscriptionMultipleExecution7Validator : AbstractValidator<SubscriptionMultipleExecution7>
{
    public SubscriptionMultipleExecution7Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleExecution7.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
