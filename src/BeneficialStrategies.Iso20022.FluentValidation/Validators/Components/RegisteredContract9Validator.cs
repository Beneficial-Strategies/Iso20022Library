...
/// <summary>
/// Validates <see cref="RegisteredContract9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class RegisteredContract9Validator : AbstractValidator<RegisteredContract9>
{
    public RegisteredContract9Validator()
    {
        RuleFor(x => x.RegisteredContractAmendment)
            .NotEmpty()
            .WithMessage("RegisteredContract9.RegisteredContractAmendment must contain at least one element (1..∞).");
    }
}
