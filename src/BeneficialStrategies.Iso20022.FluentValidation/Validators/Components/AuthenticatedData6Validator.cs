...
/// <summary>
/// Validates <see cref="AuthenticatedData6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData6Validator : AbstractValidator<AuthenticatedData6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData6"/>.
    /// </summary>
    public AuthenticatedData6Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData6.Recipient must contain at least one element (1..∞).");
    }
}
