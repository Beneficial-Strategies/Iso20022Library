...
/// <summary>
/// Validates <see cref="ChargesPerTransactionRecord3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _4FcvQTEyEe6g-ffJsqGiSA
...
/// </remarks>
public sealed class ChargesPerTransactionRecord3Validator : AbstractValidator<ChargesPerTransactionRecord3>
{
    public ChargesPerTransactionRecord3Validator()
    {
        ...
        RuleFor(x => x.ChargesBreakdown)
            .NotEmpty()
            .WithMessage("ChargesPerTransactionRecord3.ChargesBreakdown must contain at least one element (1..*).");
    }
}
