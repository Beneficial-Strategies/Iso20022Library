...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalanceInformation8Validator : AbstractValidator<AggregateBalanceInformation8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalanceInformation8"/>.
    /// </summary>
    public AggregateBalanceInformation8Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation8.PriceDetails must contain at least one element (1..∞).");
    }
}
