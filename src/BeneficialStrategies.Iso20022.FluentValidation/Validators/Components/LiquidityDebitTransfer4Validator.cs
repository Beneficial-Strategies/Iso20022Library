...
/// <summary>
/// Validates <see cref="LiquidityDebitTransfer4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _3oUHUTEyEe6g-ffJsqGiSA
/// Spec source: queried via ISO 20022 MCP server (2026-08-20).
///
/// Defines the characteristics of the liquidity debit transfer.
/// <list type="table">
...
/// type.
/// </remarks>
public class LiquidityDebitTransfer4Validator : AbstractValidator<LiquidityDebitTransfer4>
{
    /// <summary>
    ...
    /// </param>
    public LiquidityDebitTransfer4Validator(
