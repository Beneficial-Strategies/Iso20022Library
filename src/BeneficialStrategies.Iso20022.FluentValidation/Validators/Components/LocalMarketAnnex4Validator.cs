...
/// <summary>
/// Validates <see cref="LocalMarketAnnex4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LocalMarketAnnex4Validator : AbstractValidator<LocalMarketAnnex4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LocalMarketAnnex4"/>.
    /// </summary>
    public LocalMarketAnnex4Validator()
    {
        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex4.Country must contain at least one element (1..∞).");
    }
}
