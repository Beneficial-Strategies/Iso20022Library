...
/// <summary>
/// Validates <see cref="SearchCriteria1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>SearchOr</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class SearchCriteria1Validator : AbstractValidator<SearchCriteria1>
{
    public SearchCriteria1Validator()
    {
        RuleFor(x => x.SearchOr)
            .NotEmpty()
            .WithMessage("SearchCriteria1.SearchOr must contain at least one element (1..∞).");
    }
}
