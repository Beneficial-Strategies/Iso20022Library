...
/// <summary>
/// Validates <see cref="PartyReferenceDataChange3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PartyReferenceDataChange3Validator : AbstractValidator<PartyReferenceDataChange3>
{
    public PartyReferenceDataChange3Validator()
    {
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("PartyReferenceDataChange3.Record must contain at least one element (1..∞).");
    }
}
