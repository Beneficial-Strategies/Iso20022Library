...
/// <summary>
/// Validates <see cref="ActivityReportItems2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ActivityReportItems2Validator : AbstractValidator<ActivityReportItems2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ActivityReportItems2"/>.
    /// </summary>
    public ActivityReportItems2Validator()
    {
        RuleFor(x => x.ReportedItem)
            .NotEmpty()
            .WithMessage("ActivityReportItems2.ReportedItem must contain at least one element (1..∞).");
    }
}
