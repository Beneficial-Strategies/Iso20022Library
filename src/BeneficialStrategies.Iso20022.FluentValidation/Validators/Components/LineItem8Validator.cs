...
/// <summary>
/// Validates <see cref="LineItem8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem8"/>.
    /// </summary>
    public LineItem8Validator()
    {
        RuleFor(x => x.LineItemDetails)
            .NotEmpty()
            .WithMessage("LineItem8.LineItemDetails must contain at least one element (1..∞).");
    }
}
