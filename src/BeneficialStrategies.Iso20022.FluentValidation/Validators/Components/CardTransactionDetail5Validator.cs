...
/// </list>
/// </remarks>
public class CardTransactionDetail5Validator : AbstractValidator<CardTransactionDetail5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardTransactionDetail5"/>.
    /// </summary>
