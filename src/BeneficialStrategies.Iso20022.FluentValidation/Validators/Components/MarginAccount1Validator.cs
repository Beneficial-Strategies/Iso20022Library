...
/// <summary>
/// Validates <see cref="MarginAccount1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>PositionAccount</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class MarginAccount1Validator : AbstractValidator<MarginAccount1>
{
    public MarginAccount1Validator()
    {
        RuleFor(x => x.PositionAccount)
            .NotEmpty()
            .WithMessage("MarginAccount1.PositionAccount must contain at least one element (1..∞).");
    }
}
