...
/// <summary>
/// Validates <see cref="SettlementAgent1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SettlementAgent1Validator : AbstractValidator<SettlementAgent1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SettlementAgent1"/>.
    /// </summary>
    public SettlementAgent1Validator()
    {
        RuleFor(x => x.Account)
            .NotEmpty()
            .WithMessage("SettlementAgent1.Account must contain at least one element (1..∞).");
    }
}
