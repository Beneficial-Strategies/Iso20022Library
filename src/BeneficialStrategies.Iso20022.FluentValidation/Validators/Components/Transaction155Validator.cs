...
/// <summary>
/// Validates <see cref="Transaction155"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Transaction155Validator : AbstractValidator<Transaction155>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transaction155"/>.
    /// </summary>
    public Transaction155Validator()
    {
        RuleFor(x => x.ErrorDetail)
            .NotEmpty()
            .WithMessage("Transaction155.ErrorDetail must contain at least one element (1..∞).");
    }
}
