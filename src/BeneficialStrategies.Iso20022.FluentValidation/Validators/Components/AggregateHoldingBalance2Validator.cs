...
/// <summary>
/// Validates <see cref="AggregateHoldingBalance2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateHoldingBalance2"/>.
    /// </summary>
    public AggregateHoldingBalance2Validator()
    {
        RuleFor(x => x.BalanceForFinancialInstrument)
            .NotEmpty()
            .WithMessage("AggregateHoldingBalance2.BalanceForFinancialInstrument must contain at least one element (1..∞).");
    }
}
