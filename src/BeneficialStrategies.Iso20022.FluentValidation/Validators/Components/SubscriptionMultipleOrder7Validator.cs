...
/// <summary>
/// Validates <see cref="SubscriptionMultipleOrder7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SubscriptionMultipleOrder7Validator : AbstractValidator<SubscriptionMultipleOrder7>
{
    public SubscriptionMultipleOrder7Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleOrder7.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
