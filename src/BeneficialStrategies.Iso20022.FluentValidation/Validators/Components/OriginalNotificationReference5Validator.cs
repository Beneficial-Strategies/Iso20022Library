...
/// <summary>
/// Validates <see cref="OriginalNotificationReference5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _ZYMPPx77EeSxevWRRWxNAg
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItemAndStatus4"/>
/// (the type of <see cref="OriginalNotificationReference5.OriginalItemAndStatus"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public sealed class OriginalNotificationReference5Validator : AbstractValidator<OriginalNotificationReference5>
{
    public OriginalNotificationReference5Validator()
    {
        ...
        // OriginalItemAndStatus: OriginalItemAndStatus4, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItemAndStatus)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference5.OriginalItemAndStatus must contain at least one element (1..∞).");
