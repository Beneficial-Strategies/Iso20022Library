...
/// <summary>
/// Validates <see cref="RecordTechnicalData5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class RecordTechnicalData5Validator : AbstractValidator<RecordTechnicalData5>
{
    public RecordTechnicalData5Validator()
    {
        RuleFor(x => x.ExchangeReason)
            .NotEmpty()
            .WithMessage("RecordTechnicalData5.ExchangeReason must contain at least one element (1..∞).");
    }
}
