...
/// <summary>
/// Validates <see cref="ATMTransaction44"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ATMTransaction44Validator : AbstractValidator<ATMTransaction44>
{
    public ATMTransaction44Validator()
    {
        RuleFor(x => x.TotalAuthorisedAmount)
            .NotEmpty()
            .WithMessage("ATMTransaction44.TotalAuthorisedAmount must contain at least one element (1..∞).");
    }
}
