...
/// <summary>
/// Validates <see cref="ManagementPlanContent5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent5Validator : AbstractValidator<ManagementPlanContent5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent5"/>.
    /// </summary>
    public ManagementPlanContent5Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent5.Action must contain at least one element (1..∞).");
    }
}
