...
/// <summary>
/// Validates <see cref="BusinessPayload1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>BusinessContent</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class BusinessPayload1Validator : AbstractValidator<BusinessPayload1>
{
    public BusinessPayload1Validator()
    {
        RuleFor(x => x.BusinessContent)
            .NotEmpty()
            .WithMessage("BusinessPayload1.BusinessContent must contain at least one element (1..∞).");
    }
}
