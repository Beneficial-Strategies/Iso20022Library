...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace29"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalancePerSafekeepingPlace29Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace29>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace29"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace29Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace29.PriceDetails must contain at least one element (1..∞).");
    }
}
