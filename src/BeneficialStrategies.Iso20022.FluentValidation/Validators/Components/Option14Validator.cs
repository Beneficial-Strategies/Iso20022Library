...
/// <summary>
/// Validates <see cref="Option14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ExpirationStyle</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..4</description></item>
/// </list>
/// </remarks>
public class Option14Validator : AbstractValidator<Option14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Option14"/>.
    /// </summary>
    public Option14Validator()
    {
        RuleFor(x => x.ExpirationStyle)
            .NotEmpty()
            .WithMessage("Option14.ExpirationStyle must contain at least one element (1..4).");
    }
}
