...
/// <summary>
/// Validates <see cref="MultilateralSettlementRequest2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class MultilateralSettlementRequest2Validator : AbstractValidator<MultilateralSettlementRequest2>
{
    public MultilateralSettlementRequest2Validator()
    {
        RuleFor(x => x.MovementRecord)
            .NotEmpty()
            .WithMessage("MultilateralSettlementRequest2.MovementRecord must contain at least one element (2..∞).");
    }
}
