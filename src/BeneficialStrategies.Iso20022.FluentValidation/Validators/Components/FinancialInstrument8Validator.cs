...
/// <summary>
/// Validates <see cref="FinancialInstrument8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrument8Validator : AbstractValidator<FinancialInstrument8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrument8"/>.
    /// </summary>
    public FinancialInstrument8Validator()
    {
        RuleFor(x => x.Identification)
            .NotEmpty()
            .WithMessage("FinancialInstrument8.Identification must contain at least one element (1..10).");
    }
}
