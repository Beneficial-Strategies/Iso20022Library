...
/// <summary>
/// Validates <see cref="TransportDetails2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransportDetails2"/>.
    /// </summary>
    public TransportDetails2Validator()
    {
        RuleFor(x => x.TransportDocumentReference)
            .NotEmpty()
            .WithMessage("TransportDetails2.TransportDocumentReference must contain at least one element (1..∞).");

        RuleFor(x => x.TransportedGoods)
            .NotEmpty()
            .WithMessage("TransportDetails2.TransportedGoods must contain at least one element (1..∞).");
    }
}
