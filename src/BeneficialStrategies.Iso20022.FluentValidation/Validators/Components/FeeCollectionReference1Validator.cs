...
/// <summary>
/// Validates <see cref="FeeCollectionReference1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>FeeCollectionIdentification</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class FeeCollectionReference1Validator : AbstractValidator<FeeCollectionReference1>
{
    public FeeCollectionReference1Validator()
    {
        RuleFor(x => x.FeeCollectionIdentification)
            .NotEmpty()
            .WithMessage("FeeCollectionReference1.FeeCollectionIdentification must contain at least one element (1..∞).");
    }
}
