...
/// <summary>
/// Validates <see cref="ClearedProduct2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ClearedProduct2Validator : AbstractValidator<ClearedProduct2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ClearedProduct2"/>.
    /// </summary>
    public ClearedProduct2Validator()
    {
        RuleFor(x => x.TradingVenue)
            .NotEmpty()
            .WithMessage("ClearedProduct2.TradingVenue must contain at least one element (1..∞).");
    }
}
