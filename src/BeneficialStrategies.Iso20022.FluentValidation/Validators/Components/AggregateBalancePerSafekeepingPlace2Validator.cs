...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>HoldingValue</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
public class AggregateBalancePerSafekeepingPlace2Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace2"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace2Validator()
    {
        RuleFor(x => x.HoldingValue)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace2.HoldingValue must contain at least one element (1..∞).");

        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace2.PriceDetails must contain at least one element (1..∞).");
    }
}
