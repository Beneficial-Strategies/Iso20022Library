...
/// <summary>
/// Validates <see cref="OperationMandate6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class OperationMandate6Validator : AbstractValidator<OperationMandate6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OperationMandate6"/>.
    /// </summary>
    public OperationMandate6Validator()
    {
        RuleFor(x => x.ApplicableChannel)
            .NotEmpty()
            .WithMessage("OperationMandate6.ApplicableChannel must contain at least one element (1..∞).");

        RuleFor(x => x.BankOperation)
            .NotEmpty()
            .WithMessage("OperationMandate6.BankOperation must contain at least one element (1..∞).");
    }
}
