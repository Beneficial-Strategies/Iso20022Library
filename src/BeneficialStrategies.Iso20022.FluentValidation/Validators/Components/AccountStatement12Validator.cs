...
/// <summary>
/// Validates <see cref="AccountStatement12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _mjERsQ5rEe2xs7BqO31w6w
...
/// </remarks>
public class AccountStatement12Validator : AbstractValidator<AccountStatement12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountStatement12"/>.
    /// </summary>
    public AccountStatement12Validator()
    {
        ...
        // fields unvalidated.
        // Interest (AccountInterest4) and Entry (ReportEntry13): 0..∞ collections — any
        ...
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountStatement12.Balance must contain at least one element (1..*).");
    }
}
