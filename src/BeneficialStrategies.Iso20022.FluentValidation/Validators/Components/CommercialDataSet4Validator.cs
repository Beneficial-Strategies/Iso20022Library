...
/// <summary>
/// Validates <see cref="CommercialDataSet4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CommercialDataSet4"/>.
    /// </summary>
    public CommercialDataSet4Validator()
    {
        RuleFor(x => x.Goods)
            .NotEmpty()
            .WithMessage("CommercialDataSet4.Goods must contain at least one element (1..∞).");

        RuleFor(x => x.PaymentTerms)
            .NotEmpty()
            .WithMessage("CommercialDataSet4.PaymentTerms must contain at least one element (1..∞).");
    }
}
