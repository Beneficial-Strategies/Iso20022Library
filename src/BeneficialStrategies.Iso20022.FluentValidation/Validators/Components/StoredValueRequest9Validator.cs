...
/// <summary>
/// Validates <see cref="StoredValueRequest9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest9Validator : AbstractValidator<StoredValueRequest9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest9"/>.
    /// </summary>
    public StoredValueRequest9Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest9.Data must contain at least one element (1..∞).");
    }
}
