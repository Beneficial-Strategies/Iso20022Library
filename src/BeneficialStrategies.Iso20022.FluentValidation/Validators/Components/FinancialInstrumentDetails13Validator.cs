...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails13Validator : AbstractValidator<FinancialInstrumentDetails13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails13"/>.
    /// </summary>
    public FinancialInstrumentDetails13Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails13.Transaction must contain at least one element (1..∞).");
    }
}
