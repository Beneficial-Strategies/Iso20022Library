...
/// <summary>
/// Validates <see cref="ATMCustomer3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ATMCustomer3Validator : AbstractValidator<ATMCustomer3>
{
    public ATMCustomer3Validator()
    {
        RuleFor(x => x.AuthenticationResult)
            .NotEmpty()
            .WithMessage("ATMCustomer3.AuthenticationResult must contain at least one element (1..∞).");
    }
}
