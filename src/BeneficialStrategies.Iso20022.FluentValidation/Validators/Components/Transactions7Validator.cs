...
/// <summary>
/// Validates <see cref="Transactions7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Transactions7Validator : AbstractValidator<Transactions7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transactions7"/>.
    /// </summary>
    public Transactions7Validator()
    {
        RuleFor(x => x.TransactionReport)
            .NotEmpty()
            .WithMessage("Transactions7.TransactionReport must contain at least one element (1..∞).");
    }
}
