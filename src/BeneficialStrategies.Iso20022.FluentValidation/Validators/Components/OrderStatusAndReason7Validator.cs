...
/// <summary>
/// Validates <see cref="OrderStatusAndReason7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class OrderStatusAndReason7Validator : AbstractValidator<OrderStatusAndReason7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OrderStatusAndReason7"/>.
    /// </summary>
    public OrderStatusAndReason7Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("OrderStatusAndReason7.Rejected must contain at least one element (1..10).");
    }
}
