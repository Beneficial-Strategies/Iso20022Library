...
/// <summary>
/// Validates <see cref="PartyAuditTrail1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PartyAuditTrail1Validator : AbstractValidator<PartyAuditTrail1>
{
    public PartyAuditTrail1Validator()
    {
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("PartyAuditTrail1.Record must contain at least one element (1..∞).");
    }
}
