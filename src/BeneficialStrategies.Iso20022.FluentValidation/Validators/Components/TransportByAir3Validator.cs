...
/// <summary>
/// Validates <see cref="TransportByAir3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>DestinationAirport</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class TransportByAir3Validator : AbstractValidator<TransportByAir3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransportByAir3"/>.
    /// </summary>
    public TransportByAir3Validator()
    {
        RuleFor(x => x.DestinationAirport)
            .NotEmpty()
            .WithMessage("TransportByAir3.DestinationAirport must contain at least one element (1..∞).");
    }
}
