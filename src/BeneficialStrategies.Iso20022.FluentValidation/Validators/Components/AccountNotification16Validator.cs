...
/// <summary>
/// Validates <see cref="AccountNotification16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _QULXAW49EeiU9cctagi5ow
...
/// </list>
/// </remarks>
public sealed class AccountNotification16Validator : AbstractValidator<AccountNotification16>
{
    public AccountNotification16Validator()
    {
        ...
        // Item: NotificationItem7, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification16.Item must contain at least one element (1..∞).");

        // Account, RelatedAccount: CashAccount38 (0..1) — no validator exists yet for
        // CashAccount38; nested fields unvalidated.
