...
/// <summary>
/// Validates <see cref="BusinessDay6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class BusinessDay6Validator : AbstractValidator<BusinessDay6>
{
    public BusinessDay6Validator()
    {
        RuleFor(x => x.SystemIdentification)
            .NotEmpty()
            .WithMessage("BusinessDay6.SystemIdentification must contain at least one element (1..∞).");
    }
}
