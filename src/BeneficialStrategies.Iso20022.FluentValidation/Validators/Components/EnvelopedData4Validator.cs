...
/// <summary>
/// Validates <see cref="EnvelopedData4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class EnvelopedData4Validator : AbstractValidator<EnvelopedData4>
{
    public EnvelopedData4Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData4.Recipient must contain at least one element (1..∞).");
    }
}
