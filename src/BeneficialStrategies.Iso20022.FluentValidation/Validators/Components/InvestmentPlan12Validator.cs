...
/// <summary>
/// Validates <see cref="InvestmentPlan12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan12Validator : AbstractValidator<InvestmentPlan12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan12"/>.
    /// </summary>
    public InvestmentPlan12Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan12.SecurityDetails must contain at least one element (1..50).");
    }
}
