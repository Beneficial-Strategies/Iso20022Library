...
/// <summary>
/// Validates <see cref="TotalTaxes2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TotalTaxes2"/>.
    /// </summary>
    public TotalTaxes2Validator()
    {
        RuleFor(x => x.TaxDetails)
            .NotEmpty()
            .WithMessage("TotalTaxes2.TaxDetails must contain at least one element (1..∞).");
    }
}
