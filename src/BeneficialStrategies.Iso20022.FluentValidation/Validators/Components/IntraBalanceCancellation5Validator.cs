...
/// <summary>
/// Validates <see cref="IntraBalanceCancellation5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraBalanceCancellation5"/>.
    /// </summary>
    public IntraBalanceCancellation5Validator()
    {
        RuleFor(x => x.Cancellation)
            .NotEmpty()
            .WithMessage("IntraBalanceCancellation5.Cancellation must contain at least one element (1..∞).");
    }
}
