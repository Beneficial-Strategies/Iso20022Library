...
/// <summary>
/// Validates <see cref="RegulatoryStipulations1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Stipulations</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class RegulatoryStipulations1Validator : AbstractValidator<RegulatoryStipulations1>
{
    public RegulatoryStipulations1Validator()
    {
        RuleFor(x => x.Stipulations)
            .NotEmpty()
            .WithMessage("RegulatoryStipulations1.Stipulations must contain at least one element (1..∞).");
    }
}
