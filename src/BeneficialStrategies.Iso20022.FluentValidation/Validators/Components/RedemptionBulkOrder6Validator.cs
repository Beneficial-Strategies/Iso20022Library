...
/// <summary>
/// Validates <see cref="RedemptionBulkOrder6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class RedemptionBulkOrder6Validator : AbstractValidator<RedemptionBulkOrder6>
{
    public RedemptionBulkOrder6Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkOrder6.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
