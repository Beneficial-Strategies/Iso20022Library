...
/// <summary>
/// Validates <see cref="ErrorAction5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ActionResult</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class ErrorAction5Validator : AbstractValidator<ErrorAction5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ErrorAction5"/>.
    /// </summary>
    public ErrorAction5Validator()
    {
        RuleFor(x => x.ActionResult)
            .NotEmpty()
            .WithMessage("ErrorAction5.ActionResult must contain at least one element (1..∞).");
    }
}
