...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation26"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalanceInformation26Validator : AbstractValidator<AggregateBalanceInformation26>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalanceInformation26"/>.
    /// </summary>
    public AggregateBalanceInformation26Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation26.PriceDetails must contain at least one element (1..∞).");
    }
}
