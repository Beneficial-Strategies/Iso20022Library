...
/// <summary>
/// Validates <see cref="CardPaymentDataSet43"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet43Validator : AbstractValidator<CardPaymentDataSet43>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet43"/>.
    /// </summary>
    public CardPaymentDataSet43Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet43.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet43.TransactionTotals must contain at least one element (1..∞).");
    }
}
