...
/// <summary>
/// Validates <see cref="EnvelopedData7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData7Validator : AbstractValidator<EnvelopedData7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData7"/>.
    /// </summary>
    public EnvelopedData7Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData7.Recipient must contain at least one element (1..∞).");
    }
}
