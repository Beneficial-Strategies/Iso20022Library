...
/// <summary>
/// Validates <see cref="PaymentInstruction15"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction15Validator : AbstractValidator<PaymentInstruction15>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction15"/>.
    /// </summary>
    public PaymentInstruction15Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction15.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
