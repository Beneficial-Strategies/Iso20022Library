...
/// <summary>
/// Validates <see cref="CustomBasket1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Constituents</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class CustomBasket1Validator : AbstractValidator<CustomBasket1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CustomBasket1"/>.
    /// </summary>
    public CustomBasket1Validator()
    {
        RuleFor(x => x.Constituents)
            .NotEmpty()
            .WithMessage("CustomBasket1.Constituents must contain at least one element (1..∞).");
    }
}
