...
/// <summary>
/// Validates <see cref="BusinessDay8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="BusinessDay8"/>.
    /// </summary>
    public BusinessDay8Validator()
    {
        RuleFor(x => x.SystemIdentification)
            .NotEmpty()
            .WithMessage("BusinessDay8.SystemIdentification must contain at least one element (1..∞).");
    }
}
