...
/// <summary>
/// Validates <see cref="CounterpartyData76"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CounterpartyData76Validator : AbstractValidator<CounterpartyData76>
{
    public CounterpartyData76Validator()
    {
        RuleFor(x => x.CounterpartyData)
            .NotEmpty()
            .WithMessage("CounterpartyData76.CounterpartyData must contain at least one element (1..2).");
    }
}
