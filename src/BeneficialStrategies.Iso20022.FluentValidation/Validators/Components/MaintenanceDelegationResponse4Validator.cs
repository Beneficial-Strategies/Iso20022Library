...
/// <summary>
/// Validates <see cref="MaintenanceDelegationResponse4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="MaintenanceDelegationResponse4"/>.
    /// </summary>
    public MaintenanceDelegationResponse4Validator()
    {
        RuleFor(x => x.DelegationResponse)
            .NotEmpty()
            .WithMessage("MaintenanceDelegationResponse4.DelegationResponse must contain at least one element (1..∞).");
    }
}
