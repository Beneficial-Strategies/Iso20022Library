...
/// <summary>
/// Validates <see cref="EncryptedContent5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class EncryptedContent5Validator : AbstractValidator<EncryptedContent5>
{
    public EncryptedContent5Validator()
    {
        RuleFor(x => x.EncryptedDataElement)
            .NotEmpty()
            .WithMessage("EncryptedContent5.EncryptedDataElement must contain at least one element (1..∞).");
    }
}
