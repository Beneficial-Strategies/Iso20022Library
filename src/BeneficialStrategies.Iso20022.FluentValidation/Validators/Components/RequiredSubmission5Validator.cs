...
/// <summary>
/// Validates <see cref="RequiredSubmission5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RequiredSubmission5Validator : AbstractValidator<RequiredSubmission5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequiredSubmission5"/>.
    /// </summary>
    public RequiredSubmission5Validator()
    {
        RuleFor(x => x.Submitter)
            .NotEmpty()
            .WithMessage("RequiredSubmission5.Submitter must contain at least one element (1..∞).");
    }
}
