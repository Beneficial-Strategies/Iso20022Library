...
/// <summary>
/// Validates <see cref="TransferOut13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferOut13Validator : AbstractValidator<TransferOut13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut13"/>.
    /// </summary>
    public TransferOut13Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut13.TransferDetails must contain at least one element (1..∞).");
    }
}
