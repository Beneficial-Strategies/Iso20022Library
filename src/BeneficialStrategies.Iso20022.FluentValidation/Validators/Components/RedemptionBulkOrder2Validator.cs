...
/// <summary>
/// Validates <see cref="RedemptionBulkOrder2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionBulkOrder2Validator : AbstractValidator<RedemptionBulkOrder2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionBulkOrder2"/>.
    /// </summary>
    public RedemptionBulkOrder2Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkOrder2.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
