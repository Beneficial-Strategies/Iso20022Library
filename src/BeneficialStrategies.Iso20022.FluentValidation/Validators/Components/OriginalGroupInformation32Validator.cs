...
/// <summary>
/// Validates <see cref="OriginalGroupInformation32"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _7UooETEyEe6g-ffJsqGiSA
...
/// </remarks>
public class OriginalGroupInformation32Validator : AbstractValidator<OriginalGroupInformation32>
{
    /// <summary>
    /// Initializes a new instance using dependency injection: the caller supplies the validators
    /// — e.g. resolved from a DI container — instead of this type constructing its own.
    /// </summary>
    public OriginalGroupInformation32Validator(
