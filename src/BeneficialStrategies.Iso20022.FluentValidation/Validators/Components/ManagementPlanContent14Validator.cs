...
/// <summary>
/// Validates <see cref="ManagementPlanContent14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent14Validator : AbstractValidator<ManagementPlanContent14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent14"/>.
    /// </summary>
    public ManagementPlanContent14Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent14.Action must contain at least one element (1..∞).");
    }
}
