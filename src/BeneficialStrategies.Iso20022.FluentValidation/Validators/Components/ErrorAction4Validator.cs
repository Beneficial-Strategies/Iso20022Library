...
/// <summary>
/// Validates <see cref="ErrorAction4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ErrorAction4Validator : AbstractValidator<ErrorAction4>
{
    public ErrorAction4Validator()
    {
        RuleFor(x => x.ActionResult)
            .NotEmpty()
            .WithMessage("ErrorAction4.ActionResult must contain at least one element (1..∞).");
    }
}
