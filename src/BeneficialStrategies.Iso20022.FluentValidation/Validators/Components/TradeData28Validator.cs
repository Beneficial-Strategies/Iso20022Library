...
/// <summary>
/// Validates <see cref="TradeData28"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TradeData28Validator : AbstractValidator<TradeData28>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeData28"/>.
    /// </summary>
    public TradeData28Validator()
    {
        RuleFor(x => x.ReconciliationReport)
            .NotEmpty()
            .WithMessage("TradeData28.ReconciliationReport must contain at least one element (1..∞).");
    }
}
