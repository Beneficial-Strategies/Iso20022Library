...
/// <summary>
/// Validates <see cref="TMSProtocolParameters2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TMSProtocolParameters2Validator : AbstractValidator<TMSProtocolParameters2>
{
    public TMSProtocolParameters2Validator()
    {
        RuleFor(x => x.MaintenanceService)
            .NotEmpty()
            .WithMessage("TMSProtocolParameters2.MaintenanceService must contain at least one element (1..∞).");
    }
}
