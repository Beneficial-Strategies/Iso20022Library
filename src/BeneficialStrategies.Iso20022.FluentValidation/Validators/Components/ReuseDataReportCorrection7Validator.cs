...
/// <summary>
/// Validates <see cref="ReuseDataReportCorrection7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public sealed class ReuseDataReportCorrection7Validator : AbstractValidator<ReuseDataReportCorrection7>
{
    public ReuseDataReportCorrection7Validator()
    {
        RuleFor(x => x.CollateralComponent)
            .NotEmpty()
            .WithMessage("ReuseDataReportCorrection7.CollateralComponent must contain at least one element (1..∞).");
    }
}
