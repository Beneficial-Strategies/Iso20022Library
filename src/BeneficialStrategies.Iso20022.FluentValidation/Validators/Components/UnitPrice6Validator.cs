...
/// <summary>
/// Validates <see cref="UnitPrice6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class UnitPrice6Validator : AbstractValidator<UnitPrice6>
{
    public UnitPrice6Validator()
    {
        RuleFor(x => x.ValueInInvestmentCurrency)
            .NotEmpty()
            .WithMessage("UnitPrice6.ValueInInvestmentCurrency must contain at least one element (1..∞).");
    }
}
