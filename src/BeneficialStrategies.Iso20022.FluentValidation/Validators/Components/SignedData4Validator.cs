...
/// <summary>
/// Validates <see cref="SignedData4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class SignedData4Validator : AbstractValidator<SignedData4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SignedData4"/>.
    /// </summary>
    public SignedData4Validator()
    {
        RuleFor(x => x.DigestAlgorithm)
            .NotEmpty()
            .WithMessage("SignedData4.DigestAlgorithm must contain at least one element (1..∞).");

        RuleFor(x => x.Signer)
            .NotEmpty()
            .WithMessage("SignedData4.Signer must contain at least one element (1..∞).");
    }
}
