...
/// <summary>
/// Validates <see cref="ManagementPlan2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlan2Validator : AbstractValidator<ManagementPlan2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlan2"/>.
    /// </summary>
    public ManagementPlan2Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("ManagementPlan2.DataSet must contain at least one element (1..∞).");
    }
}
