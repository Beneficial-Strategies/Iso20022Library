...
/// <summary>
/// Validates <see cref="CardPaymentDataSet26"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet26Validator : AbstractValidator<CardPaymentDataSet26>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet26"/>.
    /// </summary>
    public CardPaymentDataSet26Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet26.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet26.TransactionTotals must contain at least one element (1..∞).");
    }
}
