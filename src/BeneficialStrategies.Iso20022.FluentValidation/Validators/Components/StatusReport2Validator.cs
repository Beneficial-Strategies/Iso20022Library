...
/// <summary>
/// Validates <see cref="StatusReport2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StatusReport2Validator : AbstractValidator<StatusReport2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StatusReport2"/>.
    /// </summary>
    public StatusReport2Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("StatusReport2.DataSet must contain at least one element (1..∞).");
    }
}
