...
/// <summary>
/// Validates <see cref="DeviceDisplayRequest6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class DeviceDisplayRequest6Validator : AbstractValidator<DeviceDisplayRequest6>
{
    public DeviceDisplayRequest6Validator()
    {
        RuleFor(x => x.DisplayOutput)
            .NotEmpty()
            .WithMessage("DeviceDisplayRequest6.DisplayOutput must contain at least one element (1..∞).");
    }
}
