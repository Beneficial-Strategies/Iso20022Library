...
/// <summary>
/// Validates <see cref="CashMovement3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CashMovement3Validator : AbstractValidator<CashMovement3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CashMovement3"/>.
    /// </summary>
    public CashMovement3Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("CashMovement3.AccountDetails must contain at least one element (1..2).");
    }
}
