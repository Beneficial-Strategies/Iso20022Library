...
/// <summary>
/// Validates <see cref="PaymentInstruction22"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction22Validator : AbstractValidator<PaymentInstruction22>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction22"/>.
    /// </summary>
    public PaymentInstruction22Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction22.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
