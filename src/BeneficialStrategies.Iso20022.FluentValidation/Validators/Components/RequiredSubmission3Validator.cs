...
/// <summary>
/// Validates <see cref="RequiredSubmission3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RequiredSubmission3"/>.
    /// </summary>
    public RequiredSubmission3Validator()
    {
        RuleFor(x => x.Submitter)
            .NotEmpty()
            .WithMessage("RequiredSubmission3.Submitter must contain at least one element (1..∞).");
    }
}
