...
/// <summary>
/// Validates <see cref="AvailableFinancialResourcesAmount1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AvailableFinancialResourcesAmount1"/>.
    /// </summary>
    public AvailableFinancialResourcesAmount1Validator()
    {
        RuleFor(x => x.CCPSkinInTheGame)
            .NotEmpty()
            .WithMessage("AvailableFinancialResourcesAmount1.CCPSkinInTheGame must contain at least one element (1..∞).");
    }
}
