...
/// <summary>
/// Validates <see cref="InvestmentFundTransactionsByFund3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class InvestmentFundTransactionsByFund3Validator : AbstractValidator<InvestmentFundTransactionsByFund3>
{
    public InvestmentFundTransactionsByFund3Validator()
    {
        RuleFor(x => x.TransactionDetails)
            .NotEmpty()
            .WithMessage("InvestmentFundTransactionsByFund3.TransactionDetails must contain at least one element (1..∞).");
    }
}
