...
/// <summary>
/// Validates <see cref="TransferOut16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferOut16Validator : AbstractValidator<TransferOut16>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut16"/>.
    /// </summary>
    public TransferOut16Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut16.TransferDetails must contain at least one element (1..∞).");
    }
}
