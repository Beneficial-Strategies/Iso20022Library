...
/// <summary>
/// Validates <see cref="ManagementPlanContent9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent9Validator : AbstractValidator<ManagementPlanContent9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent9"/>.
    /// </summary>
    public ManagementPlanContent9Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent9.Action must contain at least one element (1..∞).");
    }
}
