...
/// <summary>
/// Validates <see cref="InvestmentPlan7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan7Validator : AbstractValidator<InvestmentPlan7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan7"/>.
    /// </summary>
    public InvestmentPlan7Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan7.SecurityDetails must contain at least one element (1..50).");
    }
}
