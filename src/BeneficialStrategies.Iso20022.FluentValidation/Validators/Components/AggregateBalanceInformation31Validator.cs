...
/// <summary>
/// Validates <see cref="AggregateBalanceInformation31"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalanceInformation31Validator : AbstractValidator<AggregateBalanceInformation31>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalanceInformation31"/>.
    /// </summary>
    public AggregateBalanceInformation31Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalanceInformation31.PriceDetails must contain at least one element (1..∞).");
    }
}
