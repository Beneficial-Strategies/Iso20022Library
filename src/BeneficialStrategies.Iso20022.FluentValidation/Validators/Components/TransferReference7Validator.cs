...
/// <summary>
/// Validates <see cref="TransferReference7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TransferReferences</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class TransferReference7Validator : AbstractValidator<TransferReference7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferReference7"/>.
    /// </summary>
    public TransferReference7Validator()
    {
        RuleFor(x => x.TransferReferences)
            .NotEmpty()
            .WithMessage("TransferReference7.TransferReferences must contain at least one element (1..∞).");
    }
}
