...
/// <summary>
/// Validates <see cref="AcceptorConfiguration2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration2Validator : AbstractValidator<AcceptorConfiguration2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration2"/>.
    /// </summary>
    public AcceptorConfiguration2Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration2.DataSet must contain at least one element (1..∞).");
    }
}
