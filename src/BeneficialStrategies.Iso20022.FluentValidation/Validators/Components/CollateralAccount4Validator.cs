...
/// <summary>
/// Validates <see cref="CollateralAccount4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CollateralAccount4Validator : AbstractValidator<CollateralAccount4>
{
    public CollateralAccount4Validator()
    {
        RuleFor(x => x.AssetHolding)
            .NotEmpty()
            .WithMessage("CollateralAccount4.AssetHolding must contain at least one element (1..∞).");
    }
}
