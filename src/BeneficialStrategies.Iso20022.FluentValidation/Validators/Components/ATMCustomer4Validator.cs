...
/// <summary>
/// Validates <see cref="ATMCustomer4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ATMCustomer4Validator : AbstractValidator<ATMCustomer4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMCustomer4"/>.
    /// </summary>
    public ATMCustomer4Validator()
    {
        RuleFor(x => x.Authentication)
            .NotEmpty()
            .WithMessage("ATMCustomer4.Authentication must contain at least one element (1..∞).");
    }
}
