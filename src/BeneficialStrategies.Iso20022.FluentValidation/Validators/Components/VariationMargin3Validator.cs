...
/// <summary>
/// Validates <see cref="VariationMargin3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class VariationMargin3Validator : AbstractValidator<VariationMargin3>
{
    public VariationMargin3Validator()
    {
        RuleFor(x => x.TotalVariationMargin)
            .NotEmpty()
            .WithMessage("VariationMargin3.TotalVariationMargin must contain at least one element (1..∞).");
    }
}
