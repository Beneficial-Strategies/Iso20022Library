...
/// <summary>
/// Validates <see cref="TrackerStatusAndTransaction19"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TrackerStatusAndTransaction19Validator : AbstractValidator<TrackerStatusAndTransaction19>
{
    public TrackerStatusAndTransaction19Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("TrackerStatusAndTransaction19.Transaction must contain at least one element (1..∞).");
    }
}
