...
/// <summary>
/// Validates <see cref="PriceReport2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PriceReport2Validator : AbstractValidator<PriceReport2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PriceReport2"/>.
    /// </summary>
    public PriceReport2Validator()
    {
        RuleFor(x => x.PriceValuationDetails)
            .NotEmpty()
            .WithMessage("PriceReport2.PriceValuationDetails must contain at least one element (1..∞).");
    }
}
