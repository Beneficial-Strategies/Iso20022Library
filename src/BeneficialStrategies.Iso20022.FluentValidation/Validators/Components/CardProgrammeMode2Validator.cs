...
/// <summary>
/// Validates <see cref="CardProgrammeMode2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CardProgrammeMode2Validator : AbstractValidator<CardProgrammeMode2>
{
    public CardProgrammeMode2Validator()
    {
        RuleFor(x => x.Identification)
            .NotEmpty()
            .WithMessage("CardProgrammeMode2.Identification must contain at least one element (1..∞).");
    }
}
