...
/// <summary>
/// Validates <see cref="CorporateActionCashMovements2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CorporateActionCashMovements2Validator : AbstractValidator<CorporateActionCashMovements2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CorporateActionCashMovements2"/>.
    /// </summary>
    public CorporateActionCashMovements2Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("CorporateActionCashMovements2.AccountDetails must contain at least one element (1..2).");
    }
}
