...
/// <summary>
/// Validates <see cref="TransferOut12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferOut12Validator : AbstractValidator<TransferOut12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferOut12"/>.
    /// </summary>
    public TransferOut12Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferOut12.TransferDetails must contain at least one element (1..∞).");
    }
}
