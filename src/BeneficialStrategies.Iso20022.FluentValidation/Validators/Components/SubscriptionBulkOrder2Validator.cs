...
/// <summary>
/// Validates <see cref="SubscriptionBulkOrder2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionBulkOrder2Validator : AbstractValidator<SubscriptionBulkOrder2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkOrder2"/>.
    /// </summary>
    public SubscriptionBulkOrder2Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkOrder2.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
