...
/// <summary>
/// Validates <see cref="Undertaking4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Applicant</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
public class Undertaking4Validator : AbstractValidator<Undertaking4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Undertaking4"/>.
    /// </summary>
    public Undertaking4Validator()
    {
        RuleFor(x => x.Applicant)
            .NotEmpty()
            .WithMessage("Undertaking4.Applicant must contain at least one element (1..∞).");

        RuleFor(x => x.Beneficiary)
            .NotEmpty()
            .WithMessage("Undertaking4.Beneficiary must contain at least one element (1..∞).");
    }
}
