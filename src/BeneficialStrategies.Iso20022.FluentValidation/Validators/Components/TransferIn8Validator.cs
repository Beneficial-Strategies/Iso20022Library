...
/// <summary>
/// Validates <see cref="TransferIn8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn8Validator : AbstractValidator<TransferIn8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn8"/>.
    /// </summary>
    public TransferIn8Validator()
    {
        RuleFor(x => x.TransferDetails)
            .NotEmpty()
            .WithMessage("TransferIn8.TransferDetails must contain at least one element (1..∞).");
    }
}
