...
/// <summary>
/// Validates <see cref="FinancingAgreementList1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Item</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class FinancingAgreementList1Validator : AbstractValidator<FinancingAgreementList1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancingAgreementList1"/>.
    /// </summary>
    public FinancingAgreementList1Validator()
    {
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("FinancingAgreementList1.Item must contain at least one element (1..∞).");
    }
}
