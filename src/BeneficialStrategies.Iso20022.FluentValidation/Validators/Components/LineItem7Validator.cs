...
/// <summary>
/// Validates <see cref="LineItem7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class LineItem7Validator : AbstractValidator<LineItem7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LineItem7"/>.
    /// </summary>
    public LineItem7Validator()
    {
        RuleFor(x => x.LineItemDetails)
            .NotEmpty()
            .WithMessage("LineItem7.LineItemDetails must contain at least one element (1..∞).");
    }
}
