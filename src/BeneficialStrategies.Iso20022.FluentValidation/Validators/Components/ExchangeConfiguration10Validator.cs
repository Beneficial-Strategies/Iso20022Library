...
/// <summary>
/// Validates <see cref="ExchangeConfiguration10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ExchangeConfiguration10"/>.
    /// </summary>
    public ExchangeConfiguration10Validator()
    {
        RuleFor(x => x.ExchangePolicy)
            .NotEmpty()
            .WithMessage("ExchangeConfiguration10.ExchangePolicy must contain at least one element (1..∞).");
    }
}
