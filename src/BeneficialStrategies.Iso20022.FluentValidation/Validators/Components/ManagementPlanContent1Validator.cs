...
/// <summary>
/// Validates <see cref="ManagementPlanContent1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent1"/>.
    /// </summary>
    public ManagementPlanContent1Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent1.Action must contain at least one element (1..∞).");
    }
}
