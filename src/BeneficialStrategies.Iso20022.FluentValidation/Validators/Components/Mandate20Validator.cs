...
/// <summary>
/// Validates <see cref="Mandate20"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _yPqnozEyEe6g-ffJsqGiSA
...
/// implemented as real rules below rather than left as non-enforceable commentary.
///
...
/// </remarks>
public class Mandate20Validator : AbstractValidator<Mandate20>
{
    /// <summary>
    ...
    )
    {
        ...
        RuleFor(x => x)
            ...
            .WithMessage(
                "Mandate20.UltimateDebtor may only be present if different from Debtor "
                    + "(UltimateDebtorGuideline)."
            );
        ...
        RuleFor(x => x)
            ...
            .WithMessage(
                "Mandate20.UltimateCreditor may only be present if different from Creditor "
                    + "(UltimateCreditorGuideline)."
            );
