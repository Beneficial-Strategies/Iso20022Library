...
/// <summary>
/// Validates <see cref="TrackerData1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TrackerData1Validator : AbstractValidator<TrackerData1>
{
    public TrackerData1Validator()
    {
        RuleFor(x => x.TrackerRecord)
            .NotEmpty()
            .WithMessage("TrackerData1.TrackerRecord must contain at least one element (1..∞).");
    }
}
