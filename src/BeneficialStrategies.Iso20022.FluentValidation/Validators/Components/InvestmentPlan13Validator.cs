...
/// <summary>
/// Validates <see cref="InvestmentPlan13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan13Validator : AbstractValidator<InvestmentPlan13>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan13"/>.
    /// </summary>
    public InvestmentPlan13Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan13.SecurityDetails must contain at least one element (1..50).");
    }
}
