...
/// <summary>
/// Validates <see cref="IntraPositionPending11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionPending11"/>.
    /// </summary>
    public IntraPositionPending11Validator()
    {
        RuleFor(x => x.Movement)
            .NotEmpty()
            .WithMessage("IntraPositionPending11.Movement must contain at least one element (1..∞).");
    }
}
