...
/// <summary>
/// Validates <see cref="TradeLegStatement5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TradeLegStatement5Validator : AbstractValidator<TradeLegStatement5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeLegStatement5"/>.
    /// </summary>
    public TradeLegStatement5Validator()
    {
        RuleFor(x => x.TradeLegsDetails)
            .NotEmpty()
            .WithMessage("TradeLegStatement5.TradeLegsDetails must contain at least one element (1..∞).");
    }
}
