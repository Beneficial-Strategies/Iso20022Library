...
/// <summary>
/// Validates <see cref="CustomerIdentification1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CustomerIdentification1Validator : AbstractValidator<CustomerIdentification1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CustomerIdentification1"/>.
    /// </summary>
    public CustomerIdentification1Validator()
    {
        RuleFor(x => x.AuthorityRequest)
            .NotEmpty()
            .WithMessage("CustomerIdentification1.AuthorityRequest must contain at least one element (1..∞).");
    }
}
