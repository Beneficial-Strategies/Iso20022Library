...
/// <summary>
/// Validates <see cref="OperationMandate4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class OperationMandate4Validator : AbstractValidator<OperationMandate4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OperationMandate4"/>.
    /// </summary>
    public OperationMandate4Validator()
    {
        RuleFor(x => x.ApplicableChannel)
            .NotEmpty()
            .WithMessage("OperationMandate4.ApplicableChannel must contain at least one element (1..∞).");

        RuleFor(x => x.BankOperation)
            .NotEmpty()
            .WithMessage("OperationMandate4.BankOperation must contain at least one element (1..∞).");
    }
}
