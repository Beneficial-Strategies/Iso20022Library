...
/// <summary>
/// Validates <see cref="SwitchExecution8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SwitchExecution8Validator : AbstractValidator<SwitchExecution8>
{
    public SwitchExecution8Validator()
    {
        RuleFor(x => x.RedemptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchExecution8.RedemptionLegDetails must contain at least one element (1..∞).");

        RuleFor(x => x.SubscriptionLegDetails)
            .NotEmpty()
            .WithMessage("SwitchExecution8.SubscriptionLegDetails must contain at least one element (1..∞).");
    }
}
