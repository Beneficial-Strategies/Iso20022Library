...
/// <summary>
/// Validates <see cref="VariationMargin2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TotalVariationMargin</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class VariationMargin2Validator : AbstractValidator<VariationMargin2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="VariationMargin2"/>.
    /// </summary>
    public VariationMargin2Validator()
    {
        RuleFor(x => x.TotalVariationMargin)
            .NotEmpty()
            .WithMessage("VariationMargin2.TotalVariationMargin must contain at least one element (1..∞).");
    }
}
