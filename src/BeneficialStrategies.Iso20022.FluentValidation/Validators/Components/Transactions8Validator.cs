...
/// <summary>
/// Validates <see cref="Transactions8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Transactions8Validator : AbstractValidator<Transactions8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transactions8"/>.
    /// </summary>
    public Transactions8Validator()
    {
        RuleFor(x => x.TransactionReport)
            .NotEmpty()
            .WithMessage("Transactions8.TransactionReport must contain at least one element (1..∞).");
    }
}
