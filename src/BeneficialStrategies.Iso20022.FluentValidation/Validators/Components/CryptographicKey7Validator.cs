...
/// <summary>
/// Validates <see cref="CryptographicKey7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CryptographicKey7Validator : AbstractValidator<CryptographicKey7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CryptographicKey7"/>.
    /// </summary>
    public CryptographicKey7Validator()
    {
        RuleFor(x => x.Function)
            .NotEmpty()
            .WithMessage("CryptographicKey7.Function must contain at least one element (1..∞).");
    }
}
