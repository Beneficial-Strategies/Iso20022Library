...
/// <summary>
/// Validates <see cref="ManagementPlanContent8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent8Validator : AbstractValidator<ManagementPlanContent8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent8"/>.
    /// </summary>
    public ManagementPlanContent8Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent8.Action must contain at least one element (1..∞).");
    }
}
