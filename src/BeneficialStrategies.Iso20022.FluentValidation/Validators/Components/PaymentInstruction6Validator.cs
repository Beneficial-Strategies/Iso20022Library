...
/// <summary>
/// Validates <see cref="PaymentInstruction6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction6Validator : AbstractValidator<PaymentInstruction6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction6"/>.
    /// </summary>
    public PaymentInstruction6Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction6.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
