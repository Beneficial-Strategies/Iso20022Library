...
/// <summary>
/// Validates <see cref="PartyIdentificationAndAccount119"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>AccountIdentification</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
public class PartyIdentificationAndAccount119Validator : AbstractValidator<PartyIdentificationAndAccount119>
{
    public PartyIdentificationAndAccount119Validator()
    {
        RuleFor(x => x.AccountIdentification)
            .NotEmpty()
            .WithMessage("PartyIdentificationAndAccount119.AccountIdentification must contain at least one element (1..∞).");

        RuleFor(x => x.PartyIdentification)
            .NotEmpty()
            .WithMessage("PartyIdentificationAndAccount119.PartyIdentification must contain at least one element (1..∞).");
    }
}
