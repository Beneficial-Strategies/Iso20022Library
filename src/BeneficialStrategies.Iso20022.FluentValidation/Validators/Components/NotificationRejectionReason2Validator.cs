...
/// <summary>
/// Validates <see cref="NotificationRejectionReason2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NotificationRejectionReason2Validator : AbstractValidator<NotificationRejectionReason2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NotificationRejectionReason2"/>.
    /// </summary>
    public NotificationRejectionReason2Validator()
    {
        RuleFor(x => x.Reason)
            .NotEmpty()
            .WithMessage("NotificationRejectionReason2.Reason must contain at least one element (1..∞).");
    }
}
