...
/// <summary>
/// Validates <see cref="StatusReport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StatusReport1Validator : AbstractValidator<StatusReport1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StatusReport1"/>.
    /// </summary>
    public StatusReport1Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("StatusReport1.DataSet must contain at least one element (1..∞).");
    }
}
