...
/// <summary>
/// Validates <see cref="PartyIdentification79"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>AccountOwner</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class PartyIdentification79Validator : AbstractValidator<PartyIdentification79>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PartyIdentification79"/>.
    /// </summary>
    public PartyIdentification79Validator()
    {
        RuleFor(x => x.AccountOwner)
            .NotEmpty()
            .WithMessage("PartyIdentification79.AccountOwner must contain at least one element (1..∞).");
    }
}
