...
/// <summary>
/// Validates <see cref="Narrative1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Text</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..5</description></item>
/// </list>
/// </remarks>
public sealed class Narrative1Validator : AbstractValidator<Narrative1>
{
    public Narrative1Validator()
    {
        RuleFor(x => x.Text)
            .NotEmpty()
            .WithMessage("Narrative1.Text must contain at least one element (1..5).");
    }
}
