...
/// <summary>
/// Validates <see cref="StoredValueRequest7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class StoredValueRequest7Validator : AbstractValidator<StoredValueRequest7>
{
    public StoredValueRequest7Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest7.Data must contain at least one element (1..∞).");
    }
}
