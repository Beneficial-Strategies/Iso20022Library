...
/// <summary>
/// Validates <see cref="Clearing5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Clearing5"/>.
    /// </summary>
    public Clearing5Validator()
    {
        RuleFor(x => x.ClearingMember)
            .NotEmpty()
            .WithMessage("Clearing5.ClearingMember must contain at least one element (1..∞).");
    }
}
