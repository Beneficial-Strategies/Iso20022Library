...
/// <summary>
/// Validates <see cref="SubscriptionMultipleOrder4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionMultipleOrder4Validator : AbstractValidator<SubscriptionMultipleOrder4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionMultipleOrder4"/>.
    /// </summary>
    public SubscriptionMultipleOrder4Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionMultipleOrder4.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
