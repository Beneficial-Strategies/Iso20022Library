...
/// <summary>
/// Validates <see cref="CardPaymentDataSet12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet12Validator : AbstractValidator<CardPaymentDataSet12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet12"/>.
    /// </summary>
    public CardPaymentDataSet12Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet12.TransactionTotals must contain at least one element (1..∞).");
    }
}
