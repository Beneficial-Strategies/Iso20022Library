...
/// <summary>
/// Validates <see cref="ReportStatusAndReason1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ReportStatusAndReason1Validator : AbstractValidator<ReportStatusAndReason1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ReportStatusAndReason1"/>.
    /// </summary>
    public ReportStatusAndReason1Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("ReportStatusAndReason1.Rejected must contain at least one element (1..100).");
    }
}
