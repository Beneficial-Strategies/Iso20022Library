...
/// <summary>
/// Validates <see cref="CardPaymentDataSet2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet2Validator : AbstractValidator<CardPaymentDataSet2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet2"/>.
    /// </summary>
    public CardPaymentDataSet2Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet2.TransactionTotals must contain at least one element (1..∞).");
    }
}
