...
/// <summary>
/// Validates <see cref="CardPaymentDataSet5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet5Validator : AbstractValidator<CardPaymentDataSet5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet5"/>.
    /// </summary>
    public CardPaymentDataSet5Validator()
    {
        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet5.TransactionTotals must contain at least one element (1..∞).");
    }
}
