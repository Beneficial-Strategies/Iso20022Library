...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateBalancePerSafekeepingPlace12Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateBalancePerSafekeepingPlace12"/>.
    /// </summary>
    public AggregateBalancePerSafekeepingPlace12Validator()
    {
        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace12.PriceDetails must contain at least one element (1..∞).");
    }
}
