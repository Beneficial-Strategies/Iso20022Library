...
/// <summary>
/// Validates <see cref="ATMTransaction51"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TotalAuthorisedAmount</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMTransaction51"/>.
    /// </summary>
    public ATMTransaction51Validator()
    {
        RuleFor(x => x.TotalAuthorisedAmount)
            .NotEmpty()
            .WithMessage("ATMTransaction51.TotalAuthorisedAmount must contain at least one element (1..∞).");

        RuleFor(x => x.TotalDepositedAmount)
            .NotEmpty()
            .WithMessage("ATMTransaction51.TotalDepositedAmount must contain at least one element (1..∞).");
    }
}
