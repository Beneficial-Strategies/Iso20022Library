...
/// <summary>
/// Validates <see cref="OriginalNotificationReference7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _03T4gTq4EeWZFYSPlduMhw
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItemAndStatus5"/>
/// (the type of <see cref="OriginalNotificationReference7.OriginalItemAndStatus"/>) has only 5 real ISO
...
public class OriginalNotificationReference7Validator : AbstractValidator<OriginalNotificationReference7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference7"/>.
    /// </summary>
    public OriginalNotificationReference7Validator()
    {
        ...
        // OriginalItemAndStatus: OriginalItemAndStatus5, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItemAndStatus)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference7.OriginalItemAndStatus must contain at least one element (1..∞).");
