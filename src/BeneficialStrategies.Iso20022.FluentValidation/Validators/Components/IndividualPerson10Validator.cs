...
/// <summary>
/// Validates <see cref="IndividualPerson10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IndividualPerson10Validator : AbstractValidator<IndividualPerson10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IndividualPerson10"/>.
    /// </summary>
    public IndividualPerson10Validator()
    {
        RuleFor(x => x.Citizenship)
            .NotEmpty()
            .WithMessage("IndividualPerson10.Citizenship must contain at least one element (1..3).");

        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("IndividualPerson10.PostalAddress must contain at least one element (1..5).");
    }
}
