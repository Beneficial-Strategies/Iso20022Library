...
/// <summary>
/// Validates <see cref="IntraBalanceModification5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class IntraBalanceModification5Validator : AbstractValidator<IntraBalanceModification5>
{
    public IntraBalanceModification5Validator()
    {
        RuleFor(x => x.Modification)
            .NotEmpty()
            .WithMessage("IntraBalanceModification5.Modification must contain at least one element (1..∞).");
    }
}
