...
/// <summary>
/// Validates <see cref="CardPaymentDataSet10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet10Validator : AbstractValidator<CardPaymentDataSet10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet10"/>.
    /// </summary>
    public CardPaymentDataSet10Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet10.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet10.TransactionTotals must contain at least one element (1..∞).");
    }
}
