...
/// <summary>
/// Validates <see cref="ReportLine4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ReportLine4Validator : AbstractValidator<ReportLine4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ReportLine4"/>.
    /// </summary>
    public ReportLine4Validator()
    {
        RuleFor(x => x.BreakdownByPurchaseOrder)
            .NotEmpty()
            .WithMessage("ReportLine4.BreakdownByPurchaseOrder must contain at least one element (1..∞).");
    }
}
