...
/// <summary>
/// Validates <see cref="PriceReport3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PriceReport3"/>.
    /// </summary>
    public PriceReport3Validator()
    {
        RuleFor(x => x.PriceValuationDetails)
            .NotEmpty()
            .WithMessage("PriceReport3.PriceValuationDetails must contain at least one element (1..∞).");
    }
}
