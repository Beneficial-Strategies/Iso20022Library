...
/// <summary>
/// Validates <see cref="TransferIn10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class TransferIn10Validator : AbstractValidator<TransferIn10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransferIn10"/>.
    /// </summary>
    public TransferIn10Validator()
    {
        RuleFor(x => x.TransferAndReferences)
            .NotEmpty()
            .WithMessage("TransferIn10.TransferAndReferences must contain at least one element (1..∞).");
    }
}
