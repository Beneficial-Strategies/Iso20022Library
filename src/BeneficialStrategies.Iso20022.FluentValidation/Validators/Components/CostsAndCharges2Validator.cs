...
/// <summary>
/// Validates <see cref="CostsAndCharges2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>IndividualCostOrCharge</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class CostsAndCharges2Validator : AbstractValidator<CostsAndCharges2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CostsAndCharges2"/>.
    /// </summary>
    public CostsAndCharges2Validator()
    {
        RuleFor(x => x.IndividualCostOrCharge)
            .NotEmpty()
            .WithMessage("CostsAndCharges2.IndividualCostOrCharge must contain at least one element (1..∞).");
    }
}
