...
/// <summary>
/// Validates <see cref="CreditTransferTransaction9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class CreditTransferTransaction9Validator : AbstractValidator<CreditTransferTransaction9>
{
    public CreditTransferTransaction9Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("CreditTransferTransaction9.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
