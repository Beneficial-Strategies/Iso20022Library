...
/// <summary>
/// Validates <see cref="BusinessError4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>BusinessError</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class BusinessError4Validator : AbstractValidator<BusinessError4>
{
    public BusinessError4Validator()
    {
        RuleFor(x => x.BusinessError)
            .NotEmpty()
            .WithMessage("BusinessError4.BusinessError must contain at least one element (1..∞).");
    }
}
