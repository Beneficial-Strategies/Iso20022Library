...
/// <summary>
/// Validates <see cref="RedemptionBulkOrder3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionBulkOrder3Validator : AbstractValidator<RedemptionBulkOrder3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionBulkOrder3"/>.
    /// </summary>
    public RedemptionBulkOrder3Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkOrder3.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
