...
/// <summary>
/// Validates <see cref="TrackerStatusAndTransaction22"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TrackerStatusAndTransaction22Validator : AbstractValidator<TrackerStatusAndTransaction22>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TrackerStatusAndTransaction22"/>.
    /// </summary>
    public TrackerStatusAndTransaction22Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("TrackerStatusAndTransaction22.Transaction must contain at least one element (1..∞).");
    }
}
