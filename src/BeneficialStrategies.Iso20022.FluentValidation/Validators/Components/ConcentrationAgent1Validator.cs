...
/// <summary>
/// Validates <see cref="ConcentrationAgent1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ConcentrationAgent1Validator : AbstractValidator<ConcentrationAgent1>
{
    public ConcentrationAgent1Validator()
    {
        RuleFor(x => x.Account)
            .NotEmpty()
            .WithMessage("ConcentrationAgent1.Account must contain at least one element (1..∞).");
    }
}
