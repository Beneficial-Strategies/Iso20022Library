...
/// <summary>
/// Validates <see cref="PaymentInstruction41"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PaymentInstruction41Validator : AbstractValidator<PaymentInstruction41>
{
    public PaymentInstruction41Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction41.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
