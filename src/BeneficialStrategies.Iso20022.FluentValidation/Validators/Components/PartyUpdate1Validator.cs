...
/// <summary>
/// Validates <see cref="PartyUpdate1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Status</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class PartyUpdate1Validator : AbstractValidator<PartyUpdate1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PartyUpdate1"/>.
    /// </summary>
    public PartyUpdate1Validator()
    {
        RuleFor(x => x.Status)
            .NotEmpty()
            .WithMessage("PartyUpdate1.Status must contain at least one element (1..∞).");
    }
}
