...
/// <summary>
/// Validates <see cref="LiquidResources1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CashDue</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class LiquidResources1Validator : AbstractValidator<LiquidResources1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LiquidResources1"/>.
    /// </summary>
    public LiquidResources1Validator()
    {
        RuleFor(x => x.CashDue)
            .NotEmpty()
            .WithMessage("LiquidResources1.CashDue must contain at least one element (1..∞).");
    }
}
