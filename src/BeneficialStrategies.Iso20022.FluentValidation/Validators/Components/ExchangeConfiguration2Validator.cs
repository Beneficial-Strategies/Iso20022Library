...
/// <summary>
/// Validates <see cref="ExchangeConfiguration2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ExchangeConfiguration2Validator : AbstractValidator<ExchangeConfiguration2>
{
    public ExchangeConfiguration2Validator()
    {
        RuleFor(x => x.ExchangePolicy)
            .NotEmpty()
            .WithMessage("ExchangeConfiguration2.ExchangePolicy must contain at least one element (1..∞).");
    }
}
