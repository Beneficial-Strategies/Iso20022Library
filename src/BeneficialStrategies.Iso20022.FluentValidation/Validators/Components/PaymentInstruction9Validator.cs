...
/// <summary>
/// Validates <see cref="PaymentInstruction9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction9Validator : AbstractValidator<PaymentInstruction9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction9"/>.
    /// </summary>
    public PaymentInstruction9Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction9.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
