...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails27"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails27Validator : AbstractValidator<FinancialInstrumentDetails27>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails27"/>.
    /// </summary>
    public FinancialInstrumentDetails27Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails27.Transaction must contain at least one element (1..∞).");
    }
}
