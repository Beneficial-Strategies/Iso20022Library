...
/// <summary>
/// Validates <see cref="AcceptorConfiguration11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration11Validator : AbstractValidator<AcceptorConfiguration11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration11"/>.
    /// </summary>
    public AcceptorConfiguration11Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration11.DataSet must contain at least one element (1..∞).");
    }
}
