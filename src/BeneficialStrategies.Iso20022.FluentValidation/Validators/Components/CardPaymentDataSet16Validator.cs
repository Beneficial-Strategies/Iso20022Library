...
/// <summary>
/// Validates <see cref="CardPaymentDataSet16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class CardPaymentDataSet16Validator : AbstractValidator<CardPaymentDataSet16>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet16"/>.
    /// </summary>
    public CardPaymentDataSet16Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet16.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet16.TransactionTotals must contain at least one element (1..∞).");
    }
}
