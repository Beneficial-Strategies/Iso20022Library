...
/// <summary>
/// Validates <see cref="LocalMarketAnnex3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LocalMarketAnnex3"/>.
    /// </summary>
    public LocalMarketAnnex3Validator()
    {
        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex3.Country must contain at least one element (1..∞).");
    }
}
