...
/// <summary>
/// Validates <see cref="ErrorAction3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ErrorAction3Validator : AbstractValidator<ErrorAction3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ErrorAction3"/>.
    /// </summary>
    public ErrorAction3Validator()
    {
        RuleFor(x => x.ActionResult)
            .NotEmpty()
            .WithMessage("ErrorAction3.ActionResult must contain at least one element (1..∞).");
    }
}
