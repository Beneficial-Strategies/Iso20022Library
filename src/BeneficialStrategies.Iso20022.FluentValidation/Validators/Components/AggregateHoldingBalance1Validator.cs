...
/// <summary>
/// Validates <see cref="AggregateHoldingBalance1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AggregateHoldingBalance1Validator : AbstractValidator<AggregateHoldingBalance1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AggregateHoldingBalance1"/>.
    /// </summary>
    public AggregateHoldingBalance1Validator()
    {
        RuleFor(x => x.BalanceForFinancialInstrument)
            .NotEmpty()
            .WithMessage("AggregateHoldingBalance1.BalanceForFinancialInstrument must contain at least one element (1..∞).");
    }
}
