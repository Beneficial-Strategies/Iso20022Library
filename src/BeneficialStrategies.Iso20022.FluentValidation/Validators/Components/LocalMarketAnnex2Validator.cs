...
/// <summary>
/// Validates <see cref="LocalMarketAnnex2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
///   <item><term>SettlementDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class LocalMarketAnnex2Validator : AbstractValidator<LocalMarketAnnex2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LocalMarketAnnex2"/>.
    /// </summary>
    public LocalMarketAnnex2Validator()
    {
        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex2.Country must contain at least one element (1..∞).");

        RuleFor(x => x.SettlementDetails)
            .NotEmpty()
            .WithMessage("LocalMarketAnnex2.SettlementDetails must contain at least one element (1..∞).");
    }
}
