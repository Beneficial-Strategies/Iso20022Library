...
/// <summary>
/// Validates <see cref="AccountBalance3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Balance</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class AccountBalance3Validator : AbstractValidator<AccountBalance3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountBalance3"/>.
    /// </summary>
    public AccountBalance3Validator()
    {
        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountBalance3.Balance must contain at least one element (1..∞).");
    }
}
