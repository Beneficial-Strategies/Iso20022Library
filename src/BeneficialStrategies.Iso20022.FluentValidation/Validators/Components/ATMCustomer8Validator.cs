...
/// <summary>
/// Validates <see cref="ATMCustomer8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Authentication</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class ATMCustomer8Validator : AbstractValidator<ATMCustomer8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMCustomer8"/>.
    /// </summary>
    public ATMCustomer8Validator()
    {
        RuleFor(x => x.Authentication)
            .NotEmpty()
            .WithMessage("ATMCustomer8.Authentication must contain at least one element (1..∞).");
    }
}
