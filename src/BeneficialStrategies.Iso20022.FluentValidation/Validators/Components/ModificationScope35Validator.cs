...
/// <summary>
/// Validates <see cref="ModificationScope35"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ModificationScope35Validator : AbstractValidator<ModificationScope35>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ModificationScope35"/>.
    /// </summary>
    public ModificationScope35Validator()
    {
        RuleFor(x => x.AdditionalInformation)
            .NotEmpty()
            .WithMessage("ModificationScope35.AdditionalInformation must contain at least one element (1..∞).");
    }
}
