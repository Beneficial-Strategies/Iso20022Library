...
/// <summary>
/// Validates <see cref="NewAccount2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class NewAccount2Validator : AbstractValidator<NewAccount2>
{
    public NewAccount2Validator()
    {
        RuleFor(x => x.AccountParty)
            .NotEmpty()
            .WithMessage("NewAccount2.AccountParty must contain at least one element (1..∞).");
    }
}
