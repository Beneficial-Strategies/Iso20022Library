...
/// <summary>
/// Validates <see cref="PointOfInteractionComponentAssessment1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PointOfInteractionComponentAssessment1Validator : AbstractValidator<PointOfInteractionComponentAssessment1>
{
    public PointOfInteractionComponentAssessment1Validator()
    {
        RuleFor(x => x.Assigner)
            .NotEmpty()
            .WithMessage("PointOfInteractionComponentAssessment1.Assigner must contain at least one element (1..∞).");
    }
}
