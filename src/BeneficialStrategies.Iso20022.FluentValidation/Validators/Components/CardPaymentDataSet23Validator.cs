...
/// <summary>
/// Validates <see cref="CardPaymentDataSet23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet23Validator : AbstractValidator<CardPaymentDataSet23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet23"/>.
    /// </summary>
    public CardPaymentDataSet23Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet23.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet23.TransactionTotals must contain at least one element (1..∞).");
    }
}
