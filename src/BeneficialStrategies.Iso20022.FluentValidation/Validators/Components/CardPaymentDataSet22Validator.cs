...
/// <summary>
/// Validates <see cref="CardPaymentDataSet22"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet22Validator : AbstractValidator<CardPaymentDataSet22>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet22"/>.
    /// </summary>
    public CardPaymentDataSet22Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet22.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet22.TransactionTotals must contain at least one element (1..∞).");
    }
}
