...
/// <summary>
/// Validates <see cref="NewAccount3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>AccountParty</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class NewAccount3Validator : AbstractValidator<NewAccount3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NewAccount3"/>.
    /// </summary>
    public NewAccount3Validator()
    {
        RuleFor(x => x.AccountParty)
            .NotEmpty()
            .WithMessage("NewAccount3.AccountParty must contain at least one element (1..∞).");
    }
}
