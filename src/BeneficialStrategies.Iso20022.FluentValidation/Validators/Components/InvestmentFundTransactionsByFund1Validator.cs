...
/// <summary>
/// Validates <see cref="InvestmentFundTransactionsByFund1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TransactionDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class InvestmentFundTransactionsByFund1Validator : AbstractValidator<InvestmentFundTransactionsByFund1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentFundTransactionsByFund1"/>.
    /// </summary>
    public InvestmentFundTransactionsByFund1Validator()
    {
        RuleFor(x => x.TransactionDetails)
            .NotEmpty()
            .WithMessage("InvestmentFundTransactionsByFund1.TransactionDetails must contain at least one element (1..∞).");
    }
}
