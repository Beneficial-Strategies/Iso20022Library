...
/// <summary>
/// Validates <see cref="ATMCustomer6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ATMCustomer6Validator : AbstractValidator<ATMCustomer6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMCustomer6"/>.
    /// </summary>
    public ATMCustomer6Validator()
    {
        RuleFor(x => x.AuthenticationResult)
            .NotEmpty()
            .WithMessage("ATMCustomer6.AuthenticationResult must contain at least one element (1..∞).");
    }
}
