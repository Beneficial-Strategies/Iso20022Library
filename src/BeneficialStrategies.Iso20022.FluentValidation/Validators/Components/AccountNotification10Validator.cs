...
/// <summary>
/// Validates <see cref="AccountNotification10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _atcx-x77EeSxevWRRWxNAg
...
/// </list>
/// </remarks>
public sealed class AccountNotification10Validator : AbstractValidator<AccountNotification10>
{
    public AccountNotification10Validator()
    {
        ...
        // Item: NotificationItem5, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification10.Item must contain at least one element (1..∞).");
