...
/// <summary>
/// Validates <see cref="OriginalNotificationReference16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: 8796e8f3-423b-409e-b91d-b8099813928d
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItem9"/>
/// (the type of <see cref="OriginalNotificationReference16.OriginalItem"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public class OriginalNotificationReference16Validator : AbstractValidator<OriginalNotificationReference16>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="OriginalNotificationReference16"/>.
    /// </summary>
    public OriginalNotificationReference16Validator()
    {
        ...
        // OriginalItem: OriginalItem9, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItem)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference16.OriginalItem must contain at least one element (1..∞).");
