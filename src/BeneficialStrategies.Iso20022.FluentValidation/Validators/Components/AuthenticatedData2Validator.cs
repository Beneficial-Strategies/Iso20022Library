...
/// <summary>
/// Validates <see cref="AuthenticatedData2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AuthenticatedData2Validator : AbstractValidator<AuthenticatedData2>
{
    public AuthenticatedData2Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData2.Recipient must contain at least one element (1..∞).");
    }
}
