...
/// <summary>
/// Validates <see cref="AccountNotification26"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: 4410df66-25fb-4c90-86bb-92526a3afa33
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountNotification26"/>.
    /// </summary>
    public AccountNotification26Validator()
    {
        ...
        // Item: NotificationItem10, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification26.Item must contain at least one element (1..∞).");
