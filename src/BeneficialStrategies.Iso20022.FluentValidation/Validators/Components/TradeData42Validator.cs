...
/// <summary>
/// Validates <see cref="TradeData42"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TradeData42Validator : AbstractValidator<TradeData42>
{
    public TradeData42Validator()
    {
        RuleFor(x => x.CounterpartySpecificData)
            .NotEmpty()
            .WithMessage("TradeData42.CounterpartySpecificData must contain at least one element (1..2).");
    }
}
