...
/// <summary>
/// Validates <see cref="Transactions9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Transactions9Validator : AbstractValidator<Transactions9>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transactions9"/>.
    /// </summary>
    public Transactions9Validator()
    {
        RuleFor(x => x.TransactionReport)
            .NotEmpty()
            .WithMessage("Transactions9.TransactionReport must contain at least one element (1..∞).");
    }
}
