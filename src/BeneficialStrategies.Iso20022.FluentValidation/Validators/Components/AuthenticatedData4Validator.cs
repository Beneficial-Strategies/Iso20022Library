...
/// <summary>
/// Validates <see cref="AuthenticatedData4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData4Validator : AbstractValidator<AuthenticatedData4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData4"/>.
    /// </summary>
    public AuthenticatedData4Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData4.Recipient must contain at least one element (1..∞).");
    }
}
