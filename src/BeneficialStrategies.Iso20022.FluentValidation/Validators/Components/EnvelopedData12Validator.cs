...
/// <summary>
/// Validates <see cref="EnvelopedData12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData12Validator : AbstractValidator<EnvelopedData12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData12"/>.
    /// </summary>
    public EnvelopedData12Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData12.Recipient must contain at least one element (1..∞).");
    }
}
