...
/// <summary>
/// Validates <see cref="AccountStatement2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _RqIkl9p-Ed-ak6NoX_4Aeg_-1148769640
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountStatement2"/>.
    /// </summary>
    public AccountStatement2Validator()
    {
        ...
        // no rule needed.
        // Account, FromToDate, RelatedAccount, TransactionsSummary: Component types with no
        // validator yet — nested fields unvalidated.

        RuleFor(x => x.Balance)
            .NotEmpty()
            .WithMessage("AccountStatement2.Balance must contain at least one element (1..*).");
