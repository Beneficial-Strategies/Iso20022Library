...
/// <summary>
/// Validates <see cref="NewAccount4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NewAccount4Validator : AbstractValidator<NewAccount4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NewAccount4"/>.
    /// </summary>
    public NewAccount4Validator()
    {
        RuleFor(x => x.AccountParty)
            .NotEmpty()
            .WithMessage("NewAccount4.AccountParty must contain at least one element (1..∞).");
    }
}
