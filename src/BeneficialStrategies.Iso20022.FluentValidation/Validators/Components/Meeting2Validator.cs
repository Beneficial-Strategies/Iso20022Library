...
/// <summary>
/// Validates <see cref="Meeting2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class Meeting2Validator : AbstractValidator<Meeting2>
{
    public Meeting2Validator()
    {
        RuleFor(x => x.Location)
            .NotEmpty()
            .WithMessage("Meeting2.Location must contain at least one element (1..5).");
    }
}
