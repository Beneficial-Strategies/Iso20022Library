...
/// </list>
/// </remarks>
public sealed class PaymentInstruction50Validator : AbstractValidator<PaymentInstruction50>
{
    public PaymentInstruction50Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction50.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
