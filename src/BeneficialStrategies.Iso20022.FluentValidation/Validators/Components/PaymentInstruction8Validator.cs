...
/// <summary>
/// Validates <see cref="PaymentInstruction8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction8Validator : AbstractValidator<PaymentInstruction8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction8"/>.
    /// </summary>
    public PaymentInstruction8Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction8.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
