...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class FinancialInstrumentDetails5Validator : AbstractValidator<FinancialInstrumentDetails5>
{
    public FinancialInstrumentDetails5Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails5.Transaction must contain at least one element (1..∞).");
    }
}
