...
/// <summary>
/// Validates <see cref="AutomaticVariation1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>AmountAndTrigger</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class AutomaticVariation1Validator : AbstractValidator<AutomaticVariation1>
{
    public AutomaticVariation1Validator()
    {
        RuleFor(x => x.AmountAndTrigger)
            .NotEmpty()
            .WithMessage("AutomaticVariation1.AmountAndTrigger must contain at least one element (1..∞).");
    }
}
