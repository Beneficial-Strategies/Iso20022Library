...
/// <summary>
/// Validates <see cref="SignedData2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SignedData2Validator : AbstractValidator<SignedData2>
{
    public SignedData2Validator()
    {
        RuleFor(x => x.DigestAlgorithm)
            .NotEmpty()
            .WithMessage("SignedData2.DigestAlgorithm must contain at least one element (1..∞).");

        RuleFor(x => x.Signer)
            .NotEmpty()
            .WithMessage("SignedData2.Signer must contain at least one element (1..∞).");
    }
}
