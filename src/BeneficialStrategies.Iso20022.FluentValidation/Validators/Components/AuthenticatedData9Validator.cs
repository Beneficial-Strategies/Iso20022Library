...
/// <summary>
/// Validates <see cref="AuthenticatedData9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AuthenticatedData9Validator : AbstractValidator<AuthenticatedData9>
{
    public AuthenticatedData9Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData9.Recipient must contain at least one element (1..∞).");
    }
}
