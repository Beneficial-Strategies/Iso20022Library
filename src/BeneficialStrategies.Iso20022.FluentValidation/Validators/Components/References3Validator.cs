...
/// <summary>
/// Validates <see cref="References3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>RequestReason</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class References3Validator : AbstractValidator<References3>
{
    public References3Validator()
    {
        RuleFor(x => x.RequestReason)
            .NotEmpty()
            .WithMessage("References3.RequestReason must contain at least one element (1..∞).");
    }
}
