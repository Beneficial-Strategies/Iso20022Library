...
/// <summary>
/// Validates <see cref="Organisation16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Organisation16Validator : AbstractValidator<Organisation16>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Organisation16"/>.
    /// </summary>
    public Organisation16Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("Organisation16.PostalAddress must contain at least one element (1..5).");
    }
}
