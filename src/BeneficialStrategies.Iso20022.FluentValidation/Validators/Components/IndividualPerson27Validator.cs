...
/// <summary>
/// Validates <see cref="IndividualPerson27"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IndividualPerson27Validator : AbstractValidator<IndividualPerson27>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IndividualPerson27"/>.
    /// </summary>
    public IndividualPerson27Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("IndividualPerson27.PostalAddress must contain at least one element (1..10).");
    }
}
