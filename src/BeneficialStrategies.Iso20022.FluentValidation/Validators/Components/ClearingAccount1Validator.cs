...
/// <summary>
/// Validates <see cref="ClearingAccount1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>CollateralAccountOwner</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class ClearingAccount1Validator : AbstractValidator<ClearingAccount1>
{
    public ClearingAccount1Validator()
    {
        RuleFor(x => x.CollateralAccountOwner)
            .NotEmpty()
            .WithMessage("ClearingAccount1.CollateralAccountOwner must contain at least one element (1..∞).");
    }
}
