...
/// <summary>
/// Validates <see cref="Response1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ResponseTypeDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public sealed class Response1Validator : AbstractValidator<Response1>
{
    public Response1Validator()
    {
        RuleFor(x => x.ResponseTypeDetails)
            .NotEmpty()
            .WithMessage("Response1.ResponseTypeDetails must contain at least one element (1..∞).");
    }
}
