...
/// <summary>
/// Validates <see cref="AcceptorConfiguration14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration14Validator : AbstractValidator<AcceptorConfiguration14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration14"/>.
    /// </summary>
    public AcceptorConfiguration14Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration14.DataSet must contain at least one element (1..∞).");
    }
}
