...
/// <summary>
/// Validates <see cref="LineItem12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class LineItem12Validator : AbstractValidator<LineItem12>
{
    public LineItem12Validator()
    {
        RuleFor(x => x.CommercialLineItems)
            .NotEmpty()
            .WithMessage("LineItem12.CommercialLineItems must contain at least one element (1..∞).");
    }
}
