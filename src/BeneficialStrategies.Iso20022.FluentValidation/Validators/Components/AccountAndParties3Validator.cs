...
/// <summary>
/// Validates <see cref="AccountAndParties3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AccountAndParties3Validator : AbstractValidator<AccountAndParties3>
{
    public AccountAndParties3Validator()
    {
        RuleFor(x => x.AuthorityRequestType)
            .NotEmpty()
            .WithMessage("AccountAndParties3.AuthorityRequestType must contain at least one element (1..∞).");
    }
}
