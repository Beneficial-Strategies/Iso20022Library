...
/// <summary>
/// Validates <see cref="InvestmentPlan8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan8Validator : AbstractValidator<InvestmentPlan8>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan8"/>.
    /// </summary>
    public InvestmentPlan8Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan8.SecurityDetails must contain at least one element (1..50).");
    }
}
