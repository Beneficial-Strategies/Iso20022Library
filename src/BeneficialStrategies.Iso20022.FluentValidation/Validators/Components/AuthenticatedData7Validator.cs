...
/// <summary>
/// Validates <see cref="AuthenticatedData7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AuthenticatedData7Validator : AbstractValidator<AuthenticatedData7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AuthenticatedData7"/>.
    /// </summary>
    public AuthenticatedData7Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("AuthenticatedData7.Recipient must contain at least one element (1..∞).");
    }
}
