...
/// <summary>
/// Validates <see cref="ReportTransactionRequest1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ReportTransactionRequest1Validator : AbstractValidator<ReportTransactionRequest1>
{
    public ReportTransactionRequest1Validator()
    {
        RuleFor(x => x.SearchCriteria)
            .NotEmpty()
            .WithMessage("ReportTransactionRequest1.SearchCriteria must contain at least one element (1..∞).");
    }
}
