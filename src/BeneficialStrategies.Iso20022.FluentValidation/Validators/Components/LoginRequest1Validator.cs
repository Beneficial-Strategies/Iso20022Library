...
/// <summary>
/// Validates <see cref="LoginRequest1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest1Validator : AbstractValidator<LoginRequest1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest1"/>.
    /// </summary>
    public LoginRequest1Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest1.SaleSoftware must contain at least one element (1..∞).");
    }
}
