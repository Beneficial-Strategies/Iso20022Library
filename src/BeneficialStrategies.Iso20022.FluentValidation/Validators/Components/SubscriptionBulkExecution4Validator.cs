...
/// <summary>
/// Validates <see cref="SubscriptionBulkExecution4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SubscriptionBulkExecution4Validator : AbstractValidator<SubscriptionBulkExecution4>
{
    public SubscriptionBulkExecution4Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkExecution4.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
