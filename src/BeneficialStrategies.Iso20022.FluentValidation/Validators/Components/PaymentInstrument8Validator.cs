...
/// <summary>
/// Validates <see cref="PaymentInstrument8"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class PaymentInstrument8Validator : AbstractValidator<PaymentInstrument8>
{
    public PaymentInstrument8Validator()
    {
        RuleFor(x => x.CashAccountDetails)
            .NotEmpty()
            .WithMessage("PaymentInstrument8.CashAccountDetails must contain at least one element (1..3).");
    }
}
