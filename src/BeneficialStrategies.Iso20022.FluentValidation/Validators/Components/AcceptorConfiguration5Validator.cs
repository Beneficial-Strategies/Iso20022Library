...
/// <summary>
/// Validates <see cref="AcceptorConfiguration5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class AcceptorConfiguration5Validator : AbstractValidator<AcceptorConfiguration5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AcceptorConfiguration5"/>.
    /// </summary>
    public AcceptorConfiguration5Validator()
    {
        RuleFor(x => x.DataSet)
            .NotEmpty()
            .WithMessage("AcceptorConfiguration5.DataSet must contain at least one element (1..∞).");
    }
}
