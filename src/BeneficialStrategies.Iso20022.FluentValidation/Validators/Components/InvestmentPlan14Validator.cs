...
/// <summary>
/// Validates <see cref="InvestmentPlan14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan14Validator : AbstractValidator<InvestmentPlan14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan14"/>.
    /// </summary>
    public InvestmentPlan14Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan14.SecurityDetails must contain at least one element (1..50).");
    }
}
