...
/// <summary>
/// Validates <see cref="Group6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Group6Validator : AbstractValidator<Group6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Group6"/>.
    /// </summary>
    public Group6Validator()
    {
        RuleFor(x => x.Party)
            .NotEmpty()
            .WithMessage("Group6.Party must contain at least one element (1..∞).");
    }
}
