...
/// <summary>
/// Validates <see cref="PartyAuditTrail2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PartyAuditTrail2"/>.
    /// </summary>
    public PartyAuditTrail2Validator()
    {
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("PartyAuditTrail2.Record must contain at least one element (1..∞).");
    }
}
