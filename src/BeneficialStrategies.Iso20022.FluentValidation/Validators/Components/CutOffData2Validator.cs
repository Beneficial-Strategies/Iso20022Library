...
/// <summary>
/// Validates <see cref="CutOffData2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CutOffData2Validator : AbstractValidator<CutOffData2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CutOffData2"/>.
    /// </summary>
    public CutOffData2Validator()
    {
        RuleFor(x => x.NettingCutOffDetails)
            .NotEmpty()
            .WithMessage("CutOffData2.NettingCutOffDetails must contain at least one element (1..∞).");
    }
}
