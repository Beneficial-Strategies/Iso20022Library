...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FinancialInstrumentDetails14Validator : AbstractValidator<FinancialInstrumentDetails14>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FinancialInstrumentDetails14"/>.
    /// </summary>
    public FinancialInstrumentDetails14Validator()
    {
        RuleFor(x => x.SubBalance)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails14.SubBalance must contain at least one element (1..∞).");
    }
}
