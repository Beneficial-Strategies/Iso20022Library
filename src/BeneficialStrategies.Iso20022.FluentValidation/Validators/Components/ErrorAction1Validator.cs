...
/// <summary>
/// Validates <see cref="ErrorAction1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ErrorAction1Validator : AbstractValidator<ErrorAction1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ErrorAction1"/>.
    /// </summary>
    public ErrorAction1Validator()
    {
        RuleFor(x => x.ActionResult)
            .NotEmpty()
            .WithMessage("ErrorAction1.ActionResult must contain at least one element (1..∞).");
    }
}
