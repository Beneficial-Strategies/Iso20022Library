...
/// <summary>
/// Validates <see cref="OriginalNotificationReference14"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _-EtxyzEsEe6GxLzpkVnWYg
...
/// </list>
///
/// Constraints (from spec) — <b>NOT enforceable, spec/model mismatch</b>: <see cref="OriginalItem8"/>
/// (the type of <see cref="OriginalNotificationReference14.OriginalItem"/>) has only 5 real ISO
...
/// </list>
/// </remarks>
public sealed class OriginalNotificationReference14Validator : AbstractValidator<OriginalNotificationReference14>
{
    public OriginalNotificationReference14Validator()
    {
        ...
        // OriginalItem: OriginalItem8, Min=1,Max=unbounded — the ValueList<T> default ([])
        // satisfies the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.OriginalItem)
            .NotEmpty()
            .WithMessage("OriginalNotificationReference14.OriginalItem must contain at least one element (1..∞).");
