...
/// <summary>
/// Validates <see cref="AccountNotification6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _tlra8lkyEeGeoaLUQk__nA_-1825023044
...
public class AccountNotification6Validator : AbstractValidator<AccountNotification6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountNotification6"/>.
    /// </summary>
    public AccountNotification6Validator()
    {
        ...
        // Item: NotificationItem4, Min=1,Max=unbounded — the ValueList<T> default ([]) satisfies
        // the C# type system but violates the ISO minimum. Enforce at runtime.
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("AccountNotification6.Item must contain at least one element (1..∞).");

        // Account, RelatedAccount: CashAccount24 (0..1) — no validator exists yet for
        // CashAccount24; nested fields unvalidated.

        // AccountServicer, DebtorAgent, IntermediaryAgent:
        // BranchAndFinancialInstitutionIdentification5 (0..1) — no validator exists yet for
        // BranchAndFinancialInstitutionIdentification5; nested fields unvalidated.
        ...
        // AccountOwner, Debtor: Party12Choice_ (0..1). Both variants reviewed:
