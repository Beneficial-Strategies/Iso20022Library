...
/// <summary>
/// Validates <see cref="PaymentInstructionInformation2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstructionInformation2Validator : AbstractValidator<PaymentInstructionInformation2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstructionInformation2"/>.
    /// </summary>
    public PaymentInstructionInformation2Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstructionInformation2.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
