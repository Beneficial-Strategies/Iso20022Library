...
/// <summary>
/// Validates <see cref="TradeLegStatement3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TradeLegsDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class TradeLegStatement3Validator : AbstractValidator<TradeLegStatement3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeLegStatement3"/>.
    /// </summary>
    public TradeLegStatement3Validator()
    {
        RuleFor(x => x.TradeLegsDetails)
            .NotEmpty()
            .WithMessage("TradeLegStatement3.TradeLegsDetails must contain at least one element (1..∞).");
    }
}
