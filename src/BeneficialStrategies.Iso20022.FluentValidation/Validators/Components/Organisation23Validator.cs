...
/// <summary>
/// Validates <see cref="Organisation23"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Organisation23Validator : AbstractValidator<Organisation23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Organisation23"/>.
    /// </summary>
    public Organisation23Validator()
    {
        RuleFor(x => x.PostalAddress)
            .NotEmpty()
            .WithMessage("Organisation23.PostalAddress must contain at least one element (1..5).");
    }
}
