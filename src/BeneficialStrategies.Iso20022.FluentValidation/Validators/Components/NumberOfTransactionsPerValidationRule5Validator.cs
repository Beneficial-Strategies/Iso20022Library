...
/// <summary>
/// Validates <see cref="NumberOfTransactionsPerValidationRule5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class NumberOfTransactionsPerValidationRule5Validator : AbstractValidator<NumberOfTransactionsPerValidationRule5>
{
    public NumberOfTransactionsPerValidationRule5Validator()
    {
        RuleFor(x => x.ReportStatus)
            .NotEmpty()
            .WithMessage("NumberOfTransactionsPerValidationRule5.ReportStatus must contain at least one element (1..∞).");
    }
}
