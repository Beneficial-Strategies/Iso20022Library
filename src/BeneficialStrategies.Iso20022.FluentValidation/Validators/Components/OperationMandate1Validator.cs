...
/// <summary>
/// Validates <see cref="OperationMandate1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class OperationMandate1Validator : AbstractValidator<OperationMandate1>
{
    public OperationMandate1Validator()
    {
        RuleFor(x => x.BankOperation)
            .NotEmpty()
            .WithMessage("OperationMandate1.BankOperation must contain at least one element (1..∞).");
    }
}
