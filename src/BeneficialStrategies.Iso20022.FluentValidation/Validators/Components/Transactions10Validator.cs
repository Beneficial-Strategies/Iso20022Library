...
/// <summary>
/// Validates <see cref="Transactions10"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>TransactionReport</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class Transactions10Validator : AbstractValidator<Transactions10>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Transactions10"/>.
    /// </summary>
    public Transactions10Validator()
    {
        RuleFor(x => x.TransactionReport)
            .NotEmpty()
            .WithMessage("Transactions10.TransactionReport must contain at least one element (1..∞).");
    }
}
