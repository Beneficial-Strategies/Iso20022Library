...
/// <summary>
/// Validates <see cref="SwitchOrderInstruction2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>SwitchOrderDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class SwitchOrderInstruction2Validator : AbstractValidator<SwitchOrderInstruction2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SwitchOrderInstruction2"/>.
    /// </summary>
    public SwitchOrderInstruction2Validator()
    {
        RuleFor(x => x.SwitchOrderDetails)
            .NotEmpty()
            .WithMessage("SwitchOrderInstruction2.SwitchOrderDetails must contain at least one element (1..∞).");
    }
}
