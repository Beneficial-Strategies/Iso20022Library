...
/// <summary>
/// Validates <see cref="NonFinancialRequestContentComponent3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NonFinancialRequestContentComponent3Validator : AbstractValidator<NonFinancialRequestContentComponent3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NonFinancialRequestContentComponent3"/>.
    /// </summary>
    public NonFinancialRequestContentComponent3Validator()
    {
        RuleFor(x => x.NonFinancialRequestType)
            .NotEmpty()
            .WithMessage("NonFinancialRequestContentComponent3.NonFinancialRequestType must contain at least one element (1..∞).");
    }
}
