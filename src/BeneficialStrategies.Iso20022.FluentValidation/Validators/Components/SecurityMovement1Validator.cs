...
/// <summary>
/// Validates <see cref="SecurityMovement1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SecurityMovement1Validator : AbstractValidator<SecurityMovement1>
{
    public SecurityMovement1Validator()
    {
        RuleFor(x => x.AccountDetails)
            .NotEmpty()
            .WithMessage("SecurityMovement1.AccountDetails must contain at least one element (1..2).");
    }
}
