...
/// <summary>
/// Validates <see cref="StoredValueRequest6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest6Validator : AbstractValidator<StoredValueRequest6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest6"/>.
    /// </summary>
    public StoredValueRequest6Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest6.Data must contain at least one element (1..∞).");
    }
}
