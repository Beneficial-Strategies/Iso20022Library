...
/// <summary>
/// Validates <see cref="FundProcessingPassport1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class FundProcessingPassport1Validator : AbstractValidator<FundProcessingPassport1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FundProcessingPassport1"/>.
    /// </summary>
    public FundProcessingPassport1Validator()
    {
        RuleFor(x => x.SettlementDetails)
            .NotEmpty()
            .WithMessage("FundProcessingPassport1.SettlementDetails must contain at least one element (1..∞).");
    }
}
