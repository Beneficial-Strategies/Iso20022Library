...
/// <summary>
/// Validates <see cref="NetworkParameters5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NetworkParameters5"/>.
    /// </summary>
    public NetworkParameters5Validator()
    {
        RuleFor(x => x.Address)
            .NotEmpty()
            .WithMessage("NetworkParameters5.Address must contain at least one element (1..∞).");
    }
}
