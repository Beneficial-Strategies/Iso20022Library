...
/// <summary>
/// Validates <see cref="RedemptionMultipleOrder4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionMultipleOrder4Validator : AbstractValidator<RedemptionMultipleOrder4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionMultipleOrder4"/>.
    /// </summary>
    public RedemptionMultipleOrder4Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("RedemptionMultipleOrder4.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
