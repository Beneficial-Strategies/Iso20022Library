...
/// <summary>
/// Validates <see cref="LoginRequest6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest6Validator : AbstractValidator<LoginRequest6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest6"/>.
    /// </summary>
    public LoginRequest6Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest6.SaleSoftware must contain at least one element (1..∞).");
    }
}
