...
/// <summary>
/// Validates <see cref="LoginRequest2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest2Validator : AbstractValidator<LoginRequest2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest2"/>.
    /// </summary>
    public LoginRequest2Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest2.SaleSoftware must contain at least one element (1..∞).");
    }
}
