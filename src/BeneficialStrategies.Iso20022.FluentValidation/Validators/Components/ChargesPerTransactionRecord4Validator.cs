...
/// <summary>
/// Validates <see cref="ChargesPerTransactionRecord4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _6H6WQTEyEe6g-ffJsqGiSA
...
/// </remarks>
public class ChargesPerTransactionRecord4Validator : AbstractValidator<ChargesPerTransactionRecord4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ChargesPerTransactionRecord4"/>.
    /// </summary>
    public ChargesPerTransactionRecord4Validator()
    {
        ...
        // (BranchAndFinancialInstitutionIdentification8, 0..1), ChargesAccount,
        // DebtorAgentAccount (CashAccount40, 0..1), InstructionForInstructedAgent
        // (InstructionForInstructedAgent1, 0..1), TotalChargesPerRecord (TotalCharges8, 0..1),
        ...
        RuleFor(x => x.ChargesBreakdown)
            .NotEmpty()
            .WithMessage("ChargesPerTransactionRecord4.ChargesBreakdown must contain at least one element (1..*).");
    }
}
