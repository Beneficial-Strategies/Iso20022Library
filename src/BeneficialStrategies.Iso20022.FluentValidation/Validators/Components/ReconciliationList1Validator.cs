...
/// <summary>
/// Validates <see cref="ReconciliationList1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ReconciliationList1Validator : AbstractValidator<ReconciliationList1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ReconciliationList1"/>.
    /// </summary>
    public ReconciliationList1Validator()
    {
        RuleFor(x => x.Item)
            .NotEmpty()
            .WithMessage("ReconciliationList1.Item must contain at least one element (1..∞).");
    }
}
