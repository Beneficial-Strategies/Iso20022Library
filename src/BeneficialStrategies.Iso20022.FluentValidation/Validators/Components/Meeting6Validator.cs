...
/// <summary>
/// Validates <see cref="Meeting6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Meeting6Validator : AbstractValidator<Meeting6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Meeting6"/>.
    /// </summary>
    public Meeting6Validator()
    {
        RuleFor(x => x.Location)
            .NotEmpty()
            .WithMessage("Meeting6.Location must contain at least one element (1..5).");
    }
}
