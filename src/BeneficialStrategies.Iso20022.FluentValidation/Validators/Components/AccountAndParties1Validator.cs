...
/// <summary>
/// Validates <see cref="AccountAndParties1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class AccountAndParties1Validator : AbstractValidator<AccountAndParties1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AccountAndParties1"/>.
    /// </summary>
    public AccountAndParties1Validator()
    {
        RuleFor(x => x.AuthorityRequestType)
            .NotEmpty()
            .WithMessage("AccountAndParties1.AuthorityRequestType must contain at least one element (1..∞).");
    }
}
