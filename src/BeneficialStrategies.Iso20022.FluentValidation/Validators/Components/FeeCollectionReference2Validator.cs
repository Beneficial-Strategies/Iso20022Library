...
/// <summary>
/// Validates <see cref="FeeCollectionReference2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class FeeCollectionReference2Validator : AbstractValidator<FeeCollectionReference2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="FeeCollectionReference2"/>.
    /// </summary>
    public FeeCollectionReference2Validator()
    {
        RuleFor(x => x.Identification)
            .NotEmpty()
            .WithMessage("FeeCollectionReference2.Identification must contain at least one element (1..∞).");
    }
}
