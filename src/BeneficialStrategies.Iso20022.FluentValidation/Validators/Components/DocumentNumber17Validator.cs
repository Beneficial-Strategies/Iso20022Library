...
/// <summary>
/// Validates <see cref="DocumentNumber17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class DocumentNumber17Validator : AbstractValidator<DocumentNumber17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DocumentNumber17"/>.
    /// </summary>
    public DocumentNumber17Validator()
    {
        RuleFor(x => x.References)
            .NotEmpty()
            .WithMessage("DocumentNumber17.References must contain at least one element (1..∞).");
    }
}
