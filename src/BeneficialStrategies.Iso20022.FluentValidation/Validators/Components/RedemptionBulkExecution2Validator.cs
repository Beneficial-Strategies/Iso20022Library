...
/// <summary>
/// Validates <see cref="RedemptionBulkExecution2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionBulkExecution2Validator : AbstractValidator<RedemptionBulkExecution2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionBulkExecution2"/>.
    /// </summary>
    public RedemptionBulkExecution2Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkExecution2.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
