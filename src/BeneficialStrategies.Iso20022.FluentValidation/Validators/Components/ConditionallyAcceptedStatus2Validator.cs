...
/// <summary>
/// Validates <see cref="ConditionallyAcceptedStatus2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ReasonDetails</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..5</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class ConditionallyAcceptedStatus2Validator : AbstractValidator<ConditionallyAcceptedStatus2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ConditionallyAcceptedStatus2"/>.
    /// </summary>
    public ConditionallyAcceptedStatus2Validator()
    {
        RuleFor(x => x.ReasonDetails)
            .NotEmpty()
            .WithMessage("ConditionallyAcceptedStatus2.ReasonDetails must contain at least one element (1..5).");
    }
}
