...
/// <summary>
/// Validates <see cref="PaymentInstruction16"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction16Validator : AbstractValidator<PaymentInstruction16>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction16"/>.
    /// </summary>
    public PaymentInstruction16Validator()
    {
        RuleFor(x => x.CreditTransferTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction16.CreditTransferTransactionInformation must contain at least one element (1..∞).");
    }
}
