...
/// <summary>
/// Validates <see cref="LoginRequest7"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest7Validator : AbstractValidator<LoginRequest7>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest7"/>.
    /// </summary>
    public LoginRequest7Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest7.SaleSoftware must contain at least one element (1..∞).");
    }
}
