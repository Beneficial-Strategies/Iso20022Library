...
/// <summary>
/// Validates <see cref="ISATransfer17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class ISATransfer17Validator : AbstractValidator<ISATransfer17>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ISATransfer17"/>.
    /// </summary>
    public ISATransfer17Validator()
    {
        RuleFor(x => x.ProductTransfer)
            .NotEmpty()
            .WithMessage("ISATransfer17.ProductTransfer must contain at least one element (1..∞).");
    }
}
