...
/// <summary>
/// Validates <see cref="SubscriptionBulkOrder3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionBulkOrder3Validator : AbstractValidator<SubscriptionBulkOrder3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkOrder3"/>.
    /// </summary>
    public SubscriptionBulkOrder3Validator()
    {
        RuleFor(x => x.IndividualOrderDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkOrder3.IndividualOrderDetails must contain at least one element (1..∞).");
    }
}
