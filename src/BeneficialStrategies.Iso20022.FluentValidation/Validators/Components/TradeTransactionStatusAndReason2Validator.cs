...
/// <summary>
/// Validates <see cref="TradeTransactionStatusAndReason2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class TradeTransactionStatusAndReason2Validator : AbstractValidator<TradeTransactionStatusAndReason2>
{
    public TradeTransactionStatusAndReason2Validator()
    {
        RuleFor(x => x.Rejected)
            .NotEmpty()
            .WithMessage("TradeTransactionStatusAndReason2.Rejected must contain at least one element (1..100).");
    }
}
