...
/// <summary>
/// Validates <see cref="FinancialInstrumentDetails44"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class FinancialInstrumentDetails44Validator : AbstractValidator<FinancialInstrumentDetails44>
{
    public FinancialInstrumentDetails44Validator()
    {
        RuleFor(x => x.SubBalance)
            .NotEmpty()
            .WithMessage("FinancialInstrumentDetails44.SubBalance must contain at least one element (1..∞).");
    }
}
