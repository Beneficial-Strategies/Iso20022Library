...
/// <summary>
/// Validates <see cref="ChargesPerType4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _6BIY6zEyEe6g-ffJsqGiSA
...
/// </list>
/// </remarks>
public class ChargesPerType4Validator : AbstractValidator<ChargesPerType4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ChargesPerType4"/>.
    /// </summary>
    public ChargesPerType4Validator()
    {
        ...
        // Record: ChargesPerTypeRecord4, 1..∞ — NEEDS NotEmpty RULE.
        RuleFor(x => x.Record)
            .NotEmpty()
            .WithMessage("ChargesPerType4.Record must contain at least one element (1..*).");
    }
}
