...
/// <summary>
/// Validates <see cref="RegulatoryReportingNotification1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RegulatoryReportingNotification1Validator : AbstractValidator<RegulatoryReportingNotification1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RegulatoryReportingNotification1"/>.
    /// </summary>
    public RegulatoryReportingNotification1Validator()
    {
        RuleFor(x => x.TransactionCertificate)
            .NotEmpty()
            .WithMessage("RegulatoryReportingNotification1.TransactionCertificate must contain at least one element (1..∞).");
    }
}
