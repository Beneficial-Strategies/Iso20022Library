...
/// <summary>
/// Validates <see cref="ScenarioDefinition1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>StressItem</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..2</description></item>
/// </list>
/// </remarks>
public class ScenarioDefinition1Validator : AbstractValidator<ScenarioDefinition1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ScenarioDefinition1"/>.
    /// </summary>
    public ScenarioDefinition1Validator()
    {
        RuleFor(x => x.StressItem)
            .NotEmpty()
            .WithMessage("ScenarioDefinition1.StressItem must contain at least one element (1..2).");
    }
}
