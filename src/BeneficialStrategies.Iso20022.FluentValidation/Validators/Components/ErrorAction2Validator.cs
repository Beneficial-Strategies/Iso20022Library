...
/// <summary>
/// Validates <see cref="ErrorAction2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ErrorAction2Validator : AbstractValidator<ErrorAction2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ErrorAction2"/>.
    /// </summary>
    public ErrorAction2Validator()
    {
        RuleFor(x => x.ActionResult)
            .NotEmpty()
            .WithMessage("ErrorAction2.ActionResult must contain at least one element (1..∞).");
    }
}
