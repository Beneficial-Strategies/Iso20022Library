...
/// <summary>
/// Validates <see cref="IntraPositionMovements6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class IntraPositionMovements6Validator : AbstractValidator<IntraPositionMovements6>
{
    public IntraPositionMovements6Validator()
    {
        RuleFor(x => x.Movement)
            .NotEmpty()
            .WithMessage("IntraPositionMovements6.Movement must contain at least one element (1..∞).");
    }
}
