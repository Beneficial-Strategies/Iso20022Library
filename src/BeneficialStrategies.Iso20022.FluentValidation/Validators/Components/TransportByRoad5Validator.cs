...
/// <summary>
/// Validates <see cref="TransportByRoad5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TransportByRoad5"/>.
    /// </summary>
    public TransportByRoad5Validator()
    {
        RuleFor(x => x.PlaceOfDelivery)
            .NotEmpty()
            .WithMessage("TransportByRoad5.PlaceOfDelivery must contain at least one element (1..∞).");
    }
}
