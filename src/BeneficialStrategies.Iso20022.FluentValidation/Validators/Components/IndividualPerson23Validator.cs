...
public class IndividualPerson23Validator : AbstractValidator<IndividualPerson23>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IndividualPerson23"/>.
    /// </summary>
