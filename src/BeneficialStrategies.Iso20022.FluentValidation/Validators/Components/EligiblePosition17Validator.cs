...
/// <summary>
/// Validates <see cref="EligiblePosition17"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>HoldingBalance</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..3</description></item>
/// </list>
/// </remarks>
public sealed class EligiblePosition17Validator : AbstractValidator<EligiblePosition17>
{
    public EligiblePosition17Validator()
    {
        RuleFor(x => x.HoldingBalance)
            .NotEmpty()
            .WithMessage("EligiblePosition17.HoldingBalance must contain at least one element (1..3).");
    }
}
