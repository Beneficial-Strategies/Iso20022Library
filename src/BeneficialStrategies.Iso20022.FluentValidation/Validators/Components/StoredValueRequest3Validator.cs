...
/// <summary>
/// Validates <see cref="StoredValueRequest3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class StoredValueRequest3Validator : AbstractValidator<StoredValueRequest3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StoredValueRequest3"/>.
    /// </summary>
    public StoredValueRequest3Validator()
    {
        RuleFor(x => x.Data)
            .NotEmpty()
            .WithMessage("StoredValueRequest3.Data must contain at least one element (1..∞).");
    }
}
