...
/// <summary>
/// Validates <see cref="ATMDepositedMedia1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class ATMDepositedMedia1Validator : AbstractValidator<ATMDepositedMedia1>
{
    public ATMDepositedMedia1Validator()
    {
        RuleFor(x => x.MediaItems)
            .NotEmpty()
            .WithMessage("ATMDepositedMedia1.MediaItems must contain at least one element (1..∞).");
    }
}
