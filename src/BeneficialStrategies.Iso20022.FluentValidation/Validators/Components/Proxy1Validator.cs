...
/// <summary>
/// Validates <see cref="Proxy1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class Proxy1Validator : AbstractValidator<Proxy1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Proxy1"/>.
    /// </summary>
    public Proxy1Validator()
    {
        RuleFor(x => x.ProxyType)
            .NotEmpty()
            .WithMessage("Proxy1.ProxyType must contain at least one element (1..2).");
    }
}
