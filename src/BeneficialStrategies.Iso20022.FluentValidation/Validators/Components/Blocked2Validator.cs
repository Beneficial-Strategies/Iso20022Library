...
/// <summary>
/// Validates <see cref="Blocked2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class Blocked2Validator : AbstractValidator<Blocked2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="Blocked2"/>.
    /// </summary>
    public Blocked2Validator()
    {
        RuleFor(x => x.OrderType)
            .NotEmpty()
            .WithMessage("Blocked2.OrderType must contain at least one element (1..∞).");
    }
}
