...
/// <summary>
/// Validates <see cref="RedemptionMultipleExecution2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class RedemptionMultipleExecution2Validator : AbstractValidator<RedemptionMultipleExecution2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionMultipleExecution2"/>.
    /// </summary>
    public RedemptionMultipleExecution2Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("RedemptionMultipleExecution2.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
