...
/// <summary>
/// Validates <see cref="MaintenanceDelegation18"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class MaintenanceDelegation18Validator : AbstractValidator<MaintenanceDelegation18>
{
    public MaintenanceDelegation18Validator()
    {
        RuleFor(x => x.MaintenanceService)
            .NotEmpty()
            .WithMessage("MaintenanceDelegation18.MaintenanceService must contain at least one element (1..∞).");
    }
}
