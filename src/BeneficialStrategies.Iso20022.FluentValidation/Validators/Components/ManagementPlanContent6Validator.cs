...
/// <summary>
/// Validates <see cref="ManagementPlanContent6"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent6Validator : AbstractValidator<ManagementPlanContent6>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent6"/>.
    /// </summary>
    public ManagementPlanContent6Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent6.Action must contain at least one element (1..∞).");
    }
}
