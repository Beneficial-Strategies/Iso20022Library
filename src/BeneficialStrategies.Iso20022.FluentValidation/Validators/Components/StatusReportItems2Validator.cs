...
/// <summary>
/// Validates <see cref="StatusReportItems2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>ReportedEntity</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..2</description></item>
/// </list>
/// </remarks>
[Obsolete("Marked obsolete in the ISO 20022 2026-06-26 snapshot. Removal date: 2016-09-08.")]
public class StatusReportItems2Validator : AbstractValidator<StatusReportItems2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="StatusReportItems2"/>.
    /// </summary>
    public StatusReportItems2Validator()
    {
        RuleFor(x => x.ReportedEntity)
            .NotEmpty()
            .WithMessage("StatusReportItems2.ReportedEntity must contain at least one element (1..2).");
    }
}
