...
/// <summary>
/// Validates <see cref="NetworkParameters3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class NetworkParameters3Validator : AbstractValidator<NetworkParameters3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="NetworkParameters3"/>.
    /// </summary>
    public NetworkParameters3Validator()
    {
        RuleFor(x => x.Address)
            .NotEmpty()
            .WithMessage("NetworkParameters3.Address must contain at least one element (1..∞).");
    }
}
