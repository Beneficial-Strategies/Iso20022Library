...
/// <summary>
/// Validates <see cref="CertificateIssuer1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CertificateIssuer1"/>.
    /// </summary>
    public CertificateIssuer1Validator()
    {
        RuleFor(x => x.RelativeDistinguishedName)
            .NotEmpty()
            .WithMessage("CertificateIssuer1.RelativeDistinguishedName must contain at least one element (1..∞).");
    }
}
