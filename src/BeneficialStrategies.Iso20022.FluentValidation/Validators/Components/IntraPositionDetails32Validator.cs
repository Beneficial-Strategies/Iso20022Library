...
/// <summary>
/// Validates <see cref="IntraPositionDetails32"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class IntraPositionDetails32Validator : AbstractValidator<IntraPositionDetails32>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="IntraPositionDetails32"/>.
    /// </summary>
    public IntraPositionDetails32Validator()
    {
        RuleFor(x => x.IntraPositionMovement)
            .NotEmpty()
            .WithMessage("IntraPositionDetails32.IntraPositionMovement must contain at least one element (1..∞).");
    }
}
