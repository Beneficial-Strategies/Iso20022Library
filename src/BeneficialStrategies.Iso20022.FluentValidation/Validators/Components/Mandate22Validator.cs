...
/// <summary>
/// Validates <see cref="Mandate22"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
/// ISO ID: _1ko_YTEyEe6g-ffJsqGiSA
/// Spec source: queried via ISO 20022 MCP server (2026-08-20).
///
/// Information that serves as a basis to debit an account.
/// <list type="table">
///   <item><term>MandateIdentification</term><description>Max35Text — optional (0..1)</description></item>
...
///   <item><term>FirstCollectionAmount</term><description>ActiveOrHistoricCurrencyAndAmount — optional (0..1)</description></item>
///   <item><term>CollectionAmount</term><description>ActiveOrHistoricCurrencyAndAmount — optional (0..1)</description></item>
///   <item><term>MaximumAmount</term><description>ActiveOrHistoricCurrencyAndAmount — optional (0..1)</description></item>
...
/// constraints (this type additionally makes <c>MandateIdentification</c> optional rather than
/// required — the only structural difference between the two).
///
...
/// </remarks>
public class Mandate22Validator : AbstractValidator<Mandate22>
{
    /// <summary>
    ...
    )
    {
        ...
        RuleFor(x => x)
            ...
            .WithMessage(
                "Mandate22.UltimateDebtor may only be present if different from Debtor "
                    + "(UltimateDebtorGuideline)."
            );
        ...
        RuleFor(x => x)
            ...
            .WithMessage(
                "Mandate22.UltimateCreditor may only be present if different from Creditor "
                    + "(UltimateCreditorGuideline)."
            );

        // ── Field-level rules ──────────────────────────────────────────────────────
        // MandateIdentification (optional here, unlike Mandate20's required), TrackingIndicator:
        // TrackingIndicator required (1..1) and already a `required` C# property — format
        // enforced by struct constructors.
        // MandateIdentification, MandateRequestIdentification, MandateReference: optional
        // scalars, length enforced by struct constructors — no rule needed.
        // FirstCollectionAmount, CollectionAmount, MaximumAmount: ActiveOrHistoricCurrencyAndAmount,
