...
/// <summary>
/// Validates <see cref="UnitPrice15"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class UnitPrice15Validator : AbstractValidator<UnitPrice15>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="UnitPrice15"/>.
    /// </summary>
    public UnitPrice15Validator()
    {
        RuleFor(x => x.ValueInInvestmentCurrency)
            .NotEmpty()
            .WithMessage("UnitPrice15.ValueInInvestmentCurrency must contain at least one element (1..∞).");
    }
}
