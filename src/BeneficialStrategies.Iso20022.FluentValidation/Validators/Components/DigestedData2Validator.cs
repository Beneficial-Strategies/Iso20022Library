...
/// <summary>
/// Validates <see cref="DigestedData2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class DigestedData2Validator : AbstractValidator<DigestedData2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DigestedData2"/>.
    /// </summary>
    public DigestedData2Validator()
    {
        RuleFor(x => x.DigestAlgorithm)
            .NotEmpty()
            .WithMessage("DigestedData2.DigestAlgorithm must contain at least one element (1..∞).");
    }
}
