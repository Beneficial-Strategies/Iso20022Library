...
/// <summary>
/// Validates <see cref="PaymentInstruction5"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction5Validator : AbstractValidator<PaymentInstruction5>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction5"/>.
    /// </summary>
    public PaymentInstruction5Validator()
    {
        RuleFor(x => x.CreditTransferTransaction)
            .NotEmpty()
            .WithMessage("PaymentInstruction5.CreditTransferTransaction must contain at least one element (1..∞).");
    }
}
