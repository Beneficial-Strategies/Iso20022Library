...
/// <summary>
/// Validates <see cref="EnvelopedData9"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData9"/>.
    /// </summary>
    public EnvelopedData9Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData9.Recipient must contain at least one element (1..∞).");
    }
}
