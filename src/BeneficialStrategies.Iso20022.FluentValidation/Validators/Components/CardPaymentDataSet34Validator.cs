...
/// <summary>
/// Validates <see cref="CardPaymentDataSet34"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet34Validator : AbstractValidator<CardPaymentDataSet34>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet34"/>.
    /// </summary>
    public CardPaymentDataSet34Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet34.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet34.TransactionTotals must contain at least one element (1..∞).");
    }
}
