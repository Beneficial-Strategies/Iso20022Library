...
/// <summary>
/// Validates <see cref="TradeContract3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class TradeContract3Validator : AbstractValidator<TradeContract3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="TradeContract3"/>.
    /// </summary>
    public TradeContract3Validator()
    {
        RuleFor(x => x.Buyer)
            .NotEmpty()
            .WithMessage("TradeContract3.Buyer must contain at least one element (1..∞).");

        RuleFor(x => x.Seller)
            .NotEmpty()
            .WithMessage("TradeContract3.Seller must contain at least one element (1..∞).");
    }
}
