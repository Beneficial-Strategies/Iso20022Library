...
/// <summary>
/// Validates <see cref="RedemptionBulkExecution3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="RedemptionBulkExecution3"/>.
    /// </summary>
    public RedemptionBulkExecution3Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("RedemptionBulkExecution3.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
