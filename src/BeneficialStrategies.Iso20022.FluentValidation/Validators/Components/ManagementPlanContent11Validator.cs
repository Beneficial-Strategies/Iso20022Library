...
/// <summary>
/// Validates <see cref="ManagementPlanContent11"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent11Validator : AbstractValidator<ManagementPlanContent11>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent11"/>.
    /// </summary>
    public ManagementPlanContent11Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent11.Action must contain at least one element (1..∞).");
    }
}
