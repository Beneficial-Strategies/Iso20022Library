...
/// <summary>
/// Validates <see cref="DeviceDisplayResponse1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DeviceDisplayResponse1"/>.
    /// </summary>
    public DeviceDisplayResponse1Validator()
    {
        RuleFor(x => x.OutputResult)
            .NotEmpty()
            .WithMessage("DeviceDisplayResponse1.OutputResult must contain at least one element (1..∞).");
    }
}
