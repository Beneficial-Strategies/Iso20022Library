...
/// <summary>
/// Validates <see cref="SafekeepingAccount12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SafekeepingAccount12Validator : AbstractValidator<SafekeepingAccount12>
{
    public SafekeepingAccount12Validator()
    {
        RuleFor(x => x.InstructedBalance)
            .NotEmpty()
            .WithMessage("SafekeepingAccount12.InstructedBalance must contain at least one element (1..15).");
    }
}
