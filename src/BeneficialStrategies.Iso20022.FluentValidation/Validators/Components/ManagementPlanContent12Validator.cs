...
/// <summary>
/// Validates <see cref="ManagementPlanContent12"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ManagementPlanContent12Validator : AbstractValidator<ManagementPlanContent12>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ManagementPlanContent12"/>.
    /// </summary>
    public ManagementPlanContent12Validator()
    {
        RuleFor(x => x.Action)
            .NotEmpty()
            .WithMessage("ManagementPlanContent12.Action must contain at least one element (1..∞).");
    }
}
