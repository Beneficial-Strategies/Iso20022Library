...
/// <summary>
/// Validates <see cref="CardPaymentDataSet29"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class CardPaymentDataSet29Validator : AbstractValidator<CardPaymentDataSet29>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="CardPaymentDataSet29"/>.
    /// </summary>
    public CardPaymentDataSet29Validator()
    {
        RuleFor(x => x.Transaction)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet29.Transaction must contain at least one element (1..∞).");

        RuleFor(x => x.TransactionTotals)
            .NotEmpty()
            .WithMessage("CardPaymentDataSet29.TransactionTotals must contain at least one element (1..∞).");
    }
}
