...
/// <summary>
/// Validates <see cref="AncillaryPurchase1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// <list type="table">
///   <item><term>Tax</term><description>ValueList&lt;T&gt; = [] allows empty, spec requires Min=1..&#8734;</description></item>
/// </list>
/// </remarks>
public class AncillaryPurchase1Validator : AbstractValidator<AncillaryPurchase1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="AncillaryPurchase1"/>.
    /// </summary>
    public AncillaryPurchase1Validator()
    {
        RuleFor(x => x.Tax)
            .NotEmpty()
            .WithMessage("AncillaryPurchase1.Tax must contain at least one element (1..∞).");
    }
}
