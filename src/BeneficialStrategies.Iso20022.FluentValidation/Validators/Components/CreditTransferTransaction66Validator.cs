...
/// </list>
/// </remarks>
public sealed class CreditTransferTransaction66Validator : AbstractValidator<CreditTransferTransaction66>
{
    public CreditTransferTransaction66Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("CreditTransferTransaction66.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
