...
/// <summary>
/// Validates <see cref="LoginRequest4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class LoginRequest4Validator : AbstractValidator<LoginRequest4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="LoginRequest4"/>.
    /// </summary>
    public LoginRequest4Validator()
    {
        RuleFor(x => x.SaleSoftware)
            .NotEmpty()
            .WithMessage("LoginRequest4.SaleSoftware must contain at least one element (1..∞).");
    }
}
