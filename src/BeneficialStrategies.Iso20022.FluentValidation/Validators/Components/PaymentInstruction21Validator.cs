...
/// <summary>
/// Validates <see cref="PaymentInstruction21"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction21Validator : AbstractValidator<PaymentInstruction21>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction21"/>.
    /// </summary>
    public PaymentInstruction21Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction21.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
