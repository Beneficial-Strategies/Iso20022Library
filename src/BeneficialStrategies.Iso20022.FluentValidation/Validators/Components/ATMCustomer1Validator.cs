...
/// <summary>
/// Validates <see cref="ATMCustomer1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class ATMCustomer1Validator : AbstractValidator<ATMCustomer1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="ATMCustomer1"/>.
    /// </summary>
    public ATMCustomer1Validator()
    {
        RuleFor(x => x.Authentication)
            .NotEmpty()
            .WithMessage("ATMCustomer1.Authentication must contain at least one element (1..∞).");
    }
}
