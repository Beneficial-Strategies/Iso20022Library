...
/// <summary>
/// Validates <see cref="DetailedStatisticsPerCounterparty19"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="DetailedStatisticsPerCounterparty19"/>.
    /// </summary>
    public DetailedStatisticsPerCounterparty19Validator()
    {
        RuleFor(x => x.RejectionStatistics)
            .NotEmpty()
            .WithMessage("DetailedStatisticsPerCounterparty19.RejectionStatistics must contain at least one element (1..∞).");
    }
}
