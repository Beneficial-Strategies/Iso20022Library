...
/// <summary>
/// Validates <see cref="SubscriptionBulkExecution3"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class SubscriptionBulkExecution3Validator : AbstractValidator<SubscriptionBulkExecution3>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="SubscriptionBulkExecution3"/>.
    /// </summary>
    public SubscriptionBulkExecution3Validator()
    {
        RuleFor(x => x.IndividualExecutionDetails)
            .NotEmpty()
            .WithMessage("SubscriptionBulkExecution3.IndividualExecutionDetails must contain at least one element (1..∞).");
    }
}
