...
/// <summary>
/// Validates <see cref="EnvelopedData1"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public class EnvelopedData1Validator : AbstractValidator<EnvelopedData1>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="EnvelopedData1"/>.
    /// </summary>
    public EnvelopedData1Validator()
    {
        RuleFor(x => x.Recipient)
            .NotEmpty()
            .WithMessage("EnvelopedData1.Recipient must contain at least one element (1..∞).");
    }
}
