...
/// <summary>
/// Validates <see cref="AcquirerProtocolParameters13"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AcquirerProtocolParameters13Validator : AbstractValidator<AcquirerProtocolParameters13>
{
    public AcquirerProtocolParameters13Validator()
    {
        RuleFor(x => x.AcquirerIdentification)
            .NotEmpty()
            .WithMessage("AcquirerProtocolParameters13.AcquirerIdentification must contain at least one element (1..∞).");
    }
}
