...
/// <summary>
/// Validates <see cref="AggregateBalancePerSafekeepingPlace4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class AggregateBalancePerSafekeepingPlace4Validator : AbstractValidator<AggregateBalancePerSafekeepingPlace4>
{
    public AggregateBalancePerSafekeepingPlace4Validator()
    {
        RuleFor(x => x.HoldingValue)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace4.HoldingValue must contain at least one element (1..∞).");

        RuleFor(x => x.PriceDetails)
            .NotEmpty()
            .WithMessage("AggregateBalancePerSafekeepingPlace4.PriceDetails must contain at least one element (1..∞).");
    }
}
