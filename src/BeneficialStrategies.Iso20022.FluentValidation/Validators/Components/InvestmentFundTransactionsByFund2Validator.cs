...
/// <summary>
/// Validates <see cref="InvestmentFundTransactionsByFund2"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentFundTransactionsByFund2Validator : AbstractValidator<InvestmentFundTransactionsByFund2>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentFundTransactionsByFund2"/>.
    /// </summary>
    public InvestmentFundTransactionsByFund2Validator()
    {
        RuleFor(x => x.TransactionDetails)
            .NotEmpty()
            .WithMessage("InvestmentFundTransactionsByFund2.TransactionDetails must contain at least one element (1..∞).");
    }
}
