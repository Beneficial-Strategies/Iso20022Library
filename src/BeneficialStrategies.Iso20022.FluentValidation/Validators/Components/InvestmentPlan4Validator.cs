...
/// <summary>
/// Validates <see cref="InvestmentPlan4"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class InvestmentPlan4Validator : AbstractValidator<InvestmentPlan4>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="InvestmentPlan4"/>.
    /// </summary>
    public InvestmentPlan4Validator()
    {
        RuleFor(x => x.SecurityDetails)
            .NotEmpty()
            .WithMessage("InvestmentPlan4.SecurityDetails must contain at least one element (1..50).");
    }
}
