...
/// <summary>
/// Validates <see cref="PaymentInstruction18"/> per the ISO 20022 specification.
/// </summary>
/// <remarks>
...
public class PaymentInstruction18Validator : AbstractValidator<PaymentInstruction18>
{
    /// <summary>
    /// Initializes a new instance of the validator for <see cref="PaymentInstruction18"/>.
    /// </summary>
    public PaymentInstruction18Validator()
    {
        RuleFor(x => x.DirectDebitTransactionInformation)
            .NotEmpty()
            .WithMessage("PaymentInstruction18.DirectDebitTransactionInformation must contain at least one element (1..∞).");
    }
}
