...
public class FinancialInstitutionCreditTransferV13ValidatorTests
{
    private readonly FinancialInstitutionCreditTransferV13Validator _sut = new();
    ...
    private static CreditTransferTransaction79 ValidTransaction() =>
        new()
        {
    ...
    private static FinancialInstitutionCreditTransferV13 ValidMessage() =>
    ...
    [Fact]
    public void GroupHeaderExpiryDateTimePresent_TransactionExpiryAlsoPresent_HasValidationError()
    {
        var msg = ValidMessage() with
        {
            GroupHeader = ValidGroupHeader() with { ExpiryDateTime = new DateTime(2026, 2, 1) },
            CreditTransferTransactionInformation = [ValidTransaction() with { ExpiryDateTime = new DateTime(2026, 2, 1) }],
        };
        var result = _sut.Validate(msg);
    ...
    [Fact]
    public void GroupHeaderExpiryDateTimePresent_TransactionExpiryAbsent_NoValidationError()
    {
        var msg = ValidMessage() with
        {
            GroupHeader = ValidGroupHeader() with { ExpiryDateTime = new DateTime(2026, 2, 1) },
