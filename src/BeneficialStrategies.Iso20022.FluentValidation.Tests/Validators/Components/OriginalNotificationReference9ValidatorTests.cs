...
public class OriginalNotificationReference9ValidatorTests
{
    private readonly OriginalNotificationReference9Validator _sut = new();
    ...
    private static OriginalItemAndStatus6 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference9 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
