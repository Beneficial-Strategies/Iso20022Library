...
public class AccountNotification23ValidatorTests
{
    private readonly AccountNotification23Validator _sut = new();
    ...
    private static NotificationItem9 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static AccountNotification23 ValidMessage() =>
        new()
        {
