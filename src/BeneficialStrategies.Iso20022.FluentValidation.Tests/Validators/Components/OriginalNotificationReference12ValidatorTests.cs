...
public class OriginalNotificationReference12ValidatorTests
{
    private readonly OriginalNotificationReference12Validator _sut = new();
    ...
    private static OriginalItem7 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference12 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
