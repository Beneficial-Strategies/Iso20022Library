...
public class OriginalNotificationReference5ValidatorTests
{
    private readonly OriginalNotificationReference5Validator _sut = new();
    ...
    private static OriginalItemAndStatus4 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference5 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
