...
public class ChargesPerTransactionRecord4ValidatorTests
{
    private readonly ChargesPerTransactionRecord4Validator _sut = new();

    private static ChargesBreakdown1 ValidBreakdown() =>
        new() { Amount = new ActiveCurrencyAndAmount { Currency = "USD", Amount = 10m } };

    private static ChargesPerTransactionRecord4 ValidMessage() =>
