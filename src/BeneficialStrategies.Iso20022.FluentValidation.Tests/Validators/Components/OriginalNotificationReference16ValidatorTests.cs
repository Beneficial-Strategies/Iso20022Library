...
public class OriginalNotificationReference16ValidatorTests
{
    private readonly OriginalNotificationReference16Validator _sut = new();
    ...
    private static OriginalItem9 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference16 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
