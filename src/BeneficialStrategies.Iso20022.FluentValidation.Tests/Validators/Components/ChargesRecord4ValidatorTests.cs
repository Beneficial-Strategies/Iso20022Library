...
public class ChargesRecord4ValidatorTests
{
    private readonly ChargesRecord4Validator _sut = new();

    private static ChargesRecord4 ValidMessage() =>
        new()
        {
            Amount = new ActiveCurrencyAndAmount { Currency = "USD", Amount = 10m },
            ChargesAccount = new CashAccount40(),
