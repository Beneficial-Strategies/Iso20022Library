...
public class AccountNotification4ValidatorTests
{
    private readonly AccountNotification4Validator _sut = new();
    ...
    private static NotificationItem3 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static AccountNotification4 ValidMessage() =>
        new()
        {
