...
public class OriginalNotificationReference7ValidatorTests
{
    private readonly OriginalNotificationReference7Validator _sut = new();
    ...
    private static OriginalItemAndStatus5 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference7 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
