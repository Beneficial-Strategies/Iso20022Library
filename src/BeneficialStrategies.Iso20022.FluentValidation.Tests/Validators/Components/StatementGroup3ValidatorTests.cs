...
public class StatementGroup3ValidatorTests
{
    private readonly StatementGroup3Validator _sut = new();
    ...
    private static BillingStatement3 ValidBillingStatement() =>
        new()
        {
            ...
            AccountCharacteristics = new CashAccountCharacteristics3
            {
                AccountLevel = Codesets.AccountLevel2Code.Detail,
                CashAccount = new CashAccount38
                {
    ...
    private static StatementGroup3 ValidMessage() =>
        new()
        {
    ...
    // ── BillingStatement: BillingStatement3, 1..∞ ─────────────────────────────
