...
public class MandateCancellationReason2ValidatorTests
{
    private readonly MandateCancellationReason2Validator _sut = new();
    ...
    private static MandateCancellationReason2 ValidMessage() => new() { Reason = ValidReason() };
