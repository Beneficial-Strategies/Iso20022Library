...
public class OriginalNotificationReference15ValidatorTests
{
    private readonly OriginalNotificationReference15Validator _sut = new();
    ...
    private static OriginalItemAndStatus9 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference15 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
