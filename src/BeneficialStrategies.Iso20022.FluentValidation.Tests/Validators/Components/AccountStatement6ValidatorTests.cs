...
public class AccountStatement6ValidatorTests
{
    private readonly AccountStatement6Validator _sut = new();

    private static CashBalance7 ValidBalance() =>
        new()
        {
    ...
    private static AccountStatement6 ValidMessage() =>
        new()
        {
