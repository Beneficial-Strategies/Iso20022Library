...
public class OriginalNotificationReference1ValidatorTests
{
    private readonly OriginalNotificationReference1Validator _sut = new();
    ...
    private static OriginalItem2 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference1 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
