...
public class OriginalNotificationReference4ValidatorTests
{
    private readonly OriginalNotificationReference4Validator _sut = new();
    ...
    private static OriginalItem3 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference4 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
