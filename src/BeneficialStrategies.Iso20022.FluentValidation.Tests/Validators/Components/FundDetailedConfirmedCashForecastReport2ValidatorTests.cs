...
public class FundDetailedConfirmedCashForecastReport2ValidatorTests
{
    private readonly FundDetailedConfirmedCashForecastReport2Validator _sut = new();

    private static FundCashForecast4 MinimalItem() =>
        new()
        {
    ...
    private static FundDetailedConfirmedCashForecastReport2 ValidMessage() =>
    ...
    // ── FundCashForecastDetails: FundCashForecast4, 1..∞ ──────────────────────
