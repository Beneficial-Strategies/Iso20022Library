...
public class AccountNotification6ValidatorTests
{
    private readonly AccountNotification6Validator _sut = new();
    ...
    private static NotificationItem4 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static AccountNotification6 ValidMessage() =>
        new()
        {
