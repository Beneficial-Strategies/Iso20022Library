...
public class ChargesPerType3ValidatorTests
{
    private readonly ChargesPerType3Validator _sut = new();
    ...
    private static ChargesPerTypeRecord3 MinimalRecord() =>
        new()
        {
    ...
    private static ChargesPerType3 ValidMessage() =>
        new()
        {
    ...
    // ── Record: ChargesPerTypeRecord3, 1..∞ ───────────────────────────────────
