...
public class OriginalNotificationReference3ValidatorTests
{
    private readonly OriginalNotificationReference3Validator _sut = new();
    ...
    private static OriginalItemAndStatus3 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference3 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
