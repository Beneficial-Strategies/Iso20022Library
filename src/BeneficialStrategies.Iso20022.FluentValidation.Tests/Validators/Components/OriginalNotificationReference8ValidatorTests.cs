...
public class OriginalNotificationReference8ValidatorTests
{
    private readonly OriginalNotificationReference8Validator _sut = new();
    ...
    private static OriginalItem5 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference8 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
