...
public class OriginalNotificationReference13ValidatorTests
{
    private readonly OriginalNotificationReference13Validator _sut = new();
    ...
    private static OriginalItemAndStatus8 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference13 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
