...
public class OriginalNotificationReference11ValidatorTests
{
    private readonly OriginalNotificationReference11Validator _sut = new();
    ...
    private static OriginalItemAndStatus7 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference11 ValidMessage() => new() { OriginalItemAndStatus = [MinimalItem()] };
