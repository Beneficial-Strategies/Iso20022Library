...
public class ChargesPerTransactionRecord6ValidatorTests
{
    private readonly ChargesPerTransactionRecord6Validator _sut = new();

    private static ChargesBreakdown1 ValidBreakdown() =>
        new() { Amount = new ActiveCurrencyAndAmount { Currency = "USD", Amount = 10m } };

    private static ChargesPerTransactionRecord6 ValidMessage() =>
