...
public class ChargesPerTransaction5ValidatorTests
{
    private readonly ChargesPerTransaction5Validator _sut = new();
    ...
    private static ChargesPerTransactionRecord5 MinimalRecord() =>
        new() { UnderlyingTransaction = new TransactionReferences7() };

    private static ChargesPerTransaction5 ValidMessage() => new() { Record = [MinimalRecord()] };
    ...
    // ── Record: ChargesPerTransactionRecord5, 1..∞ ────────────────────────────
