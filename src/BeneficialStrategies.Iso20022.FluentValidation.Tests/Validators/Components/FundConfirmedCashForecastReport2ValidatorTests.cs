...
public class FundConfirmedCashForecastReport2ValidatorTests
{
    private readonly FundConfirmedCashForecastReport2Validator _sut = new();

    private static FundCashForecast3 MinimalItem() =>
        new()
        {
    ...
    private static FundConfirmedCashForecastReport2 ValidMessage() =>
    ...
    // ── FundCashForecastDetails: FundCashForecast3, 1..∞ ──────────────────────
