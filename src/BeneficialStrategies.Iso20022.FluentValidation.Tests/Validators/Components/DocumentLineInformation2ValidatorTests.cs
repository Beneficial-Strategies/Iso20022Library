...
public class DocumentLineInformation2ValidatorTests
{
    private readonly DocumentLineInformation2Validator _sut = new();

    private static DocumentLineInformation2 ValidMessage() =>
