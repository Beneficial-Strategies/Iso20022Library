...
public class OriginalNotificationReference10ValidatorTests
{
    private readonly OriginalNotificationReference10Validator _sut = new();
    ...
    private static OriginalItem6 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference10 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
