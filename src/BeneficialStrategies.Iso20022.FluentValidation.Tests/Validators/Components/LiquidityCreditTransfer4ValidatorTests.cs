...
public class LiquidityCreditTransfer4ValidatorTests
{
    private readonly LiquidityCreditTransfer4Validator _sut = new();
    ...
    private static LiquidityCreditTransfer4 ValidMessage() => new() { TransferredAmount = ValidAmount() };
