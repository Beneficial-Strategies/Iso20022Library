...
public class OriginalNotificationReference6ValidatorTests
{
    private readonly OriginalNotificationReference6Validator _sut = new();
    ...
    private static OriginalItem4 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static OriginalNotificationReference6 ValidMessage() => new() { OriginalItem = [MinimalItem()] };
