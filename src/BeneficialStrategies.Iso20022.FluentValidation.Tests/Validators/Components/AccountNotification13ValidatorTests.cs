...
public class AccountNotification13ValidatorTests
{
    private readonly AccountNotification13Validator _sut = new();
    ...
    private static NotificationItem6 MinimalItem(string currency = "USD", decimal amount = 100m) =>
        new()
        {
    ...
    private static AccountNotification13 ValidMessage() =>
        new()
        {
