...
public class AccountStatement8ValidatorTests
{
    private readonly AccountStatement8Validator _sut = new();
    ...
    private static AccountStatement8 ValidMessage() =>
        new()
        {
            Identification = "STMT-001",
            Account = new CashAccount36
            {
