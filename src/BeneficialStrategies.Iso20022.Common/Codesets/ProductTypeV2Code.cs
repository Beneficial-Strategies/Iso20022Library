...
[Derivations(
    typeof(ProductType4Code),
    typeof(ProductType5Code),
    typeof(ProductType6Code),
    typeof(ProductType7Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ProductTypeV2Code>))]
