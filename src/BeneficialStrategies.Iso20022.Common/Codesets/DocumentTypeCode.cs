...
[Derivations(
    typeof(DocumentType4Code),
    typeof(DocumentType3Code),
    typeof(DocumentType6Code),
    typeof(DocumentType1Code),
    typeof(DocumentType7Code),
    typeof(DocumentType5Code),
    typeof(DocumentType2Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<DocumentTypeCode>))]
