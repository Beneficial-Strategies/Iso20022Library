...
[Derivations(
    typeof(AdditionalBusinessProcess1Code),
    typeof(AdditionalBusinessProcess6Code),
    typeof(AdditionalBusinessProcess4Code),
    typeof(AdditionalBusinessProcess11Code),
    typeof(AdditionalBusinessProcess5Code),
    typeof(AdditionalBusinessProcess7Code),
    typeof(AdditionalBusinessProcess10Code),
    typeof(AdditionalBusinessProcess3Code),
    typeof(AdditionalBusinessProcess2Code),
