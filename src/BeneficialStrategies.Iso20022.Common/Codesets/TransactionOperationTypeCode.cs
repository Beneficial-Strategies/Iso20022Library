...
[Derivations(
    typeof(TransactionOperationType3Code),
    typeof(TransactionOperationType7Code),
    typeof(TransactionOperationType6Code),
    typeof(TransactionOperationType4Code),
    typeof(TransactionOperationType5Code),
    typeof(TransactionOperationType1Code)
)]
[Obsolete("Marked obsolete in the ISO 20022 2025-04-24 snapshot. No removal date recorded.")]
[JsonConverter(typeof(Iso20022EnumJsonConverter<TransactionOperationTypeCode>))]
