...
public enum ExternalDocumentAmountType1Code
{
    ...
    NewCharges = ExternalDocumentAmountTypeCode.NewCharges, // same ordinal as derivation source for type conversions
    ...
    CityTax = ExternalDocumentAmountTypeCode.CityTax, // same ordinal as derivation source for type conversions
    ...
    CountyTax = ExternalDocumentAmountTypeCode.CountyTax, // same ordinal as derivation source for type conversions
    ...
    CreditNote = ExternalDocumentAmountTypeCode.CreditNote, // same ordinal as derivation source for type conversions
    ...
    AvailableCredit = ExternalDocumentAmountTypeCode.AvailableCredit, // same ordinal as derivation source for type conversions
    ...
    DuePayable = ExternalDocumentAmountTypeCode.DuePayable, // same ordinal as derivation source for type conversions
    ...
    Escrow = ExternalDocumentAmountTypeCode.Escrow, // same ordinal as derivation source for type conversions
    ...
    Fees = ExternalDocumentAmountTypeCode.Fees, // same ordinal as derivation source for type conversions
    ...
    Insurance = ExternalDocumentAmountTypeCode.Insurance, // same ordinal as derivation source for type conversions
    ...
    InterestCharges = ExternalDocumentAmountTypeCode.InterestCharges, // same ordinal as derivation source for type conversions
    ...
    InterestPayment = ExternalDocumentAmountTypeCode.InterestPayment, // same ordinal as derivation source for type conversions
    ...
    LocalTax = ExternalDocumentAmountTypeCode.LocalTax, // same ordinal as derivation source for type conversions
    ...
    MinimumDue = ExternalDocumentAmountTypeCode.MinimumDue, // same ordinal as derivation source for type conversions
    ...
    OutstandingBalance = ExternalDocumentAmountTypeCode.OutstandingBalance, // same ordinal as derivation source for type conversions
    ...
    PastDue = ExternalDocumentAmountTypeCode.PastDue, // same ordinal as derivation source for type conversions
    ...
    PreviousBalance = ExternalDocumentAmountTypeCode.PreviousBalance, // same ordinal as derivation source for type conversions
    ...
    OutstandingPrincipal = ExternalDocumentAmountTypeCode.OutstandingPrincipal, // same ordinal as derivation source for type conversions
    ...
    ProvinceTax = ExternalDocumentAmountTypeCode.ProvinceTax, // same ordinal as derivation source for type conversions
    ...
    Remitted = ExternalDocumentAmountTypeCode.Remitted, // same ordinal as derivation source for type conversions
    ...
    StatementBalance = ExternalDocumentAmountTypeCode.StatementBalance, // same ordinal as derivation source for type conversions
    ...
    [IsoId("")]
    [Description(@"Amount is tax accessed by state jurisdictions within a country.")]
    StateTax = ExternalDocumentAmountTypeCode.StateTax, // same ordinal as derivation source for type conversions
    ...
    StandingDiscount = ExternalDocumentAmountTypeCode.StandingDiscount, // same ordinal as derivation source for type conversions
    ...
    Tax = ExternalDocumentAmountTypeCode.Tax, // same ordinal as derivation source for type conversions
    ...
    TermsDiscount = ExternalDocumentAmountTypeCode.TermsDiscount, // same ordinal as derivation source for type conversions
