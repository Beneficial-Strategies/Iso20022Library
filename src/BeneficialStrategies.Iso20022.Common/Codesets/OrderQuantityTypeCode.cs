...
[Derivations(
    typeof(OrderQuantityType3Code),
    typeof(OrderQuantityType1Code),
    typeof(OrderQuantityType2Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<OrderQuantityTypeCode>))]
