...
[Derivations(
    typeof(PendingCancellationReason7Code),
    typeof(FailingReason2Code),
    typeof(PendingReason1Code),
    typeof(PendingReason17Code),
    typeof(PendingReason2Code),
    typeof(PendingReason7Code),
    typeof(PendingReason9Code),
    typeof(PendingReason19Code),
    typeof(PendingReason5Code),
    typeof(PendingReason4Code),
    typeof(PendingProcessingReason2Code),
    typeof(PendingCancellationReason2Code),
    typeof(PendingProcessingReason3Code),
    typeof(PendingReason6Code),
    typeof(PendingReason10Code),
    typeof(PendingReason3Code),
    typeof(PendingCancellationReason1Code),
    typeof(PendingReason11Code),
    typeof(FailingReason1Code),
    typeof(FailingReason3Code),
    typeof(PendingReason8Code),
    typeof(PendingProcessingReason4Code),
    typeof(PendingReason13Code),
