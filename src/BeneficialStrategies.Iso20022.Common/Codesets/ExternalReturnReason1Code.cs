...
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalReturnReason1Code>))]
public enum ExternalReturnReason1Code
{
    ...
    MissingMandatoryInformationInMandate =
        ExternalReturnReasonCode.MissingMandatoryInformationInMandate, // same ordinal as derivation source for type conversions
    ...
    NotSpecifiedReasonCustomerGenerated =
        ExternalReturnReasonCode.NotSpecifiedReasonCustomerGenerated, // same ordinal as derivation source for type conversions
    ...
    MissingDebtorAccountOrIdentification =
        ExternalReturnReasonCode.MissingDebtorAccountOrIdentification, // same ordinal as derivation source for type conversions
    ...
    SpecificServiceOfferedByDebtorAgent =
        ExternalReturnReasonCode.SpecificServiceOfferedByDebtorAgent, // same ordinal as derivation source for type conversions
    ...
    SpecificServiceOfferedByCreditorAgent =
        ExternalReturnReasonCode.SpecificServiceOfferedByCreditorAgent, // same ordinal as derivation source for type conversions
    ...
    MaximumNumberOfDirectDebitTransactionsExceeded =
        ExternalReturnReasonCode.MaximumNumberOfDirectDebitTransactionsExceeded, // same ordinal as derivation source for type conversions
    ...
    MaximumDirectDebitTransactionAmountExceeded =
        ExternalReturnReasonCode.MaximumDirectDebitTransactionAmountExceeded, // same ordinal as derivation source for type conversions
    ...
    InvalidClearingSystemMemberIdentifier =
        ExternalReturnReasonCode.InvalidClearingSystemMemberIdentifier, // same ordinal as derivation source for type conversions
    ...
    InvalidDebtorAgentServiceIdentification =
        ExternalReturnReasonCode.InvalidDebtorAgentServiceIdentification, // same ordinal as derivation source for type conversions
    ...
    InvalidStructuredCreditorReference =
        ExternalReturnReasonCode.InvalidStructuredCreditorReference, // same ordinal as derivation source for type conversions
