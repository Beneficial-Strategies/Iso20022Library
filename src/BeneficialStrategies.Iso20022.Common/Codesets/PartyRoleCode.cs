...
[Derivations(
    typeof(InvestmentFundRole2Code),
    typeof(InvestmentFundRole4Code),
    typeof(PaymentRole1Code),
    typeof(InvestmentFundRole3Code),
    typeof(PartyRole1Code),
    typeof(InvestmentFundRole5Code),
    typeof(PartyRole2Code),
    typeof(InvestmentFundRole8Code),
    typeof(InvestmentFundRole6Code),
    typeof(InvestmentFundRole7Code),
