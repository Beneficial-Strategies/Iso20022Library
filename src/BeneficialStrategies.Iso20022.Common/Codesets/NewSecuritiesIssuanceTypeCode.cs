...
[Derivations(
    typeof(NewSecuritiesIssuanceType5Code),
    typeof(NewSecuritiesIssuanceType6Code),
    typeof(NewSecuritiesIssuanceType4Code),
    typeof(NewSecuritiesIssuanceType3Code),
    typeof(NewSecuritiesIssuanceType1Code),
    typeof(NewSecuritiesIssuanceType2Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<NewSecuritiesIssuanceTypeCode>))]
