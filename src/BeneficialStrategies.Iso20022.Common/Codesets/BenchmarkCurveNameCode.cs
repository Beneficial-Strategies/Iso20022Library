...
[Derivations(
    typeof(BenchmarkCurveName1Code),
    typeof(BenchmarkCurveName2Code),
    typeof(BenchmarkCurveName3Code),
    typeof(BenchmarkCurveName5Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<BenchmarkCurveNameCode>))]
