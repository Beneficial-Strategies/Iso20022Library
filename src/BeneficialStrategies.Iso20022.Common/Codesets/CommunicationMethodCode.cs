...
[Derivations(
    typeof(CommunicationMethod1Code),
    typeof(CommunicationMethod2Code),
    typeof(CommunicationMethod3Code),
    typeof(CommunicationMethod4Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<CommunicationMethodCode>))]
