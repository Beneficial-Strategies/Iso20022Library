...
public enum InvestmentFundMiFIDFee1Code
{
    ...
    GrossOneOffMaximumEntryCostNonAcquired =
        InvestmentFundMiFIDFeeCode.GrossOneOffMaximumEntryCostNonAcquired, // same ordinal as derivation source for type conversions
    ...
    GrossOneOffMaximumEntryCostStructured =
        InvestmentFundMiFIDFeeCode.GrossOneOffMaximumEntryCostStructured, // same ordinal as derivation source for type conversions
    ...
    OneOffMaximumEntryCostFixedAmountItaly =
        InvestmentFundMiFIDFeeCode.OneOffMaximumEntryCostFixedAmountItaly, // same ordinal as derivation source for type conversions
    ...
    OneOffMaximumExitCostFixedAmountItaly =
        InvestmentFundMiFIDFeeCode.OneOffMaximumExitCostFixedAmountItaly, // same ordinal as derivation source for type conversions
    ...
    OngoingCostsAccumulatedStructured =
        InvestmentFundMiFIDFeeCode.OngoingCostsAccumulatedStructured, // same ordinal as derivation source for type conversions
