...
[DataContract]
[Serializable]
[IsoId("5c3971c2-65c3-4358-81f5-c57788b09352")]
[Description(
    @"Specifies the reason the transaction/instruction is pending or failing settlement. Settlement on the instructed settlement date is still possible, status is pending. Settlement on the instructed settlement date is no longer possible, status is failing."
)]
[DerivedFrom(typeof(PendingFailingReasonV4Code))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<PendingProcessingReason5Code>))]
public enum PendingProcessingReason5Code
{
    ...
    [IsoId("_scxmJym4EfGfZ9PfK70MMg")]
    [Description(@"Transaction was put on hold/frozen by the system.")]
    SystemOnHold = PendingFailingReasonV4Code.SystemOnHold, // same ordinal as derivation source for type conversions
