...
[JsonConverter(typeof(Iso20022EnumJsonConverter<DTCAdjustmentPaymentType4Code>))]
public enum DTCAdjustmentPaymentType4Code
{
    ...
    MandatoryLegalReorganisationDeposit =
        DTCAdjustmentPaymentTypeV3Code.MandatoryLegalReorganisationDeposit, // same ordinal as derivation source for type conversions
    ...
    MandatoryOverThreeYearReorganisationDeposit =
        DTCAdjustmentPaymentTypeV3Code.MandatoryOverThreeYearReorganisationDeposit, // same ordinal as derivation source for type conversions
    ...
    IntraDayReversalOfOriginalTaxWithholding =
        DTCAdjustmentPaymentTypeV3Code.IntraDayReversalOfOriginalTaxWithholding, // same ordinal as derivation source for type conversions
