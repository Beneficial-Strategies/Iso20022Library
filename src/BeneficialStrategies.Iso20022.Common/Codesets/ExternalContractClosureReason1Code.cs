...
public enum ExternalContractClosureReason1Code
{
    ...
    OtherReasonsThatTheLiabilitiesOfTheContractAreFufilled =
        ExternalContractClosureReasonCode.OtherReasonsThatTheLiabilitiesOfTheContractAreFufilled, // same ordinal as derivation source for type conversions
    ...
    ContractRegistrationNotRequired =
        ExternalContractClosureReasonCode.ContractRegistrationNotRequired, // same ordinal as derivation source for type conversions
    ...
    PartyCedesAClaimOrTransfersADebtToAnotherResidentParty =
        ExternalContractClosureReasonCode.PartyCedesAClaimOrTransfersADebtToAnotherResidentParty, // same ordinal as derivation source for type conversions
    ...
    PartySubsitutedRegistrationIsNotRequired =
        ExternalContractClosureReasonCode.PartySubsitutedRegistrationIsNotRequired, // same ordinal as derivation source for type conversions
    ...
    TransferredToAnotherRegistrationAgentOrAllAccountsClosed =
        ExternalContractClosureReasonCode.TransferredToAnotherRegistrationAgentOrAllAccountsClosed, // same ordinal as derivation source for type conversions
    ...
    AllContractliabilitieshavebeenfulfilledbytheRegistrationAgent =
        ExternalContractClosureReasonCode.AllContractliabilitieshavebeenfulfilledbytheRegistrationAgent, // same ordinal as derivation source for type conversions
