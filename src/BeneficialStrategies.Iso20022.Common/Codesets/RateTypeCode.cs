...
[Derivations(
    typeof(RateValueType6Code),
    typeof(RateValueType7Code),
    typeof(RateType10Code),
    typeof(RateType13Code),
    typeof(RateType8Code),
    typeof(RateType9Code),
    typeof(RateType3Code),
