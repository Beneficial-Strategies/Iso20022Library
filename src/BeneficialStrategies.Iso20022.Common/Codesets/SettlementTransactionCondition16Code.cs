...
[JsonConverter(typeof(Iso20022EnumJsonConverter<SettlementTransactionCondition16Code>))]
public enum SettlementTransactionCondition16Code
{
    /// <summary>
