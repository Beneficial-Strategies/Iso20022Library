...
[Derivations(
    typeof(NetDividendRateType7Code),
    typeof(NetDividendRateType6Code),
    typeof(GrossDividendRateType7Code),
    typeof(GrossDividendRateType6Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<DividendRateTypeV2Code>))]
