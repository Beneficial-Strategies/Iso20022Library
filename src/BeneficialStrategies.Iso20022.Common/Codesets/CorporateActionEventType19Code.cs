...
[JsonConverter(typeof(Iso20022EnumJsonConverter<CorporateActionEventType19Code>))]
public enum CorporateActionEventType19Code
{
    ...
    CashDistributionFromNonEligibleSecuritiesSales =
        CorporateActionEventTypeV5Code.CashDistributionFromNonEligibleSecuritiesSales, // same ordinal as derivation source for type conversions
    ...
    IntermediateSecuritiesDistribution =
        CorporateActionEventTypeV5Code.IntermediateSecuritiesDistribution, // same ordinal as derivation source for type conversions
    ...
    PartialRedemptionWithNominalValueReduction =
        CorporateActionEventTypeV5Code.PartialRedemptionWithNominalValueReduction, // same ordinal as derivation source for type conversions
    ...
    PartialRedemptionWithoutNominalValueReduction =
        CorporateActionEventTypeV5Code.PartialRedemptionWithoutNominalValueReduction, // same ordinal as derivation source for type conversions
    ...
    WithholdingTaxReliefCertification =
        CorporateActionEventTypeV5Code.WithholdingTaxReliefCertification, // same ordinal as derivation source for type conversions
