...
[Derivations(
    typeof(ExposureType4Code),
    typeof(ExposureType1Code),
    typeof(ExposureType6Code),
    typeof(ExposureType5Code),
    typeof(ExposureType8Code),
    typeof(ExposureType2Code)
)]
[Obsolete("Marked obsolete in the ISO 20022 2025-04-24 snapshot. No removal date recorded.")]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExposureTypeCode>))]
