...
[Derivations(
    typeof(EncryptionFormat1Code),
    typeof(EncryptionFormat2Code),
    typeof(EncryptionFormat3Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<EncryptionFormatCode>))]
