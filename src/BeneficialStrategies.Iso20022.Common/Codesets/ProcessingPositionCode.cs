...
[Derivations(
    typeof(ProcessingPosition3Code),
    typeof(ProcessingPosition4Code),
    typeof(ProcessingPosition2Code),
    typeof(ProcessingPosition5Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ProcessingPositionCode>))]
