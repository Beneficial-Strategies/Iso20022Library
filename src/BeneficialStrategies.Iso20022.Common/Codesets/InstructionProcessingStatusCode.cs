...
[Derivations(
    typeof(SettlementConditionModificationProcessingStatus1Code),
    typeof(IntraPositionTransactionProcessingStatus1Code),
    typeof(TransactionProcessingStatus2Code),
    typeof(TransactionProcessingStatus3Code),
    typeof(TransactionProcessingStatus1Code),
    typeof(TransactionProcessingStatus4Code),
    typeof(InstructionProcessingStatus1Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<InstructionProcessingStatusCode>))]
