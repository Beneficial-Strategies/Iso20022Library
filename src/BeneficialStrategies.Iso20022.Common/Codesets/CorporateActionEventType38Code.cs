...
[DataContract]
[Serializable]
[IsoId("_wAqYkYCfEe-3UrLQHGsjgQ")]
[Description(@"Specifies the corporate action event type.")]
[DerivedFrom(typeof(CorporateActionEventTypeV7Code))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<CorporateActionEventType38Code>))]
public enum CorporateActionEventType38Code
{
    ...
    Accumulation = CorporateActionEventTypeV7Code.Accumulation, // same ordinal as derivation source for type conversions
    ...
    CashDistributionFromNonEligibleSecuritiesSales =
        CorporateActionEventTypeV7Code.CashDistributionFromNonEligibleSecuritiesSales, // same ordinal as derivation source for type conversions
    ...
    Information = CorporateActionEventTypeV7Code.Information, // same ordinal as derivation source for type conversions
    ...
    SecuritiesHoldersMeeting = CorporateActionEventTypeV7Code.SecuritiesHoldersMeeting, // same ordinal as derivation source for type conversions
    ...
    PartialRedemptionWithoutPoolFactorReduction =
        CorporateActionEventTypeV7Code.PartialRedemptionWithoutPoolFactorReduction, // same ordinal as derivation source for type conversions
    ...
    PartialRedemptionWithPoolFactorReduction =
        CorporateActionEventTypeV7Code.PartialRedemptionWithPoolFactorReduction, // same ordinal as derivation source for type conversions
    ...
    Reclassification = CorporateActionEventTypeV7Code.Reclassification, // same ordinal as derivation source for type conversions
    ...
    IntermediateSecuritiesDistribution =
        CorporateActionEventTypeV7Code.IntermediateSecuritiesDistribution, // same ordinal as derivation source for type conversions
    ...
    TaxOnNonDistributedProceeds = CorporateActionEventTypeV7Code.TaxOnNonDistributedProceeds, // same ordinal as derivation source for type conversions
    ...
    WithholdingTaxReliefCertification =
        CorporateActionEventTypeV7Code.WithholdingTaxReliefCertification, // same ordinal as derivation source for type conversions
}
