...
public enum ExtendedOptionFeature2Code
{
    ...
    [Description(@"DTC only option. The event and security are eligible for both the Dividend Reinvestment and Foreign Tax Relief services at DTC. Participants electing this option will receive additional shares and the tax withholding on those shares will be at the favourable tax rate.")]
    ...
    [Description(@"DTC only option. The event and security are eligible for both the Dividend Reinvestment and Foreign Tax services at DTC. Participants electing this option will receive additional shares and the tax withholding on those shares will be at the unfavourable tax rate.")]
    ...
    [Description(@"DTC only option. The event and security are eligible for both the Dividend Reinvestment and the Foreign Tax Relief services at DTC. Participants electing this option will receive additional shares and will be exempt from any tax withholding.")]
    ...
    [Description(@"DTC only option. The event and security are eligible for both the Foreign Currency and Foreign Tax services at DTC. Participants electing the option will receive their distribution in foreign currency and the tax withholding will be subject to favourable tax withholding.")]
    ...
    [Description(@"DTC only option. The event and security are eligible for Foreign Currency Payment service at DTC. Participants electing this option will receive their distribution in the foreign currency instructed.")]
    ...
    [Description(@"DTC only option. The event and security are eligible for both the Foreign Currency and Foreign Tax services at DTC. Participants electing this option will receive their distribution in a foreign currency and the tax withholding will be subject to unfavourable tax withholding.")]
    ...
    [Description(@"DTC only option. Participants electing this option will receive their distribution in a foreign currency and will be exempt from any tax withholding.")]
    ...
    [Description(@"DTC only option. Eligible for the Foreign Tax Relief service at DTC. An election ensures the participant receives their payment at a favourable tax withholding rate.")]
    ...
    [Description(@"DTC only option. Eligible for the Foreign Tax Relief service at DTC. Option to select unfavourable tax rate.")]
    ...
    [Description(@"DTC only option. Eligible for the Foreign Tax Relief service at DTC. An election ensures the participant is exempt from any tax withholding.")]
    ...
    [Description(@"Indicates option in which holders must not provide a shareholder number if provided will be rejected.")]
