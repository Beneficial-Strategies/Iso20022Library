...
public enum ExternalPaymentTransactionStatus1Code
{
    ...
    AcceptedSettlementCompletedCreditorAccount =
        ExternalPaymentTransactionStatusCode.AcceptedSettlementCompletedCreditorAccount, // same ordinal as derivation source for type conversions
    ...
    AcceptedSettlementCompletedDebitorAccount =
        ExternalPaymentTransactionStatusCode.AcceptedSettlementCompletedDebitorAccount, // same ordinal as derivation source for type conversions
    ...
    PartiallyAcceptedTechnicalCorrect =
        ExternalPaymentTransactionStatusCode.PartiallyAcceptedTechnicalCorrect, // same ordinal as derivation source for type conversions
