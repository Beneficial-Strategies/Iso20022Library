...
[JsonConverter(typeof(Iso20022EnumJsonConverter<DTCCSubEventType9Code>))]
public enum DTCCSubEventType9Code
{
    ...
    NameAndCUSIPChangeAndPresentationRequired =
        DTCCSubEventTypeCode.NameAndCUSIPChangeAndPresentationRequired, // same ordinal as derivation source for type conversions
    ...
    AmountsInExcessOfCumulativeNetIncome =
        DTCCSubEventTypeCode.AmountsInExcessOfCumulativeNetIncome, // same ordinal as derivation source for type conversions
