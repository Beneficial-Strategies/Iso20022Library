...
[Derivations(
    typeof(FundCashAccount2Code),
    typeof(FundCashAccount3Code),
    typeof(FundCashAccount1Code),
    typeof(FundCashAccount4Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<FundCashAccountCode>))]
