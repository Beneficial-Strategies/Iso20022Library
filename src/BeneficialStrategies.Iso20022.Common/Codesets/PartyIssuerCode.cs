...
public enum PartyIssuerCode
{
    ...
    CaisseInterprofessionelleDepotsVirementsTitres =
        IssuerCode.CaisseInterprofessionelleDepotsVirementsTitres, // same ordinal as derivation source for type conversions
    ...
    CentralSecuritiesDepositoryDepositoCentralValores =
        IssuerCode.CentralSecuritiesDepositoryDepositoCentralValores, // same ordinal as derivation source for type conversions
    ...
    ShanghaiSecuritiesCentralClearingRegistrationCompany =
        IssuerCode.ShanghaiSecuritiesCentralClearingRegistrationCompany, // same ordinal as derivation source for type conversions
    ...
    DeutscheBoerseAGFrankfurterWertpapierborse =
        IssuerCode.DeutscheBoerseAGFrankfurterWertpapierborse, // same ordinal as derivation source for type conversions
    ...
    HongKongCentralClearingSecuritiesSettlementSystem =
        IssuerCode.HongKongCentralClearingSecuritiesSettlementSystem, // same ordinal as derivation source for type conversions
    ...
    InternationalSecuritiesClearingCorporation =
        IssuerCode.InternationalSecuritiesClearingCorporation, // same ordinal as derivation source for type conversions
    ...
    MortgageBackedSecuritiesClearingCorporation =
        IssuerCode.MortgageBackedSecuritiesClearingCorporation, // same ordinal as derivation source for type conversions
