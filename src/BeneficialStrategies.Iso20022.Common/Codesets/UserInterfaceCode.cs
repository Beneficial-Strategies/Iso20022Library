...
[Derivations(
    typeof(UserInterface7Code),
    typeof(UserInterface2Code),
    typeof(UserInterface5Code),
    typeof(UserInterface1Code),
    typeof(UserInterface4Code),
    typeof(UserInterface6Code),
