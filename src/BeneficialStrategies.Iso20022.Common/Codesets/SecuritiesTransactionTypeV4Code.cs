...
[Derivations(
    typeof(SecuritiesTransactionType23Code),
    typeof(SecuritiesTransactionType27Code),
    typeof(SecuritiesTransactionType28Code),
    typeof(SecuritiesTransactionType22Code),
    typeof(SecuritiesTransactionType25Code),
    typeof(SecuritiesTransactionType26Code),
    typeof(SecuritiesTransactionType24Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<SecuritiesTransactionTypeV4Code>))]
