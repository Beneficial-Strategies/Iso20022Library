...
[Derivations(
    typeof(POIComponentType4Code),
    typeof(POIComponentType3Code),
    typeof(POIComponentType6Code),
    typeof(POIComponentType5Code),
    typeof(POIComponentType2Code),
    typeof(POIComponentType1Code),
    typeof(POIComponentType7Code)
)]
