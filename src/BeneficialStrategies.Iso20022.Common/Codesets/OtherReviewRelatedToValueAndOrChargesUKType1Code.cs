...
[Description(@"Specifies the outcome of other review about fair value and/or charges. When used in reference to MiFID, this is in the scope of the European MiFID Template (EMT) reference 09070.")]
...
public enum OtherReviewRelatedToValueAndOrChargesUKType1Code
{
    ...
    [IsoId("")]
    [Description(@"In line with the ESMA supervisory briefing on the supervision of costs in UCITS and AIFs or relevant NCA supervisory activity.")]
