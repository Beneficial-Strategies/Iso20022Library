...
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalLocalInstrument1Code>))]
public enum ExternalLocalInstrument1Code
{
    ...
    DirectDebitConfirmedElectronicMandate =
        ExternalLocalInstrumentCode.DirectDebitConfirmedElectronicMandate, // same ordinal as derivation source for type conversions
    ...
    DirectDebitPaperMandateWithPaperAuthorization =
        ExternalLocalInstrumentCode.DirectDebitPaperMandateWithPaperAuthorization, // same ordinal as derivation source for type conversions
    ...
    DirectDebitUnconfirmedElectronicMandate =
        ExternalLocalInstrumentCode.DirectDebitUnconfirmedElectronicMandate, // same ordinal as derivation source for type conversions
    ...
    AncillarySystemTransferInitiation =
        ExternalLocalInstrumentCode.AncillarySystemTransferInitiation, // same ordinal as derivation source for type conversions
    ...
    PreauthorisedDirectDebitAccéléréAcceleratedClearing2DayOrdinaireNormalClearing4Day =
        ExternalLocalInstrumentCode.PreauthorisedDirectDebitAccéléréAcceleratedClearing2DayOrdinaireNormalClearing4Day, // same ordinal as derivation source for type conversions
    ...
    PreauthorisedDirectDebitOrdinaireNormalClearing4Day =
        ExternalLocalInstrumentCode.PreauthorisedDirectDebitOrdinaireNormalClearing4Day, // same ordinal as derivation source for type conversions
    ...
    PreauthorisedDirectDebitVérifiéVerifiedClearing =
        ExternalLocalInstrumentCode.PreauthorisedDirectDebitVérifiéVerifiedClearing, // same ordinal as derivation source for type conversions
    ...
    RecoveredBillofExchangeorPromissoryNote =
        ExternalLocalInstrumentCode.RecoveredBillofExchangeorPromissoryNote, // same ordinal as derivation source for type conversions
    ...
    PreauthorisedRevocableDirectDebit =
        ExternalLocalInstrumentCode.PreauthorisedRevocableDirectDebit, // same ordinal as derivation source for type conversions
    ...
    PreauthorisedRevocableUrgentDirectDebit =
        ExternalLocalInstrumentCode.PreauthorisedRevocableUrgentDirectDebit, // same ordinal as derivation source for type conversions
    ...
    PaymentsViaInternetOwnedByCurrence =
        ExternalLocalInstrumentCode.PaymentsViaInternetOwnedByCurrence, // same ordinal as derivation source for type conversions
    ...
    InstantCreditTransferNotTimeCritical =
        ExternalLocalInstrumentCode.InstantCreditTransferNotTimeCritical, // same ordinal as derivation source for type conversions
    ...
    InstantCreditTransferTimeCritical =
        ExternalLocalInstrumentCode.InstantCreditTransferTimeCritical, // same ordinal as derivation source for type conversions
    ...
    PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransfer =
        ExternalLocalInstrumentCode.PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransfer, // same ordinal as derivation source for type conversions
    ...
    PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransferNotTimeCritical =
        ExternalLocalInstrumentCode.PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransferNotTimeCritical, // same ordinal as derivation source for type conversions
    ...
    PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransferTimeCritical =
        ExternalLocalInstrumentCode.PaymentsViaInternetOwnedByCurrenceUsingInstantCreditTransferTimeCritical, // same ordinal as derivation source for type conversions
    ...
    PaymentViaAcceptgiroOwnedByCurrence =
        ExternalLocalInstrumentCode.PaymentViaAcceptgiroOwnedByCurrence, // same ordinal as derivation source for type conversions
    ...
    DirectDebitInitiatedByTheGovernmentWithSpecialConditions =
        ExternalLocalInstrumentCode.DirectDebitInitiatedByTheGovernmentWithSpecialConditions, // same ordinal as derivation source for type conversions
    ...
    OneOffAuthorisationConstructionIndustry =
        ExternalLocalInstrumentCode.OneOffAuthorisationConstructionIndustry, // same ordinal as derivation source for type conversions
    ...
    StandingAuthorisationCompaniesWithoutDebtorRevocationRight =
        ExternalLocalInstrumentCode.StandingAuthorisationCompaniesWithoutDebtorRevocationRight, // same ordinal as derivation source for type conversions
    ...
    CrossBorderCustomerCreditTransfer =
        ExternalLocalInstrumentCode.CrossBorderCustomerCreditTransfer, // same ordinal as derivation source for type conversions
    ...
    SEPABusinessToBusinessDirectDebit =
        ExternalLocalInstrumentCode.SEPABusinessToBusinessDirectDebit, // same ordinal as derivation source for type conversions
    ...
    DrawdownResponseValueToHonorADrawdownRequest =
        ExternalLocalInstrumentCode.DrawdownResponseValueToHonorADrawdownRequest, // same ordinal as derivation source for type conversions
    ...
    BankToBankDrawdownRequestOrResponseNonvalue =
        ExternalLocalInstrumentCode.BankToBankDrawdownRequestOrResponseNonvalue, // same ordinal as derivation source for type conversions
    ...
    CustomerOrCorporateDrawdownRequestOrResponseNonvalue =
        ExternalLocalInstrumentCode.CustomerOrCorporateDrawdownRequestOrResponseNonvalue, // same ordinal as derivation source for type conversions
    ...
    CashConcentrationOrDisbursementCorporateCounterparty =
        ExternalLocalInstrumentCode.CashConcentrationOrDisbursementCorporateCounterparty, // same ordinal as derivation source for type conversions
    ...
    PrearrangedPaymentOrDepositConsumerCounterparty =
        ExternalLocalInstrumentCode.PrearrangedPaymentOrDepositConsumerCounterparty, // same ordinal as derivation source for type conversions
