...
[Derivations(
    typeof(PendingSettlement2Code),
    typeof(PendingSettlementStatusReason1Code),
    typeof(PendingSettlementStatusReason2Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<PendingSettlementStatusReasonCode>))]
