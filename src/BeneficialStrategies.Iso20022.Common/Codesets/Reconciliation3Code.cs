...
[JsonConverter(typeof(Iso20022EnumJsonConverter<Reconciliation3Code>))]
public enum Reconciliation3Code
{
    ...
    DualSidedEEAPartiallyReconciledNoValuationReconciliation =
        ReconciliationCode.DualSidedEEAPartiallyReconciledNoValuationReconciliation, // same ordinal as derivation source for type conversions
    ...
    DualSidedEEAPartiallyReconciledValuationReconciliationOnly =
        ReconciliationCode.DualSidedEEAPartiallyReconciledValuationReconciliationOnly, // same ordinal as derivation source for type conversions
    ...
    SingleSidedEEAPartiallyReconciledNoValuationReconciliation =
        ReconciliationCode.SingleSidedEEAPartiallyReconciledNoValuationReconciliation, // same ordinal as derivation source for type conversions
    ...
    SingleSidedEEAPartiallyReconciledValuationReconciliationOnly =
        ReconciliationCode.SingleSidedEEAPartiallyReconciledValuationReconciliationOnly, // same ordinal as derivation source for type conversions
