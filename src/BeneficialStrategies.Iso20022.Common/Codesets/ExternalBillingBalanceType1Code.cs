...
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalBillingBalanceType1Code>))]
public enum ExternalBillingBalanceType1Code
{
    ...
    AdditionalBalReserveRequirement =
        ExternalBillingBalanceTypeCode.AdditionalBalReserveRequirement, // same ordinal as derivation source for type conversions
    ...
    DemandDepositAccountBalanceReserveRequirement =
        ExternalBillingBalanceTypeCode.DemandDepositAccountBalanceReserveRequirement, // same ordinal as derivation source for type conversions
    ...
    InterestBearingInvestableBalance =
        ExternalBillingBalanceTypeCode.InterestBearingInvestableBalance, // same ordinal as derivation source for type conversions
    ...
    InterestBearingNetCollectedBalance =
        ExternalBillingBalanceTypeCode.InterestBearingNetCollectedBalance, // same ordinal as derivation source for type conversions
    ...
    InterestBearingNegativeCollectedBalance =
        ExternalBillingBalanceTypeCode.InterestBearingNegativeCollectedBalance, // same ordinal as derivation source for type conversions
    ...
    InterestBearingPositiveCollectedBalance =
        ExternalBillingBalanceTypeCode.InterestBearingPositiveCollectedBalance, // same ordinal as derivation source for type conversions
    ...
    InterestBearingReserveRequirementBalance =
        ExternalBillingBalanceTypeCode.InterestBearingReserveRequirementBalance, // same ordinal as derivation source for type conversions
