...
[Description(
    @"Specifies the cancellation reason, as published in an external cancellation reason code set.|External code sets can be downloaded from www.iso20022.org."
)]
[DerivedFrom(typeof(ExternalCancellationReasonCode))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalCancellationReason1Code>))]
public enum ExternalCancellationReason1Code
{
    ...
    InvalidDebtorIdentificationCode =
        ExternalCancellationReasonCode.InvalidDebtorIdentificationCode, // same ordinal as derivation source for type conversions
    ...
    RequestToSettlementSystemAdministrator =
        ExternalCancellationReasonCode.RequestToSettlementSystemAdministrator, // same ordinal as derivation source for type conversions
