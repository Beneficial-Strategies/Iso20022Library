...
[Derivations(
    typeof(SecuritiesTransactionType19Code),
    typeof(SecuritiesTransactionType4Code),
    typeof(SecuritiesTransactionType7Code),
    typeof(SecuritiesTransactionType20Code),
    typeof(SecuritiesTransactionType8Code),
    typeof(SecuritiesTransactionType16Code),
    typeof(SecuritiesTransactionType10Code),
    typeof(SecuritiesTransactionType3Code),
    typeof(SecuritiesTransactionType18Code),
    typeof(SecuritiesTransactionType9Code),
    typeof(SecuritiesTransactionType17Code),
    typeof(SecuritiesTransactionType21Code),
    typeof(SecuritiesTransactionType1Code),
    typeof(SecuritiesTransactionType5Code),
    typeof(SecuritiesFinancingTransactionType1Code),
