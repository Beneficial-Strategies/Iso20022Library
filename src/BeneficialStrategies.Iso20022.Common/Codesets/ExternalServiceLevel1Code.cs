...
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalServiceLevel1Code>))]
public enum ExternalServiceLevel1Code
{
    ...
    TrackedFinancialInstitutionTransfer =
        ExternalServiceLevelCode.TrackedFinancialInstitutionTransfer, // same ordinal as derivation source for type conversions
    ...
    DomesticChequeClearingAndSettlement =
        ExternalServiceLevelCode.DomesticChequeClearingAndSettlement, // same ordinal as derivation source for type conversions
    ...
    InstantCreditTransferOrInstantDirectDebit =
        ExternalServiceLevelCode.InstantCreditTransferOrInstantDirectDebit, // same ordinal as derivation source for type conversions
    ...
    TrackedInboundCustomerCreditTransfer =
        ExternalServiceLevelCode.TrackedInboundCustomerCreditTransfer, // same ordinal as derivation source for type conversions
    ...
    TrackedInstantCustomerCreditTransfer =
        ExternalServiceLevelCode.TrackedInstantCustomerCreditTransfer, // same ordinal as derivation source for type conversions
    ...
    TrackedLowValueCrossBorderCustomerCreditTransfer =
        ExternalServiceLevelCode.TrackedLowValueCrossBorderCustomerCreditTransfer, // same ordinal as derivation source for type conversions
    ...
    EastAfricanPaymentSystem = ExternalServiceLevelCode.EastAfricanPaymentSystem, // same ordinal as derivation source for type conversions
    ...
    [IsoId("_bnz20DowEfCAEqSMW_k_Rg")]
    [Description(@"Payment must be executed following the Icelandic Rulebook Council Area (IRCA) scheme.")]
    IcelandicRulebookCouncilArea = ExternalServiceLevelCode.IcelandicRulebookCouncilArea, // same ordinal as derivation source for type conversions
    ...
    [IsoId("_CZ4wQhDQEfGq-eDWPqCtlw")]
    [Description(@"Transaction must be processed according to the Swift Scheme rulebook.")]
    SwiftScheme = ExternalServiceLevelCode.SwiftScheme, // same ordinal as derivation source for type conversions
}
