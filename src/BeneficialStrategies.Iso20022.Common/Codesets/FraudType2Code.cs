...
[DataContract]
[Serializable]
[IsoId("_mWXiQRODEfC1ZfCQz0xB3g")]
[Description(@"Identifies the type of fraud in a card payment environment.")]
[DerivedFrom(typeof(FraudTypeCode))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<FraudType2Code>))]
public enum FraudType2Code
{
    /// <summary>
