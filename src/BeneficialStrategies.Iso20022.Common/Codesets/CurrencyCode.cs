...
[DataContract]
[Serializable]
[IsoId("_bUhmRdp-Ed-ak6NoX_4Aeg_-1745414039")]
[Description(@"Code allocated to a currency, by a maintenance agency, under an international identification scheme as described in the latest edition of the international standard ISO 4217 ""Codes for the representation of currencies and funds"". Valid currency codes are registered with the ISO 4217 Maintenance Agency, and consist of three contiguous letters.")]
[JsonConverter(typeof(Iso20022ExternalCodeJsonConverter<CurrencyCode>))]
public readonly struct CurrencyCode : IIsoExternalCode, IEquatable<CurrencyCode>
{
    ...
    public CurrencyCode(string value)
    {
        if (!Regex.IsMatch(value, Pattern))
            throw new Iso20022FormatException(typeof(CurrencyCode), value, Pattern);
        Value = value;
    }
    ...
    /// <summary>Implicitly wraps a string as a <see cref="CurrencyCode"/>.</summary>
    ...
    /// <inheritdoc/>
    public bool Equals(CurrencyCode other) => Value == other.Value;
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public static bool operator ==(CurrencyCode a, CurrencyCode b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(CurrencyCode a, CurrencyCode b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(CurrencyCode a, string? b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(CurrencyCode a, string? b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, CurrencyCode b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(string? a, CurrencyCode b) => a != b.Value;
}
