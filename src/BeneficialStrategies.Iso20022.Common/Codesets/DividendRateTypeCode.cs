...
[Derivations(
    typeof(NetDividendRateType2Code),
    typeof(GrossDividendRateType4Code),
    typeof(GrossDividendRateType5Code),
    typeof(NetDividendRateType4Code),
    typeof(NetDividendRateType3Code),
    typeof(NetDividendRateType5Code),
    typeof(GrossDividendRateType3Code),
    typeof(NetDividendRateType1Code),
    typeof(DividendRateType1Code),
