...
[JsonConverter(typeof(Iso20022ExternalCodeJsonConverter<ExternalSystemPartyType1Code>))]
public readonly struct ExternalSystemPartyType1Code : IIsoExternalCode, IEquatable<ExternalSystemPartyType1Code>
{
    ...
    public ExternalSystemPartyType1Code(string value)
    {
        if (!Regex.IsMatch(value, Pattern))
            throw new Iso20022FormatException(typeof(ExternalSystemPartyType1Code), value, Pattern);
        Value = value;
    }

    /// <summary>Returns <see langword="true"/> and a valid instance when <paramref name="value"/> satisfies <see cref="Pattern"/>; otherwise <see langword="false"/>.</summary>
    public static bool TryCreate(string value, [NotNullWhen(true)] out ExternalSystemPartyType1Code result)
    {
        if (Regex.IsMatch(value, Pattern))
    ...
    /// <summary>Implicitly wraps a string as a <see cref="ExternalSystemPartyType1Code"/>.</summary>
    public static implicit operator ExternalSystemPartyType1Code(string value) => new(value);
    /// <summary>Implicitly unwraps the code to its string value.</summary>
    public static implicit operator string(ExternalSystemPartyType1Code code) => code.Value;

    /// <inheritdoc/>
    public override string ToString() => Value ?? string.Empty;
    /// <inheritdoc/>
    public bool Equals(ExternalSystemPartyType1Code other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is ExternalSystemPartyType1Code other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value?.GetHashCode() ?? 0;

    /// <inheritdoc/>
    public static bool operator ==(ExternalSystemPartyType1Code a, ExternalSystemPartyType1Code b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(ExternalSystemPartyType1Code a, ExternalSystemPartyType1Code b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(ExternalSystemPartyType1Code a, string? b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(ExternalSystemPartyType1Code a, string? b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, ExternalSystemPartyType1Code b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(string? a, ExternalSystemPartyType1Code b) => a != b.Value;
    ...
    public static readonly ExternalSystemPartyType1Code AncillarySystem = new("ANSY");
    ...
    public static readonly ExternalSystemPartyType1Code CentralSecuritiesDepositoryParticipant = new("CSDP");
    ...
    public static readonly ExternalSystemPartyType1Code CentralSecuritiesDepository = new("CSDY");
    ...
    public static readonly ExternalSystemPartyType1Code ExternalCentralSecuritiesDepository = new("ECSD");
    ...
    public static readonly ExternalSystemPartyType1Code NationalCentralBank = new("NCBK");

    /// <summary>Commercial bank used to effect money settlements.</summary>
    [IsoId("_U4944fXXEe-Ig-GynGPh9A")]
    [Description(@"Commercial bank used to effect money settlements.")]
    public static readonly ExternalSystemPartyType1Code PaymentBank = new("PMBK");
    ...
    public static readonly ExternalSystemPartyType1Code StandardParticipantRestricted = new("STPR");
    ...
    public static readonly ExternalSystemPartyType1Code StandardParticipantUnrestricted = new("STPU");
    ...
    public static readonly ExternalSystemPartyType1Code SystemManager = new("SYMG");
    ...
    public static readonly ExternalSystemPartyType1Code SystemOperator = new("SYOP");
}
