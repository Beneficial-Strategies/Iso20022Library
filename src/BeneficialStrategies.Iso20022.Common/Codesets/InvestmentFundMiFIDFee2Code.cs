...
[JsonConverter(typeof(Iso20022EnumJsonConverter<InvestmentFundMiFIDFee2Code>))]
public enum InvestmentFundMiFIDFee2Code
{
    ...
    GrossOneOffMaximumEntryCostNonAcquired =
        InvestmentFundMiFIDFeeV2Code.GrossOneOffMaximumEntryCostNonAcquired, // same ordinal as derivation source for type conversions
    ...
    GrossOneOffMaximumEntryCostStructured =
        InvestmentFundMiFIDFeeV2Code.GrossOneOffMaximumEntryCostStructured, // same ordinal as derivation source for type conversions
    ...
    NetOneOffEntryCostExPostStructured =
        InvestmentFundMiFIDFeeV2Code.NetOneOffEntryCostExPostStructured, // same ordinal as derivation source for type conversions
    ...
    NetOneOffEntryCostNonAcquiredStructuredFund =
        InvestmentFundMiFIDFeeV2Code.NetOneOffEntryCostNonAcquiredStructuredFund, // same ordinal as derivation source for type conversions
    ...
    NetOneOffEntryCostStructuredNonAcquired =
        InvestmentFundMiFIDFeeV2Code.NetOneOffEntryCostStructuredNonAcquired, // same ordinal as derivation source for type conversions
    ...
    OneOffExitCostPriorStructuredProductFund =
        InvestmentFundMiFIDFeeV2Code.OneOffExitCostPriorStructuredProductFund, // same ordinal as derivation source for type conversions
    ...
    OneOffExitCostPriorStructuredSecurities =
        InvestmentFundMiFIDFeeV2Code.OneOffExitCostPriorStructuredSecurities, // same ordinal as derivation source for type conversions
    ...
    OneOffMaximumEntryCostFixedAmountItaly =
        InvestmentFundMiFIDFeeV2Code.OneOffMaximumEntryCostFixedAmountItaly, // same ordinal as derivation source for type conversions
    ...
    OneOffMaximumExitCostFixedAmountItaly =
        InvestmentFundMiFIDFeeV2Code.OneOffMaximumExitCostFixedAmountItaly, // same ordinal as derivation source for type conversions
    ...
    OneOffMaximumExitCostNonAcquired =
        InvestmentFundMiFIDFeeV2Code.OneOffMaximumExitCostNonAcquired, // same ordinal as derivation source for type conversions
    ...
    OneOffTypicalExitCostsStructured =
        InvestmentFundMiFIDFeeV2Code.OneOffTypicalExitCostsStructured, // same ordinal as derivation source for type conversions
    ...
    OngoingCostsAccumulatedStructured =
        InvestmentFundMiFIDFeeV2Code.OngoingCostsAccumulatedStructured, // same ordinal as derivation source for type conversions
