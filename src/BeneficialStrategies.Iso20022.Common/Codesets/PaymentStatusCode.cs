...
[Derivations(
    typeof(TransactionIndividualStatus2Code),
    typeof(CancellationIndividualStatus1Code),
    typeof(TransactionGroupStatus2Code),
    typeof(PartialGroupStatus1Code),
    typeof(ValidationGroupStatus1Code),
    typeof(ValidationGroupStatus2Code),
    typeof(GroupCancellationStatus1Code),
    typeof(TransactionGroupStatus1Code),
    typeof(TransactionIndividualStatus3Code),
    typeof(PartialGroupStatus2Code),
    typeof(TransactionGroupStatus3Code),
    typeof(TransactionIndividualStatus1Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<PaymentStatusCode>))]
