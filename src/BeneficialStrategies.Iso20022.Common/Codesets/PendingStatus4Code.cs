...
public enum PendingStatus4Code
{
    ...
    ReceiverMultilateralLimitRelated =
        PaymentInstructionStatusCode.ReceiverMultilateralLimitRelated, // same ordinal as derivation source for type conversions
    ...
    SenderReceiverBilateralLimitRelated =
        PaymentInstructionStatusCode.SenderReceiverBilateralLimitRelated, // same ordinal as derivation source for type conversions
    ...
    SenderReceiverMultilateralLimitRelated =
        PaymentInstructionStatusCode.SenderReceiverMultilateralLimitRelated, // same ordinal as derivation source for type conversions
}
