...
[Derivations(
    typeof(EntryStatus2Code),
    typeof(EntryStatus4Code),
    typeof(EntryStatus3Code),
    typeof(EntryStatus1Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<EntryStatusCode>))]
