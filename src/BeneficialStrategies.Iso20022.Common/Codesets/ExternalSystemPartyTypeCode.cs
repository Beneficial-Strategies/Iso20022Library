...
[Derivations(typeof(ExternalSystemPartyType1Code))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalSystemPartyTypeCode>))]
public enum ExternalSystemPartyTypeCode
{
    /// <summary>
    ...
    StandardParticipantUnrestricted,
