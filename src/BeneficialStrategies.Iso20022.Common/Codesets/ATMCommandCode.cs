...
[Derivations(
    typeof(ATMCommand3Code),
    typeof(ATMCommand4Code),
    typeof(ATMCommand1Code),
    typeof(ATMCommand5Code),
    typeof(ATMCommand2Code),
    typeof(ATMCommand6Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ATMCommandCode>))]
