...
[Description(
    @"Specifies the result of an investigation, as published in an external investigation execution confirmation code set.|External code sets can be downloaded from www.iso20022.org."
)]
[DerivedFrom(typeof(ExternalInvestigationExecutionConfirmationCode))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalInvestigationExecutionConfirmation1Code>))]
public enum ExternalInvestigationExecutionConfirmation1Code
{
    ...
    AcceptedDebitAuthorisation =
        ExternalInvestigationExecutionConfirmationCode.AcceptedDebitAuthorisation, // same ordinal as derivation source for type conversions
    ...
    AcceptedClaimNonReceipt =
        ExternalInvestigationExecutionConfirmationCode.AcceptedClaimNonReceipt, // same ordinal as derivation source for type conversions
    ...
    AcceptedValueDateAdjustment =
        ExternalInvestigationExecutionConfirmationCode.AcceptedValueDateAdjustment, // same ordinal as derivation source for type conversions
    ...
    CorrectValueDateAlreadyApplied =
        ExternalInvestigationExecutionConfirmationCode.CorrectValueDateAlreadyApplied, // same ordinal as derivation source for type conversions
    ...
    CancellationRequestForwardedToTheNextAgent =
        ExternalInvestigationExecutionConfirmationCode.CancellationRequestForwardedToTheNextAgent, // same ordinal as derivation source for type conversions
    ...
    PaymentInstructionInitiated =
        ExternalInvestigationExecutionConfirmationCode.PaymentInstructionInitiated, // same ordinal as derivation source for type conversions
    ...
    PendingCancellationRequest =
        ExternalInvestigationExecutionConfirmationCode.PendingCancellationRequest, // same ordinal as derivation source for type conversions
    ...
    PartiallyExecutedCancellationRequest =
        ExternalInvestigationExecutionConfirmationCode.PartiallyExecutedCancellationRequest, // same ordinal as derivation source for type conversions
    ...
    RejectedCancellationRequest =
        ExternalInvestigationExecutionConfirmationCode.RejectedCancellationRequest, // same ordinal as derivation source for type conversions
    ...
    RejectedClaimNonReceipt =
        ExternalInvestigationExecutionConfirmationCode.RejectedClaimNonReceipt, // same ordinal as derivation source for type conversions
    ...
    RejectedValueDateAdjustment =
        ExternalInvestigationExecutionConfirmationCode.RejectedValueDateAdjustment, // same ordinal as derivation source for type conversions
    ...
    StatementEntryIncorrect =
        ExternalInvestigationExecutionConfirmationCode.StatementEntryIncorrect, // same ordinal as derivation source for type conversions
    ...
    UnableToApplyWillFollow =
        ExternalInvestigationExecutionConfirmationCode.UnableToApplyWillFollow, // same ordinal as derivation source for type conversions
    ...
    BatchInstructionAlreadySettled =
        ExternalInvestigationExecutionConfirmationCode.BatchInstructionAlreadySettled, // same ordinal as derivation source for type conversions
    ...
    InstructionDoesNotExist =
        ExternalInvestigationExecutionConfirmationCode.InstructionDoesNotExist, // same ordinal as derivation source for type conversions
    ...
    InvalidCancellationRequest =
        ExternalInvestigationExecutionConfirmationCode.InvalidCancellationRequest, // same ordinal as derivation source for type conversions
    ...
    AdditionalInformationSent =
        ExternalInvestigationExecutionConfirmationCode.AdditionalInformationSent, // same ordinal as derivation source for type conversions
