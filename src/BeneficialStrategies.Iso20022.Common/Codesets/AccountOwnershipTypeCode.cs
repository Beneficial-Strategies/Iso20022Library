...
[Derivations(
    typeof(AccountOwnershipType5Code),
    typeof(AccountOwnershipType3Code),
    typeof(AccountOwnershipType6Code),
    typeof(AccountOwnershipType4Code)
)]
[JsonConverter(typeof(Iso20022EnumJsonConverter<AccountOwnershipTypeCode>))]
