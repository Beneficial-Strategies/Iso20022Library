...
[DataContract]
[Serializable]
[IsoId("_oJDlQVXZEfC0lMwgjvMClw")]
[Description(@"Specifies the specific type of tax applicable to a transaction.")]
[DerivedFrom(typeof(AddendumTaxTypeCode))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<AddendumTaxType4Code>))]
public enum AddendumTaxType4Code
{
    /// <summary>
    ...
    DepartureTax = AddendumTaxTypeCode.DepartureTax,
    ...
    [IsoId("_oLcLN1XZEfC0lMwgjvMClw")]
    [Description(@"Tax that is levied on assets given to individuals prior to the death of the donor.")]
    ...
    [IsoId("_oLcK61XZEfC0lMwgjvMClw")]
    [Description(@"Tax recovery is due to capital loss.")]
    CapitalLossCredit = AddendumTaxTypeCode.CapitalLossCredit,

    /// <summary>
    /// Tax levied for the privilege of occupying space for home or rental for a fixed period of time, as determined by a taxing authority.
    /// Encoded/decoded by serializers as &quot;OCTX&quot;.
    /// </summary>
    [EnumMember(Value = "OCTX")]
    [IsoId("_oLcLcVXZEfC0lMwgjvMClw")]
    [Description(@"Tax levied for the privilege of occupying space for home or rental for a fixed period of time, as determined by a taxing authority.")]
    ...
    [IsoId("_oLcLzVXZEfC0lMwgjvMClw")]
    [Description(@"Tax levied on telecommunications companies for the right to provide services.")]
    ...
    /// <summary>
    /// Income tax withheld or deducted from the amount due to the recipient, and paid to the government by the payer rather than the recipient.
    /// Encoded/decoded by serializers as &quot;WITH&quot;.
    /// </summary>
    [EnumMember(Value = "WITH")]
    [IsoId("_oLcL91XZEfC0lMwgjvMClw")]
    [Description(@"Income tax withheld or deducted from the amount due to the recipient, and paid to the government by the payer rather than the recipient.")]
