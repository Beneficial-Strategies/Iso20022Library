...
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalBillingRateIdentification1Code>))]
public enum ExternalBillingRateIdentification1Code
{
    ...
    AdjustedEarningsAllowanceRate =
        ExternalBillingRateIdentificationCode.AdjustedEarningsAllowanceRate, // same ordinal as derivation source for type conversions
    ...
    AdjustedNextMonthEarningsRate =
        ExternalBillingRateIdentificationCode.AdjustedNextMonthEarningsRate, // same ordinal as derivation source for type conversions
    ...
    NetCollectedBalanceOverdraftRate =
        ExternalBillingRateIdentificationCode.NetCollectedBalanceOverdraftRate, // same ordinal as derivation source for type conversions
    ...
    NegativeCollectedOverdraftRate =
        ExternalBillingRateIdentificationCode.NegativeCollectedOverdraftRate, // same ordinal as derivation source for type conversions
    ...
    NetLedgerBalanceOverdraftRate =
        ExternalBillingRateIdentificationCode.NetLedgerBalanceOverdraftRate, // same ordinal as derivation source for type conversions
    ...
    NextMonthEarningsAllowanceRate =
        ExternalBillingRateIdentificationCode.NextMonthEarningsAllowanceRate, // same ordinal as derivation source for type conversions
    ...
    ReserveRequirementRateNonDDA =
        ExternalBillingRateIdentificationCode.ReserveRequirementRateNonDDA, // same ordinal as derivation source for type conversions
