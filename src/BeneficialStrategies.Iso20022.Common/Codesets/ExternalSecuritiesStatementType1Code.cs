...
[DerivedFrom(typeof(ExternalSecuritiesStatementTypeCode))]
[JsonConverter(typeof(Iso20022EnumJsonConverter<ExternalSecuritiesStatementType1Code>))]
public enum ExternalSecuritiesStatementType1Code
{
    /// <summary>
    ...
    [IsoId("_pqqrkQJ4EfGAP_FOfstLIw")]
    [Description(@"Statement is a registered holder names(s) and address statement.")]
    RegisteredHolderNamesAndAddress = ExternalSecuritiesStatementTypeCode.RegisteredHolderNamesAndAddress, // same ordinal as derivation source for type conversions
    ...
    [IsoId("_pzG14QJ4EfGAP_FOfstLIw")]
    [Description(@"Statement is a security holder reference number and registration statement.")]
    SecurityHolderReferenceNumberAndRegistration = ExternalSecuritiesStatementTypeCode.SecurityHolderReferenceNumberAndRegistration, // same ordinal as derivation source for type conversions
}
