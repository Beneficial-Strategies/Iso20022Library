...
[JsonConverter(typeof(Iso20022EnumJsonConverter<RejectionReason76Code>))]
public enum RejectionReason76Code
{
    ...
    ImpossibleToUseTheRTGSSystemInstructed =
        RejectionReasonV3Code.ImpossibleToUseTheRTGSSystemInstructed, // same ordinal as derivation source for type conversions
    ...
    RegistrationRequestDataAndOrderRejection =
        RejectionReasonV3Code.RegistrationRequestDataAndOrderRejection, // same ordinal as derivation source for type conversions
