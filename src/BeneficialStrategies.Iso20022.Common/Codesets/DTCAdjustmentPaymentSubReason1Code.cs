...
[JsonConverter(typeof(Iso20022EnumJsonConverter<DTCAdjustmentPaymentSubReason1Code>))]
public enum DTCAdjustmentPaymentSubReason1Code
{
    ...
    ReorganizationRelatedAdjustment =
        DTCAdjustmentPaymentSubReasonCode.ReorganizationRelatedAdjustment, // same ordinal as derivation source for type conversions
    ...
    ReversalOfAnAccrualClaimPayment =
        DTCAdjustmentPaymentSubReasonCode.ReversalOfAnAccrualClaimPayment, // same ordinal as derivation source for type conversions
    ...
    ReversalOfaWithdrawalByTransfer =
        DTCAdjustmentPaymentSubReasonCode.ReversalOfaWithdrawalByTransfer, // same ordinal as derivation source for type conversions
    ...
    ReverseOfEscheatedAmountOfClaim =
        DTCAdjustmentPaymentSubReasonCode.ReverseOfEscheatedAmountOfClaim, // same ordinal as derivation source for type conversions
    ...
    ReverseOfTheSharesEscheatedToNYStateInError =
        DTCAdjustmentPaymentSubReasonCode.ReverseOfTheSharesEscheatedToNYStateInError, // same ordinal as derivation source for type conversions
    ...
    RevisionOfChargeForWithholdingTax =
        DTCAdjustmentPaymentSubReasonCode.RevisionOfChargeForWithholdingTax, // same ordinal as derivation source for type conversions
    ...
    ShareAdjustmentFromABuyTransactionInOurDTCCDividendTradingAccount =
        DTCAdjustmentPaymentSubReasonCode.ShareAdjustmentFromABuyTransactionInOurDTCCDividendTradingAccount, // same ordinal as derivation source for type conversions
    ...
    ShareAdjustmentResultingFromASellTransactionAffectedInOurDTCCDividendTradingAccount =
        DTCAdjustmentPaymentSubReasonCode.ShareAdjustmentResultingFromASellTransactionAffectedInOurDTCCDividendTradingAccount, // same ordinal as derivation source for type conversions
    ...
    SupplementalInterimActivityFromMidwest =
        DTCAdjustmentPaymentSubReasonCode.SupplementalInterimActivityFromMidwest, // same ordinal as derivation source for type conversions
    ...
    SupplementalInterimActivityFromPhiladelphia =
        DTCAdjustmentPaymentSubReasonCode.SupplementalInterimActivityFromPhiladelphia, // same ordinal as derivation source for type conversions
    ...
    AdditionalRightsForBeneficialOwner =
        DTCAdjustmentPaymentSubReasonCode.AdditionalRightsForBeneficialOwner, // same ordinal as derivation source for type conversions
    ...
    AdjustmentForAWithdrawalByTransferNotTransferredIntoYourClientsName =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentForAWithdrawalByTransferNotTransferredIntoYourClientsName, // same ordinal as derivation source for type conversions
    ...
    AdjustmentForCashInLieuOfFractionalShares =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentForCashInLieuOfFractionalShares, // same ordinal as derivation source for type conversions
    ...
    AdjustmentForCashOnIncreasedShares =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentForCashOnIncreasedShares, // same ordinal as derivation source for type conversions
    ...
    AdjustmentIsInResponseToYourInquiry =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentIsInResponseToYourInquiry, // same ordinal as derivation source for type conversions
    ...
    AdjustmentMadeForAWithdrawalByTransferSetUpAfterTheCutOffDateMadeTransferIntoYourClientsName =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentMadeForAWithdrawalByTransferSetUpAfterTheCutOffDateMadeTransferIntoYourClientsName, // same ordinal as derivation source for type conversions
    ...
    AdjustmentToAvoidFiscalPayment =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentToAvoidFiscalPayment, // same ordinal as derivation source for type conversions
    ...
    AdjustmentToYourDividendReinvestmentPosition =
        DTCAdjustmentPaymentSubReasonCode.AdjustmentToYourDividendReinvestmentPosition, // same ordinal as derivation source for type conversions
    ...
    AgentPaidBasedOnCombinedFractions =
        DTCAdjustmentPaymentSubReasonCode.AgentPaidBasedOnCombinedFractions, // same ordinal as derivation source for type conversions
    ...
    AllocationAdjustmentDueToFractionsRoundedUpByTheAgent =
        DTCAdjustmentPaymentSubReasonCode.AllocationAdjustmentDueToFractionsRoundedUpByTheAgent, // same ordinal as derivation source for type conversions
    ...
    AllocationOfBabyBondsAmountToBeExited =
        DTCAdjustmentPaymentSubReasonCode.AllocationOfBabyBondsAmountToBeExited, // same ordinal as derivation source for type conversions
    ...
    AllocationOfDRPTEDSInstruction =
        DTCAdjustmentPaymentSubReasonCode.AllocationOfDRPTEDSInstruction, // same ordinal as derivation source for type conversions
    ...
    AnnouncementDeletedOrFailTracking =
        DTCAdjustmentPaymentSubReasonCode.AnnouncementDeletedOrFailTracking, // same ordinal as derivation source for type conversions
    ...
    CalledCertificatesAccruedErroneousInterestChargeBack =
        DTCAdjustmentPaymentSubReasonCode.CalledCertificatesAccruedErroneousInterestChargeBack, // same ordinal as derivation source for type conversions
    ...
    CalledCertificatesCheckInParticipantsNameChargeBack =
        DTCAdjustmentPaymentSubReasonCode.CalledCertificatesCheckInParticipantsNameChargeBack, // same ordinal as derivation source for type conversions
    ...
    CashDueOnAnAccruedStockPayment =
        DTCAdjustmentPaymentSubReasonCode.CashDueOnAnAccruedStockPayment, // same ordinal as derivation source for type conversions
    ...
    ChargeForFrenchAvoidFiscalTaxCredit =
        DTCAdjustmentPaymentSubReasonCode.ChargeForFrenchAvoidFiscalTaxCredit, // same ordinal as derivation source for type conversions
    ...
    ChargeInLieuOfReceiptOfDividendReinvestment =
        DTCAdjustmentPaymentSubReasonCode.ChargeInLieuOfReceiptOfDividendReinvestment, // same ordinal as derivation source for type conversions
    ...
    CODWithdrawalNotDeliveredAndCertificatesIssuedInTheNameOfYourNominee =
        DTCAdjustmentPaymentSubReasonCode.CODWithdrawalNotDeliveredAndCertificatesIssuedInTheNameOfYourNominee, // same ordinal as derivation source for type conversions
    ...
    CODWithdrawalNotDeliveredAndCertificatesInTheNameOfYourGoodselves =
        DTCAdjustmentPaymentSubReasonCode.CODWithdrawalNotDeliveredAndCertificatesInTheNameOfYourGoodselves, // same ordinal as derivation source for type conversions
    ...
    CTFSHeldOverRecordDateOnWhichWeGuaranteeToHoldYouFreeAndHarmless =
        DTCAdjustmentPaymentSubReasonCode.CTFSHeldOverRecordDateOnWhichWeGuaranteeToHoldYouFreeAndHarmless, // same ordinal as derivation source for type conversions
    ...
    DepositLostCertificateOverTheRecordDateWasRegisteredInTheNameOfYour =
        DTCAdjustmentPaymentSubReasonCode.DepositLostCertificateOverTheRecordDateWasRegisteredInTheNameOfYour, // same ordinal as derivation source for type conversions
    ...
    DepositTransferredIntoTheNameOfTheCEDEAndCo =
        DTCAdjustmentPaymentSubReasonCode.DepositTransferredIntoTheNameOfTheCEDEAndCo, // same ordinal as derivation source for type conversions
    ...
    DividendReinvestmentAllocation =
        DTCAdjustmentPaymentSubReasonCode.DividendReinvestmentAllocation, // same ordinal as derivation source for type conversions
    ...
    DividendReinvestmentAllocationAdjustmentDueToYourSubAccountingInstructionsToTheAgent =
        DTCAdjustmentPaymentSubReasonCode.DividendReinvestmentAllocationAdjustmentDueToYourSubAccountingInstructionsToTheAgent, // same ordinal as derivation source for type conversions
    ...
    DividendReinvestmentAllocationOfCashInLieuOfFractions =
        DTCAdjustmentPaymentSubReasonCode.DividendReinvestmentAllocationOfCashInLieuOfFractions, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourCustomer =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourCustomer, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourCustomerLateTransfer =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourCustomerLateTransfer, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourGoodselves =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourGoodselves, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourGoodselvesLateTransfer =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourGoodselvesLateTransfer, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourNominee =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourNominee, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimAgainstRegisteredHolderInTheNameOfYourNomineeLateTransfer =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimAgainstRegisteredHolderInTheNameOfYourNomineeLateTransfer, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimOnRegisteredHolderInTheNameOfYourCustomer =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimOnRegisteredHolderInTheNameOfYourCustomer, // same ordinal as derivation source for type conversions
    ...
    DTCCClaimOnRegisteredHolderInTheNameOfYourGoodselves =
        DTCAdjustmentPaymentSubReasonCode.DTCCClaimOnRegisteredHolderInTheNameOfYourGoodselves, // same ordinal as derivation source for type conversions
    ...
    ForeignCashDividendsOrBondInterestAllocationAtExemptRate =
        DTCAdjustmentPaymentSubReasonCode.ForeignCashDividendsOrBondInterestAllocationAtExemptRate, // same ordinal as derivation source for type conversions
    ...
    ForeignCashDividendsOrBondInterestAllocationAtUnfavorableRate =
        DTCAdjustmentPaymentSubReasonCode.ForeignCashDividendsOrBondInterestAllocationAtUnfavorableRate, // same ordinal as derivation source for type conversions
    ...
    ForeignCashDividendsOrBondsInterestAllocationAtFavorableRate =
        DTCAdjustmentPaymentSubReasonCode.ForeignCashDividendsOrBondsInterestAllocationAtFavorableRate, // same ordinal as derivation source for type conversions
    ...
    ForeignCashDividendUnfavorableRate =
        DTCAdjustmentPaymentSubReasonCode.ForeignCashDividendUnfavorableRate, // same ordinal as derivation source for type conversions
    ...
    InSettlementOfATradeDTCCReorgAccount =
        DTCAdjustmentPaymentSubReasonCode.InSettlementOfATradeDTCCReorgAccount, // same ordinal as derivation source for type conversions
    ...
    InterestAdjustedDueToEarlyWithdrawal =
        DTCAdjustmentPaymentSubReasonCode.InterestAdjustedDueToEarlyWithdrawal, // same ordinal as derivation source for type conversions
    ...
    InterestDueWasErroneouslyPaidToYouByTheIssuer =
        DTCAdjustmentPaymentSubReasonCode.InterestDueWasErroneouslyPaidToYouByTheIssuer, // same ordinal as derivation source for type conversions
    ...
    InterestorDividendDueOnConversion =
        DTCAdjustmentPaymentSubReasonCode.InterestorDividendDueOnConversion, // same ordinal as derivation source for type conversions
    ...
    InterestOrDividendDueOnRedemption =
        DTCAdjustmentPaymentSubReasonCode.InterestOrDividendDueOnRedemption, // same ordinal as derivation source for type conversions
    ...
    InterestOrDividendDueOnRepaymentOption =
        DTCAdjustmentPaymentSubReasonCode.InterestOrDividendDueOnRepaymentOption, // same ordinal as derivation source for type conversions
    ...
    InterimPositionAdjustedForDeliverOrderActivity =
        DTCAdjustmentPaymentSubReasonCode.InterimPositionAdjustedForDeliverOrderActivity, // same ordinal as derivation source for type conversions
    ...
    LateAnnouncementActivityDueBillActivity =
        DTCAdjustmentPaymentSubReasonCode.LateAnnouncementActivityDueBillActivity, // same ordinal as derivation source for type conversions
    ...
    LostCertificateRegisteredInTheNameOfYourGoodselves =
        DTCAdjustmentPaymentSubReasonCode.LostCertificateRegisteredInTheNameOfYourGoodselves, // same ordinal as derivation source for type conversions
    ...
    LostCertificateWasRegisteredInTheNameOfYourCustomer =
        DTCAdjustmentPaymentSubReasonCode.LostCertificateWasRegisteredInTheNameOfYourCustomer, // same ordinal as derivation source for type conversions
    ...
    LostCertificateWasRegisteredInTheNameOfYourNominee =
        DTCAdjustmentPaymentSubReasonCode.LostCertificateWasRegisteredInTheNameOfYourNominee, // same ordinal as derivation source for type conversions
    ...
    MuniBearerBondCouponAdjustmentExcessCouponsDepositedOn =
        DTCAdjustmentPaymentSubReasonCode.MuniBearerBondCouponAdjustmentExcessCouponsDepositedOn, // same ordinal as derivation source for type conversions
    ...
    MuniBearerBondCouponAdjustmentExcessCouponsWithdrawnOn =
        DTCAdjustmentPaymentSubReasonCode.MuniBearerBondCouponAdjustmentExcessCouponsWithdrawnOn, // same ordinal as derivation source for type conversions
    ...
    MuniBearerBondCouponAdjustmentForCouponsMissingFromaDeposit =
        DTCAdjustmentPaymentSubReasonCode.MuniBearerBondCouponAdjustmentForCouponsMissingFromaDeposit, // same ordinal as derivation source for type conversions
    ...
    MuniBearerBondCouponAdjustmentForCouponsMissingFromaWithdrawal =
        DTCAdjustmentPaymentSubReasonCode.MuniBearerBondCouponAdjustmentForCouponsMissingFromaWithdrawal, // same ordinal as derivation source for type conversions
    ...
    MuniBearerBondCouponPositionAdjustedForDepositActivity =
        DTCAdjustmentPaymentSubReasonCode.MuniBearerBondCouponPositionAdjustedForDepositActivity, // same ordinal as derivation source for type conversions
    ...
    OptionalDividendAllocationAdjustment =
        DTCAdjustmentPaymentSubReasonCode.OptionalDividendAllocationAdjustment, // same ordinal as derivation source for type conversions
    ...
    PaymentOfFullAvoidFiscalTaxRefund =
        DTCAdjustmentPaymentSubReasonCode.PaymentOfFullAvoidFiscalTaxRefund, // same ordinal as derivation source for type conversions
    ...
    PaymentOfPartialAvoidFiscalTaxRefund =
        DTCAdjustmentPaymentSubReasonCode.PaymentOfPartialAvoidFiscalTaxRefund, // same ordinal as derivation source for type conversions
    ...
    PositionAdjustedForDepositActivity =
        DTCAdjustmentPaymentSubReasonCode.PositionAdjustedForDepositActivity, // same ordinal as derivation source for type conversions
    ...
    PositionReinstatedCertificatesIssuedAndOutstandingInTheNameOfYourCustomers =
        DTCAdjustmentPaymentSubReasonCode.PositionReinstatedCertificatesIssuedAndOutstandingInTheNameOfYourCustomers, // same ordinal as derivation source for type conversions
    ...
    PreviouslyCalledCertificatesFundsDelivery =
        DTCAdjustmentPaymentSubReasonCode.PreviouslyCalledCertificatesFundsDelivery, // same ordinal as derivation source for type conversions
    ...
    PriceCorrectionDividendReinvestment =
        DTCAdjustmentPaymentSubReasonCode.PriceCorrectionDividendReinvestment, // same ordinal as derivation source for type conversions
    ...
    ProceedsFromBuyTransactionInOurDTCCDividendTradingAccount =
        DTCAdjustmentPaymentSubReasonCode.ProceedsFromBuyTransactionInOurDTCCDividendTradingAccount, // same ordinal as derivation source for type conversions
    ...
    ProceedsResultingFromaASellTransactionAffectedInOurDTCCDividendTradingAccount =
        DTCAdjustmentPaymentSubReasonCode.ProceedsResultingFromaASellTransactionAffectedInOurDTCCDividendTradingAccount, // same ordinal as derivation source for type conversions
    ...
    RecordDatePositionAdjustedForaWithdrawalByTransfer =
        DTCAdjustmentPaymentSubReasonCode.RecordDatePositionAdjustedForaWithdrawalByTransfer, // same ordinal as derivation source for type conversions
    ...
    RedemptionPaymentDueToPledgeRelease =
        DTCAdjustmentPaymentSubReasonCode.RedemptionPaymentDueToPledgeRelease, // same ordinal as derivation source for type conversions
    ...
    WithdrawalTransferBuyBackWithdrawal =
        DTCAdjustmentPaymentSubReasonCode.WithdrawalTransferBuyBackWithdrawal, // same ordinal as derivation source for type conversions
    ...
    WithholdingTaxAdjustmentInUserDefinedCountry =
        DTCAdjustmentPaymentSubReasonCode.WithholdingTaxAdjustmentInUserDefinedCountry, // same ordinal as derivation source for type conversions
