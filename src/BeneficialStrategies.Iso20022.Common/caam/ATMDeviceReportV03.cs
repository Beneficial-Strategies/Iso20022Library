...
public partial record ATMDeviceReportV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMDeviceReportV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMDeviceReportV03( Header31 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ContentInformationType10? ProtectedATMDeviceReport { get; init; } 
    #else
    public ContentInformationType10? ProtectedATMDeviceReport { get; set; } 
    #endif
    ...
    public ATMDeviceReport3? ATMDeviceReport { get; init; } 
    #else
    public ATMDeviceReport3? ATMDeviceReport { get; set; } 
    #endif
...
// Since ATMDeviceReportV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ATMDeviceReportV03.
