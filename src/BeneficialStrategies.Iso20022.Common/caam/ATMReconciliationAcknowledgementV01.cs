...
public partial record ATMReconciliationAcknowledgementV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMReconciliationAcknowledgementV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMReconciliationAcknowledgementV01( Header21 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ContentInformationType10? ProtectedATMReconciliationAcknowledgement { get; init; } 
    #else
    public ContentInformationType10? ProtectedATMReconciliationAcknowledgement { get; set; } 
    #endif
    ...
    public ATMReconciliationAcknowledgement1? ATMReconciliationAcknowledgement { get; init; } 
    #else
    public ATMReconciliationAcknowledgement1? ATMReconciliationAcknowledgement { get; set; } 
    #endif
...
// Since ATMReconciliationAcknowledgementV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ATMReconciliationAcknowledgementV01.
