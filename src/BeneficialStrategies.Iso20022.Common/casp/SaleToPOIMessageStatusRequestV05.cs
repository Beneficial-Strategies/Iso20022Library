...
public partial record SaleToPOIMessageStatusRequestV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIMessageStatusRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIMessageStatusRequestV05( Header41 reqHeader,MessageStatusRequest6 reqStatusRequest )
    {
        Header = reqHeader;
    ...
    public required MessageStatusRequest6 StatusRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MessageStatusRequest6 StatusRequest { get; init; } 
    #else
    public MessageStatusRequest6 StatusRequest { get; set; } 
    #endif
...
// Since SaleToPOIMessageStatusRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIMessageStatusRequestV05.
