...
public partial record SaleToPOIAdministrativeRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIAdministrativeRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIAdministrativeRequestV02( Header41 reqHeader,AdministrativeRequest3 reqAdministrativeRequest )
    {
        Header = reqHeader;
    ...
    public required AdministrativeRequest3 AdministrativeRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AdministrativeRequest3 AdministrativeRequest { get; init; } 
    #else
    public AdministrativeRequest3 AdministrativeRequest { get; set; } 
    #endif
