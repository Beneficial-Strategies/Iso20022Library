...
public partial record SaleToPOIEventNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIEventNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIEventNotificationV05( Header41 reqHeader,SystemEventNotification6 reqEventNotification )
    {
        Header = reqHeader;
    ...
    public required SystemEventNotification6 EventNotification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SystemEventNotification6 EventNotification { get; init; } 
    #else
    public SystemEventNotification6 EventNotification { get; set; } 
    #endif
...
// Since SaleToPOIEventNotificationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIEventNotificationV05.
