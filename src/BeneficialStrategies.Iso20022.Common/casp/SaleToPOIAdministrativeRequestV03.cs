...
public partial record SaleToPOIAdministrativeRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIAdministrativeRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIAdministrativeRequestV03( Header41 reqHeader,AdministrativeRequest4 reqAdministrativeRequest )
    {
        Header = reqHeader;
    ...
    public required AdministrativeRequest4 AdministrativeRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AdministrativeRequest4 AdministrativeRequest { get; init; } 
    #else
    public AdministrativeRequest4 AdministrativeRequest { get; set; } 
    #endif
...
// Since SaleToPOIAdministrativeRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIAdministrativeRequestV03.
