...
public partial record SaleToPOIReconciliationRequestV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIReconciliationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIReconciliationRequestV05( Header41 reqHeader,ReconciliationRequest6 reqReconciliationRequest )
    {
        Header = reqHeader;
    ...
    public required ReconciliationRequest6 ReconciliationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ReconciliationRequest6 ReconciliationRequest { get; init; } 
    #else
    public ReconciliationRequest6 ReconciliationRequest { get; set; } 
    #endif
...
// Since SaleToPOIReconciliationRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIReconciliationRequestV05.
