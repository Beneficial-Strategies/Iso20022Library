...
[DataContract]
#endif
public partial record SaleToPOIEventNotificationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIEventNotificationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIEventNotificationV03( Header41 reqHeader,SystemEventNotification4 reqEventNotification )
    {
        Header = reqHeader;
    ...
    #else
    public SystemEventNotification4 EventNotification { get; set; } 
    #endif
