...
public partial record SaleToPOISessionManagementRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOISessionManagementRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOISessionManagementRequestV03( Header41 reqHeader,SessionManagementRequest4 reqSessionManagementRequest )
    {
        Header = reqHeader;
    ...
    public required SessionManagementRequest4 SessionManagementRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SessionManagementRequest4 SessionManagementRequest { get; init; } 
    #else
    public SessionManagementRequest4 SessionManagementRequest { get; set; } 
    #endif
