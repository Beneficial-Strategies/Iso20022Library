...
public partial record CollateralAndExposureReportV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralAndExposureReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralAndExposureReportV04( ReportParameters6 reqReportParameters,Obligation6 reqObligation,Collateral43 reqCollateralReport )
    {
    ...
    #else
    public Obligation6 Obligation { get; set; } 
    #endif
    ...
    #else
    public Collateral43 CollateralReport { get; set; } 
    #endif
...
// Since CollateralAndExposureReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CollateralAndExposureReportV04.
