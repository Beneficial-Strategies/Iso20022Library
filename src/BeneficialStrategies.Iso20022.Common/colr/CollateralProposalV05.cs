...
public partial record CollateralProposalV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralProposalV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralProposalV05( System.String reqTransactionIdentification,Obligation5 reqObligation,Proposal5 reqTypeAndDetails )
    {
    ...
    public required Proposal5 TypeAndDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Proposal5 TypeAndDetails { get; init; } 
    #else
    public Proposal5 TypeAndDetails { get; set; } 
    #endif
