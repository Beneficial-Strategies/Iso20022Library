...
[DataContract]
#endif
public partial record CollateralManagementCancellationRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralManagementCancellationRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralManagementCancellationRequestV03( System.String reqTransactionIdentification,Reference2Choice_ reqReference,Obligation3 reqObligation,CollateralCancellationReason1 reqCancellationReason )
    {
...
// Since CollateralManagementCancellationRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CollateralManagementCancellationRequestV03.
