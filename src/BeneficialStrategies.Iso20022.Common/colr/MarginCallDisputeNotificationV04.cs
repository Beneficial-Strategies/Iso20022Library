...
public partial record MarginCallDisputeNotificationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MarginCallDisputeNotificationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MarginCallDisputeNotificationV04( System.String reqTransactionIdentification,Obligation4 reqObligation,DisputeNotification1Choice_ reqDisputeNotification )
    {
...
// Since MarginCallDisputeNotificationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MarginCallDisputeNotificationV04.
