...
public partial record MarginCallRequestV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MarginCallRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MarginCallRequestV04( System.String reqTransactionIdentification,Obligation4 reqObligation,MarginCallResult3 reqMarginCallResult )
    {
    ...
    public MarginCall2? MarginCallDetails { get; init; } 
    #else
    public MarginCall2? MarginCallDetails { get; set; } 
    #endif
