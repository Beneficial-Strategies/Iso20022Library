...
public partial record CollateralSubstitutionConfirmationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralSubstitutionConfirmationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralSubstitutionConfirmationV04( System.String reqTransactionIdentification,Obligation4 reqObligation,CollateralConfirmation1 reqSubstitutionConfirmation )
    {
