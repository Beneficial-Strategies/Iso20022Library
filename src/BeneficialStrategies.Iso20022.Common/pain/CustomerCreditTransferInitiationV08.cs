...
/// <summary>
/// This record is an implementation of the pain.001.001.08 ISO standard message type.
...
[DataContract]
#endif
public partial record CustomerCreditTransferInitiationV08 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pain.001.001.08";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.08";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV08( GroupHeader48 reqGroupHeader,PaymentInstruction22 reqPaymentInformation )
    {
    ...
    [IsoXmlTag("PmtInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required PaymentInstruction22 PaymentInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required PaymentInstruction22 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction22 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction22 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerCreditTransferInitiationV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV08.
