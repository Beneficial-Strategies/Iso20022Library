...
/// <summary>
/// This record is an implementation of the pain.001.001.07 ISO standard message type.
...
public partial record CustomerCreditTransferInitiationV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.001.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV07( GroupHeader48 reqGroupHeader,PaymentInstruction20 reqPaymentInformation )
    {
    ...
    public required PaymentInstruction20 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction20 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction20 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerCreditTransferInitiationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV07.
