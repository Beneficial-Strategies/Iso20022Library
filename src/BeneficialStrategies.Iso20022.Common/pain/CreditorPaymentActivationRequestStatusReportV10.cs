...
public partial record CreditorPaymentActivationRequestStatusReportV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditorPaymentActivationRequestStatusReportV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditorPaymentActivationRequestStatusReportV10( GroupHeader106 reqGroupHeader,OriginalGroupInformation30 reqOriginalGroupInformationAndStatus )
    {
    ...
    public GroupHeader106 GroupHeader { get; init; } 
    #else
    public GroupHeader106 GroupHeader { get; set; } 
    #endif
    ...
    public OriginalPaymentInstruction46? OriginalPaymentInformationAndStatus { get; init; } 
    #else
    public OriginalPaymentInstruction46? OriginalPaymentInformationAndStatus { get; set; } 
    #endif
