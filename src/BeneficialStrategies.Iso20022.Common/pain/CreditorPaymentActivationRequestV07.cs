...
public partial record CreditorPaymentActivationRequestV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditorPaymentActivationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditorPaymentActivationRequestV07( GroupHeader78 reqGroupHeader,PaymentInstruction31 reqPaymentInformation )
    {
    ...
    public required PaymentInstruction31 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction31 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction31 PaymentInformation { get; set; } 
    #endif
