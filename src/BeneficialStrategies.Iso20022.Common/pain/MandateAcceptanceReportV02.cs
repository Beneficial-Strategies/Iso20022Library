...
[IsoId("_rwGZYFkyEeGeoaLUQk__nA_1820631680")]
...
public partial record MandateAcceptanceReportV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateAcceptanceReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateAcceptanceReportV02( GroupHeader47 reqGroupHeader,MandateAcceptance2 reqUnderlyingAcceptanceDetails )
    {
    ...
    public required MandateAcceptance2 UnderlyingAcceptanceDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateAcceptance2 UnderlyingAcceptanceDetails { get; init; } 
    #else
    public MandateAcceptance2 UnderlyingAcceptanceDetails { get; set; } 
    #endif
...
// Since MandateAcceptanceReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateAcceptanceReportV02.
