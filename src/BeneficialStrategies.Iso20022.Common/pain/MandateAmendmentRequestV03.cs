...
[DataContract]
#endif
public partial record MandateAmendmentRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateAmendmentRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateAmendmentRequestV03( GroupHeader47 reqGroupHeader,MandateAmendment3 reqUnderlyingAmendmentDetails )
    {
    ...
    public required MandateAmendment3 UnderlyingAmendmentDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateAmendment3 UnderlyingAmendmentDetails { get; init; } 
    #else
    public MandateAmendment3 UnderlyingAmendmentDetails { get; set; } 
    #endif
...
// Since MandateAmendmentRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateAmendmentRequestV03.
