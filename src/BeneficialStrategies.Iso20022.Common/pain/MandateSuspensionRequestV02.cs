...
/// <summary>
/// This record is an implementation of the pain.018.001.02 ISO standard message type.
...
public partial record MandateSuspensionRequestV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.018.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a MandateSuspensionRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateSuspensionRequestV02( GroupHeader80 reqGroupHeader,MandateSuspension2 reqUnderlyingSuspensionDetails )
    {
    ...
    public required MandateSuspension2 UnderlyingSuspensionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateSuspension2 UnderlyingSuspensionDetails { get; init; } 
    #else
    public MandateSuspension2 UnderlyingSuspensionDetails { get; set; } 
    #endif
...
// Since MandateSuspensionRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateSuspensionRequestV02.
