...
public partial record CustomerDirectDebitInitiationV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerDirectDebitInitiationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerDirectDebitInitiationV06( GroupHeader55 reqGroupHeader,PaymentInstruction18 reqPaymentInformation )
    {
    ...
    public required PaymentInstruction18 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction18 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction18 PaymentInformation { get; set; } 
    #endif
