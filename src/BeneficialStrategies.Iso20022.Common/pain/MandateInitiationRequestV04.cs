...
public partial record MandateInitiationRequestV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateInitiationRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateInitiationRequestV04( GroupHeader47 reqGroupHeader,Mandate7 reqMandate )
    {
    ...
    public required Mandate7 Mandate { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Mandate7 Mandate { get; init; } 
    #else
    public Mandate7 Mandate { get; set; } 
    #endif
...
// Since MandateInitiationRequestV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateInitiationRequestV04.
