...
/// <summary>
/// This record is an implementation of the pain.009.001.05 ISO standard message type.
...
public partial record MandateInitiationRequestV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.009.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a MandateInitiationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateInitiationRequestV05( GroupHeader47 reqGroupHeader,Mandate10 reqMandate )
    {
    ...
    public required Mandate10 Mandate { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Mandate10 Mandate { get; init; } 
    #else
    public Mandate10 Mandate { get; set; } 
    #endif
...
// Since MandateInitiationRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateInitiationRequestV05.
