...
/// <summary>
/// This record is an implementation of the pain.007.001.04 ISO standard message type.
...
public partial record CustomerPaymentReversalV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.007.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentReversalV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentReversalV04( GroupHeader56 reqGroupHeader,OriginalGroupHeader3 reqOriginalGroupInformation )
    {
    ...
    public OriginalPaymentInstruction7? OriginalPaymentInformationAndReversal { get; init; } 
    #else
    public OriginalPaymentInstruction7? OriginalPaymentInformationAndReversal { get; set; } 
    #endif
...
// Since CustomerPaymentReversalV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentReversalV04.
