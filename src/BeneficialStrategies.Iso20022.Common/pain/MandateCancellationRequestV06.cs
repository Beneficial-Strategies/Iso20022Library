...
/// <summary>
/// This record is an implementation of the pain.011.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record MandateCancellationRequestV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pain.011.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pain.011.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a MandateCancellationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateCancellationRequestV06( GroupHeader80 reqGroupHeader,MandateCancellation6 reqUnderlyingCancellationDetails )
    {
    ...
    #else
    public MandateCancellation6 UnderlyingCancellationDetails { get; set; } 
    #endif
...
// Since MandateCancellationRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateCancellationRequestV06.
