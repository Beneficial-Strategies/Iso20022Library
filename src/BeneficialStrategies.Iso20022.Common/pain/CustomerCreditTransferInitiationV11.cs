...
/// <summary>
/// This record is an implementation of the pain.001.001.11 ISO standard message type.
...
public partial record CustomerCreditTransferInitiationV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.001.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV11( GroupHeader95 reqGroupHeader,PaymentInstruction40 reqPaymentInformation )
    {
    ...
    #else
    public PaymentInstruction40 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerCreditTransferInitiationV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV11.
