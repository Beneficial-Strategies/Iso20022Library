...
public partial record MandateAcceptanceReportV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateAcceptanceReportV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateAcceptanceReportV07( GroupHeader80 reqGroupHeader,MandateAcceptance7 reqUnderlyingAcceptanceDetails )
    {
    ...
    public required MandateAcceptance7 UnderlyingAcceptanceDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateAcceptance7 UnderlyingAcceptanceDetails { get; init; } 
    #else
    public MandateAcceptance7 UnderlyingAcceptanceDetails { get; set; } 
    #endif
...
// Since MandateAcceptanceReportV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateAcceptanceReportV07.
