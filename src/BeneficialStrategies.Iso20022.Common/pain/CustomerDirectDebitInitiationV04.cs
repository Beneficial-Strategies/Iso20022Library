...
public partial record CustomerDirectDebitInitiationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerDirectDebitInitiationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerDirectDebitInitiationV04( GroupHeader55 reqGroupHeader,PaymentInstruction10 reqPaymentInformation )
    {
    ...
    public required PaymentInstruction10 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction10 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction10 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerDirectDebitInitiationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerDirectDebitInitiationV04.
