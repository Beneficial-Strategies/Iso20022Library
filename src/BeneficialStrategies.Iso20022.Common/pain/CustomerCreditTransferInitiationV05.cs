...
[DataContract]
#endif
public partial record CustomerCreditTransferInitiationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV05( GroupHeader48 reqGroupHeader,PaymentInstruction9 reqPaymentInformation )
    {
    ...
    public required PaymentInstruction9 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction9 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction9 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerCreditTransferInitiationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV05.
