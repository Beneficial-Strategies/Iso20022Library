...
/// <summary>
/// This record is an implementation of the pain.010.001.05 ISO standard message type.
...
public partial record MandateAmendmentRequestV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.010.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a MandateAmendmentRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateAmendmentRequestV05( GroupHeader47 reqGroupHeader,MandateAmendment5 reqUnderlyingAmendmentDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required MandateAmendment5 UnderlyingAmendmentDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required MandateAmendment5 UnderlyingAmendmentDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateAmendment5 UnderlyingAmendmentDetails { get; init; } 
    #else
    public MandateAmendment5 UnderlyingAmendmentDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_cn3ESUjuEeaVLL5QKJ4f-A")]
...
// Since MandateAmendmentRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateAmendmentRequestV05.
