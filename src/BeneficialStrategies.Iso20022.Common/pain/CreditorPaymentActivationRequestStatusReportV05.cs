...
public partial record CreditorPaymentActivationRequestStatusReportV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditorPaymentActivationRequestStatusReportV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditorPaymentActivationRequestStatusReportV05( GroupHeader46 reqGroupHeader,OriginalGroupInformation25 reqOriginalGroupInformationAndStatus )
    {
    ...
    public OriginalPaymentInstruction19? OriginalPaymentInformationAndStatus { get; init; } 
    #else
    public OriginalPaymentInstruction19? OriginalPaymentInformationAndStatus { get; set; } 
    #endif
