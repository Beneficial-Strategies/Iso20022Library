...
public partial record RequestForTransferStatusReportV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a RequestForTransferStatusReportV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestForTransferStatusReportV08( MessageIdentification1 reqMessageIdentification,MessageAndBusinessReference13 reqRequestDetails )
    {
    ...
    public required MessageAndBusinessReference13 RequestDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MessageAndBusinessReference13 RequestDetails { get; init; } 
    #else
    public MessageAndBusinessReference13 RequestDetails { get; set; } 
    #endif
