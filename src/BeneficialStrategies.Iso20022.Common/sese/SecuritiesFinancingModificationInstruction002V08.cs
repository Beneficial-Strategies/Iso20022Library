...
[DataContract]
#endif
public partial record SecuritiesFinancingModificationInstruction002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingModificationInstruction002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V08( TransactionTypeAndAdditionalParameters20 reqTransactionTypeAndModificationAdditionalParameters,SecuritiesTradeDetails103 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount105 reqQuantityAndAccountDetails,SecuritiesFinancingTransactionDetails48 reqSecuritiesFinancingAdditionalDetails )
    {
    ...
    public required QuantityAndAccount105 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount105 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount105 QuantityAndAccountDetails { get; set; } 
    #endif
