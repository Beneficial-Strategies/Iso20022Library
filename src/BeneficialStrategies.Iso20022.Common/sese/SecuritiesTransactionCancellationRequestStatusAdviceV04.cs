...
public partial record SecuritiesTransactionCancellationRequestStatusAdviceV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionCancellationRequestStatusAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionCancellationRequestStatusAdviceV04( Identification1 reqCancellationRequestReference,ProcessingStatus45Choice_ reqProcessingStatus )
    {
    ...
    public required ProcessingStatus45Choice_ ProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ProcessingStatus45Choice_ ProcessingStatus { get; init; } 
    #else
    public ProcessingStatus45Choice_ ProcessingStatus { get; set; } 
    #endif
