...
/// <summary>
/// This record is an implementation of the sese.032.002.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionGenerationNotification002V09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.032.002.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.032.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotification002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotification002V09( SettlementTypeAndIdentification24 reqTransactionIdentificationDetails,SecuritiesTradeDetails107 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount86 reqQuantityAndAccountDetails,SettlementDetails177 reqSettlementParameters )
    {
    ...
    [IsoXmlTag("TradDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SecuritiesTradeDetails107 TradeDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SecuritiesTradeDetails107 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails107 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails107 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_J4Co-ffYEeiNZp_PtLohLw")]
...
// Since SecuritiesSettlementTransactionGenerationNotification002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionGenerationNotification002V09.
