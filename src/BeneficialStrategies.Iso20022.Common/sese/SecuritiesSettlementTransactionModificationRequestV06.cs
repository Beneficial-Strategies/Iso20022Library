...
public partial record SecuritiesSettlementTransactionModificationRequestV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequestV06( TransactionDetails106 reqModifiedTransactionDetails )
    {
    ...
    #else
    public TransactionDetails106 ModifiedTransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionModificationRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequestV06.
