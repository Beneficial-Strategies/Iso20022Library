...
public partial record TransferOutConfirmationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferOutConfirmationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferOutConfirmationV04( MessageIdentification1 reqMessageIdentification,Transfer23 reqTransferDetails,InvestmentAccount22 reqAccountDetails )
    {
    ...
    public required Transfer23 TransferDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transfer23 TransferDetails { get; init; } 
    #else
    public Transfer23 TransferDetails { get; set; } 
    #endif
...
// Since TransferOutConfirmationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TransferOutConfirmationV04.
