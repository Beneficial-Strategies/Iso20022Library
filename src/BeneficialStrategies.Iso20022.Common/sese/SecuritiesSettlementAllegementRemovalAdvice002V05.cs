...
/// <summary>
/// This record is an implementation of the sese.029.002.05 ISO standard message type.
...
public partial record SecuritiesSettlementAllegementRemovalAdvice002V05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.029.002.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementAllegementRemovalAdvice002V05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementAllegementRemovalAdvice002V05( SettlementTypeAndIdentification22 reqAccountServicerTransactionIdentification,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    public TransactionDetails139? TransactionDetails { get; init; } 
    #else
    public TransactionDetails139? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementAllegementRemovalAdvice002V05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementAllegementRemovalAdvice002V05.
