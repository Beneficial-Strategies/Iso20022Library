...
/// <summary>
/// This record is an implementation of the sese.026.001.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionReversalAdviceV09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdviceV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV09( SettlementTypeAndIdentification19 reqTransactionIdentificationDetails,Identification14 reqConfirmationReference,SecuritiesTradeDetails118 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount77 reqQuantityAndAccountDetails,SettlementDetails163 reqSettlementParameters )
    {
...
// Since SecuritiesSettlementTransactionReversalAdviceV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV09.
