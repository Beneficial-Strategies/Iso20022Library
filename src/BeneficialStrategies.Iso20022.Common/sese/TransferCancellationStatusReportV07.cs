...
public partial record TransferCancellationStatusReportV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferCancellationStatusReportV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferCancellationStatusReportV07( MessageIdentification1 reqMessageIdentification,CancellationStatusAndReason5 reqStatusReport )
    {
    ...
    public required CancellationStatusAndReason5 StatusReport { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CancellationStatusAndReason5 StatusReport { get; init; } 
    #else
    public CancellationStatusAndReason5 StatusReport { get; set; } 
    #endif
...
// Since TransferCancellationStatusReportV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TransferCancellationStatusReportV07.
