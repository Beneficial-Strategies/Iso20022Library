...
/// <summary>
/// This record is an implementation of the sese.026.001.05 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionReversalAdviceV05 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV05( SettlementTypeAndIdentification19 reqTransactionIdentificationDetails,Identification14 reqConfirmationReference,SecuritiesTradeDetails53 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount41 reqQuantityAndAccountDetails,SettlementDetails90 reqSettlementParameters )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AdditionalParameters23? AdditionalParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AdditionalParameters23? AdditionalParameters { get; init; } 
    #else
    public AdditionalParameters23? AdditionalParameters { get; set; } 
    #endif
    ...
    public required SecuritiesTradeDetails53 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails53 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails53 TradeDetails { get; set; } 
    #endif
    ...
    public required QuantityAndAccount41 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount41 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount41 QuantityAndAccountDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails90 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails90 SettlementParameters { get; init; } 
    #else
    public SettlementDetails90 SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies what settlement standing instruction database is to be used to derive the settlement parties involved in the transaction.
    /// </summary>
    [IsoId("_YSWIEQCTEeW_3KiG8SEjHA")]
    ...
    public AmountAndDirection46? SettledAmount { get; init; } 
    #else
    public AmountAndDirection46? SettledAmount { get; set; } 
    #endif
    ...
    public OtherAmounts30? OtherAmounts { get; init; } 
    #else
    public OtherAmounts30? OtherAmounts { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionReversalAdviceV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV05.
