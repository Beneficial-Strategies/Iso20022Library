...
public partial record SecuritiesSettlementTransactionInstruction002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstruction002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstruction002V07( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters20 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails63 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount56 reqQuantityAndAccountDetails,SettlementDetails132 reqSettlementParameters )
    {
    ...
    public required SettlementDetails132 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails132 SettlementParameters { get; init; } 
    #else
    public SettlementDetails132 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionInstruction002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionInstruction002V07.
