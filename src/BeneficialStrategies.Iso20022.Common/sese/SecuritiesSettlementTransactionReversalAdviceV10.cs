...
/// <summary>
/// This record is an implementation of the sese.026.001.10 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionReversalAdviceV10 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.10";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdviceV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV10( SettlementTypeAndIdentification27 reqTransactionIdentificationDetails,System.String reqConfirmationReference,SecuritiesTradeDetails118 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount96 reqQuantityAndAccountDetails,SettlementDetails199 reqSettlementParameters )
    {
    ...
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required System.String ConfirmationReference { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public System.String ConfirmationReference { get; init; } 
    #else
    public System.String ConfirmationReference { get; set; } 
    #endif
    
    /// <summary>
    /// Additional parameters for the transaction.
    /// </summary>
    [IsoId("_x9gW3SgTEeym1_Zp1BTvEw")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SettlementDetails199 SettlementParameters { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SettlementDetails199 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails199 SettlementParameters { get; init; } 
    #else
    public SettlementDetails199 SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies what settlement standing instruction database is to be used to derive the settlement parties involved in the transaction.
    /// </summary>
    [IsoId("_x9gW6SgTEeym1_Zp1BTvEw")]
...
// Since SecuritiesSettlementTransactionReversalAdviceV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV10.
