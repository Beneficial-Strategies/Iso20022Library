...
public partial record SecuritiesTransactionCancellationRequestStatusAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionCancellationRequestStatusAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionCancellationRequestStatusAdviceV02( Identification1 reqCancellationRequestReference,ProcessingStatus13Choice_ reqProcessingStatus )
    {
    ...
    public TransactionIdentifications11? TransactionIdentification { get; init; } 
    #else
    public TransactionIdentifications11? TransactionIdentification { get; set; } 
    #endif
    ...
    #else
    public ProcessingStatus13Choice_ ProcessingStatus { get; set; } 
    #endif
...
// Since SecuritiesTransactionCancellationRequestStatusAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionCancellationRequestStatusAdviceV02.
