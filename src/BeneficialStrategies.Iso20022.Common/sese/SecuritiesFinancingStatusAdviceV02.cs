...
[DataContract]
#endif
public partial record SecuritiesFinancingStatusAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingStatusAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingStatusAdviceV02( TransactionIdentifications1 reqTransactionIdentification )
    {
    ...
    public SecuritiesFinancingTransactionDetails8? TransactionDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails8? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesFinancingStatusAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingStatusAdviceV02.
