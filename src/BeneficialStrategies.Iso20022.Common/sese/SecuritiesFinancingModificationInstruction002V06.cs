...
/// <summary>
/// This record is an implementation of the sese.036.002.06 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesFinancingModificationInstruction002V06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.036.002.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.036.002.06";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingModificationInstruction002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V06( TransactionTypeAndAdditionalParameters20 reqTransactionTypeAndModificationAdditionalParameters,SecuritiesTradeDetails12 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount61 reqQuantityAndAccountDetails,SecuritiesFinancingTransactionDetails32 reqSecuritiesFinancingAdditionalDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required QuantityAndAccount61 QuantityAndAccountDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required QuantityAndAccount61 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount61 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount61 QuantityAndAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the closing of the securities financing transaction.
    /// </summary>
    [IsoId("_yYMhT5w2EeazcsnODTksnQ")]
...
// Since SecuritiesFinancingModificationInstruction002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingModificationInstruction002V06.
