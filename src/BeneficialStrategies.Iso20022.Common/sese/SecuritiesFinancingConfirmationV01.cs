...
public partial record SecuritiesFinancingConfirmationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmationV01( DocumentIdentification11 reqIdentification,TransactionTypeAndAdditionalParameters3 reqTransactionIdentificationDetails,SecuritiesTradeDetails6 reqTradeDetails,SecurityIdentification11 reqFinancialInstrumentIdentification,QuantityAndAccount6 reqQuantityAndAccountDetails )
    {
    ...
    public required QuantityAndAccount6 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount6 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount6 QuantityAndAccountDetails { get; set; } 
    #endif
    ...
    public SecuritiesFinancingTransactionDetails3? SecuritiesFinancingDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails3? SecuritiesFinancingDetails { get; set; } 
    #endif
    ...
    public SettlementDetails9? SettlementParameters { get; init; } 
    #else
    public SettlementDetails9? SettlementParameters { get; set; } 
    #endif
