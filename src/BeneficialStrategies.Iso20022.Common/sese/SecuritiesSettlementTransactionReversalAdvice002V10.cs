...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionReversalAdvice002V10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdvice002V10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdvice002V10( SettlementTypeAndIdentification28 reqTransactionIdentificationDetails,System.String reqConfirmationReference,SecuritiesTradeDetails128 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount108 reqQuantityAndAccountDetails,SettlementDetails209 reqSettlementParameters )
    {
    ...
    public required QuantityAndAccount108 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount108 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount108 QuantityAndAccountDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails209 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails209 SettlementParameters { get; init; } 
    #else
    public SettlementDetails209 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionReversalAdvice002V10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdvice002V10.
