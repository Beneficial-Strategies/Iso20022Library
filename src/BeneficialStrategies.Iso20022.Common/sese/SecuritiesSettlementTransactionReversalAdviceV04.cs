...
public partial record SecuritiesSettlementTransactionReversalAdviceV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV04( SettlementTypeAndIdentification15 reqTransactionIdentificationDetails,Identification1 reqConfirmationReference,SecuritiesTradeDetails31 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount28 reqQuantityAndAccountDetails,SettlementDetails70 reqSettlementParameters )
    {
