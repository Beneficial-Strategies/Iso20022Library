...
public partial record PortfolioTransferNotificationV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferNotificationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferNotificationV02( Pagination reqPagination,Statement19 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public SecuritiesTradeDetails19? TransferNotificationDetails { get; init; } 
    #else
    public SecuritiesTradeDetails19? TransferNotificationDetails { get; set; } 
    #endif
