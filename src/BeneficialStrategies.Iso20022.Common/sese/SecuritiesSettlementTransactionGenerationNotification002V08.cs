...
public partial record SecuritiesSettlementTransactionGenerationNotification002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotification002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotification002V08( SettlementTypeAndIdentification24 reqTransactionIdentificationDetails,SecuritiesTradeDetails87 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount69 reqQuantityAndAccountDetails,SettlementDetails156 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails87 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails87 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails87 TradeDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails156 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails156 SettlementParameters { get; init; } 
    #else
    public SettlementDetails156 SettlementParameters { get; set; } 
    #endif
