...
public partial record SecuritiesSettlementConditionModificationStatusAdviceV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionModificationStatusAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionModificationStatusAdviceV03( Identification1 reqRequestReference,ProcessingStatus18Choice_ reqProcessingStatus )
    {
