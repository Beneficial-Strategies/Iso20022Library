...
public partial record SecuritiesSettlementTransactionModificationRequestStatusAdvice002V04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequestStatusAdvice002V04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequestStatusAdvice002V04( Identification16 reqModificationRequestReference,SecuritiesAccount30 reqSafekeepingAccount,ModificationProcessingStatus8Choice_ reqModificationProcessingStatus )
    {
    ...
    public TransactionDetails84? TransactionDetails { get; init; } 
    #else
    public TransactionDetails84? TransactionDetails { get; set; } 
    #endif
