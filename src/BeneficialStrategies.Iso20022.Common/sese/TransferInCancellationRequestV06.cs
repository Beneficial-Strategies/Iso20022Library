...
public partial record TransferInCancellationRequestV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferInCancellationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferInCancellationRequestV06( MessageIdentification1 reqMessageIdentification,Cancellation9Choice_ reqCancellation )
    {
    ...
    public required Cancellation9Choice_ Cancellation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Cancellation9Choice_ Cancellation { get; init; } 
    #else
    public Cancellation9Choice_ Cancellation { get; set; } 
    #endif
