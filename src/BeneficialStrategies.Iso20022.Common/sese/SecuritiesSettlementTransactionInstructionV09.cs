...
public partial record SecuritiesSettlementTransactionInstructionV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstructionV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstructionV09( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters19 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails97 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount79 reqQuantityAndAccountDetails,SettlementDetails164 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails97 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails97 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails97 TradeDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails164 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails164 SettlementParameters { get; init; } 
    #else
    public SettlementDetails164 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionInstructionV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionInstructionV09.
