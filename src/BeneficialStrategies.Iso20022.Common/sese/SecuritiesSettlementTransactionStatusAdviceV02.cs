...
public partial record SecuritiesSettlementTransactionStatusAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdviceV02( TransactionIdentifications9 reqTransactionIdentification )
    {
    ...
    public TransactionIdentifications9 TransactionIdentification { get; init; } 
    #else
    public TransactionIdentifications9 TransactionIdentification { get; set; } 
    #endif
    ...
    public TransactionDetails22? TransactionDetails { get; init; } 
    #else
    public TransactionDetails22? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionStatusAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionStatusAdviceV02.
