...
public partial record PortfolioTransferInstructionV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferInstructionV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferInstructionV09( MessageIdentification1 reqMessageReference,InvestmentAccount69 reqTransferorAccount,PartyIdentification132 reqTransferee,PortfolioTransfer3 reqProductTransfer )
    {
    ...
    public required PortfolioTransfer3 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PortfolioTransfer3 ProductTransfer { get; init; } 
    #else
    public PortfolioTransfer3 ProductTransfer { get; set; } 
    #endif
