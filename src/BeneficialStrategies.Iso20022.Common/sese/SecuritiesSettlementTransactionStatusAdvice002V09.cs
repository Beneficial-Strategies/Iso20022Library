...
public partial record SecuritiesSettlementTransactionStatusAdvice002V09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdvice002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdvice002V09( TransactionIdentifications38 reqTransactionIdentification )
    {
    ...
    public TransactionDetails110? TransactionDetails { get; init; } 
    #else
    public TransactionDetails110? TransactionDetails { get; set; } 
    #endif
