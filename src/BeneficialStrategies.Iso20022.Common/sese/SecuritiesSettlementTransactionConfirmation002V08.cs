...
public partial record SecuritiesSettlementTransactionConfirmation002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionConfirmation002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionConfirmation002V08( SettlementTypeAndIdentification24 reqTransactionIdentificationDetails,SecuritiesTradeDetails86 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount72 reqQuantityAndAccountDetails,SettlementDetails155 reqSettlementParameters )
    {
...
// Since SecuritiesSettlementTransactionConfirmation002V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionConfirmation002V08.
