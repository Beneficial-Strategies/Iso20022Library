...
public partial record SecuritiesSettlementTransactionInstruction002V09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstruction002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstruction002V09( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters20 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails108 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount86 reqQuantityAndAccountDetails,SettlementDetails178 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails108 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails108 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails108 TradeDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails178 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails178 SettlementParameters { get; init; } 
    #else
    public SettlementDetails178 SettlementParameters { get; set; } 
    #endif
