...
/// <summary>
/// This record is an implementation of the sese.036.002.07 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesFinancingModificationInstruction002V07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.036.002.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.036.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingModificationInstruction002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V07( TransactionTypeAndAdditionalParameters20 reqTransactionTypeAndModificationAdditionalParameters,SecuritiesTradeDetails103 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount87 reqQuantityAndAccountDetails,SecuritiesFinancingTransactionDetails48 reqSecuritiesFinancingAdditionalDetails )
    {
    ...
    public TransactionTypeAndAdditionalParameters20 TransactionTypeAndModificationAdditionalParameters { get; init; } 
    #else
    public TransactionTypeAndAdditionalParameters20 TransactionTypeAndModificationAdditionalParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the securities financing deal.
    /// </summary>
    [IsoId("_SsHYiffWEeiNZp_PtLohLw")]
    ...
    public required SecuritiesTradeDetails103 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails103 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails103 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_SsHYi_fWEeiNZp_PtLohLw")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required QuantityAndAccount87 QuantityAndAccountDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required QuantityAndAccount87 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount87 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount87 QuantityAndAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the closing of the securities financing transaction.
    /// </summary>
    [IsoId("_SsHYj_fWEeiNZp_PtLohLw")]
    ...
    public required SecuritiesFinancingTransactionDetails48 SecuritiesFinancingAdditionalDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesFinancingTransactionDetails48 SecuritiesFinancingAdditionalDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails48 SecuritiesFinancingAdditionalDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.
    /// </summary>
    [IsoId("_SsHYkffWEeiNZp_PtLohLw")]
    ...
    public SettlementDetails172? SettlementParameters { get; init; } 
    #else
    public SettlementDetails172? SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Identifies the chain of delivering settlement parties.
    /// </summary>
    [IsoId("_SsHYk_fWEeiNZp_PtLohLw")]
...
// Since SecuritiesFinancingModificationInstruction002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingModificationInstruction002V07.
