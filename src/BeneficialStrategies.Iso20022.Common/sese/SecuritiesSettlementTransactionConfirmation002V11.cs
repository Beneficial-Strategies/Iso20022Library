...
/// <summary>
/// This record is an implementation of the sese.025.002.11 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionConfirmation002V11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.025.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionConfirmation002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionConfirmation002V11( SettlementTypeAndIdentification28 reqTransactionIdentificationDetails,SecuritiesTradeDetails128 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount108 reqQuantityAndAccountDetails,SettlementDetails211 reqSettlementParameters )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SettlementDetails211 SettlementParameters { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SettlementDetails211 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails211 SettlementParameters { get; init; } 
    #else
    public SettlementDetails211 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionConfirmation002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionConfirmation002V11.
