...
public partial record SecuritiesSettlementConditionsModificationRequest002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionsModificationRequest002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionsModificationRequest002V06( SecuritiesAccount30 reqSafekeepingAccount,RequestDetails16 reqRequestDetails )
    {
    ...
    public AdditionalInformation12? AdditionalInformation { get; init; } 
    #else
    public AdditionalInformation12? AdditionalInformation { get; set; } 
    #endif
...
// Since SecuritiesSettlementConditionsModificationRequest002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionsModificationRequest002V06.
