...
public partial record PortfolioTransferCancellationRequestV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferCancellationRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferCancellationRequestV04( MessageIdentification1 reqMessageReference,Cancellation3Choice_ reqCancellation )
    {
    ...
    public required Cancellation3Choice_ Cancellation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Cancellation3Choice_ Cancellation { get; init; } 
    #else
    public Cancellation3Choice_ Cancellation { get; set; } 
    #endif
...
// Since PortfolioTransferCancellationRequestV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferCancellationRequestV04.
