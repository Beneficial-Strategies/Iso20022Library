...
public partial record SecuritiesFinancingInstructionV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingInstructionV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingInstructionV06( System.String reqTransactionIdentification,TransactionTypeAndAdditionalParameters9 reqTransactionTypeAndAdditionalParameters,SecuritiesTradeDetails56 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount39 reqQuantityAndAccountDetails,SecuritiesFinancingTransactionDetails28 reqSecuritiesFinancingDetails )
    {
    ...
    public required TransactionTypeAndAdditionalParameters9 TransactionTypeAndAdditionalParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionTypeAndAdditionalParameters9 TransactionTypeAndAdditionalParameters { get; init; } 
    #else
    public TransactionTypeAndAdditionalParameters9 TransactionTypeAndAdditionalParameters { get; set; } 
    #endif
