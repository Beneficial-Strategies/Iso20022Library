...
public partial record PortfolioTransferConfirmationV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferConfirmationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferConfirmationV06( MessageIdentification1 reqMessageReference,Account15 reqTransferorAccount,PartyIdentification2Choice_ reqTransferee,ISATransfer21 reqProductTransfer )
    {
    ...
    public required ISATransfer21 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ISATransfer21 ProductTransfer { get; init; } 
    #else
    public ISATransfer21 ProductTransfer { get; set; } 
    #endif
