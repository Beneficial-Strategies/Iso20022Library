...
/// <summary>
/// This record is an implementation of the sese.024.001.05 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionStatusAdviceV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.024.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdviceV05( TransactionIdentifications16 reqTransactionIdentification )
    {
    ...
    public ProcessingStatus37Choice_? ProcessingStatus { get; init; } 
    #else
    public ProcessingStatus37Choice_? ProcessingStatus { get; set; } 
    #endif
    ...
    public TransactionDetails61? TransactionDetails { get; init; } 
    #else
    public TransactionDetails61? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionStatusAdviceV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionStatusAdviceV05.
