...
/// <summary>
/// This record is an implementation of the sese.024.001.03 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionStatusAdviceV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.024.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdviceV03( TransactionIdentifications16 reqTransactionIdentification )
    {
    ...
    public TransactionDetails36? TransactionDetails { get; init; } 
    #else
    public TransactionDetails36? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionStatusAdviceV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionStatusAdviceV03.
