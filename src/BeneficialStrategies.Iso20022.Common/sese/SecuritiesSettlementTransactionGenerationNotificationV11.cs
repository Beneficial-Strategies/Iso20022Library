...
public partial record SecuritiesSettlementTransactionGenerationNotificationV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotificationV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotificationV11( SettlementTypeAndIdentification27 reqTransactionIdentificationDetails,SecuritiesTradeDetails117 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount95 reqQuantityAndAccountDetails,SettlementDetails204 reqSettlementParameters )
    {
    ...
    public Linkages61? Linkages { get; init; } 
    #else
    public Linkages61? Linkages { get; set; } 
    #endif
    ...
    public required SettlementDetails204 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails204 SettlementParameters { get; init; } 
    #else
    public SettlementDetails204 SettlementParameters { get; set; } 
    #endif
