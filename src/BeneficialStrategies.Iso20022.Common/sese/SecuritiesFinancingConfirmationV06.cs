...
/// <summary>
/// This record is an implementation of the sese.035.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesFinancingConfirmationV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.035.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmationV06( TransactionTypeAndAdditionalParameters10 reqTransactionIdentificationDetails,SecuritiesTradeDetails55 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount40 reqQuantityAndAccountDetails )
    {
    ...
    [IsoXmlTag("TxIdDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required TransactionTypeAndAdditionalParameters10 TransactionIdentificationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required TransactionTypeAndAdditionalParameters10 TransactionIdentificationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionTypeAndAdditionalParameters10 TransactionIdentificationDetails { get; init; } 
    #else
    public TransactionTypeAndAdditionalParameters10 TransactionIdentificationDetails { get; set; } 
    #endif
    ...
    public required SecuritiesTradeDetails55 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails55 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails55 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_YSMWfQCTEeW_3KiG8SEjHA")]
    ...
    public SettlementDetails96? SettlementParameters { get; init; } 
    #else
    public SettlementDetails96? SettlementParameters { get; set; } 
    #endif
    ...
    public OtherAmounts31? OtherAmounts { get; init; } 
    #else
    public OtherAmounts31? OtherAmounts { get; set; } 
    #endif
    
    /// <summary>
    /// Other business parties relevant to the transaction.
    /// </summary>
    [IsoId("_YSMWkwCTEeW_3KiG8SEjHA")]
...
// Since SecuritiesFinancingConfirmationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmationV06.
