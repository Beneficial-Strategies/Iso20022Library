...
public partial record SecuritiesSettlementTransactionGenerationNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotificationV05( SettlementTypeAndIdentification15 reqTransactionIdentificationDetails,SecuritiesTradeDetails33 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount25 reqQuantityAndAccountDetails,SettlementDetails67 reqSettlementParameters )
    {
    ...
    public GeneratedReason3? GeneratedReason { get; init; } 
    #else
    public GeneratedReason3? GeneratedReason { get; set; } 
    #endif
    ...
    public StatusAndReason19? StatusAndReason { get; init; } 
    #else
    public StatusAndReason19? StatusAndReason { get; set; } 
    #endif
