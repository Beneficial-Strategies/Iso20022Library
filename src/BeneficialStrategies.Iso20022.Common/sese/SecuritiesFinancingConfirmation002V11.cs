...
public partial record SecuritiesFinancingConfirmation002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmation002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmation002V11( TransactionTypeAndAdditionalParameters19 reqTransactionIdentificationDetails,SecuritiesTradeDetails124 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount103 reqQuantityAndAccountDetails )
    {
    ...
    public required QuantityAndAccount103 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount103 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount103 QuantityAndAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesFinancingConfirmation002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmation002V11.
