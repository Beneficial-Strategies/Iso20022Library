...
/// <summary>
/// This record is an implementation of the sese.032.001.04 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionGenerationNotificationV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.032.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotificationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotificationV04( SettlementTypeAndIdentification15 reqTransactionIdentificationDetails,SecuritiesTradeDetails1 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount25 reqQuantityAndAccountDetails,SettlementDetails42 reqSettlementParameters )
    {
...
// Since SecuritiesSettlementTransactionGenerationNotificationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionGenerationNotificationV04.
