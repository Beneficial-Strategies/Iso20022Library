...
public partial record SecuritiesSettlementTransactionCounterpartyResponseV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionCounterpartyResponseV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionCounterpartyResponseV04( TransactionIdentification6 reqTransactionIdentification,ResponseStatus6Choice_ reqResponseStatus )
    {
    ...
    public TransactionDetails149? TransactionDetails { get; init; } 
    #else
    public TransactionDetails149? TransactionDetails { get; set; } 
    #endif
