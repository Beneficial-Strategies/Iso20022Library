...
public partial record PortfolioTransferNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferNotificationV05( Pagination1 reqPagination,Statement62 reqStatementGeneralDetails,SecuritiesAccount19 reqSafekeepingAccount )
    {
    ...
    public SecuritiesTradeDetails72? TransferNotificationDetails { get; init; } 
    #else
    public SecuritiesTradeDetails72? TransferNotificationDetails { get; set; } 
    #endif
