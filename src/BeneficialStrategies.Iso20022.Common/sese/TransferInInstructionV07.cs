...
public partial record TransferInInstructionV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferInInstructionV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferInInstructionV07( MessageIdentification1 reqMessageIdentification,Transfer32 reqTransferDetails,InvestmentAccount56 reqAccountDetails )
    {
    ...
    public required Transfer32 TransferDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transfer32 TransferDetails { get; init; } 
    #else
    public Transfer32 TransferDetails { get; set; } 
    #endif
...
// Since TransferInInstructionV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TransferInInstructionV07.
