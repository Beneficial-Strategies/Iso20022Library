...
public partial record SecuritiesFinancingConfirmation002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmation002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmation002V06( TransactionTypeAndAdditionalParameters12 reqTransactionIdentificationDetails,SecuritiesTradeDetails58 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount46 reqQuantityAndAccountDetails )
    {
    ...
    public TransactionTypeAndAdditionalParameters12 TransactionIdentificationDetails { get; init; } 
    #else
    public TransactionTypeAndAdditionalParameters12 TransactionIdentificationDetails { get; set; } 
    #endif
    ...
    public required QuantityAndAccount46 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount46 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount46 QuantityAndAccountDetails { get; set; } 
    #endif
