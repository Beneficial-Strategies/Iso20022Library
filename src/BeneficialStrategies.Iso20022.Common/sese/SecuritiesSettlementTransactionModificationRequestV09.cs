...
/// <summary>
/// This record is an implementation of the sese.038.001.09 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionModificationRequestV09 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.038.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequestV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequestV09( TransactionDetails150 reqModifiedTransactionDetails )
    {
    ...
    public TransactionDetails150 ModifiedTransactionDetails { get; init; } 
    #else
    public TransactionDetails150 ModifiedTransactionDetails { get; set; } 
    #endif
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType37Choice_> UpdateType { get; init; } = new ValueList<UpdateType37Choice_>(){};
...
// Since SecuritiesSettlementTransactionModificationRequestV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequestV09.
