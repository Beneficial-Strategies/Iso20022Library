...
public partial record SecuritiesFinancingStatusAdvice002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingStatusAdvice002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingStatusAdvice002V08( TransactionIdentifications35 reqTransactionIdentification )
    {
    ...
    public SecuritiesFinancingTransactionDetails49? TransactionDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails49? TransactionDetails { get; set; } 
    #endif
