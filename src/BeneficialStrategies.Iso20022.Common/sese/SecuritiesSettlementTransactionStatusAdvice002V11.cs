...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionStatusAdvice002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdvice002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdvice002V11( TransactionIdentifications38 reqTransactionIdentification )
    {
    ...
    public ProcessingStatus81Choice_? ProcessingStatus { get; init; } 
    #else
    public ProcessingStatus81Choice_? ProcessingStatus { get; set; } 
    #endif
    ...
    public SettlementStatus29Choice_? SettlementStatus { get; init; } 
    #else
    public SettlementStatus29Choice_? SettlementStatus { get; set; } 
    #endif
    ...
    public TransactionDetails142? TransactionDetails { get; init; } 
    #else
    public TransactionDetails142? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionStatusAdvice002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionStatusAdvice002V11.
