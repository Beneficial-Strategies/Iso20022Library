...
// global using ExternalSystemPartyTypeCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalSystemPartyTypeCode.cs (extensible ISO registry); deferred, no current production impact
...
// global using ExternalChequeCancellationStatusCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalChequeCancellationStatusCode.cs (extensible ISO registry); deferred, no current production impact
//global using ExternalInstructedAgentInstructionCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInstructedAgentInstructionCode.cs (extensible ISO registry); deferred, no current production impact
global using ExternalChequeCancellationReasonCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalChequeCancellationReasonCode.cs (extensible ISO registry); deferred, no current production impact
...
// global using ExternalInvestigationActionCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationActionCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationActionReasonCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationActionReasonCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationInstrumentCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationInstrumentCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationReasonSubType1Code = System.String;  // BUCKET B (1 live usage) — shadows Codesets/ExternalInvestigationReasonSubType1Code.cs (extensible ISO registry, needs IIsoExternalCode struct, not enum) — DEFERRED TO BATCH 2 (large, ~92 members)
// global using ExternalInvestigationReasonSubTypeCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationReasonSubTypeCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationReason1Code = System.String;  // BUCKET B (1 live usage) — shadows Codesets/ExternalInvestigationReason1Code.cs (extensible ISO registry, needs IIsoExternalCode struct, not enum) — DEFERRED TO BATCH 2 (large, ~61 members)
// global using ExternalInvestigationReasonCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationReasonCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationServiceLevelCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationServiceLevelCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationStatusCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationStatusCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationStatusReasonCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationStatusReasonCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationSubTypeCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationSubTypeCode.cs (extensible ISO registry); deferred, no current production impact
// global using ExternalInvestigationTypeCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalInvestigationTypeCode.cs (extensible ISO registry); deferred, no current production impact
global using ExternalLegalFramework1Code = System.String;
global using ExternalLegalFrameworkCode = System.String;
global using ExternalMessageFunctionCode = System.String;  // BUCKET B (0 live usages) — shadows Codesets/ExternalMessageFunctionCode.cs (extensible ISO registry); deferred, no current production impact
