...
global using IsoQUICKIdentifier = System.String; // In ISO 20022 spec (IdentifierSet) — no formal pattern; Japanese QUICK proprietary format
global using IsoWertpapierIdentifier = System.String; // In ISO 20022 spec (IdentifierSet) — no formal pattern; German WKN (6-digit proprietary)
global using IsoDutchIdentifier = System.String; // In ISO 20022 spec (IdentifierSet) — no formal pattern; Dutch securities proprietary format
global using IsoValorenIdentifier = System.String; // In ISO 20022 spec (IdentifierSet) — no formal pattern; Swiss Telekurs proprietary format
global using IsoSicovamIdentifier = System.String; // In ISO 20022 spec (IdentifierSet) — no formal pattern; French Sicovam 5-digit proprietary
...
global using IsogYear = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsogYearMonth = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsohexBinary = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoID = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoIDREF = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoIDREFS = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using Isolanguage = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoName = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoNCName = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoNMTOKEN = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoNMTOKENS = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsonormalizedString = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
global using IsoQName = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
...
global using Isotoken = System.String; // W3C XML Schema built-in (xsi:type: iso20022:SchemaType) — no ISO 20022 constraint
