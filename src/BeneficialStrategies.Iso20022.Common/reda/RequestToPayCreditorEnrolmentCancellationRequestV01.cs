...
public partial record RequestToPayCreditorEnrolmentCancellationRequestV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a RequestToPayCreditorEnrolmentCancellationRequestV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestToPayCreditorEnrolmentCancellationRequestV01( EnrolmentHeader2 reqHeader,CreditorEnrolmentCancellation2 reqCancellationData )
    {
        Header = reqHeader;
    ...
    #else
    public CreditorEnrolmentCancellation2 CancellationData { get; set; } 
    #endif
