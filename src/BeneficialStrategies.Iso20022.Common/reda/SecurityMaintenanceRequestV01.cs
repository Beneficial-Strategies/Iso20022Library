...
public partial record SecurityMaintenanceRequestV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecurityMaintenanceRequestV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecurityMaintenanceRequestV01( UpdateType36Choice_ reqUpdateType,SecurityIdentification39 reqFinancialInstrumentIdentification )
    {
    ...
    #else
    public UpdateType36Choice_ UpdateType { get; set; } 
    #endif
    ...
    public SecuritiesUpdateReason1Choice_? UpdateReason { get; init; } 
    #else
    public SecuritiesUpdateReason1Choice_? UpdateReason { get; set; } 
    #endif
