...
public partial record BankToCustomerDebitCreditNotificationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerDebitCreditNotificationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerDebitCreditNotificationV07( GroupHeader73 reqGroupHeader,AccountNotification15 reqNotification )
    {
    ...
    public required AccountNotification15 Notification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountNotification15 Notification { get; init; } 
    #else
    public AccountNotification15 Notification { get; set; } 
    #endif
...
// Since BankToCustomerDebitCreditNotificationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerDebitCreditNotificationV07.
