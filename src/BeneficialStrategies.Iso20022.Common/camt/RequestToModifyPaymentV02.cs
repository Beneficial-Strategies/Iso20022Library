...
/// <summary>
/// This record is an implementation of the camt.087.001.02 ISO standard message type.
...
[DataContract]
#endif
public partial record RequestToModifyPaymentV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.087.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a RequestToModifyPaymentV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestToModifyPaymentV02( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction2Choice_ reqUnderlying,RequestedModification4 reqModification )
    {
    ...
    public required RequestedModification4 Modification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RequestedModification4 Modification { get; init; } 
    #else
    public RequestedModification4 Modification { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_wQzayxPeEeSVo-TFVwFHvA")]
...
// Since RequestToModifyPaymentV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RequestToModifyPaymentV02.
