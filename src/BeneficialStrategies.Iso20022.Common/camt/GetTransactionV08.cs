...
public partial record GetTransactionV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a GetTransactionV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GetTransactionV08( MessageHeader9 reqMessageHeader )
    {
    ...
    public TransactionQuery5? TransactionQueryDefinition { get; init; } 
    #else
    public TransactionQuery5? TransactionQueryDefinition { get; set; } 
    #endif
...
// Since GetTransactionV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to GetTransactionV08.
