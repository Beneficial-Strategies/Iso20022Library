...
public partial record UnableToApplyV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a UnableToApplyV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnableToApplyV05( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction3Choice_ reqUnderlying,UnableToApplyJustification3Choice_ reqJustification )
    {
...
// Since UnableToApplyV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to UnableToApplyV05.
