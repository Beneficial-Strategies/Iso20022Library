...
[IsoId("_sODgsFkyEeGeoaLUQk__nA_-596470641")]
...
public partial record CustomerPaymentCancellationRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentCancellationRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentCancellationRequestV02( CaseAssignment3 reqAssignment,UnderlyingTransaction6 reqUnderlying )
    {
    ...
    public required UnderlyingTransaction6 Underlying { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnderlyingTransaction6 Underlying { get; init; } 
    #else
    public UnderlyingTransaction6 Underlying { get; set; } 
    #endif
...
// Since CustomerPaymentCancellationRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentCancellationRequestV02.
