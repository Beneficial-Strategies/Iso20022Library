...
/// <summary>
/// This record is an implementation of the camt.052.001.10 ISO standard message type.
...
public partial record BankToCustomerAccountReportV10 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.052.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerAccountReportV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerAccountReportV10( GroupHeader81 reqGroupHeader,AccountReport31 reqReport )
    {
    ...
    [IsoXmlTag("Rpt")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AccountReport31 Report { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AccountReport31 Report { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountReport31 Report { get; init; } 
    #else
    public AccountReport31 Report { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_7xDUqSttEeysar7zFstVmw")]
...
// Since BankToCustomerAccountReportV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerAccountReportV10.
