...
/// <summary>
/// This record is an implementation of the camt.030.001.05 ISO standard message type.
...
public partial record NotificationOfCaseAssignmentV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.030.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a NotificationOfCaseAssignmentV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public NotificationOfCaseAssignmentV05( ReportHeader5 reqHeader,Case5 reqCase,CaseAssignment5 reqAssignment,CaseForwardingNotification3 reqNotification )
    {
        Header = reqHeader;
        Case = reqCase;
...
// Since NotificationOfCaseAssignmentV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to NotificationOfCaseAssignmentV05.
