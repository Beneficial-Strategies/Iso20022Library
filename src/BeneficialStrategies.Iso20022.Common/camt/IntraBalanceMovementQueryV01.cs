...
public partial record IntraBalanceMovementQueryV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraBalanceMovementQueryV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraBalanceMovementQueryV01( IntraBalanceQueryDefinition9 reqQueryDefinition )
    {
    ...
    public required IntraBalanceQueryDefinition9 QueryDefinition { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraBalanceQueryDefinition9 QueryDefinition { get; init; } 
    #else
    public IntraBalanceQueryDefinition9 QueryDefinition { get; set; } 
    #endif
