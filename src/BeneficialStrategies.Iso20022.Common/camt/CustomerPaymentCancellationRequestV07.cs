...
/// <summary>
/// This record is an implementation of the camt.055.001.07 ISO standard message type.
...
public partial record CustomerPaymentCancellationRequestV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.055.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentCancellationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentCancellationRequestV07( CaseAssignment4 reqAssignment,UnderlyingTransaction21 reqUnderlying )
    {
    ...
    public required UnderlyingTransaction21 Underlying { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnderlyingTransaction21 Underlying { get; init; } 
    #else
    public UnderlyingTransaction21 Underlying { get; set; } 
    #endif
...
// Since CustomerPaymentCancellationRequestV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentCancellationRequestV07.
