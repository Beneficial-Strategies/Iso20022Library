...
[DataContract]
#endif
public partial record BankToCustomerStatementV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerStatementV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerStatementV05( GroupHeader58 reqGroupHeader,AccountStatement5 reqStatement )
    {
    ...
    public required AccountStatement5 Statement { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountStatement5 Statement { get; init; } 
    #else
    public AccountStatement5 Statement { get; set; } 
    #endif
...
// Since BankToCustomerStatementV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerStatementV05.
