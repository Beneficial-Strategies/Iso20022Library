...
/// <summary>
/// This record is an implementation of the camt.087.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record RequestToModifyPaymentV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.087.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a RequestToModifyPaymentV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestToModifyPaymentV06( CaseAssignment5 reqAssignment,UnderlyingTransaction5Choice_ reqUnderlying,RequestedModification8 reqModification )
    {
    ...
    public required RequestedModification8 Modification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RequestedModification8 Modification { get; init; } 
    #else
    public RequestedModification8 Modification { get; set; } 
    #endif
...
// Since RequestToModifyPaymentV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RequestToModifyPaymentV06.
