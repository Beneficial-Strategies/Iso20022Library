...
public partial record AdditionalPaymentInformationV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalPaymentInformationV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalPaymentInformationV09( CaseAssignment5 reqAssignment,UnderlyingTransaction5Choice_ reqUnderlying,PaymentComplementaryInformation8 reqInformation )
    {
    ...
    public required PaymentComplementaryInformation8 Information { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentComplementaryInformation8 Information { get; init; } 
    #else
    public PaymentComplementaryInformation8 Information { get; set; } 
    #endif
...
// Since AdditionalPaymentInformationV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdditionalPaymentInformationV09.
