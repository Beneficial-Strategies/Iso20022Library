...
/// <summary>
/// This record is an implementation of the camt.058.001.03 ISO standard message type.
...
[IsoId("_sQSVUFkyEeGeoaLUQk__nA_474784398")]
...
public partial record NotificationToReceiveCancellationAdviceV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.058.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a NotificationToReceiveCancellationAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public NotificationToReceiveCancellationAdviceV03( GroupHeader59 reqGroupHeader,OriginalNotification6 reqOriginalNotification )
    {
    ...
    public required OriginalNotification6 OriginalNotification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OriginalNotification6 OriginalNotification { get; init; } 
    #else
    public OriginalNotification6 OriginalNotification { get; set; } 
    #endif
...
// Since NotificationToReceiveCancellationAdviceV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to NotificationToReceiveCancellationAdviceV03.
