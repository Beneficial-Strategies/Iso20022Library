...
/// <summary>
/// This record is an implementation of the camt.053.001.11 ISO standard message type.
...
public partial record BankToCustomerStatementV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.053.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerStatementV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerStatementV11( GroupHeader81 reqGroupHeader,AccountStatement12 reqStatement )
    {
    ...
    #else
    public AccountStatement12 Statement { get; set; } 
    #endif
...
// Since BankToCustomerStatementV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerStatementV11.
