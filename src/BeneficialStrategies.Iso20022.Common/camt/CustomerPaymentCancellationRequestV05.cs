...
/// <summary>
/// This record is an implementation of the camt.055.001.05 ISO standard message type.
...
[DataContract]
#endif
public partial record CustomerPaymentCancellationRequestV05 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.055.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentCancellationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentCancellationRequestV05( CaseAssignment3 reqAssignment,UnderlyingTransaction12 reqUnderlying )
    {
    ...
    [IsoXmlTag("Undrlyg")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required UnderlyingTransaction12 Underlying { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required UnderlyingTransaction12 Underlying { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnderlyingTransaction12 Underlying { get; init; } 
    #else
    public UnderlyingTransaction12 Underlying { get; set; } 
    #endif
...
// Since CustomerPaymentCancellationRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentCancellationRequestV05.
