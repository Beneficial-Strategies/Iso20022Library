...
/// <summary>
/// This record is an implementation of the camt.055.001.11 ISO standard message type.
...
public partial record CustomerPaymentCancellationRequestV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.055.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentCancellationRequestV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentCancellationRequestV11( CaseAssignment5 reqAssignment,UnderlyingTransaction30 reqUnderlying )
    {
...
// Since CustomerPaymentCancellationRequestV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentCancellationRequestV11.
