...
/// <summary>
/// This record is an implementation of the camt.058.001.07 ISO standard message type.
...
[DataContract]
#endif
public partial record NotificationToReceiveCancellationAdviceV07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.058.001.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.058.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a NotificationToReceiveCancellationAdviceV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public NotificationToReceiveCancellationAdviceV07( GroupHeader77 reqGroupHeader,OriginalNotification14 reqOriginalNotification )
    {
...
// Since NotificationToReceiveCancellationAdviceV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to NotificationToReceiveCancellationAdviceV07.
