...
/// <summary>
/// This record is an implementation of the camt.086.001.04 ISO standard message type.
...
public partial record BankServicesBillingStatementV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.086.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a BankServicesBillingStatementV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankServicesBillingStatementV04( ReportHeader6 reqReportHeader,StatementGroup4 reqBillingStatementGroup )
    {
    ...
    public required StatementGroup4 BillingStatementGroup { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatementGroup4 BillingStatementGroup { get; init; } 
    #else
    public StatementGroup4 BillingStatementGroup { get; set; } 
    #endif
