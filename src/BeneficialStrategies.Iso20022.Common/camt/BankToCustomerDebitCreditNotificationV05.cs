...
public partial record BankToCustomerDebitCreditNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerDebitCreditNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerDebitCreditNotificationV05( GroupHeader58 reqGroupHeader,AccountNotification11 reqNotification )
    {
    ...
    public required AccountNotification11 Notification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountNotification11 Notification { get; init; } 
    #else
    public AccountNotification11 Notification { get; set; } 
    #endif
...
// Since BankToCustomerDebitCreditNotificationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerDebitCreditNotificationV05.
