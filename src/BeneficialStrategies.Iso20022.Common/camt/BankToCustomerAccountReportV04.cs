...
public partial record BankToCustomerAccountReportV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerAccountReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerAccountReportV04( GroupHeader58 reqGroupHeader,AccountReport16 reqReport )
    {
    ...
    public required AccountReport16 Report { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountReport16 Report { get; init; } 
    #else
    public AccountReport16 Report { get; set; } 
    #endif
...
// Since BankToCustomerAccountReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BankToCustomerAccountReportV04.
