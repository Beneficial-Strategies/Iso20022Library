...
/// <summary>
/// This record is an implementation of the camt.028.001.04 ISO standard message type.
...
[IsoId("_sYCjIVkyEeGeoaLUQk__nA_-1513426724")]
...
[DataContract]
#endif
public partial record AdditionalPaymentInformationV04 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.028.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalPaymentInformationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalPaymentInformationV04( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction2Choice_ reqUnderlying,PaymentComplementaryInformation3 reqInformation )
    {
    ...
    /// </summary>
    [IsoId("_sYLtEFkyEeGeoaLUQk__nA_1488272778")]
    ...
    /// </summary>
    [IsoId("_sYLtEVkyEeGeoaLUQk__nA_605039491")]
    [DisplayName("Case")]
    #if DECLARE_DATACONTRACT
    ...
    /// </summary>
    [IsoId("_sYLtElkyEeGeoaLUQk__nA_491200425")]
    ...
    /// </summary>
    [IsoId("_sYVeEFkyEeGeoaLUQk__nA_-392032862")]
    ...
    [IsoXmlTag("Inf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required PaymentComplementaryInformation3 Information { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required PaymentComplementaryInformation3 Information { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentComplementaryInformation3 Information { get; init; } 
    #else
    public PaymentComplementaryInformation3 Information { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_sYVeEVkyEeGeoaLUQk__nA_1999910584")]
...
// Since AdditionalPaymentInformationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdditionalPaymentInformationV04.
