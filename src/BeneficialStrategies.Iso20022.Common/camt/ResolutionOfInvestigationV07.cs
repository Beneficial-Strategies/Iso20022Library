...
public partial record ResolutionOfInvestigationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ResolutionOfInvestigationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ResolutionOfInvestigationV07( CaseAssignment3 reqAssignment,InvestigationStatus3Choice_ reqStatus )
    {
    ...
    public UnderlyingTransaction17? CancellationDetails { get; init; } 
    #else
    public UnderlyingTransaction17? CancellationDetails { get; set; } 
    #endif
    ...
    public CorrectiveTransaction2Choice_? CorrectionTransaction { get; init; } 
    #else
    public CorrectiveTransaction2Choice_? CorrectionTransaction { get; set; } 
    #endif
...
// Since ResolutionOfInvestigationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ResolutionOfInvestigationV07.
