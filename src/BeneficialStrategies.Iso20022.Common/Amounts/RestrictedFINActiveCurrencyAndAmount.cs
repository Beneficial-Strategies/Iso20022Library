...
/// </summary>
public partial record RestrictedFINActiveCurrencyAndAmount
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a RestrictedFINActiveCurrencyAndAmount instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RestrictedFINActiveCurrencyAndAmount( System.String reqCurrency,System.Decimal reqAmount )
    {
