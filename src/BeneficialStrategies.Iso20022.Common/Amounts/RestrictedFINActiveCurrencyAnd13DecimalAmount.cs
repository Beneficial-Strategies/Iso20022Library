...
public partial record RestrictedFINActiveCurrencyAnd13DecimalAmount
{
    ...
    #else
    /// <summary>
    /// Constructs a RestrictedFINActiveCurrencyAnd13DecimalAmount instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RestrictedFINActiveCurrencyAnd13DecimalAmount( System.String reqCurrency,System.Decimal reqAmount )
    {
