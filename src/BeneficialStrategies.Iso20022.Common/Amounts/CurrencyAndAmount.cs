...
public partial record CurrencyAndAmount
{
    ...
    #else
    /// <summary>
    /// Constructs a CurrencyAndAmount instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CurrencyAndAmount( System.String reqCurrency,System.Decimal reqAmount )
    {
