...
/// <summary>
/// This record is an implementation of the catm.001.001.03 ISO standard message type.
...
public partial record StatusReportV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "catm.001.001.03";
    ...
    /// </summary>
    public StatusReportV03( Header4 reqHeader,StatusReport3 reqStatusReport,ContentInformationType9 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    [IsoXmlTag("StsRpt")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required StatusReport3 StatusReport { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required StatusReport3 StatusReport { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusReport3 StatusReport { get; init; } 
    #else
    public StatusReport3 StatusReport { get; set; } 
    #endif
