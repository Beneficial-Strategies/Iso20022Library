...
public partial record CertificateManagementRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CertificateManagementRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CertificateManagementRequestV02( Header29 reqHeader,CertificateManagementRequest1 reqCertificateManagementRequest )
    {
        Header = reqHeader;
