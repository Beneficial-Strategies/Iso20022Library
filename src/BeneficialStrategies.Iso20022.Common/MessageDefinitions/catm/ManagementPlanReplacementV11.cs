...
public partial record ManagementPlanReplacementV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ManagementPlanReplacementV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ManagementPlanReplacementV11( TMSHeader1 reqHeader,ManagementPlan11 reqManagementPlan )
    {
        Header = reqHeader;
    ...
    public required ManagementPlan11 ManagementPlan { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ManagementPlan11 ManagementPlan { get; init; } 
    #else
    public ManagementPlan11 ManagementPlan { get; set; } 
    #endif
