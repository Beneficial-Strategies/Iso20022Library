...
/// <summary>
/// This record is an implementation of the catm.006.001.04 ISO standard message type.
...
public partial record MaintenanceDelegationResponseV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "catm.006.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationResponseV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationResponseV04( TMSHeader1 reqHeader,MaintenanceDelegationResponse4 reqMaintenanceDelegationResponse )
    {
        Header = reqHeader;
    ...
    public required MaintenanceDelegationResponse4 MaintenanceDelegationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MaintenanceDelegationResponse4 MaintenanceDelegationResponse { get; init; } 
    #else
    public MaintenanceDelegationResponse4 MaintenanceDelegationResponse { get; set; } 
    #endif
...
// Since MaintenanceDelegationResponseV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MaintenanceDelegationResponseV04.
