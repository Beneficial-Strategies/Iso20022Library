...
/// <summary>
/// This record is an implementation of the catm.002.001.08 ISO standard message type.
...
public partial record ManagementPlanReplacementV08 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "catm.002.001.08";
    ...
    #else
    /// <summary>
    /// Constructs a ManagementPlanReplacementV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ManagementPlanReplacementV08( TMSHeader1 reqHeader,ManagementPlan8 reqManagementPlan )
    {
        Header = reqHeader;
    ...
    [IsoXmlTag("MgmtPlan")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required ManagementPlan8 ManagementPlan { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required ManagementPlan8 ManagementPlan { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ManagementPlan8 ManagementPlan { get; init; } 
    #else
    public ManagementPlan8 ManagementPlan { get; set; } 
    #endif
...
// Since ManagementPlanReplacementV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ManagementPlanReplacementV08.
