...
public partial record MaintenanceDelegationRequestV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationRequestV04( MaintenanceDelegationRequest4 reqMaintenanceDelegationRequest,ContentInformationType18 reqSecurityTrailer )
    {
    ...
    public required MaintenanceDelegationRequest4 MaintenanceDelegationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MaintenanceDelegationRequest4 MaintenanceDelegationRequest { get; init; } 
    #else
    public MaintenanceDelegationRequest4 MaintenanceDelegationRequest { get; set; } 
    #endif
