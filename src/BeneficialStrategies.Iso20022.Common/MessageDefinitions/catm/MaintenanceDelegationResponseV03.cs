...
public partial record MaintenanceDelegationResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationResponseV03( Header29 reqHeader,MaintenanceDelegationResponse3 reqMaintenanceDelegationResponse )
    {
        Header = reqHeader;
    ...
    public required MaintenanceDelegationResponse3 MaintenanceDelegationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MaintenanceDelegationResponse3 MaintenanceDelegationResponse { get; init; } 
    #else
    public MaintenanceDelegationResponse3 MaintenanceDelegationResponse { get; set; } 
    #endif
