...
public partial record FIToFICustomerCreditTransferV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerCreditTransferV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerCreditTransferV11( GroupHeader96 reqGroupHeader,CreditTransferTransaction58 reqCreditTransferTransactionInformation )
    {
    ...
    public required CreditTransferTransaction58 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction58 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction58 CreditTransferTransactionInformation { get; set; } 
    #endif
...
// Since FIToFICustomerCreditTransferV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerCreditTransferV11.
