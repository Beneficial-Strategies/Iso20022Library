...
public partial record FinancialInstitutionCreditTransferV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstitutionCreditTransferV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstitutionCreditTransferV09( GroupHeader93 reqGroupHeader,CreditTransferTransaction44 reqCreditTransferTransactionInformation )
    {
    ...
    public required CreditTransferTransaction44 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction44 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction44 CreditTransferTransactionInformation { get; set; } 
    #endif
