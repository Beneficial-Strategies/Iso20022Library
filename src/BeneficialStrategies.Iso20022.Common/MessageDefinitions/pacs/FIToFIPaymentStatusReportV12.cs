...
[DataContract]
#endif
public partial record FIToFIPaymentStatusReportV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentStatusReportV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentStatusReportV12( GroupHeader101 reqGroupHeader )
    {
    ...
    public PaymentTransaction130? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction130? TransactionInformationAndStatus { get; set; } 
    #endif
...
// Since FIToFIPaymentStatusReportV12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentStatusReportV12.
