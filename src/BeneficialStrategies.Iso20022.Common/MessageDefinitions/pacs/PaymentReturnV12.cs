...
public partial record PaymentReturnV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReturnV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReturnV12( GroupHeader99 reqGroupHeader )
    {
    ...
    public PaymentTransaction146? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction146? TransactionInformation { get; set; } 
    #endif
...
// Since PaymentReturnV12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PaymentReturnV12.
