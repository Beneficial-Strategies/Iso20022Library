...
/// <summary>
/// This record is an implementation of the pacs.004.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record PaymentReturnV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.004.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReturnV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReturnV06( GroupHeader72 reqGroupHeader )
    {
    ...
    public PaymentTransaction65? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction65? TransactionInformation { get; set; } 
    #endif
...
// Since PaymentReturnV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PaymentReturnV06.
