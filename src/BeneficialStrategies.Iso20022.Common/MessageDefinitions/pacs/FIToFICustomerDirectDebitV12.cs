...
public record FIToFICustomerDirectDebitV12 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.003.001.12";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.12";
    ...
    public ValueList<DirectDebitTransactionInformation35> DirectDebitTransactionInformation { get; init; } =
        [];
...
// Since FIToFICustomerDirectDebitV12Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerDirectDebitV12.
