...
public partial record FinancialInstitutionDirectDebitV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstitutionDirectDebitV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstitutionDirectDebitV05( GroupHeader92 reqGroupHeader,CreditTransferTransaction53 reqCreditInstruction )
    {
    ...
    public required CreditTransferTransaction53 CreditInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction53 CreditInstruction { get; init; } 
    #else
    public CreditTransferTransaction53 CreditInstruction { get; set; } 
    #endif
...
// Since FinancialInstitutionDirectDebitV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstitutionDirectDebitV05.
