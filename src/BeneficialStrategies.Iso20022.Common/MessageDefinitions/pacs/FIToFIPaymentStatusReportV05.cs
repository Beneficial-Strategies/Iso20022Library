...
/// <summary>
/// This record is an implementation of the pacs.002.001.05 ISO standard message type.
...
[DataContract]
#endif
public partial record FIToFIPaymentStatusReportV05 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.002.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentStatusReportV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentStatusReportV05( GroupHeader53 reqGroupHeader,OriginalGroupHeader1 reqOriginalGroupInformationAndStatus )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction43? TransactionInformationAndStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction43? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction43? TransactionInformationAndStatus { get; set; } 
    #endif
...
// Since FIToFIPaymentStatusReportV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentStatusReportV05.
