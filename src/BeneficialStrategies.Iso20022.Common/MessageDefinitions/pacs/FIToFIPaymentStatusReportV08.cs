...
public partial record FIToFIPaymentStatusReportV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentStatusReportV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentStatusReportV08( GroupHeader53 reqGroupHeader )
    {
    ...
    public PaymentTransaction80? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction80? TransactionInformationAndStatus { get; set; } 
    #endif
