...
/// <summary>
/// This record is an implementation of the pacs.003.001.07 ISO standard message type.
...
public partial record FIToFICustomerDirectDebitV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.003.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerDirectDebitV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerDirectDebitV07( GroupHeader50 reqGroupHeader,DirectDebitTransactionInformation21 reqDirectDebitTransactionInformation )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required DirectDebitTransactionInformation21 DirectDebitTransactionInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required DirectDebitTransactionInformation21 DirectDebitTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DirectDebitTransactionInformation21 DirectDebitTransactionInformation { get; init; } 
    #else
    public DirectDebitTransactionInformation21 DirectDebitTransactionInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_cceql2k2Eeanu6HLe77Rkg")]
...
// Since FIToFICustomerDirectDebitV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerDirectDebitV07.
