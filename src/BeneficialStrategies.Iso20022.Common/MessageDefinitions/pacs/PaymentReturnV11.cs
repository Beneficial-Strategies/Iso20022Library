...
/// <summary>
/// This record is an implementation of the pacs.004.001.11 ISO standard message type.
...
[DataContract]
#endif
public partial record PaymentReturnV11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.004.001.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReturnV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReturnV11( GroupHeader99 reqGroupHeader )
    {
    ...
    public GroupHeader99 GroupHeader { get; init; } 
    #else
    public GroupHeader99 GroupHeader { get; set; } 
    #endif
    
    /// <summary>
    /// Information concerning the original group of transactions, to which the message refers.
    /// </summary>
    [IsoId("_jMZaNdcBEeq_l4BJLVUF2Q")]
    ...
    public OriginalGroupHeader18? OriginalGroupInformation { get; init; } 
    #else
    public OriginalGroupHeader18? OriginalGroupInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Information concerning the original transactions, to which the return message refers.
    /// </summary>
    [IsoId("_jMZaN9cBEeq_l4BJLVUF2Q")]
    ...
    [IsoXmlTag("TxInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction133? TransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction133? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction133? TransactionInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_jMZaOdcBEeq_l4BJLVUF2Q")]
...
// Since PaymentReturnV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PaymentReturnV11.
