...
public partial record PaymentReturnV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReturnV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReturnV10( GroupHeader90 reqGroupHeader )
    {
    ...
    public PaymentTransaction118? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction118? TransactionInformation { get; set; } 
    #endif
...
// Since PaymentReturnV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PaymentReturnV10.
