...
public partial record FIToFICustomerDirectDebitV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerDirectDebitV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerDirectDebitV06( GroupHeader50 reqGroupHeader,DirectDebitTransactionInformation20 reqDirectDebitTransactionInformation )
    {
    ...
    public required DirectDebitTransactionInformation20 DirectDebitTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DirectDebitTransactionInformation20 DirectDebitTransactionInformation { get; init; } 
    #else
    public DirectDebitTransactionInformation20 DirectDebitTransactionInformation { get; set; } 
    #endif
