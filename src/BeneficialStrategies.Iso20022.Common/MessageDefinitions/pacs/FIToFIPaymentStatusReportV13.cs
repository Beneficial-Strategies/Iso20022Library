...
/// <summary>
/// This record is an implementation of the pacs.002.001.13 ISO standard message type.
...
[DataContract]
#endif
public partial record FIToFIPaymentStatusReportV13 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.002.001.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentStatusReportV13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentStatusReportV13( GroupHeader101 reqGroupHeader )
    {
    ...
    public GroupHeader101 GroupHeader { get; init; } 
    #else
    public GroupHeader101 GroupHeader { get; set; } 
    #endif
    
    /// <summary>
    /// Original group information concerning the group of transactions, to which the status report message refers to.
    /// </summary>
    [IsoId("_L7vn8wLFEe2X55dNQNVKfg")]
    ...
    public PaymentTransaction142? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction142? TransactionInformationAndStatus { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_L7vn9wLFEe2X55dNQNVKfg")]
...
// Since FIToFIPaymentStatusReportV13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentStatusReportV13.
