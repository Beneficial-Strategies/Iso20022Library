...
public partial record ATMDiagnosticRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMDiagnosticRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMDiagnosticRequestV02( Header31 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ContentInformationType10? ProtectedATMDiagnosticRequest { get; init; } 
    #else
    public ContentInformationType10? ProtectedATMDiagnosticRequest { get; set; } 
    #endif
    ...
    public ATMDiagnosticRequest2? ATMDiagnosticRequest { get; init; } 
    #else
    public ATMDiagnosticRequest2? ATMDiagnosticRequest { get; set; } 
    #endif
