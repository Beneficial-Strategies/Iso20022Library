...
public partial record ATMKeyDownloadRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMKeyDownloadRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMKeyDownloadRequestV02( Header31 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ATMKeyDownloadRequest2? ATMKeyDownloadRequest { get; init; } 
    #else
    public ATMKeyDownloadRequest2? ATMKeyDownloadRequest { get; set; } 
    #endif
