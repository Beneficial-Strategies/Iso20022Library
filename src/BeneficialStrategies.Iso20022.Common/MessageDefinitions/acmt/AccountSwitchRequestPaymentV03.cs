...
public partial record AccountSwitchRequestPaymentV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSwitchRequestPaymentV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSwitchRequestPaymentV03( MessageIdentification1 reqMessageIdentification,AccountSwitchDetails1 reqAccountSwitchDetails,CashAccount39 reqOldAccount,CreditTransferTransaction41 reqCreditInstruction )
    {
    ...
    public required CreditTransferTransaction41 CreditInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction41 CreditInstruction { get; init; } 
    #else
    public CreditTransferTransaction41 CreditInstruction { get; set; } 
    #endif
