...
public partial record AccountClosingAmendmentRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountClosingAmendmentRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountClosingAmendmentRequestV03( References4 reqReferences,AccountForAction1 reqAccountIdentification,BranchAndFinancialInstitutionIdentification6 reqAccountServicerIdentification,OrganisationIdentification29 reqOrganisationIdentification )
    {
