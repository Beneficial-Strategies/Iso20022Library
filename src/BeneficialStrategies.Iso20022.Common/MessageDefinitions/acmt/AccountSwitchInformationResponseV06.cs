...
/// <summary>
/// This record is an implementation of the acmt.028.001.06 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("dfaaa882-a9cd-4872-b814-d50a83cf82f5")]
[DisplayName("Account Switch Information Response V06")]
public record AccountSwitchInformationResponseV06 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "acmt.028.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:acmt.028.001.06";
