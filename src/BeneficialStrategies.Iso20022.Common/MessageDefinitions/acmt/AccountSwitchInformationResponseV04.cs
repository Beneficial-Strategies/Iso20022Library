...
[DisplayName("Account Switch Information Response V04")]
public record AccountSwitchInformationResponseV04 : IOuterRecord
{
    ...
    [IsoXmlTag("PmtInstr")]
    public ValueList<PaymentInstruction38> PaymentInstruction { get; init; } = [];
    ...
    public ValueList<DirectDebitInstructionDetails2> DirectDebitInstruction { get; init; } = [];
