...
public partial record AccountMandateMaintenanceRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountMandateMaintenanceRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountMandateMaintenanceRequestV03( References4 reqReferences,AccountForAction1 reqAccountIdentification,BranchAndFinancialInstitutionIdentification6 reqAccountServicerIdentification,Organisation34 reqOrganisationIdentification,OperationMandate5 reqMandate )
    {
