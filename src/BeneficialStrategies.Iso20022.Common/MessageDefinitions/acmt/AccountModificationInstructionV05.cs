...
public record AccountModificationInstructionV05 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(0)]
    [MaxLength(10)]
    public ValueList<AccountParties11> ModifiedAccountParties { get; init; } = [];
    ...
    [MinLength(0)]
    [MaxLength(10)]
    public ValueList<ModificationScope20> ModifiedIntermediaries { get; init; } = [];
    ...
    [MinLength(0)]
    [MaxLength(50)]
    public ValueList<ModificationScope25> ModifiedSavingsInvestmentPlan { get; init; } = [];
    ...
    [MinLength(0)]
    [MaxLength(10)]
    public ValueList<ModificationScope25> ModifiedWithdrawalInvestmentPlan { get; init; } = [];
    ...
    [MinLength(0)]
    [MaxLength(30)]
    public ValueList<ModificationScope22> ModifiedServiceLevelAgreement { get; init; } = [];
