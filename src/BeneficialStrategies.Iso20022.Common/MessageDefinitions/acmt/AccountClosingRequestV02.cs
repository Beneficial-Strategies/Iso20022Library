...
public partial record AccountClosingRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountClosingRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountClosingRequestV02( References4 reqReferences,AccountForAction2 reqAccountIdentification,BranchAndFinancialInstitutionIdentification5 reqAccountServicerIdentification,Organisation14 reqOrganisationIdentification )
    {
