...
public partial record NetworkManagementInitiationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a NetworkManagementInitiationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public NetworkManagementInitiationV03( Header63 reqHeader,NetworkManagementInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required NetworkManagementInitiation2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public NetworkManagementInitiation2 Body { get; init; } 
    #else
    public NetworkManagementInitiation2 Body { get; set; } 
    #endif
...
// Since NetworkManagementInitiationV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to NetworkManagementInitiationV03.
