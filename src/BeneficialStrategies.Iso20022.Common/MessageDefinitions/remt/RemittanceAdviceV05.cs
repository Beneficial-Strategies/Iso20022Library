...
[DisplayName("Remittance Advice V05")]
public record RemittanceAdviceV05 : IOuterRecord
{
    /// <summary>
    ...
    [IsoXmlTag("RmtInf")]
    [MinLength(1)]
    public ValueList<RemittanceInformation20> RemittanceInformation { get; init; } = [];
