...
public partial record ReconciliationInitiationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ReconciliationInitiationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReconciliationInitiationV03( Header60 reqHeader,ReconciliationInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required ReconciliationInitiation2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ReconciliationInitiation2 Body { get; init; } 
    #else
    public ReconciliationInitiation2 Body { get; set; } 
    #endif
