...
/// <summary>
/// This record is an implementation of the caad.009.001.02 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_xH5gsY7cEe6S0_1AaJzQCA")]
[DisplayName("Administrative Response V02")]
public partial record AdministrativeResponseV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "caad.009.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:caad.009.001.02";
    ...
    [IsoXmlTag("PrcgRslt")]
    public required ProcessingResult27 ProcessingResult { get; init; } 
    ...
    [IsoXmlTag("Rcncltn")]
    public required Reconciliation4 Reconciliation { get; init; } 
...
// Since AdministrativeResponseV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdministrativeResponseV02.
