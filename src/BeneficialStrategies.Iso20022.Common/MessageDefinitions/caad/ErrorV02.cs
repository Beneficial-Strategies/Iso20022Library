...
public partial record ErrorV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ErrorV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ErrorV02( Header45 reqHeader,Error1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public Header45 Header { get; init; } 
    #else
    public Header45 Header { get; set; } 
    #endif
    ...
    public required Error1 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Error1 Body { get; init; } 
    #else
    public Error1 Body { get; set; } 
    #endif
