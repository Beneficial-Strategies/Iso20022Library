...
/// <summary>
/// This record is an implementation of the caad.003.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_vC87EROHEfC1ZfCQz0xB3g")]
[DisplayName("Batch Transfer Initiation V04")]
public record BatchTransferInitiationV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "caad.003.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:caad.003.001.04";
    ...
    public ValueList<ClearingBatchData4> ClearingBatchData { get; init; } = [];
    ...
    [DisplayName("Record")]
    [IsoXmlTag("Rcrd")]
    public ValueList<Record4> Record { get; init; } = [];
...
// Since BatchTransferInitiationV04Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BatchTransferInitiationV04.
