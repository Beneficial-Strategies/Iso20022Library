...
public partial record BatchManagementResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BatchManagementResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BatchManagementResponseV01( Header38 reqHeader,BatchManagementResponse1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public Header38 Header { get; init; } 
    #else
    public Header38 Header { get; set; } 
    #endif
    ...
    public required BatchManagementResponse1 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public BatchManagementResponse1 Body { get; init; } 
    #else
    public BatchManagementResponse1 Body { get; set; } 
    #endif
...
// Since BatchManagementResponseV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to BatchManagementResponseV01.
