...
public partial record BatchManagementInitiationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BatchManagementInitiationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BatchManagementInitiationV01( Header38 reqHeader,BatchManagementInitiation1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required BatchManagementInitiation1 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public BatchManagementInitiation1 Body { get; init; } 
    #else
    public BatchManagementInitiation1 Body { get; set; } 
    #endif
