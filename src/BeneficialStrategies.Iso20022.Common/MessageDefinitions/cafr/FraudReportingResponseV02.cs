...
public partial record FraudReportingResponseV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FraudReportingResponseV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FraudReportingResponseV02( Header66 reqHeader,FraudReportingResponse2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required FraudReportingResponse2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FraudReportingResponse2 Body { get; init; } 
    #else
    public FraudReportingResponse2 Body { get; set; } 
    #endif
...
// Since FraudReportingResponseV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FraudReportingResponseV02.
