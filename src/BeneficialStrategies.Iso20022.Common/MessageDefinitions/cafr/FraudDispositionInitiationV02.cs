...
public partial record FraudDispositionInitiationV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FraudDispositionInitiationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FraudDispositionInitiationV02( Header66 reqHeader,FraudDispositionInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required FraudDispositionInitiation2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FraudDispositionInitiation2 Body { get; init; } 
    #else
    public FraudDispositionInitiation2 Body { get; set; } 
    #endif
