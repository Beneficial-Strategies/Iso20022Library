...
/// <summary>
/// This record is an implementation of the cafr.001.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_eCUWgROFEfC1ZfCQz0xB3g")]
[DisplayName("Fraud Reporting Initiation V04")]
public record FraudReportingInitiationV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "cafr.001.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:cafr.001.001.04";
    ...
    public CardNotReceivedData1? CardNotReceivedDetails { get; init; }
    ...
    public required FraudulentTransactionData4 FraudulentTransactionData { get; init; }
    ...
    [IsoXmlTag("LclData")]
    public LocalData23? LocalData { get; init; }
    ...
    [IsoXmlTag("RptdFrd")]
    public required ReportedFraud6 ReportedFraud { get; init; }
...
// Since FraudReportingInitiationV04Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FraudReportingInitiationV04.
