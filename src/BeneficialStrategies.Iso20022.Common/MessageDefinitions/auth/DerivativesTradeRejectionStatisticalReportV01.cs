...
public partial record DerivativesTradeRejectionStatisticalReportV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a DerivativesTradeRejectionStatisticalReportV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DerivativesTradeRejectionStatisticalReportV01( StatisticsPerCounterparty2Choice_ reqStatisticsPerCounterparty )
    {
    ...
    public StatisticsPerCounterparty2Choice_ StatisticsPerCounterparty { get; init; } 
    #else
    public StatisticsPerCounterparty2Choice_ StatisticsPerCounterparty { get; set; } 
    #endif
...
// Since DerivativesTradeRejectionStatisticalReportV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DerivativesTradeRejectionStatisticalReportV01.
