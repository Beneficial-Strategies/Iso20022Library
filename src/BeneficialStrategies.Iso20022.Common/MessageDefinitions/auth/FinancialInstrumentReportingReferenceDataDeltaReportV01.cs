...
public partial record FinancialInstrumentReportingReferenceDataDeltaReportV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentReportingReferenceDataDeltaReportV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentReportingReferenceDataDeltaReportV01( SecuritiesMarketReportHeader1 reqReportHeader )
    {
    ...
    public SecuritiesReferenceDeltaStatusReport2Choice_? FinancialInstrument { get; init; } 
    #else
    public SecuritiesReferenceDeltaStatusReport2Choice_? FinancialInstrument { get; set; } 
    #endif
...
// Since FinancialInstrumentReportingReferenceDataDeltaReportV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstrumentReportingReferenceDataDeltaReportV01.
