...
public partial record ContractRegistrationRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ContractRegistrationRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ContractRegistrationRequestV02( CurrencyControlHeader4 reqGroupHeader,ContractRegistration3 reqContractRegistration )
    {
    ...
    public required ContractRegistration3 ContractRegistration { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ContractRegistration3 ContractRegistration { get; init; } 
    #else
    public ContractRegistration3 ContractRegistration { get; set; } 
    #endif
