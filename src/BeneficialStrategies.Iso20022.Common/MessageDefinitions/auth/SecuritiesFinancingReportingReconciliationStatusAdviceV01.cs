...
public partial record SecuritiesFinancingReportingReconciliationStatusAdviceV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingReconciliationStatusAdviceV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingReconciliationStatusAdviceV01( TradeData14Choice_ reqReconciliationData )
    {
    ...
    public TradeData14Choice_ ReconciliationData { get; init; } 
    #else
    public TradeData14Choice_ ReconciliationData { get; set; } 
    #endif
