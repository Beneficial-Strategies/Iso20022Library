...
public partial record SecuritiesFinancingReportingTransactionReusedCollateralDataReportV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingTransactionReusedCollateralDataReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingTransactionReusedCollateralDataReportV02( TradeData36Choice_ reqTradeData )
    {
    ...
    public TradeData36Choice_ TradeData { get; init; } 
    #else
    public TradeData36Choice_ TradeData { get; set; } 
    #endif
