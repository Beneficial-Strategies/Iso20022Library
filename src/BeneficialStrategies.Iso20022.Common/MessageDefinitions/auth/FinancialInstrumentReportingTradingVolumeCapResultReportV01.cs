...
public partial record FinancialInstrumentReportingTradingVolumeCapResultReportV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentReportingTradingVolumeCapResultReportV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentReportingTradingVolumeCapResultReportV01( SecuritiesMarketReportHeader1 reqReportHeader,VolumeCapResult1 reqVolumeCapResult )
    {
        ReportHeader = reqReportHeader;
        VolumeCapResult = reqVolumeCapResult;
    }
    #endif
    #nullable enable
    ...
    public required VolumeCapResult1 VolumeCapResult { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public VolumeCapResult1 VolumeCapResult { get; init; } 
    #else
    public VolumeCapResult1 VolumeCapResult { get; set; } 
    #endif
