...
/// <summary>
/// This record is an implementation of the auth.025.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_R3HVYzEZEe6kQ-WGAhcVPQ")]
[DisplayName("Currency Control Supporting Document Delivery V04")]
public partial record CurrencyControlSupportingDocumentDeliveryV04 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "auth.025.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:auth.025.001.04";
