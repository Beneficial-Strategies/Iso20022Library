...
/// <summary>
/// This record is an implementation of the auth.070.001.02 ISO standard message type.
...
public partial record SecuritiesFinancingReportingTransactionMarginDataReportV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "auth.070.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingTransactionMarginDataReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingTransactionMarginDataReportV02( TradeData39Choice_ reqTradeData )
    {
    ...
    #else
    public TradeData39Choice_ TradeData { get; set; } 
    #endif
...
// Since SecuritiesFinancingReportingTransactionMarginDataReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingReportingTransactionMarginDataReportV02.
