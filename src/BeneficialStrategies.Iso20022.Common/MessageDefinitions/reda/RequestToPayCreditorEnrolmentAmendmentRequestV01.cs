...
/// </summary>
[Description(
    @"The RequestToPayCreditorEnrolmentAmendmentRequest message is sent by the creditor RTP (Request To Pay) provider to an RTP directory provider and optionally by the creditor to a creditor RTP provider to request for the amendment of the creditor registration in the RTP directory. |The message may also be forwarded to any authorised third party, as defined in the local scheme"
)]
[IsoId("_rNNBkeHzEeqbls7Gk4-ckA")]
[DisplayName("Request To Pay Creditor Enrolment Amendment Request V")]
public record RequestToPayCreditorEnrolmentAmendmentRequestV01 : IOuterRecord
{
    /// <summary>
...
// Since RequestToPayCreditorEnrolmentAmendmentRequestV01Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RequestToPayCreditorEnrolmentAmendmentRequestV01.
