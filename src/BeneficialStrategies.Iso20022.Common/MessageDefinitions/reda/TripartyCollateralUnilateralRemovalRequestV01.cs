...
/// </summary>
[Description(
    @"Scope:|A collateral giver/taker sends a TripartyCollateralFinancialInstrumentRemovalRequest to the Triparty Agent to remove a financial instrument from the collateral pool.||The status of this request is provided with the reda.028 , the CollateralDataStatusAdvice."
)]
[IsoId("_2uaNRys7EeySlt9bF77XfA")]
[DisplayName("Triparty Collateral Unilateral Removal Request V")]
public record TripartyCollateralUnilateralRemovalRequestV01 : IOuterRecord
{
    /// <summary>
