...
/// <summary>
/// This record is an implementation of the cafc.002.001.03 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_1jSlcZByEe6TWIDarRgYow")]
[DisplayName("Fee Collection Response V03")]
public partial record FeeCollectionResponseV03 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "cafc.002.001.03";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:cafc.002.001.03";
    ...
    [DisplayName("Context")]
    [IsoXmlTag("Cntxt")]
    public Context22? Context { get; init; } 
    ...
    /// <summary>
    /// Fee Collection Reference.
    /// </summary>
    [DisplayName("Fee Collection Reference")]
    [IsoXmlTag("FeeColltnRef")]
    public FeeCollectionReference2? FeeCollectionReference { get; init; } 
    ...
    [IsoXmlTag("TxChrtcs")]
    public TransactionCharacteristics4? TransactionCharacteristics { get; init; } 
...
// Since FeeCollectionResponseV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FeeCollectionResponseV03.
