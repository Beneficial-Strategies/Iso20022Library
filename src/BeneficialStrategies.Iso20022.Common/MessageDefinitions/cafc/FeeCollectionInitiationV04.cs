...
/// <summary>
/// This record is an implementation of the cafc.001.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_ArDaMROIEfC1ZfCQz0xB3g")]
[DisplayName("Fee Collection Initiation V04")]
public record FeeCollectionInitiationV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "cafc.001.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04";
    ...
    [IsoXmlTag("Accptr")]
    public AcceptorData4? Acceptor { get; init; }
    ...
    [DisplayName("Context")]
    [IsoXmlTag("Cntxt")]
    public Context29? Context { get; init; }
    ...
    [IsoXmlTag("TxChrtcs")]
    public TransactionCharacteristics7? TransactionCharacteristics { get; init; }
