...
/// <summary>
/// This record is an implementation of the colr.008.001.05 ISO standard message type.
...
public partial record CollateralProposalResponseV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "colr.008.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a CollateralProposalResponseV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralProposalResponseV05( System.String reqTransactionIdentification,Obligation5 reqObligation,CollateralProposalResponse3Choice_ reqProposalResponse )
    {
    ...
    public required Obligation5 Obligation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Obligation5 Obligation { get; init; } 
    #else
    public Obligation5 Obligation { get; set; } 
    #endif
    ...
    [IsoXmlTag("PrpslRspn")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CollateralProposalResponse3Choice_ ProposalResponse { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CollateralProposalResponse3Choice_ ProposalResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CollateralProposalResponse3Choice_ ProposalResponse { get; init; } 
    #else
    public CollateralProposalResponse3Choice_ ProposalResponse { get; set; } 
    #endif
...
// Since CollateralProposalResponseV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CollateralProposalResponseV05.
