...
/// <summary>
/// This record is an implementation of the colr.010.001.03 ISO standard message type.
...
public partial record CollateralSubstitutionRequestV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "colr.010.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a CollateralSubstitutionRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralSubstitutionRequestV03( System.String reqTransactionIdentification,Obligation3 reqObligation,CollateralSubstitution2 reqCollateralSubstitutionReturn )
    {
    ...
    public required CollateralSubstitution2 CollateralSubstitutionReturn { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CollateralSubstitution2 CollateralSubstitutionReturn { get; init; } 
    #else
    public CollateralSubstitution2 CollateralSubstitutionReturn { get; set; } 
    #endif
    ...
    public CollateralSubstitution3? CollateralSubstitutionDeliver { get; init; } 
    #else
    public CollateralSubstitution3? CollateralSubstitutionDeliver { get; set; } 
    #endif
...
// Since CollateralSubstitutionRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CollateralSubstitutionRequestV03.
