...
/// <summary>
/// This record is an implementation of the seev.032.002.07 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionEventProcessingStatusAdvice002V07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.032.002.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.032.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventProcessingStatusAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventProcessingStatusAdvice002V07( CorporateActionGeneralInformation144 reqCorporateActionGeneralInformation,EventProcessingStatus6Choice_ reqEventProcessingStatus )
    {
    ...
    public required EventProcessingStatus6Choice_ EventProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public EventProcessingStatus6Choice_ EventProcessingStatus { get; init; } 
    #else
    public EventProcessingStatus6Choice_ EventProcessingStatus { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_Szi5kAVREeqjd8n6wD9JVw")]
...
// Since CorporateActionEventProcessingStatusAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionEventProcessingStatusAdvice002V07.
