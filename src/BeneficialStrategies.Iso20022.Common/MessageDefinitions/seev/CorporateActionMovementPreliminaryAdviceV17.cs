...
/// <summary>
/// This record is an implementation of the seev.035.001.17 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_BwiGYY5cEfCNdMvBaLxujg")]
[DisplayName("Corporate Action Movement Preliminary Advice V17")]
public record CorporateActionMovementPreliminaryAdviceV17 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.035.001.17";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.035.001.17";
    ...
    public CorporateAction91? CorporateActionDetails { get; init; }
    ...
    public ValueList<CorporateActionOption252> CorporateActionMovementDetails { get; init; } = [];
...
// Since CorporateActionMovementPreliminaryAdviceV17Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceV17.
