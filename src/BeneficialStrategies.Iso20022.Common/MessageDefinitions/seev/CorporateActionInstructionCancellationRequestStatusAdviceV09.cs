...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdviceV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV09( CorporateActionGeneralInformation109 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus11Choice_ reqInstructionCancellationRequestStatus )
    {
