...
public record MeetingNotificationV10 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(1)]
    [MaxLength(5)]
    public ValueList<Meeting6> MeetingDetails { get; init; } = [];
    ...
    [MinLength(1)]
    [MaxLength(200)]
    public ValueList<SecurityPosition16> Security { get; init; } = [];
    ...
    [MinLength(0)]
    [MaxLength(1000)]
    public ValueList<Resolution6> Resolution { get; init; } = [];
...
// Since MeetingNotificationV10Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingNotificationV10.
