...
public record MeetingNotificationV08 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(0)]
    [MaxLength(1000)]
    public ValueList<Resolution5> Resolution { get; init; } = [];
...
// Since MeetingNotificationV08Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingNotificationV08.
