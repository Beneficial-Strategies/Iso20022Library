...
/// <summary>
/// This record is an implementation of the seev.031.002.15 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_nLWsI5t3Ee-wQIOX0djF2w")]
[DisplayName("Corporate Action Notification002V15")]
public partial record CorporateActionNotification002V15 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.031.002.15";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.031.002.15";
    ...
    [IsoXmlTag("AcctDtls")]
    public required AccountIdentification78Choice_ AccountDetails { get; init; } 
    ...
    public CorporateAction87? CorporateActionDetails { get; init; } 
    ...
    public required CorporateActionGeneralInformation194 CorporateActionGeneralInformation { get; init; } 
    ...
    public ValueList<CorporateActionOption247> CorporateActionOptionDetails { get; init; } = [];
...
// Since CorporateActionNotification002V15Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotification002V15.
