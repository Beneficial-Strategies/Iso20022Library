...
/// <summary>
/// This record is an implementation of the seev.042.002.11 ISO standard message type.
...
public partial record CorporateActionInstructionStatementReport002V11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.042.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatementReport002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatementReport002V11( Pagination1 reqPagination,Statement75 reqStatementGeneralDetails,AccountIdentification63 reqAccountAndStatementDetails )
    {
    ...
    public required AccountIdentification63 AccountAndStatementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountIdentification63 AccountAndStatementDetails { get; init; } 
    #else
    public AccountIdentification63 AccountAndStatementDetails { get; set; } 
    #endif
...
// Since CorporateActionInstructionStatementReport002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatementReport002V11.
