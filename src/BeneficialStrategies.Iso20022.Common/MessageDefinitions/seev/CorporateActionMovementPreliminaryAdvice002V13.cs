...
public partial record CorporateActionMovementPreliminaryAdvice002V13 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdvice002V13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdvice002V13( CorporateActionPreliminaryAdviceType2 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation168 reqCorporateActionGeneralInformation,AccountIdentification52Choice_ reqAccountDetails )
    {
    ...
    public CorporateAction65? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction65? CorporateActionDetails { get; set; } 
    #endif
    ...
    public CorporateActionOption206? CorporateActionMovementDetails { get; init; } 
    #else
    public CorporateActionOption206? CorporateActionMovementDetails { get; set; } 
    #endif
