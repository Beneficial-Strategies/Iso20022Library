...
public partial record CorporateActionEventProcessingStatusAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventProcessingStatusAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventProcessingStatusAdviceV02( CorporateActionGeneralInformation9 reqCorporateActionGeneralInformation,EventProcessingStatus1Choice_ reqEventProcessingStatus )
    {
