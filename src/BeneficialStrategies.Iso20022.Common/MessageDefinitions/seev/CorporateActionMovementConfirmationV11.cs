...
/// <summary>
/// This record is an implementation of the seev.036.001.11 ISO standard message type.
...
public partial record CorporateActionMovementConfirmationV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.036.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV11( CorporateActionGeneralInformation142 reqCorporateActionGeneralInformation,AccountAndBalance43 reqAccountDetails,CorporateActionOption162 reqCorporateActionConfirmationDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CorporateActionOption162 CorporateActionConfirmationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CorporateActionOption162 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption162 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption162 CorporateActionConfirmationDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementConfirmationV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmationV11.
