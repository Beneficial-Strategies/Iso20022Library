...
[DataContract]
#endif
public partial record CorporateActionInstructionV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionV03( CorporateActionGeneralInformation36 reqCorporateActionGeneralInformation,AccountAndBalance17 reqAccountDetails,CorporateActionOption38 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation36 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation36 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation36 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required CorporateActionOption38 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption38 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption38 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionV03.
