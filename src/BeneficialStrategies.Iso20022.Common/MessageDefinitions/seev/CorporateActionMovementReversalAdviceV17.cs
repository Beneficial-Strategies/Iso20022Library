...
/// <summary>
/// This record is an implementation of the seev.037.001.17 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_8gjZgaRfEfC9EJoPPbbyNQ")]
[DisplayName("Corporate Action Movement Reversal Advice V17")]
public record CorporateActionMovementReversalAdviceV17 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.001.17";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.17";
    ...
    public CorporateAction93? CorporateActionDetails { get; init; }
...
// Since CorporateActionMovementReversalAdviceV17Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdviceV17.
