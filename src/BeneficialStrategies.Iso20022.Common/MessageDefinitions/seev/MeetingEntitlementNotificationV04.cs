...
[IsoId("_Tme46dEwEd-BzquC8wXy7w_-1564035735")]
...
[DataContract]
#endif
public partial record MeetingEntitlementNotificationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingEntitlementNotificationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingEntitlementNotificationV04( MessageIdentification1 reqIdentification,MeetingReference4 reqMeetingReference,PartyIdentification9Choice_ reqNotifyingParty,EligibilityDates1 reqEligibility )
    {
    ...
    [MinLength(1)]
    [MaxLength(200)]
    public ValueList<SecurityPosition7> Security { get; init; } = new ValueList<SecurityPosition7>(){};
...
// Since MeetingEntitlementNotificationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingEntitlementNotificationV04.
