...
public partial record CorporateActionMovementConfirmationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV01( DocumentIdentification11 reqIdentification,CorporateActionGeneralInformation4 reqCorporateActionGeneralInformation,AccountAndBalance3 reqAccountDetails,CorporateActionOption4 reqCorporateActionConfirmationDetails )
    {
    ...
    public required AccountAndBalance3 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountAndBalance3 AccountDetails { get; init; } 
    #else
    public AccountAndBalance3 AccountDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption4 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption4 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption4 CorporateActionConfirmationDetails { get; set; } 
    #endif
