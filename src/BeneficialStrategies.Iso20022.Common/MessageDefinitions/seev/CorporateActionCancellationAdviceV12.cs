...
public partial record CorporateActionCancellationAdviceV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdviceV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdviceV12( CorporateActionCancellation3 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation135 reqCorporateActionGeneralInformation,AccountIdentification49Choice_ reqAccountsDetails )
    {
    ...
    public CorporateAction72? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction72? CorporateActionDetails { get; set; } 
    #endif
