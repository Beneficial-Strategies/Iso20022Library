...
public partial record CorporateActionEventProcessingStatusAdviceV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventProcessingStatusAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventProcessingStatusAdviceV04( CorporateActionGeneralInformation52 reqCorporateActionGeneralInformation,EventProcessingStatus1Choice_ reqEventProcessingStatus )
    {
...
// Since CorporateActionEventProcessingStatusAdviceV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionEventProcessingStatusAdviceV04.
