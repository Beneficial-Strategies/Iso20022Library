...
public record MeetingCancellationV08 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(1)]
    [MaxLength(200)]
    public ValueList<SecurityPosition15> Security { get; init; } = [];
...
// Since MeetingCancellationV08Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingCancellationV08.
