...
/// <summary>
/// This record is an implementation of the seev.037.002.16 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_m44cE5t3Ee-wQIOX0djF2w")]
[DisplayName("Corporate Action Movement Reversal Advice002V16")]
public partial record CorporateActionMovementReversalAdvice002V16 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.002.16";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.16";
    ...
    public required CorporateActionOption246 CorporateActionConfirmationDetails { get; init; } 
    ...
    public required CorporateActionGeneralInformation193 CorporateActionGeneralInformation { get; init; } 
    ...
    [IsoXmlTag("RvslRsn")]
    public CorporateActionReversalReason10? ReversalReason { get; init; } 
...
// Since CorporateActionMovementReversalAdvice002V16Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdvice002V16.
