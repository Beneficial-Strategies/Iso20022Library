...
public partial record CorporateActionEventProcessingStatusAdvice002V05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventProcessingStatusAdvice002V05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventProcessingStatusAdvice002V05( CorporateActionGeneralInformation94 reqCorporateActionGeneralInformation,EventProcessingStatus4Choice_ reqEventProcessingStatus )
    {
...
// Since CorporateActionEventProcessingStatusAdvice002V05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionEventProcessingStatusAdvice002V05.
