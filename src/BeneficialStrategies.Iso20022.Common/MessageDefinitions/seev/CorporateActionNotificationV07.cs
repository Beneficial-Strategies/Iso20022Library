...
public partial record CorporateActionNotificationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNotificationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNotificationV07( CorporateActionNotification5 reqNotificationGeneralInformation,CorporateActionGeneralInformation105 reqCorporateActionGeneralInformation,AccountIdentification32Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation105 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation105 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation105 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public FinancialInstrumentAttributes68? IntermediateSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes68? IntermediateSecurity { get; set; } 
    #endif
    ...
    public CorporateAction31? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction31? CorporateActionDetails { get; set; } 
    #endif
    ...
    public CorporateActionOption130? CorporateActionOptionDetails { get; init; } 
    #else
    public CorporateActionOption130? CorporateActionOptionDetails { get; set; } 
    #endif
...
// Since CorporateActionNotificationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV07.
