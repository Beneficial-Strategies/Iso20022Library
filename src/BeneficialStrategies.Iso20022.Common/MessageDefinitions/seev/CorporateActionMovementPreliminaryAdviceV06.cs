...
public partial record CorporateActionMovementPreliminaryAdviceV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceV06( CorporateActionPreliminaryAdviceType2 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation69 reqCorporateActionGeneralInformation,AccountIdentification23Choice_ reqAccountDetails )
    {
    ...
    public CorporateAction24? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction24? CorporateActionDetails { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? Registrar { get; init; } 
    #else
    public PartyIdentification40Choice_? Registrar { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? ResellingAgent { get; init; } 
    #else
    public PartyIdentification40Choice_? ResellingAgent { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? PhysicalSecuritiesAgent { get; init; } 
    #else
    public PartyIdentification40Choice_? PhysicalSecuritiesAgent { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? DropAgent { get; init; } 
    #else
    public PartyIdentification40Choice_? DropAgent { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? SolicitationAgent { get; init; } 
    #else
    public PartyIdentification40Choice_? SolicitationAgent { get; set; } 
    #endif
    ...
    public PartyIdentification40Choice_? InformationAgent { get; init; } 
    #else
    public PartyIdentification40Choice_? InformationAgent { get; set; } 
    #endif
