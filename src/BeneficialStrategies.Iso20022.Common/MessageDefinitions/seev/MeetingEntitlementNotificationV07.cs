...
public record MeetingEntitlementNotificationV07 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(1)]
    [MaxLength(200)]
    public ValueList<SecurityPosition13> Security { get; init; } = [];
...
// Since MeetingEntitlementNotificationV07Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingEntitlementNotificationV07.
