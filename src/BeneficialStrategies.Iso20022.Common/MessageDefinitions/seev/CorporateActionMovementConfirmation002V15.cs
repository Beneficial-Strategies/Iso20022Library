...
/// <summary>
/// This record is an implementation of the seev.036.002.15 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_UrnNY3SdEe6VWZz2tTgENw")]
[DisplayName("Corporate Action Movement Confirmation002V15")]
public partial record CorporateActionMovementConfirmation002V15 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.036.002.15";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.036.002.15";
    ...
    public required CorporateActionOption225 CorporateActionConfirmationDetails { get; init; } 
...
// Since CorporateActionMovementConfirmation002V15Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmation002V15.
