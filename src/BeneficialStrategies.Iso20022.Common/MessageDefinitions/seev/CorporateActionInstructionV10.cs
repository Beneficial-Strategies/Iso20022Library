...
[DataContract]
#endif
public partial record CorporateActionInstructionV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionV10( CorporateActionGeneralInformation138 reqCorporateActionGeneralInformation,AccountAndBalance41 reqAccountDetails,CorporateActionOption165 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation138 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation138 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation138 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public PartyIdentification233? BeneficialOwnerDetails { get; init; } 
    #else
    public PartyIdentification233? BeneficialOwnerDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption165 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption165 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption165 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionV10.
