...
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V13 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdvice002V13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdvice002V13( CorporateActionGeneralInformation158 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus16Choice_ reqInstructionCancellationRequestStatus )
    {
    ...
    public required InstructionCancellationRequestStatus16Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionCancellationRequestStatus16Choice_ InstructionCancellationRequestStatus { get; init; } 
    #else
    public InstructionCancellationRequestStatus16Choice_ InstructionCancellationRequestStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequestStatusAdvice002V13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestStatusAdvice002V13.
