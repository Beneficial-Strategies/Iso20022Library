...
/// <summary>
/// This record is an implementation of the seev.037.001.15 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_y9GtUWHCEe6yt_d72zQZeQ")]
[DisplayName("Corporate Action Movement Reversal Advice V15")]
public partial record CorporateActionMovementReversalAdviceV15 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.001.15";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.15";
    ...
    public required CorporateActionOption219 CorporateActionConfirmationDetails { get; init; } 
...
// Since CorporateActionMovementReversalAdviceV15Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdviceV15.
