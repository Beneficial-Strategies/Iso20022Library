...
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdvice002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdvice002V06( CorporateActionGeneralInformation94 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus10Choice_ reqInstructionCancellationRequestStatus )
    {
    ...
    public required InstructionCancellationRequestStatus10Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionCancellationRequestStatus10Choice_ InstructionCancellationRequestStatus { get; init; } 
    #else
    public InstructionCancellationRequestStatus10Choice_ InstructionCancellationRequestStatus { get; set; } 
    #endif
