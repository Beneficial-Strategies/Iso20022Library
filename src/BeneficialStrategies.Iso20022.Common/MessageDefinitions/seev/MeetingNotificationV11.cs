...
/// <summary>
/// This record is an implementation of the seev.001.001.11 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_d7xBDVxxEe6fgZt44_IqFA")]
[DisplayName("Meeting Notification V11")]
public partial record MeetingNotificationV11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.001.001.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.001.001.11";
    ...
    [IsoXmlTag("MtgDtls")]
    public required Meeting6 MeetingDetails { get; init; } 
    ...
    [IsoXmlTag("Rsltn")]
    public Resolution7? Resolution { get; init; } 
    ...
    [IsoXmlTag("Scty")]
    public required SecurityPosition16 Security { get; init; } 
...
// Since MeetingNotificationV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingNotificationV11.
