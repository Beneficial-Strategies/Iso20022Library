...
/// <summary>
/// This record is an implementation of the seev.034.001.11 ISO standard message type.
...
public partial record CorporateActionInstructionStatusAdviceV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.034.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdviceV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdviceV11( CorporateActionGeneralInformation137 reqCorporateActionGeneralInformation,InstructionProcessingStatus38Choice_ reqInstructionProcessingStatus )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required InstructionProcessingStatus38Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required InstructionProcessingStatus38Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionProcessingStatus38Choice_ InstructionProcessingStatus { get; init; } 
    #else
    public InstructionProcessingStatus38Choice_ InstructionProcessingStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionStatusAdviceV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatusAdviceV11.
