...
[DataContract]
#endif
public partial record CorporateActionInstruction002V12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstruction002V12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstruction002V12( CorporateActionGeneralInformation166 reqCorporateActionGeneralInformation,AccountAndBalance51 reqAccountDetails,CorporateActionOption204 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation166 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation166 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation166 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required AccountAndBalance51 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountAndBalance51 AccountDetails { get; init; } 
    #else
    public AccountAndBalance51 AccountDetails { get; set; } 
    #endif
    ...
    public PartyIdentification252? BeneficialOwnerDetails { get; init; } 
    #else
    public PartyIdentification252? BeneficialOwnerDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption204 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption204 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption204 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstruction002V12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstruction002V12.
