...
/// <summary>
/// This record is an implementation of the seev.042.001.10 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionInstructionStatementReportV10 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.042.001.10";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.042.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatementReportV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatementReportV10( Pagination1 reqPagination,Statement72 reqStatementGeneralDetails,AccountIdentification56 reqAccountAndStatementDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AccountIdentification56 AccountAndStatementDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AccountIdentification56 AccountAndStatementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountIdentification56 AccountAndStatementDetails { get; init; } 
    #else
    public AccountIdentification56 AccountAndStatementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that can not be captured in the structured fields and/or any other specific block.
    /// </summary>
    [IsoId("_B3V7he2zEeqc-LCjwLsUVg")]
...
// Since CorporateActionInstructionStatementReportV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatementReportV10.
