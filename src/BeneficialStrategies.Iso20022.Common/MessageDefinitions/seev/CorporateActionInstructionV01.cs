...
public partial record CorporateActionInstructionV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionV01( DocumentIdentification12 reqIdentification,CorporateActionGeneralInformation6 reqCorporateActionGeneralInformation,AccountAndBalance2 reqAccountDetails,CorporateActionOption5 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation6 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation6 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation6 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required AccountAndBalance2 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountAndBalance2 AccountDetails { get; init; } 
    #else
    public AccountAndBalance2 AccountDetails { get; set; } 
    #endif
    ...
    public PartyIdentification33? BeneficialOwnerDetails { get; init; } 
    #else
    public PartyIdentification33? BeneficialOwnerDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption5 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption5 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption5 CorporateActionInstruction { get; set; } 
    #endif
