...
/// <summary>
/// This record is an implementation of the seev.031.001.16 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("702428b0-0cfa-48c6-ade5-3e4a4cf035d9")]
[DisplayName("Corporate Action Notification V16")]
public record CorporateActionNotificationV16 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.031.001.16";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.16";
    ...
    [IsoXmlTag("AcctDtls")]
    public required AccountIdentification71Choice_ AccountDetails { get; init; }
    ...
    [IsoXmlTag("AddtlInf")]
    public CorporateActionNarrative60? AdditionalInformation { get; init; }
    ...
    public CorporateAction94? CorporateActionDetails { get; init; }
    ...
    public required CorporateActionGeneralInformation176 CorporateActionGeneralInformation { get; init; }
    ...
    public ValueList<CorporateActionOption251> CorporateActionOptionDetails { get; init; } = [];
    ...
    public FinancialInstrumentAttributes139? IntermediateSecurity { get; init; }
    ...
    public required CorporateActionNotification9 NotificationGeneralInformation { get; init; }
...
// Since CorporateActionNotificationV16Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV16.
