...
public partial record CorporateActionCancellationAdvice002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdvice002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdvice002V11( CorporateActionCancellation4 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation143 reqCorporateActionGeneralInformation,AccountIdentification50Choice_ reqAccountsDetails )
    {
