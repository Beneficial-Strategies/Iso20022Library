...
/// <summary>
/// This record is an implementation of the seev.037.001.11 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementReversalAdviceV11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.001.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdviceV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdviceV11( DocumentIdentification31 reqMovementConfirmationIdentification,CorporateActionGeneralInformation142 reqCorporateActionGeneralInformation,AccountAndBalance36 reqAccountDetails,CorporateActionOption168 reqCorporateActionConfirmationDetails )
    {
...
// Since CorporateActionMovementReversalAdviceV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdviceV11.
