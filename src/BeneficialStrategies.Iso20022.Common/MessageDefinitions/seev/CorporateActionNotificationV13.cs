...
public partial record CorporateActionNotificationV13 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNotificationV13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNotificationV13( CorporateActionNotification7 reqNotificationGeneralInformation,CorporateActionGeneralInformation165 reqCorporateActionGeneralInformation,AccountIdentification56Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionNotification7 NotificationGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionNotification7 NotificationGeneralInformation { get; init; } 
    #else
    public CorporateActionNotification7 NotificationGeneralInformation { get; set; } 
    #endif
    ...
    public required CorporateActionGeneralInformation165 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation165 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation165 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    [IsoXmlTag("AcctDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AccountIdentification56Choice_ AccountDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AccountIdentification56Choice_ AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountIdentification56Choice_ AccountDetails { get; init; } 
    #else
    public AccountIdentification56Choice_ AccountDetails { get; set; } 
    #endif
    ...
    public FinancialInstrumentAttributes110? IntermediateSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes110? IntermediateSecurity { get; set; } 
    #endif
    ...
    public CorporateAction68? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction68? CorporateActionDetails { get; set; } 
    #endif
    ...
    public CorporateActionOption210? CorporateActionOptionDetails { get; init; } 
    #else
    public CorporateActionOption210? CorporateActionOptionDetails { get; set; } 
    #endif
    ...
    public CorporateActionNarrative51? AdditionalInformation { get; init; } 
    #else
    public CorporateActionNarrative51? AdditionalInformation { get; set; } 
    #endif
...
// Since CorporateActionNotificationV13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV13.
