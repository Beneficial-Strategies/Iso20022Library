...
/// <summary>
/// This record is an implementation of the seev.040.002.11 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionInstructionCancellationRequest002V11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.040.002.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.040.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequest002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequest002V11( DocumentIdentification37 reqInstructionIdentification,CorporateActionGeneralInformation159 reqCorporateActionGeneralInformation,AccountIdentification62 reqAccountDetails,CorporateActionOption202 reqCorporateActionInstruction )
    {
...
// Since CorporateActionInstructionCancellationRequest002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequest002V11.
