...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdviceV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV06( CorporateActionGeneralInformation91 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus9Choice_ reqInstructionCancellationRequestStatus )
    {
    ...
    public required InstructionCancellationRequestStatus9Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionCancellationRequestStatus9Choice_ InstructionCancellationRequestStatus { get; init; } 
    #else
    public InstructionCancellationRequestStatus9Choice_ InstructionCancellationRequestStatus { get; set; } 
    #endif
