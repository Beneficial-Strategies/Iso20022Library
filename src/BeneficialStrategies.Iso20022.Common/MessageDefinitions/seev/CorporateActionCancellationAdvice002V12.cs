...
[DataContract]
#endif
public partial record CorporateActionCancellationAdvice002V12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdvice002V12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdvice002V12( CorporateActionCancellation4 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation143 reqCorporateActionGeneralInformation,AccountIdentification50Choice_ reqAccountsDetails )
    {
    ...
    public required AccountIdentification50Choice_ AccountsDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountIdentification50Choice_ AccountsDetails { get; init; } 
    #else
    public AccountIdentification50Choice_ AccountsDetails { get; set; } 
    #endif
    ...
    public CorporateAction74? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction74? CorporateActionDetails { get; set; } 
    #endif
