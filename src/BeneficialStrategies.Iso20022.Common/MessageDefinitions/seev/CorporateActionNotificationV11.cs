...
public partial record CorporateActionNotificationV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNotificationV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNotificationV11( CorporateActionNotification5 reqNotificationGeneralInformation,CorporateActionGeneralInformation136 reqCorporateActionGeneralInformation,AccountIdentification41Choice_ reqAccountDetails )
    {
    ...
    public CorporateAction57? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction57? CorporateActionDetails { get; set; } 
    #endif
    ...
    public CorporateActionOption177? CorporateActionOptionDetails { get; init; } 
    #else
    public CorporateActionOption177? CorporateActionOptionDetails { get; set; } 
    #endif
    ...
    public CorporateActionNarrative46? AdditionalInformation { get; init; } 
    #else
    public CorporateActionNarrative46? AdditionalInformation { get; set; } 
    #endif
...
// Since CorporateActionNotificationV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV11.
