...
[DataContract]
#endif
public partial record CorporateActionInstructionV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionV08( CorporateActionGeneralInformation107 reqCorporateActionGeneralInformation,AccountAndBalance35 reqAccountDetails,CorporateActionOption142 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionOption142 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption142 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption142 CorporateActionInstruction { get; set; } 
    #endif
