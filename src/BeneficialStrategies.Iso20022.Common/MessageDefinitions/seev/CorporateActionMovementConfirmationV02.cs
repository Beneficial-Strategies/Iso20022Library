...
/// <summary>
/// This record is an implementation of the seev.036.001.02 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementConfirmationV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.036.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.036.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV02( CorporateActionGeneralInformation24 reqCorporateActionGeneralInformation,AccountAndBalance11 reqAccountDetails,CorporateActionOption23 reqCorporateActionConfirmationDetails )
    {
    ...
    [IsoXmlTag("AcctDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AccountAndBalance11 AccountDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AccountAndBalance11 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountAndBalance11 AccountDetails { get; init; } 
    #else
    public AccountAndBalance11 AccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the corporate action option.
    /// </summary>
    [IsoId("_-enNE93BEd-KAqAOGQOnnw")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CorporateActionOption23 CorporateActionConfirmationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CorporateActionOption23 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption23 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption23 CorporateActionConfirmationDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_-enNFd3BEd-KAqAOGQOnnw")]
...
// Since CorporateActionMovementConfirmationV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmationV02.
