...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdviceV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV07( CorporateActionGeneralInformation109 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus11Choice_ reqInstructionCancellationRequestStatus )
    {
...
// Since CorporateActionInstructionCancellationRequestStatusAdviceV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestStatusAdviceV07.
