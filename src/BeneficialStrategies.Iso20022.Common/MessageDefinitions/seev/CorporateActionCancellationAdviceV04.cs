...
public partial record CorporateActionCancellationAdviceV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdviceV04( CorporateActionCancellation1 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation56 reqCorporateActionGeneralInformation,AccountIdentification13Choice_ reqAccountsDetails )
    {
