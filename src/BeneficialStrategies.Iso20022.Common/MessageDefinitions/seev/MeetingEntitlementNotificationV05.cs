...
public partial record MeetingEntitlementNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingEntitlementNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingEntitlementNotificationV05( MeetingReference7 reqMeetingReference,EligibilityDates1 reqEligibility )
    {
    ...
    [MinLength(1)]
    [MaxLength(200)]
    public ValueList<SecurityPosition9> Security { get; init; } = new ValueList<SecurityPosition9>(){};
