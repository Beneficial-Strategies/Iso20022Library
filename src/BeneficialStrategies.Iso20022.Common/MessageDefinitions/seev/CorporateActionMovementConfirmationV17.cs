...
/// <summary>
/// This record is an implementation of the seev.036.001.17 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_zx83gaLnEfCHi7w3_0pcpw")]
[DisplayName("Corporate Action Movement Confirmation V17")]
public record CorporateActionMovementConfirmationV17 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.036.001.17";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.036.001.17";
    ...
    public required CorporateActionOption253 CorporateActionConfirmationDetails { get; init; }
    ...
    public CorporateAction92? CorporateActionDetails { get; init; }
...
// Since CorporateActionMovementConfirmationV17Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmationV17.
