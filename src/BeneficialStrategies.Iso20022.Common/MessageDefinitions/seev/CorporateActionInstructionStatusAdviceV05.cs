...
/// <summary>
/// This record is an implementation of the seev.034.001.05 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionInstructionStatusAdviceV05 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.034.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdviceV05( CorporateActionGeneralInformation52 reqCorporateActionGeneralInformation,InstructionProcessingStatus15Choice_ reqInstructionProcessingStatus )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required InstructionProcessingStatus15Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required InstructionProcessingStatus15Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionProcessingStatus15Choice_ InstructionProcessingStatus { get; init; } 
    #else
    public InstructionProcessingStatus15Choice_ InstructionProcessingStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionStatusAdviceV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatusAdviceV05.
