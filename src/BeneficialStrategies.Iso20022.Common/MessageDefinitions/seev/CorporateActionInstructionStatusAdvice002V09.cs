...
/// <summary>
/// This record is an implementation of the seev.034.002.09 ISO standard message type.
...
public partial record CorporateActionInstructionStatusAdvice002V09 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.034.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdvice002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdvice002V09( CorporateActionGeneralInformation114 reqCorporateActionGeneralInformation,InstructionProcessingStatus30Choice_ reqInstructionProcessingStatus )
    {
...
// Since CorporateActionInstructionStatusAdvice002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatusAdvice002V09.
