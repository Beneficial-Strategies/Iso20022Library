...
/// <summary>
/// This record is an implementation of the seev.033.001.13 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_4baRyX_4Ee-h086v0qPiyQ")]
[DisplayName("Corporate Action Instruction V13")]
public partial record CorporateActionInstructionV13 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.033.001.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.033.001.13";
    ...
    [IsoXmlTag("AcctDtls")]
    public required AccountAndBalance61 AccountDetails { get; init; } 
    ...
    public ValueList<PartyIdentification313> BeneficialOwnerDetails { get; init; } = [];
    ...
    public required CorporateActionGeneralInformation180 CorporateActionGeneralInformation { get; init; } 
    ...
    public required CorporateActionOption237 CorporateActionInstruction { get; init; } 
...
// Since CorporateActionInstructionV13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionV13.
