...
/// <summary>
/// This record is an implementation of the seev.050.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_FfUWEaN1EfCxxJ9emeyVvA")]
[DisplayName("Market Claim Creation V04")]
public record MarketClaimCreationV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.050.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.050.001.04";
    ...
    /// <summary>
    /// Market Claim Settlement Indicator.
    /// </summary>
    [DisplayName("Market Claim Settlement Indicator")]
    [IsoXmlTag("MktClmSttlmInd")]
    [IsoSimpleType(IsoSimpleType.YesNoIndicator)]
    public IsoYesNoIndicator? MarketClaimSettlementIndicator { get; init; }
