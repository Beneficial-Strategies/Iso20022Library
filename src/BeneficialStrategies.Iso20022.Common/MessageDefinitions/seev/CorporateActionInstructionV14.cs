...
/// <summary>
/// This record is an implementation of the seev.033.001.14 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_9dBqoa3oEfCN-rGCydxGUA")]
[DisplayName("Corporate Action Instruction V14")]
public record CorporateActionInstructionV14 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.033.001.14";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.033.001.14";
    ...
    public ValueList<PartyIdentification340> BeneficialOwnerDetails { get; init; } = [];
...
// Since CorporateActionInstructionV14Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionV14.
