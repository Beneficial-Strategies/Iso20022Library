...
/// <summary>
/// This record is an implementation of the seev.050.001.02 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_FG4Dh1xPEe6fgZt44_IqFA")]
[DisplayName("Market Claim Creation V02")]
public partial record MarketClaimCreationV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.050.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.050.001.02";
    ...
    public SettlementParties122? DeliveringSettlementParties { get; init; } 
    ...
    public required CorporateActionOption217 MarketClaimDetails { get; init; } 
    ...
    public SettlementParties122? ReceivingSettlementParties { get; init; } 
...
// Since MarketClaimCreationV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MarketClaimCreationV02.
