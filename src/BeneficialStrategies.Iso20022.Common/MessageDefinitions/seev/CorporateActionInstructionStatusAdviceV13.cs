...
/// <summary>
/// This record is an implementation of the seev.034.001.13 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionInstructionStatusAdviceV13 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.034.001.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.034.001.13";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdviceV13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdviceV13( CorporateActionGeneralInformation154 reqCorporateActionGeneralInformation,InstructionProcessingStatus46Choice_ reqInstructionProcessingStatus )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required InstructionProcessingStatus46Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required InstructionProcessingStatus46Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionProcessingStatus46Choice_ InstructionProcessingStatus { get; init; } 
    #else
    public InstructionProcessingStatus46Choice_ InstructionProcessingStatus { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionOption196? CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption196? CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption196? CorporateActionInstruction { get; set; } 
    #endif
    ...
    public ProtectInstruction2? ProtectInstruction { get; init; } 
    #else
    public ProtectInstruction2? ProtectInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionStatusAdviceV13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatusAdviceV13.
