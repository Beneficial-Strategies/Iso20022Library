...
public partial record CorporateActionInstructionCancellationRequestV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestV01( DocumentIdentification12 reqIdentification,DocumentIdentification15 reqInstructionIdentification,CorporateActionGeneralInformation7 reqCorporateActionGeneralInformation,AccountIdentification8 reqAccountDetails,CorporateActionOption6 reqCorporateActionInstruction )
    {
    ...
    public DocumentIdentification12 Identification { get; init; } 
    #else
    public DocumentIdentification12 Identification { get; set; } 
    #endif
    ...
    public required CorporateActionGeneralInformation7 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation7 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation7 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required AccountIdentification8 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountIdentification8 AccountDetails { get; init; } 
    #else
    public AccountIdentification8 AccountDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption6 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption6 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption6 CorporateActionInstruction { get; set; } 
    #endif
