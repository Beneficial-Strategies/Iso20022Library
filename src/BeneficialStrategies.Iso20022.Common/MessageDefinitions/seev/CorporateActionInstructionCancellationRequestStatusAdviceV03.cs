...
/// <summary>
/// This record is an implementation of the seev.041.001.03 ISO standard message type.
...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.041.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV03( CorporateActionGeneralInformation34 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus5Choice_ reqInstructionCancellationRequestStatus )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required InstructionCancellationRequestStatus5Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required InstructionCancellationRequestStatus5Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionCancellationRequestStatus5Choice_ InstructionCancellationRequestStatus { get; init; } 
    #else
    public InstructionCancellationRequestStatus5Choice_ InstructionCancellationRequestStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequestStatusAdviceV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestStatusAdviceV03.
