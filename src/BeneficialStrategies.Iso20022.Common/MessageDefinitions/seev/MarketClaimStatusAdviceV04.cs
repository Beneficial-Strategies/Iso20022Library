...
/// <summary>
/// This record is an implementation of the seev.052.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_yIku0a8wEfCx2aBifPEdRg")]
[DisplayName("Market Claim Status Advice V04")]
public record MarketClaimStatusAdviceV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.052.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.052.001.04";
    ...
    public required MarketClaimProcessingStatus2Choice_ MarketClaimProcessingStatus { get; init; }
...
// Since MarketClaimStatusAdviceV04Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MarketClaimStatusAdviceV04.
