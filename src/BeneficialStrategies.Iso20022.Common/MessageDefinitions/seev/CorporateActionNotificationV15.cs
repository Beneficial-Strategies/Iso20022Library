...
/// <summary>
/// This record is an implementation of the seev.031.001.15 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_4baRMX_4Ee-h086v0qPiyQ")]
[DisplayName("Corporate Action Notification V15")]
public partial record CorporateActionNotificationV15 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.031.001.15";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.031.001.15";
    ...
    public CorporateAction84? CorporateActionDetails { get; init; } 
    ...
    public ValueList<CorporateActionOption236> CorporateActionOptionDetails { get; init; } = [];
...
// Since CorporateActionNotificationV15Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV15.
