...
public partial record CorporateActionMovementReversalAdvice002V09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V09( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation130 reqCorporateActionGeneralInformation,AccountAndBalance40 reqAccountDetails,CorporateActionOption149 reqCorporateActionConfirmationDetails )
    {
...
// Since CorporateActionMovementReversalAdvice002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdvice002V09.
