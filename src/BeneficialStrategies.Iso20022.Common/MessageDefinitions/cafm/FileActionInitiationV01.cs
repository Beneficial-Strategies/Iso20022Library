...
public partial record FileActionInitiationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FileActionInitiationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FileActionInitiationV01( Header39 reqHeader,FileActionInitiation1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required FileActionInitiation1 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FileActionInitiation1 Body { get; init; } 
    #else
    public FileActionInitiation1 Body { get; set; } 
    #endif
...
// Since FileActionInitiationV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FileActionInitiationV01.
