...
public partial record StatusExtensionRejectionNotificationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusExtensionRejectionNotificationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusExtensionRejectionNotificationV03( MessageIdentification1 reqNotificationIdentification,SimpleIdentificationInformation reqTransactionIdentification,TransactionStatus4 reqNonExtendedStatus,Reason2 reqRejectionReason )
    {
        NotificationIdentification = reqNotificationIdentification;
        TransactionIdentification = reqTransactionIdentification;
        NonExtendedStatus = reqNonExtendedStatus;
    ...
    public required TransactionStatus4 NonExtendedStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionStatus4 NonExtendedStatus { get; init; } 
    #else
    public TransactionStatus4 NonExtendedStatus { get; set; } 
    #endif
