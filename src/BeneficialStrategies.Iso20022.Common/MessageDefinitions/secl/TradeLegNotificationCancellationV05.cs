...
/// <summary>
/// This record is an implementation of the secl.002.001.05 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_wyKbsaoxEfCG2_q2WT-90w")]
[DisplayName("Trade Leg Notification Cancellation V05")]
public record TradeLegNotificationCancellationV05 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "secl.002.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:secl.002.001.05";
    ...
    [IsoXmlTag("CxlRsn")]
    public CancellationReason36Choice_? CancellationReason { get; init; }
...
// Since TradeLegNotificationCancellationV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TradeLegNotificationCancellationV05.
