...
public record CustomerPaymentStatusReportV15 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.002.001.15";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.15";
    ...
    public ValueList<OriginalPaymentInstruction56> OriginalPaymentInformationAndStatus { get; init; } =
        [];
...
// Since CustomerPaymentStatusReportV15Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentStatusReportV15.
