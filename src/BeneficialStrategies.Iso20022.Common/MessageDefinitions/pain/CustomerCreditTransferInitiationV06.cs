...
/// <summary>
/// This record is an implementation of the pain.001.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record CustomerCreditTransferInitiationV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pain.001.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV06( GroupHeader48 reqGroupHeader,PaymentInstruction16 reqPaymentInformation )
    {
    ...
    [IsoXmlTag("PmtInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required PaymentInstruction16 PaymentInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required PaymentInstruction16 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstruction16 PaymentInformation { get; init; } 
    #else
    public PaymentInstruction16 PaymentInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_NasXORPeEeSVo-TFVwFHvA")]
...
// Since CustomerCreditTransferInitiationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV06.
