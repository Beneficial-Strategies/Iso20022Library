...
public partial record MandateCopyRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateCopyRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateCopyRequestV02( GroupHeader80 reqGroupHeader,MandateCopy2 reqUnderlyingCopyRequestDetails )
    {
    ...
    public required MandateCopy2 UnderlyingCopyRequestDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateCopy2 UnderlyingCopyRequestDetails { get; init; } 
    #else
    public MandateCopy2 UnderlyingCopyRequestDetails { get; set; } 
    #endif
...
// Since MandateCopyRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateCopyRequestV02.
