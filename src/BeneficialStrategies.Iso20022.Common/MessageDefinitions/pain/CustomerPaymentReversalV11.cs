...
public partial record CustomerPaymentReversalV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentReversalV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentReversalV11( GroupHeader88 reqGroupHeader,OriginalGroupHeader16 reqOriginalGroupInformation )
    {
    ...
    public OriginalPaymentInstruction41? OriginalPaymentInformationAndReversal { get; init; } 
    #else
    public OriginalPaymentInstruction41? OriginalPaymentInformationAndReversal { get; set; } 
    #endif
