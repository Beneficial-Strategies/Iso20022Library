...
[IsoId("_r4JiIFkyEeGeoaLUQk__nA_2146216592")]
...
public partial record CustomerPaymentReversalV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentReversalV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentReversalV03( GroupHeader56 reqGroupHeader,OriginalGroupHeader3 reqOriginalGroupInformation )
    {
    ...
    public OriginalPaymentInstruction2? OriginalPaymentInformationAndReversal { get; init; } 
    #else
    public OriginalPaymentInstruction2? OriginalPaymentInformationAndReversal { get; set; } 
    #endif
...
// Since CustomerPaymentReversalV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentReversalV03.
