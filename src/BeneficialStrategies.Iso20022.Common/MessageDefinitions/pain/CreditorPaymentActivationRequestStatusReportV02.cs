...
/// <summary>
/// This record is an implementation of the pain.014.001.02 ISO standard message type.
...
public partial record CreditorPaymentActivationRequestStatusReportV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.014.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CreditorPaymentActivationRequestStatusReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditorPaymentActivationRequestStatusReportV02( GroupHeader46 reqGroupHeader,OriginalGroupInformation25 reqOriginalGroupInformationAndStatus )
    {
    ...
    public OriginalPaymentInstruction5? OriginalPaymentInformationAndStatus { get; init; } 
    #else
    public OriginalPaymentInstruction5? OriginalPaymentInformationAndStatus { get; set; } 
    #endif
...
// Since CreditorPaymentActivationRequestStatusReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CreditorPaymentActivationRequestStatusReportV02.
