...
/// <summary>
/// This record is an implementation of the pain.011.001.03 ISO standard message type.
...
public partial record MandateCancellationRequestV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.011.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a MandateCancellationRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateCancellationRequestV03( GroupHeader47 reqGroupHeader,MandateCancellation3 reqUnderlyingCancellationDetails )
    {
    ...
    public required MandateCancellation3 UnderlyingCancellationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateCancellation3 UnderlyingCancellationDetails { get; init; } 
    #else
    public MandateCancellation3 UnderlyingCancellationDetails { get; set; } 
    #endif
...
// Since MandateCancellationRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateCancellationRequestV03.
