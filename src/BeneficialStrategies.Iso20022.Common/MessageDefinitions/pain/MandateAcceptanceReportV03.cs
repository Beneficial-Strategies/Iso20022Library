...
/// <summary>
/// This record is an implementation of the pain.012.001.03 ISO standard message type.
...
[DataContract]
#endif
public partial record MandateAcceptanceReportV03 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pain.012.001.03";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pain.012.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a MandateAcceptanceReportV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateAcceptanceReportV03( GroupHeader47 reqGroupHeader,MandateAcceptance3 reqUnderlyingAcceptanceDetails )
    {
    ...
    #else
    public MandateAcceptance3 UnderlyingAcceptanceDetails { get; set; } 
    #endif
...
// Since MandateAcceptanceReportV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateAcceptanceReportV03.
