...
[IsoId("_r1UQkFkyEeGeoaLUQk__nA_-422128939")]
...
public partial record MandateInitiationRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateInitiationRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateInitiationRequestV02( GroupHeader47 reqGroupHeader,Mandate2 reqMandate )
    {
    ...
    public required Mandate2 Mandate { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Mandate2 Mandate { get; init; } 
    #else
    public Mandate2 Mandate { get; set; } 
    #endif
...
// Since MandateInitiationRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateInitiationRequestV02.
