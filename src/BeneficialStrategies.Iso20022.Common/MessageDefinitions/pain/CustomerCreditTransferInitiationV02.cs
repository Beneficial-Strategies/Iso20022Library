...
[IsoId("_GWb0ldEvEd-BzquC8wXy7w_1535349168")]
...
public partial record CustomerCreditTransferInitiationV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerCreditTransferInitiationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerCreditTransferInitiationV02( GroupHeader1 reqGroupHeader,PaymentInstructionInformation1 reqPaymentInformation )
    {
    ...
    public required PaymentInstructionInformation1 PaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentInstructionInformation1 PaymentInformation { get; init; } 
    #else
    public PaymentInstructionInformation1 PaymentInformation { get; set; } 
    #endif
...
// Since CustomerCreditTransferInitiationV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerCreditTransferInitiationV02.
