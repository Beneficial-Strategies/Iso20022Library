...
[DataContract]
#endif
public partial record MandateCancellationRequestV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateCancellationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateCancellationRequestV07( GroupHeader80 reqGroupHeader,MandateCancellation7 reqUnderlyingCancellationDetails )
    {
    ...
    public required MandateCancellation7 UnderlyingCancellationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MandateCancellation7 UnderlyingCancellationDetails { get; init; } 
    #else
    public MandateCancellation7 UnderlyingCancellationDetails { get; set; } 
    #endif
...
// Since MandateCancellationRequestV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MandateCancellationRequestV07.
