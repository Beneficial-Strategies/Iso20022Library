...
/// <summary>
/// This record is an implementation of the pain.007.001.10 ISO standard message type.
...
public partial record CustomerPaymentReversalV10 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.007.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentReversalV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentReversalV10( GroupHeader88 reqGroupHeader,OriginalGroupHeader16 reqOriginalGroupInformation )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public OriginalPaymentInstruction37? OriginalPaymentInformationAndReversal { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OriginalPaymentInstruction37? OriginalPaymentInformationAndReversal { get; init; } 
    #else
    public OriginalPaymentInstruction37? OriginalPaymentInformationAndReversal { get; set; } 
    #endif
...
// Since CustomerPaymentReversalV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentReversalV10.
