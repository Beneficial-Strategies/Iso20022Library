...
[IsoId("_r6PM0FkyEeGeoaLUQk__nA_629151")]
...
public partial record CustomerPaymentStatusReportV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CustomerPaymentStatusReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CustomerPaymentStatusReportV04( GroupHeader52 reqGroupHeader,OriginalGroupHeader1 reqOriginalGroupInformationAndStatus )
    {
    ...
    public OriginalPaymentInstruction1? OriginalPaymentInformationAndStatus { get; init; } 
    #else
    public OriginalPaymentInstruction1? OriginalPaymentInformationAndStatus { get; set; } 
    #endif
...
// Since CustomerPaymentStatusReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CustomerPaymentStatusReportV04.
