...
/// <summary>
/// This record is an implementation of the pain.014.001.07 ISO standard message type.
...
public partial record CreditorPaymentActivationRequestStatusReportV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pain.014.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a CreditorPaymentActivationRequestStatusReportV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditorPaymentActivationRequestStatusReportV07( GroupHeader87 reqGroupHeader,OriginalGroupInformation30 reqOriginalGroupInformationAndStatus )
    {
    ...
    public OriginalPaymentInstruction31? OriginalPaymentInformationAndStatus { get; init; } 
    #else
    public OriginalPaymentInstruction31? OriginalPaymentInformationAndStatus { get; set; } 
    #endif
...
// Since CreditorPaymentActivationRequestStatusReportV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CreditorPaymentActivationRequestStatusReportV07.
