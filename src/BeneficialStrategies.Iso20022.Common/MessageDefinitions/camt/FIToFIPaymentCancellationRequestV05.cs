...
/// <summary>
/// This record is an implementation of the camt.056.001.05 ISO standard message type.
...
public partial record FIToFIPaymentCancellationRequestV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.056.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentCancellationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentCancellationRequestV05( CaseAssignment3 reqAssignment,UnderlyingTransaction13 reqUnderlying )
    {
    ...
    [IsoXmlTag("Undrlyg")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required UnderlyingTransaction13 Underlying { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required UnderlyingTransaction13 Underlying { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnderlyingTransaction13 Underlying { get; init; } 
    #else
    public UnderlyingTransaction13 Underlying { get; set; } 
    #endif
...
// Since FIToFIPaymentCancellationRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentCancellationRequestV05.
