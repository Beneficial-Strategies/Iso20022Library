...
/// <summary>
/// This record is an implementation of the camt.024.001.06 ISO standard message type.
...
public partial record ModifyStandingOrderV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.024.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a ModifyStandingOrderV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModifyStandingOrderV06( MessageHeader1 reqMessageHeader,StandingOrderIdentification4 reqStandingOrderIdentification,StandingOrder7 reqNewStandingOrderValueSet )
    {
    ...
    #else
    public StandingOrder7 NewStandingOrderValueSet { get; set; } 
    #endif
...
// Since ModifyStandingOrderV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ModifyStandingOrderV06.
