...
/// <summary>
/// This record is an implementation of the camt.007.001.09 ISO standard message type.
...
[DataContract]
#endif
public partial record ModifyTransactionV09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.007.001.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.007.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a ModifyTransactionV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModifyTransactionV09( MessageHeader1 reqMessageHeader,TransactionModification6 reqModification )
    {
    ...
    [IsoXmlTag("Mod")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required TransactionModification6 Modification { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required TransactionModification6 Modification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionModification6 Modification { get; init; } 
    #else
    public TransactionModification6 Modification { get; set; } 
    #endif
...
// Since ModifyTransactionV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ModifyTransactionV09.
