...
public partial record FundDetailedConfirmedCashForecastReportCancellationV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FundDetailedConfirmedCashForecastReportCancellationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FundDetailedConfirmedCashForecastReportCancellationV02( MessageIdentification1 reqMessageIdentification,Pagination reqMessagePagination )
    {
    ...
    public FundDetailedConfirmedCashForecastReport2? CashForecastReportToBeCancelled { get; init; } 
    #else
    public FundDetailedConfirmedCashForecastReport2? CashForecastReportToBeCancelled { get; set; } 
    #endif
