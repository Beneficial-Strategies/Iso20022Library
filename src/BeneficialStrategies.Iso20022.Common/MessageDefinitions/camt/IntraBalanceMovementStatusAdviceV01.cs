...
public partial record IntraBalanceMovementStatusAdviceV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraBalanceMovementStatusAdviceV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraBalanceMovementStatusAdviceV01( TransactionIdentifications24 reqTransactionIdentification,CashAccount38 reqCashAccount )
    {
    ...
    public required TransactionIdentifications24 TransactionIdentification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionIdentifications24 TransactionIdentification { get; init; } 
    #else
    public TransactionIdentifications24 TransactionIdentification { get; set; } 
    #endif
