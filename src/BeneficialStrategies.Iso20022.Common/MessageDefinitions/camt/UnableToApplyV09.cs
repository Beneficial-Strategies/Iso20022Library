...
/// <summary>
/// This record is an implementation of the camt.026.001.09 ISO standard message type.
...
public partial record UnableToApplyV09 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.026.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a UnableToApplyV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnableToApplyV09( CaseAssignment5 reqAssignment,UnderlyingTransaction7Choice_ reqUnderlying,UnableToApplyJustification4Choice_ reqJustification )
    {
    ...
    public required UnableToApplyJustification4Choice_ Justification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnableToApplyJustification4Choice_ Justification { get; init; } 
    #else
    public UnableToApplyJustification4Choice_ Justification { get; set; } 
    #endif
...
// Since UnableToApplyV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to UnableToApplyV09.
