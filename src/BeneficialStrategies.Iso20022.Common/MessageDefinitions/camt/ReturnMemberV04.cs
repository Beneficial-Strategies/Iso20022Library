...
public partial record ReturnMemberV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ReturnMemberV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReturnMemberV04( MessageHeader7 reqMessageHeader,MemberReportOrError5Choice_ reqReportOrError )
    {
    ...
    #else
    public MemberReportOrError5Choice_ ReportOrError { get; set; } 
    #endif
...
// Since ReturnMemberV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ReturnMemberV04.
