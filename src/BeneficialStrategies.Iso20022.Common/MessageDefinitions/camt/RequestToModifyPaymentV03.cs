...
/// <summary>
/// This record is an implementation of the camt.087.001.03 ISO standard message type.
...
[DataContract]
#endif
public partial record RequestToModifyPaymentV03 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.087.001.03";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a RequestToModifyPaymentV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestToModifyPaymentV03( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction2Choice_ reqUnderlying,RequestedModification5 reqModification )
    {
    ...
    [IsoXmlTag("Mod")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required RequestedModification5 Modification { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required RequestedModification5 Modification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RequestedModification5 Modification { get; init; } 
    #else
    public RequestedModification5 Modification { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_pmmdwTqxEeWZFYSPlduMhw")]
...
// Since RequestToModifyPaymentV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RequestToModifyPaymentV03.
