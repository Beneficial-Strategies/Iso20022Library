...
/// <summary>
/// This record is an implementation of the camt.085.001.02 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_R3ODgzEZEe6kQ-WGAhcVPQ")]
[DisplayName("Intra Balance Movement Pending Report V02")]
public partial record IntraBalanceMovementPendingReportV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.085.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.085.001.02";
    ...
    [IsoXmlTag("Mvmnts")]
    public ValueList<IntraBalancePending5> Movements { get; init; } = [];
