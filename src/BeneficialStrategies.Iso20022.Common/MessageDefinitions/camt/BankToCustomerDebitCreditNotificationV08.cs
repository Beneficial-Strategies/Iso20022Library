...
public partial record BankToCustomerDebitCreditNotificationV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BankToCustomerDebitCreditNotificationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BankToCustomerDebitCreditNotificationV08( GroupHeader81 reqGroupHeader,AccountNotification17 reqNotification )
    {
    ...
    public required AccountNotification17 Notification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountNotification17 Notification { get; init; } 
    #else
    public AccountNotification17 Notification { get; set; } 
    #endif
