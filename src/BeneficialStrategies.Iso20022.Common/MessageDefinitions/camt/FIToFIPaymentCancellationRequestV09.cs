...
/// <summary>
/// This record is an implementation of the camt.056.001.09 ISO standard message type.
...
public partial record FIToFIPaymentCancellationRequestV09 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.056.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentCancellationRequestV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentCancellationRequestV09( CaseAssignment5 reqAssignment,UnderlyingTransaction26 reqUnderlying )
    {
    ...
    public required UnderlyingTransaction26 Underlying { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public UnderlyingTransaction26 Underlying { get; init; } 
    #else
    public UnderlyingTransaction26 Underlying { get; set; } 
    #endif
...
// Since FIToFIPaymentCancellationRequestV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentCancellationRequestV09.
