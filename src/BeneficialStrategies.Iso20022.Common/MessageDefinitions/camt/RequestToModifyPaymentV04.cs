...
public partial record RequestToModifyPaymentV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a RequestToModifyPaymentV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestToModifyPaymentV04( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction3Choice_ reqUnderlying,RequestedModification6 reqModification )
    {
    ...
    public required RequestedModification6 Modification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RequestedModification6 Modification { get; init; } 
    #else
    public RequestedModification6 Modification { get; set; } 
    #endif
...
// Since RequestToModifyPaymentV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RequestToModifyPaymentV04.
