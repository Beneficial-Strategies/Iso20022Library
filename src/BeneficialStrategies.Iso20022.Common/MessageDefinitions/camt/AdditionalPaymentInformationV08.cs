...
/// <summary>
/// This record is an implementation of the camt.028.001.08 ISO standard message type.
...
[DataContract]
#endif
public partial record AdditionalPaymentInformationV08 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.028.001.08";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.08";
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalPaymentInformationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalPaymentInformationV08( CaseAssignment4 reqAssignment,UnderlyingTransaction4Choice_ reqUnderlying,PaymentComplementaryInformation7 reqInformation )
    {
    ...
    public required PaymentComplementaryInformation7 Information { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentComplementaryInformation7 Information { get; init; } 
    #else
    public PaymentComplementaryInformation7 Information { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_nNCyW6qDEeeMmtkfa8-zPg")]
...
// Since AdditionalPaymentInformationV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdditionalPaymentInformationV08.
