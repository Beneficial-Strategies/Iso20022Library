...
public partial record AdditionalPaymentInformationV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalPaymentInformationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalPaymentInformationV06( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction2Choice_ reqUnderlying,PaymentComplementaryInformation5 reqInformation )
    {
    ...
    public required PaymentComplementaryInformation5 Information { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentComplementaryInformation5 Information { get; init; } 
    #else
    public PaymentComplementaryInformation5 Information { get; set; } 
    #endif
...
// Since AdditionalPaymentInformationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdditionalPaymentInformationV06.
