...
/// <summary>
/// This record is an implementation of the camt.026.001.08 ISO standard message type.
...
public partial record UnableToApplyV08 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "camt.026.001.08";
    ...
    #else
    /// <summary>
    /// Constructs a UnableToApplyV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnableToApplyV08( CaseAssignment5 reqAssignment,UnderlyingTransaction6Choice_ reqUnderlying,UnableToApplyJustification3Choice_ reqJustification )
    {
...
// Since UnableToApplyV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to UnableToApplyV08.
