...
/// <summary>
/// This record is an implementation of the camt.028.001.07 ISO standard message type.
...
[DataContract]
#endif
public partial record AdditionalPaymentInformationV07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.028.001.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalPaymentInformationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalPaymentInformationV07( CaseAssignment3 reqAssignment,Case3 reqCase,UnderlyingTransaction3Choice_ reqUnderlying,PaymentComplementaryInformation6 reqInformation )
    {
    ...
    [IsoXmlTag("Inf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required PaymentComplementaryInformation6 Information { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required PaymentComplementaryInformation6 Information { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentComplementaryInformation6 Information { get; init; } 
    #else
    public PaymentComplementaryInformation6 Information { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_xwzGK2XoEeap-P22vGV91g")]
...
// Since AdditionalPaymentInformationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdditionalPaymentInformationV07.
