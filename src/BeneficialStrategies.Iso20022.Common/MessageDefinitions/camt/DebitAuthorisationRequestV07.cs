...
public partial record DebitAuthorisationRequestV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a DebitAuthorisationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DebitAuthorisationRequestV07( CaseAssignment5 reqAssignment,UnderlyingTransaction5Choice_ reqUnderlying,DebitAuthorisation2 reqDetail )
    {
...
// Since DebitAuthorisationRequestV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DebitAuthorisationRequestV07.
