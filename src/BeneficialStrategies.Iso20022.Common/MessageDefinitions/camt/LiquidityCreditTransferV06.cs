...
/// <summary>
/// This record is an implementation of the camt.050.001.06 ISO standard message type.
...
public record LiquidityCreditTransferV06 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "camt.050.001.06";
...
// Since LiquidityCreditTransferV06Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to LiquidityCreditTransferV06.
