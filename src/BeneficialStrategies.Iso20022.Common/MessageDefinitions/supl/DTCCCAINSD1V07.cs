...
public partial record DTCCCAINSD1V07 : IOuterRecord
{
    ...
    public ReorganisationInstructionSD13? ReorganisationInstructionDetails { get; init; } 
    #else
    public ReorganisationInstructionSD13? ReorganisationInstructionDetails { get; set; } 
    #endif
...
// Since DTCCCAINSD1V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAINSD1V07.
