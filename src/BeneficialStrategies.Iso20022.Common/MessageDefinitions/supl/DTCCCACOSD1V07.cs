...
/// <summary>
/// This record is an implementation of the supl.011.001.07 ISO standard message type.
...
public partial record DTCCCACOSD1V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.011.001.07";
    ...
    public CorporateActionGeneralInformationSD37? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD37? CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public OptionTransactionSD5? OptionTransactionDetails { get; init; } 
    #else
    public OptionTransactionSD5? OptionTransactionDetails { get; set; } 
    #endif
...
// Since DTCCCACOSD1V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCACOSD1V07.
