...
/// <summary>
/// This record is an implementation of the supl.010.001.07 ISO standard message type.
...
public partial record DTCCCAPSSD1V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.010.001.07";
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionGeneralInformationSD34? CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformationSD34? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD34? CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since DTCCCAPSSD1V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAPSSD1V07.
