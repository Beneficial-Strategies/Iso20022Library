...
[DataContract]
#endif
public partial record DTCCCAPSSD1V08 : IOuterRecord
{
    ...
    public CorporateActionGeneralInformationSD46? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD46? CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since DTCCCAPSSD1V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAPSSD1V08.
