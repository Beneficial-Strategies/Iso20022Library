...
/// <summary>
/// This record is an implementation of the supl.006.001.06 ISO standard message type.
...
public partial record DTCCCACNSD1V06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.006.001.06";
...
// Since DTCCCACNSD1V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCACNSD1V06.
