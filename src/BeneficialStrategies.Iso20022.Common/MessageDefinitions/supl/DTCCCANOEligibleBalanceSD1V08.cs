...
/// <summary>
/// This record is an implementation of the supl.007.001.08 ISO standard message type.
...
public record DTCCCANOEligibleBalanceSD1V08 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "supl.007.001.08";
...
// Since DTCCCANOEligibleBalanceSD1V08Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOEligibleBalanceSD1V08.
