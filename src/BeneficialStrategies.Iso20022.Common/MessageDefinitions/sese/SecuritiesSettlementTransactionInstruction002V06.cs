...
public partial record SecuritiesSettlementTransactionInstruction002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstruction002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstruction002V06( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters16 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails63 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount47 reqQuantityAndAccountDetails,SettlementDetails112 reqSettlementParameters )
    {
    ...
    public required SettlementTypeAndAdditionalParameters16 SettlementTypeAndAdditionalParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementTypeAndAdditionalParameters16 SettlementTypeAndAdditionalParameters { get; init; } 
    #else
    public SettlementTypeAndAdditionalParameters16 SettlementTypeAndAdditionalParameters { get; set; } 
    #endif
    ...
    public required SecuritiesTradeDetails63 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails63 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails63 TradeDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails112 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails112 SettlementParameters { get; init; } 
    #else
    public SettlementDetails112 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionInstruction002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionInstruction002V06.
