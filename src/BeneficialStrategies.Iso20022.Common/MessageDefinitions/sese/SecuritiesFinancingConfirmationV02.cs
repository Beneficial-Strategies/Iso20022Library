...
public partial record SecuritiesFinancingConfirmationV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmationV02( TransactionTypeAndAdditionalParameters3 reqTransactionIdentificationDetails,SecuritiesTradeDetails6 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount18 reqQuantityAndAccountDetails )
    {
    ...
    public SettlementDetails30? SettlementParameters { get; init; } 
    #else
    public SettlementDetails30? SettlementParameters { get; set; } 
    #endif
    ...
    public OtherParties9? OtherBusinessParties { get; init; } 
    #else
    public OtherParties9? OtherBusinessParties { get; set; } 
    #endif
