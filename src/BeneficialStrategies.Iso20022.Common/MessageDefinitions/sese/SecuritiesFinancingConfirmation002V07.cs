...
/// <summary>
/// This record is an implementation of the sese.035.002.07 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesFinancingConfirmation002V07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.035.002.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.035.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmation002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmation002V07( TransactionTypeAndAdditionalParameters19 reqTransactionIdentificationDetails,SecuritiesTradeDetails58 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount62 reqQuantityAndAccountDetails )
    {
    ...
    public required SecuritiesTradeDetails58 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails58 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails58 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_dkgFZZw1EeazcsnODTksnQ")]
    ...
    public SettlementDetails104? SettlementParameters { get; init; } 
    #else
    public SettlementDetails104? SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Identifies the chain of delivering settlement parties.
    /// </summary>
    [IsoId("_dkgFcZw1EeazcsnODTksnQ")]
    ...
    public OtherAmounts34? OtherAmounts { get; init; } 
    #else
    public OtherAmounts34? OtherAmounts { get; set; } 
    #endif
    
    /// <summary>
    /// Other business parties relevant to the transaction.
    /// </summary>
    [IsoId("_dkgFe5w1EeazcsnODTksnQ")]
...
// Since SecuritiesFinancingConfirmation002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmation002V07.
