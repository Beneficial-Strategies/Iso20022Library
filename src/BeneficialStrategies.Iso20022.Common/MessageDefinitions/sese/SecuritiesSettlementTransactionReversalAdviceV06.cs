...
/// <summary>
/// This record is an implementation of the sese.026.001.06 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionReversalAdviceV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.06";
    ...
    public required SettlementDetails128 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails128 SettlementParameters { get; init; } 
    #else
    public SettlementDetails128 SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies what settlement standing instruction database is to be used to derive the settlement parties involved in the transaction.
    /// </summary>
    [IsoId("_xLRRLY7CEeaa5_S8lsRKCQ")]
...
// Since SecuritiesSettlementTransactionReversalAdviceV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV06.
