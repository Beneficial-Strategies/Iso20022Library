...
/// <summary>
/// This record is an implementation of the sese.038.002.05 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionModificationRequest002V05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.038.002.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequest002V05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequest002V05( TransactionDetails101 reqModifiedTransactionDetails )
    {
    ...
    public TransactionDetails101 ModifiedTransactionDetails { get; init; } 
    #else
    public TransactionDetails101 ModifiedTransactionDetails { get; set; } 
    #endif
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType26Choice_> UpdateType { get; init; } = new ValueList<UpdateType26Choice_>(){};
...
// Since SecuritiesSettlementTransactionModificationRequest002V05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequest002V05.
