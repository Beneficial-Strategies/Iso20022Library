...
/// <summary>
/// This record is an implementation of the sese.035.001.13 ISO standard message type.
...
[IsoId("_heMswZaFEfC2_67yGLymgA")]
[DisplayName("Securities Financing Confirmation V13")]
public record SecuritiesFinancingConfirmationV13 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.035.001.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.035.001.13";
    ...
    [IsoXmlTag("OthrAmts")]
    public OtherAmounts47? OtherAmounts { get; init; }
    ...
    public required QuantityAndAccount120 QuantityAndAccountDetails { get; init; }
    ...
    public SecuritiesFinancingTransactionDetails56? SecuritiesFinancingDetails { get; init; }
    ...
    public SettlementDetails228? SettlementParameters { get; init; }
...
// Since SecuritiesFinancingConfirmationV13Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmationV13.
