...
/// <summary>
/// This record is an implementation of the sese.026.001.12 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("b95ef421-1781-4bd7-9a54-88b26d6a57f7")]
[DisplayName("Securities Settlement Transaction Reversal Advice V12")]
public record SecuritiesSettlementTransactionReversalAdviceV12 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.12";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.12";
    ...
    public required SettlementDetails223 SettlementParameters { get; init; }
    ...
    [IsoXmlTag("TradDtls")]
    public required SecuritiesTradeDetails150 TradeDetails { get; init; }
...
// Since SecuritiesSettlementTransactionReversalAdviceV12Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV12.
