...
/// <summary>
/// This record is an implementation of the sese.002.001.06 ISO standard message type.
...
public partial record TransferOutCancellationRequestV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.002.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a TransferOutCancellationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferOutCancellationRequestV06( MessageIdentification1 reqMessageIdentification,Cancellation8Choice_ reqCancellation )
    {
    ...
    [IsoXmlTag("Cxl")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required Cancellation8Choice_ Cancellation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required Cancellation8Choice_ Cancellation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Cancellation8Choice_ Cancellation { get; init; } 
    #else
    public Cancellation8Choice_ Cancellation { get; set; } 
    #endif
...
// Since TransferOutCancellationRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TransferOutCancellationRequestV06.
