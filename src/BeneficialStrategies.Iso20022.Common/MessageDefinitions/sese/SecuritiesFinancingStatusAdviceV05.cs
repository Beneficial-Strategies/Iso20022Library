...
public partial record SecuritiesFinancingStatusAdviceV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingStatusAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingStatusAdviceV05( TransactionIdentifications1 reqTransactionIdentification )
    {
    ...
    public SecuritiesFinancingTransactionDetails24? TransactionDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails24? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesFinancingStatusAdviceV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingStatusAdviceV05.
