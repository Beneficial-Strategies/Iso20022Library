...
/// <summary>
/// This record is an implementation of the sese.031.001.11 ISO standard message type.
...
[IsoId("_INcVAaofEfCG2_q2WT-90w")]
[DisplayName("Securities Settlement Condition Modification Status Advice V11")]
public record SecuritiesSettlementConditionModificationStatusAdviceV11 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.031.001.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.031.001.11";
    ...
    [IsoXmlTag("PrcgSts")]
    public required ProcessingStatus106Choice_ ProcessingStatus { get; init; }
    ...
    [IsoXmlTag("ReqDtls")]
    public RequestDetails31? RequestDetails { get; init; }
...
// Since SecuritiesSettlementConditionModificationStatusAdviceV11Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionModificationStatusAdviceV11.
