...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionCounterpartyResponse002V04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionCounterpartyResponse002V04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionCounterpartyResponse002V04( TransactionIdentification7 reqTransactionIdentification,ResponseStatus8Choice_ reqResponseStatus )
    {
    ...
    public TransactionDetails157? TransactionDetails { get; init; } 
    #else
    public TransactionDetails157? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionCounterpartyResponse002V04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionCounterpartyResponse002V04.
