...
public record PortfolioTransferCompletionV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.043.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.043.001.02";
...
// Since PortfolioTransferCompletionV02Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferCompletionV02.
