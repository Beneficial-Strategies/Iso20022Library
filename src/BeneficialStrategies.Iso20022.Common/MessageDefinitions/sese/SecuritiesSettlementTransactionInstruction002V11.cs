...
/// <summary>
/// This record is an implementation of the sese.023.002.11 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionInstruction002V11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.023.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstruction002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstruction002V11( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters22 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails131 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount104 reqQuantityAndAccountDetails,SettlementDetails207 reqSettlementParameters )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SettlementTypeAndAdditionalParameters22 SettlementTypeAndAdditionalParameters { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SettlementTypeAndAdditionalParameters22 SettlementTypeAndAdditionalParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementTypeAndAdditionalParameters22 SettlementTypeAndAdditionalParameters { get; init; } 
    #else
    public SettlementTypeAndAdditionalParameters22 SettlementTypeAndAdditionalParameters { get; set; } 
    #endif
    ...
    public Linkages65? Linkages { get; init; } 
    #else
    public Linkages65? Linkages { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SettlementDetails207 SettlementParameters { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SettlementDetails207 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails207 SettlementParameters { get; init; } 
    #else
    public SettlementDetails207 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionInstruction002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionInstruction002V11.
