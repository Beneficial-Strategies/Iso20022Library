...
/// <summary>
/// This record is an implementation of the sese.039.001.08 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_ID_0MZaOEfC2_67yGLymgA")]
[DisplayName("Securities Settlement Transaction Modification Request Status Advice V08")]
public record SecuritiesSettlementTransactionModificationRequestStatusAdviceV08 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.039.001.08";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.039.001.08";
    ...
    public required ModificationProcessingStatus12Choice_ ModificationProcessingStatus { get; init; }
    ...
    [IsoXmlTag("TxDtls")]
    public TransactionDetails182? TransactionDetails { get; init; }
