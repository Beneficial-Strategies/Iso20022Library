...
/// <summary>
/// This record is an implementation of the sese.013.001.07 ISO standard message type.
...
public partial record PortfolioTransferConfirmationV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.013.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferConfirmationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferConfirmationV07( MessageIdentification1 reqMessageReference,Account19 reqTransferorAccount,PartyIdentification70Choice_ reqTransferee,ISATransfer26 reqProductTransfer )
    {
    ...
    [IsoXmlTag("PdctTrf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required ISATransfer26 ProductTransfer { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required ISATransfer26 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ISATransfer26 ProductTransfer { get; init; } 
    #else
    public ISATransfer26 ProductTransfer { get; set; } 
    #endif
    
    /// <summary>
    /// Identifies the market practice to which the message conforms.
    /// </summary>
    [IsoId("_0lbfjR8OEeWpZde3LQh6dg")]
...
// Since PortfolioTransferConfirmationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferConfirmationV07.
