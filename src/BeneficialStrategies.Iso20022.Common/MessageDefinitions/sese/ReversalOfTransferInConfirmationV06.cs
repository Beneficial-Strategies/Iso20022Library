...
/// <summary>
/// This record is an implementation of the sese.008.001.06 ISO standard message type.
...
public partial record ReversalOfTransferInConfirmationV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.008.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a ReversalOfTransferInConfirmationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReversalOfTransferInConfirmationV06( MessageIdentification1 reqMessageIdentification,Reversal6Choice_ reqReversal )
    {
    ...
    public required Reversal6Choice_ Reversal { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Reversal6Choice_ Reversal { get; init; } 
    #else
    public Reversal6Choice_ Reversal { get; set; } 
    #endif
...
// Since ReversalOfTransferInConfirmationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ReversalOfTransferInConfirmationV06.
