...
public partial record SecuritiesFinancingConfirmationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmationV07( TransactionTypeAndAdditionalParameters16 reqTransactionIdentificationDetails,SecuritiesTradeDetails55 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount40 reqQuantityAndAccountDetails )
    {
