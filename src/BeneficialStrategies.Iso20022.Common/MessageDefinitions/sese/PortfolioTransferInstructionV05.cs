...
public partial record PortfolioTransferInstructionV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferInstructionV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferInstructionV05( MessageIdentification1 reqMessageReference,Account15 reqTransferorAccount,PartyIdentification2Choice_ reqTransferee,ISATransfer16 reqProductTransfer )
    {
    ...
    public required ISATransfer16 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ISATransfer16 ProductTransfer { get; init; } 
    #else
    public ISATransfer16 ProductTransfer { get; set; } 
    #endif
...
// Since PortfolioTransferInstructionV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferInstructionV05.
