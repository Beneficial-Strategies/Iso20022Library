...
/// <summary>
/// This record is an implementation of the sese.026.001.02 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionReversalAdviceV02 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.026.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionReversalAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV02( SettlementTypeAndIdentification9 reqTransactionIdentificationDetails,Identification1 reqConfirmationReference,SecuritiesTradeDetails2 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount15 reqQuantityAndAccountDetails,SettlementDetails26 reqSettlementParameters )
    {
    ...
    public required SettlementDetails26 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails26 SettlementParameters { get; init; } 
    #else
    public SettlementDetails26 SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies what settlement standing instruction database is to be used to derive the settlement parties involved in the transaction.
    /// </summary>
    [IsoId("__VmJVdtZEd-RF5yaMAVhAw")]
    ...
    public OtherParties12? OtherBusinessParties { get; init; } 
    #else
    public OtherParties12? OtherBusinessParties { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information required for the registration or physical settlement.
    /// </summary>
    [IsoId("__VmJY9tZEd-RF5yaMAVhAw")]
...
// Since SecuritiesSettlementTransactionReversalAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionReversalAdviceV02.
