...
public partial record SecuritiesSettlementTransactionAllegementNotification002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementNotification002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementNotification002V07( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters15 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails84 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount70 reqQuantityAndAccountDetails,SettlementDetails153 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails84 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails84 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails84 TradeDetails { get; set; } 
    #endif
    ...
    public required QuantityAndAccount70 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount70 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount70 QuantityAndAccountDetails { get; set; } 
    #endif
    ...
    public SecuritiesFinancingTransactionDetails41? SecuritiesFinancingDetails { get; init; } 
    #else
    public SecuritiesFinancingTransactionDetails41? SecuritiesFinancingDetails { get; set; } 
    #endif
    ...
    public required SettlementDetails153 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails153 SettlementParameters { get; init; } 
    #else
    public SettlementDetails153 SettlementParameters { get; set; } 
    #endif
