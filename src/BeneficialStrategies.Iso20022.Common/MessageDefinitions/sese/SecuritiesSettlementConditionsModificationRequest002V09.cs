...
public partial record SecuritiesSettlementConditionsModificationRequest002V09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionsModificationRequest002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionsModificationRequest002V09( RequestDetails29 reqRequestDetails )
    {
    ...
    public AdditionalInformation28? AdditionalInformation { get; init; } 
    #else
    public AdditionalInformation28? AdditionalInformation { get; set; } 
    #endif
