...
[DataContract]
#endif
public partial record SecuritiesSettlementConditionsModificationRequestV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionsModificationRequestV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionsModificationRequestV08( SecuritiesAccount19 reqSafekeepingAccount,RequestDetails20 reqRequestDetails )
    {
    ...
    public AdditionalInformation16? AdditionalInformation { get; init; } 
    #else
    public AdditionalInformation16? AdditionalInformation { get; set; } 
    #endif
...
// Since SecuritiesSettlementConditionsModificationRequestV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionsModificationRequestV08.
