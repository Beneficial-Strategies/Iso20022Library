...
public partial record PortfolioTransferConfirmationV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferConfirmationV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferConfirmationV11( MessageIdentification1 reqMessageReference,InvestmentAccount69 reqTransferorAccount,PartyIdentification132 reqTransferee,PortfolioTransfer10 reqProductTransfer )
    {
    ...
    public required PortfolioTransfer10 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PortfolioTransfer10 ProductTransfer { get; init; } 
    #else
    public PortfolioTransfer10 ProductTransfer { get; set; } 
    #endif
