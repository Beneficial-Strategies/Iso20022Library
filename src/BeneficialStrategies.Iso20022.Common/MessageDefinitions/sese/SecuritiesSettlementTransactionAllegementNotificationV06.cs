...
/// <summary>
/// This record is an implementation of the sese.028.001.06 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionAllegementNotificationV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.028.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementNotificationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementNotificationV06( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters12 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails54 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount42 reqQuantityAndAccountDetails,SettlementDetails125 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails54 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails54 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails54 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_j5_wV26tEeat2-NFbXd1Pw")]
    ...
    public required QuantityAndAccount42 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount42 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount42 QuantityAndAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the closing of the securities financing transaction.
    /// </summary>
    [IsoId("_j5_wXW6tEeat2-NFbXd1Pw")]
...
// Since SecuritiesSettlementTransactionAllegementNotificationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementNotificationV06.
