...
/// <summary>
/// This record is an implementation of the sese.035.002.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesFinancingConfirmation002V09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.035.002.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.035.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmation002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmation002V09( TransactionTypeAndAdditionalParameters19 reqTransactionIdentificationDetails,SecuritiesTradeDetails101 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount85 reqQuantityAndAccountDetails )
    {
    ...
    [IsoXmlTag("TradDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SecuritiesTradeDetails101 TradeDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SecuritiesTradeDetails101 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails101 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails101 TradeDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Financial instrument representing a sum of rights of the investor vis-a-vis the issuer.
    /// </summary>
    [IsoId("_6sbsVffVEeiNZp_PtLohLw")]
...
// Since SecuritiesFinancingConfirmation002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmation002V09.
