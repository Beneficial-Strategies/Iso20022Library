...
public partial record SecuritiesSettlementTransactionInstructionV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionInstructionV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionInstructionV07( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters19 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails51 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount39 reqQuantityAndAccountDetails,SettlementDetails119 reqSettlementParameters )
    {
    ...
    public required SettlementDetails119 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails119 SettlementParameters { get; init; } 
    #else
    public SettlementDetails119 SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionInstructionV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionInstructionV07.
