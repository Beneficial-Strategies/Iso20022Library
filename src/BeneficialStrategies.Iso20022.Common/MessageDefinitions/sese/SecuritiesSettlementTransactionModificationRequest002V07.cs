...
public record SecuritiesSettlementTransactionModificationRequest002V07 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType30Choice_> UpdateType { get; init; } = [];
}

// Since SecuritiesSettlementTransactionModificationRequest002V07Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequest002V07.
