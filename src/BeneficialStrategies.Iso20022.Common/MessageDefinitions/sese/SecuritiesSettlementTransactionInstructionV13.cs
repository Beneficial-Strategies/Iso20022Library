...
/// <summary>
/// This record is an implementation of the sese.023.001.13 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("191cd2e6-a552-456d-ac1c-20ed86a77dce")]
[DisplayName("Securities Settlement Transaction Instruction V13")]
public record SecuritiesSettlementTransactionInstructionV13 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.023.001.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.023.001.13";
    ...
    [IsoXmlTag("Lnkgs")]
    public ValueList<Linkages79> Linkages { get; init; } = [];
    ...
    public required SettlementDetails220 SettlementParameters { get; init; }
    ...
    [IsoXmlTag("TradDtls")]
    public required SecuritiesTradeDetails149 TradeDetails { get; init; }
