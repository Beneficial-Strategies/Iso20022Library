...
public partial record SecuritiesSettlementTransactionConfirmationV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionConfirmationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionConfirmationV08( SettlementTypeAndIdentification19 reqTransactionIdentificationDetails,SecuritiesTradeDetails76 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount64 reqQuantityAndAccountDetails,SettlementDetails144 reqSettlementParameters )
    {
...
// Since SecuritiesSettlementTransactionConfirmationV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionConfirmationV08.
