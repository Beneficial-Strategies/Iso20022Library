...
public partial record SecuritiesSettlementConditionsModificationRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionsModificationRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionsModificationRequestV03( SecuritiesAccount13 reqSafekeepingAccount,RequestDetails8 reqRequestDetails )
    {
    ...
    #else
    public RequestDetails8 RequestDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementConditionsModificationRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionsModificationRequestV03.
