...
public partial record SecuritiesSettlementTransactionStatusAdvice002V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.024.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionStatusAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdvice002V07( TransactionIdentifications38 reqTransactionIdentification )
    {
    ...
    public ProcessingStatus63Choice_? ProcessingStatus { get; init; } 
    #else
    public ProcessingStatus63Choice_? ProcessingStatus { get; set; } 
    #endif
    
    /// <summary>
    /// Provides the matching status of an instruction as per the account servicer based on an allegement. At this time no matching took place on the market (at the CSD/ICSD).
    /// </summary>
    [IsoId("_8NnkR5NLEeWGlc8L7oPDIg")]
    ...
    [IsoXmlTag("TxDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public TransactionDetails87? TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionDetails87? TransactionDetails { get; init; } 
    #else
    public TransactionDetails87? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_8NnkT5NLEeWGlc8L7oPDIg")]
...
// Since SecuritiesSettlementTransactionStatusAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionStatusAdvice002V07.
