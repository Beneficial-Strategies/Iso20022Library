...
/// <summary>
/// This record is an implementation of the sese.040.001.06 ISO standard message type.
...
[IsoId("_X-uLgZaOEfC2_67yGLymgA")]
[DisplayName("Securities Settlement Transaction Counterparty Response V06")]
public record SecuritiesSettlementTransactionCounterpartyResponseV06 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.040.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.040.001.06";
    ...
    [IsoXmlTag("TxDtls")]
    public TransactionDetails183? TransactionDetails { get; init; }
...
// Since SecuritiesSettlementTransactionCounterpartyResponseV06Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionCounterpartyResponseV06.
