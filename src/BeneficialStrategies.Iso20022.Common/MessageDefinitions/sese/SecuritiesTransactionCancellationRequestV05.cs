...
public partial record SecuritiesTransactionCancellationRequestV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionCancellationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionCancellationRequestV05( References45Choice_ reqAccountOwnerTransactionIdentification,SecuritiesAccount19 reqSafekeepingAccount )
    {
    ...
    public CancellationReason13? CancellationReason { get; init; } 
    #else
    public CancellationReason13? CancellationReason { get; set; } 
    #endif
