...
/// <summary>
/// This record is an implementation of the sese.031.002.07 ISO standard message type.
...
public partial record SecuritiesSettlementConditionModificationStatusAdvice002V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.031.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionModificationStatusAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionModificationStatusAdvice002V07( Identification16 reqRequestReference,ProcessingStatus58Choice_ reqProcessingStatus )
    {
...
// Since SecuritiesSettlementConditionModificationStatusAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionModificationStatusAdvice002V07.
