...
public partial record SecuritiesSettlementTransactionModificationRequest002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequest002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequest002V08( TransactionDetails119 reqModifiedTransactionDetails )
    {
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType34Choice_> UpdateType { get; init; } = new ValueList<UpdateType34Choice_>(){};
...
// Since SecuritiesSettlementTransactionModificationRequest002V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequest002V08.
