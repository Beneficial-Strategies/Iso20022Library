...
/// <summary>
/// This record is an implementation of the sese.013.001.12 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("8f9b446f-86fc-4ebd-bb28-8057ab4929a4")]
[DisplayName("Portfolio Transfer Confirmation V12")]
public record PortfolioTransferConfirmationV12 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.013.001.12";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.013.001.12";
    ...
    [IsoXmlTag("PdctTrf")]
    public ValueList<PortfolioTransfer15> ProductTransfer { get; init; } = [];
...
// Since PortfolioTransferConfirmationV12Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferConfirmationV12.
