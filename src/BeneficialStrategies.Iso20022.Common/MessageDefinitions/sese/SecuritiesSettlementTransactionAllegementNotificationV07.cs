...
public partial record SecuritiesSettlementTransactionAllegementNotificationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementNotificationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementNotificationV07( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters12 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails80 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount63 reqQuantityAndAccountDetails,SettlementDetails141 reqSettlementParameters )
    {
    ...
    public required SecuritiesTradeDetails80 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails80 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails80 TradeDetails { get; set; } 
    #endif
    ...
    public required QuantityAndAccount63 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount63 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount63 QuantityAndAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAllegementNotificationV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementNotificationV07.
