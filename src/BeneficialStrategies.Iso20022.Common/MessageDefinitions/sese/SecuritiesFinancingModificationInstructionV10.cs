...
/// <summary>
/// This record is an implementation of the sese.036.001.10 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("__g5O4ZaGEfC2_67yGLymgA")]
[DisplayName("Securities Financing Modification Instruction V10")]
public record SecuritiesFinancingModificationInstructionV10 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.036.001.10";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.036.001.10";
    ...
    /// <summary>
    /// Opening Digital Settlement Amount.
    /// </summary>
    [DisplayName("Opening Digital Settlement Amount")]
    [IsoXmlTag("OpngDgtlSttlmAmt")]
    public DigitalPaymentSettlement2? OpeningDigitalSettlementAmount { get; init; }
    ...
    public SettlementDetails226? SettlementParameters { get; init; }
...
// Since SecuritiesFinancingModificationInstructionV10Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingModificationInstructionV10.
