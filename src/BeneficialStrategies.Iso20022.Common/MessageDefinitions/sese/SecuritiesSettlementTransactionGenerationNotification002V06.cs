...
public partial record SecuritiesSettlementTransactionGenerationNotification002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionGenerationNotification002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotification002V06( SettlementTypeAndIdentification24 reqTransactionIdentificationDetails,SecuritiesTradeDetails63 reqTradeDetails,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount47 reqQuantityAndAccountDetails,SettlementDetails111 reqSettlementParameters )
    {
    ...
    public required SettlementDetails111 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails111 SettlementParameters { get; init; } 
    #else
    public SettlementDetails111 SettlementParameters { get; set; } 
    #endif
