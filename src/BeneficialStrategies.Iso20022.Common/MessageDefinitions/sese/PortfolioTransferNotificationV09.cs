...
/// <summary>
/// This record is an implementation of the sese.037.001.09 ISO standard message type.
...
[IsoId("_uLnIoZaHEfC2_67yGLymgA")]
[DisplayName("Portfolio Transfer Notification V09")]
public record PortfolioTransferNotificationV09 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "sese.037.001.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:sese.037.001.09";
    ...
    public ValueList<SecuritiesTradeDetails154> TransferNotificationDetails { get; init; } = [];
}

// Since PortfolioTransferNotificationV09Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferNotificationV09.
