...
public record SecuritiesSettlementTransactionModificationRequestV05 : IOuterRecord
{
    /// <summary>
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType25Choice_> UpdateType { get; init; } = [];
}

// Since SecuritiesSettlementTransactionModificationRequestV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequestV05.
