...
/// <summary>
/// This record is an implementation of the sese.028.001.05 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionAllegementNotificationV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.028.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementNotificationV05( System.String reqTransactionIdentification,SettlementTypeAndAdditionalParameters12 reqSettlementTypeAndAdditionalParameters,SecuritiesTradeDetails54 reqTradeDetails,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount42 reqQuantityAndAccountDetails,SettlementDetails99 reqSettlementParameters )
    {
...
// Since SecuritiesSettlementTransactionAllegementNotificationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementNotificationV05.
