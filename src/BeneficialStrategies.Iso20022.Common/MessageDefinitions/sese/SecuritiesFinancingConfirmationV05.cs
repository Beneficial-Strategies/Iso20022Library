...
public partial record SecuritiesFinancingConfirmationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingConfirmationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingConfirmationV05( TransactionTypeAndAdditionalParameters3 reqTransactionIdentificationDetails,SecuritiesTradeDetails38 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount18 reqQuantityAndAccountDetails )
    {
    ...
    public required SecuritiesTradeDetails38 TradeDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails38 TradeDetails { get; init; } 
    #else
    public SecuritiesTradeDetails38 TradeDetails { get; set; } 
    #endif
    ...
    public SettlementDetails71? SettlementParameters { get; init; } 
    #else
    public SettlementDetails71? SettlementParameters { get; set; } 
    #endif
...
// Since SecuritiesFinancingConfirmationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingConfirmationV05.
