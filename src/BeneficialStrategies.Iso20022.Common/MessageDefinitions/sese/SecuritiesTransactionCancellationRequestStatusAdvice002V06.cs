...
public partial record SecuritiesTransactionCancellationRequestStatusAdvice002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionCancellationRequestStatusAdvice002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionCancellationRequestStatusAdvice002V06( Identification16 reqCancellationRequestReference,ProcessingStatus65Choice_ reqProcessingStatus )
    {
    ...
    public TransactionDetails143? TransactionDetails { get; init; } 
    #else
    public TransactionDetails143? TransactionDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionCancellationRequestStatusAdvice002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionCancellationRequestStatusAdvice002V06.
