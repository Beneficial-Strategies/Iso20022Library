...
[DataContract]
#endif
public partial record SecuritiesFinancingInstructionV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingInstructionV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingInstructionV02( System.String reqTransactionIdentification,TransactionTypeAndAdditionalParameters1 reqTransactionTypeAndAdditionalParameters,SecuritiesTradeDetails3 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount17 reqQuantityAndAccountDetails,SecuritiesFinancingTransactionDetails1 reqSecuritiesFinancingDetails )
    {
    ...
    public Linkages9? Linkages { get; init; } 
    #else
    public Linkages9? Linkages { get; set; } 
    #endif
    ...
    public SettlementDetails31? SettlementParameters { get; init; } 
    #else
    public SettlementDetails31? SettlementParameters { get; set; } 
    #endif
