...
/// <summary>
/// This record is an implementation of the sese.031.001.04 ISO standard message type.
...
public partial record SecuritiesSettlementConditionModificationStatusAdviceV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.031.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionModificationStatusAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionModificationStatusAdviceV04( Identification1 reqRequestReference,ProcessingStatus18Choice_ reqProcessingStatus )
    {
    ...
    #else
    public ProcessingStatus18Choice_ ProcessingStatus { get; set; } 
    #endif
...
// Since SecuritiesSettlementConditionModificationStatusAdviceV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionModificationStatusAdviceV04.
