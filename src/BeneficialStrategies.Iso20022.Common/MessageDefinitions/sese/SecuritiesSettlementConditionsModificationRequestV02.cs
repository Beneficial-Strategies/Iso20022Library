...
[DataContract]
#endif
public partial record SecuritiesSettlementConditionsModificationRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementConditionsModificationRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementConditionsModificationRequestV02( SecuritiesAccount13 reqSafekeepingAccount,RequestDetails6 reqRequestDetails )
    {
...
// Since SecuritiesSettlementConditionsModificationRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementConditionsModificationRequestV02.
