...
public partial record SecuritiesSettlementTransactionModificationRequest002V09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionModificationRequest002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionModificationRequest002V09( TransactionDetails159 reqModifiedTransactionDetails )
    {
    ...
    public TransactionDetails159 ModifiedTransactionDetails { get; init; } 
    #else
    public TransactionDetails159 ModifiedTransactionDetails { get; set; } 
    #endif
    ...
    [MinLength(1)]
    [MaxLength(3)]
    public ValueList<UpdateType38Choice_> UpdateType { get; init; } = new ValueList<UpdateType38Choice_>(){};
...
// Since SecuritiesSettlementTransactionModificationRequest002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionModificationRequest002V09.
