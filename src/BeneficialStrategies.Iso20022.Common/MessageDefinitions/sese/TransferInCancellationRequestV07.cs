...
public partial record TransferInCancellationRequestV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferInCancellationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferInCancellationRequestV07( MessageIdentification1 reqMessageIdentification,Cancellation10Choice_ reqCancellation )
    {
    ...
    public required Cancellation10Choice_ Cancellation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Cancellation10Choice_ Cancellation { get; init; } 
    #else
    public Cancellation10Choice_ Cancellation { get; set; } 
    #endif
