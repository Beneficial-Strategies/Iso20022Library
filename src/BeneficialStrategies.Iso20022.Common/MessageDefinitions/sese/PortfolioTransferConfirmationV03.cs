...
/// <summary>
/// This record is an implementation of the sese.013.001.03 ISO standard message type.
...
public partial record PortfolioTransferConfirmationV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "sese.013.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransferConfirmationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransferConfirmationV03( MessageIdentification1 reqMessageReference,Account5 reqTransferorAccount,PartyIdentification2Choice_ reqTransferee,ISATransfer2 reqProductTransfer )
    {
    ...
    public required ISATransfer2 ProductTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ISATransfer2 ProductTransfer { get; init; } 
    #else
    public ISATransfer2 ProductTransfer { get; set; } 
    #endif
...
// Since PortfolioTransferConfirmationV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PortfolioTransferConfirmationV03.
