...
public partial record AuthorisationInitiationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AuthorisationInitiationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AuthorisationInitiationV03( Header62 reqHeader,AuthorisationInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required AuthorisationInitiation2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AuthorisationInitiation2 Body { get; init; } 
    #else
    public AuthorisationInitiation2 Body { get; set; } 
    #endif
...
// Since AuthorisationInitiationV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AuthorisationInitiationV03.
