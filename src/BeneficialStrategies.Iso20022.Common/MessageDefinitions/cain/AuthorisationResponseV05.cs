...
/// <summary>
/// This record is an implementation of the cain.002.001.05 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_n9iXkROHEfC1ZfCQz0xB3g")]
[DisplayName("Authorisation Response V05")]
public record AuthorisationResponseV05 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "cain.002.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:cain.002.001.05";
    ...
    [IsoXmlTag("PrcgRslt")]
    public required ProcessingResult29 ProcessingResult { get; init; }
    ...
    public TransactionSpecificData2? TransactionSpecificData { get; init; }
...
// Since AuthorisationResponseV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AuthorisationResponseV05.
