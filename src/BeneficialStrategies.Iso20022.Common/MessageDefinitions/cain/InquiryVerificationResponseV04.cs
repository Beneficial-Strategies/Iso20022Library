...
/// <summary>
/// This record is an implementation of the cain.017.001.04 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_Femd0SRUEfCa6bxMAKEOKg")]
[DisplayName("Inquiry Verification Response V04")]
public record InquiryVerificationResponseV04 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "cain.017.001.04";

    /// <summary>
    /// The ISO specified XML tag that should be used for standardized serialization of this message.
    /// </summary>
    public const string XmlTag = "NqryVrfctnRspn";

    /// <summary>
    /// The ISO specified XML namespace that should be used for standardized serialization of this message type.
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:cain.017.001.04";
    ...
    public ValueList<ProgrammeMode6> CardProgramme { get; init; } = [];
    ...
    [DisplayName("Context")]
    [IsoXmlTag("Cntxt")]
    public Context27? Context { get; init; }
    ...
    [IsoXmlTag("TxId")]
    public required TransactionIdentification60 TransactionIdentification { get; init; }
...
// Since InquiryVerificationResponseV04Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to InquiryVerificationResponseV04.
