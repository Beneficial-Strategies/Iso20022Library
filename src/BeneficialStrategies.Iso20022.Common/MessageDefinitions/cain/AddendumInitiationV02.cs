...
/// </summary>
[Description(
    @"Provides supplemental data in addition to that which is required to complete an authorization initiation or financial initiation. ||The supplemental data is associated with an authorization or financial message."
)]
[IsoId("_FqDuYYdJEeuBS50MFjViNw")]
[DisplayName("Addendum Initiation V")]
public record AddendumInitiationV02 : IOuterRecord
{
    /// <summary>
