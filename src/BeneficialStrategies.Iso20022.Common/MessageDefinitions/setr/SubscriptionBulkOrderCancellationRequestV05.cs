...
public record SubscriptionBulkOrderCancellationRequestV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "setr.008.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:setr.008.001.05";
...
// Since SubscriptionBulkOrderCancellationRequestV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SubscriptionBulkOrderCancellationRequestV05.
