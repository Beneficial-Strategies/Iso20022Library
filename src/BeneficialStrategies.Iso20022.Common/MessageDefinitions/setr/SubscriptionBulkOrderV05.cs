...
/// <summary>
/// This record is an implementation of the setr.007.001.05 ISO standard message type.
...
[IsoId("f27d3b7f-b6b1-4a86-8bdd-c19bbd55dab6")]
[DisplayName("Subscription Bulk Order V05")]
public record SubscriptionBulkOrderV05 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "setr.007.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:setr.007.001.05";
    ...
    public required SubscriptionBulkOrder06 BulkOrderDetails { get; init; }
...
// Since SubscriptionBulkOrderV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SubscriptionBulkOrderV05.
