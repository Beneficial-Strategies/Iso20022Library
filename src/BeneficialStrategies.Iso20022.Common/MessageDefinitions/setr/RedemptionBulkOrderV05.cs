...
/// <summary>
/// This record is an implementation of the setr.001.001.05 ISO standard message type.
...
[IsoId("3a261563-b653-4d49-9418-7de2c9c6b3d0")]
[DisplayName("Redemption Bulk Order V05")]
public record RedemptionBulkOrderV05 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "setr.001.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:setr.001.001.05";
    ...
    public required RedemptionBulkOrder08 BulkOrderDetails { get; init; }
...
// Since RedemptionBulkOrderV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RedemptionBulkOrderV05.
