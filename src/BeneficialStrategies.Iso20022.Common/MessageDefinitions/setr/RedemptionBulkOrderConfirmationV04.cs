...
public partial record RedemptionBulkOrderConfirmationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a RedemptionBulkOrderConfirmationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RedemptionBulkOrderConfirmationV04( MessageIdentification1 reqMessageIdentification,RedemptionBulkExecution5 reqBulkExecutionDetails )
    {
    ...
    public required RedemptionBulkExecution5 BulkExecutionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RedemptionBulkExecution5 BulkExecutionDetails { get; init; } 
    #else
    public RedemptionBulkExecution5 BulkExecutionDetails { get; set; } 
    #endif
...
// Since RedemptionBulkOrderConfirmationV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RedemptionBulkOrderConfirmationV04.
