...
/// <summary>
/// This record is an implementation of the setr.003.001.05 ISO standard message type.
...
[IsoId("20ffb2f9-e0ff-484c-939c-2e7b09982696")]
[DisplayName("Redemption Bulk Order Confirmation V05")]
public record RedemptionBulkOrderConfirmationV05 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "setr.003.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:setr.003.001.05";
    ...
    public required RedemptionBulkExecution06 BulkExecutionDetails { get; init; }
...
// Since RedemptionBulkOrderConfirmationV05Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to RedemptionBulkOrderConfirmationV05.
