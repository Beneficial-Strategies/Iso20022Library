...
public partial record ForeignExchangeTradeStatusAndDetailsNotificationV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTradeStatusAndDetailsNotificationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTradeStatusAndDetailsNotificationV05( TradeData14 reqStatusDetails,TradeAgreement12 reqTradeInformation,TradePartyIdentification8 reqTradingSideIdentification,TradePartyIdentification8 reqCounterpartySideIdentification,AmountsAndValueDate6 reqTradeAmounts,AgreedRate3 reqAgreedRate )
    {
    ...
    public GeneralInformation8? GeneralInformation { get; init; } 
    #else
    public GeneralInformation8? GeneralInformation { get; set; } 
    #endif
    ...
    public SplitTradeDetails4? SplitTradeInformation { get; init; } 
    #else
    public SplitTradeDetails4? SplitTradeInformation { get; set; } 
    #endif
