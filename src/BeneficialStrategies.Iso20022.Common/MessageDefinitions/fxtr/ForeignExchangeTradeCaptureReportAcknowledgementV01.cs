...
/// </summary>
[Description(
    @"Scope|The ForeignExchangeTradeCaptureReportAcknowledgement message is sent by trading members to the trading system for notifying the trade capture report is received.||Usage|The acknowledgement is sent by the trading member to the trading system after they received the trade capture report. |Note that one capture acknowledgement responds to one capture report."
)]
[IsoId("_5_POYHO0EeSG-OV0nXMl5w")]
[DisplayName("Foreign Exchange Trade Capture Report Acknowledgement V")]
public record ForeignExchangeTradeCaptureReportAcknowledgementV01 : IOuterRecord
{
    /// <summary>
