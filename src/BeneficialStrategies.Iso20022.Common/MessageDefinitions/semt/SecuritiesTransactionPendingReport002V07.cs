...
/// <summary>
/// This record is an implementation of the semt.018.002.07 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesTransactionPendingReport002V07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.018.002.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReport002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReport002V07( Pagination reqPagination,Statement55 reqStatementGeneralDetails,SecuritiesAccount27 reqSafekeepingAccount )
    {
    ...
    public required Statement55 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement55 StatementGeneralDetails { get; init; } 
    #else
    public Statement55 StatementGeneralDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Party that legally owns the account.
    /// </summary>
    [IsoId("_8VHTU5NLEeWGlc8L7oPDIg")]
    ...
    [IsoXmlTag("Sts")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public StatusAndReason30? Status { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusAndReason30? Status { get; init; } 
    #else
    public StatusAndReason30? Status { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the transactions reported.
    /// </summary>
    [IsoId("_8VHTWZNLEeWGlc8L7oPDIg")]
    ...
    [IsoXmlTag("Txs")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public Transaction49? Transactions { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction49? Transactions { get; init; } 
    #else
    public Transaction49? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReport002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReport002V07.
