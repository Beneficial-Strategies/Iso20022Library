...
/// <summary>
/// This record is an implementation of the semt.016.002.09 ISO standard message type.
...
[DataContract]
#endif
public partial record IntraPositionMovementPostingReport002V09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.016.002.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.016.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementPostingReport002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementPostingReport002V09( Pagination1 reqPagination,Statement81 reqStatementGeneralDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required Statement81 StatementGeneralDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required Statement81 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement81 StatementGeneralDetails { get; init; } 
    #else
    public Statement81 StatementGeneralDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Party that legally owns the account.
    /// </summary>
    [IsoId("_ccnLMji8Eeydid5dcNPKvg")]
    ...
    [IsoXmlTag("FinInstrm")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public FinancialInstrumentDetails44? FinancialInstrument { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FinancialInstrumentDetails44? FinancialInstrument { get; init; } 
    #else
    public FinancialInstrumentDetails44? FinancialInstrument { get; set; } 
    #endif
...
// Since IntraPositionMovementPostingReport002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementPostingReport002V09.
