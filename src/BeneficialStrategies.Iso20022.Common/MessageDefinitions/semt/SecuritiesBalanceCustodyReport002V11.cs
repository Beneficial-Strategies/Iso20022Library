...
/// <summary>
/// This record is an implementation of the semt.002.002.11 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesBalanceCustodyReport002V11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.002.002.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.002.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceCustodyReport002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceCustodyReport002V11( Pagination1 reqPagination,Statement77 reqStatementGeneralDetails )
    {
    ...
    public SecuritiesAccount42? SafekeepingAccount { get; init; } 
    #else
    public SecuritiesAccount42? SafekeepingAccount { get; set; } 
    #endif
    
    /// <summary>
    /// Blockchain address or wallet where digital assets are maintained. This is the equivalent of safekeeping account for digital assets.
    /// </summary>
    [IsoId("_csT0IDi8Eeydid5dcNPKvg")]
    ...
    public BlockChainAddressWallet10? BlockChainAddressOrWallet { get; init; } 
    #else
    public BlockChainAddressWallet10? BlockChainAddressOrWallet { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the party that provides services relating to financial products to investors, for example, advice on products and placement of orders for the investment fund.
    /// </summary>
    [IsoId("_csT0Iji8Eeydid5dcNPKvg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalanceInformation44? BalanceForAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalanceInformation44? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation44? BalanceForAccount { get; set; } 
    #endif
    
    /// <summary>
    /// Sub-account of the safekeeping or investment account.
    /// </summary>
    [IsoId("_csT0Jji8Eeydid5dcNPKvg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SubAccountIdentification69? SubAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SubAccountIdentification69? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification69? SubAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Total valuation amounts provided in the base currency of the account.
    /// </summary>
    [IsoId("_csT0KDi8Eeydid5dcNPKvg")]
