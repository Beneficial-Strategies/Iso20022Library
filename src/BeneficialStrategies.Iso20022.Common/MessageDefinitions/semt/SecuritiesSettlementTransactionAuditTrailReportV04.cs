...
public partial record SecuritiesSettlementTransactionAuditTrailReportV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAuditTrailReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAuditTrailReportV04( Pagination1 reqPagination,SecuritiesAccount22 reqSafekeepingAccount )
    {
    ...
    public StatusTrail8? StatusTrail { get; init; } 
    #else
    public StatusTrail8? StatusTrail { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAuditTrailReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAuditTrailReportV04.
