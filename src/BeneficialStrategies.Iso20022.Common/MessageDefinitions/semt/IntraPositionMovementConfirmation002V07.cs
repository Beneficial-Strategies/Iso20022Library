...
public partial record IntraPositionMovementConfirmation002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementConfirmation002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementConfirmation002V07( SecuritiesAccount30 reqSafekeepingAccount,SecurityIdentification20 reqFinancialInstrumentIdentification,IntraPositionDetails47 reqIntraPositionDetails )
    {
    ...
    public required IntraPositionDetails47 IntraPositionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraPositionDetails47 IntraPositionDetails { get; init; } 
    #else
    public IntraPositionDetails47 IntraPositionDetails { get; set; } 
    #endif
...
// Since IntraPositionMovementConfirmation002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementConfirmation002V07.
