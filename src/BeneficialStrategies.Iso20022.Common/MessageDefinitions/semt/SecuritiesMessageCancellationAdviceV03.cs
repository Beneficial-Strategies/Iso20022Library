...
/// <summary>
/// This record is an implementation of the semt.020.001.03 ISO standard message type.
...
public partial record SecuritiesMessageCancellationAdviceV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.020.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesMessageCancellationAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesMessageCancellationAdviceV03( References18Choice_ reqReference,SecuritiesAccount13 reqSafekeepingAccount )
    {
...
// Since SecuritiesMessageCancellationAdviceV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesMessageCancellationAdviceV03.
