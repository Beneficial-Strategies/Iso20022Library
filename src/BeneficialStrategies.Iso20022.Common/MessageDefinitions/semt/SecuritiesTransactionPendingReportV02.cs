...
/// <summary>
/// This record is an implementation of the semt.018.001.02 ISO standard message type.
...
public partial record SecuritiesTransactionPendingReportV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReportV02( Pagination reqPagination,Statement14 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public StatusAndReason7? Status { get; init; } 
    #else
    public StatusAndReason7? Status { get; set; } 
    #endif
    ...
    public Transaction12? Transactions { get; init; } 
    #else
    public Transaction12? Transactions { get; set; } 
    #endif
