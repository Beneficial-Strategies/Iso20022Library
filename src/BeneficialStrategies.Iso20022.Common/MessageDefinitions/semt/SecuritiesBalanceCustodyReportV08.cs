...
public partial record SecuritiesBalanceCustodyReportV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceCustodyReportV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceCustodyReportV08( Pagination reqPagination,Statement33 reqStatementGeneralDetails,SecuritiesAccount11 reqSafekeepingAccount )
    {
    ...
    public AggregateBalanceInformation25? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation25? BalanceForAccount { get; set; } 
    #endif
    ...
    public SubAccountIdentification37? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification37? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesBalanceCustodyReportV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesBalanceCustodyReportV08.
