...
/// <summary>
/// This record is an implementation of the semt.003.001.11 ISO standard message type.
...
public partial record SecuritiesBalanceAccountingReportV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.003.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceAccountingReportV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceAccountingReportV11( Pagination1 reqPagination,Statement74 reqStatementGeneralDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalanceInformation40? BalanceForAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalanceInformation40? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation40? BalanceForAccount { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SubAccountIdentification65? SubAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SubAccountIdentification65? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification65? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesBalanceAccountingReportV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesBalanceAccountingReportV11.
