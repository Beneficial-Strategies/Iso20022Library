...
/// <summary>
/// This record is an implementation of the semt.019.002.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionAllegementReport002V09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.019.002.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.019.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementReport002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementReport002V09( Pagination1 reqPagination,Statement69 reqStatementGeneralDetails,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SecuritiesTradeDetails127? AllegementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTradeDetails127? AllegementDetails { get; init; } 
    #else
    public SecuritiesTradeDetails127? AllegementDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAllegementReport002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementReport002V09.
