...
public partial record SecuritiesBalanceAccountingReportV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceAccountingReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceAccountingReportV04( Pagination reqPagination,Statement20 reqStatementGeneralDetails,SecuritiesAccount11 reqSafekeepingAccount )
    {
    ...
    public AggregateBalanceInformation13? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation13? BalanceForAccount { get; set; } 
    #endif
    ...
    public SubAccountIdentification16? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification16? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesBalanceAccountingReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesBalanceAccountingReportV04.
