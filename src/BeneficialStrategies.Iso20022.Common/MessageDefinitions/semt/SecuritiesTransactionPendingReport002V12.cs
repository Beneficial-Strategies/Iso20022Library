...
public partial record SecuritiesTransactionPendingReport002V12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReport002V12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReport002V12( Pagination1 reqPagination,Statement70 reqStatementGeneralDetails,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    public StatusAndReason43? Status { get; init; } 
    #else
    public StatusAndReason43? Status { get; set; } 
    #endif
    ...
    public Transaction118? Transactions { get; init; } 
    #else
    public Transaction118? Transactions { get; set; } 
    #endif
