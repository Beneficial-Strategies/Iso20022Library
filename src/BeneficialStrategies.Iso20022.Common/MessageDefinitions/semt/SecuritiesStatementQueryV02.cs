...
public partial record SecuritiesStatementQueryV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesStatementQueryV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesStatementQueryV02( DocumentNumber1 reqStatementRequested,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public AdditionalQueryParameters3? AdditionalQueryParameters { get; init; } 
    #else
    public AdditionalQueryParameters3? AdditionalQueryParameters { get; set; } 
    #endif
...
// Since SecuritiesStatementQueryV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesStatementQueryV02.
