...
[IsoId("_MfuZMdFSEd-BzquC8wXy7w_-524231997")]
...
public partial record SecuritiesTransactionPostingReportV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV01( DocumentIdentification11 reqIdentification,Pagination reqPagination,Statement11 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public SubAccountIdentification9? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification9? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV01.
