...
public partial record IntraPositionMovementPostingReport002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementPostingReport002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementPostingReport002V06( Pagination reqPagination,Statement49 reqStatementGeneralDetails,SecuritiesAccount27 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails26? FinancialInstrument { get; init; } 
    #else
    public FinancialInstrumentDetails26? FinancialInstrument { get; set; } 
    #endif
...
// Since IntraPositionMovementPostingReport002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementPostingReport002V06.
