...
public partial record IntraPositionMovementStatusAdviceV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementStatusAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementStatusAdviceV05( TransactionIdentifications29 reqTransactionIdentification )
    {
    ...
    public IntraPositionDetails39? TransactionDetails { get; init; } 
    #else
    public IntraPositionDetails39? TransactionDetails { get; set; } 
    #endif
...
// Since IntraPositionMovementStatusAdviceV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementStatusAdviceV05.
