...
/// <summary>
/// This record is an implementation of the semt.018.001.14 ISO standard message type.
/// There are significant differences between different variants of the same message. It is crucial that you select exactly the implementation you intend to send or receive.
/// </summary>
[IsoId("_rBFIoYYPEe-Pv9KR9bv9IA")]
[DisplayName("Securities Transaction Pending Report V14")]
public partial record SecuritiesTransactionPendingReportV14 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.018.001.14";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.14";
    ...
    [DisplayName("Status")]
    [IsoXmlTag("Sts")]
    public ValueList<StatusAndReason47> Status { get; init; } = [];
