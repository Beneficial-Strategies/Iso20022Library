...
public partial record SecuritiesTransactionPendingReportV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReportV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReportV06( Pagination reqPagination,Statement14 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public StatusAndReason25? Status { get; init; } 
    #else
    public StatusAndReason25? Status { get; set; } 
    #endif
    ...
    public Transaction41? Transactions { get; init; } 
    #else
    public Transaction41? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReportV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReportV06.
