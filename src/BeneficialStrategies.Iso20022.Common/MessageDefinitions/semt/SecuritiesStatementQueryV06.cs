...
public partial record SecuritiesStatementQueryV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesStatementQueryV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesStatementQueryV06( DocumentNumber13 reqStatementRequested,SecuritiesAccount24 reqSafekeepingAccount )
    {
    ...
    public Statement42? StatementGeneralDetails { get; init; } 
    #else
    public Statement42? StatementGeneralDetails { get; set; } 
    #endif
