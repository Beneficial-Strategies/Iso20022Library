...
/// <summary>
/// This record is an implementation of the semt.018.001.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesTransactionPendingReportV09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.018.001.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.018.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReportV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReportV09( Pagination1 reqPagination,Statement64 reqStatementGeneralDetails,SecuritiesAccount19 reqSafekeepingAccount )
    {
    ...
    [IsoXmlTag("Sts")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public StatusAndReason34? Status { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusAndReason34? Status { get; init; } 
    #else
    public StatusAndReason34? Status { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the transactions reported.
    /// </summary>
    [IsoId("_GsMZ36N-EeeNVLC-L_hywg")]
    ...
    [IsoXmlTag("Txs")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public Transaction60? Transactions { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction60? Transactions { get; init; } 
    #else
    public Transaction60? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReportV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReportV09.
