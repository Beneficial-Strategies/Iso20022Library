...
public partial record StatementOfInvestmentFundTransactionsCancellationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a StatementOfInvestmentFundTransactionsCancellationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatementOfInvestmentFundTransactionsCancellationV03( MessageIdentification1 reqMessageIdentification,Pagination reqMessagePagination )
    {
    ...
    public StatementOfInvestmentFundTransactions3? StatementToBeCancelled { get; init; } 
    #else
    public StatementOfInvestmentFundTransactions3? StatementToBeCancelled { get; set; } 
    #endif
