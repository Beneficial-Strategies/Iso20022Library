...
/// <summary>
/// This record is an implementation of the semt.020.002.05 ISO standard message type.
...
public partial record SecuritiesMessageCancellationAdvice002V05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.020.002.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesMessageCancellationAdvice002V05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesMessageCancellationAdvice002V05( References53Choice_ reqReference,SecuritiesAccount27 reqSafekeepingAccount )
    {
    ...
    [IsoXmlTag("Ref")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required References53Choice_ Reference { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required References53Choice_ Reference { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public References53Choice_ Reference { get; init; } 
    #else
    public References53Choice_ Reference { get; set; } 
    #endif
...
// Since SecuritiesMessageCancellationAdvice002V05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesMessageCancellationAdvice002V05.
