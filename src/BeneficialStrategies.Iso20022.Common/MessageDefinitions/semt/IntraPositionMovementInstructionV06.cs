...
public partial record IntraPositionMovementInstructionV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementInstructionV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementInstructionV06( System.String reqTransactionIdentification,SecurityIdentification19 reqFinancialInstrumentIdentification,IntraPositionDetails58 reqIntraPositionDetails )
    {
    ...
    public required IntraPositionDetails58 IntraPositionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraPositionDetails58 IntraPositionDetails { get; init; } 
    #else
    public IntraPositionDetails58 IntraPositionDetails { get; set; } 
    #endif
