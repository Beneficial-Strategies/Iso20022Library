...
/// <summary>
/// This record is an implementation of the semt.017.002.06 ISO standard message type.
...
public partial record SecuritiesTransactionPostingReport002V06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.017.002.06";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReport002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReport002V06( Pagination reqPagination,Statement56 reqStatementGeneralDetails,SecuritiesAccount27 reqSafekeepingAccount )
    {
    ...
    public required Statement56 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement56 StatementGeneralDetails { get; init; } 
    #else
    public Statement56 StatementGeneralDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Party that legally owns the account.
    /// </summary>
    [IsoId("_8bfoMZNLEeWGlc8L7oPDIg")]
    ...
    public SubAccountIdentification47? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification47? SubAccountDetails { get; set; } 
    #endif
