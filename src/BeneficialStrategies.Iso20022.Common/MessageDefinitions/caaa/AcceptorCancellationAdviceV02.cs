...
public partial record AcceptorCancellationAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdviceV02( Header2 reqHeader,AcceptorCancellationAdvice2 reqCancellationAdvice,ContentInformationType6 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationAdvice2 CancellationAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdvice2 CancellationAdvice { get; init; } 
    #else
    public AcceptorCancellationAdvice2 CancellationAdvice { get; set; } 
    #endif
