...
public partial record AcceptorReconciliationResponseV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationResponseV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationResponseV06( Header35 reqHeader,AcceptorReconciliationResponse5 reqReconciliationResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorReconciliationResponse5 ReconciliationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorReconciliationResponse5 ReconciliationResponse { get; init; } 
    #else
    public AcceptorReconciliationResponse5 ReconciliationResponse { get; set; } 
    #endif
...
// Since AcceptorReconciliationResponseV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorReconciliationResponseV06.
