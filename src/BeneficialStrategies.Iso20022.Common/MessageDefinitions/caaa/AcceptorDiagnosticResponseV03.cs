...
public partial record AcceptorDiagnosticResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorDiagnosticResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorDiagnosticResponseV03( Header7 reqHeader,AcceptorDiagnosticResponse3 reqDiagnosticResponse,ContentInformationType8 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    public required AcceptorDiagnosticResponse3 DiagnosticResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorDiagnosticResponse3 DiagnosticResponse { get; init; } 
    #else
    public AcceptorDiagnosticResponse3 DiagnosticResponse { get; set; } 
    #endif
...
// Since AcceptorDiagnosticResponseV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorDiagnosticResponseV03.
