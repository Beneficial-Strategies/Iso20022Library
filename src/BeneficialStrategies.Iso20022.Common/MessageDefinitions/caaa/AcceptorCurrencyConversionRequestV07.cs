...
/// <summary>
/// This record is an implementation of the caaa.016.001.07 ISO standard message type.
...
public partial record AcceptorCurrencyConversionRequestV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.016.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionRequestV07( Header58 reqHeader,AcceptorCurrencyConversionRequest7 reqCurrencyConversionRequest )
    {
        Header = reqHeader;
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AcceptorCurrencyConversionRequest7 CurrencyConversionRequest { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AcceptorCurrencyConversionRequest7 CurrencyConversionRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCurrencyConversionRequest7 CurrencyConversionRequest { get; init; } 
    #else
    public AcceptorCurrencyConversionRequest7 CurrencyConversionRequest { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionRequestV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionRequestV07.
