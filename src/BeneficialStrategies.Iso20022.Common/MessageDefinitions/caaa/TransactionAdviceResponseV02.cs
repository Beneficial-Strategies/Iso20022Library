...
public partial record TransactionAdviceResponseV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionAdviceResponseV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionAdviceResponseV02( Header59 reqHeader,AcceptorCompletionAdviceResponse9 reqTransactionAdviceResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCompletionAdviceResponse9 TransactionAdviceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCompletionAdviceResponse9 TransactionAdviceResponse { get; init; } 
    #else
    public AcceptorCompletionAdviceResponse9 TransactionAdviceResponse { get; set; } 
    #endif
...
// Since TransactionAdviceResponseV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to TransactionAdviceResponseV02.
