...
public partial record AcceptorReconciliationRequestV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequestV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequestV11( Header70 reqHeader,AcceptorReconciliationRequest11 reqReconciliationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorReconciliationRequest11 ReconciliationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorReconciliationRequest11 ReconciliationRequest { get; init; } 
    #else
    public AcceptorReconciliationRequest11 ReconciliationRequest { get; set; } 
    #endif
