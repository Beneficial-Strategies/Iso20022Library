...
/// <summary>
/// This record is an implementation of the caaa.008.001.07 ISO standard message type.
...
public partial record AcceptorCancellationAdviceResponseV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.008.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdviceResponseV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdviceResponseV07( Header36 reqHeader,AcceptorCancellationAdviceResponse7 reqCancellationAdviceResponse )
    {
        Header = reqHeader;
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AcceptorCancellationAdviceResponse7 CancellationAdviceResponse { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AcceptorCancellationAdviceResponse7 CancellationAdviceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdviceResponse7 CancellationAdviceResponse { get; init; } 
    #else
    public AcceptorCancellationAdviceResponse7 CancellationAdviceResponse { get; set; } 
    #endif
...
// Since AcceptorCancellationAdviceResponseV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationAdviceResponseV07.
