...
/// <summary>
/// This record is an implementation of the caaa.001.001.06 ISO standard message type.
...
public partial record AcceptorAuthorisationRequestV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.001.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorAuthorisationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorAuthorisationRequestV06( Header30 reqHeader,AcceptorAuthorisationRequest6 reqAuthorisationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorAuthorisationRequest6 AuthorisationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorAuthorisationRequest6 AuthorisationRequest { get; init; } 
    #else
    public AcceptorAuthorisationRequest6 AuthorisationRequest { get; set; } 
    #endif
...
// Since AcceptorAuthorisationRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorAuthorisationRequestV06.
