...
public partial record AcceptorCurrencyConversionRequestV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionRequestV05( Header35 reqHeader,AcceptorCurrencyConversionRequest5 reqCurrencyConversionRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorCurrencyConversionRequest5 CurrencyConversionRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCurrencyConversionRequest5 CurrencyConversionRequest { get; init; } 
    #else
    public AcceptorCurrencyConversionRequest5 CurrencyConversionRequest { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionRequestV05.
