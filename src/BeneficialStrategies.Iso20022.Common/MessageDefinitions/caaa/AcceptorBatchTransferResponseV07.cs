...
public partial record AcceptorBatchTransferResponseV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorBatchTransferResponseV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorBatchTransferResponseV07( Header25 reqHeader,CardPaymentBatchTransferResponse6 reqBatchTransferResponse )
    {
        Header = reqHeader;
    ...
    public required CardPaymentBatchTransferResponse6 BatchTransferResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentBatchTransferResponse6 BatchTransferResponse { get; init; } 
    #else
    public CardPaymentBatchTransferResponse6 BatchTransferResponse { get; set; } 
    #endif
...
// Since AcceptorBatchTransferResponseV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorBatchTransferResponseV07.
