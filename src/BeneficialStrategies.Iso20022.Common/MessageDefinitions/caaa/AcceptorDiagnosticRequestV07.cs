...
/// <summary>
/// This record is an implementation of the caaa.013.001.07 ISO standard message type.
...
public partial record AcceptorDiagnosticRequestV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.013.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorDiagnosticRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorDiagnosticRequestV07( Header35 reqHeader,AcceptorDiagnosticRequest7 reqDiagnosticRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorDiagnosticRequest7 DiagnosticRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorDiagnosticRequest7 DiagnosticRequest { get; init; } 
    #else
    public AcceptorDiagnosticRequest7 DiagnosticRequest { get; set; } 
    #endif
...
// Since AcceptorDiagnosticRequestV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorDiagnosticRequestV07.
