...
/// <summary>
/// This record is an implementation of the caaa.006.001.11 ISO standard message type.
...
public partial record AcceptorCancellationResponseV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.006.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationResponseV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationResponseV11( Header70 reqHeader,AcceptorCancellationResponse11 reqCancellationResponse )
    {
        Header = reqHeader;
    ...
    [IsoXmlTag("CxlRspn")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AcceptorCancellationResponse11 CancellationResponse { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AcceptorCancellationResponse11 CancellationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationResponse11 CancellationResponse { get; init; } 
    #else
    public AcceptorCancellationResponse11 CancellationResponse { get; set; } 
    #endif
...
// Since AcceptorCancellationResponseV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationResponseV11.
