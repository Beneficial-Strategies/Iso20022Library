...
public partial record AcceptorBatchTransferResponseV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorBatchTransferResponseV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorBatchTransferResponseV10( Header56 reqHeader,CardPaymentBatchTransferResponse9 reqBatchTransferResponse )
    {
        Header = reqHeader;
    ...
    public required CardPaymentBatchTransferResponse9 BatchTransferResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentBatchTransferResponse9 BatchTransferResponse { get; init; } 
    #else
    public CardPaymentBatchTransferResponse9 BatchTransferResponse { get; set; } 
    #endif
...
// Since AcceptorBatchTransferResponseV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorBatchTransferResponseV10.
