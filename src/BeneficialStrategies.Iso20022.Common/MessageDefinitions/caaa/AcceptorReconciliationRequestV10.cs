...
/// <summary>
/// This record is an implementation of the caaa.009.001.10 ISO standard message type.
...
public partial record AcceptorReconciliationRequestV10 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.009.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequestV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequestV10( Header59 reqHeader,AcceptorReconciliationRequest10 reqReconciliationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorReconciliationRequest10 ReconciliationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorReconciliationRequest10 ReconciliationRequest { get; init; } 
    #else
    public AcceptorReconciliationRequest10 ReconciliationRequest { get; set; } 
    #endif
...
// Since AcceptorReconciliationRequestV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorReconciliationRequestV10.
