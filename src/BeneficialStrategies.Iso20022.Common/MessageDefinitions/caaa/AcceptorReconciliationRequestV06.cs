...
[DataContract]
#endif
public partial record AcceptorReconciliationRequestV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequestV06( Header30 reqHeader,AcceptorReconciliationRequest6 reqReconciliationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorReconciliationRequest6 ReconciliationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorReconciliationRequest6 ReconciliationRequest { get; init; } 
    #else
    public AcceptorReconciliationRequest6 ReconciliationRequest { get; set; } 
    #endif
...
// Since AcceptorReconciliationRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorReconciliationRequestV06.
