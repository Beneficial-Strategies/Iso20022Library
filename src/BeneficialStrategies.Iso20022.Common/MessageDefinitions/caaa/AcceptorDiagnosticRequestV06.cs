...
[DataContract]
#endif
public partial record AcceptorDiagnosticRequestV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorDiagnosticRequestV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorDiagnosticRequestV06( Header30 reqHeader,AcceptorDiagnosticRequest6 reqDiagnosticRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorDiagnosticRequest6 DiagnosticRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorDiagnosticRequest6 DiagnosticRequest { get; init; } 
    #else
    public AcceptorDiagnosticRequest6 DiagnosticRequest { get; set; } 
    #endif
...
// Since AcceptorDiagnosticRequestV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorDiagnosticRequestV06.
