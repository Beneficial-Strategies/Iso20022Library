...
/// <summary>
/// This record is an implementation of the casp.008.001.03 ISO standard message type.
...
public partial record SaleToPOIAdministrativeResponseV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "casp.008.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIAdministrativeResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIAdministrativeResponseV03( Header41 reqHeader,AdministrativeResponse4 reqAdministrativeResponse )
    {
        Header = reqHeader;
    ...
    public required AdministrativeResponse4 AdministrativeResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AdministrativeResponse4 AdministrativeResponse { get; init; } 
    #else
    public AdministrativeResponse4 AdministrativeResponse { get; set; } 
    #endif
...
// Since SaleToPOIAdministrativeResponseV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIAdministrativeResponseV03.
