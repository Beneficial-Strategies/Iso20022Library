...
public partial record SaleToPOIAbortV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIAbortV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIAbortV05( Header41 reqHeader,SystemAbort6 reqAbort )
    {
        Header = reqHeader;
        Abort = reqAbort;
    }
    ...
    public required SystemAbort6 Abort { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SystemAbort6 Abort { get; init; } 
    #else
    public SystemAbort6 Abort { get; set; } 
    #endif
...
// Since SaleToPOIAbortV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIAbortV05.
