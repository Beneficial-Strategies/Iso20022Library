...
/// <summary>
/// This record is an implementation of the casp.008.001.01 ISO standard message type.
...
public record SaleToPOIAdministrativeResponseV01 : IOuterRecord
{
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "casp.008.001.01";
...
// Since SaleToPOIAdministrativeResponseV01Document is not really part of the logical business domain model,
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIAdministrativeResponseV01.
