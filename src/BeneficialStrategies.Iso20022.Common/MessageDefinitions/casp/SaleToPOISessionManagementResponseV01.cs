...
public partial record SaleToPOISessionManagementResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOISessionManagementResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOISessionManagementResponseV01( Header37 reqHeader,SessionManagementResponse2 reqSessionManagementResponse )
    {
        Header = reqHeader;
    ...
    public required SessionManagementResponse2 SessionManagementResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SessionManagementResponse2 SessionManagementResponse { get; init; } 
    #else
    public SessionManagementResponse2 SessionManagementResponse { get; set; } 
    #endif
