...
public partial record SaleToPOIAbortV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIAbortV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIAbortV04( Header41 reqHeader,SystemAbort5 reqAbort )
    {
        Header = reqHeader;
        Abort = reqAbort;
    }
    ...
    public required SystemAbort5 Abort { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SystemAbort5 Abort { get; init; } 
    #else
    public SystemAbort5 Abort { get; set; } 
    #endif
