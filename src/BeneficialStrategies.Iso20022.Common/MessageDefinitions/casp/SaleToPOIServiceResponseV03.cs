...
public partial record SaleToPOIServiceResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOIServiceResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOIServiceResponseV03( Header41 reqHeader,ServiceResponse5 reqServiceResponse )
    {
        Header = reqHeader;
    ...
    public required ServiceResponse5 ServiceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ServiceResponse5 ServiceResponse { get; init; } 
    #else
    public ServiceResponse5 ServiceResponse { get; set; } 
    #endif
...
// Since SaleToPOIServiceResponseV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOIServiceResponseV03.
