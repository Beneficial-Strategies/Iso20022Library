...
public partial record SaleToPOISessionManagementRequestV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SaleToPOISessionManagementRequestV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SaleToPOISessionManagementRequestV01( Header37 reqHeader,SessionManagementRequest2 reqSessionManagementRequest )
    {
        Header = reqHeader;
    ...
    public required SessionManagementRequest2 SessionManagementRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SessionManagementRequest2 SessionManagementRequest { get; init; } 
    #else
    public SessionManagementRequest2 SessionManagementRequest { get; set; } 
    #endif
...
// Since SaleToPOISessionManagementRequestV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SaleToPOISessionManagementRequestV01.
