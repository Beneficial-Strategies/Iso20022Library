...
/// <summary>
/// This record is an implementation of the cafc.001.001.01 ISO standard message type.
...
public partial record FeeCollectionInitiationV01 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "cafc.001.001.01";
    ...
    #else
    /// <summary>
    /// Constructs a FeeCollectionInitiationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FeeCollectionInitiationV01( Header48 reqHeader,FeeCollectionInitiation1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    #else
    public FeeCollectionInitiation1 Body { get; set; } 
    #endif
...
// Since FeeCollectionInitiationV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FeeCollectionInitiationV01.
