...
[DataContract]
[Serializable]
[IsoId("_YWZBNtp-Ed-ak6NoX_4Aeg_-1295138508")]
...
[JsonConverter(typeof(Iso20022SimpleValueJsonConverter<BICFIIdentifier>))]
public readonly struct BICFIIdentifier : IIsoSimpleValue<string>, IEquatable<BICFIIdentifier>
{
    ...
    public BICFIIdentifier(string value)
    {
        ...
        if (!Regex.IsMatch(value, Pattern))
            throw new Iso20022FormatException(typeof(BICFIIdentifier), value, Pattern);
        Value = value;
    }

    /// <summary>Returns <see langword="true"/> when <paramref name="value"/> satisfies <see cref="Pattern"/>.</summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out BICFIIdentifier result)
    {
    ...
    /// <summary>Implicitly wraps a string as a <see cref="BICFIIdentifier"/>.</summary>
    public static implicit operator BICFIIdentifier(string value) => new(value);
    /// <summary>Implicitly unwraps to the underlying string.</summary>
    public static implicit operator string(BICFIIdentifier id) => id.Value;

    /// <inheritdoc/>
    public override string ToString() => Value ?? string.Empty;
    /// <inheritdoc/>
    public bool Equals(BICFIIdentifier other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is BICFIIdentifier other && Equals(other);
    /// <inheritdoc/>
