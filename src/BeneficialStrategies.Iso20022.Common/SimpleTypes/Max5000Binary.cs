...
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max5000Binary>))]
public readonly struct Max5000Binary : IIsoSimpleValue<byte[]>, IEquatable<Max5000Binary>
{
    ...
    /// </exception>
    public Max5000Binary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max5000Binary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max5000Binary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max5000Binary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max5000Binary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max5000Binary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max5000Binary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max5000Binary"/>.</summary>
    public static implicit operator Max5000Binary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max5000Binary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max5000Binary"/>.</summary>
    public static implicit operator Max5000Binary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max5000Binary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max5000Binary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max5000Binary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max5000Binary a, Max5000Binary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max5000Binary a, Max5000Binary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max5000Binary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max5000Binary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max5000Binary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max5000Binary b) => a != b.ToString();
}
