...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>LongDecimalNumber</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
/// totalDigits (22) and fractionDigits (11) are independent maximums,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=22, fractionDigits=11).
/// </remarks>
[DataContract]
[Serializable]
[IsoId("_ZExq03cPEeGgn5GmpWx6yw")]
[Description(@"Number of objects represented as a decimal number, eg, 0.75 or 45.6.")]
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<LongDecimalNumber, decimal>))]
public readonly struct LongDecimalNumber : IIsoSimpleValue<decimal>, IEquatable<LongDecimalNumber>
{
    ...
    public const int FractionDigits = 11;
    ...
    public LongDecimalNumber(decimal value)
    {

        var scale = GetScale(value);
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(LongDecimalNumber), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(LongDecimalNumber), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public LongDecimalNumber(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(LongDecimalNumber), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out LongDecimalNumber result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out LongDecimalNumber result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="LongDecimalNumber"/>.</summary>
    public static implicit operator LongDecimalNumber(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(LongDecimalNumber v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="LongDecimalNumber"/>.</summary>
    public static implicit operator LongDecimalNumber(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(LongDecimalNumber v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(LongDecimalNumber other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is LongDecimalNumber other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(LongDecimalNumber a, LongDecimalNumber b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(LongDecimalNumber a, LongDecimalNumber b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(LongDecimalNumber a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(LongDecimalNumber a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, LongDecimalNumber b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, LongDecimalNumber b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(LongDecimalNumber a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(LongDecimalNumber a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, LongDecimalNumber b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, LongDecimalNumber b) => a != b.ToString();
}
