...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>DecimalNumberFraction5</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=18, fractionDigits=5. registrationStatus=Obsolete, removalDate=2020-02-01). Marked obsolete in the ISO 20022 specification.
/// </remarks>
[DataContract]
[Serializable]
[IsoId("_VerqkWk5EeaLAKoEUNsD9g")]
...
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<DecimalNumberFraction5, decimal>))]
public readonly struct DecimalNumberFraction5 : IIsoSimpleValue<decimal>, IEquatable<DecimalNumberFraction5>
{
    ...
    public DecimalNumberFraction5(decimal value)
    {

        var scale = GetScale(value);
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(DecimalNumberFraction5), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(DecimalNumberFraction5), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public DecimalNumberFraction5(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(DecimalNumberFraction5), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out DecimalNumberFraction5 result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out DecimalNumberFraction5 result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="DecimalNumberFraction5"/>.</summary>
    public static implicit operator DecimalNumberFraction5(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(DecimalNumberFraction5 v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="DecimalNumberFraction5"/>.</summary>
    public static implicit operator DecimalNumberFraction5(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(DecimalNumberFraction5 v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(DecimalNumberFraction5 other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is DecimalNumberFraction5 other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(DecimalNumberFraction5 a, DecimalNumberFraction5 b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumberFraction5 a, DecimalNumberFraction5 b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(DecimalNumberFraction5 a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumberFraction5 a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, DecimalNumberFraction5 b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, DecimalNumberFraction5 b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(DecimalNumberFraction5 a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumberFraction5 a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, DecimalNumberFraction5 b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, DecimalNumberFraction5 b) => a != b.ToString();
}
