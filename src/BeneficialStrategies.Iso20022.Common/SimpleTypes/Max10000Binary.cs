...
[DataContract]
[Serializable]
[IsoId("_TQbTwQEcEeCQm6a_G2yO_w_1563706338")]
[Description(@"Specifies a binary string with a maximum length of 10000 binary bytes.")]
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max10000Binary>))]
public readonly struct Max10000Binary : IIsoSimpleValue<byte[]>, IEquatable<Max10000Binary>
{
    ...
    /// </exception>
    public Max10000Binary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max10000Binary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max10000Binary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max10000Binary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max10000Binary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max10000Binary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max10000Binary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max10000Binary"/>.</summary>
    public static implicit operator Max10000Binary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max10000Binary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max10000Binary"/>.</summary>
    public static implicit operator Max10000Binary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max10000Binary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max10000Binary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max10000Binary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max10000Binary a, Max10000Binary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max10000Binary a, Max10000Binary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max10000Binary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max10000Binary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max10000Binary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max10000Binary b) => a != b.ToString();
}
