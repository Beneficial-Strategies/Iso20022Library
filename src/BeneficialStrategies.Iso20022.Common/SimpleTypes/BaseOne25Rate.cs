...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>BaseOne25Rate</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
/// totalDigits (25) and fractionDigits (13) are independent maximums,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=25, fractionDigits=13. baseValue=1.0).
/// </remarks>
[DataContract]
[Serializable]
[IsoId("_TUM5EEzcEey52P6g9uU9kQ")]
[Description(@"Rate expressed as a decimal, for example, 0.7 is 7/10 and 70% with 13 fractional digits maximum and 25 total digits. May contain values larger than 1.")]
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<BaseOne25Rate, decimal>))]
public readonly struct BaseOne25Rate : IIsoSimpleValue<decimal>, IEquatable<BaseOne25Rate>
{
    ...
    public BaseOne25Rate(decimal value)
    {

        var scale = GetScale(value);
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(BaseOne25Rate), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(BaseOne25Rate), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public BaseOne25Rate(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(BaseOne25Rate), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out BaseOne25Rate result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out BaseOne25Rate result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="BaseOne25Rate"/>.</summary>
    public static implicit operator BaseOne25Rate(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(BaseOne25Rate v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="BaseOne25Rate"/>.</summary>
    public static implicit operator BaseOne25Rate(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(BaseOne25Rate v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(BaseOne25Rate other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is BaseOne25Rate other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(BaseOne25Rate a, BaseOne25Rate b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(BaseOne25Rate a, BaseOne25Rate b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(BaseOne25Rate a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(BaseOne25Rate a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, BaseOne25Rate b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, BaseOne25Rate b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(BaseOne25Rate a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(BaseOne25Rate a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, BaseOne25Rate b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, BaseOne25Rate b) => a != b.ToString();
}
