...
[DataContract]
[Serializable]
[IsoId("_iAksQRJZEeWg-NN-FmovgQ")]
[Description(@"Binary data of 2K maximum.")]
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max2KBinary>))]
public readonly struct Max2KBinary : IIsoSimpleValue<byte[]>, IEquatable<Max2KBinary>
{
    ...
    /// </exception>
    public Max2KBinary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max2KBinary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max2KBinary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max2KBinary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max2KBinary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max2KBinary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max2KBinary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max2KBinary"/>.</summary>
    public static implicit operator Max2KBinary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max2KBinary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max2KBinary"/>.</summary>
    public static implicit operator Max2KBinary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max2KBinary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max2KBinary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max2KBinary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max2KBinary a, Max2KBinary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max2KBinary a, Max2KBinary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max2KBinary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max2KBinary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max2KBinary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max2KBinary b) => a != b.ToString();
}
