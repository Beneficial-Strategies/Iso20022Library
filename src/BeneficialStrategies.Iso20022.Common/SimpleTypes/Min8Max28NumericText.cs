...
[JsonConverter(typeof(Iso20022SimpleValueJsonConverter<Min8Max28NumericText>))]
public readonly struct Min8Max28NumericText : IIsoSimpleValue<string>, IEquatable<Min8Max28NumericText>
{
    ...
    public Min8Max28NumericText(string value)
    {
        ...
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Min8Max28NumericText), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Min8Max28NumericText), value, MaxLength);
        foreach (var c in value)
            if (c < '0' || c > '9')
                throw Iso20022FormatException.ForInvalidCharacter(typeof(Min8Max28NumericText), value, "0-9");
        Value = value;
    }

    /// <summary>Returns <see langword="true"/> when <paramref name="value"/> satisfies all constraints.</summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Min8Max28NumericText result)
    {
    ...
    /// <summary>Implicitly wraps a string as a <see cref="Min8Max28NumericText"/>.</summary>
    public static implicit operator Min8Max28NumericText(string value) => new(value);
    /// <summary>Implicitly unwraps to the underlying string.</summary>
    public static implicit operator string(Min8Max28NumericText text) => text.Value;

    /// <inheritdoc/>
    public override string ToString() => Value ?? string.Empty;
    /// <inheritdoc/>
    public bool Equals(Min8Max28NumericText other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Min8Max28NumericText other && Equals(other);
    /// <inheritdoc/>
