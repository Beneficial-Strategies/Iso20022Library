...
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max35Binary>))]
public readonly struct Max35Binary : IIsoSimpleValue<byte[]>, IEquatable<Max35Binary>
{
    ...
    /// </exception>
    public Max35Binary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max35Binary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max35Binary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max35Binary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max35Binary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max35Binary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max35Binary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max35Binary"/>.</summary>
    public static implicit operator Max35Binary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max35Binary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max35Binary"/>.</summary>
    public static implicit operator Max35Binary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max35Binary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max35Binary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max35Binary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max35Binary a, Max35Binary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max35Binary a, Max35Binary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max35Binary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max35Binary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max35Binary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max35Binary b) => a != b.ToString();
}
