...
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max100KBinary>))]
public readonly struct Max100KBinary : IIsoSimpleValue<byte[]>, IEquatable<Max100KBinary>
{
    ...
    /// </exception>
    public Max100KBinary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max100KBinary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max100KBinary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max100KBinary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max100KBinary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max100KBinary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max100KBinary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max100KBinary"/>.</summary>
    public static implicit operator Max100KBinary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max100KBinary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max100KBinary"/>.</summary>
    public static implicit operator Max100KBinary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max100KBinary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max100KBinary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max100KBinary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max100KBinary a, Max100KBinary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max100KBinary a, Max100KBinary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max100KBinary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max100KBinary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max100KBinary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max100KBinary b) => a != b.ToString();
}
