...
[DataContract]
[Serializable]
[IsoId("_YWr8Jdp-Ed-ak6NoX_4Aeg_-1676525626")]
[Description(@"Specifies a character string with a maximum length of 8000 characters.")]
[JsonConverter(typeof(Iso20022SimpleValueJsonConverter<Max8000Text>))]
public readonly struct Max8000Text : IIsoSimpleValue<string>, IEquatable<Max8000Text>
{
    ...
    /// </exception>
    public Max8000Text(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max8000Text), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max8000Text), value, MaxLength);
        Value = value;
    }
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max8000Text result)
    {
    ...
    /// <summary>Implicitly wraps a string as a <see cref="Max8000Text"/>.</summary>
    public static implicit operator Max8000Text(string value) => new(value);
    /// <summary>Implicitly unwraps to the underlying string.</summary>
    public static implicit operator string(Max8000Text text) => text.Value;

    /// <inheritdoc/>
    public override string ToString() => Value ?? string.Empty;
    /// <inheritdoc/>
    public bool Equals(Max8000Text other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max8000Text other && Equals(other);
    /// <inheritdoc/>
