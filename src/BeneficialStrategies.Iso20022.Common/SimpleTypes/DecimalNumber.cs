...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>DecimalNumber</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=18, fractionDigits=17).
/// </remarks>
[DataContract]
[Serializable]
...
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<DecimalNumber, decimal>))]
public readonly struct DecimalNumber : IIsoSimpleValue<decimal>, IEquatable<DecimalNumber>
{
    ...
    public DecimalNumber(decimal value)
    {
        ...
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(DecimalNumber), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(DecimalNumber), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public DecimalNumber(string value)
    {
        ...
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(DecimalNumber), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out DecimalNumber result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out DecimalNumber result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="DecimalNumber"/>.</summary>
    public static implicit operator DecimalNumber(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(DecimalNumber v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="DecimalNumber"/>.</summary>
    public static implicit operator DecimalNumber(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(DecimalNumber v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(DecimalNumber other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is DecimalNumber other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(DecimalNumber a, DecimalNumber b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumber a, DecimalNumber b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(DecimalNumber a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumber a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, DecimalNumber b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, DecimalNumber b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(DecimalNumber a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(DecimalNumber a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, DecimalNumber b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, DecimalNumber b) => a != b.ToString();
}
