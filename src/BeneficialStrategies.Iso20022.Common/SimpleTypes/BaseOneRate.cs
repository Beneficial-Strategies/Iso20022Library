...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>BaseOneRate</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=11, fractionDigits=10. baseValue=1.0).
/// </remarks>
[DataContract]
[Serializable]
[IsoId("_YXbjAdp-Ed-ak6NoX_4Aeg_1236114363")]
[Description(@"Rate expressed as a decimal, for example, 0.7 is 7/10 and 70%.")]
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<BaseOneRate, decimal>))]
public readonly struct BaseOneRate : IIsoSimpleValue<decimal>, IEquatable<BaseOneRate>
{
    ...
    public BaseOneRate(decimal value)
    {

        var scale = GetScale(value);
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(BaseOneRate), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(BaseOneRate), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public BaseOneRate(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(BaseOneRate), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out BaseOneRate result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out BaseOneRate result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="BaseOneRate"/>.</summary>
    public static implicit operator BaseOneRate(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(BaseOneRate v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="BaseOneRate"/>.</summary>
    public static implicit operator BaseOneRate(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(BaseOneRate v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(BaseOneRate other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is BaseOneRate other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(BaseOneRate a, BaseOneRate b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(BaseOneRate a, BaseOneRate b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(BaseOneRate a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(BaseOneRate a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, BaseOneRate b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, BaseOneRate b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(BaseOneRate a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(BaseOneRate a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, BaseOneRate b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, BaseOneRate b) => a != b.ToString();
}
