...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>Max10NumberFraction2</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
/// totalDigits (10) and fractionDigits (2) are independent maximums,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=10, fractionDigits=2).
/// </remarks>
[DataContract]
[Serializable]
[IsoId("_WNPjwf2mEeiS2rs-hXBB5Q")]
[Description(@"Number of objects represented as a decimal number, for example, 0.75 or 45.6.")]
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<Max10NumberFraction2, decimal>))]
public readonly struct Max10NumberFraction2 : IIsoSimpleValue<decimal>, IEquatable<Max10NumberFraction2>
{
    ...
    public Max10NumberFraction2(decimal value)
    {

        var scale = GetScale(value);
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(Max10NumberFraction2), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(Max10NumberFraction2), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public Max10NumberFraction2(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(Max10NumberFraction2), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out Max10NumberFraction2 result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max10NumberFraction2 result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="Max10NumberFraction2"/>.</summary>
    public static implicit operator Max10NumberFraction2(decimal value) => new(value);
    /// <summary>Implicitly unwraps to the native <see cref="decimal"/> value.</summary>
    public static implicit operator decimal(Max10NumberFraction2 v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="Max10NumberFraction2"/>.</summary>
    public static implicit operator Max10NumberFraction2(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(Max10NumberFraction2 v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(Max10NumberFraction2 other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max10NumberFraction2 other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => Value.GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max10NumberFraction2 a, Max10NumberFraction2 b) => a.Value == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(Max10NumberFraction2 a, Max10NumberFraction2 b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(Max10NumberFraction2 a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(Max10NumberFraction2 a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, Max10NumberFraction2 b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, Max10NumberFraction2 b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(Max10NumberFraction2 a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max10NumberFraction2 a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max10NumberFraction2 b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max10NumberFraction2 b) => a != b.ToString();
}
