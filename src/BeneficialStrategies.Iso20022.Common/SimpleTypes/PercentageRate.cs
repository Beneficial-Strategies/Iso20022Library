...
/// </summary>
/// <remarks>
/// ISO 20022 Rate/Quantity data type <c>PercentageRate</c>. Signed (no minInclusive facet); bounded by the totalDigits/fractionDigits facets below. Per XSD facet semantics,
...
/// (source: ISO 20022 MCP facets — no minInclusive facet (signed), totalDigits=11, fractionDigits=10. baseValue=100.0).
/// </remarks>
[DataContract]
[Serializable]
...
[JsonConverter(typeof(Iso20022NumericValueJsonConverter<PercentageRate, decimal>))]
public readonly struct PercentageRate : IIsoSimpleValue<decimal>, IEquatable<PercentageRate>
{
    ...
    public PercentageRate(decimal value)
    {
        ...
        if (scale > FractionDigits)
            throw new Iso20022FormatException(typeof(PercentageRate), value.ToString(CultureInfo.InvariantCulture), $"at most {FractionDigits} fraction digits");
        if (CountIntegerDigits(value) + scale > TotalDigits)
            throw new Iso20022FormatException(typeof(PercentageRate), value.ToString(CultureInfo.InvariantCulture), $"at most {TotalDigits} significant digits total");
        Value = value;
    }
    ...
    public PercentageRate(string value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (!decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture, out var parsed))
            throw new Iso20022FormatException(typeof(PercentageRate), value, "decimal string");
        this = new(parsed);
    }
    ...
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out PercentageRate result)
    {
        try
    ...
    public static bool TryCreate(string? value, [NotNullWhen(true)] out PercentageRate result)
    {
    ...
    /// <summary>Implicitly wraps a <see cref="decimal"/> as a <see cref="PercentageRate"/>.</summary>
    ...
    public static implicit operator decimal(PercentageRate v) => v.Value;
    /// <summary>Implicitly wraps a wire string as a <see cref="PercentageRate"/>.</summary>
    public static implicit operator PercentageRate(string value) => new(value);
    /// <summary>Implicitly unwraps to the wire string representation.</summary>
    public static implicit operator string(PercentageRate v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value.ToString(CultureInfo.InvariantCulture);
    /// <inheritdoc/>
    public bool Equals(PercentageRate other) => Value == other.Value;
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is PercentageRate other && Equals(other);
    /// <inheritdoc/>
    ...
    public static bool operator !=(PercentageRate a, PercentageRate b) => a.Value != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(PercentageRate a, decimal b) => a.Value == b;
    /// <inheritdoc/>
    public static bool operator !=(PercentageRate a, decimal b) => a.Value != b;
    /// <inheritdoc/>
    public static bool operator ==(decimal a, PercentageRate b) => a == b.Value;
    /// <inheritdoc/>
    public static bool operator !=(decimal a, PercentageRate b) => a != b.Value;
    /// <inheritdoc/>
    public static bool operator ==(PercentageRate a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(PercentageRate a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, PercentageRate b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, PercentageRate b) => a != b.ToString();
}
