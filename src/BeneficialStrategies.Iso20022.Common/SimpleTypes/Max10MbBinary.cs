...
[Description(@"Binary data of 10 megabytes (10 Mb) maximum.")]
[JsonConverter(typeof(Iso20022BinaryValueJsonConverter<Max10MbBinary>))]
public readonly struct Max10MbBinary : IIsoSimpleValue<byte[]>, IEquatable<Max10MbBinary>
{
    ...
    public const int MaxLength = 10485760;
    ...
    /// </exception>
    public Max10MbBinary(byte[] value)
    {
        ArgumentNullException.ThrowIfNull(value);
        if (value.Length < MinLength)
            throw Iso20022FormatException.ForTooShort(typeof(Max10MbBinary), value, MinLength);
        if (value.Length > MaxLength)
            throw Iso20022FormatException.ForTooLong(typeof(Max10MbBinary), value, MaxLength);
        Value = value;
    }
    ...
    /// </exception>
    public Max10MbBinary(string value) : this(DecodeBase64(value)) { }
    ...
    private static byte[] DecodeBase64(string value)
    {
        ...
        {
            throw new Iso20022FormatException(typeof(Max10MbBinary), value, "a valid base64-encoded string", ex);
        }
    }
    ...
    /// </summary>
    public static bool TryCreate(byte[]? value, [NotNullWhen(true)] out Max10MbBinary result)
    {
    ...
    /// </summary>
    public static bool TryCreate(string? value, [NotNullWhen(true)] out Max10MbBinary result)
    {
    ...
    /// <summary>Implicitly wraps raw binary data as a <see cref="Max10MbBinary"/>.</summary>
    public static implicit operator Max10MbBinary(byte[] value) => new(value);
    /// <summary>Implicitly unwraps to the raw binary data.</summary>
    public static implicit operator byte[](Max10MbBinary v) => v.Value;
    /// <summary>Implicitly wraps a base64 wire string as a <see cref="Max10MbBinary"/>.</summary>
    public static implicit operator Max10MbBinary(string value) => new(value);
    /// <summary>Implicitly unwraps to the base64 wire string representation.</summary>
    public static implicit operator string(Max10MbBinary v) => v.ToString();

    /// <inheritdoc/>
    public override string ToString() => Value is null ? string.Empty : Convert.ToBase64String(Value);
    /// <inheritdoc/>
    public bool Equals(Max10MbBinary other) =>
        Value is null ? other.Value is null
        : other.Value is not null && Value.AsSpan().SequenceEqual(other.Value);
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Max10MbBinary other && Equals(other);
    /// <inheritdoc/>
    public override int GetHashCode() => ToString().GetHashCode();

    /// <inheritdoc/>
    public static bool operator ==(Max10MbBinary a, Max10MbBinary b) => a.Equals(b);
    /// <inheritdoc/>
    public static bool operator !=(Max10MbBinary a, Max10MbBinary b) => !a.Equals(b);
    /// <inheritdoc/>
    public static bool operator ==(Max10MbBinary a, string? b) => a.ToString() == b;
    /// <inheritdoc/>
    public static bool operator !=(Max10MbBinary a, string? b) => a.ToString() != b;
    /// <inheritdoc/>
    public static bool operator ==(string? a, Max10MbBinary b) => a == b.ToString();
    /// <inheritdoc/>
    public static bool operator !=(string? a, Max10MbBinary b) => a != b.ToString();
}
