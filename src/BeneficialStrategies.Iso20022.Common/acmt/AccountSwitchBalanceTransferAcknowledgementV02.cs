...
public partial record AccountSwitchBalanceTransferAcknowledgementV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSwitchBalanceTransferAcknowledgementV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSwitchBalanceTransferAcknowledgementV02( MessageIdentification1 reqMessageIdentification,AccountSwitchDetails1 reqAccountSwitchDetails,CashAccount39 reqOldAccount,AmountAndDirection5 reqOldAccountBalance )
    {
