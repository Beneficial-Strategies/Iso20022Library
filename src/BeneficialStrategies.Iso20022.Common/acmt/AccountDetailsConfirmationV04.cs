...
public partial record AccountDetailsConfirmationV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountDetailsConfirmationV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountDetailsConfirmationV04( MessageIdentification1 reqMessageIdentification,AccountManagementConfirmation1 reqConfirmationDetails )
    {
    ...
    public InvestmentAccount38? InvestmentAccount { get; init; } 
    #else
    public InvestmentAccount38? InvestmentAccount { get; set; } 
    #endif
