...
public partial record AccountOpeningAmendmentRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountOpeningAmendmentRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountOpeningAmendmentRequestV02( References4 reqReferences,CustomerAccount4 reqAccount,BranchAndFinancialInstitutionIdentification5 reqAccountServicerIdentification,Organisation12 reqOrganisation )
    {
