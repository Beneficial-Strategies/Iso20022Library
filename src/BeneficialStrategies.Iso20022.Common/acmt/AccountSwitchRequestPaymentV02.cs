...
public partial record AccountSwitchRequestPaymentV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSwitchRequestPaymentV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSwitchRequestPaymentV02( MessageIdentification1 reqMessageIdentification,AccountSwitchDetails1 reqAccountSwitchDetails,CashAccount39 reqOldAccount,CreditTransferTransaction33 reqCreditInstruction )
    {
    ...
    public required CreditTransferTransaction33 CreditInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction33 CreditInstruction { get; init; } 
    #else
    public CreditTransferTransaction33 CreditInstruction { get; set; } 
    #endif
...
// Since AccountSwitchRequestPaymentV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AccountSwitchRequestPaymentV02.
