...
public partial record AccountSwitchTechnicalRejectionV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSwitchTechnicalRejectionV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSwitchTechnicalRejectionV01( MessageIdentification1 reqMessageIdentification,AccountSwitchDetails1 reqAccountSwitchDetails )
    {
