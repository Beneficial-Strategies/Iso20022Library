...
/// <summary>
/// This record is an implementation of the acmt.001.001.06 ISO standard message type.
...
public partial record AccountOpeningInstructionV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountOpeningInstructionV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountOpeningInstructionV06( MessageIdentification1 reqMessageIdentification,InvestmentAccountOpening2 reqInstructionDetails,InvestmentAccount49 reqInvestmentAccount,AccountParties13 reqAccountParties )
    {
    ...
    public required InvestmentAccountOpening2 InstructionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOpening2 InstructionDetails { get; init; } 
    #else
    public InvestmentAccountOpening2 InstructionDetails { get; set; } 
    #endif
    ...
    public required InvestmentAccount49 InvestmentAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccount49 InvestmentAccount { get; init; } 
    #else
    public InvestmentAccount49 InvestmentAccount { get; set; } 
    #endif
