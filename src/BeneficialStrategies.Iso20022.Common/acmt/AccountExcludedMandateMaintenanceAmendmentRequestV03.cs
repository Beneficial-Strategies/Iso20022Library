...
public partial record AccountExcludedMandateMaintenanceAmendmentRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountExcludedMandateMaintenanceAmendmentRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountExcludedMandateMaintenanceAmendmentRequestV03( References4 reqReferences,CustomerAccountModification1 reqAccount,BranchAndFinancialInstitutionIdentification6 reqAccountServicerIdentification,OrganisationModification2 reqOrganisation )
    {
...
// Since AccountExcludedMandateMaintenanceAmendmentRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AccountExcludedMandateMaintenanceAmendmentRequestV03.
