...
/// <summary>
/// This record is an implementation of the supl.001.001.06 ISO standard message type.
...
public partial record DTCCCANOCSDDataSD1V06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.001.001.06";
    ...
    public FinancialInstrumentAttributesSD11? UnderlyingSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributesSD11? UnderlyingSecurity { get; set; } 
    #endif
    ...
    public CorporateActionSD13? CorporateActionDetails { get; init; } 
    #else
    public CorporateActionSD13? CorporateActionDetails { get; set; } 
    #endif
    ...
    public SecuritiesOptionSD7? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOptionSD7? SecuritiesMovementDetails { get; set; } 
    #endif
    ...
    public CashOptionSD8? CashMovementDetails { get; init; } 
    #else
    public CashOptionSD8? CashMovementDetails { get; set; } 
    #endif
...
// Since DTCCCANOCSDDataSD1V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOCSDDataSD1V06.
