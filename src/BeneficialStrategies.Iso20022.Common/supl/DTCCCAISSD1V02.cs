...
/// <summary>
/// This record is an implementation of the supl.030.001.02 ISO standard message type.
...
public partial record DTCCCAISSD1V02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.030.001.02";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:supl.030.001.02";
...
// Since DTCCCAISSD1V02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAISSD1V02.
