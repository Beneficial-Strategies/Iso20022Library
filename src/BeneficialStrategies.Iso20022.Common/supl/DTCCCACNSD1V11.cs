...
/// <summary>
/// This record is an implementation of the supl.006.001.11 ISO standard message type.
...
public partial record DTCCCACNSD1V11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.006.001.11";
    ...
    public CorporateActionGeneralInformationSD48? GeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD48? GeneralInformation { get; set; } 
    #endif
...
// Since DTCCCACNSD1V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCACNSD1V11.
