...
public partial record DTCCCANOEligibleBalanceSD1V06 : IOuterRecord
{
    ...
    public AccountBalanceSD8? ReorganisationAccountBalance { get; init; } 
    #else
    public AccountBalanceSD8? ReorganisationAccountBalance { get; set; } 
    #endif
...
// Since DTCCCANOEligibleBalanceSD1V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOEligibleBalanceSD1V06.
