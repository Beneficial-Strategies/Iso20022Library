...
/// <summary>
/// This record is an implementation of the supl.009.001.07 ISO standard message type.
...
public partial record DTCCCAPASD1V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.009.001.07";
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionGeneralInformationSD39? CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformationSD39? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD39? CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since DTCCCAPASD1V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAPASD1V07.
