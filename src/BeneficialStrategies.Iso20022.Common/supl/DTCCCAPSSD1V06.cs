...
public partial record DTCCCAPSSD1V06 : IOuterRecord
{
    ...
    public CorporateActionGeneralInformationSD31? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD31? CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since DTCCCAPSSD1V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAPSSD1V06.
