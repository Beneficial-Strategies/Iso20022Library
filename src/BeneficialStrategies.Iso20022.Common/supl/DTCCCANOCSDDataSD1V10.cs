...
public partial record DTCCCANOCSDDataSD1V10 : IOuterRecord
{
    ...
    public CorporateActionGeneralInformationSD28? CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformationSD28? CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionDateSD8? CorporateActionDateDetails { get; init; } 
    #else
    public CorporateActionDateSD8? CorporateActionDateDetails { get; set; } 
    #endif
    ...
    public CorporateActionOptionSD11? OptionDetails { get; init; } 
    #else
    public CorporateActionOptionSD11? OptionDetails { get; set; } 
    #endif
    ...
    public CorporateActionDateSD9? OptionDateDetails { get; init; } 
    #else
    public CorporateActionDateSD9? OptionDateDetails { get; set; } 
    #endif
...
// Since DTCCCANOCSDDataSD1V10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOCSDDataSD1V10.
