...
/// <summary>
/// This record is an implementation of the supl.007.001.03 ISO standard message type.
...
public partial record DTCCCANOEligibleBalanceSD1V03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "supl.007.001.03";
    ...
    public AccountBalanceSD5? DistributionsAccountBalance { get; init; } 
    #else
    public AccountBalanceSD5? DistributionsAccountBalance { get; set; } 
    #endif
    ...
    public AccountBalanceSD6? RedemptionsAccountBalance { get; init; } 
    #else
    public AccountBalanceSD6? RedemptionsAccountBalance { get; set; } 
    #endif
...
// Since DTCCCANOEligibleBalanceSD1V03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOEligibleBalanceSD1V03.
