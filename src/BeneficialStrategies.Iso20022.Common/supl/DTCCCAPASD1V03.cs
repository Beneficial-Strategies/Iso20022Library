...
public partial record DTCCCAPASD1V03 : IOuterRecord
{
    ...
    public CorporateActionMovementSecuritiesMovementDetailsSD3? CorporateActionMovementSecuritiesMovementDetails { get; init; } 
    #else
    public CorporateActionMovementSecuritiesMovementDetailsSD3? CorporateActionMovementSecuritiesMovementDetails { get; set; } 
    #endif
...
// Since DTCCCAPASD1V03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCAPASD1V03.
