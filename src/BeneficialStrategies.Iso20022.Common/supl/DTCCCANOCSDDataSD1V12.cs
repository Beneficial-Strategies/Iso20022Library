...
/// <summary>
/// This record is an implementation of the supl.001.001.12 ISO standard message type.
...
[DataContract]
#endif
public partial record DTCCCANOCSDDataSD1V12 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "supl.001.001.12";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:supl.001.001.12";
    ...
    public CorporateActionSD17? CorporateActionDetails { get; init; } 
    #else
    public CorporateActionSD17? CorporateActionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information to be extended as supplementary data to corporate action date details.
    /// </summary>
    [IsoId("_x6QR2wB6EeqouY-yI_q3qQ")]
    ...
    [IsoXmlTag("OptnDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionOptionSD13? OptionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOptionSD13? OptionDetails { get; init; } 
    #else
    public CorporateActionOptionSD13? OptionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information to be extended as supplementary data to option date details.
    /// </summary>
    [IsoId("_x6QR5wB6EeqouY-yI_q3qQ")]
...
// Since DTCCCANOCSDDataSD1V12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to DTCCCANOCSDDataSD1V12.
