...
public partial record AcceptorCompletionAdviceV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCompletionAdviceV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCompletionAdviceV09( Header58 reqHeader,AcceptorCompletionAdvice9 reqCompletionAdvice )
    {
        Header = reqHeader;
    ...
    public required AcceptorCompletionAdvice9 CompletionAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCompletionAdvice9 CompletionAdvice { get; init; } 
    #else
    public AcceptorCompletionAdvice9 CompletionAdvice { get; set; } 
    #endif
