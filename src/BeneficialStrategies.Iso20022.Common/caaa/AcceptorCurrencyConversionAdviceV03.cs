...
public partial record AcceptorCurrencyConversionAdviceV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionAdviceV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionAdviceV03( Header36 reqHeader,AcceptorCurrencyConversionAdvice3 reqAcceptorCurrencyConversionAdvice )
    {
        Header = reqHeader;
    ...
    public required AcceptorCurrencyConversionAdvice3 AcceptorCurrencyConversionAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCurrencyConversionAdvice3 AcceptorCurrencyConversionAdvice { get; init; } 
    #else
    public AcceptorCurrencyConversionAdvice3 AcceptorCurrencyConversionAdvice { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionAdviceV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionAdviceV03.
