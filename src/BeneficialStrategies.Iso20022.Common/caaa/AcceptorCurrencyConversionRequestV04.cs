...
/// <summary>
/// This record is an implementation of the caaa.016.001.04 ISO standard message type.
...
public partial record AcceptorCurrencyConversionRequestV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.016.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionRequestV04( Header30 reqHeader,AcceptorCurrencyConversionRequest4 reqCurrencyConversionRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorCurrencyConversionRequest4 CurrencyConversionRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCurrencyConversionRequest4 CurrencyConversionRequest { get; init; } 
    #else
    public AcceptorCurrencyConversionRequest4 CurrencyConversionRequest { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionRequestV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionRequestV04.
