...
public partial record AcceptorBatchTransferResponseV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorBatchTransferResponseV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorBatchTransferResponseV09( Header56 reqHeader,CardPaymentBatchTransferResponse8 reqBatchTransferResponse )
    {
        Header = reqHeader;
    ...
    public required CardPaymentBatchTransferResponse8 BatchTransferResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentBatchTransferResponse8 BatchTransferResponse { get; init; } 
    #else
    public CardPaymentBatchTransferResponse8 BatchTransferResponse { get; set; } 
    #endif
