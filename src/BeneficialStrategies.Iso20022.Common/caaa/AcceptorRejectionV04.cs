...
public partial record AcceptorRejectionV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorRejectionV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorRejectionV04( Header13 reqHeader,AcceptorRejection2 reqReject )
    {
        Header = reqHeader;
        Reject = reqReject;
    }
    ...
    public Header13 Header { get; init; } 
    #else
    public Header13 Header { get; set; } 
    #endif
