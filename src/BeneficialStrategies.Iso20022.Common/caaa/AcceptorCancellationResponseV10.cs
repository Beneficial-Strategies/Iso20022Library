...
public partial record AcceptorCancellationResponseV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationResponseV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationResponseV10( Header59 reqHeader,AcceptorCancellationResponse10 reqCancellationResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationResponse10 CancellationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationResponse10 CancellationResponse { get; init; } 
    #else
    public AcceptorCancellationResponse10 CancellationResponse { get; set; } 
    #endif
...
// Since AcceptorCancellationResponseV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationResponseV10.
