...
public partial record AcceptorCancellationAdviceV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdviceV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdviceV08( Header36 reqHeader,AcceptorCancellationAdvice8 reqCancellationAdvice )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationAdvice8 CancellationAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdvice8 CancellationAdvice { get; init; } 
    #else
    public AcceptorCancellationAdvice8 CancellationAdvice { get; set; } 
    #endif
