...
public partial record AcceptorCurrencyConversionResponseV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionResponseV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionResponseV05( Header35 reqHeader,AcceptorCurrencyConversionResponse5 reqCurrencyConversionResponse )
    {
        Header = reqHeader;
    ...
    #else
    public AcceptorCurrencyConversionResponse5 CurrencyConversionResponse { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionResponseV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionResponseV05.
