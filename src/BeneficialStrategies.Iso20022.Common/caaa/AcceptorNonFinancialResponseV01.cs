...
public partial record AcceptorNonFinancialResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorNonFinancialResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorNonFinancialResponseV01( Header59 reqHeader,NonFinancialResponseComponent1 reqNonFinancialResponse )
    {
        Header = reqHeader;
    ...
    public required NonFinancialResponseComponent1 NonFinancialResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public NonFinancialResponseComponent1 NonFinancialResponse { get; init; } 
    #else
    public NonFinancialResponseComponent1 NonFinancialResponse { get; set; } 
    #endif
