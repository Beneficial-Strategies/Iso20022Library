...
public partial record AcceptorDiagnosticResponseV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorDiagnosticResponseV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorDiagnosticResponseV06( Header35 reqHeader,AcceptorDiagnosticResponse5 reqDiagnosticResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorDiagnosticResponse5 DiagnosticResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorDiagnosticResponse5 DiagnosticResponse { get; init; } 
    #else
    public AcceptorDiagnosticResponse5 DiagnosticResponse { get; set; } 
    #endif
