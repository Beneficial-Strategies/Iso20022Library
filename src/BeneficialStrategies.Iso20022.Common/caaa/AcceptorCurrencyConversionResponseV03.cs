...
public partial record AcceptorCurrencyConversionResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionResponseV03( Header30 reqHeader,AcceptorCurrencyConversionResponse3 reqCurrencyConversionResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCurrencyConversionResponse3 CurrencyConversionResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCurrencyConversionResponse3 CurrencyConversionResponse { get; init; } 
    #else
    public AcceptorCurrencyConversionResponse3 CurrencyConversionResponse { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionResponseV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionResponseV03.
