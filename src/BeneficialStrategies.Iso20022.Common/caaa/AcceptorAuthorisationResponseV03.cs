...
public partial record AcceptorAuthorisationResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorAuthorisationResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorAuthorisationResponseV03( Header7 reqHeader,AcceptorAuthorisationResponse3 reqAuthorisationResponse,ContentInformationType8 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    public required AcceptorAuthorisationResponse3 AuthorisationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorAuthorisationResponse3 AuthorisationResponse { get; init; } 
    #else
    public AcceptorAuthorisationResponse3 AuthorisationResponse { get; set; } 
    #endif
