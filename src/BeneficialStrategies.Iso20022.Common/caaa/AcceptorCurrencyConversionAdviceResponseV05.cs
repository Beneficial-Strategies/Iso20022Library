...
/// <summary>
/// This record is an implementation of the caaa.019.001.05 ISO standard message type.
...
public partial record AcceptorCurrencyConversionAdviceResponseV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.019.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionAdviceResponseV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionAdviceResponseV05( Header59 reqHeader,AcceptorCancellationAdviceResponse10 reqCurrencyConversionAdviceResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationAdviceResponse10 CurrencyConversionAdviceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdviceResponse10 CurrencyConversionAdviceResponse { get; init; } 
    #else
    public AcceptorCancellationAdviceResponse10 CurrencyConversionAdviceResponse { get; set; } 
    #endif
...
// Since AcceptorCurrencyConversionAdviceResponseV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCurrencyConversionAdviceResponseV05.
