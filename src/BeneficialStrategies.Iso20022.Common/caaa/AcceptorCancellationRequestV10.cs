...
public partial record AcceptorCancellationRequestV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationRequestV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationRequestV10( Header59 reqHeader,AcceptorCancellationRequest10 reqCancellationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationRequest10 CancellationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationRequest10 CancellationRequest { get; init; } 
    #else
    public AcceptorCancellationRequest10 CancellationRequest { get; set; } 
    #endif
...
// Since AcceptorCancellationRequestV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationRequestV10.
