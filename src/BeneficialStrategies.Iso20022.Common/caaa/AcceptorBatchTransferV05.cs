...
public partial record AcceptorBatchTransferV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorBatchTransferV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorBatchTransferV05( Header25 reqHeader,CardPaymentBatchTransfer4 reqBatchTransfer )
    {
        Header = reqHeader;
    ...
    public required CardPaymentBatchTransfer4 BatchTransfer { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentBatchTransfer4 BatchTransfer { get; init; } 
    #else
    public CardPaymentBatchTransfer4 BatchTransfer { get; set; } 
    #endif
...
// Since AcceptorBatchTransferV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorBatchTransferV05.
