...
/// <summary>
/// This record is an implementation of the caaa.005.001.04 ISO standard message type.
...
public partial record AcceptorCancellationRequestV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.005.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationRequestV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationRequestV04( Header10 reqHeader,AcceptorCancellationRequest4 reqCancellationRequest,ContentInformationType11 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationRequest4 CancellationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationRequest4 CancellationRequest { get; init; } 
    #else
    public AcceptorCancellationRequest4 CancellationRequest { get; set; } 
    #endif
...
// Since AcceptorCancellationRequestV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationRequestV04.
