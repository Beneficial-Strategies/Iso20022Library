...
public partial record AcceptorCancellationAdviceV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdviceV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdviceV11( Header59 reqHeader,AcceptorCancellationAdvice11 reqCancellationAdvice )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationAdvice11 CancellationAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdvice11 CancellationAdvice { get; init; } 
    #else
    public AcceptorCancellationAdvice11 CancellationAdvice { get; set; } 
    #endif
...
// Since AcceptorCancellationAdviceV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationAdviceV11.
