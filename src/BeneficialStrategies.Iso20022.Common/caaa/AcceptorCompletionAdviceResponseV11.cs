...
public partial record AcceptorCompletionAdviceResponseV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCompletionAdviceResponseV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCompletionAdviceResponseV11( Header70 reqHeader,AcceptorCompletionAdviceResponse11 reqCompletionAdviceResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCompletionAdviceResponse11 CompletionAdviceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCompletionAdviceResponse11 CompletionAdviceResponse { get; init; } 
    #else
    public AcceptorCompletionAdviceResponse11 CompletionAdviceResponse { get; set; } 
    #endif
...
// Since AcceptorCompletionAdviceResponseV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCompletionAdviceResponseV11.
