...
/// <summary>
/// This record is an implementation of the caaa.001.001.08 ISO standard message type.
...
public partial record AcceptorAuthorisationRequestV08 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.001.001.08";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorAuthorisationRequestV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorAuthorisationRequestV08( Header35 reqHeader,AcceptorAuthorisationRequest8 reqAuthorisationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorAuthorisationRequest8 AuthorisationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorAuthorisationRequest8 AuthorisationRequest { get; init; } 
    #else
    public AcceptorAuthorisationRequest8 AuthorisationRequest { get; set; } 
    #endif
...
// Since AcceptorAuthorisationRequestV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorAuthorisationRequestV08.
