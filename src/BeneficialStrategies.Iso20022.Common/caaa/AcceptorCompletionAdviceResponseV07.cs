...
/// <summary>
/// This record is an implementation of the caaa.004.001.07 ISO standard message type.
...
public partial record AcceptorCompletionAdviceResponseV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.004.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCompletionAdviceResponseV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCompletionAdviceResponseV07( Header36 reqHeader,AcceptorCompletionAdviceResponse7 reqCompletionAdviceResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCompletionAdviceResponse7 CompletionAdviceResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCompletionAdviceResponse7 CompletionAdviceResponse { get; init; } 
    #else
    public AcceptorCompletionAdviceResponse7 CompletionAdviceResponse { get; set; } 
    #endif
...
// Since AcceptorCompletionAdviceResponseV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCompletionAdviceResponseV07.
