...
/// <summary>
/// This record is an implementation of the caaa.007.001.04 ISO standard message type.
...
public partial record AcceptorCancellationAdviceV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "caaa.007.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdviceV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdviceV04( Header11 reqHeader,AcceptorCancellationAdvice4 reqCancellationAdvice,ContentInformationType11 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    [IsoXmlTag("CxlAdvc")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required AcceptorCancellationAdvice4 CancellationAdvice { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required AcceptorCancellationAdvice4 CancellationAdvice { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationAdvice4 CancellationAdvice { get; init; } 
    #else
    public AcceptorCancellationAdvice4 CancellationAdvice { get; set; } 
    #endif
    
    /// <summary>
    /// Trailer of the message containing a MAC.
    /// </summary>
    [IsoId("_UhKcGWl8EeSxgrJ0GX4SQQ")]
...
// Since AcceptorCancellationAdviceV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AcceptorCancellationAdviceV04.
