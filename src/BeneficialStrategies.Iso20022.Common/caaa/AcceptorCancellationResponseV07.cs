...
public partial record AcceptorCancellationResponseV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationResponseV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationResponseV07( Header35 reqHeader,AcceptorCancellationResponse7 reqCancellationResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationResponse7 CancellationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationResponse7 CancellationResponse { get; init; } 
    #else
    public AcceptorCancellationResponse7 CancellationResponse { get; set; } 
    #endif
