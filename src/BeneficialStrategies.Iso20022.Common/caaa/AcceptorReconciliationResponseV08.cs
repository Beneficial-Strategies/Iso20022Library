...
public partial record AcceptorReconciliationResponseV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationResponseV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationResponseV08( Header59 reqHeader,AcceptorReconciliationResponse7 reqReconciliationResponse )
    {
        Header = reqHeader;
    ...
    public required AcceptorReconciliationResponse7 ReconciliationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorReconciliationResponse7 ReconciliationResponse { get; init; } 
    #else
    public AcceptorReconciliationResponse7 ReconciliationResponse { get; set; } 
    #endif
