...
[DataContract]
#endif
public partial record AcceptorCancellationRequestV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationRequestV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationRequestV11( Header59 reqHeader,AcceptorCancellationRequest11 reqCancellationRequest )
    {
        Header = reqHeader;
    ...
    public required AcceptorCancellationRequest11 CancellationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcceptorCancellationRequest11 CancellationRequest { get; init; } 
    #else
    public AcceptorCancellationRequest11 CancellationRequest { get; set; } 
    #endif
