...
public partial record SecuritiesTransactionPostingReportV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV07( Pagination reqPagination,Statement44 reqStatementGeneralDetails,SecuritiesAccount24 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails25? FinancialInstrumentDetails { get; init; } 
    #else
    public FinancialInstrumentDetails25? FinancialInstrumentDetails { get; set; } 
    #endif
    ...
    public SubAccountIdentification49? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification49? SubAccountDetails { get; set; } 
    #endif
