...
public partial record SecuritiesSettlementTransactionAllegementReportV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementReportV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementReportV06( Pagination reqPagination,Statement39 reqStatementGeneralDetails,SecuritiesAccount24 reqSafekeepingAccount )
    {
    ...
    public required Statement39 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement39 StatementGeneralDetails { get; init; } 
    #else
    public Statement39 StatementGeneralDetails { get; set; } 
    #endif
    ...
    public SecuritiesTradeDetails68? AllegementDetails { get; init; } 
    #else
    public SecuritiesTradeDetails68? AllegementDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAllegementReportV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementReportV06.
