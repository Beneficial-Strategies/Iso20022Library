...
public partial record SecuritiesTransactionPostingReport002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReport002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReport002V11( Pagination1 reqPagination,Statement82 reqStatementGeneralDetails,SecuritiesAccount40 reqSafekeepingAccount )
    {
    ...
    public SubAccountIdentification63? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification63? SubAccountDetails { get; set; } 
    #endif
