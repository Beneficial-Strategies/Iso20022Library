...
public partial record SecuritiesBalanceAccountingReportV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceAccountingReportV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceAccountingReportV06( Pagination reqPagination,Statement20 reqStatementGeneralDetails,SecuritiesAccount11 reqSafekeepingAccount )
    {
