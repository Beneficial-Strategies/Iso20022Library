...
public partial record IntraPositionMovementPostingReportV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementPostingReportV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementPostingReportV09( Pagination1 reqPagination,Statement80 reqStatementGeneralDetails )
    {
    ...
    public FinancialInstrumentDetails40? FinancialInstrument { get; init; } 
    #else
    public FinancialInstrumentDetails40? FinancialInstrument { get; set; } 
    #endif
...
// Since IntraPositionMovementPostingReportV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementPostingReportV09.
