...
[DataContract]
#endif
public partial record SecuritiesMessageCancellationAdviceV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesMessageCancellationAdviceV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesMessageCancellationAdviceV06( References69Choice_ reqReference,SecuritiesAccount19 reqSafekeepingAccount )
    {
