...
/// <summary>
/// This record is an implementation of the semt.017.001.03 ISO standard message type.
...
public partial record SecuritiesTransactionPostingReportV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.017.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV03( Pagination reqPagination,Statement11 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails9? FinancialInstrumentDetails { get; init; } 
    #else
    public FinancialInstrumentDetails9? FinancialInstrumentDetails { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SubAccountIdentification21? SubAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SubAccountIdentification21? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification21? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV03.
