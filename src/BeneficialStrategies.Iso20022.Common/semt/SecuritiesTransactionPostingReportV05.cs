...
/// <summary>
/// This record is an implementation of the semt.017.001.05 ISO standard message type.
...
public partial record SecuritiesTransactionPostingReportV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.017.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV05( Pagination reqPagination,Statement11 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public SubAccountIdentification34? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification34? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV05.
