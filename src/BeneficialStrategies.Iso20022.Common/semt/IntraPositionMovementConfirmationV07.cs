...
public partial record IntraPositionMovementConfirmationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementConfirmationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementConfirmationV07( SecuritiesAccount19 reqSafekeepingAccount,SecurityIdentification19 reqFinancialInstrumentIdentification,IntraPositionDetails46 reqIntraPositionDetails )
    {
    ...
    public required IntraPositionDetails46 IntraPositionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraPositionDetails46 IntraPositionDetails { get; init; } 
    #else
    public IntraPositionDetails46 IntraPositionDetails { get; set; } 
    #endif
