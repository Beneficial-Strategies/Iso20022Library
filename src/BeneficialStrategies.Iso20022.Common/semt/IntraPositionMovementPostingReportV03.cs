...
/// <summary>
/// This record is an implementation of the semt.016.001.03 ISO standard message type.
...
public partial record IntraPositionMovementPostingReportV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.016.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementPostingReportV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementPostingReportV03( Pagination reqPagination,Statement15 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails10? FinancialInstrument { get; init; } 
    #else
    public FinancialInstrumentDetails10? FinancialInstrument { get; set; } 
    #endif
...
// Since IntraPositionMovementPostingReportV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementPostingReportV03.
