...
public partial record SecuritiesTransactionPostingReportV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV09( Pagination1 reqPagination,Statement61 reqStatementGeneralDetails,SecuritiesAccount36 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails32? FinancialInstrumentDetails { get; init; } 
    #else
    public FinancialInstrumentDetails32? FinancialInstrumentDetails { get; set; } 
    #endif
    ...
    public SubAccountIdentification53? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification53? SubAccountDetails { get; set; } 
    #endif
