...
/// <summary>
/// This record is an implementation of the semt.017.001.11 ISO standard message type.
...
public partial record SecuritiesTransactionPostingReportV11 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.017.001.11";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV11( Pagination1 reqPagination,Statement79 reqStatementGeneralDetails,SecuritiesAccount36 reqSafekeepingAccount )
    {
    ...
    public FinancialInstrumentDetails38? FinancialInstrumentDetails { get; init; } 
    #else
    public FinancialInstrumentDetails38? FinancialInstrumentDetails { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SubAccountIdentification62? SubAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SubAccountIdentification62? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification62? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV11.
