...
/// <summary>
/// This record is an implementation of the semt.019.001.05 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionAllegementReportV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.019.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementReportV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementReportV05( Pagination reqPagination,Statement39 reqStatementGeneralDetails,SecuritiesAccount24 reqSafekeepingAccount )
    {
    ...
    public SecuritiesTradeDetails49? AllegementDetails { get; init; } 
    #else
    public SecuritiesTradeDetails49? AllegementDetails { get; set; } 
    #endif
