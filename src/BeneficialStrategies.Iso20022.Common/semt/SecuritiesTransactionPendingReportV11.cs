...
public partial record SecuritiesTransactionPendingReportV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReportV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReportV11( Pagination1 reqPagination,Statement64 reqStatementGeneralDetails,SecuritiesAccount19 reqSafekeepingAccount )
    {
    ...
    public StatusAndReason40? Status { get; init; } 
    #else
    public StatusAndReason40? Status { get; set; } 
    #endif
    ...
    public Transaction109? Transactions { get; init; } 
    #else
    public Transaction109? Transactions { get; set; } 
    #endif
