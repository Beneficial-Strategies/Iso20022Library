...
public partial record SecuritiesTransactionPostingReportV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV08( Pagination1 reqPagination,Statement61 reqStatementGeneralDetails,SecuritiesAccount19 reqSafekeepingAccount )
    {
    ...
    public required Statement61 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement61 StatementGeneralDetails { get; init; } 
    #else
    public Statement61 StatementGeneralDetails { get; set; } 
    #endif
    ...
    public SubAccountIdentification51? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification51? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV08.
