...
/// <summary>
/// This record is an implementation of the semt.017.002.09 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesTransactionPostingReport002V09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.017.002.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.017.002.09";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReport002V09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReport002V09( Pagination1 reqPagination,Statement71 reqStatementGeneralDetails,SecuritiesAccount40 reqSafekeepingAccount )
    {
    ...
    public SubAccountIdentification59? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification59? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReport002V09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReport002V09.
