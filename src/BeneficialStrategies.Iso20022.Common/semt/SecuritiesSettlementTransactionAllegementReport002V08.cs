...
/// <summary>
/// This record is an implementation of the semt.019.002.08 ISO standard message type.
...
public partial record SecuritiesSettlementTransactionAllegementReport002V08 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.019.002.08";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAllegementReport002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAllegementReport002V08( Pagination1 reqPagination,Statement69 reqStatementGeneralDetails,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    public SecuritiesTradeDetails105? AllegementDetails { get; init; } 
    #else
    public SecuritiesTradeDetails105? AllegementDetails { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAllegementReport002V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAllegementReport002V08.
