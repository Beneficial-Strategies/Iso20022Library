...
/// <summary>
/// This record is an implementation of the semt.015.001.05 ISO standard message type.
...
[DataContract]
#endif
public partial record IntraPositionMovementConfirmationV05 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.015.001.05";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.015.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementConfirmationV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementConfirmationV05( SecuritiesAccount24 reqSafekeepingAccount,SecurityIdentification19 reqFinancialInstrumentIdentification,IntraPositionDetails34 reqIntraPositionDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required IntraPositionDetails34 IntraPositionDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required IntraPositionDetails34 IntraPositionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraPositionDetails34 IntraPositionDetails { get; init; } 
    #else
    public IntraPositionDetails34 IntraPositionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_XVkgRQCUEeW_3KiG8SEjHA")]
...
// Since IntraPositionMovementConfirmationV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementConfirmationV05.
