...
/// <summary>
/// This record is an implementation of the semt.021.001.05 ISO standard message type.
...
public partial record SecuritiesStatementQueryV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.021.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesStatementQueryV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesStatementQueryV05( DocumentNumber1 reqStatementRequested,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public AdditionalQueryParameters9? AdditionalQueryParameters { get; init; } 
    #else
    public AdditionalQueryParameters9? AdditionalQueryParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_Xq75QU3MEeS1yPC0JC-FvQ")]
...
// Since SecuritiesStatementQueryV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesStatementQueryV05.
