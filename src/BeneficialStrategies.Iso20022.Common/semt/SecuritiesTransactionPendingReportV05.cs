...
/// <summary>
/// This record is an implementation of the semt.018.001.05 ISO standard message type.
...
public partial record SecuritiesTransactionPendingReportV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.018.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReportV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReportV05( Pagination reqPagination,Statement14 reqStatementGeneralDetails,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    [IsoXmlTag("Sts")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public StatusAndReason18? Status { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusAndReason18? Status { get; init; } 
    #else
    public StatusAndReason18? Status { get; set; } 
    #endif
    ...
    [IsoXmlTag("Txs")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public Transaction34? Transactions { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction34? Transactions { get; init; } 
    #else
    public Transaction34? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReportV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReportV05.
