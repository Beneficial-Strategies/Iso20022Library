...
[DataContract]
#endif
public partial record SecuritiesSettlementTransactionAuditTrailReportV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesSettlementTransactionAuditTrailReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesSettlementTransactionAuditTrailReportV02( Pagination reqPagination,SecuritiesAccount13 reqSafekeepingAccount )
    {
    ...
    public StatusTrail4? StatusTrail { get; init; } 
    #else
    public StatusTrail4? StatusTrail { get; set; } 
    #endif
...
// Since SecuritiesSettlementTransactionAuditTrailReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesSettlementTransactionAuditTrailReportV02.
