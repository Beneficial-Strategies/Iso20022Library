...
/// <summary>
/// This record is an implementation of the semt.017.001.06 ISO standard message type.
...
public partial record SecuritiesTransactionPostingReportV06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.017.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPostingReportV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPostingReportV06( Pagination reqPagination,Statement44 reqStatementGeneralDetails,SecuritiesAccount24 reqSafekeepingAccount )
    {
    ...
    public required Statement44 StatementGeneralDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Statement44 StatementGeneralDetails { get; init; } 
    #else
    public Statement44 StatementGeneralDetails { get; set; } 
    #endif
    ...
    public FinancialInstrumentDetails20? FinancialInstrumentDetails { get; init; } 
    #else
    public FinancialInstrumentDetails20? FinancialInstrumentDetails { get; set; } 
    #endif
    ...
    public SubAccountIdentification44? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification44? SubAccountDetails { get; set; } 
    #endif
...
// Since SecuritiesTransactionPostingReportV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPostingReportV06.
