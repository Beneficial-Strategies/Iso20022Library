...
public partial record IntraPositionMovementStatusAdvice002V04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementStatusAdvice002V04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementStatusAdvice002V04( TransactionIdentifications34 reqTransactionIdentification )
    {
    ...
    public IntraPositionDetails38? TransactionDetails { get; init; } 
    #else
    public IntraPositionDetails38? TransactionDetails { get; set; } 
    #endif
...
// Since IntraPositionMovementStatusAdvice002V04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementStatusAdvice002V04.
