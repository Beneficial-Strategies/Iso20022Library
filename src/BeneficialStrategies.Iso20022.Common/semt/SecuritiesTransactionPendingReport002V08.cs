...
[DataContract]
#endif
public partial record SecuritiesTransactionPendingReport002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReport002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReport002V08( Pagination reqPagination,Statement55 reqStatementGeneralDetails,SecuritiesAccount27 reqSafekeepingAccount )
    {
    ...
    public StatusAndReason33? Status { get; init; } 
    #else
    public StatusAndReason33? Status { get; set; } 
    #endif
    ...
    public Transaction57? Transactions { get; init; } 
    #else
    public Transaction57? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReport002V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReport002V08.
