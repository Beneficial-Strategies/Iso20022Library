...
/// <summary>
/// This record is an implementation of the semt.002.001.04 ISO standard message type.
...
public partial record SecuritiesBalanceCustodyReportV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.002.001.04";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.002.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceCustodyReportV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceCustodyReportV04( Pagination reqPagination,Statement21 reqStatementGeneralDetails,SecuritiesAccount11 reqSafekeepingAccount )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalanceInformation12? BalanceForAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalanceInformation12? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation12? BalanceForAccount { get; set; } 
    #endif
    
    /// <summary>
    /// Sub-account of the safekeeping or investment account.
    /// </summary>
    [IsoId("_HGMCs9tYEd-RF5yaMAVhAw")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SubAccountIdentification17? SubAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SubAccountIdentification17? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification17? SubAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Total valuation amounts provided in the base currency of the account.
    /// </summary>
    [IsoId("_HGMCtdtYEd-RF5yaMAVhAw")]
...
// Since SecuritiesBalanceCustodyReportV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesBalanceCustodyReportV04.
