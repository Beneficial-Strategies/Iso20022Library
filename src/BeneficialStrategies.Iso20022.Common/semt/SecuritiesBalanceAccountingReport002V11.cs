...
public partial record SecuritiesBalanceAccountingReport002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceAccountingReport002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceAccountingReport002V11( Pagination1 reqPagination,Statement76 reqStatementGeneralDetails )
    {
    ...
    public AggregateBalanceInformation43? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation43? BalanceForAccount { get; set; } 
    #endif
    ...
    public SubAccountIdentification68? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification68? SubAccountDetails { get; set; } 
    #endif
