...
/// <summary>
/// This record is an implementation of the semt.003.001.07 ISO standard message type.
...
public partial record SecuritiesBalanceAccountingReportV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "semt.003.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesBalanceAccountingReportV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesBalanceAccountingReportV07( Pagination reqPagination,Statement20 reqStatementGeneralDetails,SecuritiesAccount11 reqSafekeepingAccount )
    {
    ...
    public AggregateBalanceInformation22? BalanceForAccount { get; init; } 
    #else
    public AggregateBalanceInformation22? BalanceForAccount { get; set; } 
    #endif
    
    /// <summary>
    /// Sub-account of the safekeeping or investment account.
    /// </summary>
    [IsoId("_MqefHSRLEeON6sEIseGaUg")]
    ...
    public SubAccountIdentification29? SubAccountDetails { get; init; } 
    #else
    public SubAccountIdentification29? SubAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Total valuation amounts provided in the base currency of the account.
    /// </summary>
    [IsoId("_MqefHyRLEeON6sEIseGaUg")]
...
// Since SecuritiesBalanceAccountingReportV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesBalanceAccountingReportV07.
