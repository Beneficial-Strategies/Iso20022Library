...
public partial record IntraPositionMovementConfirmationV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementConfirmationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementConfirmationV06( SecuritiesAccount24 reqSafekeepingAccount,SecurityIdentification19 reqFinancialInstrumentIdentification,IntraPositionDetails41 reqIntraPositionDetails )
    {
    ...
    public required IntraPositionDetails41 IntraPositionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public IntraPositionDetails41 IntraPositionDetails { get; init; } 
    #else
    public IntraPositionDetails41 IntraPositionDetails { get; set; } 
    #endif
...
// Since IntraPositionMovementConfirmationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to IntraPositionMovementConfirmationV06.
