...
/// <summary>
/// This record is an implementation of the semt.018.002.10 ISO standard message type.
...
[DataContract]
#endif
public partial record SecuritiesTransactionPendingReport002V10 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "semt.018.002.10";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:semt.018.002.10";
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTransactionPendingReport002V10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTransactionPendingReport002V10( Pagination1 reqPagination,Statement70 reqStatementGeneralDetails,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    [IsoXmlTag("Sts")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public StatusAndReason37? Status { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusAndReason37? Status { get; init; } 
    #else
    public StatusAndReason37? Status { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the transactions reported.
    /// </summary>
    [IsoId("_iE4K8ffZEeiNZp_PtLohLw")]
    ...
    [IsoXmlTag("Txs")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public Transaction71? Transactions { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction71? Transactions { get; init; } 
    #else
    public Transaction71? Transactions { get; set; } 
    #endif
...
// Since SecuritiesTransactionPendingReport002V10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesTransactionPendingReport002V10.
