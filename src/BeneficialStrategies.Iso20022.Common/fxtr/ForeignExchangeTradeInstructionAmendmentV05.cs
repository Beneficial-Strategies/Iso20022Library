...
public partial record ForeignExchangeTradeInstructionAmendmentV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTradeInstructionAmendmentV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTradeInstructionAmendmentV05( TradeAgreement15 reqTradeInformation,TradePartyIdentification8 reqTradingSideIdentification,TradePartyIdentification8 reqCounterpartySideIdentification,AmountsAndValueDate6 reqTradeAmounts,AgreedRate3 reqAgreedRate )
    {
