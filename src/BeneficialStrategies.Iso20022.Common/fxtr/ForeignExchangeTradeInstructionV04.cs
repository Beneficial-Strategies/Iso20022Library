...
[DataContract]
#endif
public partial record ForeignExchangeTradeInstructionV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTradeInstructionV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTradeInstructionV04( TradeAgreement14 reqTradeInformation,TradePartyIdentification6 reqTradingSideIdentification,TradePartyIdentification6 reqCounterpartySideIdentification,AmountsAndValueDate1 reqTradeAmounts,AgreedRate3 reqAgreedRate )
    {
...
// Since ForeignExchangeTradeInstructionV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ForeignExchangeTradeInstructionV04.
