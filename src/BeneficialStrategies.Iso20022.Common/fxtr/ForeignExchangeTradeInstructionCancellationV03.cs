...
/// <summary>
/// This record is an implementation of the fxtr.016.001.03 ISO standard message type.
...
public partial record ForeignExchangeTradeInstructionCancellationV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "fxtr.016.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTradeInstructionCancellationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTradeInstructionCancellationV03( TradeAgreement11 reqTradeInformation,TradePartyIdentification6 reqTradingSideIdentification,TradePartyIdentification6 reqCounterpartySideIdentification,AmountsAndValueDate1 reqTradeAmounts )
    {
    ...
    #else
    public TradeAgreement11 TradeInformation { get; set; } 
    #endif
...
// Since ForeignExchangeTradeInstructionCancellationV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ForeignExchangeTradeInstructionCancellationV03.
