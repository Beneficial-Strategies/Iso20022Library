...
public partial record FinancialInstrumentReportingNonEquityTradingActivityResultV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentReportingNonEquityTradingActivityResultV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentReportingNonEquityTradingActivityResultV01( SecuritiesMarketReportHeader1 reqReportHeader,TransparencyDataReport14 reqNonEquityTransparencyData )
    {
    ...
    public required TransparencyDataReport14 NonEquityTransparencyData { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransparencyDataReport14 NonEquityTransparencyData { get; init; } 
    #else
    public TransparencyDataReport14 NonEquityTransparencyData { get; set; } 
    #endif
