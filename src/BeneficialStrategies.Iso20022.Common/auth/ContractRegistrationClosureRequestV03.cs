...
public partial record ContractRegistrationClosureRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ContractRegistrationClosureRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ContractRegistrationClosureRequestV03( CurrencyControlHeader4 reqGroupHeader,RegisteredContract15 reqRegisteredContractClosure )
    {
    ...
    #else
    public RegisteredContract15 RegisteredContractClosure { get; set; } 
    #endif
...
// Since ContractRegistrationClosureRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ContractRegistrationClosureRequestV03.
