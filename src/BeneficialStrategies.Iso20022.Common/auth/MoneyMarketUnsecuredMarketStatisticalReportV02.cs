...
/// <summary>
/// This record is an implementation of the auth.013.001.02 ISO standard message type.
...
public partial record MoneyMarketUnsecuredMarketStatisticalReportV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "auth.013.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a MoneyMarketUnsecuredMarketStatisticalReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MoneyMarketUnsecuredMarketStatisticalReportV02( MoneyMarketReportHeader1 reqReportHeader,UnsecuredMarketReport4Choice_ reqUnsecuredMarketReport )
    {
    ...
    #else
    public UnsecuredMarketReport4Choice_ UnsecuredMarketReport { get; set; } 
    #endif
...
// Since MoneyMarketUnsecuredMarketStatisticalReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MoneyMarketUnsecuredMarketStatisticalReportV02.
