...
public partial record SecuritiesFinancingReportingMarginDataTransactionStateReportV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingMarginDataTransactionStateReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingMarginDataTransactionStateReportV02( TradeData38Choice_ reqTradeData )
    {
    ...
    public TradeData38Choice_ TradeData { get; init; } 
    #else
    public TradeData38Choice_ TradeData { get; set; } 
    #endif
