...
/// <summary>
/// This record is an implementation of the auth.045.001.02 ISO standard message type.
...
public partial record FinancialInstrumentReportingNonEquityTradingActivityResultV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "auth.045.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentReportingNonEquityTradingActivityResultV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentReportingNonEquityTradingActivityResultV02( SecuritiesMarketReportHeader1 reqReportHeader,TransparencyDataReport18 reqNonEquityTransparencyData )
    {
    ...
    public required TransparencyDataReport18 NonEquityTransparencyData { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransparencyDataReport18 NonEquityTransparencyData { get; init; } 
    #else
    public TransparencyDataReport18 NonEquityTransparencyData { get; set; } 
    #endif
...
// Since FinancialInstrumentReportingNonEquityTradingActivityResultV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstrumentReportingNonEquityTradingActivityResultV02.
