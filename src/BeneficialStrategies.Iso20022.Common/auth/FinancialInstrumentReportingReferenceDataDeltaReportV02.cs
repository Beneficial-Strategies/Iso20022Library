...
/// <summary>
/// This record is an implementation of the auth.036.001.02 ISO standard message type.
...
public partial record FinancialInstrumentReportingReferenceDataDeltaReportV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "auth.036.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentReportingReferenceDataDeltaReportV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentReportingReferenceDataDeltaReportV02( SecuritiesMarketReportHeader1 reqReportHeader )
    {
    ...
    [IsoXmlTag("FinInstrm")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SecuritiesReferenceDeltaStatusReport3Choice_? FinancialInstrument { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesReferenceDeltaStatusReport3Choice_? FinancialInstrument { get; init; } 
    #else
    public SecuritiesReferenceDeltaStatusReport3Choice_? FinancialInstrument { get; set; } 
    #endif
...
// Since FinancialInstrumentReportingReferenceDataDeltaReportV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstrumentReportingReferenceDataDeltaReportV02.
