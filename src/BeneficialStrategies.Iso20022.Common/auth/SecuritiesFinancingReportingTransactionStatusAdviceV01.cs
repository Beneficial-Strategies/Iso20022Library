...
public partial record SecuritiesFinancingReportingTransactionStatusAdviceV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingTransactionStatusAdviceV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingTransactionStatusAdviceV01( TradeData11Choice_ reqTransactionReportStatusAndReason )
    {
    ...
    public TradeData11Choice_ TransactionReportStatusAndReason { get; init; } 
    #else
    public TradeData11Choice_ TransactionReportStatusAndReason { get; set; } 
    #endif
...
// Since SecuritiesFinancingReportingTransactionStatusAdviceV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to SecuritiesFinancingReportingTransactionStatusAdviceV01.
