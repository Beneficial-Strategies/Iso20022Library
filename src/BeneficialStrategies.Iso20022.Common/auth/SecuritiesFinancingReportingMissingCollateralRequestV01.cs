...
public partial record SecuritiesFinancingReportingMissingCollateralRequestV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingReportingMissingCollateralRequestV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingReportingMissingCollateralRequestV01( TradeTransactionIdentification6 reqTransactionIdentification )
    {
    ...
    #else
    public TradeTransactionIdentification6 TransactionIdentification { get; set; } 
    #endif
