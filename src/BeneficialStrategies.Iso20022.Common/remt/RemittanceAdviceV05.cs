...
public partial record RemittanceAdviceV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a RemittanceAdviceV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RemittanceAdviceV05( GroupHeader79 reqGroupHeader,RemittanceInformation20 reqRemittanceInformation )
    {
    ...
    public required RemittanceInformation20 RemittanceInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public RemittanceInformation20 RemittanceInformation { get; init; } 
    #else
    public RemittanceInformation20 RemittanceInformation { get; set; } 
    #endif
