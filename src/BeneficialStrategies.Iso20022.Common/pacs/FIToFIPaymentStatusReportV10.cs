...
public partial record FIToFIPaymentStatusReportV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentStatusReportV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentStatusReportV10( GroupHeader91 reqGroupHeader )
    {
    ...
    public PaymentTransaction110? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction110? TransactionInformationAndStatus { get; set; } 
    #endif
