...
[IsoId("_ejE0QdEuEd-BzquC8wXy7w_677726026")]
...
public partial record FIToFICustomerDirectDebitV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerDirectDebitV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerDirectDebitV01( GroupHeader3 reqGroupHeader,DirectDebitTransactionInformation2 reqDirectDebitTransactionInformation )
    {
    ...
    public GroupHeader3 GroupHeader { get; init; } 
    #else
    public GroupHeader3 GroupHeader { get; set; } 
    #endif
    ...
    public required DirectDebitTransactionInformation2 DirectDebitTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DirectDebitTransactionInformation2 DirectDebitTransactionInformation { get; init; } 
    #else
    public DirectDebitTransactionInformation2 DirectDebitTransactionInformation { get; set; } 
    #endif
...
// Since FIToFICustomerDirectDebitV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerDirectDebitV01.
