...
/// <summary>
/// This record is an implementation of the pacs.009.001.03 ISO standard message type.
...
[IsoId("_sB-zkFkyEeGeoaLUQk__nA_-289152134")]
...
public partial record FinancialInstitutionCreditTransferV03 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.009.001.03";
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstitutionCreditTransferV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstitutionCreditTransferV03( GroupHeader51 reqGroupHeader,CreditTransferTransaction4 reqCreditTransferTransactionInformation )
    {
    ...
    [IsoXmlTag("GrpHdr")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required GroupHeader51 GroupHeader { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required GroupHeader51 GroupHeader { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public GroupHeader51 GroupHeader { get; init; } 
    #else
    public GroupHeader51 GroupHeader { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CreditTransferTransaction4 CreditTransferTransactionInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CreditTransferTransaction4 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction4 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction4 CreditTransferTransactionInformation { get; set; } 
    #endif
...
// Since FinancialInstitutionCreditTransferV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstitutionCreditTransferV03.
