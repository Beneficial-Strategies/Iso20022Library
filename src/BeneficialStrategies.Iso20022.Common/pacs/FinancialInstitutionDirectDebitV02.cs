...
public partial record FinancialInstitutionDirectDebitV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstitutionDirectDebitV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstitutionDirectDebitV02( GroupHeader63 reqGroupHeader,CreditTransferTransaction9 reqCreditInstruction )
    {
    ...
    #else
    public CreditTransferTransaction9 CreditInstruction { get; set; } 
    #endif
...
// Since FinancialInstitutionDirectDebitV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FinancialInstitutionDirectDebitV02.
