...
/// <summary>
/// This record is an implementation of the pacs.008.001.09 ISO standard message type.
...
[DataContract]
#endif
public partial record FIToFICustomerCreditTransferV09 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.008.001.09";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerCreditTransferV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerCreditTransferV09( GroupHeader93 reqGroupHeader,CreditTransferTransaction43 reqCreditTransferTransactionInformation )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CreditTransferTransaction43 CreditTransferTransactionInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CreditTransferTransaction43 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction43 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction43 CreditTransferTransactionInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_LwCCDcP_Eemsic1bQcEtLA")]
...
// Since FIToFICustomerCreditTransferV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerCreditTransferV09.
