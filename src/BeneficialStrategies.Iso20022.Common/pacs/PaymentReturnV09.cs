...
/// <summary>
/// This record is an implementation of the pacs.004.001.09 ISO standard message type.
...
public partial record PaymentReturnV09 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.004.001.09";
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReturnV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReturnV09( GroupHeader90 reqGroupHeader )
    {
    ...
    public GroupHeader90 GroupHeader { get; init; } 
    #else
    public GroupHeader90 GroupHeader { get; set; } 
    #endif
    
    /// <summary>
    /// Information concerning the original group of transactions, to which the message refers.
    /// </summary>
    [IsoId("_x0JZM3L4EeidQ_AAdEzxQA")]
    ...
    [IsoXmlTag("TxInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction112? TransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction112? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction112? TransactionInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_x0JZN3L4EeidQ_AAdEzxQA")]
...
// Since PaymentReturnV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to PaymentReturnV09.
