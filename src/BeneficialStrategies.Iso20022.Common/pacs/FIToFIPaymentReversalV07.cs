...
/// <summary>
/// This record is an implementation of the pacs.007.001.07 ISO standard message type.
...
public partial record FIToFIPaymentReversalV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.007.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFIPaymentReversalV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFIPaymentReversalV07( GroupHeader71 reqGroupHeader )
    {
    ...
    [IsoXmlTag("TxInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction81? TransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction81? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction81? TransactionInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_GDIJQ2XkEeap-P22vGV91g")]
...
// Since FIToFIPaymentReversalV07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFIPaymentReversalV07.
