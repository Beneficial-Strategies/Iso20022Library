...
/// <summary>
/// This record is an implementation of the pacs.008.001.04 ISO standard message type.
...
public partial record FIToFICustomerCreditTransferV04 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "pacs.008.001.04";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerCreditTransferV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerCreditTransferV04( GroupHeader49 reqGroupHeader,CreditTransferTransaction7 reqCreditTransferTransactionInformation )
    {
    ...
    public required CreditTransferTransaction7 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction7 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction7 CreditTransferTransactionInformation { get; set; } 
    #endif
...
// Since FIToFICustomerCreditTransferV04Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerCreditTransferV04.
