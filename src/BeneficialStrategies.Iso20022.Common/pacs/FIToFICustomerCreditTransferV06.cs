...
/// <summary>
/// This record is an implementation of the pacs.008.001.06 ISO standard message type.
...
[DataContract]
#endif
public partial record FIToFICustomerCreditTransferV06 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "pacs.008.001.06";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06";
    ...
    #else
    /// <summary>
    /// Constructs a FIToFICustomerCreditTransferV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FIToFICustomerCreditTransferV06( GroupHeader70 reqGroupHeader,CreditTransferTransaction25 reqCreditTransferTransactionInformation )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CreditTransferTransaction25 CreditTransferTransactionInformation { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CreditTransferTransaction25 CreditTransferTransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CreditTransferTransaction25 CreditTransferTransactionInformation { get; init; } 
    #else
    public CreditTransferTransaction25 CreditTransferTransactionInformation { get; set; } 
    #endif
...
// Since FIToFICustomerCreditTransferV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to FIToFICustomerCreditTransferV06.
