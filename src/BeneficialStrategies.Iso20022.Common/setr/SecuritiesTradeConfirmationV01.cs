...
public partial record SecuritiesTradeConfirmationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeConfirmationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeConfirmationV01( TransactiontIdentification4 reqIdentification,Order14 reqTradeDetails,SecurityIdentification14 reqFinancialInstrumentIdentification,ConfirmationParties2 reqConfirmationParties )
    {
    ...
    public FinancialInstrumentAttributes31? FinancialInstrumentAttributes { get; init; } 
    #else
    public FinancialInstrumentAttributes31? FinancialInstrumentAttributes { get; set; } 
    #endif
    ...
    public UnderlyingFinancialInstrument1? UnderlyingFinancialInstrument { get; init; } 
    #else
    public UnderlyingFinancialInstrument1? UnderlyingFinancialInstrument { get; set; } 
    #endif
    ...
    public CashParties6? CashParties { get; init; } 
    #else
    public CashParties6? CashParties { get; set; } 
    #endif
