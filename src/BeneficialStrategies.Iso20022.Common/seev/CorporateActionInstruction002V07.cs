...
public partial record CorporateActionInstruction002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstruction002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstruction002V07( CorporateActionGeneralInformation115 reqCorporateActionGeneralInformation,AccountAndBalance37 reqAccountDetails,CorporateActionOption134 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionOption134 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption134 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption134 CorporateActionInstruction { get; set; } 
    #endif
