...
public partial record MeetingInstructionStatusV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingInstructionStatusV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingInstructionStatusV09( InstructionType2Choice_ reqInstructionType,MeetingReference10 reqMeetingReference,SecurityIdentification19 reqFinancialInstrumentIdentification,InstructionTypeStatus5Choice_ reqInstructionTypeStatus,PartyIdentification226Choice_ reqConfirmingParty,PartyIdentification226Choice_ reqVoteCastingParty )
    {
    ...
    public EligiblePosition17? Position { get; init; } 
    #else
    public EligiblePosition17? Position { get; set; } 
    #endif
...
// Since MeetingInstructionStatusV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingInstructionStatusV09.
