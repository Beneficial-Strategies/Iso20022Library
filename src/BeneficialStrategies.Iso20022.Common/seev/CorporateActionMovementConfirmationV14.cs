...
/// <summary>
/// This record is an implementation of the seev.036.001.14 ISO standard message type.
...
public partial record CorporateActionMovementConfirmationV14 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.036.001.14";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV14( CorporateActionGeneralInformation162 reqCorporateActionGeneralInformation,AccountAndBalance49 reqAccountDetails,CorporateActionOption211 reqCorporateActionConfirmationDetails )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateAction73? CorporateActionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateAction73? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction73? CorporateActionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the corporate action option.
    /// </summary>
    [IsoId("_V4gr3TN3Ee2Amemf1A0gtA")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CorporateActionOption211 CorporateActionConfirmationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CorporateActionOption211 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption211 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption211 CorporateActionConfirmationDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_V4gr3zN3Ee2Amemf1A0gtA")]
...
// Since CorporateActionMovementConfirmationV14Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmationV14.
