...
/// <summary>
/// This record is an implementation of the seev.040.001.02 ISO standard message type.
...
public partial record CorporateActionInstructionCancellationRequestV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.040.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestV02( DocumentIdentification15 reqInstructionIdentification,CorporateActionGeneralInformation26 reqCorporateActionGeneralInformation,AccountIdentification17 reqAccountDetails,CorporateActionOption21 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation26 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation26 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation26 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required CorporateActionOption21 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption21 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption21 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequestV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestV02.
