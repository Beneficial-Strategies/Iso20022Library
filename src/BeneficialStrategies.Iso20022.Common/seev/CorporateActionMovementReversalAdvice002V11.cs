...
/// <summary>
/// This record is an implementation of the seev.037.002.11 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementReversalAdvice002V11 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.002.11";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.11";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V11( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation149 reqCorporateActionGeneralInformation,AccountAndBalance40 reqAccountDetails,CorporateActionOption175 reqCorporateActionConfirmationDetails )
    {
...
// Since CorporateActionMovementReversalAdvice002V11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdvice002V11.
