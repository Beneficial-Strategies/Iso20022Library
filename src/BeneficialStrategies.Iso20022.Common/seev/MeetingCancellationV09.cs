...
[DataContract]
#endif
public partial record MeetingCancellationV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingCancellationV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingCancellationV09( MeetingReference10 reqMeetingReference,MeetingCancellationReason2 reqReason )
    {
