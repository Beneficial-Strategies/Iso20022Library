...
public partial record CorporateActionMovementConfirmationV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV12( CorporateActionGeneralInformation142 reqCorporateActionGeneralInformation,AccountAndBalance43 reqAccountDetails,CorporateActionOption179 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption179 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption179 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption179 CorporateActionConfirmationDetails { get; set; } 
    #endif
