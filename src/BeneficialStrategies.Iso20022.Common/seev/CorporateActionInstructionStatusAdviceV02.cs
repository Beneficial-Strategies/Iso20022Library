...
[DataContract]
#endif
public partial record CorporateActionInstructionStatusAdviceV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdviceV02( CorporateActionGeneralInformation9 reqCorporateActionGeneralInformation,InstructionProcessingStatus7Choice_ reqInstructionProcessingStatus )
    {
    ...
    public CorporateActionOption26? CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption26? CorporateActionInstruction { get; set; } 
    #endif
