...
public partial record CorporateActionCancellationAdvice002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdvice002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdvice002V06( CorporateActionCancellation4 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation93 reqCorporateActionGeneralInformation,AccountIdentification34Choice_ reqAccountsDetails )
    {
    ...
    public required CorporateActionGeneralInformation93 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation93 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation93 CorporateActionGeneralInformation { get; set; } 
    #endif
