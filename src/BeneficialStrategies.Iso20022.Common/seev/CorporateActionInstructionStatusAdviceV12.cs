...
public partial record CorporateActionInstructionStatusAdviceV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdviceV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdviceV12( CorporateActionGeneralInformation154 reqCorporateActionGeneralInformation,InstructionProcessingStatus40Choice_ reqInstructionProcessingStatus )
    {
    ...
    public required InstructionProcessingStatus40Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionProcessingStatus40Choice_ InstructionProcessingStatus { get; init; } 
    #else
    public InstructionProcessingStatus40Choice_ InstructionProcessingStatus { get; set; } 
    #endif
    ...
    public CorporateActionOption184? CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption184? CorporateActionInstruction { get; set; } 
    #endif
