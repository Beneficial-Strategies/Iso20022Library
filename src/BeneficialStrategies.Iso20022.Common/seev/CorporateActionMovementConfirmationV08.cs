...
public partial record CorporateActionMovementConfirmationV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV08( CorporateActionGeneralInformation111 reqCorporateActionGeneralInformation,AccountAndBalance34 reqAccountDetails,CorporateActionOption132 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption132 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption132 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption132 CorporateActionConfirmationDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementConfirmationV08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmationV08.
