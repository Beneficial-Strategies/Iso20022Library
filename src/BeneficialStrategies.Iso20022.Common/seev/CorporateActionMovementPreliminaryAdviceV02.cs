...
/// <summary>
/// This record is an implementation of the seev.035.001.02 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdviceV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.035.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceV02( CorporateActionPreliminaryAdviceType1 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation23 reqCorporateActionGeneralInformation,AccountIdentification12Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation23 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation23 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation23 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionOption20? CorporateActionMovementDetails { get; init; } 
    #else
    public CorporateActionOption20? CorporateActionMovementDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceV02.
