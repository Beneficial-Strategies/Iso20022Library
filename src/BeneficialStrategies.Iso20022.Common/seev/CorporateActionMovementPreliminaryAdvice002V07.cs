...
/// <summary>
/// This record is an implementation of the seev.035.002.07 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdvice002V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.035.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdvice002V07( CorporateActionPreliminaryAdviceType2 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation100 reqCorporateActionGeneralInformation,AccountIdentification36Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation100 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation100 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation100 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionOption125? CorporateActionMovementDetails { get; init; } 
    #else
    public CorporateActionOption125? CorporateActionMovementDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdvice002V07.
