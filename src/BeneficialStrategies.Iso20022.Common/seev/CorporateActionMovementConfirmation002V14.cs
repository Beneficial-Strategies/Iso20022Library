...
[DataContract]
#endif
public partial record CorporateActionMovementConfirmation002V14 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmation002V14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmation002V14( CorporateActionGeneralInformation167 reqCorporateActionGeneralInformation,AccountAndBalance52 reqAccountDetails,CorporateActionOption213 reqCorporateActionConfirmationDetails )
    {
    ...
    public CorporateAction75? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction75? CorporateActionDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption213 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption213 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption213 CorporateActionConfirmationDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementConfirmation002V14Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmation002V14.
