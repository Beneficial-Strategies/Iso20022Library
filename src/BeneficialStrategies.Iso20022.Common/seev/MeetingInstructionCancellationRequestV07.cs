...
public partial record MeetingInstructionCancellationRequestV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingInstructionCancellationRequestV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingInstructionCancellationRequestV07( System.String reqMeetingInstructionIdentification )
    {
    ...
    public CancelInstruction2? ToBeCancelledInstruction { get; init; } 
    #else
    public CancelInstruction2? ToBeCancelledInstruction { get; set; } 
    #endif
