...
/// <summary>
/// This record is an implementation of the seev.037.002.13 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementReversalAdvice002V13 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.002.13";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.13";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V13( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation167 reqCorporateActionGeneralInformation,AccountAndBalance54 reqAccountDetails,CorporateActionOption207 reqCorporateActionConfirmationDetails )
    {
    ...
    public required AccountAndBalance54 AccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AccountAndBalance54 AccountDetails { get; init; } 
    #else
    public AccountAndBalance54 AccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the corporate action event.
    /// </summary>
    [IsoId("_p3AJLTi7Eeydid5dcNPKvg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateAction66? CorporateActionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateAction66? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction66? CorporateActionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the corporate action option.
    /// </summary>
    [IsoId("_p3AJLzi7Eeydid5dcNPKvg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CorporateActionOption207 CorporateActionConfirmationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CorporateActionOption207 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption207 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption207 CorporateActionConfirmationDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_p3AJMTi7Eeydid5dcNPKvg")]
...
// Since CorporateActionMovementReversalAdvice002V13Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdvice002V13.
