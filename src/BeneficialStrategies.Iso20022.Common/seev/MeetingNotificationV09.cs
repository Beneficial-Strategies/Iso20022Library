...
public partial record MeetingNotificationV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingNotificationV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingNotificationV09( NotificationGeneralInformation3 reqNotificationGeneralInformation,MeetingNotice7 reqMeeting,IssuerInformation3 reqIssuer )
    {
    ...
    public required NotificationGeneralInformation3 NotificationGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public NotificationGeneralInformation3 NotificationGeneralInformation { get; init; } 
    #else
    public NotificationGeneralInformation3 NotificationGeneralInformation { get; set; } 
    #endif
    ...
    public required MeetingNotice7 Meeting { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MeetingNotice7 Meeting { get; init; } 
    #else
    public MeetingNotice7 Meeting { get; set; } 
    #endif
    ...
    public VoteParameters7? Vote { get; init; } 
    #else
    public VoteParameters7? Vote { get; set; } 
    #endif
