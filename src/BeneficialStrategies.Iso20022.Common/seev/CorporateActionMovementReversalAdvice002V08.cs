...
/// <summary>
/// This record is an implementation of the seev.037.002.08 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementReversalAdvice002V08 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.037.002.08";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.037.002.08";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V08( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation118 reqCorporateActionGeneralInformation,AccountAndBalance40 reqAccountDetails,CorporateActionOption126 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption126 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption126 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption126 CorporateActionConfirmationDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_ZbbRp5wtEeazcsnODTksnQ")]
...
// Since CorporateActionMovementReversalAdvice002V08Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementReversalAdvice002V08.
