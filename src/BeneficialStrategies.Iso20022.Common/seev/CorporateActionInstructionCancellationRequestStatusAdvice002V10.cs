...
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdvice002V10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdvice002V10( CorporateActionGeneralInformation144 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus12Choice_ reqInstructionCancellationRequestStatus )
    {
