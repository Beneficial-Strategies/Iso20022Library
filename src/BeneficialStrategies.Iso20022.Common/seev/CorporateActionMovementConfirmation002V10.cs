...
public partial record CorporateActionMovementConfirmation002V10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmation002V10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmation002V10( CorporateActionGeneralInformation130 reqCorporateActionGeneralInformation,AccountAndBalance45 reqAccountDetails,CorporateActionOption159 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption159 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption159 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption159 CorporateActionConfirmationDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementConfirmation002V10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmation002V10.
