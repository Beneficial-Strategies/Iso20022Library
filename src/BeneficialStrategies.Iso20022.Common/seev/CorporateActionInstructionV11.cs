...
public partial record CorporateActionInstructionV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionV11( CorporateActionGeneralInformation156 reqCorporateActionGeneralInformation,AccountAndBalance41 reqAccountDetails,CorporateActionOption180 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation156 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation156 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation156 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public PartyIdentification236? BeneficialOwnerDetails { get; init; } 
    #else
    public PartyIdentification236? BeneficialOwnerDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption180 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption180 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption180 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionV11Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionV11.
