...
public partial record CorporateActionCancellationAdviceV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdviceV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdviceV07( CorporateActionCancellation3 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation108 reqCorporateActionGeneralInformation,AccountIdentification29Choice_ reqAccountsDetails )
    {
    ...
    public required CorporateActionGeneralInformation108 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation108 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation108 CorporateActionGeneralInformation { get; set; } 
    #endif
