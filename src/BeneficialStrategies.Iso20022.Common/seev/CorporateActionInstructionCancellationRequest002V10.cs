...
public partial record CorporateActionInstructionCancellationRequest002V10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequest002V10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequest002V10( DocumentIdentification37 reqInstructionIdentification,CorporateActionGeneralInformation159 reqCorporateActionGeneralInformation,AccountIdentification49 reqAccountDetails,CorporateActionOption192 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionOption192 CorporateActionInstruction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption192 CorporateActionInstruction { get; init; } 
    #else
    public CorporateActionOption192 CorporateActionInstruction { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequest002V10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequest002V10.
