...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdviceV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV12( CorporateActionGeneralInformation154 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus13Choice_ reqInstructionCancellationRequestStatus )
    {
    ...
    public required InstructionCancellationRequestStatus13Choice_ InstructionCancellationRequestStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionCancellationRequestStatus13Choice_ InstructionCancellationRequestStatus { get; init; } 
    #else
    public InstructionCancellationRequestStatus13Choice_ InstructionCancellationRequestStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequestStatusAdviceV12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestStatusAdviceV12.
