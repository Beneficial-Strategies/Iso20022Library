...
/// <summary>
/// This record is an implementation of the seev.035.002.12 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdvice002V12 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.035.002.12";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdvice002V12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdvice002V12( CorporateActionPreliminaryAdviceType2 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation151 reqCorporateActionGeneralInformation,AccountIdentification45Choice_ reqAccountDetails )
    {
    ...
    public CorporateActionOption190? CorporateActionMovementDetails { get; init; } 
    #else
    public CorporateActionOption190? CorporateActionMovementDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdvice002V12Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdvice002V12.
