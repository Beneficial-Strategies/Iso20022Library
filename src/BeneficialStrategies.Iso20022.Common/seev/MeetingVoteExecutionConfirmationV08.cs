...
public partial record MeetingVoteExecutionConfirmationV08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingVoteExecutionConfirmationV08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingVoteExecutionConfirmationV08( System.String reqMeetingInstructionIdentification,MeetingReference10 reqMeetingReference,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public DetailedInstructionStatus17? VoteInstructions { get; init; } 
    #else
    public DetailedInstructionStatus17? VoteInstructions { get; set; } 
    #endif
