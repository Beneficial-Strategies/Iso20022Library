...
/// <summary>
/// This record is an implementation of the seev.044.002.07 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdvice002V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.044.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceCancellationAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceCancellationAdvice002V07( DocumentIdentification37 reqMovementPreliminaryAdviceIdentification,CorporateActionGeneralInformation123 reqCorporateActionGeneralInformation,AccountIdentification34Choice_ reqAccountDetails )
    {
    ...
    #else
    public CorporateActionGeneralInformation123 CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdviceCancellationAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceCancellationAdvice002V07.
