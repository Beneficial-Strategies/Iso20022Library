...
/// <summary>
/// This record is an implementation of the seev.038.002.06 ISO standard message type.
...
public partial record CorporateActionNarrative002V06 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.038.002.06";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNarrative002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNarrative002V06( CorporateActionGeneralInformation102 reqCorporateActionGeneralInformation,UpdatedAdditionalInformation10 reqAdditionalInformation )
    {
...
// Since CorporateActionNarrative002V06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNarrative002V06.
