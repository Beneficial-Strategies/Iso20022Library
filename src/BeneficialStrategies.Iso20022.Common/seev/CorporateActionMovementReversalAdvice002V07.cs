...
public partial record CorporateActionMovementReversalAdvice002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V07( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation98 reqCorporateActionGeneralInformation,AccountAndBalance40 reqAccountDetails,CorporateActionOption126 reqCorporateActionConfirmationDetails )
    {
