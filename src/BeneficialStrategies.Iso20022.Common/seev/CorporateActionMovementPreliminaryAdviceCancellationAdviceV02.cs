...
/// <summary>
/// This record is an implementation of the seev.044.001.02 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.044.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceCancellationAdviceV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceCancellationAdviceV02( CorporateActionProcessingStatus1Choice_ reqCancellationAdviceGeneralInformation,DocumentIdentification15 reqMovementPreliminaryAdviceIdentification,CorporateActionGeneralInformation25 reqCorporateActionGeneralInformation,AccountIdentification13Choice_ reqAccountDetails )
    {
...
// Since CorporateActionMovementPreliminaryAdviceCancellationAdviceV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceCancellationAdviceV02.
