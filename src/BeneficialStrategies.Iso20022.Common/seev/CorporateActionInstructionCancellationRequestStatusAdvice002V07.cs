...
/// <summary>
/// This record is an implementation of the seev.041.002.07 ISO standard message type.
...
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.041.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestStatusAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdvice002V07( CorporateActionGeneralInformation114 reqCorporateActionGeneralInformation,InstructionCancellationRequestStatus12Choice_ reqInstructionCancellationRequestStatus )
    {
...
// Since CorporateActionInstructionCancellationRequestStatusAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestStatusAdvice002V07.
