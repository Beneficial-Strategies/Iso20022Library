...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceCancellationAdviceV11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceCancellationAdviceV11( DocumentIdentification31 reqMovementPreliminaryAdviceIdentification,CorporateActionGeneralInformation140 reqCorporateActionGeneralInformation,AccountIdentification49Choice_ reqAccountDetails )
    {
