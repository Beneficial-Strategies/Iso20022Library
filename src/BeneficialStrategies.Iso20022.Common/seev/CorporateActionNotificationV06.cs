...
public partial record CorporateActionNotificationV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNotificationV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNotificationV06( CorporateActionNotification5 reqNotificationGeneralInformation,CorporateActionGeneralInformation85 reqCorporateActionGeneralInformation,AccountIdentification32Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation85 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation85 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation85 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionOption114? CorporateActionOptionDetails { get; init; } 
    #else
    public CorporateActionOption114? CorporateActionOptionDetails { get; set; } 
    #endif
...
// Since CorporateActionNotificationV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV06.
