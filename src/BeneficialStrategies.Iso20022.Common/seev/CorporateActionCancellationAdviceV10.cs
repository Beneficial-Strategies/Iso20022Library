...
public partial record CorporateActionCancellationAdviceV10 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionCancellationAdviceV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionCancellationAdviceV10( CorporateActionCancellation3 reqCancellationAdviceGeneralInformation,CorporateActionGeneralInformation135 reqCorporateActionGeneralInformation,AccountIdentification40Choice_ reqAccountsDetails )
    {
...
// Since CorporateActionCancellationAdviceV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionCancellationAdviceV10.
