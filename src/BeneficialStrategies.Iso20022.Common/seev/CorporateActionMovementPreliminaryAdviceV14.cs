...
/// <summary>
/// This record is an implementation of the seev.035.001.14 ISO standard message type.
...
public partial record CorporateActionMovementPreliminaryAdviceV14 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.035.001.14";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceV14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceV14( CorporateActionPreliminaryAdviceType3 reqMovementPreliminaryAdviceGeneralInformation,CorporateActionGeneralInformation163 reqCorporateActionGeneralInformation,AccountIdentification47Choice_ reqAccountDetails )
    {
    ...
    public CorporateAction69? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction69? CorporateActionDetails { get; set; } 
    #endif
    ...
    public CorporateActionOption209? CorporateActionMovementDetails { get; init; } 
    #else
    public CorporateActionOption209? CorporateActionMovementDetails { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdviceV14Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceV14.
