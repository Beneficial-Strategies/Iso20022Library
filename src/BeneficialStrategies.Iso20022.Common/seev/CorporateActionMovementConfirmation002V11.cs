...
public partial record CorporateActionMovementConfirmation002V11 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmation002V11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmation002V11( CorporateActionGeneralInformation149 reqCorporateActionGeneralInformation,AccountAndBalance45 reqAccountDetails,CorporateActionOption173 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption173 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption173 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption173 CorporateActionConfirmationDetails { get; set; } 
    #endif
