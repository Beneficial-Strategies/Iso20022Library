...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceCancellationAdviceV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceCancellationAdviceV06( DocumentIdentification31 reqMovementPreliminaryAdviceIdentification,CorporateActionGeneralInformation87 reqCorporateActionGeneralInformation,AccountIdentification29Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation87 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation87 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation87 CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since CorporateActionMovementPreliminaryAdviceCancellationAdviceV06Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementPreliminaryAdviceCancellationAdviceV06.
