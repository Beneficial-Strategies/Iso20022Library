...
public partial record CorporateActionEventProcessingStatusAdvice002V08 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventProcessingStatusAdvice002V08 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventProcessingStatusAdvice002V08( CorporateActionGeneralInformation158 reqCorporateActionGeneralInformation,EventProcessingStatus6Choice_ reqEventProcessingStatus )
    {
