...
public partial record CorporateActionNarrativeV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNarrativeV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNarrativeV07( CorporateActionGeneralInformation92 reqCorporateActionGeneralInformation,UpdatedAdditionalInformation8 reqAdditionalInformation )
    {
    ...
    public AccountIdentification48Choice_? AccountDetails { get; init; } 
    #else
    public AccountIdentification48Choice_? AccountDetails { get; set; } 
    #endif
