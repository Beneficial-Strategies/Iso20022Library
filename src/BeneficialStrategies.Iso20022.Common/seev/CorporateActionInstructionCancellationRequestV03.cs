...
public partial record CorporateActionInstructionCancellationRequestV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionCancellationRequestV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionCancellationRequestV03( DocumentIdentification15 reqInstructionIdentification,CorporateActionGeneralInformation33 reqCorporateActionGeneralInformation,AccountIdentification17 reqAccountDetails,CorporateActionOption42 reqCorporateActionInstruction )
    {
    ...
    public required CorporateActionGeneralInformation33 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation33 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation33 CorporateActionGeneralInformation { get; set; } 
    #endif
...
// Since CorporateActionInstructionCancellationRequestV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionCancellationRequestV03.
