...
/// <summary>
/// This record is an implementation of the seev.031.001.10 ISO standard message type.
...
public partial record CorporateActionNotificationV10 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.031.001.10";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNotificationV10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNotificationV10( CorporateActionNotification5 reqNotificationGeneralInformation,CorporateActionGeneralInformation136 reqCorporateActionGeneralInformation,AccountIdentification41Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation136 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation136 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation136 CorporateActionGeneralInformation { get; set; } 
    #endif
    
    /// <summary>
    /// General information about the safekeeping account, owner and account balance.
    /// </summary>
    [IsoId("_hpjSy-XjEemEj48jhmlA0Q")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateAction56? CorporateActionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateAction56? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction56? CorporateActionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Information about the corporate action option.
    /// </summary>
    [IsoId("_hpjS0eXjEemEj48jhmlA0Q")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionOption163? CorporateActionOptionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption163? CorporateActionOptionDetails { get; init; } 
    #else
    public CorporateActionOption163? CorporateActionOptionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information on the event.
    /// </summary>
    [IsoId("_hpjS0-XjEemEj48jhmlA0Q")]
    ...
    [IsoXmlTag("AddtlInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionNarrative42? AdditionalInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionNarrative42? AdditionalInformation { get; init; } 
    #else
    public CorporateActionNarrative42? AdditionalInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Party appointed to administer the event on behalf of the issuer company/offeror. The party may be contacted for more information about the event.
    /// </summary>
    [IsoId("_hpjS1eXjEemEj48jhmlA0Q")]
...
// Since CorporateActionNotificationV10Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionNotificationV10.
