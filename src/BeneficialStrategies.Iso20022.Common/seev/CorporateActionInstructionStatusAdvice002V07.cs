...
[DataContract]
#endif
public partial record CorporateActionInstructionStatusAdvice002V07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructionStatusAdvice002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructionStatusAdvice002V07( CorporateActionGeneralInformation94 reqCorporateActionGeneralInformation,InstructionProcessingStatus25Choice_ reqInstructionProcessingStatus )
    {
    ...
    public required CorporateActionGeneralInformation94 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation94 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation94 CorporateActionGeneralInformation { get; set; } 
    #endif
    ...
    public required InstructionProcessingStatus25Choice_ InstructionProcessingStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructionProcessingStatus25Choice_ InstructionProcessingStatus { get; init; } 
    #else
    public InstructionProcessingStatus25Choice_ InstructionProcessingStatus { get; set; } 
    #endif
...
// Since CorporateActionInstructionStatusAdvice002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionInstructionStatusAdvice002V07.
