...
public partial record CorporateActionNarrativeV04 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionNarrativeV04 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionNarrativeV04( CorporateActionGeneralInformation92 reqCorporateActionGeneralInformation,UpdatedAdditionalInformation8 reqAdditionalInformation )
    {
    ...
    public AccountIdentification33Choice_? AccountDetails { get; init; } 
    #else
    public AccountIdentification33Choice_? AccountDetails { get; set; } 
    #endif
