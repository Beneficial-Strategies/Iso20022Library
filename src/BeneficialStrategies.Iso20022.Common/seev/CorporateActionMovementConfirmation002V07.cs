...
/// <summary>
/// This record is an implementation of the seev.036.002.07 ISO standard message type.
...
[DataContract]
#endif
public partial record CorporateActionMovementConfirmation002V07 : IOuterRecord
{
    
    /// <summary>
    /// The official ISO 20022 designation for this version of this message.
    /// </summary>
    public const string IsoIdentifier = "seev.036.002.07";
    ...
    /// </summary>
    public const string DocumentNamespace = "urn:iso:std:iso:20022:tech:xsd:seev.036.002.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmation002V07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmation002V07( CorporateActionGeneralInformation98 reqCorporateActionGeneralInformation,AccountAndBalance38 reqAccountDetails,CorporateActionOption124 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionGeneralInformation98 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation98 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation98 CorporateActionGeneralInformation { get; set; } 
    #endif
    
    /// <summary>
    /// General information about the safekeeping account, owner and account balance.
    /// </summary>
    [IsoId("_cjrMD5KQEeWHWpTQn1FFVg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required CorporateActionOption124 CorporateActionConfirmationDetails { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required CorporateActionOption124 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption124 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption124 CorporateActionConfirmationDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information.
    /// </summary>
    [IsoId("_cjrMFZKQEeWHWpTQn1FFVg")]
...
// Since CorporateActionMovementConfirmation002V07Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CorporateActionMovementConfirmation002V07.
