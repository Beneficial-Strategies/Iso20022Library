...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdvice002V06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementPreliminaryAdviceCancellationAdvice002V06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementPreliminaryAdviceCancellationAdvice002V06( DocumentIdentification37 reqMovementPreliminaryAdviceIdentification,CorporateActionGeneralInformation99 reqCorporateActionGeneralInformation,AccountIdentification34Choice_ reqAccountDetails )
    {
    ...
    public required CorporateActionGeneralInformation99 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation99 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation99 CorporateActionGeneralInformation { get; set; } 
    #endif
