...
[IsoId("_TlSmJNEwEd-BzquC8wXy7w_-1183208887")]
...
public partial record MeetingCancellationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MeetingCancellationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MeetingCancellationV03( MessageIdentification1 reqIdentification,MeetingReference5 reqMeetingReference,MeetingCancellationReason2 reqReason )
    {
...
// Since MeetingCancellationV03Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MeetingCancellationV03.
