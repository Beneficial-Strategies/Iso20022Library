...
/// <summary>
/// This record is an implementation of the seev.037.001.07 ISO standard message type.
...
public partial record CorporateActionMovementReversalAdviceV07 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "seev.037.001.07";
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdviceV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdviceV07( DocumentIdentification31 reqMovementConfirmationIdentification,CorporateActionGeneralInformation89 reqCorporateActionGeneralInformation,AccountAndBalance36 reqAccountDetails,CorporateActionOption119 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionGeneralInformation89 CorporateActionGeneralInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionGeneralInformation89 CorporateActionGeneralInformation { get; init; } 
    #else
    public CorporateActionGeneralInformation89 CorporateActionGeneralInformation { get; set; } 
    #endif
