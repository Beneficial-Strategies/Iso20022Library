...
public partial record CorporateActionMovementReversalAdvice002V14 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementReversalAdvice002V14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementReversalAdvice002V14( DocumentIdentification37 reqMovementConfirmationIdentification,CorporateActionGeneralInformation167 reqCorporateActionGeneralInformation,AccountAndBalance54 reqAccountDetails,CorporateActionOption215 reqCorporateActionConfirmationDetails )
    {
    ...
    public CorporateActionReversalReason7? ReversalReason { get; init; } 
    #else
    public CorporateActionReversalReason7? ReversalReason { get; set; } 
    #endif
    ...
    public CorporateAction78? CorporateActionDetails { get; init; } 
    #else
    public CorporateAction78? CorporateActionDetails { get; set; } 
    #endif
    ...
    public required CorporateActionOption215 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption215 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption215 CorporateActionConfirmationDetails { get; set; } 
    #endif
