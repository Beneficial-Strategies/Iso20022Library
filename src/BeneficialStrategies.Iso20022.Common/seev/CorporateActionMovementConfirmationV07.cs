...
public partial record CorporateActionMovementConfirmationV07 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementConfirmationV07 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementConfirmationV07( CorporateActionGeneralInformation89 reqCorporateActionGeneralInformation,AccountAndBalance34 reqAccountDetails,CorporateActionOption117 reqCorporateActionConfirmationDetails )
    {
    ...
    public required CorporateActionOption117 CorporateActionConfirmationDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption117 CorporateActionConfirmationDetails { get; init; } 
    #else
    public CorporateActionOption117 CorporateActionConfirmationDetails { get; set; } 
    #endif
