...
public partial record ATMWithdrawalRequestV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMWithdrawalRequestV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMWithdrawalRequestV02( Header31 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ATMWithdrawalRequest2? ATMWithdrawalRequest { get; init; } 
    #else
    public ATMWithdrawalRequest2? ATMWithdrawalRequest { get; set; } 
    #endif
