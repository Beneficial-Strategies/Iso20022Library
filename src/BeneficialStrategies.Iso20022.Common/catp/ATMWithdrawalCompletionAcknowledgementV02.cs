...
/// <summary>
/// This record is an implementation of the catp.004.001.02 ISO standard message type.
...
public partial record ATMWithdrawalCompletionAcknowledgementV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "catp.004.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a ATMWithdrawalCompletionAcknowledgementV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMWithdrawalCompletionAcknowledgementV02( Header32 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ATMWithdrawalCompletionAcknowledgement2? ATMWithdrawalCompletionAcknowledgement { get; init; } 
    #else
    public ATMWithdrawalCompletionAcknowledgement2? ATMWithdrawalCompletionAcknowledgement { get; set; } 
    #endif
...
// Since ATMWithdrawalCompletionAcknowledgementV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ATMWithdrawalCompletionAcknowledgementV02.
