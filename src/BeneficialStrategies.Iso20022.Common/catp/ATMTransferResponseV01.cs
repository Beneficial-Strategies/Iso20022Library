...
public partial record ATMTransferResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMTransferResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMTransferResponseV01( Header31 reqHeader )
    {
        Header = reqHeader;
    }
    #endif
    ...
    public ContentInformationType10? ProtectedATMTransferResponse { get; init; } 
    #else
    public ContentInformationType10? ProtectedATMTransferResponse { get; set; } 
    #endif
    ...
    public ATMTransferResponse1? ATMTransferResponse { get; init; } 
    #else
    public ATMTransferResponse1? ATMTransferResponse { get; set; } 
    #endif
