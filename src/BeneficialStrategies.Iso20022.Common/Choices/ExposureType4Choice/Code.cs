...
namespace BeneficialStrategies.Iso20022.Choices.ExposureType4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : ExposureType4Choice_
    #else
    public partial class Code : ExposureType4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExposureType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExposureType2Code Value { get; init; } 
        #else
        public ExposureType2Code Value { get; set; } 
        #endif
