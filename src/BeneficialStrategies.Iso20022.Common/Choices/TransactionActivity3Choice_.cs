...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TransactionActivity3Choice.Code),
        nameof(TransactionActivity3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(TransactionActivity3Choice.Proprietary),
        nameof(TransactionActivity3Choice.Proprietary)
    )]
    [IsoId("_iF2-wTqDEeWVrPy0StzzSg")]
    [DisplayName("Transaction Activity 3 Choice")]
    public abstract record TransactionActivity3Choice_ { }
}
