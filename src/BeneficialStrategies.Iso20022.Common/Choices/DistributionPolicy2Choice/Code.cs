...
namespace BeneficialStrategies.Iso20022.Choices.DistributionPolicy2Choice
{
    ...
    #else
    public partial class Code : DistributionPolicy2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DistributionPolicy1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DistributionPolicy1Code Value { get; init; } 
        #else
        public DistributionPolicy1Code Value { get; set; } 
        #endif
