...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus76Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : ProcessingStatus76Choice_
    #else
    public partial class ModificationRequested : ProcessingStatus76Choice_
    #endif
    {
