...
namespace BeneficialStrategies.Iso20022.Choices.ShareRanking1FormatChoice
{
    ...
    #else
    public partial class Code : ShareRanking1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ShareRanking1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ShareRanking1Code Value { get; init; } 
        #else
        public ShareRanking1Code Value { get; set; } 
        #endif
