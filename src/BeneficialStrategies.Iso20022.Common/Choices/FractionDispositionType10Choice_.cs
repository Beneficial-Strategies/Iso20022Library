...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FractionDispositionType10Choice.Code),
        nameof(FractionDispositionType10Choice.Code)
    )]
    [JsonDerivedType(
        typeof(FractionDispositionType10Choice.Proprietary),
        nameof(FractionDispositionType10Choice.Proprietary)
    )]
    [IsoId("_XZY5UeHEEd-1Ktb5rVaajw")]
    [DisplayName("Fraction Disposition Type 10 Choice")]
    public abstract record FractionDispositionType10Choice_ { }
}
