...
namespace BeneficialStrategies.Iso20022.Choices.EUCapitalGainType1Choice
{
    ...
    /// </summary>
    [IsoId("_RgcdFtp-Ed-ak6NoX_4Aeg_-1765424373")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record EUCapitalGain : EUCapitalGainType1Choice_
    #else
    public partial class EUCapitalGain : EUCapitalGainType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a EUCapitalGain instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public EUCapitalGain( EUCapitalGain2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
