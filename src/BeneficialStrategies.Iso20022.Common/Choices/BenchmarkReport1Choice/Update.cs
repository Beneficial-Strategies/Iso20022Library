...
namespace BeneficialStrategies.Iso20022.Choices.BenchmarkReport1Choice
{
    ...
    #else
    public partial class Update : BenchmarkReport1Choice_
    #endif
    {
        ...
        /// </summary>
        public Update( SecurityIdentification19 reqIdentification,BenchmarkDetail1 reqOther,PartyIdentification136 reqAdministrator )
        {
