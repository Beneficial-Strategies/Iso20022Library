...
namespace BeneficialStrategies.Iso20022.Choices.Reversal7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record TransferInConfirmationDetails : Reversal7Choice_
    #else
    public partial class TransferInConfirmationDetails : Reversal7Choice_
    #endif
    {
        ...
        /// </summary>
        public TransferInConfirmationDetails( InvestmentAccount56 reqAccountDetails )
        {
