...
namespace BeneficialStrategies.Iso20022.Choices.ReceivedReason2Choice
{
    ...
    #else
    public partial class Code : ReceivedReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalReceivedReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalReceivedReason1Code Value { get; init; } 
        #else
        public ExternalReceivedReason1Code Value { get; set; } 
        #endif
