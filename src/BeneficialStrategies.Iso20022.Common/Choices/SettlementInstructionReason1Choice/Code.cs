...
namespace BeneficialStrategies.Iso20022.Choices.SettlementInstructionReason1Choice
{
    ...
    #else
    public partial class Code : SettlementInstructionReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementInstructionReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementInstructionReason1Code Value { get; init; } 
        #else
        public SettlementInstructionReason1Code Value { get; set; } 
        #endif
