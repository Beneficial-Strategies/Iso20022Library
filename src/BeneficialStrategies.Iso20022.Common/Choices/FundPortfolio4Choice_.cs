...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FundPortfolio4Choice.TaxEfficientProduct),
        nameof(FundPortfolio4Choice.TaxEfficientProduct)
    )]
    [JsonDerivedType(
        typeof(FundPortfolio4Choice.GeneralInvestment),
        nameof(FundPortfolio4Choice.GeneralInvestment)
    )]
    ...
    public abstract record FundPortfolio4Choice_ { }
}
