...
namespace BeneficialStrategies.Iso20022.Choices.ClearingSystemMemberIdentificationChoice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CanadianPaymentsAssociationRoutingNumberIdentification : ClearingSystemMemberIdentificationChoice_
    #else
    public partial class CanadianPaymentsAssociationRoutingNumberIdentification : ClearingSystemMemberIdentificationChoice_
    #endif
    {
