...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason24Choice
{
    ...
    #else
    public partial class Code : CancellationReason24Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancelledStatusReason13Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancelledStatusReason13Code Value { get; init; } 
        #else
        public CancelledStatusReason13Code Value { get; set; } 
        #endif
