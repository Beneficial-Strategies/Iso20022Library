...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionOrRepairStatus14Choice_
    #else
    public partial class Reason : RejectionOrRepairStatus14Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionAndRepairReason13Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public RejectionAndRepairReason13Choice_ Code { get; init; } 
        #else
        public RejectionAndRepairReason13Choice_ Code { get; set; } 
        #endif
