...
namespace BeneficialStrategies.Iso20022.Choices.BalanceFormat12Choice
{
    ...
    #else
    public partial class PartWayPeriodUnits : BalanceFormat12Choice_
    #endif
    {
        ...
        /// </summary>
        public PartWayPeriodUnits( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity33Choice_ reqQuantity )
        {
