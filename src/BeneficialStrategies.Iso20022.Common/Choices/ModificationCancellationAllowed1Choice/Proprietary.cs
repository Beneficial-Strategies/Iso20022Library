...
namespace BeneficialStrategies.Iso20022.Choices.ModificationCancellationAllowed1Choice
{
    ...
    /// </summary>
    [IsoId("_Qt7bBNp-Ed-ak6NoX_4Aeg_1213217598")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ModificationCancellationAllowed1Choice_
    #else
    public partial class Proprietary : ModificationCancellationAllowed1Choice_
    #endif
    {
