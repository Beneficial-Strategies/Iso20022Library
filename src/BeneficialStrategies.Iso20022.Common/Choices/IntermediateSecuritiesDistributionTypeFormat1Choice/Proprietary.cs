...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecuritiesDistributionTypeFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q3UnlNp-Ed-ak6NoX_4Aeg_1110084068")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IntermediateSecuritiesDistributionTypeFormat1Choice_
    #else
    public partial class Proprietary : IntermediateSecuritiesDistributionTypeFormat1Choice_
    #endif
    {
