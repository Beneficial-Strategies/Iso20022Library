...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecuritiesDistributionTypeFormat1Choice
{
    ...
    #else
    public partial class Code : IntermediateSecuritiesDistributionTypeFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( IntermediateSecurityDistributionType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public IntermediateSecurityDistributionType3Code Value { get; init; } 
        #else
        public IntermediateSecurityDistributionType3Code Value { get; set; } 
        #endif
