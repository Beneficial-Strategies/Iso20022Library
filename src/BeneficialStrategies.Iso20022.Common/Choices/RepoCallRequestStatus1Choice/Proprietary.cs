...
namespace BeneficialStrategies.Iso20022.Choices.RepoCallRequestStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UXIWV9p-Ed-ak6NoX_4Aeg_-695454166")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RepoCallRequestStatus1Choice_
    #else
    public partial class Proprietary : RepoCallRequestStatus1Choice_
    #endif
    {
