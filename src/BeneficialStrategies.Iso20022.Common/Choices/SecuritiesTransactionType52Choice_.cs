...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SecuritiesTransactionType52Choice.Code),
        nameof(SecuritiesTransactionType52Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SecuritiesTransactionType52Choice.Proprietary),
        nameof(SecuritiesTransactionType52Choice.Proprietary)
    )]
    [IsoId("_J4Cyy_fYEeiNZp_PtLohLw")]
    [DisplayName("Securities Transaction Type 52 Choice")]
    public abstract record SecuritiesTransactionType52Choice_ { }
}
