...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason10Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason10Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason7Code Value { get; init; } 
        #else
        public UnmatchedReason7Code Value { get; set; } 
        #endif
