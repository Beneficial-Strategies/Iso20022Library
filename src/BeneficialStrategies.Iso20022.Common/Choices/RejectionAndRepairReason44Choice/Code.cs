...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason44Choice
{
    ...
    #else
    public partial class Code : RejectionAndRepairReason44Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason77Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason77Code Value { get; init; } 
        #else
        public RejectionReason77Code Value { get; set; } 
        #endif
