...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption5Choice
{
    ...
    #else
    public partial class Code : CorporateActionOption5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOption6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOption6Code Value { get; init; } 
        #else
        public CorporateActionOption6Code Value { get; set; } 
        #endif
