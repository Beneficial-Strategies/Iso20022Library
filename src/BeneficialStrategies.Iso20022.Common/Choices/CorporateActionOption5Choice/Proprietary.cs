...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption5Choice
{
    ...
    /// </summary>
    [IsoId("_Q0CqFNp-Ed-ak6NoX_4Aeg_-289326687")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption5Choice_
    #else
    public partial class Proprietary : CorporateActionOption5Choice_
    #endif
    {
