...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PrimaryOwner : AccountParties7Choice_
    #else
    public partial class PrimaryOwner : AccountParties7Choice_
    #endif
    {
        ...
        /// </summary>
        public PrimaryOwner( Party23Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
