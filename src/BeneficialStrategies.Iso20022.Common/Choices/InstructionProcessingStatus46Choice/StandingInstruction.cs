...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus46Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record StandingInstruction : InstructionProcessingStatus46Choice_
    #else
    public partial class StandingInstruction : InstructionProcessingStatus46Choice_
    #endif
    {
