...
namespace BeneficialStrategies.Iso20022.Choices.TransferUnmatchedStatus3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : TransferUnmatchedStatus3Choice_
    #else
    public partial class NoSpecifiedReason : TransferUnmatchedStatus3Choice_
    #endif
    {
