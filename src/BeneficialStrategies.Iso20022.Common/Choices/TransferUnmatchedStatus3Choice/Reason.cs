...
namespace BeneficialStrategies.Iso20022.Choices.TransferUnmatchedStatus3Choice
{
    ...
    #else
    public partial class Reason : TransferUnmatchedStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( TransferUnmatchedReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransferUnmatchedReason2Code Value { get; init; } 
        #else
        public TransferUnmatchedReason2Code Value { get; set; } 
        #endif
