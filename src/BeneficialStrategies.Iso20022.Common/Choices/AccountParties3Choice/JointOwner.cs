...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record JointOwner : AccountParties3Choice_
    #else
    public partial class JointOwner : AccountParties3Choice_
    #endif
    {
        ...
        /// </summary>
        public JointOwner( Party15Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
