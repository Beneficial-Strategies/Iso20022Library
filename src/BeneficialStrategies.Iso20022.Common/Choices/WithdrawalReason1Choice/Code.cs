...
namespace BeneficialStrategies.Iso20022.Choices.WithdrawalReason1Choice
{
    ...
    #else
    public partial class Code : WithdrawalReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PortfolioWithdrawalReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PortfolioWithdrawalReason1Code Value { get; init; } 
        #else
        public PortfolioWithdrawalReason1Code Value { get; set; } 
        #endif
