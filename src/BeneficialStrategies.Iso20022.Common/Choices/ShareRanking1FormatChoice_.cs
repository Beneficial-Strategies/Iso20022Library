...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ShareRanking1FormatChoice.Code),
        nameof(ShareRanking1FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(ShareRanking1FormatChoice.Proprietary),
        nameof(ShareRanking1FormatChoice.Proprietary)
    )]
    [IsoId("_Ro8Rw9p-Ed-ak6NoX_4Aeg_1933759381")]
    [DisplayName("Share Ranking 1 Format Choice")]
    public abstract record ShareRanking1FormatChoice_ { }
}
