...
namespace BeneficialStrategies.Iso20022.Choices.AdjustmentType1Choice
{
    ...
    #else
    public partial class Type : AdjustmentType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Type( AdjustmentType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AdjustmentType2Code Value { get; init; } 
        #else
        public AdjustmentType2Code Value { get; set; } 
        #endif
