...
namespace BeneficialStrategies.Iso20022.Choices.AdjustmentType1Choice
{
    ...
    #else
    public partial class OtherAdjustmentType : AdjustmentType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a OtherAdjustmentType instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public OtherAdjustmentType( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
