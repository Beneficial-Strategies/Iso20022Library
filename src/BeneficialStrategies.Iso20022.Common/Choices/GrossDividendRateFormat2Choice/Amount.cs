...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat2Choice
{
    ...
    /// </summary>
    [IsoId("_UNAJ99p-Ed-ak6NoX_4Aeg_1829064661")]
    [DisplayName("Amount")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat2Choice_
    #else
    public partial class Amount : GrossDividendRateFormat2Choice_
    #endif
    {
