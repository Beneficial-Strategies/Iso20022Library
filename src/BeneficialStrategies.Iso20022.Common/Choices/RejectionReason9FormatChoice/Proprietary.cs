...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason9FormatChoice
{
    ...
    /// </summary>
    [IsoId("_Roovx9p-Ed-ak6NoX_4Aeg_287891056")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason9FormatChoice_
    #else
    public partial class Proprietary : RejectionReason9FormatChoice_
    #endif
    {
