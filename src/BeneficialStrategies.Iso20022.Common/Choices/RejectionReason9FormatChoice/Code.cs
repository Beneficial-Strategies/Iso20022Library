...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason9FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason9FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason9Code Value { get; init; } 
        #else
        public RejectionReason9Code Value { get; set; } 
        #endif
