...
namespace BeneficialStrategies.Iso20022.Choices.BillingRateIdentification1Choice
{
    ...
    /// </summary>
    [IsoId("_6Q_lgJqlEeGSON8vddiWzQ_-1814132724")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BillingRateIdentification1Choice_
    #else
    public partial class Proprietary : BillingRateIdentification1Choice_
    #endif
    {
