...
namespace BeneficialStrategies.Iso20022.Choices.DistributionType1FormatChoice
{
    ...
    #else
    public partial class Code : DistributionType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( DistributionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DistributionType1Code Value { get; init; } 
        #else
        public DistributionType1Code Value { get; set; } 
        #endif
