...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat28Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : NetDividendRateFormat28Choice_
    #else
    public partial class NotSpecifiedRate : NetDividendRateFormat28Choice_
    #endif
    {
