...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementDateCode1Choice.Code),
        nameof(SettlementDateCode1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementDateCode1Choice.Proprietary),
        nameof(SettlementDateCode1Choice.Proprietary)
    )]
    [IsoId("_QvRe0Np-Ed-ak6NoX_4Aeg_308749085")]
    [DisplayName("Settlement Date Code 1 Choice")]
    public abstract record SettlementDateCode1Choice_ { }
}
