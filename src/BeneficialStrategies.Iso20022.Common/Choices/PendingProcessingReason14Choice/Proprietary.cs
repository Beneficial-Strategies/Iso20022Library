...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingReason14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingProcessingReason14Choice_
    #else
    public partial class Proprietary : PendingProcessingReason14Choice_
    #endif
    {
