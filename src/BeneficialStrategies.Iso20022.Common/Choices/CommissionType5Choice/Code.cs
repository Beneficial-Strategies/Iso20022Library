...
namespace BeneficialStrategies.Iso20022.Choices.CommissionType5Choice
{
    ...
    #else
    public partial class Code : CommissionType5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CommissionType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CommissionType6Code Value { get; init; } 
        #else
        public CommissionType6Code Value { get; set; } 
        #endif
