...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification23Choice
{
    ...
    /// </summary>
    [IsoId("_QReIgtp-Ed-ak6NoX_4Aeg_-1086683059")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BICOrBEI : PartyIdentification23Choice_
    #else
    public partial class BICOrBEI : PartyIdentification23Choice_
    #endif
    {
