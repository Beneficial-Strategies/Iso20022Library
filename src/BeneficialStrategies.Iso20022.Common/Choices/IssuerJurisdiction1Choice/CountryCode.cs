...
namespace BeneficialStrategies.Iso20022.Choices.IssuerJurisdiction1Choice
{
    ...
    #else
    public partial class CountryCode : IssuerJurisdiction1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a CountryCode instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public CountryCode( string reqValue )
        {
            Value = reqValue;
        }
        #endif
