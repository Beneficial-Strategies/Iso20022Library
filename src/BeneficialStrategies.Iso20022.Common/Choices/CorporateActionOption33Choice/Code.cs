...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption33Choice
{
    ...
    #else
    public partial class Code : CorporateActionOption33Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOption12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOption12Code Value { get; init; } 
        #else
        public CorporateActionOption12Code Value { get; set; } 
        #endif
