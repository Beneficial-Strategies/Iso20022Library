...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ReservationOrError7Choice.Reservation),
        nameof(ReservationOrError7Choice.Reservation)
    )]
    [JsonDerivedType(
        typeof(ReservationOrError7Choice.BusinessError),
        nameof(ReservationOrError7Choice.BusinessError)
    )]
    [IsoId("_T0LEt5liEeeE1Ya-LgRsuQ")]
    [DisplayName("Reservation Or Error 7 Choice")]
    public abstract record ReservationOrError7Choice_ { }
}
