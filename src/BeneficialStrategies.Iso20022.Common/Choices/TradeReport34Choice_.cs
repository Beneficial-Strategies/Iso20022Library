...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TradeReport34Choice.Correction),
        nameof(TradeReport34Choice.Correction)
    )]
    [JsonDerivedType(typeof(TradeReport34Choice.Error), nameof(TradeReport34Choice.Error))]
    [JsonDerivedType(
        typeof(TradeReport34Choice.MarginUpdate),
        nameof(TradeReport34Choice.MarginUpdate)
    )]
    ...
    public abstract record TradeReport34Choice_ { }
}
