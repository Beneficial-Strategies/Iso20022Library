...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType29Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType29Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType19Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType19Code Value { get; init; } 
        #else
        public CorporateActionEventType19Code Value { get; set; } 
        #endif
