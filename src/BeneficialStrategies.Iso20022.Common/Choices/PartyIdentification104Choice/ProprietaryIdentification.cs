...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification104Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification104Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification104Choice_
    #endif
    {
