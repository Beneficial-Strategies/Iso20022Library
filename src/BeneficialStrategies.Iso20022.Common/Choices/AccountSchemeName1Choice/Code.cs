...
namespace BeneficialStrategies.Iso20022.Choices.AccountSchemeName1Choice
{
    ...
    #else
    public partial class Code : AccountSchemeName1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalAccountIdentification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalAccountIdentification1Code Value { get; init; } 
        #else
        public ExternalAccountIdentification1Code Value { get; set; } 
        #endif
