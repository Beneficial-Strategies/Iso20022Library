...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RejectionReason1Choice.GlobalRejectionReason),
        nameof(RejectionReason1Choice.GlobalRejectionReason)
    )]
    [JsonDerivedType(
        typeof(RejectionReason1Choice.RejectedElement),
        nameof(RejectionReason1Choice.RejectedElement)
    )]
    [IsoId("_RJ8ooNp-Ed-ak6NoX_4Aeg_891683676")]
    [DisplayName("Rejection Reason 1 Choice")]
    public abstract record RejectionReason1Choice_ { }
}
