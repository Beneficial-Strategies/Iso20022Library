...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountParties1Choice.PrimaryOwner),
        nameof(AccountParties1Choice.PrimaryOwner)
    )]
    [JsonDerivedType(typeof(AccountParties1Choice.Trustee), nameof(AccountParties1Choice.Trustee))]
    [JsonDerivedType(
        typeof(AccountParties1Choice.CustodianForMinor),
        nameof(AccountParties1Choice.CustodianForMinor)
    )]
    [JsonDerivedType(typeof(AccountParties1Choice.Nominee), nameof(AccountParties1Choice.Nominee))]
    [JsonDerivedType(
        typeof(AccountParties1Choice.JointOwner),
        nameof(AccountParties1Choice.JointOwner)
    )]
    [IsoId("_7vPYQxdAEeK5g-3oYI0_9Q")]
    [DisplayName("Account Parties 1 Choice")]
    public abstract record AccountParties1Choice_ { }
}
