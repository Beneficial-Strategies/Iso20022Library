...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationType1Choice
{
    ...
    /// </summary>
    [IsoId("_QAoQKNp-Ed-ak6NoX_4Aeg_-1246497888")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IdentificationType1Choice_
    #else
    public partial class Proprietary : IdentificationType1Choice_
    #endif
    {
