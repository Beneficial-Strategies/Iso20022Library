...
namespace BeneficialStrategies.Iso20022.Choices.ChargeType6Choice
{
    ...
    #else
    public partial class Code : ChargeType6Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestmentFundFee2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestmentFundFee2Code Value { get; init; } 
        #else
        public InvestmentFundFee2Code Value { get; set; } 
        #endif
