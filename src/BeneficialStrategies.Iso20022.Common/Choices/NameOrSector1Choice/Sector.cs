...
namespace BeneficialStrategies.Iso20022.Choices.NameOrSector1Choice
{
    ...
    #else
    public partial class Sector : NameOrSector1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Sector instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Sector( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
