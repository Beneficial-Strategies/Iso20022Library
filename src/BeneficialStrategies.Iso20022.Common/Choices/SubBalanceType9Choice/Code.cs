...
namespace BeneficialStrategies.Iso20022.Choices.SubBalanceType9Choice
{
    ...
    #else
    public partial class Code : SubBalanceType9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesBalanceType14Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesBalanceType14Code Value { get; init; } 
        #else
        public SecuritiesBalanceType14Code Value { get; set; } 
        #endif
