...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason36Choice
{
    ...
    #else
    public partial class Code : RejectedReason36Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason58Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason58Code Value { get; init; } 
        #else
        public RejectionReason58Code Value { get; set; } 
        #endif
