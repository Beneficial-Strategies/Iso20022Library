...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat2Choice
{
    ...
    /// </summary>
    [IsoId("_Q4XJZtp-Ed-ak6NoX_4Aeg_455311258")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AdditionalBusinessProcessFormat2Choice_
    #else
    public partial class Proprietary : AdditionalBusinessProcessFormat2Choice_
    #endif
    {
