...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason9Choice
{
    ...
    /// </summary>
    [IsoId("_0jOiAglIEeGATtfOBToyew_347124013")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason9Choice_
    #else
    public partial class Proprietary : AcknowledgementReason9Choice_
    #endif
    {
