...
namespace BeneficialStrategies.Iso20022.Choices.TradingDateCode1Choice
{
    ...
    /// </summary>
    [IsoId("_AXUwU9okEeC60axPepSq7g_1133805807")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TradingDateCode1Choice_
    #else
    public partial class Proprietary : TradingDateCode1Choice_
    #endif
    {
