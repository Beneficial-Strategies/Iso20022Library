...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(NonEligibleProceedsIndicator3Choice.Code),
        nameof(NonEligibleProceedsIndicator3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(NonEligibleProceedsIndicator3Choice.Proprietary),
        nameof(NonEligibleProceedsIndicator3Choice.Proprietary)
    )]
    [IsoId("_MvA2sUEKEeWVgfuHGaKtRQ")]
    [DisplayName("Non Eligible Proceeds Indicator 3 Choice")]
    public abstract record NonEligibleProceedsIndicator3Choice_ { }
}
