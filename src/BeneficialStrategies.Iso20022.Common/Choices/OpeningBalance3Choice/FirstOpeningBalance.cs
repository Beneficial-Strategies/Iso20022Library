...
namespace BeneficialStrategies.Iso20022.Choices.OpeningBalance3Choice
{
    ...
    #else
    public partial class FirstOpeningBalance : OpeningBalance3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a FirstOpeningBalance instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public FirstOpeningBalance( System.UInt64 reqUnit )
        {
            Unit = reqUnit;
        }
        #endif
