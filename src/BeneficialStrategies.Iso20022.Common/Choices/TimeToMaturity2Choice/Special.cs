...
namespace BeneficialStrategies.Iso20022.Choices.TimeToMaturity2Choice
{
    ...
    #else
    public partial class Special : TimeToMaturity2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Special instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Special( SpecialPurpose2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public SpecialPurpose2Code Value { get; set; } 
        #endif
