...
namespace BeneficialStrategies.Iso20022.Choices.DateFormat44Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DateCodeAndTime : DateFormat44Choice_
    #else
    public partial class DateCodeAndTime : DateFormat44Choice_
    #endif
    {
        ...
        /// </summary>
        public DateCodeAndTime( DateCode21Choice_ reqDateCode,System.TimeOnly reqTime )
        {
        ...
        #else
        public DateCode21Choice_ DateCode { get; set; } 
        #endif
