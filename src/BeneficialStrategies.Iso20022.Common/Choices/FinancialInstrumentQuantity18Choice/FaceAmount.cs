...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity18Choice
{
    ...
    /// </summary>
    [IsoId("_SrfnEtorEeCWg-hsBVGrDA_71339976")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record FaceAmount : FinancialInstrumentQuantity18Choice_
    #else
    public partial class FaceAmount : FinancialInstrumentQuantity18Choice_
    #endif
    {
