...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventProcessingTypeChoice
{
    ...
    /// </summary>
    [IsoId("_Q4g6atp-Ed-ak6NoX_4Aeg_1219970609")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventProcessingTypeChoice_
    #else
    public partial class Proprietary : CorporateActionEventProcessingTypeChoice_
    #endif
    {
