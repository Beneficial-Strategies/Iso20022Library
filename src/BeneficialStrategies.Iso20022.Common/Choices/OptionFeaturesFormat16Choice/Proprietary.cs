...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : OptionFeaturesFormat16Choice_
    #else
    public partial class Proprietary : OptionFeaturesFormat16Choice_
    #endif
    {
