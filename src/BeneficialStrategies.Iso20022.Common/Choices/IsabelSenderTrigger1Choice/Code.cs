...
namespace BeneficialStrategies.Iso20022.Choices.IsabelSenderTrigger1Choice
{
    ...
    #else
    public partial class Code : IsabelSenderTrigger1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SenderTrigger1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SenderTrigger1Code Value { get; init; } 
        #else
        public SenderTrigger1Code Value { get; set; } 
        #endif
