...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TradingPartyCapacity2Choice.Code),
        nameof(TradingPartyCapacity2Choice.Code)
    )]
    [JsonDerivedType(
        typeof(TradingPartyCapacity2Choice.Proprietary),
        nameof(TradingPartyCapacity2Choice.Proprietary)
    )]
    [IsoId("_AXehUdokEeC60axPepSq7g_-114557953")]
    [DisplayName("Trading Party Capacity 2 Choice")]
    public abstract record TradingPartyCapacity2Choice_ { }
}
