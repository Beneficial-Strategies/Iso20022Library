...
namespace BeneficialStrategies.Iso20022.Choices.PriceRateOrAmountOrUnknown3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rate : PriceRateOrAmountOrUnknown3Choice_
    #else
    public partial class Rate : PriceRateOrAmountOrUnknown3Choice_
    #endif
    {
