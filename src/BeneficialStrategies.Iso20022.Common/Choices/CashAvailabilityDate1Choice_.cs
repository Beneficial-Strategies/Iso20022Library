...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CashAvailabilityDate1Choice.NumberOfDays),
        nameof(CashAvailabilityDate1Choice.NumberOfDays)
    )]
    [JsonDerivedType(
        typeof(CashAvailabilityDate1Choice.ActualDate),
        nameof(CashAvailabilityDate1Choice.ActualDate)
    )]
    [IsoId("_Vf2nGTqwEeWZFYSPlduMhw")]
    [DisplayName("Cash Availability Date 1 Choice")]
    public abstract record CashAvailabilityDate1Choice_ { }
}
