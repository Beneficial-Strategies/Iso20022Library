...
namespace BeneficialStrategies.Iso20022.Choices.ValidationRuleSchemeName1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ValidationRuleSchemeName1Choice_
    #else
    public partial class Proprietary : ValidationRuleSchemeName1Choice_
    #endif
    {
