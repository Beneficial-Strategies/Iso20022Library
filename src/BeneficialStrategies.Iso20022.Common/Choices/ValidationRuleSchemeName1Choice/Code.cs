...
namespace BeneficialStrategies.Iso20022.Choices.ValidationRuleSchemeName1Choice
{
    ...
    #else
    public partial class Code : ValidationRuleSchemeName1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalValidationRuleIdentification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalValidationRuleIdentification1Code Value { get; init; } 
        #else
        public ExternalValidationRuleIdentification1Code Value { get; set; } 
        #endif
