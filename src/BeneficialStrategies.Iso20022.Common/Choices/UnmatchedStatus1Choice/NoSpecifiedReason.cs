...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UaHY5tp-Ed-ak6NoX_4Aeg_-2089549257")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : UnmatchedStatus1Choice_
    #else
    public partial class NoSpecifiedReason : UnmatchedStatus1Choice_
    #endif
    {
