...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason31Choice
{
    ...
    #else
    public partial class Code : RejectionAndRepairReason31Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason24Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason24Code Value { get; init; } 
        #else
        public RejectionReason24Code Value { get; set; } 
        #endif
