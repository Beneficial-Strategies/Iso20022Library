...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason31Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason31Choice_
    #endif
    {
