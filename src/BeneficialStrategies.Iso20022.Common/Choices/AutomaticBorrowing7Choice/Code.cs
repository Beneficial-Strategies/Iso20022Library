...
namespace BeneficialStrategies.Iso20022.Choices.AutomaticBorrowing7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : AutomaticBorrowing7Choice_
    #else
    public partial class Code : AutomaticBorrowing7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AutoBorrowing2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AutoBorrowing2Code Value { get; init; } 
        #else
        public AutoBorrowing2Code Value { get; set; } 
        #endif
