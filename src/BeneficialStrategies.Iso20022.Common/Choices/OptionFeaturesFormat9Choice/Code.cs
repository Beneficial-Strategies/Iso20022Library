...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat9Choice
{
    ...
    #else
    public partial class Code : OptionFeaturesFormat9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures4Code Value { get; init; } 
        #else
        public OptionFeatures4Code Value { get; set; } 
        #endif
