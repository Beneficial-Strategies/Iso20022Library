...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentFundTransactionInType1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InvestmentFundTransactionInType1Choice_
    #else
    public partial class Proprietary : InvestmentFundTransactionInType1Choice_
    #endif
    {
