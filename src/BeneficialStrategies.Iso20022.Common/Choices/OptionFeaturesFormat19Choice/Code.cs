...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat19Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : OptionFeaturesFormat19Choice_
    #else
    public partial class Code : OptionFeaturesFormat19Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures6Code Value { get; init; } 
        #else
        public OptionFeatures6Code Value { get; set; } 
        #endif
