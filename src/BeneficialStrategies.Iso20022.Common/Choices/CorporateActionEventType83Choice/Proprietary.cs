...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType83Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType83Choice_
    #else
    public partial class Proprietary : CorporateActionEventType83Choice_
    #endif
    {
