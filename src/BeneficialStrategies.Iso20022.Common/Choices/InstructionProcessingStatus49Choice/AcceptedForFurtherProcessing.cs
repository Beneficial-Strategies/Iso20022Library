...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus49Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AcceptedForFurtherProcessing : InstructionProcessingStatus49Choice_
    #else
    public partial class AcceptedForFurtherProcessing : InstructionProcessingStatus49Choice_
    #endif
    {
