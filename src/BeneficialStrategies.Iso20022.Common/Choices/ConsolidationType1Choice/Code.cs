...
namespace BeneficialStrategies.Iso20022.Choices.ConsolidationType1Choice
{
    ...
    #else
    public partial class Code : ConsolidationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ConsolidationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ConsolidationType1Code Value { get; init; } 
        #else
        public ConsolidationType1Code Value { get; set; } 
        #endif
