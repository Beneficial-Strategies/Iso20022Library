...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecuritiesDistributionTypeFormat2Choice
{
    ...
    #else
    public partial class Code : IntermediateSecuritiesDistributionTypeFormat2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( IntermediateSecurityDistributionType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public IntermediateSecurityDistributionType2Code Value { get; init; } 
        #else
        public IntermediateSecurityDistributionType2Code Value { get; set; } 
        #endif
