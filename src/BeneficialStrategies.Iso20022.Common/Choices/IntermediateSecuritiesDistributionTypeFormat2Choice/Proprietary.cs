...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecuritiesDistributionTypeFormat2Choice
{
    ...
    /// </summary>
    [IsoId("_Q0L0BNp-Ed-ak6NoX_4Aeg_-674295255")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IntermediateSecuritiesDistributionTypeFormat2Choice_
    #else
    public partial class Proprietary : IntermediateSecuritiesDistributionTypeFormat2Choice_
    #endif
    {
