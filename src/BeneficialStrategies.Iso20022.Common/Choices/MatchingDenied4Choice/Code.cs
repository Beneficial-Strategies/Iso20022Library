...
namespace BeneficialStrategies.Iso20022.Choices.MatchingDenied4Choice
{
    ...
    #else
    public partial class Code : MatchingDenied4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MatchingProcess1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MatchingProcess1Code Value { get; init; } 
        #else
        public MatchingProcess1Code Value { get; set; } 
        #endif
