...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RejectedReason38Choice.Proprietary),nameof(RejectedReason38Choice.Proprietary))]
    #endif
    ...
    #else
    public abstract partial class RejectedReason38Choice_
    #endif
    {
    }
}
