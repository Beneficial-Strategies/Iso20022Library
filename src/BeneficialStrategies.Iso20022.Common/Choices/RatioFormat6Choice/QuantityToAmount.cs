...
namespace BeneficialStrategies.Iso20022.Choices.RatioFormat6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record QuantityToAmount : RatioFormat6Choice_
    #else
    public partial class QuantityToAmount : RatioFormat6Choice_
    #endif
    {
        ...
        /// </summary>
        public QuantityToAmount( ActiveCurrencyAnd13DecimalAmount reqAmount,System.UInt64 reqQuantity )
        {
            Amount = reqAmount;
