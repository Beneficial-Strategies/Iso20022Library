...
namespace BeneficialStrategies.Iso20022.Choices.SubBalanceType5Choice
{
    ...
    /// </summary>
    [IsoId("_QYU-dtp-Ed-ak6NoX_4Aeg_-1583252155")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SubBalanceType5Choice_
    #else
    public partial class Proprietary : SubBalanceType5Choice_
    #endif
    {
