...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason2Choice
{
    ...
    /// </summary>
    [IsoId("_UWigdtp-Ed-ak6NoX_4Aeg_-439842579")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason2Choice_
    #else
    public partial class Proprietary : RejectionReason2Choice_
    #endif
    {
