...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD1Choice
{
    ...
    /// </summary>
    [IsoId("_1QPnlTL3EeKU9IrkkToqcw_133829864")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BorrowedBalance : CorporateActionUnallocatedBalanceSD1Choice_
    #else
    public partial class BorrowedBalance : CorporateActionUnallocatedBalanceSD1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a BorrowedBalance instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public BorrowedBalance( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
        {
