...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD1Choice
{
    ...
    /// </summary>
    [IsoId("_1QPnljL3EeKU9IrkkToqcw_1119803440")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CollateralInBalance : CorporateActionUnallocatedBalanceSD1Choice_
    #else
    public partial class CollateralInBalance : CorporateActionUnallocatedBalanceSD1Choice_
    #endif
    {
