...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD1Choice
{
    ...
    /// </summary>
    [IsoId("_1QYxgzL3EeKU9IrkkToqcw_1426481324")]
    ...
    #else
    public partial class PendingReceiptBalance : CorporateActionUnallocatedBalanceSD1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PendingReceiptBalance instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PendingReceiptBalance( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
        {
