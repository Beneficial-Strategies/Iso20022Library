...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : InterestRateUsedForPaymentFormat10Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : InterestRateUsedForPaymentFormat10Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType45Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType45Choice_ RateType { get; init; } 
        #else
        public RateType45Choice_ RateType { get; set; } 
        #endif
