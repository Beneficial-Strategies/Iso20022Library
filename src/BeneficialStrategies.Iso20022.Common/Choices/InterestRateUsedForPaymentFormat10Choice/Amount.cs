...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : InterestRateUsedForPaymentFormat10Choice_
    #else
    public partial class Amount : InterestRateUsedForPaymentFormat10Choice_
    #endif
    {
