...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(InvestorCapacity1Choice.Proprietary),nameof(InvestorCapacity1Choice.Proprietary))]
    #endif
    ...
    #else
    public abstract partial class InvestorCapacity1Choice_
    #endif
    {
    }
}
