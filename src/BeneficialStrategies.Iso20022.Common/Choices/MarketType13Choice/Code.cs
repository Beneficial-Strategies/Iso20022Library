...
namespace BeneficialStrategies.Iso20022.Choices.MarketType13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : MarketType13Choice_
    #else
    public partial class Code : MarketType13Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MarketType8Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MarketType8Code Value { get; init; } 
        #else
        public MarketType8Code Value { get; set; } 
        #endif
