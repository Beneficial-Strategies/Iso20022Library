...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat17Choice
{
    ...
    #else
    public partial class Code : AdditionalBusinessProcessFormat17Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AdditionalBusinessProcess9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AdditionalBusinessProcess9Code Value { get; init; } 
        #else
        public AdditionalBusinessProcess9Code Value { get; set; } 
        #endif
