...
namespace BeneficialStrategies.Iso20022.Choices.RatioFormat5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RatioFormat5Choice_
    #else
    public partial class NotSpecifiedRate : RatioFormat5Choice_
    #endif
    {
        ...
        /// </summary>
        public NotSpecifiedRate( RateValueType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RateValueType6Code Value { get; init; } 
        #else
        public RateValueType6Code Value { get; set; } 
        #endif
