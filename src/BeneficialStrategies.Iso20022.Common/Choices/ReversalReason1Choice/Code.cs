...
namespace BeneficialStrategies.Iso20022.Choices.ReversalReason1Choice
{
    ...
    #else
    public partial class Code : ReversalReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TransactionReversalReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransactionReversalReason1Code Value { get; init; } 
        #else
        public TransactionReversalReason1Code Value { get; set; } 
        #endif
