...
namespace BeneficialStrategies.Iso20022.Choices.AcceptedReason1Choice
{
    ...
    #else
    public partial class Code : AcceptedReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AcknowledgementReason4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AcknowledgementReason4Code Value { get; init; } 
        #else
        public AcknowledgementReason4Code Value { get; set; } 
        #endif
