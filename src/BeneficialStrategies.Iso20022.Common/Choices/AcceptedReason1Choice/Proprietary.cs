...
namespace BeneficialStrategies.Iso20022.Choices.AcceptedReason1Choice
{
    ...
    /// </summary>
    [IsoId("_QyjcWdp-Ed-ak6NoX_4Aeg_831638613")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcceptedReason1Choice_
    #else
    public partial class Proprietary : AcceptedReason1Choice_
    #endif
    {
