...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason20Choice
{
    ...
    #else
    public partial class Code : RejectedReason20Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectedStatusReason11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectedStatusReason11Code Value { get; init; } 
        #else
        public RejectedStatusReason11Code Value { get; set; } 
        #endif
