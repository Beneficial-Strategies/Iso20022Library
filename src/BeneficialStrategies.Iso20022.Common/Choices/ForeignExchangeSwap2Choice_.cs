...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ForeignExchangeSwap2Choice.DataSetAction),
        nameof(ForeignExchangeSwap2Choice.DataSetAction)
    )]
    [JsonDerivedType(
        typeof(ForeignExchangeSwap2Choice.Transaction),
        nameof(ForeignExchangeSwap2Choice.Transaction)
    )]
    [IsoId("_qc3MAZ2WEeW_58xcYxhewg")]
    [DisplayName("Foreign Exchange Swap 2 Choice")]
    public abstract record ForeignExchangeSwap2Choice_ { }
}
