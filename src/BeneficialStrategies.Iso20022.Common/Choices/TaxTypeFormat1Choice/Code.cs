...
namespace BeneficialStrategies.Iso20022.Choices.TaxTypeFormat1Choice
{
    ...
    #else
    public partial class Code : TaxTypeFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxType15Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxType15Code Value { get; init; } 
        #else
        public TaxType15Code Value { get; set; } 
        #endif
