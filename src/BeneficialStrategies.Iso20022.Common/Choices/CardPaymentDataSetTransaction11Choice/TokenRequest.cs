...
namespace BeneficialStrategies.Iso20022.Choices.CardPaymentDataSetTransaction11Choice
{
    ...
    #else
    public partial class TokenRequest : CardPaymentDataSetTransaction11Choice_
    #endif
    {
        ...
        /// </summary>
        public TokenRequest( System.String reqTransactionSequenceCounter,CardPaymentEnvironment79 reqEnvironment )
        {
