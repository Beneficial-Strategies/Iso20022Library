...
namespace BeneficialStrategies.Iso20022.Choices.UnderlyingTransaction1Choice
{
    ...
    /// </summary>
    [IsoId("_P9DXudp-Ed-ak6NoX_4Aeg_-105758071")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Initiation : UnderlyingTransaction1Choice_
    #else
    public partial class Initiation : UnderlyingTransaction1Choice_
    #endif
    {
