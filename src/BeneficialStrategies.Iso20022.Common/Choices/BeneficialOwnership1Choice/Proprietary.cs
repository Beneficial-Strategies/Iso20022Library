...
namespace BeneficialStrategies.Iso20022.Choices.BeneficialOwnership1Choice
{
    ...
    /// </summary>
    [IsoId("_QwBFs9p-Ed-ak6NoX_4Aeg_-1721548146")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficialOwnership1Choice_
    #else
    public partial class Proprietary : BeneficialOwnership1Choice_
    #endif
    {
