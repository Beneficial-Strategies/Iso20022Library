...
namespace BeneficialStrategies.Iso20022.Choices.InvestorCapacity1Choice
{
    ...
    /// </summary>
    [IsoId("_Qs45Mdp-Ed-ak6NoX_4Aeg_-1152132898")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InvestorCapacity1Choice_
    #else
    public partial class Proprietary : InvestorCapacity1Choice_
    #endif
    {
