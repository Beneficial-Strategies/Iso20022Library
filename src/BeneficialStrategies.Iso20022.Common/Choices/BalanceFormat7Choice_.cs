...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BalanceFormat7Choice.EligibleBalance),
        nameof(BalanceFormat7Choice.EligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat7Choice.NotEligibleBalance),
        nameof(BalanceFormat7Choice.NotEligibleBalance)
    )]
    [IsoId("_cfsErZKQEeWHWpTQn1FFVg")]
    [DisplayName("Balance Format 7 Choice")]
    public abstract record BalanceFormat7Choice_ { }
}
