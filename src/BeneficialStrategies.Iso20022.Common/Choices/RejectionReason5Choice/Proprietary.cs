...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason5Choice
{
    ...
    /// </summary>
    [IsoId("_UYLfNdp-Ed-ak6NoX_4Aeg_743710435")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason5Choice_
    #else
    public partial class Proprietary : RejectionReason5Choice_
    #endif
    {
