...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType19Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType19Choice_
    #else
    public partial class Proprietary : FractionDispositionType19Choice_
    #endif
    {
