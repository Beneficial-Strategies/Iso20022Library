...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity12Choice
{
    ...
    /// </summary>
    [IsoId("_RgvYBtp-Ed-ak6NoX_4Aeg_426549785")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record GrossAmount : FinancialInstrumentQuantity12Choice_
    #else
    public partial class GrossAmount : FinancialInstrumentQuantity12Choice_
    #endif
    {
