...
namespace BeneficialStrategies.Iso20022.Choices.FXStandingInstruction1Choice
{
    ...
    /// </summary>
    [IsoId("_QuFMB9p-Ed-ak6NoX_4Aeg_-1213284611")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FXStandingInstruction1Choice_
    #else
    public partial class Proprietary : FXStandingInstruction1Choice_
    #endif
    {
