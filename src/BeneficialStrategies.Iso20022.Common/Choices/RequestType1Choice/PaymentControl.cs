...
namespace BeneficialStrategies.Iso20022.Choices.RequestType1Choice
{
    ...
    /// </summary>
    [IsoId("_RZlnJ9p-Ed-ak6NoX_4Aeg_-533116355")]
    ...
    #else
    public partial class PaymentControl : RequestType1Choice_
    #endif
    {
        ...
        /// </summary>
        public PaymentControl( RequestType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public RequestType1Code Value { get; set; } 
        #endif
