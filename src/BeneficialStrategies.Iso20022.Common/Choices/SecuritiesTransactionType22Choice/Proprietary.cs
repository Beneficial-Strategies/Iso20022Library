...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType22Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType22Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType22Choice_
    #endif
    {
