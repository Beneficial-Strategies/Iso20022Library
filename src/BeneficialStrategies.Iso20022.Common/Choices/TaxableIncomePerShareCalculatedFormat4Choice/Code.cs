...
namespace BeneficialStrategies.Iso20022.Choices.TaxableIncomePerShareCalculatedFormat4Choice
{
    ...
    #else
    public partial class Code : TaxableIncomePerShareCalculatedFormat4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionTaxableIncomePerShareCalculated1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionTaxableIncomePerShareCalculated1Code Value { get; init; } 
        #else
        public CorporateActionTaxableIncomePerShareCalculated1Code Value { get; set; } 
        #endif
