...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason8FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason8FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason8Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason8Code Value { get; init; } 
        #else
        public RejectionReason8Code Value { get; set; } 
        #endif
