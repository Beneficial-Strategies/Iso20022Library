...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason8FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RoovxNp-Ed-ak6NoX_4Aeg_274039650")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason8FormatChoice_
    #else
    public partial class Proprietary : RejectionReason8FormatChoice_
    #endif
    {
