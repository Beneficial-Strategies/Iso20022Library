...
namespace BeneficialStrategies.Iso20022.Choices.TradingVenueIdentification1Choice
{
    ...
    #else
    public partial class NationalCompetentAuthority : TradingVenueIdentification1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NationalCompetentAuthority instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NationalCompetentAuthority( string reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="NtlCmptntAuthrty")]
        #endif
