...
namespace BeneficialStrategies.Iso20022.Choices.SettlementConditionModificationStatus3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementConditionModificationStatus3Choice_
    #else
    public partial class Proprietary : SettlementConditionModificationStatus3Choice_
    #endif
    {
