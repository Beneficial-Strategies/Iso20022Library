...
namespace BeneficialStrategies.Iso20022.Choices.InvestorRestrictionType3Choice
{
    ...
    #else
    public partial class Code : InvestorRestrictionType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestorRestrictionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestorRestrictionType1Code Value { get; init; } 
        #else
        public InvestorRestrictionType1Code Value { get; set; } 
        #endif
