...
namespace BeneficialStrategies.Iso20022.Choices.PaymentInstrument10Choice
{
    ...
    /// </summary>
    [IsoId("_VKY_R9p-Ed-ak6NoX_4Aeg_483348981")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PaymentCardDetails : PaymentInstrument10Choice_
    #else
    public partial class PaymentCardDetails : PaymentInstrument10Choice_
    #endif
    {
