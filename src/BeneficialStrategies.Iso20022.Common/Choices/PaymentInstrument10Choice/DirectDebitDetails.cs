...
namespace BeneficialStrategies.Iso20022.Choices.PaymentInstrument10Choice
{
    ...
    /// </summary>
    [IsoId("_VKY_Sdp-Ed-ak6NoX_4Aeg_734057953")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DirectDebitDetails : PaymentInstrument10Choice_
    #else
    public partial class DirectDebitDetails : PaymentInstrument10Choice_
    #endif
    {
