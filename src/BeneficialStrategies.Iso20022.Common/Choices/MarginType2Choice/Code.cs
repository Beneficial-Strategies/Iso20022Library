...
namespace BeneficialStrategies.Iso20022.Choices.MarginType2Choice
{
    ...
    #else
    public partial class Code : MarginType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MarginType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MarginType2Code Value { get; init; } 
        #else
        public MarginType2Code Value { get; set; } 
        #endif
