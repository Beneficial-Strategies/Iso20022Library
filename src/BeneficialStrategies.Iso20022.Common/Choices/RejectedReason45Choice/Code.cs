...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason45Choice
{
    ...
    #else
    public partial class Code : RejectedReason45Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectedStatusReason13Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectedStatusReason13Code Value { get; init; } 
        #else
        public RejectedStatusReason13Code Value { get; set; } 
        #endif
