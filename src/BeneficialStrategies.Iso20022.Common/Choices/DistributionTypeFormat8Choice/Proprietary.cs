...
namespace BeneficialStrategies.Iso20022.Choices.DistributionTypeFormat8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : DistributionTypeFormat8Choice_
    #else
    public partial class Proprietary : DistributionTypeFormat8Choice_
    #endif
    {
