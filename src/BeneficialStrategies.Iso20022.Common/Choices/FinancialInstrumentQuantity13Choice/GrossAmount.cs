...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity13Choice
{
    ...
    /// </summary>
    [IsoId("_RgSsE9p-Ed-ak6NoX_4Aeg_446864960")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record GrossAmount : FinancialInstrumentQuantity13Choice_
    #else
    public partial class GrossAmount : FinancialInstrumentQuantity13Choice_
    #endif
    {
