...
namespace BeneficialStrategies.Iso20022.Choices.ProcessedStatus3FormatChoice
{
    ...
    #else
    public partial class Code : ProcessedStatus3FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProcessedStatus3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProcessedStatus3Code Value { get; init; } 
        #else
        public ProcessedStatus3Code Value { get; set; } 
        #endif
