...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity2Choice
{
    ...
    /// </summary>
    [IsoId("_Sn-F1Np-Ed-ak6NoX_4Aeg_-85763507")]
    [DisplayName("Unit")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Unit : FinancialInstrumentQuantity2Choice_
    #else
    public partial class Unit : FinancialInstrumentQuantity2Choice_
    #endif
    {
