...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason16Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason16Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason9Code Value { get; init; } 
        #else
        public UnmatchedReason9Code Value { get; set; } 
        #endif
