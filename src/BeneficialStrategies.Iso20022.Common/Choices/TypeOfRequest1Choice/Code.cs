...
namespace BeneficialStrategies.Iso20022.Choices.TypeOfRequest1Choice
{
    ...
    #else
    public partial class Code : TypeOfRequest1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TypeOfRequest1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TypeOfRequest1Code Value { get; init; } 
        #else
        public TypeOfRequest1Code Value { get; set; } 
        #endif
