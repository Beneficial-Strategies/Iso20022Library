...
namespace BeneficialStrategies.Iso20022.Choices.LegalRestrictions5Choice
{
    ...
    #else
    public partial class Code : LegalRestrictions5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( LegalRestrictions2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public LegalRestrictions2Code Value { get; init; } 
        #else
        public LegalRestrictions2Code Value { get; set; } 
        #endif
