...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason6FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason6FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason6Code Value { get; init; } 
        #else
        public RejectionReason6Code Value { get; set; } 
        #endif
