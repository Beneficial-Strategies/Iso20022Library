...
namespace BeneficialStrategies.Iso20022.Choices.CreditorReferenceType1Choice
{
    ...
    #else
    public partial class Code : CreditorReferenceType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DocumentType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DocumentType3Code Value { get; init; } 
        #else
        public DocumentType3Code Value { get; set; } 
        #endif
