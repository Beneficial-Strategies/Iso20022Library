...
namespace BeneficialStrategies.Iso20022.Choices.NonEligibleProceedsIndicator1Choice
{
    ...
    /// </summary>
    [IsoId("_Q5QhQdp-Ed-ak6NoX_4Aeg_1143839187")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : NonEligibleProceedsIndicator1Choice_
    #else
    public partial class Proprietary : NonEligibleProceedsIndicator1Choice_
    #endif
    {
