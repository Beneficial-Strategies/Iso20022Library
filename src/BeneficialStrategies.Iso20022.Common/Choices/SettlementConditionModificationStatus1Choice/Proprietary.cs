...
namespace BeneficialStrategies.Iso20022.Choices.SettlementConditionModificationStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UYeaJNp-Ed-ak6NoX_4Aeg_-936948756")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementConditionModificationStatus1Choice_
    #else
    public partial class Proprietary : SettlementConditionModificationStatus1Choice_
    #endif
    {
