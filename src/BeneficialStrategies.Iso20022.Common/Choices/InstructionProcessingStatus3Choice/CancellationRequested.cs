...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : InstructionProcessingStatus3Choice_
    #else
    public partial class CancellationRequested : InstructionProcessingStatus3Choice_
    #endif
    {
