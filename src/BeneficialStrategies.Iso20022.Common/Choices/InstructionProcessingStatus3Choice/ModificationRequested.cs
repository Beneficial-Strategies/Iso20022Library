...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus3Choice
{
    ...
    /// </summary>
    [IsoId("_UZg799p-Ed-ak6NoX_4Aeg_-41941340")]
    ...
    #else
    public partial class ModificationRequested : InstructionProcessingStatus3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ModificationRequested instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ModificationRequested( NoReasonCode reqNoSpecifiedReason )
        {
