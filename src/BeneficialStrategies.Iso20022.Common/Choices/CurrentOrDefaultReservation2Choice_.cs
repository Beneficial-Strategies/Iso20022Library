...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CurrentOrDefaultReservation2Choice.Current),
        nameof(CurrentOrDefaultReservation2Choice.Current)
    )]
    [JsonDerivedType(
        typeof(CurrentOrDefaultReservation2Choice.Default),
        nameof(CurrentOrDefaultReservation2Choice.Default)
    )]
    [IsoId("_BndOfW4-EeiU9cctagi5ow")]
    [DisplayName("Current Or Default Reservation 2 Choice")]
    public abstract record CurrentOrDefaultReservation2Choice_ { }
}
