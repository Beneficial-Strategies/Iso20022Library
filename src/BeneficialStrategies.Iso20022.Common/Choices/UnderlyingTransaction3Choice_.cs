...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(UnderlyingTransaction3Choice.Initiation),
        nameof(UnderlyingTransaction3Choice.Initiation)
    )]
    [JsonDerivedType(
        typeof(UnderlyingTransaction3Choice.Interbank),
        nameof(UnderlyingTransaction3Choice.Interbank)
    )]
    [JsonDerivedType(
        typeof(UnderlyingTransaction3Choice.StatementEntry),
        nameof(UnderlyingTransaction3Choice.StatementEntry)
    )]
    [IsoId("_Xq7UAWXpEeap-P22vGV91g")]
    [DisplayName("Underlying Transaction 3 Choice")]
    public abstract record UnderlyingTransaction3Choice_ { }
}
