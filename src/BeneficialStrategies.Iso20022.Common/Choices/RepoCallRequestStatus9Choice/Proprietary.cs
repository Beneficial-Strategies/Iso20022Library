...
namespace BeneficialStrategies.Iso20022.Choices.RepoCallRequestStatus9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RepoCallRequestStatus9Choice_
    #else
    public partial class Proprietary : RepoCallRequestStatus9Choice_
    #endif
    {
