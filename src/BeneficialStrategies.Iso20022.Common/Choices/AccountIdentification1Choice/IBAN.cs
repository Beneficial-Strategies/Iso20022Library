...
namespace BeneficialStrategies.Iso20022.Choices.AccountIdentification1Choice
{
    ...
    /// </summary>
    [IsoId("_Pdd4uNp-Ed-ak6NoX_4Aeg_-1673516704")]
    [DisplayName("IBAN")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IBAN : AccountIdentification1Choice_
    #else
    public partial class IBAN : AccountIdentification1Choice_
    #endif
    {
