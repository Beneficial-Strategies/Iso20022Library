...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus23Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : AcknowledgedAcceptedStatus23Choice_
    #else
    public partial class NoSpecifiedReason : AcknowledgedAcceptedStatus23Choice_
    #endif
    {
