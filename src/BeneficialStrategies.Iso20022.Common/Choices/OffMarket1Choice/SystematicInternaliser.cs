...
namespace BeneficialStrategies.Iso20022.Choices.OffMarket1Choice
{
    ...
    #else
    public partial class SystematicInternaliser : OffMarket1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a SystematicInternaliser instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public SystematicInternaliser( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
