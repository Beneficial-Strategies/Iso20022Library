...
namespace BeneficialStrategies.Iso20022.Choices.AccountOrOperationalError4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : AccountOrOperationalError4Choice_
    #else
    public partial class OperationalError : AccountOrOperationalError4Choice_
    #endif
    {
