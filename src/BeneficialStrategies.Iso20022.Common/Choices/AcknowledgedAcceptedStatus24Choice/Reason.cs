...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus24Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : AcknowledgedAcceptedStatus24Choice_
    #else
    public partial class Reason : AcknowledgedAcceptedStatus24Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( AcknowledgementReason15Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
