...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification4Choice
{
    ...
    /// </summary>
    [IsoId("_QRUXhNp-Ed-ak6NoX_4Aeg_923150051")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BICOrBEI : PartyIdentification4Choice_
    #else
    public partial class BICOrBEI : PartyIdentification4Choice_
    #endif
    {
