...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification4Choice
{
    ...
    /// </summary>
    [IsoId("_QRUXhdp-Ed-ak6NoX_4Aeg_923150310")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification4Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification4Choice_
    #endif
    {
