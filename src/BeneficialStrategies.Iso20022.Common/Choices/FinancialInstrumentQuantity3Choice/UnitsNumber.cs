...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity3Choice
{
    ...
    /// </summary>
    [IsoId("_VOteoNp-Ed-ak6NoX_4Aeg_1922478109")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record UnitsNumber : FinancialInstrumentQuantity3Choice_
    #else
    public partial class UnitsNumber : FinancialInstrumentQuantity3Choice_
    #endif
    {
