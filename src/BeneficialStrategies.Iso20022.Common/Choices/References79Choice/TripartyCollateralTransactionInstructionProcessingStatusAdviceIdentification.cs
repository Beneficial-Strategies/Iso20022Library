...
namespace BeneficialStrategies.Iso20022.Choices.References79Choice
{
    ...
    #else
    public partial class TripartyCollateralTransactionInstructionProcessingStatusAdviceIdentification : References79Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a TripartyCollateralTransactionInstructionProcessingStatusAdviceIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public TripartyCollateralTransactionInstructionProcessingStatusAdviceIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="TrptyCollTxInstrPrcgStsAdvcId")]
        #endif
