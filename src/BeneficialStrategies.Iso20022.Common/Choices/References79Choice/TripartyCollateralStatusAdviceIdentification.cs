...
namespace BeneficialStrategies.Iso20022.Choices.References79Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record TripartyCollateralStatusAdviceIdentification : References79Choice_
    #else
    public partial class TripartyCollateralStatusAdviceIdentification : References79Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a TripartyCollateralStatusAdviceIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public TripartyCollateralStatusAdviceIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="TrptyCollStsAdvcId")]
        #endif
