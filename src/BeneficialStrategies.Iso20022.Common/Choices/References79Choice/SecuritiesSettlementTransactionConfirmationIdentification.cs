...
namespace BeneficialStrategies.Iso20022.Choices.References79Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionConfirmationIdentification : References79Choice_
    #else
    public partial class SecuritiesSettlementTransactionConfirmationIdentification : References79Choice_
    #endif
    {
