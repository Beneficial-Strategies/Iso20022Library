...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalAmount1Choice
{
    ...
    #else
    public partial class ResultingCashOut : AdditionalAmount1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ResultingCashOut instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ResultingCashOut( System.String reqCurrency,System.Decimal reqAmount )
        {
