...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus22Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : InstructionProcessingStatus22Choice_
    #else
    public partial class ModificationRequested : InstructionProcessingStatus22Choice_
    #endif
    {
