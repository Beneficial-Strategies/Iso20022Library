...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesReferenceDeltaStatusReport3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NewRecord : SecuritiesReferenceDeltaStatusReport3Choice_
    #else
    public partial class NewRecord : SecuritiesReferenceDeltaStatusReport3Choice_
    #endif
    {
