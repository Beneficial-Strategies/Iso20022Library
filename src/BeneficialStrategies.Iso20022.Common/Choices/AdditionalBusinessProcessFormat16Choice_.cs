...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AdditionalBusinessProcessFormat16Choice.Code),
        nameof(AdditionalBusinessProcessFormat16Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AdditionalBusinessProcessFormat16Choice.Proprietary),
        nameof(AdditionalBusinessProcessFormat16Choice.Proprietary)
    )]
    [IsoId("_MkrIodD7Eeetfps_dpxRmg")]
    [DisplayName("Additional Business Process Format 16 Choice")]
    public abstract record AdditionalBusinessProcessFormat16Choice_ { }
}
