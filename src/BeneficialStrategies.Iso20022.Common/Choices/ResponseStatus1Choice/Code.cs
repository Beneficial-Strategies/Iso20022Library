...
namespace BeneficialStrategies.Iso20022.Choices.ResponseStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UYUpJdp-Ed-ak6NoX_4Aeg_-688354436")]
    [DisplayName("Code")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : ResponseStatus1Choice_
    #else
    public partial class Code : ResponseStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ResponseStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ResponseStatus1Code Value { get; init; } 
        #else
        public ResponseStatus1Code Value { get; set; } 
        #endif
