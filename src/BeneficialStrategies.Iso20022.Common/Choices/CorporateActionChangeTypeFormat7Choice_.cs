...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionChangeTypeFormat7Choice.Code),
        nameof(CorporateActionChangeTypeFormat7Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionChangeTypeFormat7Choice.Proprietary),
        nameof(CorporateActionChangeTypeFormat7Choice.Proprietary)
    )]
    [IsoId("_cheMk5KQEeWHWpTQn1FFVg")]
    [DisplayName("Corporate Action Change Type Format 7 Choice")]
    public abstract record CorporateActionChangeTypeFormat7Choice_ { }
}
