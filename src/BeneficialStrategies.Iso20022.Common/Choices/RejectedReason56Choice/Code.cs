...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason56Choice
{
    ...
    #else
    public partial class Code : RejectedReason56Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason79Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason79Code Value { get; init; } 
        #else
        public RejectionReason79Code Value { get; set; } 
        #endif
