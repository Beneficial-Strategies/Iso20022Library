...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat39Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : GrossDividendRateFormat39Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : GrossDividendRateFormat39Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType80Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType80Choice_ RateType { get; init; } 
        #else
        public RateType80Choice_ RateType { get; set; } 
        #endif
