...
namespace BeneficialStrategies.Iso20022.Choices.References69Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesFinancingConfirmationIdentification : References69Choice_
    #else
    public partial class SecuritiesFinancingConfirmationIdentification : References69Choice_
    #endif
    {
