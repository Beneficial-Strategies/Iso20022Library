...
namespace BeneficialStrategies.Iso20022.Choices.References69Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesTransactionPendingReportIdentification : References69Choice_
    #else
    public partial class SecuritiesTransactionPendingReportIdentification : References69Choice_
    #endif
    {
