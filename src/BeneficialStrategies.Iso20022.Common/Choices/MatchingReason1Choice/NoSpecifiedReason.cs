...
namespace BeneficialStrategies.Iso20022.Choices.MatchingReason1Choice
{
    ...
    /// </summary>
    [IsoId("_Az7z1dokEeC60axPepSq7g_830509134")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : MatchingReason1Choice_
    #else
    public partial class NoSpecifiedReason : MatchingReason1Choice_
    #endif
    {
