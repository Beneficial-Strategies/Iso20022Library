...
namespace BeneficialStrategies.Iso20022.Choices.FailingStatus3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : FailingStatus3Choice_
    #else
    public partial class Reason : FailingStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( FailingReason3Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public FailingReason3Choice_ Code { get; init; } 
        #else
        public FailingReason3Choice_ Code { get; set; } 
        #endif
