...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SecuritiesTransactionType25Choice.Code),
        nameof(SecuritiesTransactionType25Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SecuritiesTransactionType25Choice.Proprietary),
        nameof(SecuritiesTransactionType25Choice.Proprietary)
    )]
    [IsoId("_6dqpg5NLEeWGlc8L7oPDIg")]
    [DisplayName("Securities Transaction Type 25 Choice")]
    public abstract record SecuritiesTransactionType25Choice_ { }
}
