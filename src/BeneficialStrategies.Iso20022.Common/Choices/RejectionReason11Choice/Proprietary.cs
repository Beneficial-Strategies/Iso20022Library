...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason11Choice
{
    ...
    /// </summary>
    [IsoId("_0kRD1QlIEeGATtfOBToyew_-562636159")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason11Choice_
    #else
    public partial class Proprietary : RejectionReason11Choice_
    #endif
    {
