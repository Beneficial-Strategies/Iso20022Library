...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity8Choice
{
    ...
    /// </summary>
    [IsoId("_RhC6Adp-Ed-ak6NoX_4Aeg_1589727060")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record GrossAmount : FinancialInstrumentQuantity8Choice_
    #else
    public partial class GrossAmount : FinancialInstrumentQuantity8Choice_
    #endif
    {
