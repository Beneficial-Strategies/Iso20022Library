...
namespace BeneficialStrategies.Iso20022.Choices.DebtorActivationStatusReason1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : DebtorActivationStatusReason1Choice_
    #else
    public partial class Proprietary : DebtorActivationStatusReason1Choice_
    #endif
    {
