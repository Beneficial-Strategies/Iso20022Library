...
namespace BeneficialStrategies.Iso20022.Choices.DebtorActivationStatusReason1Choice
{
    ...
    #else
    public partial class Code : DebtorActivationStatusReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalDebtorActivationStatusReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalDebtorActivationStatusReason1Code Value { get; init; } 
        #else
        public ExternalDebtorActivationStatusReason1Code Value { get; set; } 
        #endif
