...
namespace BeneficialStrategies.Iso20022.Choices.Amount2Choice
{
    ...
    /// </summary>
    [IsoId("_75DzlqMgEeCJ6YNENx4h-w_776606949")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountWithCurrency : Amount2Choice_
    #else
    public partial class AmountWithCurrency : Amount2Choice_
    #endif
    {
        ...
        /// </summary>
        public AmountWithCurrency( System.String reqCurrency,System.Decimal reqAmount )
        {
