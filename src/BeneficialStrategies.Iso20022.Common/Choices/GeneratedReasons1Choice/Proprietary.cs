...
namespace BeneficialStrategies.Iso20022.Choices.GeneratedReasons1Choice
{
    ...
    /// </summary>
    [IsoId("_UYxVF9p-Ed-ak6NoX_4Aeg_-1972160083")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : GeneratedReasons1Choice_
    #else
    public partial class Proprietary : GeneratedReasons1Choice_
    #endif
    {
