...
namespace BeneficialStrategies.Iso20022.Choices.GeneratedReasons1Choice
{
    ...
    #else
    public partial class Code : GeneratedReasons1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GeneratedReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GeneratedReason2Code Value { get; init; } 
        #else
        public GeneratedReason2Code Value { get; set; } 
        #endif
