...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationFormat1Choice
{
    ...
    #else
    public partial class ShortIdentification : IdentificationFormat1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ShortIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ShortIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
