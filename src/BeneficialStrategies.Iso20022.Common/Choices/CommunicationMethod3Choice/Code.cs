...
namespace BeneficialStrategies.Iso20022.Choices.CommunicationMethod3Choice
{
    ...
    #else
    public partial class Code : CommunicationMethod3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CommunicationMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CommunicationMethod1Code Value { get; init; } 
        #else
        public CommunicationMethod1Code Value { get; set; } 
        #endif
