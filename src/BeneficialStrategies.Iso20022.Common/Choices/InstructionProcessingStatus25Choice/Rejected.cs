...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus25Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rejected : InstructionProcessingStatus25Choice_
    #else
    public partial class Rejected : InstructionProcessingStatus25Choice_
    #endif
    {
