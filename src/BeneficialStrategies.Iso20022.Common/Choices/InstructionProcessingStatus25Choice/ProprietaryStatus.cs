...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus25Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : InstructionProcessingStatus25Choice_
    #else
    public partial class ProprietaryStatus : InstructionProcessingStatus25Choice_
    #endif
    {
