...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TransactionType1CodeChoice.Structured),
        nameof(TransactionType1CodeChoice.Structured)
    )]
    [JsonDerivedType(
        typeof(TransactionType1CodeChoice.Unstructured),
        nameof(TransactionType1CodeChoice.Unstructured)
    )]
    [IsoId("_U0V2wdp-Ed-ak6NoX_4Aeg_1816953757")]
    [DisplayName("Transaction Type 1 Code Choice")]
    public abstract record TransactionType1CodeChoice_ { }
}
