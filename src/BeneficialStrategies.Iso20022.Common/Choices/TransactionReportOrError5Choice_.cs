...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TransactionReportOrError5Choice.BusinessReport),
        nameof(TransactionReportOrError5Choice.BusinessReport)
    )]
    [JsonDerivedType(
        typeof(TransactionReportOrError5Choice.OperationalError),
        nameof(TransactionReportOrError5Choice.OperationalError)
    )]
    [IsoId("_dc83EdcZEeqRFcf2R4bPBw")]
    [DisplayName("Transaction Report Or Error 5 Choice")]
    public abstract record TransactionReportOrError5Choice_ { }
}
