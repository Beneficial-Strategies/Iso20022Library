...
namespace BeneficialStrategies.Iso20022.Choices.FormOfSecurity4Choice
{
    ...
    /// </summary>
    [IsoId("_AbzApNokEeC60axPepSq7g_-1774996885")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FormOfSecurity4Choice_
    #else
    public partial class Proprietary : FormOfSecurity4Choice_
    #endif
    {
