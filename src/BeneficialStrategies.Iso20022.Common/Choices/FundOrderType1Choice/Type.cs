...
namespace BeneficialStrategies.Iso20022.Choices.FundOrderType1Choice
{
    ...
    #else
    public partial class Type : FundOrderType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Type( FundOrderType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FundOrderType6Code Value { get; init; } 
        #else
        public FundOrderType6Code Value { get; set; } 
        #endif
