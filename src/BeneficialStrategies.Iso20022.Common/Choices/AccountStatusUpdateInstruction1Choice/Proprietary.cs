...
namespace BeneficialStrategies.Iso20022.Choices.AccountStatusUpdateInstruction1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AccountStatusUpdateInstruction1Choice_
    #else
    public partial class Proprietary : AccountStatusUpdateInstruction1Choice_
    #endif
    {
