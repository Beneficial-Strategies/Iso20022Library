...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus98Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AcknowledgedAccepted : ProcessingStatus98Choice_
    #else
    public partial class AcknowledgedAccepted : ProcessingStatus98Choice_
    #endif
    {
