...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType32Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType32Choice_
    #endif
    {
