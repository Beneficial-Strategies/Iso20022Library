...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingType1Choice
{
    ...
    /// </summary>
    [IsoId("_705FRKMgEeCJ6YNENx4h-w_619782211")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessingType1Choice_
    #else
    public partial class Proprietary : ProcessingType1Choice_
    #endif
    {
