...
namespace BeneficialStrategies.Iso20022.Choices.PresentationDocumentFormat1Choice
{
    ...
    #else
    public partial class Code : PresentationDocumentFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalUndertakingDocumentType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public ExternalUndertakingDocumentType1Code Value { get; set; } 
        #endif
