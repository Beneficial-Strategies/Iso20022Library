...
namespace BeneficialStrategies.Iso20022.Choices.References37Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesBalanceCustodyReportIdentification : References37Choice_
    #else
    public partial class SecuritiesBalanceCustodyReportIdentification : References37Choice_
    #endif
    {
