...
namespace BeneficialStrategies.Iso20022.Choices.PaymentStatusType2Choice
{
    ...
    #else
    public partial class RawStatus : PaymentStatusType2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RawStatus instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RawStatus( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
