...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus46Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionOrRepairStatus46Choice_
    #else
    public partial class Reason : RejectionOrRepairStatus46Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionAndRepairReason41Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
