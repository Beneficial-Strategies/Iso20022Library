...
namespace BeneficialStrategies.Iso20022.Choices.AccountIdentificationSearchCriteria2Choice
{
    ...
    #else
    public partial class ContainText : AccountIdentificationSearchCriteria2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ContainText instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ContainText( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
