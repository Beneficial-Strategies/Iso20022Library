...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason4Choice
{
    ...
    #else
    public partial class Code : RejectionAndRepairReason4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason22Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason22Code Value { get; init; } 
        #else
        public RejectionReason22Code Value { get; set; } 
        #endif
