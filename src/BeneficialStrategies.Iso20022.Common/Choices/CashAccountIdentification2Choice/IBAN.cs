...
namespace BeneficialStrategies.Iso20022.Choices.CashAccountIdentification2Choice
{
    ...
    /// </summary>
    [IsoId("_Pd6kodp-Ed-ak6NoX_4Aeg_324893738")]
    [DisplayName("IBAN")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IBAN : CashAccountIdentification2Choice_
    #else
    public partial class IBAN : CashAccountIdentification2Choice_
    #endif
    {
