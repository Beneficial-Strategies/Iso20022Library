...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionCalculationMethod1FormatChoice
{
    ...
    #else
    public partial class Code : CorporateActionCalculationMethod1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionCalculationMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionCalculationMethod1Code Value { get; init; } 
        #else
        public CorporateActionCalculationMethod1Code Value { get; set; } 
        #endif
