...
namespace BeneficialStrategies.Iso20022.Choices.RatioFormat18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountToQuantity : RatioFormat18Choice_
    #else
    public partial class AmountToQuantity : RatioFormat18Choice_
    #endif
    {
        ...
        /// </summary>
        public AmountToQuantity( ActiveCurrencyAnd13DecimalAmount reqAmount,System.UInt64 reqQuantity )
        {
            Amount = reqAmount;
