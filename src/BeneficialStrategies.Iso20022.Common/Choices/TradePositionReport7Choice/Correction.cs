...
namespace BeneficialStrategies.Iso20022.Choices.TradePositionReport7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Correction : TradePositionReport7Choice_
    #else
    public partial class Correction : TradePositionReport7Choice_
    #endif
    {
        ...
        /// </summary>
        public Correction( CommonTradeDataReport34 reqCommonTradeData )
        {
