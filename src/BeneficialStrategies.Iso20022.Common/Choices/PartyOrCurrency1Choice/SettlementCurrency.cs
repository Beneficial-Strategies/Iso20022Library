...
namespace BeneficialStrategies.Iso20022.Choices.PartyOrCurrency1Choice
{
    ...
    #else
    public partial class SettlementCurrency : PartyOrCurrency1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a SettlementCurrency instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public SettlementCurrency( string reqValue )
        {
            Value = reqValue;
        }
        #endif
