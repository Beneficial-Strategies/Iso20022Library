...
namespace BeneficialStrategies.Iso20022.Choices.CancelledReason1Choice
{
    ...
    /// </summary>
    [IsoId("_QysmStp-Ed-ak6NoX_4Aeg_503789698")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancelledReason1Choice_
    #else
    public partial class Proprietary : CancelledReason1Choice_
    #endif
    {
