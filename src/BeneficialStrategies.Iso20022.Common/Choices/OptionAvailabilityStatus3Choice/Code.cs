...
namespace BeneficialStrategies.Iso20022.Choices.OptionAvailabilityStatus3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : OptionAvailabilityStatus3Choice_
    #else
    public partial class Code : OptionAvailabilityStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionAvailabilityStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionAvailabilityStatus1Code Value { get; init; } 
        #else
        public OptionAvailabilityStatus1Code Value { get; set; } 
        #endif
