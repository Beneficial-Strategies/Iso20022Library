...
namespace BeneficialStrategies.Iso20022.Choices.AcceptedStatus4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : AcceptedStatus4Choice_
    #else
    public partial class Reason : AcceptedStatus4Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( AcceptedReason4Choice_ reqReasonCode )
        {
