...
namespace BeneficialStrategies.Iso20022.Choices.FailedSettlementReason1FormatChoice
{
    ...
    #else
    public partial class Code : FailedSettlementReason1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( FailedSettlementReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public FailedSettlementReason1Code Value { get; set; } 
        #endif
