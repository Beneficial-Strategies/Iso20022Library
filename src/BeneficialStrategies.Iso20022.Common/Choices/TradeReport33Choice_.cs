...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(TradeReport33Choice.Compression),nameof(TradeReport33Choice.Compression))]
    [JsonDerivedType(typeof(TradeReport33Choice.Correction),nameof(TradeReport33Choice.Correction))]
    [JsonDerivedType(typeof(TradeReport33Choice.Error),nameof(TradeReport33Choice.Error))]
    [JsonDerivedType(typeof(TradeReport33Choice.Modification),nameof(TradeReport33Choice.Modification))]
    ...
    [JsonDerivedType(typeof(TradeReport33Choice.PositionComponent),nameof(TradeReport33Choice.PositionComponent))]
    [JsonDerivedType(typeof(TradeReport33Choice.Revive),nameof(TradeReport33Choice.Revive))]
    [JsonDerivedType(typeof(TradeReport33Choice.Termination),nameof(TradeReport33Choice.Termination))]
    [JsonDerivedType(typeof(TradeReport33Choice.ValuationUpdate),nameof(TradeReport33Choice.ValuationUpdate))]
    [IsoId("_8qzg8Y-REe6Ojt1b3tfu9Q")]
    [DisplayName("Trade Report33Choice")]
    public abstract partial record TradeReport33Choice_
    {
    }
}
