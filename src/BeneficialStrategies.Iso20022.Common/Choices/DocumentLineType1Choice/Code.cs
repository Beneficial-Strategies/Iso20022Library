...
namespace BeneficialStrategies.Iso20022.Choices.DocumentLineType1Choice
{
    ...
    #else
    public partial class Code : DocumentLineType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalDocumentLineType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public ExternalDocumentLineType1Code Value { get; set; } 
        #endif
