...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PrimaryOwner : AccountParties13Choice_
    #else
    public partial class PrimaryOwner : AccountParties13Choice_
    #endif
    {
        ...
        /// </summary>
        public PrimaryOwner( Party48Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
