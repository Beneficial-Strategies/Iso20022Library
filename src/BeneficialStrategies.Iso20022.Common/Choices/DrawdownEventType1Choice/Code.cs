...
namespace BeneficialStrategies.Iso20022.Choices.DrawdownEventType1Choice
{
    ...
    #else
    public partial class Code : DrawdownEventType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DrawdownEventType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DrawdownEventType1Code Value { get; init; } 
        #else
        public DrawdownEventType1Code Value { get; set; } 
        #endif
