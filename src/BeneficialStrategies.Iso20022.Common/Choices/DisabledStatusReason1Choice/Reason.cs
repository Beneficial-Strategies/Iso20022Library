...
namespace BeneficialStrategies.Iso20022.Choices.DisabledStatusReason1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : DisabledStatusReason1Choice_
    #else
    public partial class Reason : DisabledStatusReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( DisabledStatusReason2Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
