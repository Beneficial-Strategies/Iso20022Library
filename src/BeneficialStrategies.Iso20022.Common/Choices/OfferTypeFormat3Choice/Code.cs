...
namespace BeneficialStrategies.Iso20022.Choices.OfferTypeFormat3Choice
{
    ...
    #else
    public partial class Code : OfferTypeFormat3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OfferType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OfferType2Code Value { get; init; } 
        #else
        public OfferType2Code Value { get; set; } 
        #endif
