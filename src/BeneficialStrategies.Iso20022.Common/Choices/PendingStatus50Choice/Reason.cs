...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus50Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingStatus50Choice_
    #else
    public partial class Reason : PendingStatus50Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingReason41Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
