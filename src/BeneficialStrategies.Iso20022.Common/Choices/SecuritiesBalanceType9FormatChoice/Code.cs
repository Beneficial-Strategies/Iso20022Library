...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesBalanceType9FormatChoice
{
    ...
    #else
    public partial class Code : SecuritiesBalanceType9FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesBalanceType9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesBalanceType9Code Value { get; init; } 
        #else
        public SecuritiesBalanceType9Code Value { get; set; } 
        #endif
