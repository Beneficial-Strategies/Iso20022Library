...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason23Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason23Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason12Code Value { get; init; } 
        #else
        public UnmatchedReason12Code Value { get; set; } 
        #endif
