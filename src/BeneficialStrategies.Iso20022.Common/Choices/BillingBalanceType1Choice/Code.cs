...
namespace BeneficialStrategies.Iso20022.Choices.BillingBalanceType1Choice
{
    ...
    #else
    public partial class Code : BillingBalanceType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalBillingBalanceType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalBillingBalanceType1Code Value { get; init; } 
        #else
        public ExternalBillingBalanceType1Code Value { get; set; } 
        #endif
