...
namespace BeneficialStrategies.Iso20022.Choices.FormOfSecurity2Choice
{
    ...
    /// </summary>
    [IsoId("_QvHt2Np-Ed-ak6NoX_4Aeg_-1979489686")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FormOfSecurity2Choice_
    #else
    public partial class Proprietary : FormOfSecurity2Choice_
    #endif
    {
