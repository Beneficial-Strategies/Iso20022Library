...
namespace BeneficialStrategies.Iso20022.Choices.References50Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record MarketInfrastructureTransactionIdentification : References50Choice_
    #else
    public partial class MarketInfrastructureTransactionIdentification : References50Choice_
    #endif
    {
