...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat34Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : NetDividendRateFormat34Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : NetDividendRateFormat34Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType75Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType75Choice_ RateType { get; init; } 
        #else
        public RateType75Choice_ RateType { get; set; } 
        #endif
