...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat34Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : NetDividendRateFormat34Choice_
    #else
    public partial class AmountAndRateStatus : NetDividendRateFormat34Choice_
    #endif
    {
