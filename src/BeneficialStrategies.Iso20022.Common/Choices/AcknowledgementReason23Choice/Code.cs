...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason23Choice
{
    ...
    #else
    public partial class Code : AcknowledgementReason23Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AcknowledgementReason9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AcknowledgementReason9Code Value { get; init; } 
        #else
        public AcknowledgementReason9Code Value { get; set; } 
        #endif
