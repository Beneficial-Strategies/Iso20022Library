...
namespace BeneficialStrategies.Iso20022.Choices.PaymentInstrument6Choice
{
    ...
    /// </summary>
    [IsoId("_VKiwRNp-Ed-ak6NoX_4Aeg_-620434482")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ChequeDetails : PaymentInstrument6Choice_
    #else
    public partial class ChequeDetails : PaymentInstrument6Choice_
    #endif
    {
