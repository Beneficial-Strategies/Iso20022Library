...
namespace BeneficialStrategies.Iso20022.Choices.BillingSubServiceQualifier1Choice
{
    ...
    #else
    public partial class Code : BillingSubServiceQualifier1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BillingSubServiceQualifier1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public BillingSubServiceQualifier1Code Value { get; set; } 
        #endif
