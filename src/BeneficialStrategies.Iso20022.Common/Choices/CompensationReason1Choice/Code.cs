...
namespace BeneficialStrategies.Iso20022.Choices.CompensationReason1Choice
{
    ...
    #else
    public partial class Code : CompensationReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalPaymentCompensationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalPaymentCompensationReason1Code Value { get; init; } 
        #else
        public ExternalPaymentCompensationReason1Code Value { get; set; } 
        #endif
