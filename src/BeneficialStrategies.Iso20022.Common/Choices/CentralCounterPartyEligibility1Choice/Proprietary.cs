...
namespace BeneficialStrategies.Iso20022.Choices.CentralCounterPartyEligibility1Choice
{
    ...
    /// </summary>
    [IsoId("_QvkZwNp-Ed-ak6NoX_4Aeg_74167294")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CentralCounterPartyEligibility1Choice_
    #else
    public partial class Proprietary : CentralCounterPartyEligibility1Choice_
    #endif
    {
