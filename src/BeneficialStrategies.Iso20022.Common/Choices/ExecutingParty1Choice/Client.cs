...
namespace BeneficialStrategies.Iso20022.Choices.ExecutingParty1Choice
{
    ...
    #else
    public partial class Client : ExecutingParty1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Client instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Client( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
