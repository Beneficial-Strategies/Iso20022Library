...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionOption18Choice.Code),
        nameof(CorporateActionOption18Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionOption18Choice.Proprietary),
        nameof(CorporateActionOption18Choice.Proprietary)
    )]
    [IsoId("_eSyW0UEHEeWVgfuHGaKtRQ")]
    [DisplayName("Corporate Action Option 18 Choice")]
    public abstract record CorporateActionOption18Choice_ { }
}
