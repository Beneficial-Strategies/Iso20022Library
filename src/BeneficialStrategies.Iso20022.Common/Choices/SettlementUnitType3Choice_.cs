...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementUnitType3Choice.Code),
        nameof(SettlementUnitType3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementUnitType3Choice.Proprietary),
        nameof(SettlementUnitType3Choice.Proprietary)
    )]
    [IsoId("_dzq1AeLxEeWOD7aAy2fAcA")]
    [DisplayName("Settlement Unit Type 3 Choice")]
    public abstract record SettlementUnitType3Choice_ { }
}
