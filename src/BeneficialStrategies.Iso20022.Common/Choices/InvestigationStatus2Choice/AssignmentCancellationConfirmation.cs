...
namespace BeneficialStrategies.Iso20022.Choices.InvestigationStatus2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AssignmentCancellationConfirmation : InvestigationStatus2Choice_
    #else
    public partial class AssignmentCancellationConfirmation : InvestigationStatus2Choice_
    #endif
    {
