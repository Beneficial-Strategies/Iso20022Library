...
namespace BeneficialStrategies.Iso20022.Choices.InvestigationStatus2Choice
{
    ...
    #else
    public partial class RejectedModification : InvestigationStatus2Choice_
    #endif
    {
        ...
        /// </summary>
        public RejectedModification( ModificationRejection2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public ModificationRejection2Code Value { get; set; } 
        #endif
