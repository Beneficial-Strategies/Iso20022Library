...
namespace BeneficialStrategies.Iso20022.Choices.PendingCancellationReason4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingCancellationReason4Choice_
    #else
    public partial class Proprietary : PendingCancellationReason4Choice_
    #endif
    {
