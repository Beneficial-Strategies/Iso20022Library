...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat37Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : GrossDividendRateFormat37Choice_
    #else
    public partial class AmountAndRateStatus : GrossDividendRateFormat37Choice_
    #endif
    {
