...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AwaitingAffirmationReason1Choice.Code),
        nameof(AwaitingAffirmationReason1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AwaitingAffirmationReason1Choice.Proprietary),
        nameof(AwaitingAffirmationReason1Choice.Proprietary)
    )]
    [IsoId("_A6MM0NokEeC60axPepSq7g_-1469713993")]
    [DisplayName("Awaiting Affirmation Reason 1 Choice")]
    public abstract record AwaitingAffirmationReason1Choice_ { }
}
