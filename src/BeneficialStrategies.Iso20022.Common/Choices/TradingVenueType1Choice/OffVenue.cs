...
namespace BeneficialStrategies.Iso20022.Choices.TradingVenueType1Choice
{
    ...
    #else
    public partial class OffVenue : TradingVenueType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a OffVenue instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public OffVenue( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
