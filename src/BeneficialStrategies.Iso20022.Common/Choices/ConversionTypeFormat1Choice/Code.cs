...
namespace BeneficialStrategies.Iso20022.Choices.ConversionTypeFormat1Choice
{
    ...
    #else
    public partial class Code : ConversionTypeFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ConversionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ConversionType1Code Value { get; init; } 
        #else
        public ConversionType1Code Value { get; set; } 
        #endif
