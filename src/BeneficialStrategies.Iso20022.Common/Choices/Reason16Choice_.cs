...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Reason16Choice.RepoCallAcknowledgementReason),
        nameof(Reason16Choice.RepoCallAcknowledgementReason)
    )]
    [JsonDerivedType(
        typeof(Reason16Choice.CancellationReason),
        nameof(Reason16Choice.CancellationReason)
    )]
    [JsonDerivedType(
        typeof(Reason16Choice.PendingCancellationReason),
        nameof(Reason16Choice.PendingCancellationReason)
    )]
    [JsonDerivedType(
        typeof(Reason16Choice.GeneratedReason),
        nameof(Reason16Choice.GeneratedReason)
    )]
    [JsonDerivedType(typeof(Reason16Choice.DeniedReason), nameof(Reason16Choice.DeniedReason))]
    [JsonDerivedType(
        typeof(Reason16Choice.AcknowledgedAcceptedReason),
        nameof(Reason16Choice.AcknowledgedAcceptedReason)
    )]
    ...
    [JsonDerivedType(
        typeof(Reason16Choice.PendingProcessingReason),
        nameof(Reason16Choice.PendingProcessingReason)
    )]
    [JsonDerivedType(
        typeof(Reason16Choice.RejectionReason),
        nameof(Reason16Choice.RejectionReason)
    )]
    [JsonDerivedType(typeof(Reason16Choice.RepairReason), nameof(Reason16Choice.RepairReason))]
    [JsonDerivedType(
        typeof(Reason16Choice.PendingModificationReason),
        nameof(Reason16Choice.PendingModificationReason)
    )]
    [JsonDerivedType(
        typeof(Reason16Choice.UnmatchedReason),
        nameof(Reason16Choice.UnmatchedReason)
    )]
    [IsoId("_j3rg_TnvEeWfSKvvZlhRKg")]
    [DisplayName("Reason 16 Choice")]
    public abstract record Reason16Choice_ { }
}
