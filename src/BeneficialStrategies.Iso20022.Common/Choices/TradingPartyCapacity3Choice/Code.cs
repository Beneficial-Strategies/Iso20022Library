...
namespace BeneficialStrategies.Iso20022.Choices.TradingPartyCapacity3Choice
{
    ...
    #else
    public partial class Code : TradingPartyCapacity3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TradingCapacity6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TradingCapacity6Code Value { get; init; } 
        #else
        public TradingCapacity6Code Value { get; set; } 
        #endif
