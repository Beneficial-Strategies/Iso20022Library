...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PendingCancellationReason3Choice.Code),
        nameof(PendingCancellationReason3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(PendingCancellationReason3Choice.Proprietary),
        nameof(PendingCancellationReason3Choice.Proprietary)
    )]
    [IsoId("_MinedUGXEeWqy4niLuXETA")]
    [DisplayName("Pending Cancellation Reason 3 Choice")]
    public abstract record PendingCancellationReason3Choice_ { }
}
