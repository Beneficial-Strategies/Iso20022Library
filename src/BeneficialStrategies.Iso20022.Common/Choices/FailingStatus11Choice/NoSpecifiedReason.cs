...
namespace BeneficialStrategies.Iso20022.Choices.FailingStatus11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : FailingStatus11Choice_
    #else
    public partial class NoSpecifiedReason : FailingStatus11Choice_
    #endif
    {
