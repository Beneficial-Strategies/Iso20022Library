...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BenchmarkCurveName7Choice.Code),
        nameof(BenchmarkCurveName7Choice.Code)
    )]
    [JsonDerivedType(
        typeof(BenchmarkCurveName7Choice.Proprietary),
        nameof(BenchmarkCurveName7Choice.Proprietary)
    )]
    [IsoId("_HZotkeLwEeWOD7aAy2fAcA")]
    [DisplayName("Benchmark Curve Name 7 Choice")]
    public abstract record BenchmarkCurveName7Choice_ { }
}
