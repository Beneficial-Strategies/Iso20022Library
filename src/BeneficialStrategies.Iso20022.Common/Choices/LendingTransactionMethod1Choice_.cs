...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(LendingTransactionMethod1Choice.Code),
        nameof(LendingTransactionMethod1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(LendingTransactionMethod1Choice.Proprietary),
        nameof(LendingTransactionMethod1Choice.Proprietary)
    )]
    [IsoId("_AXB1YNokEeC60axPepSq7g_713665433")]
    [DisplayName("Lending Transaction Method 1 Choice")]
    public abstract record LendingTransactionMethod1Choice_ { }
}
