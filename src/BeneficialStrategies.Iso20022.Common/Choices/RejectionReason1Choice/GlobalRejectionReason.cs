...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason1Choice
{
    ...
    #else
    public partial class GlobalRejectionReason : RejectionReason1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a GlobalRejectionReason instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public GlobalRejectionReason( System.String reqDescription )
        {
