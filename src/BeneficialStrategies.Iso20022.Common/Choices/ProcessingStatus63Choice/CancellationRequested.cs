...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus63Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : ProcessingStatus63Choice_
    #else
    public partial class CancellationRequested : ProcessingStatus63Choice_
    #endif
    {
