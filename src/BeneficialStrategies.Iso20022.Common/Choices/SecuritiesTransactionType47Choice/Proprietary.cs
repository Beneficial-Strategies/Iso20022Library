...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType47Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType47Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType47Choice_
    #endif
    {
