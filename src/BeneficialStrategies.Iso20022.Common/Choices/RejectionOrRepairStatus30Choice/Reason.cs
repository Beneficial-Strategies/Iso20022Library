...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus30Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionOrRepairStatus30Choice_
    #else
    public partial class Reason : RejectionOrRepairStatus30Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionAndRepairReason24Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
