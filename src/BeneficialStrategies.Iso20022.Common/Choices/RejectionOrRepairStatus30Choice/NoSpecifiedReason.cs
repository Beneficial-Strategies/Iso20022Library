...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus30Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionOrRepairStatus30Choice_
    #else
    public partial class NoSpecifiedReason : RejectionOrRepairStatus30Choice_
    #endif
    {
