...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason9Choice
{
    ...
    /// </summary>
    [IsoId("_A5wH8tokEeC60axPepSq7g_873663092")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason9Choice_
    #else
    public partial class Proprietary : RejectionReason9Choice_
    #endif
    {
