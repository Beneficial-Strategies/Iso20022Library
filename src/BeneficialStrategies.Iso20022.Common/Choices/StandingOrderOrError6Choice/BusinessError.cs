...
namespace BeneficialStrategies.Iso20022.Choices.StandingOrderOrError6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BusinessError : StandingOrderOrError6Choice_
    #else
    public partial class BusinessError : StandingOrderOrError6Choice_
    #endif
    {
