...
namespace BeneficialStrategies.Iso20022.Choices.InRepairStatus4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DataSourceScheme : InRepairStatus4Choice_
    #else
    public partial class DataSourceScheme : InRepairStatus4Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a DataSourceScheme instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public DataSourceScheme( System.String reqIdentification )
        {
