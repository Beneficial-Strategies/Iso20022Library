...
namespace BeneficialStrategies.Iso20022.Choices.RejectionStatus3Choice
{
    ...
    /// </summary>
    [IsoId("_UVy5lNp-Ed-ak6NoX_4Aeg_68497547")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionStatus3Choice_
    #else
    public partial class NoSpecifiedReason : RejectionStatus3Choice_
    #endif
    {
