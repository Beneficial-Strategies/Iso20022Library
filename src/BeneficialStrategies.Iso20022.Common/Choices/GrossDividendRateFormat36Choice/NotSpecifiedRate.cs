...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat36Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : GrossDividendRateFormat36Choice_
    #else
    public partial class NotSpecifiedRate : GrossDividendRateFormat36Choice_
    #endif
    {
