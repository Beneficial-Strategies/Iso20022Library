...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AssetClassCommodityPolypropylene3Choice.Plastic),
        nameof(AssetClassCommodityPolypropylene3Choice.Plastic)
    )]
    [JsonDerivedType(
        typeof(AssetClassCommodityPolypropylene3Choice.Other),
        nameof(AssetClassCommodityPolypropylene3Choice.Other)
    )]
    [IsoId("_IX9wAbv9EeiLRYqS-r-R-A")]
    [DisplayName("Asset Class Commodity Polypropylene 3 Choice")]
    public abstract record AssetClassCommodityPolypropylene3Choice_ { }
}
