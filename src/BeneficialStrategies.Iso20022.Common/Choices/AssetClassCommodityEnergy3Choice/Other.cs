...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnergy3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : AssetClassCommodityEnergy3Choice_
    #else
    public partial class Other : AssetClassCommodityEnergy3Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType2Code reqBaseProduct )
        {
