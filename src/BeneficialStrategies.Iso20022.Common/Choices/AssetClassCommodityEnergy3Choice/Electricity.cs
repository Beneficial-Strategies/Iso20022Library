...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnergy3Choice
{
    ...
    #else
    public partial class Electricity : AssetClassCommodityEnergy3Choice_
    #endif
    {
        ...
        /// </summary>
        public Electricity( AssetClassProductType2Code reqBaseProduct )
        {
