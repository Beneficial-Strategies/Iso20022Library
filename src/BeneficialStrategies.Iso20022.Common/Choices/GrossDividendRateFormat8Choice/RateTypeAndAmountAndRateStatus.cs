...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : GrossDividendRateFormat8Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : GrossDividendRateFormat8Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType20Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType20Choice_ RateType { get; init; } 
        #else
        public RateType20Choice_ RateType { get; set; } 
        #endif
