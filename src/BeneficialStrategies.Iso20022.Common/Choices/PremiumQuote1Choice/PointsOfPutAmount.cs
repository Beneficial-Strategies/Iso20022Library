...
namespace BeneficialStrategies.Iso20022.Choices.PremiumQuote1Choice
{
    ...
    #else
    public partial class PointsOfPutAmount : PremiumQuote1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PointsOfPutAmount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PointsOfPutAmount( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
