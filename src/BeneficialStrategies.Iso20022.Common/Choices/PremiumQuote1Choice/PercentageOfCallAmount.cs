...
namespace BeneficialStrategies.Iso20022.Choices.PremiumQuote1Choice
{
    ...
    #else
    public partial class PercentageOfCallAmount : PremiumQuote1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PercentageOfCallAmount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PercentageOfCallAmount( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
