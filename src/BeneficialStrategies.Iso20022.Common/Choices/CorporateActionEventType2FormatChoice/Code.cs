...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType2FormatChoice
{
    ...
    #else
    public partial class Code : CorporateActionEventType2FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType2Code Value { get; init; } 
        #else
        public CorporateActionEventType2Code Value { get; set; } 
        #endif
