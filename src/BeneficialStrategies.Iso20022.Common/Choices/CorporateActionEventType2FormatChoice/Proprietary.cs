...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType2FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RjRupdp-Ed-ak6NoX_4Aeg_-1421399537")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType2FormatChoice_
    #else
    public partial class Proprietary : CorporateActionEventType2FormatChoice_
    #endif
    {
