...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType9Choice
{
    ...
    #else
    public partial class Code : FractionDispositionType9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FractionDispositionType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FractionDispositionType5Code Value { get; init; } 
        #else
        public FractionDispositionType5Code Value { get; set; } 
        #endif
