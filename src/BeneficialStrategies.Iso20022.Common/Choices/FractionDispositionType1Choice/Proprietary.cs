...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType1Choice
{
    ...
    /// </summary>
    [IsoId("_Q1FL49p-Ed-ak6NoX_4Aeg_1269654743")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType1Choice_
    #else
    public partial class Proprietary : FractionDispositionType1Choice_
    #endif
    {
