...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType1Choice
{
    ...
    #else
    public partial class Code : FractionDispositionType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FractionDispositionType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FractionDispositionType4Code Value { get; init; } 
        #else
        public FractionDispositionType4Code Value { get; set; } 
        #endif
