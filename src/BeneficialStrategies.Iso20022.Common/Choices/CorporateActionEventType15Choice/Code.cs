...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType15Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType15Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType14Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType14Code Value { get; init; } 
        #else
        public CorporateActionEventType14Code Value { get; set; } 
        #endif
