...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType11Choice
{
    ...
    #else
    public partial class Code : RepurchaseType11Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepurchaseType7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepurchaseType7Code Value { get; init; } 
        #else
        public RepurchaseType7Code Value { get; set; } 
        #endif
