...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification30Choice
{
    ...
    /// </summary>
    [IsoId("_QQIEuNp-Ed-ak6NoX_4Aeg_-1070125411")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification30Choice_
    #else
    public partial class NameAndAddress : PartyIdentification30Choice_
    #endif
    {
