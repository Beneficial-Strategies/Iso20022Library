...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification30Choice
{
    ...
    /// </summary>
    [IsoId("_QQIEudp-Ed-ak6NoX_4Aeg_1572214377")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification30Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification30Choice_
    #endif
    {
