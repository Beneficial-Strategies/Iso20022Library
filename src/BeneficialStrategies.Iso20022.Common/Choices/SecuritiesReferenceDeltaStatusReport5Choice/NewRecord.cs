...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesReferenceDeltaStatusReport5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NewRecord : SecuritiesReferenceDeltaStatusReport5Choice_
    #else
    public partial class NewRecord : SecuritiesReferenceDeltaStatusReport5Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NewRecord instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NewRecord( SecurityInstrumentDescription9 reqFinancialInstrumentGeneralAttributes,System.String reqIssuer )
        {
