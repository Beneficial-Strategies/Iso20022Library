...
namespace BeneficialStrategies.Iso20022.Choices.RateValueType2FormatChoice
{
    ...
    /// </summary>
    [IsoId("_Rn5I5tp-Ed-ak6NoX_4Aeg_-895977984")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RateValueType2FormatChoice_
    #else
    public partial class Proprietary : RateValueType2FormatChoice_
    #endif
    {
