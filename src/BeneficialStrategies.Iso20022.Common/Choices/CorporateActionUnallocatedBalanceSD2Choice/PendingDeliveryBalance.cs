...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PendingDeliveryBalance : CorporateActionUnallocatedBalanceSD2Choice_
    #else
    public partial class PendingDeliveryBalance : CorporateActionUnallocatedBalanceSD2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PendingDeliveryBalance instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PendingDeliveryBalance( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
        {
