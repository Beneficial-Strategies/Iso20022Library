...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BorrowedBalance : CorporateActionUnallocatedBalanceSD2Choice_
    #else
    public partial class BorrowedBalance : CorporateActionUnallocatedBalanceSD2Choice_
    #endif
    {
