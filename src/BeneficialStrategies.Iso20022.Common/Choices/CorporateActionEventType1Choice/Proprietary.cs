...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType1Choice
{
    ...
    /// </summary>
    [IsoId("_QwUAodp-Ed-ak6NoX_4Aeg_2018145722")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType1Choice_
    #else
    public partial class Proprietary : CorporateActionEventType1Choice_
    #endif
    {
