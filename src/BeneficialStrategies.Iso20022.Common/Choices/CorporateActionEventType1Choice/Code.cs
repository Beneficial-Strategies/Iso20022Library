...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType1Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType3Code Value { get; init; } 
        #else
        public CorporateActionEventType3Code Value { get; set; } 
        #endif
