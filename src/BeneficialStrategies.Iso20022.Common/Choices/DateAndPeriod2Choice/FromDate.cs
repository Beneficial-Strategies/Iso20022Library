...
namespace BeneficialStrategies.Iso20022.Choices.DateAndPeriod2Choice
{
    ...
    /// </summary>
    [IsoId("_76joYKMgEeCJ6YNENx4h-w_-1958941273")]
    ...
    #else
    public partial class FromDate : DateAndPeriod2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a FromDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public FromDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
