...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionPrice3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PendingPrice : SecuritiesTransactionPrice3Choice_
    #else
    public partial class PendingPrice : SecuritiesTransactionPrice3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PendingPrice instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PendingPrice( PriceStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public PriceStatus1Code Value { get; set; } 
        #endif
