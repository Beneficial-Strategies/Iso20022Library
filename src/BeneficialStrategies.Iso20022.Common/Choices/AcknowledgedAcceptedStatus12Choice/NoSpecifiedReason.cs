...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : AcknowledgedAcceptedStatus12Choice_
    #else
    public partial class NoSpecifiedReason : AcknowledgedAcceptedStatus12Choice_
    #endif
    {
