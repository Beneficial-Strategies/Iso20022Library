...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionOrRepairStatus31Choice_
    #else
    public partial class NoSpecifiedReason : RejectionOrRepairStatus31Choice_
    #endif
    {
