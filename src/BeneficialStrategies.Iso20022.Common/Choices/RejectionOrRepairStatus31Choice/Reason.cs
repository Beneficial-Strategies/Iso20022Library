...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionOrRepairStatus31Choice_
    #else
    public partial class Reason : RejectionOrRepairStatus31Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionAndRepairReason25Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public RejectionAndRepairReason25Choice_ Code { get; init; } 
        #else
        public RejectionAndRepairReason25Choice_ Code { get; set; } 
        #endif
