...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus42Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionOrRepairStatus42Choice_
    #else
    public partial class Reason : RejectionOrRepairStatus42Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionAndRepairReason37Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
