...
namespace BeneficialStrategies.Iso20022.Choices.Quantity13Choice
{
    ...
    #else
    public partial class PortfolioTransferOutRate : Quantity13Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PortfolioTransferOutRate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PortfolioTransferOutRate( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
