...
namespace BeneficialStrategies.Iso20022.Choices.RejectionStatus14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionStatus14Choice_
    #else
    public partial class Reason : RejectionStatus14Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionReason15Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
