...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TemporaryFinancialInstrumentIndicator3Choice.TemporaryIndicator),
        nameof(TemporaryFinancialInstrumentIndicator3Choice.TemporaryIndicator)
    )]
    [JsonDerivedType(
        typeof(TemporaryFinancialInstrumentIndicator3Choice.Proprietary),
        nameof(TemporaryFinancialInstrumentIndicator3Choice.Proprietary)
    )]
    [IsoId("_KJSKkUEKEeWVgfuHGaKtRQ")]
    [DisplayName("Temporary Financial Instrument Indicator 3 Choice")]
    public abstract record TemporaryFinancialInstrumentIndicator3Choice_ { }
}
