...
namespace BeneficialStrategies.Iso20022.Choices.PaymentStatusCode3Choice
{
    ...
    /// </summary>
    [IsoId("_RF7ESNp-Ed-ak6NoX_4Aeg_2006585750")]
    ...
    #else
    public partial class PendingStatus : PaymentStatusCode3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PendingStatus instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PendingStatus( PendingStatus4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
