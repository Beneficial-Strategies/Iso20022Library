...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TradeReport21Choice.Correction),
        nameof(TradeReport21Choice.Correction)
    )]
    [JsonDerivedType(
        typeof(TradeReport21Choice.TradeUpdate),
        nameof(TradeReport21Choice.TradeUpdate)
    )]
    [IsoId("_SJHcgcg2EeuGrNSsxk3B0A")]
    [DisplayName("Trade Report 21 Choice")]
    public abstract record TradeReport21Choice_ { }
}
