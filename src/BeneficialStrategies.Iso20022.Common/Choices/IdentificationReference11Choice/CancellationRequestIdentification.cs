...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationReference11Choice
{
    ...
    #else
    public partial class CancellationRequestIdentification : IdentificationReference11Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a CancellationRequestIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public CancellationRequestIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
