...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RateFormat30Choice.NotSpecifiedRate),nameof(RateFormat30Choice.NotSpecifiedRate))]
    ...
    public abstract partial record RateFormat30Choice_
    {
    }
}
