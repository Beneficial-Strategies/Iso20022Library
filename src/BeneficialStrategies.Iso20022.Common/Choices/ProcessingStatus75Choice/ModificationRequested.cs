...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus75Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : ProcessingStatus75Choice_
    #else
    public partial class ModificationRequested : ProcessingStatus75Choice_
    #endif
    {
