...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnvironmental2Choice
{
    ...
    #else
    public partial class Other : AssetClassCommodityEnvironmental2Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType3Code reqBaseProduct,AssetClassSubProductType49Code reqSubProduct )
        {
