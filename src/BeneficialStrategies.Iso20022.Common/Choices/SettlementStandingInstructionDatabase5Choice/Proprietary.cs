...
namespace BeneficialStrategies.Iso20022.Choices.SettlementStandingInstructionDatabase5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementStandingInstructionDatabase5Choice_
    #else
    public partial class Proprietary : SettlementStandingInstructionDatabase5Choice_
    #endif
    {
