...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FixedOrRecurrentDate1Choice.FixedDate),
        nameof(FixedOrRecurrentDate1Choice.FixedDate)
    )]
    [JsonDerivedType(
        typeof(FixedOrRecurrentDate1Choice.RecurrentDate),
        nameof(FixedOrRecurrentDate1Choice.RecurrentDate)
    )]
    [IsoId("_98LLBnltEeG7BsjMvd1mEw_-980384765")]
    [DisplayName("Fixed Or Recurrent Date 1 Choice")]
    public abstract record FixedOrRecurrentDate1Choice_ { }
}
