...
namespace BeneficialStrategies.Iso20022.Choices.MatchingStatus8Choice
{
    ...
    /// </summary>
    [IsoId("_A0Fk1dokEeC60axPepSq7g_-1841500618")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : MatchingStatus8Choice_
    #else
    public partial class Proprietary : MatchingStatus8Choice_
    #endif
    {
