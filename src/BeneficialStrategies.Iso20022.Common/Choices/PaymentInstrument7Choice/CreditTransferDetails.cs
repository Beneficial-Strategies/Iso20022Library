...
namespace BeneficialStrategies.Iso20022.Choices.PaymentInstrument7Choice
{
    ...
    /// </summary>
    [IsoId("_VKiwR9p-Ed-ak6NoX_4Aeg_-1553198084")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CreditTransferDetails : PaymentInstrument7Choice_
    #else
    public partial class CreditTransferDetails : PaymentInstrument7Choice_
    #endif
    {
