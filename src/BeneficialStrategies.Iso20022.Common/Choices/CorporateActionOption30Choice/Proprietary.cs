...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption30Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption30Choice_
    #else
    public partial class Proprietary : CorporateActionOption30Choice_
    #endif
    {
