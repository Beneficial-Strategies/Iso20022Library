...
namespace BeneficialStrategies.Iso20022.Choices.Appearance3Choice
{
    ...
    #else
    public partial class Code : Appearance3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Appearance1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Appearance1Code Value { get; init; } 
        #else
        public Appearance1Code Value { get; set; } 
        #endif
