...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BalanceFormat3Choice.EligibleBalance),
        nameof(BalanceFormat3Choice.EligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat3Choice.NotEligibleBalance),
        nameof(BalanceFormat3Choice.NotEligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat3Choice.FullPeriodUnits),
        nameof(BalanceFormat3Choice.FullPeriodUnits)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat3Choice.PartWayPeriodUnits),
        nameof(BalanceFormat3Choice.PartWayPeriodUnits)
    )]
    [IsoId("_2-A6IRFPEeKp2ZN13DI_pA")]
    [DisplayName("Balance Format 3 Choice")]
    public abstract record BalanceFormat3Choice_ { }
}
