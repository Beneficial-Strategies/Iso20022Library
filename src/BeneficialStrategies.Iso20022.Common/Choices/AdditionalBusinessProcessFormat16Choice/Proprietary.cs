...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AdditionalBusinessProcessFormat16Choice_
    #else
    public partial class Proprietary : AdditionalBusinessProcessFormat16Choice_
    #endif
    {
