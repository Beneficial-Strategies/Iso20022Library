...
namespace BeneficialStrategies.Iso20022.Choices.StatementBasisCodeAndDSSCodeChoice
{
    ...
    #else
    public partial class StatementBasisAsDSS : StatementBasisCodeAndDSSCodeChoice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a StatementBasisAsDSS instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public StatementBasisAsDSS( System.String reqIssuer,System.String reqInformation )
        {
            Issuer = reqIssuer;
