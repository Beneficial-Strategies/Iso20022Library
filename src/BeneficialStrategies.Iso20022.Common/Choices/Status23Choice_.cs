...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Status23Choice.InferredMatchingStatus),
        nameof(Status23Choice.InferredMatchingStatus)
    )]
    [JsonDerivedType(
        typeof(Status23Choice.SettlementStatus),
        nameof(Status23Choice.SettlementStatus)
    )]
    [JsonDerivedType(
        typeof(Status23Choice.InstructionProcessingStatus),
        nameof(Status23Choice.InstructionProcessingStatus)
    )]
    [IsoId("_8VHUK5NLEeWGlc8L7oPDIg")]
    [DisplayName("Status 23 Choice")]
    public abstract record Status23Choice_ { }
}
