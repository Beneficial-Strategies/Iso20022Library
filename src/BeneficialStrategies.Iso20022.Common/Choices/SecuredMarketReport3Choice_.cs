...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SecuredMarketReport3Choice.DataSetAction),
        nameof(SecuredMarketReport3Choice.DataSetAction)
    )]
    [JsonDerivedType(
        typeof(SecuredMarketReport3Choice.Transaction),
        nameof(SecuredMarketReport3Choice.Transaction)
    )]
    [IsoId("_ghnREaidEeWHO_l3hf2rlA")]
    [DisplayName("Secured Market Report 3 Choice")]
    public abstract record SecuredMarketReport3Choice_ { }
}
