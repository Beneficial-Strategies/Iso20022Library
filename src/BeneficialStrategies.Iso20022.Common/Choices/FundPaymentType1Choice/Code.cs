...
namespace BeneficialStrategies.Iso20022.Choices.FundPaymentType1Choice
{
    ...
    #else
    public partial class Code : FundPaymentType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FundPaymentType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FundPaymentType1Code Value { get; init; } 
        #else
        public FundPaymentType1Code Value { get; set; } 
        #endif
