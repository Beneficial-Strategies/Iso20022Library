...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesBalanceType2Choice
{
    ...
    /// </summary>
    [IsoId("_QtL0JNp-Ed-ak6NoX_4Aeg_-1912680829")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesBalanceType2Choice_
    #else
    public partial class Proprietary : SecuritiesBalanceType2Choice_
    #endif
    {
