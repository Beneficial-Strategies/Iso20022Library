...
namespace BeneficialStrategies.Iso20022.Choices.SettlingCapacity3Choice
{
    ...
    /// </summary>
    [IsoId("_AZabANokEeC60axPepSq7g_-560130780")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlingCapacity3Choice_
    #else
    public partial class Proprietary : SettlingCapacity3Choice_
    #endif
    {
