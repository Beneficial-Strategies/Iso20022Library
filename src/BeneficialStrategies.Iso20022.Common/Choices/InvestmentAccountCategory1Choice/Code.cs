...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentAccountCategory1Choice
{
    ...
    #else
    public partial class Code : InvestmentAccountCategory1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestmentAccountCategory1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public InvestmentAccountCategory1Code Value { get; set; } 
        #endif
