...
namespace BeneficialStrategies.Iso20022.Choices.References47Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IntraPositionMovementIdentification : References47Choice_
    #else
    public partial class IntraPositionMovementIdentification : References47Choice_
    #endif
    {
