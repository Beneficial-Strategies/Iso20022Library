...
namespace BeneficialStrategies.Iso20022.Choices.TradeTransactionCondition7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TradeTransactionCondition7Choice_
    #else
    public partial class Proprietary : TradeTransactionCondition7Choice_
    #endif
    {
