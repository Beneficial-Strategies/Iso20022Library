...
namespace BeneficialStrategies.Iso20022.Choices.TypeOfPrice49Choice
{
    ...
    #else
    public partial class Code : TypeOfPrice49Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TypeOfPrice17Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TypeOfPrice17Code Value { get; init; } 
        #else
        public TypeOfPrice17Code Value { get; set; } 
        #endif
