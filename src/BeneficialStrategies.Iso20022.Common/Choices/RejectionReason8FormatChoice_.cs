...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RejectionReason8FormatChoice.Code),
        nameof(RejectionReason8FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(RejectionReason8FormatChoice.Proprietary),
        nameof(RejectionReason8FormatChoice.Proprietary)
    )]
    [IsoId("_Roovwtp-Ed-ak6NoX_4Aeg_520363786")]
    [DisplayName("Rejection Reason 8 Format Choice")]
    public abstract record RejectionReason8FormatChoice_ { }
}
