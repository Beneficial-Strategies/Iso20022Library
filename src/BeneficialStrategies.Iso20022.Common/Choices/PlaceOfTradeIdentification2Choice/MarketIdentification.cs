...
namespace BeneficialStrategies.Iso20022.Choices.PlaceOfTradeIdentification2Choice
{
    ...
    #else
    public partial class MarketIdentification : PlaceOfTradeIdentification2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a MarketIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public MarketIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
