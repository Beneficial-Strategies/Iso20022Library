...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventReference4Choice
{
    ...
    #else
    public partial class LinkedCorporateActionIdentification : CorporateActionEventReference4Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a LinkedCorporateActionIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public LinkedCorporateActionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
