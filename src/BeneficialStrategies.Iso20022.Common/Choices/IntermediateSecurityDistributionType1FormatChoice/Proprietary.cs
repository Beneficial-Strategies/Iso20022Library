...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecurityDistributionType1FormatChoice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IntermediateSecurityDistributionType1FormatChoice_
    #else
    public partial class Proprietary : IntermediateSecurityDistributionType1FormatChoice_
    #endif
    {
