...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecurityDistributionType1FormatChoice
{
    ...
    #else
    public partial class Code : IntermediateSecurityDistributionType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( IntermediateSecurityDistributionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public IntermediateSecurityDistributionType1Code Value { get; init; } 
        #else
        public IntermediateSecurityDistributionType1Code Value { get; set; } 
        #endif
