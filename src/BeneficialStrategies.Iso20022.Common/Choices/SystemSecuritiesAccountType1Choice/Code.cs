...
namespace BeneficialStrategies.Iso20022.Choices.SystemSecuritiesAccountType1Choice
{
    ...
    #else
    public partial class Code : SystemSecuritiesAccountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SystemSecuritiesAccountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SystemSecuritiesAccountType1Code Value { get; init; } 
        #else
        public SystemSecuritiesAccountType1Code Value { get; set; } 
        #endif
