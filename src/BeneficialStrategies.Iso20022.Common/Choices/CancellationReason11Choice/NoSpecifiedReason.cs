...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason11Choice
{
    ...
    /// </summary>
    [IsoId("_A0Fk0dokEeC60axPepSq7g_242608046")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : CancellationReason11Choice_
    #else
    public partial class NoSpecifiedReason : CancellationReason11Choice_
    #endif
    {
