...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType25Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType25Choice_
    #else
    public partial class Proprietary : FractionDispositionType25Choice_
    #endif
    {
