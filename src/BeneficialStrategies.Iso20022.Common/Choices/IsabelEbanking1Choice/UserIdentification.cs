...
namespace BeneficialStrategies.Iso20022.Choices.IsabelEbanking1Choice
{
    ...
    #else
    public partial class UserIdentification : IsabelEbanking1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a UserIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public UserIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
