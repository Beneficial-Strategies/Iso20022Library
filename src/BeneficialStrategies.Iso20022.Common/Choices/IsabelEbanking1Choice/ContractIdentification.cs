...
namespace BeneficialStrategies.Iso20022.Choices.IsabelEbanking1Choice
{
    ...
    #else
    public partial class ContractIdentification : IsabelEbanking1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ContractIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ContractIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
