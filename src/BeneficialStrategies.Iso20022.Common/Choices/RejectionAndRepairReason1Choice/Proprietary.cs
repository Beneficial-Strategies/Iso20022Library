...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason1Choice
{
    ...
    /// </summary>
    [IsoId("_UWrqZ9p-Ed-ak6NoX_4Aeg_-254225546")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason1Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason1Choice_
    #endif
    {
