...
namespace BeneficialStrategies.Iso20022.Choices.RepairReason10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : RepairReason10Choice_
    #else
    public partial class Code : RepairReason10Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepairReason4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepairReason4Code Value { get; init; } 
        #else
        public RepairReason4Code Value { get; set; } 
        #endif
