...
namespace BeneficialStrategies.Iso20022.Choices.RepairStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UYxVE9p-Ed-ak6NoX_4Aeg_1642292154")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RepairStatus1Choice_
    #else
    public partial class NoSpecifiedReason : RepairStatus1Choice_
    #endif
    {
