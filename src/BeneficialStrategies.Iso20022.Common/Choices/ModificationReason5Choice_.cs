...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ModificationReason5Choice.Code),
        nameof(ModificationReason5Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ModificationReason5Choice.Proprietary),
        nameof(ModificationReason5Choice.Proprietary)
    )]
    [IsoId("_6QDrcZNLEeWGlc8L7oPDIg")]
    [DisplayName("Modification Reason 5 Choice")]
    public abstract record ModificationReason5Choice_ { }
}
