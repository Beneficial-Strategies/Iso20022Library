...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason3Choice
{
    ...
    /// </summary>
    [IsoId("_UWigcNp-Ed-ak6NoX_4Aeg_1064638221")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : UnmatchedReason3Choice_
    #else
    public partial class Proprietary : UnmatchedReason3Choice_
    #endif
    {
