...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason21Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason21Choice_
    #else
    public partial class Proprietary : AcknowledgementReason21Choice_
    #endif
    {
