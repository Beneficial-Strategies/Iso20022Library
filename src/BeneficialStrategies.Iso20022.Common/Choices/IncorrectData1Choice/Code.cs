...
namespace BeneficialStrategies.Iso20022.Choices.IncorrectData1Choice
{
    ...
    #else
    public partial class Code : IncorrectData1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalUnableToApplyIncorrectData1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalUnableToApplyIncorrectData1Code Value { get; init; } 
        #else
        public ExternalUnableToApplyIncorrectData1Code Value { get; set; } 
        #endif
