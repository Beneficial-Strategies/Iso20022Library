...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnergy2Choice
{
    ...
    #else
    public partial class Coal : AssetClassCommodityEnergy2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Coal instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Coal( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType24Code reqSubProduct )
        {
