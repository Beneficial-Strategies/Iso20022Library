...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnergy2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RenewableEnergy : AssetClassCommodityEnergy2Choice_
    #else
    public partial class RenewableEnergy : AssetClassCommodityEnergy2Choice_
    #endif
    {
        ...
        /// </summary>
        public RenewableEnergy( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType28Code reqSubProduct )
        {
