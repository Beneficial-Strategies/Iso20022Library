...
namespace BeneficialStrategies.Iso20022.Choices.References54Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OtherTransactionIdentification : References54Choice_
    #else
    public partial class OtherTransactionIdentification : References54Choice_
    #endif
    {
