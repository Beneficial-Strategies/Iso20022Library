...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType2Choice
{
    ...
    #else
    public partial class Code : FractionDispositionType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FractionDispositionType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FractionDispositionType3Code Value { get; init; } 
        #else
        public FractionDispositionType3Code Value { get; set; } 
        #endif
