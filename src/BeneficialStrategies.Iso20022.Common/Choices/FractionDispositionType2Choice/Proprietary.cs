...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType2Choice
{
    ...
    /// </summary>
    [IsoId("_Qzl-J9p-Ed-ak6NoX_4Aeg_33258421")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType2Choice_
    #else
    public partial class Proprietary : FractionDispositionType2Choice_
    #endif
    {
