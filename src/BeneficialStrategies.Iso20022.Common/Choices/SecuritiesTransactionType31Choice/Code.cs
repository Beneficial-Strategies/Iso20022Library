...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType31Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType31Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType11Code Value { get; init; } 
        #else
        public SecuritiesTransactionType11Code Value { get; set; } 
        #endif
