...
namespace BeneficialStrategies.Iso20022.Choices.CertificationTypeFormat3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CertificationTypeFormat3Choice_
    #else
    public partial class Proprietary : CertificationTypeFormat3Choice_
    #endif
    {
