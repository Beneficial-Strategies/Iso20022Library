...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType11Choice_
    #else
    public partial class Proprietary : CorporateActionEventType11Choice_
    #endif
    {
