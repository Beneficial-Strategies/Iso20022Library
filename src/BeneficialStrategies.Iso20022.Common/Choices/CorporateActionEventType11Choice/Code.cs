...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType11Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType11Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType10Code Value { get; init; } 
        #else
        public CorporateActionEventType10Code Value { get; set; } 
        #endif
