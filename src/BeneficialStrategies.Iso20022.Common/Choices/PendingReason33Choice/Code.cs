...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason33Choice
{
    ...
    #else
    public partial class Code : PendingReason33Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason13Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason13Code Value { get; init; } 
        #else
        public PendingReason13Code Value { get; set; } 
        #endif
