...
namespace BeneficialStrategies.Iso20022.Choices.PaymentScheduleType2Choice
{
    ...
    #else
    public partial class Code : PaymentScheduleType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PaymentScheduleType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PaymentScheduleType2Code Value { get; init; } 
        #else
        public PaymentScheduleType2Code Value { get; set; } 
        #endif
