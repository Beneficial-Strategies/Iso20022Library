...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : PendingProcessingStatus13Choice_
    #else
    public partial class NoSpecifiedReason : PendingProcessingStatus13Choice_
    #endif
    {
