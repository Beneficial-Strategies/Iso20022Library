...
namespace BeneficialStrategies.Iso20022.Choices.BalanceType7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : BalanceType7Choice_
    #else
    public partial class Code : BalanceType7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FinancialAssetBalanceType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FinancialAssetBalanceType1Code Value { get; init; } 
        #else
        public FinancialAssetBalanceType1Code Value { get; set; } 
        #endif
