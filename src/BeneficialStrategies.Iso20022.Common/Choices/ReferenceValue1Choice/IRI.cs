...
namespace BeneficialStrategies.Iso20022.Choices.ReferenceValue1Choice
{
    ...
    #else
    public partial class IRI : ReferenceValue1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a IRI instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public IRI( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
