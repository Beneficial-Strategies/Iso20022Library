...
namespace BeneficialStrategies.Iso20022.Choices.OrganisationIdentification15Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AnyBIC : OrganisationIdentification15Choice_
    #else
    public partial class AnyBIC : OrganisationIdentification15Choice_
    #endif
    {
