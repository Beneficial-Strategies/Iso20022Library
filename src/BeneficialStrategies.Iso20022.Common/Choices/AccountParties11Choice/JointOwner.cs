...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record JointOwner : AccountParties11Choice_
    #else
    public partial class JointOwner : AccountParties11Choice_
    #endif
    {
        ...
        /// </summary>
        public JointOwner( Party33Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
