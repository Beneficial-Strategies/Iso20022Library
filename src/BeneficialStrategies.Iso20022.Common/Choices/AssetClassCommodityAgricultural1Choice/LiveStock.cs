...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityAgricultural1Choice
{
    ...
    #else
    public partial class LiveStock : AssetClassCommodityAgricultural1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a LiveStock instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public LiveStock( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType22Code reqSubProduct )
        {
