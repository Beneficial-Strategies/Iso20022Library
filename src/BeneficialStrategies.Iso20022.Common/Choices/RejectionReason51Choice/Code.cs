...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason51Choice
{
    ...
    #else
    public partial class Code : RejectionReason51Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason76Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason76Code Value { get; init; } 
        #else
        public RejectionReason76Code Value { get; set; } 
        #endif
