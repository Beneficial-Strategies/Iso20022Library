...
namespace BeneficialStrategies.Iso20022.Choices.RejectedStatus26Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectedStatus26Choice_
    #else
    public partial class Reason : RejectedStatus26Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectedReason25Choice_ reqReasonCode )
        {
