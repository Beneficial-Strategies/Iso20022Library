...
namespace BeneficialStrategies.Iso20022.Choices.FixedAmountOrUnlimited1Choice
{
    ...
    #else
    public partial class NotLimited : FixedAmountOrUnlimited1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NotLimited instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NotLimited( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
