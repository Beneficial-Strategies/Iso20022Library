...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Error : TradeReport10Choice_
    #else
    public partial class Error : TradeReport10Choice_
    #endif
    {
        ...
        /// </summary>
        public Error( CounterpartyData60 reqCounterpartyData,LoanData86 reqLoanData )
        {
