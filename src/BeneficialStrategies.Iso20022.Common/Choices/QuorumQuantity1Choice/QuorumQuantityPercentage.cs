...
namespace BeneficialStrategies.Iso20022.Choices.QuorumQuantity1Choice
{
    ...
    #else
    public partial class QuorumQuantityPercentage : QuorumQuantity1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a QuorumQuantityPercentage instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public QuorumQuantityPercentage( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
