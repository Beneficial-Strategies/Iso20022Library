...
namespace BeneficialStrategies.Iso20022.Choices.StatusReason3Choice
{
    ...
    #else
    public partial class Code : StatusReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TransactionRejectReason4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransactionRejectReason4Code Value { get; init; } 
        #else
        public TransactionRejectReason4Code Value { get; set; } 
        #endif
