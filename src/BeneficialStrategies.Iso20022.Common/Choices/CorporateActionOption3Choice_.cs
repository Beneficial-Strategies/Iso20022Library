...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionOption3Choice.Code),
        nameof(CorporateActionOption3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionOption3Choice.Proprietary),
        nameof(CorporateActionOption3Choice.Proprietary)
    )]
    [IsoId("_Q1FL59p-Ed-ak6NoX_4Aeg_882016043")]
    [DisplayName("Corporate Action Option 3 Choice")]
    public abstract record CorporateActionOption3Choice_ { }
}
