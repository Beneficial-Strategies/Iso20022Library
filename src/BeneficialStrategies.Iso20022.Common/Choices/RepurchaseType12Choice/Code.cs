...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType12Choice
{
    ...
    #else
    public partial class Code : RepurchaseType12Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepurchaseType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepurchaseType3Code Value { get; init; } 
        #else
        public RepurchaseType3Code Value { get; set; } 
        #endif
