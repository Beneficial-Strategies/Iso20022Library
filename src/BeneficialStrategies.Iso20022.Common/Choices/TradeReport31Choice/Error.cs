...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport31Choice
{
    ...
    #else
    public partial class Error : TradeReport31Choice_
    #endif
    {
        ...
        /// </summary>
        public Error( TradeCounterpartyReport20 reqCounterpartyIdentification,MarginCollateralReport4 reqCollateral )
        {
