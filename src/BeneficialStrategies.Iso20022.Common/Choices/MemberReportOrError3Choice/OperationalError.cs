...
namespace BeneficialStrategies.Iso20022.Choices.MemberReportOrError3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : MemberReportOrError3Choice_
    #else
    public partial class OperationalError : MemberReportOrError3Choice_
    #endif
    {
