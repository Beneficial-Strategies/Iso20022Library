...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountIdentification56Choice.ForAllAccounts),
        nameof(AccountIdentification56Choice.ForAllAccounts)
    )]
    [JsonDerivedType(
        typeof(AccountIdentification56Choice.AccountsListAndBalanceDetails),
        nameof(AccountIdentification56Choice.AccountsListAndBalanceDetails)
    )]
    [IsoId("_QhKpUTgDEe23pOhj-2WbKw")]
    [DisplayName("Account Identification 56 Choice")]
    public abstract record AccountIdentification56Choice_ { }
}
