...
namespace BeneficialStrategies.Iso20022.Choices.GeneratedReasons6Choice
{
    ...
    #else
    public partial class Code : GeneratedReasons6Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GeneratedReason3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GeneratedReason3Code Value { get; init; } 
        #else
        public GeneratedReason3Code Value { get; set; } 
        #endif
