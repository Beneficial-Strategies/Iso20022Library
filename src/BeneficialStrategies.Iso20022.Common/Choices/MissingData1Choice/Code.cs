...
namespace BeneficialStrategies.Iso20022.Choices.MissingData1Choice
{
    ...
    #else
    public partial class Code : MissingData1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalUnableToApplyMissingData1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalUnableToApplyMissingData1Code Value { get; init; } 
        #else
        public ExternalUnableToApplyMissingData1Code Value { get; set; } 
        #endif
