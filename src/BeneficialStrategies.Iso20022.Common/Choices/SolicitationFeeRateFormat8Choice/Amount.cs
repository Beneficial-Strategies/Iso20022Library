...
namespace BeneficialStrategies.Iso20022.Choices.SolicitationFeeRateFormat8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : SolicitationFeeRateFormat8Choice_
    #else
    public partial class Amount : SolicitationFeeRateFormat8Choice_
    #endif
    {
