...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason49Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : PendingReason49Choice_
    #else
    public partial class Code : PendingReason49Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason14Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason14Code Value { get; init; } 
        #else
        public PendingReason14Code Value { get; set; } 
        #endif
