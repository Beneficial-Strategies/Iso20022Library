...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType86Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType86Choice_
    #else
    public partial class Proprietary : CorporateActionEventType86Choice_
    #endif
    {
