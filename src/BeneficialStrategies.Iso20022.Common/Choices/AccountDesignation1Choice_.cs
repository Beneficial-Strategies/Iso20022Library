...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountDesignation1Choice.Code),
        nameof(AccountDesignation1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AccountDesignation1Choice.Proprietary),
        nameof(AccountDesignation1Choice.Proprietary)
    )]
    [IsoId("_gpWFICCzEeWJd9HF2tO7BA")]
    [DisplayName("Account Designation 1 Choice")]
    public abstract record AccountDesignation1Choice_ { }
}
