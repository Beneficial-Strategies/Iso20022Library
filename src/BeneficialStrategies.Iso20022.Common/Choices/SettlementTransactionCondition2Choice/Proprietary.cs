...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition2Choice
{
    ...
    /// </summary>
    [IsoId("_QuYG9dp-Ed-ak6NoX_4Aeg_-450512440")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementTransactionCondition2Choice_
    #else
    public partial class Proprietary : SettlementTransactionCondition2Choice_
    #endif
    {
