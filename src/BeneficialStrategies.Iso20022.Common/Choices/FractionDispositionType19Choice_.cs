...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FractionDispositionType19Choice.Code),
        nameof(FractionDispositionType19Choice.Code)
    )]
    [JsonDerivedType(
        typeof(FractionDispositionType19Choice.Proprietary),
        nameof(FractionDispositionType19Choice.Proprietary)
    )]
    [IsoId("_ImikQWSEEeKFfdK0gKYFLQ")]
    [DisplayName("Fraction Disposition Type 19 Choice")]
    public abstract record FractionDispositionType19Choice_ { }
}
