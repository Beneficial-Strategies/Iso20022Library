...
namespace BeneficialStrategies.Iso20022.Choices.AffirmationReason1Choice
{
    ...
    /// </summary>
    [IsoId("_Azo44tokEeC60axPepSq7g_-1600518468")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : AffirmationReason1Choice_
    #else
    public partial class NoSpecifiedReason : AffirmationReason1Choice_
    #endif
    {
