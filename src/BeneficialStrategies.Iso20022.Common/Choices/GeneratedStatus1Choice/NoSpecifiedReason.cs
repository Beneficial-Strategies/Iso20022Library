...
namespace BeneficialStrategies.Iso20022.Choices.GeneratedStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UY7GFNp-Ed-ak6NoX_4Aeg_285305461")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : GeneratedStatus1Choice_
    #else
    public partial class NoSpecifiedReason : GeneratedStatus1Choice_
    #endif
    {
