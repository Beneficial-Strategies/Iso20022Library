...
namespace BeneficialStrategies.Iso20022.Choices.ClosureReason2Choice
{
    ...
    #else
    public partial class Code : ClosureReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SystemClosureReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SystemClosureReason1Code Value { get; init; } 
        #else
        public SystemClosureReason1Code Value { get; set; } 
        #endif
