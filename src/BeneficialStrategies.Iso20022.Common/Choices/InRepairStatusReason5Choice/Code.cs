...
namespace BeneficialStrategies.Iso20022.Choices.InRepairStatusReason5Choice
{
    ...
    #else
    public partial class Code : InRepairStatusReason5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InRepairStatusReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InRepairStatusReason1Code Value { get; init; } 
        #else
        public InRepairStatusReason1Code Value { get; set; } 
        #endif
