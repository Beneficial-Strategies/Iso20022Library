...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Party1Choice.OrganisationIdentification),
        nameof(Party1Choice.OrganisationIdentification)
    )]
    [JsonDerivedType(
        typeof(Party1Choice.PrivateIdentification),
        nameof(Party1Choice.PrivateIdentification)
    )]
    [IsoId("_Rca4t9p-Ed-ak6NoX_4Aeg_49258998")]
    [DisplayName("Party 1 Choice")]
    public abstract record Party1Choice_ { }
}
