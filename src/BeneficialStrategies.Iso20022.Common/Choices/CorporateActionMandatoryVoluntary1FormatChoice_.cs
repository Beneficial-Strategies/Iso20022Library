...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionMandatoryVoluntary1FormatChoice.Code),
        nameof(CorporateActionMandatoryVoluntary1FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionMandatoryVoluntary1FormatChoice.Proprietary),
        nameof(CorporateActionMandatoryVoluntary1FormatChoice.Proprietary)
    )]
    [IsoId("_RmZ7Itp-Ed-ak6NoX_4Aeg_1296355739")]
    [DisplayName("Corporate Action Mandatory Voluntary 1 Format Choice")]
    public abstract record CorporateActionMandatoryVoluntary1FormatChoice_ { }
}
