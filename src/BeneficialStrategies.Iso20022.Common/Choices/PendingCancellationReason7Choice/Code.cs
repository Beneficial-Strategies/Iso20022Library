...
namespace BeneficialStrategies.Iso20022.Choices.PendingCancellationReason7Choice
{
    ...
    #else
    public partial class Code : PendingCancellationReason7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingCancellationReason6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingCancellationReason6Code Value { get; init; } 
        #else
        public PendingCancellationReason6Code Value { get; set; } 
        #endif
