...
namespace BeneficialStrategies.Iso20022.Choices.ChargeType2Choice
{
    ...
    #else
    public partial class Code : ChargeType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ChargeType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ChargeType1Code Value { get; init; } 
        #else
        public ChargeType1Code Value { get; set; } 
        #endif
