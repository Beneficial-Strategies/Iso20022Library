...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(MatchingStatus9Choice.MatchedWithTolerance),
        nameof(MatchingStatus9Choice.MatchedWithTolerance)
    )]
    [JsonDerivedType(
        typeof(MatchingStatus9Choice.MatchingAlleged),
        nameof(MatchingStatus9Choice.MatchingAlleged)
    )]
    [JsonDerivedType(
        typeof(MatchingStatus9Choice.Unmatched),
        nameof(MatchingStatus9Choice.Unmatched)
    )]
    [JsonDerivedType(
        typeof(MatchingStatus9Choice.ProprietaryStatus),
        nameof(MatchingStatus9Choice.ProprietaryStatus)
    )]
    [IsoId("_A4aEItokEeC60axPepSq7g_-668898951")]
    [DisplayName("Matching Status 9 Choice")]
    public abstract record MatchingStatus9Choice_ { }
}
