...
namespace BeneficialStrategies.Iso20022.Choices.References60Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesFinancingTransactionIdentification : References60Choice_
    #else
    public partial class SecuritiesFinancingTransactionIdentification : References60Choice_
    #endif
    {
