...
namespace BeneficialStrategies.Iso20022.Choices.SettlementSystemMethod1Choice
{
    ...
    /// </summary>
    [IsoId("_QvkZxdp-Ed-ak6NoX_4Aeg_-1731315832")]
    [DisplayName("Code")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : SettlementSystemMethod1Choice_
    #else
    public partial class Code : SettlementSystemMethod1Choice_
    #endif
    {
