...
namespace BeneficialStrategies.Iso20022.Choices.SettlementSystemMethod1Choice
{
    ...
    /// </summary>
    [IsoId("_QvkZxtp-Ed-ak6NoX_4Aeg_-1724851228")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementSystemMethod1Choice_
    #else
    public partial class Proprietary : SettlementSystemMethod1Choice_
    #endif
    {
