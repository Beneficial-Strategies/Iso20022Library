...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Error : TradeReport32Choice_
    #else
    public partial class Error : TradeReport32Choice_
    #endif
    {
        ...
        /// </summary>
        public Error( CommonTradeDataReport69 reqCommonTradeData )
        {
