...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport32Choice
{
    ...
    #else
    public partial class Revive : TradeReport32Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Revive instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Revive( CommonTradeDataReport69 reqCommonTradeData )
        {
