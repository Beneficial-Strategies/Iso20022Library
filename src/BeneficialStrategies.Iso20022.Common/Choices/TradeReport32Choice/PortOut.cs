...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport32Choice
{
    ...
    #else
    public partial class PortOut : TradeReport32Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PortOut instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PortOut( CommonTradeDataReport69 reqCommonTradeData )
        {
