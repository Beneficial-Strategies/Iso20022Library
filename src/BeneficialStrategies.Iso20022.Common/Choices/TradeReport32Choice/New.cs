...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record New : TradeReport32Choice_
    #else
    public partial class New : TradeReport32Choice_
    #endif
    {
        ...
        /// </summary>
        public New( CommonTradeDataReport69 reqCommonTradeData )
        {
