...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport32Choice
{
    ...
    #else
    public partial class PositionComponent : TradeReport32Choice_
    #endif
    {
        ...
        /// </summary>
        public PositionComponent( CommonTradeDataReport69 reqCommonTradeData )
        {
