...
namespace BeneficialStrategies.Iso20022.Choices.InstrumentSubStructureType2Choice
{
    ...
    #else
    public partial class Code : InstrumentSubStructureType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InstrumentSubStructureType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InstrumentSubStructureType1Code Value { get; init; } 
        #else
        public InstrumentSubStructureType1Code Value { get; set; } 
        #endif
