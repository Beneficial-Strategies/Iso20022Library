...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat23Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : NetDividendRateFormat23Choice_
    #else
    public partial class AmountAndRateStatus : NetDividendRateFormat23Choice_
    #endif
    {
