...
namespace BeneficialStrategies.Iso20022.Choices.SettlementFailsDailyInstructionType1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DataSetAction : SettlementFailsDailyInstructionType1Choice_
    #else
    public partial class DataSetAction : SettlementFailsDailyInstructionType1Choice_
    #endif
    {
