...
namespace BeneficialStrategies.Iso20022.Choices.ChargeTypeFormat3Choice
{
    ...
    #else
    public partial class Code : ChargeTypeFormat3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ChargeType17Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ChargeType17Code Value { get; init; } 
        #else
        public ChargeType17Code Value { get; set; } 
        #endif
