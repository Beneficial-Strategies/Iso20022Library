...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason28Choice
{
    ...
    #else
    public partial class Code : RejectedReason28Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason50Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason50Code Value { get; init; } 
        #else
        public RejectionReason50Code Value { get; set; } 
        #endif
