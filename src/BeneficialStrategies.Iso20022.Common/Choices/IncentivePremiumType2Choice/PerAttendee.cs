...
namespace BeneficialStrategies.Iso20022.Choices.IncentivePremiumType2Choice
{
    ...
    #else
    public partial class PerAttendee : IncentivePremiumType2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PerAttendee instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PerAttendee( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
