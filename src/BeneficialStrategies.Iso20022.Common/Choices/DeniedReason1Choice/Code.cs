...
namespace BeneficialStrategies.Iso20022.Choices.DeniedReason1Choice
{
    ...
    #else
    public partial class Code : DeniedReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DeniedReason5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DeniedReason5Code Value { get; init; } 
        #else
        public DeniedReason5Code Value { get; set; } 
        #endif
