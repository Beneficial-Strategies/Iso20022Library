...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Completed : ProcessingStatus14Choice_
    #else
    public partial class Completed : ProcessingStatus14Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Completed instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Completed( NoReasonCode reqNoSpecifiedReason )
        {
