...
namespace BeneficialStrategies.Iso20022.Choices.MarketIdentification4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record MarketIdentifierCode : MarketIdentification4Choice_
    #else
    public partial class MarketIdentifierCode : MarketIdentification4Choice_
    #endif
    {
