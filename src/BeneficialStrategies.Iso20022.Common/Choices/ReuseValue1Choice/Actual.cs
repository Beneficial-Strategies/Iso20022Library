...
namespace BeneficialStrategies.Iso20022.Choices.ReuseValue1Choice
{
    ...
    #else
    public partial class Actual : ReuseValue1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Actual instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Actual( System.String reqCurrency,System.Decimal reqAmount )
        {
