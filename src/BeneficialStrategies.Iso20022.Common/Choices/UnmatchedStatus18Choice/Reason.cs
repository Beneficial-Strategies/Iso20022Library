...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedStatus18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : UnmatchedStatus18Choice_
    #else
    public partial class Reason : UnmatchedStatus18Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( UnmatchedReason24Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
