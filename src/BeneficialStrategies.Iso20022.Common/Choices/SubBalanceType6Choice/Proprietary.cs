...
namespace BeneficialStrategies.Iso20022.Choices.SubBalanceType6Choice
{
    ...
    /// </summary>
    [IsoId("_QYBcftp-Ed-ak6NoX_4Aeg_1202366991")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SubBalanceType6Choice_
    #else
    public partial class Proprietary : SubBalanceType6Choice_
    #endif
    {
