...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RejectionReason9FormatChoice.Code),
        nameof(RejectionReason9FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(RejectionReason9FormatChoice.Proprietary),
        nameof(RejectionReason9FormatChoice.Proprietary)
    )]
    [IsoId("_Roovxdp-Ed-ak6NoX_4Aeg_-1408419853")]
    [DisplayName("Rejection Reason 9 Format Choice")]
    public abstract record RejectionReason9FormatChoice_ { }
}
