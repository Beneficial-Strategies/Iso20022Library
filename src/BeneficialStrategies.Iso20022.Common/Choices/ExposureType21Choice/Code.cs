...
namespace BeneficialStrategies.Iso20022.Choices.ExposureType21Choice
{
    ...
    #else
    public partial class Code : ExposureType21Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExposureType11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExposureType11Code Value { get; init; } 
        #else
        public ExposureType11Code Value { get; set; } 
        #endif
