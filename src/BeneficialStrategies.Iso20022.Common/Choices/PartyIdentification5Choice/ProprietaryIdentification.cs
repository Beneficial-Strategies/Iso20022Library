...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification5Choice
{
    ...
    /// </summary>
    [IsoId("_QRLNmNp-Ed-ak6NoX_4Aeg_2070041170")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification5Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification5Choice_
    #endif
    {
