...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification5Choice
{
    ...
    /// </summary>
    [IsoId("_QRLNl9p-Ed-ak6NoX_4Aeg_2069121146")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BICOrBEI : PartyIdentification5Choice_
    #else
    public partial class BICOrBEI : PartyIdentification5Choice_
    #endif
    {
