...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementTransactionCondition12Choice_
    #else
    public partial class Proprietary : SettlementTransactionCondition12Choice_
    #endif
    {
