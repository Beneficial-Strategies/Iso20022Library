...
namespace BeneficialStrategies.Iso20022.Choices.StatementBasis6Choice
{
    ...
    /// </summary>
    [IsoId("_nAFOcvNBEeCuA5Tr22BnwA_454957194")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : StatementBasis6Choice_
    #else
    public partial class Proprietary : StatementBasis6Choice_
    #endif
    {
