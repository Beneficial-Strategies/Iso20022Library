...
namespace BeneficialStrategies.Iso20022.Choices.PoliticalExposureType2Choice
{
    ...
    #else
    public partial class Code : PoliticalExposureType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PoliticalExposureType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PoliticalExposureType2Code Value { get; init; } 
        #else
        public PoliticalExposureType2Code Value { get; set; } 
        #endif
