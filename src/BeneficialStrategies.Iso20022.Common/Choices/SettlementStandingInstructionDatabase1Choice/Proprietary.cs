...
namespace BeneficialStrategies.Iso20022.Choices.SettlementStandingInstructionDatabase1Choice
{
    ...
    /// </summary>
    [IsoId("_Qt7bAdp-Ed-ak6NoX_4Aeg_78394216")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementStandingInstructionDatabase1Choice_
    #else
    public partial class Proprietary : SettlementStandingInstructionDatabase1Choice_
    #endif
    {
