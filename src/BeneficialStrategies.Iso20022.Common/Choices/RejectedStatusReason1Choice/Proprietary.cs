...
namespace BeneficialStrategies.Iso20022.Choices.RejectedStatusReason1Choice
{
    ...
    /// </summary>
    [IsoId("_Rhov6Np-Ed-ak6NoX_4Aeg_353021501")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectedStatusReason1Choice_
    #else
    public partial class Proprietary : RejectedStatusReason1Choice_
    #endif
    {
