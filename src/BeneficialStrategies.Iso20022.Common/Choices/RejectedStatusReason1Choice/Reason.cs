...
namespace BeneficialStrategies.Iso20022.Choices.RejectedStatusReason1Choice
{
    ...
    #else
    public partial class Reason : RejectedStatusReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectedStatusReason10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectedStatusReason10Code Value { get; init; } 
        #else
        public RejectedStatusReason10Code Value { get; set; } 
        #endif
