...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalRightThreshold1Choice
{
    ...
    #else
    public partial class AdditionalRightThresholdPercentage : AdditionalRightThreshold1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a AdditionalRightThresholdPercentage instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public AdditionalRightThresholdPercentage( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="AddtlRghtThrshldPctg")]
        #endif
