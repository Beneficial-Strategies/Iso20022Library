...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType102Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType102Choice_
    #else
    public partial class Proprietary : CorporateActionEventType102Choice_
    #endif
    {
