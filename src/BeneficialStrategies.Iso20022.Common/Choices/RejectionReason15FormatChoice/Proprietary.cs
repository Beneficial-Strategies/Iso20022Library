...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason15FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RoV00tp-Ed-ak6NoX_4Aeg_356231669")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason15FormatChoice_
    #else
    public partial class Proprietary : RejectionReason15FormatChoice_
    #endif
    {
