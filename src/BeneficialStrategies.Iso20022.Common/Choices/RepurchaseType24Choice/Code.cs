...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType24Choice
{
    ...
    #else
    public partial class Code : RepurchaseType24Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepurchaseType9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepurchaseType9Code Value { get; init; } 
        #else
        public RepurchaseType9Code Value { get; set; } 
        #endif
