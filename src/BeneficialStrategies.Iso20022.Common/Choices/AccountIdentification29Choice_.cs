...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountIdentification29Choice.ForAllAccounts),
        nameof(AccountIdentification29Choice.ForAllAccounts)
    )]
    [JsonDerivedType(
        typeof(AccountIdentification29Choice.AccountsList),
        nameof(AccountIdentification29Choice.AccountsList)
    )]
    [IsoId("_xiegeTq3EeWQ1Y7f8kds2A")]
    [DisplayName("Account Identification 29 Choice")]
    public abstract record AccountIdentification29Choice_ { }
}
