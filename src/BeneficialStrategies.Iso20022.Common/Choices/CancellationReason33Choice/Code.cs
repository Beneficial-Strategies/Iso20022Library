...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason33Choice
{
    ...
    #else
    public partial class Code : CancellationReason33Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalCancellationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalCancellationReason1Code Value { get; init; } 
        #else
        public ExternalCancellationReason1Code Value { get; set; } 
        #endif
