...
namespace BeneficialStrategies.Iso20022.Choices.TaxEfficientProductType2Choice
{
    ...
    #else
    public partial class Code : TaxEfficientProductType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxEfficientProductType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxEfficientProductType2Code Value { get; init; } 
        #else
        public TaxEfficientProductType2Code Value { get; set; } 
        #endif
