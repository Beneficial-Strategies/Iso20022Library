...
namespace BeneficialStrategies.Iso20022.Choices.GovernanceProcess1Choice
{
    ...
    #else
    public partial class Code : GovernanceProcess1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GovernanceProcessType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GovernanceProcessType1Code Value { get; init; } 
        #else
        public GovernanceProcessType1Code Value { get; set; } 
        #endif
