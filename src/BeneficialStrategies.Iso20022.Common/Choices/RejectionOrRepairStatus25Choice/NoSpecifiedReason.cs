...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus25Choice
{
    ...
    /// </summary>
    [IsoId("__kUpdENHEeGHJ_bHJRPaIQ_1277316146")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionOrRepairStatus25Choice_
    #else
    public partial class NoSpecifiedReason : RejectionOrRepairStatus25Choice_
    #endif
    {
