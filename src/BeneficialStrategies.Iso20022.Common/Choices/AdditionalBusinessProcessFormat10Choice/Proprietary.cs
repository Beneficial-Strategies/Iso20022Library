...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AdditionalBusinessProcessFormat10Choice_
    #else
    public partial class Proprietary : AdditionalBusinessProcessFormat10Choice_
    #endif
    {
