...
namespace BeneficialStrategies.Iso20022.Choices.RateAndAmountFormat5Choice
{
    ...
    /// </summary>
    [IsoId("_UOCrwtp-Ed-ak6NoX_4Aeg_722186532")]
    [DisplayName("Amount")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : RateAndAmountFormat5Choice_
    #else
    public partial class Amount : RateAndAmountFormat5Choice_
    #endif
    {
