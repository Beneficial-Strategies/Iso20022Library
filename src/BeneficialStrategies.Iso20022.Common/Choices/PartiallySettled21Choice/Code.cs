...
namespace BeneficialStrategies.Iso20022.Choices.PartiallySettled21Choice
{
    ...
    #else
    public partial class Code : PartiallySettled21Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettledStatusReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettledStatusReason2Code Value { get; init; } 
        #else
        public SettledStatusReason2Code Value { get; set; } 
        #endif
