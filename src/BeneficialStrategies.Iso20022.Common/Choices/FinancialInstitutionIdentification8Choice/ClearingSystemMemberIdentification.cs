...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstitutionIdentification8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ClearingSystemMemberIdentification : FinancialInstitutionIdentification8Choice_
    #else
    public partial class ClearingSystemMemberIdentification : FinancialInstitutionIdentification8Choice_
    #endif
    {
