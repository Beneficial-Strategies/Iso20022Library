...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType3Choice
{
    ...
    /// </summary>
    [IsoId("_Q4g6ZNp-Ed-ak6NoX_4Aeg_489319378")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType3Choice_
    #else
    public partial class Proprietary : CorporateActionEventType3Choice_
    #endif
    {
