...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus1FormatChoice
{
    ...
    #else
    public partial class Code : ProcessingStatus1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProcessingStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProcessingStatus1Code Value { get; init; } 
        #else
        public ProcessingStatus1Code Value { get; set; } 
        #endif
