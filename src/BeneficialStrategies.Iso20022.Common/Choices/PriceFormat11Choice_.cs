...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceFormat11Choice.PercentagePrice),
        nameof(PriceFormat11Choice.PercentagePrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat11Choice.AmountPrice),
        nameof(PriceFormat11Choice.AmountPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat11Choice.NotSpecifiedPrice),
        nameof(PriceFormat11Choice.NotSpecifiedPrice)
    )]
    [IsoId("_Q4EOdNp-Ed-ak6NoX_4Aeg_1637637339")]
    [DisplayName("Price Format 11 Choice")]
    public abstract record PriceFormat11Choice_ { }
}
