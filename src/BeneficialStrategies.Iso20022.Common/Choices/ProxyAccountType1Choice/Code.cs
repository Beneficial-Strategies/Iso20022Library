...
namespace BeneficialStrategies.Iso20022.Choices.ProxyAccountType1Choice
{
    ...
    #else
    public partial class Code : ProxyAccountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalProxyAccountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalProxyAccountType1Code Value { get; init; } 
        #else
        public ExternalProxyAccountType1Code Value { get; set; } 
        #endif
