...
namespace BeneficialStrategies.Iso20022.Choices.TemporaryFinancialInstrumentIndicator1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TemporaryFinancialInstrumentIndicator1Choice_
    #else
    public partial class Proprietary : TemporaryFinancialInstrumentIndicator1Choice_
    #endif
    {
