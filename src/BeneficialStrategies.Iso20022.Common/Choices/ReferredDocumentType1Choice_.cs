...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ReferredDocumentType1Choice.Code),
        nameof(ReferredDocumentType1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ReferredDocumentType1Choice.Proprietary),
        nameof(ReferredDocumentType1Choice.Proprietary)
    )]
    [IsoId("_T3sBRdp-Ed-ak6NoX_4Aeg_174928116")]
    [DisplayName("Referred Document Type 1 Choice")]
    public abstract record ReferredDocumentType1Choice_ { }
}
