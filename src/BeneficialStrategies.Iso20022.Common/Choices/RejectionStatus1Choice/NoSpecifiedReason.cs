...
namespace BeneficialStrategies.Iso20022.Choices.RejectionStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UVfXkNp-Ed-ak6NoX_4Aeg_909832180")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionStatus1Choice_
    #else
    public partial class NoSpecifiedReason : RejectionStatus1Choice_
    #endif
    {
