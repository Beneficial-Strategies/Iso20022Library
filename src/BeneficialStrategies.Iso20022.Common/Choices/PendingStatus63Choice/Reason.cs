...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus63Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingStatus63Choice_
    #else
    public partial class Reason : PendingStatus63Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingReason59Choice_ reqReasonCode )
        {
