...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason28Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationReason28Choice_
    #else
    public partial class Proprietary : CancellationReason28Choice_
    #endif
    {
