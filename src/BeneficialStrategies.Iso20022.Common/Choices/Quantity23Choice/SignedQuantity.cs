...
namespace BeneficialStrategies.Iso20022.Choices.Quantity23Choice
{
    ...
    #else
    public partial class SignedQuantity : Quantity23Choice_
    #endif
    {
        ...
        /// </summary>
        public SignedQuantity( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
        {
