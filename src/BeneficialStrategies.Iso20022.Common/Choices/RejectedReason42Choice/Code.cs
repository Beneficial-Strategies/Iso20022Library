...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason42Choice
{
    ...
    #else
    public partial class Code : RejectedReason42Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason67Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason67Code Value { get; init; } 
        #else
        public RejectionReason67Code Value { get; set; } 
        #endif
