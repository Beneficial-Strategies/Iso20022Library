...
namespace BeneficialStrategies.Iso20022.Choices.InsuranceType2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : InsuranceType2Choice_
    #else
    public partial class Code : InsuranceType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Insurance1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Insurance1Code Value { get; init; } 
        #else
        public Insurance1Code Value { get; set; } 
        #endif
