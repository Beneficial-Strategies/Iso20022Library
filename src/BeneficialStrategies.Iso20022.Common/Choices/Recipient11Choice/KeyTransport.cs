...
namespace BeneficialStrategies.Iso20022.Choices.Recipient11Choice
{
    ...
    #else
    public partial class KeyTransport : Recipient11Choice_
    #endif
    {
        ...
        /// </summary>
        public KeyTransport( Recipient12Choice_ reqRecipientIdentification,AlgorithmIdentification19 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
        {
