...
namespace BeneficialStrategies.Iso20022.Choices.SettlementType3Choice
{
    ...
    #else
    public partial class Code : SettlementType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementType1Code Value { get; init; } 
        #else
        public SettlementType1Code Value { get; set; } 
        #endif
