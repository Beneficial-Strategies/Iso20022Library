...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason33Choice
{
    ...
    #else
    public partial class Code : RejectedReason33Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectedStatusReason12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectedStatusReason12Code Value { get; init; } 
        #else
        public RejectedStatusReason12Code Value { get; set; } 
        #endif
