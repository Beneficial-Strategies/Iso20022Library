...
namespace BeneficialStrategies.Iso20022.Choices.TaxReferenceParty1Choice
{
    ...
    #else
    public partial class Code : TaxReferenceParty1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( HolderType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public HolderType1Code Value { get; init; } 
        #else
        public HolderType1Code Value { get; set; } 
        #endif
