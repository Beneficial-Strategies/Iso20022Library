...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity16Choice
{
    ...
    #else
    public partial class Code : FinancialInstrumentQuantity16Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Quantity3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Quantity3Code Value { get; init; } 
        #else
        public Quantity3Code Value { get; set; } 
        #endif
