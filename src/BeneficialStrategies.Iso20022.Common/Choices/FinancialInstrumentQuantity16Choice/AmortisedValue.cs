...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmortisedValue : FinancialInstrumentQuantity16Choice_
    #else
    public partial class AmortisedValue : FinancialInstrumentQuantity16Choice_
    #endif
    {
