...
namespace BeneficialStrategies.Iso20022.Choices.ImpliedCurrencyAmountRange1Choice
{
    ...
    #else
    public partial class FromAmount : ImpliedCurrencyAmountRange1Choice_
    #endif
    {
        ...
        /// </summary>
        public FromAmount( ImpliedCurrencyAndAmount reqBoundaryAmount,System.String reqIncluded )
        {
