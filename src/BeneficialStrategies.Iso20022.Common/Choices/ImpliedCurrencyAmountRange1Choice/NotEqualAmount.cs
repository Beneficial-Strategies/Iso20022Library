...
namespace BeneficialStrategies.Iso20022.Choices.ImpliedCurrencyAmountRange1Choice
{
    ...
    #else
    public partial class NotEqualAmount : ImpliedCurrencyAmountRange1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NotEqualAmount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NotEqualAmount( System.String reqCurrency,System.Decimal reqAmount )
        {
