...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat12Choice
{
    ...
    #else
    public partial class Code : AdditionalBusinessProcessFormat12Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AdditionalBusinessProcess5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public AdditionalBusinessProcess5Code Value { get; set; } 
        #endif
