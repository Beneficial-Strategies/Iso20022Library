...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficiaryCertificationType5Choice_
    #else
    public partial class Proprietary : BeneficiaryCertificationType5Choice_
    #endif
    {
