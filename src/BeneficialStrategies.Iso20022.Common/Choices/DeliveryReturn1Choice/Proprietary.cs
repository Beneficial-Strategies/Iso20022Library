...
namespace BeneficialStrategies.Iso20022.Choices.DeliveryReturn1Choice
{
    ...
    /// </summary>
    [IsoId("_QuOV9dp-Ed-ak6NoX_4Aeg_1589917456")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : DeliveryReturn1Choice_
    #else
    public partial class Proprietary : DeliveryReturn1Choice_
    #endif
    {
