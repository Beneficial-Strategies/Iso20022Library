...
namespace BeneficialStrategies.Iso20022.Choices.LendingTransactionMethod1Choice
{
    ...
    #else
    public partial class Code : LendingTransactionMethod1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( LendingTransactionMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public LendingTransactionMethod1Code Value { get; init; } 
        #else
        public LendingTransactionMethod1Code Value { get; set; } 
        #endif
