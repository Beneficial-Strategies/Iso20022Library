...
namespace BeneficialStrategies.Iso20022.Choices.References43Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesFinancingConfirmationIdentification : References43Choice_
    #else
    public partial class SecuritiesFinancingConfirmationIdentification : References43Choice_
    #endif
    {
