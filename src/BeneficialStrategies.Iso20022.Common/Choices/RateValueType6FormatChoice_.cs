...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RateValueType6FormatChoice.Code),
        nameof(RateValueType6FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(RateValueType6FormatChoice.Proprietary),
        nameof(RateValueType6FormatChoice.Proprietary)
    )]
    [IsoId("_Rn5I59p-Ed-ak6NoX_4Aeg_-1190812471")]
    [DisplayName("Rate Value Type 6 Format Choice")]
    public abstract record RateValueType6FormatChoice_ { }
}
