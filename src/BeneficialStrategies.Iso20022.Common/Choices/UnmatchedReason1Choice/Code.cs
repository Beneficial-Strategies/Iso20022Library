...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason1Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason2Code Value { get; init; } 
        #else
        public UnmatchedReason2Code Value { get; set; } 
        #endif
