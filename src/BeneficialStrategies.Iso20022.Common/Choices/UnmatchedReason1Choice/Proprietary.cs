...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason1Choice
{
    ...
    /// </summary>
    [IsoId("_UaHY4dp-Ed-ak6NoX_4Aeg_-1586004186")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : UnmatchedReason1Choice_
    #else
    public partial class Proprietary : UnmatchedReason1Choice_
    #endif
    {
