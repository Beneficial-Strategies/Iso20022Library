...
namespace BeneficialStrategies.Iso20022.Choices.ProcessedStatus5FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RnmN9Np-Ed-ak6NoX_4Aeg_-1894283607")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessedStatus5FormatChoice_
    #else
    public partial class Proprietary : ProcessedStatus5FormatChoice_
    #endif
    {
