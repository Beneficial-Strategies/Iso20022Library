...
namespace BeneficialStrategies.Iso20022.Choices.ProcessedStatus5FormatChoice
{
    ...
    #else
    public partial class Code : ProcessedStatus5FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProcessedStatus5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProcessedStatus5Code Value { get; init; } 
        #else
        public ProcessedStatus5Code Value { get; set; } 
        #endif
