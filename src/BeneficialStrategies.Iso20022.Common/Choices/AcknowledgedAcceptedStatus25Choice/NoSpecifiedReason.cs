...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus25Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : AcknowledgedAcceptedStatus25Choice_
    #else
    public partial class NoSpecifiedReason : AcknowledgedAcceptedStatus25Choice_
    #endif
    {
