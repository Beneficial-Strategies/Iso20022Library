...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus17Choice
{
    ...
    /// </summary>
    [IsoId("_A5JrBNokEeC60axPepSq7g_-1727127313")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record TradingSuspendedByStockExchange : ProcessingStatus17Choice_
    #else
    public partial class TradingSuspendedByStockExchange : ProcessingStatus17Choice_
    #endif
    {
