...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStageFormat13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStageFormat13Choice_
    #else
    public partial class Proprietary : CorporateActionEventStageFormat13Choice_
    #endif
    {
