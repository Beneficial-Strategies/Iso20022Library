...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingReason5Choice
{
    ...
    /// </summary>
    [IsoId("_0jExAglIEeGATtfOBToyew_2042913121")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingProcessingReason5Choice_
    #else
    public partial class Proprietary : PendingProcessingReason5Choice_
    #endif
    {
