...
namespace BeneficialStrategies.Iso20022.Choices.LetterOfGuarantee3Choice
{
    ...
    /// </summary>
    [IsoId("_AY9vE9okEeC60axPepSq7g_1517408108")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : LetterOfGuarantee3Choice_
    #else
    public partial class Proprietary : LetterOfGuarantee3Choice_
    #endif
    {
