...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType2Choice
{
    ...
    #else
    public partial class Code : RepurchaseType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepurchaseType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepurchaseType4Code Value { get; init; } 
        #else
        public RepurchaseType4Code Value { get; set; } 
        #endif
