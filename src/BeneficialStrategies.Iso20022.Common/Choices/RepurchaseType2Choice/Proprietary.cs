...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType2Choice
{
    ...
    /// </summary>
    [IsoId("_QtVlINp-Ed-ak6NoX_4Aeg_566735123")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RepurchaseType2Choice_
    #else
    public partial class Proprietary : RepurchaseType2Choice_
    #endif
    {
