...
namespace BeneficialStrategies.Iso20022.Choices.ModificationReason2Choice
{
    ...
    /// </summary>
    [IsoId("_0jrN9AlIEeGATtfOBToyew_-383362613")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ModificationReason2Choice_
    #else
    public partial class Proprietary : ModificationReason2Choice_
    #endif
    {
