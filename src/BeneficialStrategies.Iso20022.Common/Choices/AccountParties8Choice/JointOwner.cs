...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record JointOwner : AccountParties8Choice_
    #else
    public partial class JointOwner : AccountParties8Choice_
    #endif
    {
        ...
        /// </summary>
        public JointOwner( Party31Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
