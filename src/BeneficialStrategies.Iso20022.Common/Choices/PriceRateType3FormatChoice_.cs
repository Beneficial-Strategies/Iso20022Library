...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceRateType3FormatChoice.Code),
        nameof(PriceRateType3FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(PriceRateType3FormatChoice.Proprietary),
        nameof(PriceRateType3FormatChoice.Proprietary)
    )]
    [IsoId("_RnAYE9p-Ed-ak6NoX_4Aeg_1859127225")]
    [DisplayName("Price Rate Type 3 Format Choice")]
    public abstract record PriceRateType3FormatChoice_ { }
}
