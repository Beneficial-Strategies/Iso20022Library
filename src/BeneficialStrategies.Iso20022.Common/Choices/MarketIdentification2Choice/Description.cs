...
namespace BeneficialStrategies.Iso20022.Choices.MarketIdentification2Choice
{
    ...
    /// </summary>
    [IsoId("_XK10Etp-Ed-ak6NoX_4Aeg_1009207657")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Description : MarketIdentification2Choice_
    #else
    public partial class Description : MarketIdentification2Choice_
    #endif
    {
