...
namespace BeneficialStrategies.Iso20022.Choices.ReturnReason5Choice
{
    ...
    #else
    public partial class Code : ReturnReason5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalReturnReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalReturnReason1Code Value { get; init; } 
        #else
        public ExternalReturnReason1Code Value { get; set; } 
        #endif
