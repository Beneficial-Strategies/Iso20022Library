...
namespace BeneficialStrategies.Iso20022.Choices.ConfirmationRejectedReason1Choice
{
    ...
    #else
    public partial class Code : ConfirmationRejectedReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectedConfirmationStatusReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectedConfirmationStatusReason1Code Value { get; init; } 
        #else
        public RejectedConfirmationStatusReason1Code Value { get; set; } 
        #endif
