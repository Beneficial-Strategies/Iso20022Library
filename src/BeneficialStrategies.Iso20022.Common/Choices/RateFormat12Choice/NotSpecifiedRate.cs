...
namespace BeneficialStrategies.Iso20022.Choices.RateFormat12Choice
{
    ...
    #else
    public partial class NotSpecifiedRate : RateFormat12Choice_
    #endif
    {
        ...
        /// </summary>
        public NotSpecifiedRate( RateType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RateType5Code Value { get; init; } 
        #else
        public RateType5Code Value { get; set; } 
        #endif
