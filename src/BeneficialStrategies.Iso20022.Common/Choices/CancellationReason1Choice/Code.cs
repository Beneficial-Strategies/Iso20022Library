...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason1Choice
{
    ...
    #else
    public partial class Code : CancellationReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancellationReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancellationReason2Code Value { get; init; } 
        #else
        public CancellationReason2Code Value { get; set; } 
        #endif
