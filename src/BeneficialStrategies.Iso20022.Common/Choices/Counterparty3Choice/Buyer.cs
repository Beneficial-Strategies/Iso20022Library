...
namespace BeneficialStrategies.Iso20022.Choices.Counterparty3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Buyer : Counterparty3Choice_
    #else
    public partial class Buyer : Counterparty3Choice_
    #endif
    {
        ...
        /// </summary>
        public Buyer( PartyIdentification49Choice_ reqIdentification )
        {
