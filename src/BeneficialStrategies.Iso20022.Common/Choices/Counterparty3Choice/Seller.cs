...
namespace BeneficialStrategies.Iso20022.Choices.Counterparty3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Seller : Counterparty3Choice_
    #else
    public partial class Seller : Counterparty3Choice_
    #endif
    {
        ...
        /// </summary>
        public Seller( PartyIdentification49Choice_ reqIdentification )
        {
