...
namespace BeneficialStrategies.Iso20022.Choices.References75Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record MarketInfrastructureTransactionIdentification : References75Choice_
    #else
    public partial class MarketInfrastructureTransactionIdentification : References75Choice_
    #endif
    {
