...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CancellationReason31Choice.Code),
        nameof(CancellationReason31Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CancellationReason31Choice.Proprietary),
        nameof(CancellationReason31Choice.Proprietary)
    )]
    [IsoId("_tTaksVM4Eear4I4mBVNwZg")]
    [DisplayName("Cancellation Reason 31 Choice")]
    public abstract record CancellationReason31Choice_ { }
}
