...
namespace BeneficialStrategies.Iso20022.Choices.Recipient6Choice
{
    ...
    #else
    public partial class KEK : Recipient6Choice_
    #endif
    {
        ...
        /// </summary>
        public KEK( KEKIdentifier2 reqKEKIdentification,AlgorithmIdentification23 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
        {
