...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassDetailedSubProductType1Choice
{
    ...
    #else
    public partial class Code : AssetClassDetailedSubProductType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AssetClassDetailedSubProductType16Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AssetClassDetailedSubProductType16Code Value { get; init; } 
        #else
        public AssetClassDetailedSubProductType16Code Value { get; set; } 
        #endif
