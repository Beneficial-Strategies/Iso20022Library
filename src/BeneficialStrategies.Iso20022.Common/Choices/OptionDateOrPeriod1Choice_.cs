...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OptionDateOrPeriod1Choice.EarliestExerciseDate),
        nameof(OptionDateOrPeriod1Choice.EarliestExerciseDate)
    )]
    [JsonDerivedType(
        typeof(OptionDateOrPeriod1Choice.NoticePeriod),
        nameof(OptionDateOrPeriod1Choice.NoticePeriod)
    )]
    [IsoId("_FBT61jU7EeWITbq5W8H-2w")]
    [DisplayName("Option Date Or Period 1 Choice")]
    public abstract record OptionDateOrPeriod1Choice_ { }
}
