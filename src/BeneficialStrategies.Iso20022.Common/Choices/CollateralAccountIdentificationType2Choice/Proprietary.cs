...
namespace BeneficialStrategies.Iso20022.Choices.CollateralAccountIdentificationType2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CollateralAccountIdentificationType2Choice_
    #else
    public partial class Proprietary : CollateralAccountIdentificationType2Choice_
    #endif
    {
