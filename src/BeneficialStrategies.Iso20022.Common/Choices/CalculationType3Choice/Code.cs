...
namespace BeneficialStrategies.Iso20022.Choices.CalculationType3Choice
{
    ...
    #else
    public partial class Code : CalculationType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CalculationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CalculationType1Code Value { get; init; } 
        #else
        public CalculationType1Code Value { get; set; } 
        #endif
