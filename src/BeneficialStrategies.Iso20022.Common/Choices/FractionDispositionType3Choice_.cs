...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FractionDispositionType3Choice.Code),
        nameof(FractionDispositionType3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(FractionDispositionType3Choice.Proprietary),
        nameof(FractionDispositionType3Choice.Proprietary)
    )]
    [IsoId("_QzJSMNp-Ed-ak6NoX_4Aeg_1234427512")]
    [DisplayName("Fraction Disposition Type 3 Choice")]
    public abstract record FractionDispositionType3Choice_ { }
}
