...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType85Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType85Choice_
    #else
    public partial class Proprietary : CorporateActionEventType85Choice_
    #endif
    {
