...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ExchangeRateOrPercentage1Choice.Rate),
        nameof(ExchangeRateOrPercentage1Choice.Rate)
    )]
    [JsonDerivedType(
        typeof(ExchangeRateOrPercentage1Choice.Percentage),
        nameof(ExchangeRateOrPercentage1Choice.Percentage)
    )]
    [IsoId("_lW_QMNfvEeqoweZZxm4TPQ")]
    [DisplayName("Exchange Rate Or Percentage 1 Choice")]
    public abstract record ExchangeRateOrPercentage1Choice_ { }
}
