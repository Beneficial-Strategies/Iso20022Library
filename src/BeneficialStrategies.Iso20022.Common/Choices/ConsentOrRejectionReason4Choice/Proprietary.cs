...
namespace BeneficialStrategies.Iso20022.Choices.ConsentOrRejectionReason4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ConsentOrRejectionReason4Choice_
    #else
    public partial class Proprietary : ConsentOrRejectionReason4Choice_
    #endif
    {
