...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementDateCode11Choice.Code),
        nameof(SettlementDateCode11Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementDateCode11Choice.Proprietary),
        nameof(SettlementDateCode11Choice.Proprietary)
    )]
    [IsoId("_6BMwg5NLEeWGlc8L7oPDIg")]
    [DisplayName("Settlement Date Code 11 Choice")]
    public abstract record SettlementDateCode11Choice_ { }
}
