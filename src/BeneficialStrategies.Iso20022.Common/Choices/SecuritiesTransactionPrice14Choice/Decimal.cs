...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionPrice14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Decimal : SecuritiesTransactionPrice14Choice_
    #else
    public partial class Decimal : SecuritiesTransactionPrice14Choice_
    #endif
    {
