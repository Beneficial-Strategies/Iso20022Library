...
namespace BeneficialStrategies.Iso20022.Choices.TypeOfPrice29Choice
{
    ...
    #else
    public partial class Code : TypeOfPrice29Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TypeOfPrice14Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TypeOfPrice14Code Value { get; init; } 
        #else
        public TypeOfPrice14Code Value { get; set; } 
        #endif
