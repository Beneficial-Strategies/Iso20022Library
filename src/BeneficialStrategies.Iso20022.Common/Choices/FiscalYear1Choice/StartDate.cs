...
namespace BeneficialStrategies.Iso20022.Choices.FiscalYear1Choice
{
    ...
    #else
    public partial class StartDate : FiscalYear1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a StartDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public StartDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
