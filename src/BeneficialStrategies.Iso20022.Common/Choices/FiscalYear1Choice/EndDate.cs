...
namespace BeneficialStrategies.Iso20022.Choices.FiscalYear1Choice
{
    ...
    #else
    public partial class EndDate : FiscalYear1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a EndDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public EndDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
