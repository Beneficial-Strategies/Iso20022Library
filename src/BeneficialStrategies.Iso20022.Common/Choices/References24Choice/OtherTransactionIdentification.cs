...
namespace BeneficialStrategies.Iso20022.Choices.References24Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OtherTransactionIdentification : References24Choice_
    #else
    public partial class OtherTransactionIdentification : References24Choice_
    #endif
    {
