...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification35Choice
{
    ...
    /// </summary>
    [IsoId("_QPYd49p-Ed-ak6NoX_4Aeg_1773963208")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification35Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification35Choice_
    #endif
    {
