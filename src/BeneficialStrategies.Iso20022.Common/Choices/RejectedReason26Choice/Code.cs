...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason26Choice
{
    ...
    #else
    public partial class Code : RejectedReason26Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason48Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason48Code Value { get; init; } 
        #else
        public RejectionReason48Code Value { get; set; } 
        #endif
