...
namespace BeneficialStrategies.Iso20022.Choices.CardPaymentDataSetTransaction10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record TokenResponse : CardPaymentDataSetTransaction10Choice_
    #else
    public partial class TokenResponse : CardPaymentDataSetTransaction10Choice_
    #endif
    {
        ...
        /// </summary>
        public TokenResponse( System.String reqTransactionSequenceCounter,CardPaymentEnvironment78 reqEnvironment )
        {
