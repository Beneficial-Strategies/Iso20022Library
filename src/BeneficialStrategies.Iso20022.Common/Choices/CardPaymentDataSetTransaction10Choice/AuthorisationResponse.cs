...
namespace BeneficialStrategies.Iso20022.Choices.CardPaymentDataSetTransaction10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AuthorisationResponse : CardPaymentDataSetTransaction10Choice_
    #else
    public partial class AuthorisationResponse : CardPaymentDataSetTransaction10Choice_
    #endif
    {
        ...
        /// </summary>
        public AuthorisationResponse( System.String reqTransactionSequenceCounter,CardPaymentEnvironment78 reqEnvironment,CardPaymentTransaction121 reqTransaction,CardPaymentTransaction114 reqTransactionResponse )
        {
