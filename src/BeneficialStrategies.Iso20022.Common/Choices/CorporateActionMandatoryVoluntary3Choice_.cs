...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionMandatoryVoluntary3Choice.Code),
        nameof(CorporateActionMandatoryVoluntary3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionMandatoryVoluntary3Choice.Proprietary),
        nameof(CorporateActionMandatoryVoluntary3Choice.Proprietary)
    )]
    [IsoId("_e9j1tzndEeWLJsP1cO-amg")]
    [DisplayName("Corporate Action Mandatory Voluntary 3 Choice")]
    public abstract record CorporateActionMandatoryVoluntary3Choice_ { }
}
