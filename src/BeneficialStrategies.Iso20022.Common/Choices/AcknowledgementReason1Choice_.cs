...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AcknowledgementReason1Choice.Code),
        nameof(AcknowledgementReason1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AcknowledgementReason1Choice.Proprietary),
        nameof(AcknowledgementReason1Choice.Proprietary)
    )]
    [IsoId("_UXuzR9p-Ed-ak6NoX_4Aeg_-355998535")]
    [DisplayName("Acknowledgement Reason 1 Choice")]
    public abstract record AcknowledgementReason1Choice_ { }
}
