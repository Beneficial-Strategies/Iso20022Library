...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficiaryCertificationType12Choice_
    #else
    public partial class Proprietary : BeneficiaryCertificationType12Choice_
    #endif
    {
