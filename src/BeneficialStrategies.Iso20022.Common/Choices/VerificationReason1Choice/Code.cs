...
namespace BeneficialStrategies.Iso20022.Choices.VerificationReason1Choice
{
    ...
    #else
    public partial class Code : VerificationReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalVerificationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalVerificationReason1Code Value { get; init; } 
        #else
        public ExternalVerificationReason1Code Value { get; set; } 
        #endif
