...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record JointOwner : AccountParties2Choice_
    #else
    public partial class JointOwner : AccountParties2Choice_
    #endif
    {
        ...
        /// </summary>
        public JointOwner( Party14Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
