...
namespace BeneficialStrategies.Iso20022.Choices.PendingCancellationReasons2Choice
{
    ...
    /// </summary>
    [IsoId("_UYBuONp-Ed-ak6NoX_4Aeg_-1094614518")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingCancellationReasons2Choice_
    #else
    public partial class Proprietary : PendingCancellationReasons2Choice_
    #endif
    {
