...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceFormat58Choice.AmountPrice),
        nameof(PriceFormat58Choice.AmountPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat58Choice.NotSpecifiedPrice),
        nameof(PriceFormat58Choice.NotSpecifiedPrice)
    )]
    [IsoId("_ctku05KQEeWHWpTQn1FFVg")]
    [DisplayName("Price Format 58 Choice")]
    public abstract record PriceFormat58Choice_ { }
}
