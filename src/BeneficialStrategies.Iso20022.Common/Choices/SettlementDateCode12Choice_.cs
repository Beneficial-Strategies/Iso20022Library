...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementDateCode12Choice.Code),
        nameof(SettlementDateCode12Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementDateCode12Choice.Proprietary),
        nameof(SettlementDateCode12Choice.Proprietary)
    )]
    [IsoId("_GxX0yZBhEeakHoV5BVecAQ")]
    [DisplayName("Settlement Date Code 12 Choice")]
    public abstract record SettlementDateCode12Choice_ { }
}
