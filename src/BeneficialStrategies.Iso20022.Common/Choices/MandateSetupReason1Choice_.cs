...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(MandateSetupReason1Choice.Code),
        nameof(MandateSetupReason1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(MandateSetupReason1Choice.Proprietary),
        nameof(MandateSetupReason1Choice.Proprietary)
    )]
    [IsoId("_iQq8ND2OEeS6DKIV6SF6gw")]
    [DisplayName("Mandate Setup Reason 1 Choice")]
    public abstract record MandateSetupReason1Choice_ { }
}
