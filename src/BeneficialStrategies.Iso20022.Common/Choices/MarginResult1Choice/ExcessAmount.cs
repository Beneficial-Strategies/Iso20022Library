...
namespace BeneficialStrategies.Iso20022.Choices.MarginResult1Choice
{
    ...
    #else
    public partial class ExcessAmount : MarginResult1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ExcessAmount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ExcessAmount( System.String reqCurrency,System.Decimal reqAmount )
        {
