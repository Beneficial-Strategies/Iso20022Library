...
namespace BeneficialStrategies.Iso20022.Choices.OptionStyle8Choice
{
    ...
    #else
    public partial class Code : OptionStyle8Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionStyle2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionStyle2Code Value { get; init; } 
        #else
        public OptionStyle2Code Value { get; set; } 
        #endif
