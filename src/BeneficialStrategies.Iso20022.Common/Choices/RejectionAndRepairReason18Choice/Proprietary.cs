...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason18Choice
{
    ...
    /// </summary>
    [IsoId("__j39hUNHEeGHJ_bHJRPaIQ_-916101306")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason18Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason18Choice_
    #endif
    {
