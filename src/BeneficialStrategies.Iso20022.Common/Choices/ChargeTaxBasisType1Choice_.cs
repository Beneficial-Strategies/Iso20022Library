...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ChargeTaxBasisType1Choice.Code),
        nameof(ChargeTaxBasisType1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ChargeTaxBasisType1Choice.Proprietary),
        nameof(ChargeTaxBasisType1Choice.Proprietary)
    )]
    [IsoId("_AdIdYtokEeC60axPepSq7g_397232246")]
    [DisplayName("Charge Tax Basis Type 1 Choice")]
    public abstract record ChargeTaxBasisType1Choice_ { }
}
