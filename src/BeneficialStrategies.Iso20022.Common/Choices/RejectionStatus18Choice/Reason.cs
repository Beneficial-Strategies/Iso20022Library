...
namespace BeneficialStrategies.Iso20022.Choices.RejectionStatus18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionStatus18Choice_
    #else
    public partial class Reason : RejectionStatus18Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionReason24Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
