...
namespace BeneficialStrategies.Iso20022.Choices.SecurityStatus3Choice
{
    ...
    #else
    public partial class Code : SecurityStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecurityStatus2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecurityStatus2Code Value { get; init; } 
        #else
        public SecurityStatus2Code Value { get; set; } 
        #endif
