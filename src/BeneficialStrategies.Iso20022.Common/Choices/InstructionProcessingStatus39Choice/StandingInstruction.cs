...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus39Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record StandingInstruction : InstructionProcessingStatus39Choice_
    #else
    public partial class StandingInstruction : InstructionProcessingStatus39Choice_
    #endif
    {
