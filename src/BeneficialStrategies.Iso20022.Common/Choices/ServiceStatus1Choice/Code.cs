...
namespace BeneficialStrategies.Iso20022.Choices.ServiceStatus1Choice
{
    ...
    #else
    public partial class Code : ServiceStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ServiceRequestStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ServiceRequestStatus1Code Value { get; init; } 
        #else
        public ServiceRequestStatus1Code Value { get; set; } 
        #endif
