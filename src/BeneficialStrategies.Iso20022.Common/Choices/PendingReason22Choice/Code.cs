...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason22Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : PendingReason22Choice_
    #else
    public partial class Code : PendingReason22Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason11Code Value { get; init; } 
        #else
        public PendingReason11Code Value { get; set; } 
        #endif
