...
namespace BeneficialStrategies.Iso20022.Choices.CompanyLink1Choice
{
    ...
    #else
    public partial class Code : CompanyLink1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CompanyLink1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CompanyLink1Code Value { get; init; } 
        #else
        public CompanyLink1Code Value { get; set; } 
        #endif
