...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CustomerConductClassification1Choice.Code),
        nameof(CustomerConductClassification1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CustomerConductClassification1Choice.Proprietary),
        nameof(CustomerConductClassification1Choice.Proprietary)
    )]
    [IsoId("_E0HGsxdwEeKYM7Bc71nDlA")]
    [DisplayName("Customer Conduct Classification 1 Choice")]
    public abstract record CustomerConductClassification1Choice_ { }
}
