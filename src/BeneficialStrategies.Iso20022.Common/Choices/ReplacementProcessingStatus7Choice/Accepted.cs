...
namespace BeneficialStrategies.Iso20022.Choices.ReplacementProcessingStatus7Choice
{
    ...
    /// </summary>
    [IsoId("_A5TcAdokEeC60axPepSq7g_128678824")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Accepted : ReplacementProcessingStatus7Choice_
    #else
    public partial class Accepted : ReplacementProcessingStatus7Choice_
    #endif
    {
