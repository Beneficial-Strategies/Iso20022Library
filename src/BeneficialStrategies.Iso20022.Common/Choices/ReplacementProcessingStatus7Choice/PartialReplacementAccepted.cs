...
namespace BeneficialStrategies.Iso20022.Choices.ReplacementProcessingStatus7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PartialReplacementAccepted : ReplacementProcessingStatus7Choice_
    #else
    public partial class PartialReplacementAccepted : ReplacementProcessingStatus7Choice_
    #endif
    {
