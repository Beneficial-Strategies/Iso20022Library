...
namespace BeneficialStrategies.Iso20022.Choices.ReplacementProcessingStatus7Choice
{
    ...
    /// </summary>
    [IsoId("_A5TcAtokEeC60axPepSq7g_349693069")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Completed : ReplacementProcessingStatus7Choice_
    #else
    public partial class Completed : ReplacementProcessingStatus7Choice_
    #endif
    {
