...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus47Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Covered : InstructionProcessingStatus47Choice_
    #else
    public partial class Covered : InstructionProcessingStatus47Choice_
    #endif
    {
