...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(MarginRequirement1Choice.MarginRequirement),
        nameof(MarginRequirement1Choice.MarginRequirement)
    )]
    [JsonDerivedType(
        typeof(MarginRequirement1Choice.SegregatedIndependentAmountRequirement),
        nameof(MarginRequirement1Choice.SegregatedIndependentAmountRequirement)
    )]
    [IsoId("_QmevONp-Ed-ak6NoX_4Aeg_-593475226")]
    [DisplayName("Margin Requirement 1 Choice")]
    public abstract record MarginRequirement1Choice_ { }
}
