...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat23Choice
{
    ...
    #else
    public partial class Code : OptionFeaturesFormat23Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures10Code Value { get; init; } 
        #else
        public OptionFeatures10Code Value { get; set; } 
        #endif
