...
namespace BeneficialStrategies.Iso20022.Choices.Frequency21Choice
{
    ...
    #else
    public partial class Type : Frequency21Choice_
    #endif
    {
        ...
        /// </summary>
        public Type( Frequency6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Frequency6Code Value { get; init; } 
        #else
        public Frequency6Code Value { get; set; } 
        #endif
