...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodity2Choice
{
    ...
    #else
    public partial class Energy : AssetClassCommodity2Choice_
    #endif
    {
        ...
        /// </summary>
        public Energy( AssetClassSubProductEnergyType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public AssetClassSubProductEnergyType1Code Value { get; set; } 
        #endif
