...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodity2Choice
{
    ...
    #else
    public partial class Exotic : AssetClassCommodity2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Exotic instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Exotic( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
