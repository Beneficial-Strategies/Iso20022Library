...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat40Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : GrossDividendRateFormat40Choice_
    #else
    public partial class AmountAndRateStatus : GrossDividendRateFormat40Choice_
    #endif
    {
