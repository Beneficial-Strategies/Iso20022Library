...
namespace BeneficialStrategies.Iso20022.Choices.CashAccountType2Choice
{
    ...
    #else
    public partial class Code : CashAccountType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalCashAccountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalCashAccountType1Code Value { get; init; } 
        #else
        public ExternalCashAccountType1Code Value { get; set; } 
        #endif
