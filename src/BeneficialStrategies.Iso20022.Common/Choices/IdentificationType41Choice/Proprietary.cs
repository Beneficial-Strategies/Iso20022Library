...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationType41Choice
{
    ...
    /// </summary>
    [IsoId("_VizA0toqEeCWg-hsBVGrDA_-1679538881")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IdentificationType41Choice_
    #else
    public partial class Proprietary : IdentificationType41Choice_
    #endif
    {
