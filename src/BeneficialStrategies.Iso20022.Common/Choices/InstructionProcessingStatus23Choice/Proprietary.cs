...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus23Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InstructionProcessingStatus23Choice_
    #else
    public partial class Proprietary : InstructionProcessingStatus23Choice_
    #endif
    {
