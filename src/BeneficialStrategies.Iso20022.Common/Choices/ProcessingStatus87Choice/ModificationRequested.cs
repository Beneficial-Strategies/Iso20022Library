...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus87Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : ProcessingStatus87Choice_
    #else
    public partial class ModificationRequested : ProcessingStatus87Choice_
    #endif
    {
