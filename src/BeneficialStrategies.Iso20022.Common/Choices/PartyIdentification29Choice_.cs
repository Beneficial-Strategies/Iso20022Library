...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PartyIdentification29Choice.BIC),
        nameof(PartyIdentification29Choice.BIC)
    )]
    [JsonDerivedType(
        typeof(PartyIdentification29Choice.NameAndAddress),
        nameof(PartyIdentification29Choice.NameAndAddress)
    )]
    [IsoId("_QFGgcNp-Ed-ak6NoX_4Aeg_-162334661")]
    [DisplayName("Party Identification 29 Choice")]
    public abstract record PartyIdentification29Choice_ { }
}
