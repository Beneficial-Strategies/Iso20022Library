...
namespace BeneficialStrategies.Iso20022.Choices.PaymentCodeOrOther2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PaymentDueDate : PaymentCodeOrOther2Choice_
    #else
    public partial class PaymentDueDate : PaymentCodeOrOther2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PaymentDueDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PaymentDueDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
