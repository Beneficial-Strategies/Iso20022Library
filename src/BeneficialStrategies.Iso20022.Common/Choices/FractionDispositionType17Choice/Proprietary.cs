...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType17Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType17Choice_
    #else
    public partial class Proprietary : FractionDispositionType17Choice_
    #endif
    {
