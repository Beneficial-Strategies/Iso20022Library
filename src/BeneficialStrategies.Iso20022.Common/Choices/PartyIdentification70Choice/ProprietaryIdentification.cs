...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification70Choice
{
    ...
    /// </summary>
    [IsoId("_g-pD8tooEeCWg-hsBVGrDA_467846975")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification70Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification70Choice_
    #endif
    {
