...
namespace BeneficialStrategies.Iso20022.Choices.AdjustedBalanceTypeSD1Choice
{
    ...
    /// </summary>
    [IsoId("_1hE45DL3EeKU9IrkkToqcw_-1932564014")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record StockLoan : AdjustedBalanceTypeSD1Choice_
    #else
    public partial class StockLoan : AdjustedBalanceTypeSD1Choice_
    #endif
    {
