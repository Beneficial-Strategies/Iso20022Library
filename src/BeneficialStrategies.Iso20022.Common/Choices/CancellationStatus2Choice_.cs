...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CancellationStatus2Choice.ProcessingStatus),
        nameof(CancellationStatus2Choice.ProcessingStatus)
    )]
    [JsonDerivedType(
        typeof(CancellationStatus2Choice.RejectionStatus),
        nameof(CancellationStatus2Choice.RejectionStatus)
    )]
    [IsoId("_RCy3wNp-Ed-ak6NoX_4Aeg_-815488240")]
    [DisplayName("Cancellation Status 2 Choice")]
    public abstract record CancellationStatus2Choice_ { }
}
