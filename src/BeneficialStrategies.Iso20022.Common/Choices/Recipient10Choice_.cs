...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Recipient10Choice.KeyTransport),
        nameof(Recipient10Choice.KeyTransport)
    )]
    [JsonDerivedType(typeof(Recipient10Choice.KEK), nameof(Recipient10Choice.KEK))]
    [JsonDerivedType(
        typeof(Recipient10Choice.KeyIdentifier),
        nameof(Recipient10Choice.KeyIdentifier)
    )]
    [IsoId("_Wl_KAS8jEeu125Ip9zFcsQ")]
    [DisplayName("Recipient 10 Choice")]
    public abstract record Recipient10Choice_ { }
}
