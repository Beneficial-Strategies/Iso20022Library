...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(InterestRateFrequency2Choice.Term),
        nameof(InterestRateFrequency2Choice.Term)
    )]
    [JsonDerivedType(
        typeof(InterestRateFrequency2Choice.Proprietary),
        nameof(InterestRateFrequency2Choice.Proprietary)
    )]
    [IsoId("_mBwkwfOFEeaS7fYULSI4_Q")]
    [DisplayName("Interest Rate Frequency 2 Choice")]
    public abstract record InterestRateFrequency2Choice_ { }
}
