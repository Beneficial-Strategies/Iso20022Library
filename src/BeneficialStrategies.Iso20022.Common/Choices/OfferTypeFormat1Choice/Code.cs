...
namespace BeneficialStrategies.Iso20022.Choices.OfferTypeFormat1Choice
{
    ...
    #else
    public partial class Code : OfferTypeFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OfferType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OfferType1Code Value { get; init; } 
        #else
        public OfferType1Code Value { get; set; } 
        #endif
