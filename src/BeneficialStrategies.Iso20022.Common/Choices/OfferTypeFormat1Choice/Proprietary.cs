...
namespace BeneficialStrategies.Iso20022.Choices.OfferTypeFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q3nihNp-Ed-ak6NoX_4Aeg_789019732")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : OfferTypeFormat1Choice_
    #else
    public partial class Proprietary : OfferTypeFormat1Choice_
    #endif
    {
