...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Status18Choice.InferredMatchingStatus),
        nameof(Status18Choice.InferredMatchingStatus)
    )]
    [JsonDerivedType(
        typeof(Status18Choice.SettlementStatus),
        nameof(Status18Choice.SettlementStatus)
    )]
    [JsonDerivedType(
        typeof(Status18Choice.InstructionProcessingStatus),
        nameof(Status18Choice.InstructionProcessingStatus)
    )]
    [IsoId("_gi4k0TnuEeWfSKvvZlhRKg")]
    [DisplayName("Status 18 Choice")]
    public abstract record Status18Choice_ { }
}
