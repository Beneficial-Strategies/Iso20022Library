...
namespace BeneficialStrategies.Iso20022.Choices.CSDOrNCB1Choice
{
    ...
    #else
    public partial class CSDIdentification : CSDOrNCB1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a CSDIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public CSDIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
