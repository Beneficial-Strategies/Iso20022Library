...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(UnderlyingData1Choice.Initiation),
        nameof(UnderlyingData1Choice.Initiation)
    )]
    [JsonDerivedType(
        typeof(UnderlyingData1Choice.Interbank),
        nameof(UnderlyingData1Choice.Interbank)
    )]
    [JsonDerivedType(
        typeof(UnderlyingData1Choice.StatementEntry),
        nameof(UnderlyingData1Choice.StatementEntry)
    )]
    ...
    public abstract record UnderlyingData1Choice_ { }
}
