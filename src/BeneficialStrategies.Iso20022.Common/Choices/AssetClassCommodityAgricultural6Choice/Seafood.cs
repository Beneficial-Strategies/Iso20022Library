...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityAgricultural6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Seafood : AssetClassCommodityAgricultural6Choice_
    #else
    public partial class Seafood : AssetClassCommodityAgricultural6Choice_
    #endif
    {
        ...
        /// </summary>
        public Seafood( AssetClassProductType1Code reqBaseProduct )
        {
