...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason23Choice
{
    ...
    #else
    public partial class Code : RejectedReason23Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason46Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason46Code Value { get; init; } 
        #else
        public RejectionReason46Code Value { get; set; } 
        #endif
