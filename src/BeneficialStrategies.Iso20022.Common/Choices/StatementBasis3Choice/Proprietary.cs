...
namespace BeneficialStrategies.Iso20022.Choices.StatementBasis3Choice
{
    ...
    /// </summary>
    [IsoId("_QrsmZtp-Ed-ak6NoX_4Aeg_-1111153534")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : StatementBasis3Choice_
    #else
    public partial class Proprietary : StatementBasis3Choice_
    #endif
    {
