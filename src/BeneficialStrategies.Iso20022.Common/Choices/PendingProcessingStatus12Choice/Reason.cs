...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingProcessingStatus12Choice_
    #else
    public partial class Reason : PendingProcessingStatus12Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingProcessingReason11Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
