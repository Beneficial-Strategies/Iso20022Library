...
namespace BeneficialStrategies.Iso20022.Choices.RejectionStatus22Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectionStatus22Choice_
    #else
    public partial class Reason : RejectionStatus22Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectionReason28Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public RejectionReason28Choice_ Code { get; init; } 
        #else
        public RejectionReason28Choice_ Code { get; set; } 
        #endif
