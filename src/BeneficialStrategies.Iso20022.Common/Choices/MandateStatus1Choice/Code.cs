...
namespace BeneficialStrategies.Iso20022.Choices.MandateStatus1Choice
{
    ...
    #else
    public partial class Code : MandateStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalMandateStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalMandateStatus1Code Value { get; init; } 
        #else
        public ExternalMandateStatus1Code Value { get; set; } 
        #endif
