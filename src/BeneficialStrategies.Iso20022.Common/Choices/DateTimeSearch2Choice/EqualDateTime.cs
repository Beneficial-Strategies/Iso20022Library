...
namespace BeneficialStrategies.Iso20022.Choices.DateTimeSearch2Choice
{
    ...
    /// </summary>
    [IsoId("_7Gq0l33sEeibM9CPDGCw0g")]
    [DisplayName("Equal Date Time")]
    ...
    #else
    public partial class EqualDateTime : DateTimeSearch2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a EqualDateTime instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public EqualDateTime( System.DateTime reqValue )
        {
            Value = reqValue;
        }
        #endif
