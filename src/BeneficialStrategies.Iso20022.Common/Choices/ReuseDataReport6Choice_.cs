...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ReuseDataReport6Choice.Correction),
        nameof(ReuseDataReport6Choice.Correction)
    )]
    [JsonDerivedType(
        typeof(ReuseDataReport6Choice.CollateralReuseUpdate),
        nameof(ReuseDataReport6Choice.CollateralReuseUpdate)
    )]
    [IsoId("_MxqLscK8EeuMhqg3CsEu6Q")]
    [DisplayName("Reuse Data Report 6 Choice")]
    public abstract record ReuseDataReport6Choice_ { }
}
