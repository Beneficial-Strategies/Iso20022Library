...
namespace BeneficialStrategies.Iso20022.Choices.EventSequenceTypeFormat1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : EventSequenceTypeFormat1Choice_
    #else
    public partial class Proprietary : EventSequenceTypeFormat1Choice_
    #endif
    {
