...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTradeVenueCriteria1Choice
{
    ...
    #else
    public partial class AnyMIC : SecuritiesTradeVenueCriteria1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a AnyMIC instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public AnyMIC( AnyMIC1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public AnyMIC1Code Value { get; set; } 
        #endif
