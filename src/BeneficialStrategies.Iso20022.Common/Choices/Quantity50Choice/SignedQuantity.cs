...
namespace BeneficialStrategies.Iso20022.Choices.Quantity50Choice
{
    ...
    #else
    public partial class SignedQuantity : Quantity50Choice_
    #endif
    {
        ...
        /// </summary>
        public SignedQuantity( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity33Choice_ reqQuantity )
        {
