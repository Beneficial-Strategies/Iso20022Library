...
namespace BeneficialStrategies.Iso20022.Choices.BalanceType1Choice
{
    ...
    #else
    public partial class Code : BalanceType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BalanceType8Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BalanceType8Code Value { get; init; } 
        #else
        public BalanceType8Code Value { get; set; } 
        #endif
