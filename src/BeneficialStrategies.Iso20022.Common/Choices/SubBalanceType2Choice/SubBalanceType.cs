...
namespace BeneficialStrategies.Iso20022.Choices.SubBalanceType2Choice
{
    ...
    #else
    public partial class SubBalanceType : SubBalanceType2Choice_
    #endif
    {
        ...
        /// </summary>
        public SubBalanceType( SecuritiesBalanceType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public SecuritiesBalanceType3Code Value { get; set; } 
        #endif
