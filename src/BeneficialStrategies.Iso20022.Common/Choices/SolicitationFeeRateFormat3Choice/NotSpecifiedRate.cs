...
namespace BeneficialStrategies.Iso20022.Choices.SolicitationFeeRateFormat3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : SolicitationFeeRateFormat3Choice_
    #else
    public partial class NotSpecifiedRate : SolicitationFeeRateFormat3Choice_
    #endif
    {
