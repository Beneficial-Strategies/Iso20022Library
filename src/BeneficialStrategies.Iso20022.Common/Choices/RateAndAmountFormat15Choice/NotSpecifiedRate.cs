...
namespace BeneficialStrategies.Iso20022.Choices.RateAndAmountFormat15Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RateAndAmountFormat15Choice_
    #else
    public partial class NotSpecifiedRate : RateAndAmountFormat15Choice_
    #endif
    {
