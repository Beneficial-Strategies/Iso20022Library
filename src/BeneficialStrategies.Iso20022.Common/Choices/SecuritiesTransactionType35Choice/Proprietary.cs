...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType35Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType35Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType35Choice_
    #endif
    {
