...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AffirmationReason1Choice.Reason),
        nameof(AffirmationReason1Choice.Reason)
    )]
    [JsonDerivedType(
        typeof(AffirmationReason1Choice.NoSpecifiedReason),
        nameof(AffirmationReason1Choice.NoSpecifiedReason)
    )]
    [IsoId("_Azo44NokEeC60axPepSq7g_-579916981")]
    [DisplayName("Affirmation Reason 1 Choice")]
    public abstract record AffirmationReason1Choice_ { }
}
