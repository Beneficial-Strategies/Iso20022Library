...
namespace BeneficialStrategies.Iso20022.Choices.AgentRole1FormatChoice
{
    ...
    #else
    public partial class Code : AgentRole1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( AgentRole2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AgentRole2Code Value { get; init; } 
        #else
        public AgentRole2Code Value { get; set; } 
        #endif
