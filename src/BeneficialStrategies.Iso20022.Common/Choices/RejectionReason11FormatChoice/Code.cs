...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason11FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason11FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason11Code Value { get; init; } 
        #else
        public RejectionReason11Code Value { get; set; } 
        #endif
