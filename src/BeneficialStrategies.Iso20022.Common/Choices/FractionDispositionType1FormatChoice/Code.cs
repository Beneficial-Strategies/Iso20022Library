...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType1FormatChoice
{
    ...
    #else
    public partial class Code : FractionDispositionType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( FractionDispositionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FractionDispositionType1Code Value { get; init; } 
        #else
        public FractionDispositionType1Code Value { get; set; } 
        #endif
