...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType1FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RmjsJ9p-Ed-ak6NoX_4Aeg_-1753886297")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType1FormatChoice_
    #else
    public partial class Proprietary : FractionDispositionType1FormatChoice_
    #endif
    {
