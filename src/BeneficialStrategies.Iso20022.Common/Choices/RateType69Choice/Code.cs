...
namespace BeneficialStrategies.Iso20022.Choices.RateType69Choice
{
    ...
    #else
    public partial class Code : RateType69Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( NetDividendRateType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public NetDividendRateType4Code Value { get; init; } 
        #else
        public NetDividendRateType4Code Value { get; set; } 
        #endif
