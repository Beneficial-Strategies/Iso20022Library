...
namespace BeneficialStrategies.Iso20022.Choices.FXAmountType1Choice
{
    ...
    #else
    public partial class Code : FXAmountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FXAmountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FXAmountType1Code Value { get; init; } 
        #else
        public FXAmountType1Code Value { get; set; } 
        #endif
