...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus43Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Uncovered : InstructionProcessingStatus43Choice_
    #else
    public partial class Uncovered : InstructionProcessingStatus43Choice_
    #endif
    {
