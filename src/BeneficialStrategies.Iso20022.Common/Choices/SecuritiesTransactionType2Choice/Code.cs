...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType2Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType3Code Value { get; init; } 
        #else
        public SecuritiesTransactionType3Code Value { get; set; } 
        #endif
