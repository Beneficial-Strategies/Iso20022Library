...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType2Choice
{
    ...
    /// </summary>
    [IsoId("_QtevGdp-Ed-ak6NoX_4Aeg_-529584242")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType2Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType2Choice_
    #endif
    {
