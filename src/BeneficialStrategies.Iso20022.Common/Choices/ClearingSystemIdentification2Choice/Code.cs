...
namespace BeneficialStrategies.Iso20022.Choices.ClearingSystemIdentification2Choice
{
    ...
    #else
    public partial class Code : ClearingSystemIdentification2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalClearingSystemIdentification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalClearingSystemIdentification1Code Value { get; init; } 
        #else
        public ExternalClearingSystemIdentification1Code Value { get; set; } 
        #endif
