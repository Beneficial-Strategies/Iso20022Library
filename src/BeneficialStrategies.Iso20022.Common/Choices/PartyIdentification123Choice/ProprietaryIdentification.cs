...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification123Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification123Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification123Choice_
    #endif
    {
