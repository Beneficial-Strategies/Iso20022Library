...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TransactionChannelType1Choice.Code),
        nameof(TransactionChannelType1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(TransactionChannelType1Choice.Proprietary),
        nameof(TransactionChannelType1Choice.Proprietary)
    )]
    [IsoId("_JtX4MRRGEeOKWo1NF21OVw")]
    [DisplayName("Transaction Channel Type 1 Choice")]
    public abstract record TransactionChannelType1Choice_ { }
}
