...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FractionDispositionType27Choice.Code),
        nameof(FractionDispositionType27Choice.Code)
    )]
    [JsonDerivedType(
        typeof(FractionDispositionType27Choice.Proprietary),
        nameof(FractionDispositionType27Choice.Proprietary)
    )]
    [IsoId("_61TwIUGLEeWqy4niLuXETA")]
    [DisplayName("Fraction Disposition Type 27 Choice")]
    public abstract record FractionDispositionType27Choice_ { }
}
