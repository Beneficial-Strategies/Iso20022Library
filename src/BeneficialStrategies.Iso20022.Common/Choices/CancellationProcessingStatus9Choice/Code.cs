...
namespace BeneficialStrategies.Iso20022.Choices.CancellationProcessingStatus9Choice
{
    ...
    #else
    public partial class Code : CancellationProcessingStatus9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancellationProcessingStatus3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancellationProcessingStatus3Code Value { get; init; } 
        #else
        public CancellationProcessingStatus3Code Value { get; set; } 
        #endif
