...
namespace BeneficialStrategies.Iso20022.Choices.CancelledStatus5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : CancelledStatus5Choice_
    #else
    public partial class Reason : CancelledStatus5Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( CancellationReason17Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
