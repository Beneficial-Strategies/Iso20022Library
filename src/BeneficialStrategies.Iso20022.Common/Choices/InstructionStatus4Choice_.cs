...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(InstructionStatus4Choice.ProcessingStatus),
        nameof(InstructionStatus4Choice.ProcessingStatus)
    )]
    [JsonDerivedType(
        typeof(InstructionStatus4Choice.RejectionStatus),
        nameof(InstructionStatus4Choice.RejectionStatus)
    )]
    [IsoId("_RCpGxdp-Ed-ak6NoX_4Aeg_-1718693015")]
    [DisplayName("Instruction Status 4 Choice")]
    public abstract record InstructionStatus4Choice_ { }
}
