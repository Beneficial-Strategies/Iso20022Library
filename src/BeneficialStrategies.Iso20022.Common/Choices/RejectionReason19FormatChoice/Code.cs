...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason19FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason19FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason19Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason19Code Value { get; init; } 
        #else
        public RejectionReason19Code Value { get; set; } 
        #endif
