...
namespace BeneficialStrategies.Iso20022.Choices.RepairStatus12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RepairStatus12Choice_
    #else
    public partial class NoSpecifiedReason : RepairStatus12Choice_
    #endif
    {
