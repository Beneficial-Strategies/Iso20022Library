...
namespace BeneficialStrategies.Iso20022.Choices.CounterpartyTradeNature9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : CounterpartyTradeNature9Choice_
    #else
    public partial class Other : CounterpartyTradeNature9Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
