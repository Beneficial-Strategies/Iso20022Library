...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat8Choice
{
    ...
    /// </summary>
    [IsoId("_Q2Reu9p-Ed-ak6NoX_4Aeg_1518172286")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PercentagePrice : PriceFormat8Choice_
    #else
    public partial class PercentagePrice : PriceFormat8Choice_
    #endif
    {
