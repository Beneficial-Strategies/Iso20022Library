...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus2Choice
{
    ...
    /// </summary>
    [IsoId("_UYBuMtp-Ed-ak6NoX_4Aeg_-1515031008")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InstructionProcessingStatus2Choice_
    #else
    public partial class Proprietary : InstructionProcessingStatus2Choice_
    #endif
    {
