...
namespace BeneficialStrategies.Iso20022.Choices.PreferenceToIncome2Choice
{
    ...
    /// </summary>
    [IsoId("_Qu-j5dp-Ed-ak6NoX_4Aeg_1951703204")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PreferenceToIncome2Choice_
    #else
    public partial class Proprietary : PreferenceToIncome2Choice_
    #endif
    {
