...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification2Choice
{
    ...
    /// </summary>
    [IsoId("_QRLNktp-Ed-ak6NoX_4Aeg_-1721645108")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification2Choice_
    #else
    public partial class NameAndAddress : PartyIdentification2Choice_
    #endif
    {
