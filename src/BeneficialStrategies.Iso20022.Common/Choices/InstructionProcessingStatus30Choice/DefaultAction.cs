...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus30Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DefaultAction : InstructionProcessingStatus30Choice_
    #else
    public partial class DefaultAction : InstructionProcessingStatus30Choice_
    #endif
    {
