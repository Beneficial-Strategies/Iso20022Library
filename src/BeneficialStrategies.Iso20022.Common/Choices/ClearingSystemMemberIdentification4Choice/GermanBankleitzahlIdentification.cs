...
namespace BeneficialStrategies.Iso20022.Choices.ClearingSystemMemberIdentification4Choice
{
    ...
    #else
    public partial class GermanBankleitzahlIdentification : ClearingSystemMemberIdentification4Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a GermanBankleitzahlIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public GermanBankleitzahlIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
