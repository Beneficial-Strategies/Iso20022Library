...
namespace BeneficialStrategies.Iso20022.Choices.ClearingSystemMemberIdentification4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SpanishDomesticInterbankingIdentification : ClearingSystemMemberIdentification4Choice_
    #else
    public partial class SpanishDomesticInterbankingIdentification : ClearingSystemMemberIdentification4Choice_
    #endif
    {
