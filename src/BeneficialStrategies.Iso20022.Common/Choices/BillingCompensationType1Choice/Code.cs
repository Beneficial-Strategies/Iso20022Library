...
namespace BeneficialStrategies.Iso20022.Choices.BillingCompensationType1Choice
{
    ...
    #else
    public partial class Code : BillingCompensationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalBillingCompensationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalBillingCompensationType1Code Value { get; init; } 
        #else
        public ExternalBillingCompensationType1Code Value { get; set; } 
        #endif
