...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityMetal1Choice
{
    ...
    #else
    public partial class NonPrecious : AssetClassCommodityMetal1Choice_
    #endif
    {
        ...
        /// </summary>
        public NonPrecious( AssetClassProductType7Code reqBaseProduct,AssetClassSubProductType15Code reqSubProduct,AssetClassDetailedSubProductType10Code reqAdditionalSubProduct )
        {
