...
namespace BeneficialStrategies.Iso20022.Choices.OrderWaiverReason1Choice
{
    ...
    /// </summary>
    [IsoId("_SdiXd9p-Ed-ak6NoX_4Aeg_622792492")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : OrderWaiverReason1Choice_
    #else
    public partial class Proprietary : OrderWaiverReason1Choice_
    #endif
    {
