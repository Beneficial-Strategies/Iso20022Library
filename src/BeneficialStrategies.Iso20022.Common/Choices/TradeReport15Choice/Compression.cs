...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport15Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Compression : TradeReport15Choice_
    #else
    public partial class Compression : TradeReport15Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Compression instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Compression( CommonTradeDataReport49 reqCommonTradeData )
        {
