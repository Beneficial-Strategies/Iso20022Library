...
namespace BeneficialStrategies.Iso20022.Choices.References41Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionIdentification : References41Choice_
    #else
    public partial class SecuritiesSettlementTransactionIdentification : References41Choice_
    #endif
    {
