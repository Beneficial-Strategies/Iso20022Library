...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(UnableToApplyJustification1Choice.AnyInformation),
        nameof(UnableToApplyJustification1Choice.AnyInformation)
    )]
    [JsonDerivedType(
        typeof(UnableToApplyJustification1Choice.MissingOrIncorrectInformation),
        nameof(UnableToApplyJustification1Choice.MissingOrIncorrectInformation)
    )]
    [IsoId("_T-i3MNp-Ed-ak6NoX_4Aeg_-1347537926")]
    [DisplayName("Unable To Apply Justification 1 Choice")]
    public abstract record UnableToApplyJustification1Choice_ { }
}
