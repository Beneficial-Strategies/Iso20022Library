...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryType1Choice
{
    ...
    #else
    public partial class Code : BeneficiaryType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BeneficiaryType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BeneficiaryType1Code Value { get; init; } 
        #else
        public BeneficiaryType1Code Value { get; set; } 
        #endif
