...
namespace BeneficialStrategies.Iso20022.Choices.TaxCalculationBasisType1Choice
{
    ...
    #else
    public partial class Basis : TaxCalculationBasisType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Basis instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Basis( TaxationBasis2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxationBasis2Code Value { get; init; } 
        #else
        public TaxationBasis2Code Value { get; set; } 
        #endif
