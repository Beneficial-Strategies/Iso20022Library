...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType3Choice
{
    ...
    #else
    public partial class Code : FractionDispositionType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FractionDispositionType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FractionDispositionType2Code Value { get; init; } 
        #else
        public FractionDispositionType2Code Value { get; set; } 
        #endif
