...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType3Choice
{
    ...
    /// </summary>
    [IsoId("_QzJSMtp-Ed-ak6NoX_4Aeg_-913998330")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType3Choice_
    #else
    public partial class Proprietary : FractionDispositionType3Choice_
    #endif
    {
