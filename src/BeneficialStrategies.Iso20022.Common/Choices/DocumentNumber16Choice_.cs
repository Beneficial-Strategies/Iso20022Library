...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(DocumentNumber16Choice.ShortNumber),
        nameof(DocumentNumber16Choice.ShortNumber)
    )]
    [JsonDerivedType(
        typeof(DocumentNumber16Choice.LongNumber),
        nameof(DocumentNumber16Choice.LongNumber)
    )]
    [JsonDerivedType(
        typeof(DocumentNumber16Choice.ProprietaryNumber),
        nameof(DocumentNumber16Choice.ProprietaryNumber)
    )]
    [IsoId("_6GW8w5NLEeWGlc8L7oPDIg")]
    [DisplayName("Document Number 16 Choice")]
    public abstract record DocumentNumber16Choice_ { }
}
