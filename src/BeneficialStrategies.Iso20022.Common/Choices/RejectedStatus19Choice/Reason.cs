...
namespace BeneficialStrategies.Iso20022.Choices.RejectedStatus19Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : RejectedStatus19Choice_
    #else
    public partial class Reason : RejectedStatus19Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectedReason13Choice_ reqReasonCode )
        {
