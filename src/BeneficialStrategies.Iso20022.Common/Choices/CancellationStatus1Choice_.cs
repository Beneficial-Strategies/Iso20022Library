...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CancellationStatus1Choice.ProcessingStatus),
        nameof(CancellationStatus1Choice.ProcessingStatus)
    )]
    [JsonDerivedType(
        typeof(CancellationStatus1Choice.RejectionStatus),
        nameof(CancellationStatus1Choice.RejectionStatus)
    )]
    [IsoId("_RVa41dp-Ed-ak6NoX_4Aeg_-538392841")]
    [DisplayName("Cancellation Status 1 Choice")]
    public abstract record CancellationStatus1Choice_ { }
}
