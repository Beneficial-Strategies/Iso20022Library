...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionChangeTypeFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q3Unl9p-Ed-ak6NoX_4Aeg_796354141")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionChangeTypeFormat1Choice_
    #else
    public partial class Proprietary : CorporateActionChangeTypeFormat1Choice_
    #endif
    {
