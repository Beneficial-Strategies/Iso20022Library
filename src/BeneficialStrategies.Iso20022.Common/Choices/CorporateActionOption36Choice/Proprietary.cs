...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption36Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption36Choice_
    #else
    public partial class Proprietary : CorporateActionOption36Choice_
    #endif
    {
