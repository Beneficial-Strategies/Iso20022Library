...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason7Choice
{
    ...
    /// </summary>
    [IsoId("_A4s_EdokEeC60axPepSq7g_8505415")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : UnmatchedReason7Choice_
    #else
    public partial class Proprietary : UnmatchedReason7Choice_
    #endif
    {
