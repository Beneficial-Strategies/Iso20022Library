...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType28Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType28Choice_
    #else
    public partial class Proprietary : FractionDispositionType28Choice_
    #endif
    {
