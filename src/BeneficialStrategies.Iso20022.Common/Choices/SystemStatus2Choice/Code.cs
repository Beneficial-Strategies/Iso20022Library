...
namespace BeneficialStrategies.Iso20022.Choices.SystemStatus2Choice
{
    ...
    #else
    public partial class Code : SystemStatus2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SystemStatus2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SystemStatus2Code Value { get; init; } 
        #else
        public SystemStatus2Code Value { get; set; } 
        #endif
