...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionReversalReason4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionReversalReason4Choice_
    #else
    public partial class Proprietary : CorporateActionReversalReason4Choice_
    #endif
    {
