...
namespace BeneficialStrategies.Iso20022.Choices.PaymentOrigin1Choice
{
    ...
    #else
    public partial class XMLMessageName : PaymentOrigin1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a XMLMessageName instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public XMLMessageName( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
