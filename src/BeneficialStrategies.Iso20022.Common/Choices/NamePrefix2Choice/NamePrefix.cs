...
namespace BeneficialStrategies.Iso20022.Choices.NamePrefix2Choice
{
    ...
    #else
    public partial class NamePrefix : NamePrefix2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NamePrefix instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NamePrefix( NamePrefix1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public NamePrefix1Code Value { get; set; } 
        #endif
