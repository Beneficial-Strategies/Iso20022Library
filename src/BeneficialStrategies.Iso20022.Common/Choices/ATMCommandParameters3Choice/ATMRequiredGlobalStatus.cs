...
namespace BeneficialStrategies.Iso20022.Choices.ATMCommandParameters3Choice
{
    ...
    #else
    public partial class ATMRequiredGlobalStatus : ATMCommandParameters3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ATMRequiredGlobalStatus instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ATMRequiredGlobalStatus( ATMStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public ATMStatus1Code Value { get; set; } 
        #endif
