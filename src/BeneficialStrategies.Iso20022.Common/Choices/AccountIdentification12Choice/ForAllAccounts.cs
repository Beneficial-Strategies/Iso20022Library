...
namespace BeneficialStrategies.Iso20022.Choices.AccountIdentification12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ForAllAccounts : AccountIdentification12Choice_
    #else
    public partial class ForAllAccounts : AccountIdentification12Choice_
    #endif
    {
