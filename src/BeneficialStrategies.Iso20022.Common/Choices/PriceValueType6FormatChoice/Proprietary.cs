...
namespace BeneficialStrategies.Iso20022.Choices.PriceValueType6FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RnJiAtp-Ed-ak6NoX_4Aeg_124226634")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PriceValueType6FormatChoice_
    #else
    public partial class Proprietary : PriceValueType6FormatChoice_
    #endif
    {
