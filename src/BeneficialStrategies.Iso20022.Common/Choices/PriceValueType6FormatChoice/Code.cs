...
namespace BeneficialStrategies.Iso20022.Choices.PriceValueType6FormatChoice
{
    ...
    #else
    public partial class Code : PriceValueType6FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( PriceValueType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PriceValueType6Code Value { get; init; } 
        #else
        public PriceValueType6Code Value { get; set; } 
        #endif
