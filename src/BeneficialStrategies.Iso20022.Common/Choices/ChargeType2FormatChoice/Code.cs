...
namespace BeneficialStrategies.Iso20022.Choices.ChargeType2FormatChoice
{
    ...
    #else
    public partial class Code : ChargeType2FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ChargeType14Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ChargeType14Code Value { get; init; } 
        #else
        public ChargeType14Code Value { get; set; } 
        #endif
