...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CashSettlementSystem1Choice.Code),
        nameof(CashSettlementSystem1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CashSettlementSystem1Choice.Proprietary),
        nameof(CashSettlementSystem1Choice.Proprietary)
    )]
    [IsoId("_Qv3Ut9p-Ed-ak6NoX_4Aeg_-955027637")]
    [DisplayName("Cash Settlement System 1 Choice")]
    public abstract record CashSettlementSystem1Choice_ { }
}
