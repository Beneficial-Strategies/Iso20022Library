...
namespace BeneficialStrategies.Iso20022.Choices.CashAssetType1Choice
{
    ...
    #else
    public partial class Code : CashAssetType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CashAssetType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CashAssetType1Code Value { get; init; } 
        #else
        public CashAssetType1Code Value { get; set; } 
        #endif
