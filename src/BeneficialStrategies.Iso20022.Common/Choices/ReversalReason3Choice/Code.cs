...
namespace BeneficialStrategies.Iso20022.Choices.ReversalReason3Choice
{
    ...
    #else
    public partial class Code : ReversalReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TransactionReversalReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransactionReversalReason2Code Value { get; init; } 
        #else
        public TransactionReversalReason2Code Value { get; set; } 
        #endif
