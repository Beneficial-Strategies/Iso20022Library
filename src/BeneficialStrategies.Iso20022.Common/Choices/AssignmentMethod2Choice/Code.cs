...
namespace BeneficialStrategies.Iso20022.Choices.AssignmentMethod2Choice
{
    ...
    #else
    public partial class Code : AssignmentMethod2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AssignmentMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AssignmentMethod1Code Value { get; init; } 
        #else
        public AssignmentMethod1Code Value { get; set; } 
        #endif
