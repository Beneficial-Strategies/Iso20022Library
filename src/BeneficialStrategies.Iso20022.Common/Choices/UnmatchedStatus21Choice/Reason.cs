...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedStatus21Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : UnmatchedStatus21Choice_
    #else
    public partial class Reason : UnmatchedStatus21Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( UnmatchedReason27Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
