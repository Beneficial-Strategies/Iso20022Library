...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus3Choice
{
    ...
    /// </summary>
    [IsoId("_UZOBBtp-Ed-ak6NoX_4Aeg_-779516953")]
    [DisplayName("Reason")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : AcknowledgedAcceptedStatus3Choice_
    #else
    public partial class Reason : AcknowledgedAcceptedStatus3Choice_
    #endif
    {
