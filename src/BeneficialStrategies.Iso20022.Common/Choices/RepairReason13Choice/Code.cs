...
namespace BeneficialStrategies.Iso20022.Choices.RepairReason13Choice
{
    ...
    #else
    public partial class Code : RepairReason13Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepairReason5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepairReason5Code Value { get; init; } 
        #else
        public RepairReason5Code Value { get; set; } 
        #endif
