...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementDateCode7Choice.Code),
        nameof(SettlementDateCode7Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementDateCode7Choice.Proprietary),
        nameof(SettlementDateCode7Choice.Proprietary)
    )]
    [IsoId("_b0UOpzqLEeWVrPy0StzzSg")]
    [DisplayName("Settlement Date Code 7 Choice")]
    public abstract record SettlementDateCode7Choice_ { }
}
