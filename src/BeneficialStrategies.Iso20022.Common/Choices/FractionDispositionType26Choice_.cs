...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FractionDispositionType26Choice.Code),
        nameof(FractionDispositionType26Choice.Code)
    )]
    [JsonDerivedType(
        typeof(FractionDispositionType26Choice.Proprietary),
        nameof(FractionDispositionType26Choice.Proprietary)
    )]
    [IsoId("_lsfIQUEHEeWVgfuHGaKtRQ")]
    [DisplayName("Fraction Disposition Type 26 Choice")]
    public abstract record FractionDispositionType26Choice_ { }
}
