...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason38Choice
{
    ...
    #else
    public partial class Code : RejectedReason38Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason61Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason61Code Value { get; init; } 
        #else
        public RejectionReason61Code Value { get; set; } 
        #endif
