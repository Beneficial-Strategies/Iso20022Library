...
namespace BeneficialStrategies.Iso20022.Choices.AccountIdentification9Choice
{
    ...
    /// </summary>
    [IsoId("_QSXgYNp-Ed-ak6NoX_4Aeg_-664394019")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ForAllAccounts : AccountIdentification9Choice_
    #else
    public partial class ForAllAccounts : AccountIdentification9Choice_
    #endif
    {
