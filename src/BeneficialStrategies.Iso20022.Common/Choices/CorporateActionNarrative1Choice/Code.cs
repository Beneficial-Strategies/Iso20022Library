...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionNarrative1Choice
{
    ...
    #else
    public partial class Code : CorporateActionNarrative1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionNarrative1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionNarrative1Code Value { get; init; } 
        #else
        public CorporateActionNarrative1Code Value { get; set; } 
        #endif
