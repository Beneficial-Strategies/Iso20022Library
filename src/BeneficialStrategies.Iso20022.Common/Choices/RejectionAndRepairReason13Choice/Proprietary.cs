...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason13Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason13Choice_
    #endif
    {
