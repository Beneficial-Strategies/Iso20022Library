...
namespace BeneficialStrategies.Iso20022.Choices.TypeOfAmount1Choice
{
    ...
    #else
    public partial class Code : TypeOfAmount1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxWrapperAmountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxWrapperAmountType1Code Value { get; init; } 
        #else
        public TaxWrapperAmountType1Code Value { get; set; } 
        #endif
