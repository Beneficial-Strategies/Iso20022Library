...
namespace BeneficialStrategies.Iso20022.Choices.PersonIdentificationType3Choice
{
    ...
    #else
    public partial class Code : PersonIdentificationType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PersonIdentificationType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public PersonIdentificationType3Code Value { get; set; } 
        #endif
