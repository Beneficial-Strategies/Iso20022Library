...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RateFormat10Choice.NotSpecifiedRate),
        nameof(RateFormat10Choice.NotSpecifiedRate)
    )]
    [JsonDerivedType(
        typeof(RateFormat10Choice.RateTypeAndRate),
        nameof(RateFormat10Choice.RateTypeAndRate)
    )]
    [IsoId("_CR-rCieJEeOXAt_43VmZGw")]
    [DisplayName("Rate Format 10 Choice")]
    public abstract record RateFormat10Choice_ { }
}
