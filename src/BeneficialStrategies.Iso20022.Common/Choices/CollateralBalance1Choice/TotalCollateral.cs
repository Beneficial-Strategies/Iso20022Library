...
namespace BeneficialStrategies.Iso20022.Choices.CollateralBalance1Choice
{
    ...
    #else
    public partial class TotalCollateral : CollateralBalance1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a TotalCollateral instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public TotalCollateral( System.String reqCurrency,System.Decimal reqAmount )
        {
