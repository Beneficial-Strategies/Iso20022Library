...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(AmountOrPercentage2Choice.Amount),nameof(AmountOrPercentage2Choice.Amount))]
    [JsonDerivedType(typeof(AmountOrPercentage2Choice.Percentage),nameof(AmountOrPercentage2Choice.Percentage))]
