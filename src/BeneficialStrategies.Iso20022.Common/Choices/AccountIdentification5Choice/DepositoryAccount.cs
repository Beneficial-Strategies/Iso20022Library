...
namespace BeneficialStrategies.Iso20022.Choices.AccountIdentification5Choice
{
    ...
    #else
    public partial class DepositoryAccount : AccountIdentification5Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a DepositoryAccount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public DepositoryAccount( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
