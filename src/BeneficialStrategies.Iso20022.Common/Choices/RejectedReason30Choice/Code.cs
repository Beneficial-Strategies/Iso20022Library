...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason30Choice
{
    ...
    #else
    public partial class Code : RejectedReason30Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason52Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason52Code Value { get; init; } 
        #else
        public RejectionReason52Code Value { get; set; } 
        #endif
