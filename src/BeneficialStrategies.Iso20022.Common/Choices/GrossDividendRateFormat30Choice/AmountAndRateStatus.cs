...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat30Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : GrossDividendRateFormat30Choice_
    #else
    public partial class AmountAndRateStatus : GrossDividendRateFormat30Choice_
    #endif
    {
