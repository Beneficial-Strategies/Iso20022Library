...
namespace BeneficialStrategies.Iso20022.Choices.MarketType9Choice
{
    ...
    #else
    public partial class Code : MarketType9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MarketType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MarketType5Code Value { get; init; } 
        #else
        public MarketType5Code Value { get; set; } 
        #endif
