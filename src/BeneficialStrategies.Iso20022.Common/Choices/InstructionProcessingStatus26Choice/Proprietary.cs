...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus26Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InstructionProcessingStatus26Choice_
    #else
    public partial class Proprietary : InstructionProcessingStatus26Choice_
    #endif
    {
