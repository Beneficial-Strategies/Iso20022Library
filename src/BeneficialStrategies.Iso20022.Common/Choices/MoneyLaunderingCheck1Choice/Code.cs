...
namespace BeneficialStrategies.Iso20022.Choices.MoneyLaunderingCheck1Choice
{
    ...
    #else
    public partial class Code : MoneyLaunderingCheck1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MoneyLaunderingCheck1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MoneyLaunderingCheck1Code Value { get; init; } 
        #else
        public MoneyLaunderingCheck1Code Value { get; set; } 
        #endif
