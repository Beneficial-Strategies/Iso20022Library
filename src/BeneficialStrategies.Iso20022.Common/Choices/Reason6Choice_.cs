...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Reason6Choice.RepoCallAcknowledgementReason),
        nameof(Reason6Choice.RepoCallAcknowledgementReason)
    )]
    [JsonDerivedType(
        typeof(Reason6Choice.CancellationReason),
        nameof(Reason6Choice.CancellationReason)
    )]
    [JsonDerivedType(
        typeof(Reason6Choice.PendingCancellationReason),
        nameof(Reason6Choice.PendingCancellationReason)
    )]
    ...
    [JsonDerivedType(
        typeof(Reason6Choice.AcknowledgedAcceptedReason),
        nameof(Reason6Choice.AcknowledgedAcceptedReason)
    )]
    ...
    [JsonDerivedType(
        typeof(Reason6Choice.PendingProcessingReason),
        nameof(Reason6Choice.PendingProcessingReason)
    )]
    ...
    [JsonDerivedType(
        typeof(Reason6Choice.PendingModificationReason),
        nameof(Reason6Choice.PendingModificationReason)
    )]
    ...
    public abstract record Reason6Choice_ { }
}
