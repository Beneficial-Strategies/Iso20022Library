...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus45Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : InstructionProcessingStatus45Choice_
    #else
    public partial class CancellationRequested : InstructionProcessingStatus45Choice_
    #endif
    {
