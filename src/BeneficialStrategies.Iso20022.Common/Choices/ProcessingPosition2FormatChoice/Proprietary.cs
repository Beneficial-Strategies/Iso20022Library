...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingPosition2FormatChoice
{
    ...
    /// </summary>
    [IsoId("_Rnv-8tp-Ed-ak6NoX_4Aeg_-520028992")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessingPosition2FormatChoice_
    #else
    public partial class Proprietary : ProcessingPosition2FormatChoice_
    #endif
    {
