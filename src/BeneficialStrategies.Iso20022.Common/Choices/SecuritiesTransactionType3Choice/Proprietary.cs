...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType3Choice
{
    ...
    /// </summary>
    [IsoId("_QwUApNp-Ed-ak6NoX_4Aeg_-465105993")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType3Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType3Choice_
    #endif
    {
