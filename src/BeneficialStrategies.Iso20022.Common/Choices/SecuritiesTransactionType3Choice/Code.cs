...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType3Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType4Code Value { get; init; } 
        #else
        public SecuritiesTransactionType4Code Value { get; set; } 
        #endif
