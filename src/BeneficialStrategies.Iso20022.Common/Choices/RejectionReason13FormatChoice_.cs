...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RejectionReason13FormatChoice.Code),
        nameof(RejectionReason13FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(RejectionReason13FormatChoice.Proprietary),
        nameof(RejectionReason13FormatChoice.Proprietary)
    )]
    [IsoId("_RoMq4tp-Ed-ak6NoX_4Aeg_-549911598")]
    [DisplayName("Rejection Reason 13 Format Choice")]
    public abstract record RejectionReason13FormatChoice_ { }
}
