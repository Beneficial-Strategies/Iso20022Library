...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedStatus17Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : UnmatchedStatus17Choice_
    #else
    public partial class Reason : UnmatchedStatus17Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( UnmatchedReason23Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
