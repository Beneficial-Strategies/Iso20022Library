...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PrimaryOwner : AccountParties9Choice_
    #else
    public partial class PrimaryOwner : AccountParties9Choice_
    #endif
    {
        ...
        /// </summary>
        public PrimaryOwner( Party30Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
