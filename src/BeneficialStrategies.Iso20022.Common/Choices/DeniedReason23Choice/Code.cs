...
namespace BeneficialStrategies.Iso20022.Choices.DeniedReason23Choice
{
    ...
    #else
    public partial class Code : DeniedReason23Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DeniedReason7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DeniedReason7Code Value { get; init; } 
        #else
        public DeniedReason7Code Value { get; set; } 
        #endif
