...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateType1FormatChoice
{
    ...
    #else
    public partial class Code : GrossDividendRateType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( GrossDividendRateType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GrossDividendRateType1Code Value { get; init; } 
        #else
        public GrossDividendRateType1Code Value { get; set; } 
        #endif
