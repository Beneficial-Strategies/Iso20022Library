...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(DateOrDateTimePeriod2Choice.Date),
        nameof(DateOrDateTimePeriod2Choice.Date)
    )]
    [JsonDerivedType(
        typeof(DateOrDateTimePeriod2Choice.DateTime),
        nameof(DateOrDateTimePeriod2Choice.DateTime)
    )]
    [IsoId("_lq6kIbQVEeemgtANb5gbCw")]
    [DisplayName("Date Or Date Time Period 2 Choice")]
    public abstract record DateOrDateTimePeriod2Choice_ { }
}
