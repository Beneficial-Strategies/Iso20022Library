...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : InstructionProcessingStatus10Choice_
    #else
    public partial class ModificationRequested : InstructionProcessingStatus10Choice_
    #endif
    {
