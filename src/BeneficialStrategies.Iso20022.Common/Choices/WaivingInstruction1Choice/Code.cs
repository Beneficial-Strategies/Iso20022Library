...
namespace BeneficialStrategies.Iso20022.Choices.WaivingInstruction1Choice
{
    ...
    #else
    public partial class Code : WaivingInstruction1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( WaivingInstruction1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public WaivingInstruction1Code Value { get; init; } 
        #else
        public WaivingInstruction1Code Value { get; set; } 
        #endif
