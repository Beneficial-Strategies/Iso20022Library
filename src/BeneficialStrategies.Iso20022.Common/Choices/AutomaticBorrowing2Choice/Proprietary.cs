...
namespace BeneficialStrategies.Iso20022.Choices.AutomaticBorrowing2Choice
{
    ...
    /// </summary>
    [IsoId("_QtyRFtp-Ed-ak6NoX_4Aeg_-1043359247")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AutomaticBorrowing2Choice_
    #else
    public partial class Proprietary : AutomaticBorrowing2Choice_
    #endif
    {
