...
namespace BeneficialStrategies.Iso20022.Choices.SignatureType1Choice
{
    ...
    #else
    public partial class Code : SignatureType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SignatureType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SignatureType2Code Value { get; init; } 
        #else
        public SignatureType2Code Value { get; set; } 
        #endif
