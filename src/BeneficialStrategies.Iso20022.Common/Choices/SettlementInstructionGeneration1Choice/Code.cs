...
namespace BeneficialStrategies.Iso20022.Choices.SettlementInstructionGeneration1Choice
{
    ...
    #else
    public partial class Code : SettlementInstructionGeneration1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementInstructionGeneration1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementInstructionGeneration1Code Value { get; init; } 
        #else
        public SettlementInstructionGeneration1Code Value { get; set; } 
        #endif
