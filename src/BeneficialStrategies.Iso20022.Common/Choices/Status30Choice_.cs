...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Status30Choice.InferredMatchingStatus),
        nameof(Status30Choice.InferredMatchingStatus)
    )]
    [JsonDerivedType(
        typeof(Status30Choice.SettlementStatus),
        nameof(Status30Choice.SettlementStatus)
    )]
    [JsonDerivedType(
        typeof(Status30Choice.InstructionProcessingStatus),
        nameof(Status30Choice.InstructionProcessingStatus)
    )]
    [IsoId("_iE4L6ffZEeiNZp_PtLohLw")]
    [DisplayName("Status 30 Choice")]
    public abstract record Status30Choice_ { }
}
