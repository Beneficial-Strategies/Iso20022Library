...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason63Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : PendingReason63Choice_
    #else
    public partial class Code : PendingReason63Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason24Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason24Code Value { get; init; } 
        #else
        public PendingReason24Code Value { get; set; } 
        #endif
