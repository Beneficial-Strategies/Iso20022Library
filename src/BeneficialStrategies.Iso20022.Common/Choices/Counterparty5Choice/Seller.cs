...
namespace BeneficialStrategies.Iso20022.Choices.Counterparty5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Seller : Counterparty5Choice_
    #else
    public partial class Seller : Counterparty5Choice_
    #endif
    {
        ...
        /// </summary>
        public Seller( PartyIdentification45Choice_ reqIdentification )
        {
