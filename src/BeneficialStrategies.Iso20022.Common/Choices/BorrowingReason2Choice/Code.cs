...
namespace BeneficialStrategies.Iso20022.Choices.BorrowingReason2Choice
{
    ...
    #else
    public partial class Code : BorrowingReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BorrowingReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BorrowingReason1Code Value { get; init; } 
        #else
        public BorrowingReason1Code Value { get; set; } 
        #endif
