...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat21Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : GrossDividendRateFormat21Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : GrossDividendRateFormat21Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType40Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType40Choice_ RateType { get; init; } 
        #else
        public RateType40Choice_ RateType { get; set; } 
        #endif
