...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat21Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat21Choice_
    #else
    public partial class Amount : GrossDividendRateFormat21Choice_
    #endif
    {
