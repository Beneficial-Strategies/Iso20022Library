...
namespace BeneficialStrategies.Iso20022.Choices.DeniedStatus19Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : DeniedStatus19Choice_
    #else
    public partial class Reason : DeniedStatus19Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( DeniedReason24Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public DeniedReason24Choice_ Code { get; init; } 
        #else
        public DeniedReason24Choice_ Code { get; set; } 
        #endif
