...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationSource3Choice
{
    ...
    /// </summary>
    [IsoId("_QmU-MNp-Ed-ak6NoX_4Aeg_-1238582323")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : IdentificationSource3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalFinancialInstrumentIdentificationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalFinancialInstrumentIdentificationType1Code Value { get; init; } 
        #else
        public ExternalFinancialInstrumentIdentificationType1Code Value { get; set; } 
        #endif
