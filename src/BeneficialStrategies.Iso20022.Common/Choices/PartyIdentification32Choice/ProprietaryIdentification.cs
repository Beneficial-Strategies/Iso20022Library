...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification32Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification32Choice_
    #endif
    {
