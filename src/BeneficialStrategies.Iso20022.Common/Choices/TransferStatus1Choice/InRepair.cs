...
namespace BeneficialStrategies.Iso20022.Choices.TransferStatus1Choice
{
    ...
    #else
    public partial class InRepair : TransferStatus1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a InRepair instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public InRepair( System.String reqReason,GenericIdentification1 reqDataSourceScheme,NoReasonCode reqNoSpecifiedReason )
        {
            Reason = reqReason;
