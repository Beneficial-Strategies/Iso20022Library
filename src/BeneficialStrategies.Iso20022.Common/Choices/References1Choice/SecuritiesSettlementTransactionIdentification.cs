...
namespace BeneficialStrategies.Iso20022.Choices.References1Choice
{
    ...
    /// </summary>
    [IsoId("_USg8Ftp-Ed-ak6NoX_4Aeg_-968189337")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionIdentification : References1Choice_
    #else
    public partial class SecuritiesSettlementTransactionIdentification : References1Choice_
    #endif
    {
