...
namespace BeneficialStrategies.Iso20022.Choices.References1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IntraPositionMovementIdentification : References1Choice_
    #else
    public partial class IntraPositionMovementIdentification : References1Choice_
    #endif
    {
