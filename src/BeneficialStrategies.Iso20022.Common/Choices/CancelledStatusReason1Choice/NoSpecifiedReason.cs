...
namespace BeneficialStrategies.Iso20022.Choices.CancelledStatusReason1Choice
{
    ...
    /// </summary>
    [IsoId("_RiFb1tp-Ed-ak6NoX_4Aeg_-275254213")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : CancelledStatusReason1Choice_
    #else
    public partial class NoSpecifiedReason : CancelledStatusReason1Choice_
    #endif
    {
