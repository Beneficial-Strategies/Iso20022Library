...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatusReason1Choice
{
    ...
    #else
    public partial class Code : CancellationStatusReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PaymentCancellationRejection1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PaymentCancellationRejection1Code Value { get; init; } 
        #else
        public PaymentCancellationRejection1Code Value { get; set; } 
        #endif
