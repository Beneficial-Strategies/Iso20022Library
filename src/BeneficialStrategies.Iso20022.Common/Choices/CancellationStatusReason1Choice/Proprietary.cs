...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatusReason1Choice
{
    ...
    /// </summary>
    [IsoId("_TP6PkNp-Ed-ak6NoX_4Aeg_1784056985")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationStatusReason1Choice_
    #else
    public partial class Proprietary : CancellationStatusReason1Choice_
    #endif
    {
