...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityPolypropylene3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : AssetClassCommodityPolypropylene3Choice_
    #else
    public partial class Other : AssetClassCommodityPolypropylene3Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType9Code reqBaseProduct,AssetClassSubProductType49Code reqSubProduct )
        {
