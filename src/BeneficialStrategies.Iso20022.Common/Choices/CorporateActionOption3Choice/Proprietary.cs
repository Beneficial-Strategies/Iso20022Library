...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption3Choice
{
    ...
    /// </summary>
    [IsoId("_Q1O84Np-Ed-ak6NoX_4Aeg_882016136")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption3Choice_
    #else
    public partial class Proprietary : CorporateActionOption3Choice_
    #endif
    {
