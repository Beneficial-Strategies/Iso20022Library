...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason60Choice
{
    ...
    #else
    public partial class Code : PendingReason60Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason21Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason21Code Value { get; init; } 
        #else
        public PendingReason21Code Value { get; set; } 
        #endif
