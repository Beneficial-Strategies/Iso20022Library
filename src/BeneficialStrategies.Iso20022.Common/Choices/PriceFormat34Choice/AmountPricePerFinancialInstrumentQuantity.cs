...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat34Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountPricePerFinancialInstrumentQuantity : PriceFormat34Choice_
    #else
    public partial class AmountPricePerFinancialInstrumentQuantity : PriceFormat34Choice_
    #endif
    {
