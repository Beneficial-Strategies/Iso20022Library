...
namespace BeneficialStrategies.Iso20022.Choices.ModelFormIdentification1Choice
{
    ...
    #else
    public partial class Code : ModelFormIdentification1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalModelFormIdentification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalModelFormIdentification1Code Value { get; init; } 
        #else
        public ExternalModelFormIdentification1Code Value { get; set; } 
        #endif
