...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentParty1Choice
{
    ...
    #else
    public partial class Algorithm : InvestmentParty1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Algorithm instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Algorithm( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
