...
namespace BeneficialStrategies.Iso20022.Choices.RepurchaseType1Choice
{
    ...
    /// </summary>
    [IsoId("_QuFMBNp-Ed-ak6NoX_4Aeg_-557724702")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RepurchaseType1Choice_
    #else
    public partial class Proprietary : RepurchaseType1Choice_
    #endif
    {
