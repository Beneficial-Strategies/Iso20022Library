...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ReservationOrError9Choice.Reservation),
        nameof(ReservationOrError9Choice.Reservation)
    )]
    [JsonDerivedType(
        typeof(ReservationOrError9Choice.BusinessError),
        nameof(ReservationOrError9Choice.BusinessError)
    )]
    [IsoId("_RN8LwXhdEeidzqjNEfehPg")]
    [DisplayName("Reservation Or Error 9 Choice")]
    public abstract record ReservationOrError9Choice_ { }
}
