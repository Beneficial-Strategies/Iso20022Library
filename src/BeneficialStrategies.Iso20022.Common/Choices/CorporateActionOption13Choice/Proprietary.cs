...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption13Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption13Choice_
    #else
    public partial class Proprietary : CorporateActionOption13Choice_
    #endif
    {
