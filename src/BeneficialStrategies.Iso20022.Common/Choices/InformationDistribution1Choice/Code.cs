...
namespace BeneficialStrategies.Iso20022.Choices.InformationDistribution1Choice
{
    ...
    #else
    public partial class Code : InformationDistribution1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InformationDistribution2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InformationDistribution2Code Value { get; init; } 
        #else
        public InformationDistribution2Code Value { get; set; } 
        #endif
