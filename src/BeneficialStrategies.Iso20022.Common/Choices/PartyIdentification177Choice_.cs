...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PartyIdentification177Choice.AnyBIC),
        nameof(PartyIdentification177Choice.AnyBIC)
    )]
    [JsonDerivedType(
        typeof(PartyIdentification177Choice.ProprietaryIdentification),
        nameof(PartyIdentification177Choice.ProprietaryIdentification)
    )]
    [IsoId("_7X5zsdgvEeipBO1pkKK6zg")]
    [DisplayName("Party Identification 177 Choice")]
    public abstract record PartyIdentification177Choice_ { }
}
