...
namespace BeneficialStrategies.Iso20022.Choices.PriceRateOrAmountOrUnknown2Choice
{
    ...
    #else
    public partial class UnknownIndicator : PriceRateOrAmountOrUnknown2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a UnknownIndicator instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public UnknownIndicator( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
