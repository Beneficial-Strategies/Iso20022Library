...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceFormat63Choice.PercentagePrice),
        nameof(PriceFormat63Choice.PercentagePrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat63Choice.AmountPrice),
        nameof(PriceFormat63Choice.AmountPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat63Choice.NotSpecifiedPrice),
        nameof(PriceFormat63Choice.NotSpecifiedPrice)
    )]
    [IsoId("_Rt7u8Q-zEeuE0Pnt-OcNOA")]
    [DisplayName("Price Format 63 Choice")]
    public abstract record PriceFormat63Choice_ { }
}
