...
namespace BeneficialStrategies.Iso20022.Choices.InstructionType2Choice
{
    ...
    #else
    public partial class InstructionCancellationIdentification : InstructionType2Choice_
    #endif
    {
        ...
        /// </summary>
        public InstructionCancellationIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
