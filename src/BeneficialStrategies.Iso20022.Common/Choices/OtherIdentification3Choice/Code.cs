...
namespace BeneficialStrategies.Iso20022.Choices.OtherIdentification3Choice
{
    ...
    #else
    public partial class Code : OtherIdentification3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PartyIdentificationType7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PartyIdentificationType7Code Value { get; init; } 
        #else
        public PartyIdentificationType7Code Value { get; set; } 
        #endif
