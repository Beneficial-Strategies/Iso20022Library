...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason14Choice
{
    ...
    #else
    public partial class Code : CancellationReason14Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancellationReason5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancellationReason5Code Value { get; init; } 
        #else
        public CancellationReason5Code Value { get; set; } 
        #endif
