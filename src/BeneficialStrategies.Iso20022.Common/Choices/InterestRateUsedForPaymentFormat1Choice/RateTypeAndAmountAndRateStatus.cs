...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_UOySpNp-Ed-ak6NoX_4Aeg_-1208255108")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : InterestRateUsedForPaymentFormat1Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : InterestRateUsedForPaymentFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType6Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
