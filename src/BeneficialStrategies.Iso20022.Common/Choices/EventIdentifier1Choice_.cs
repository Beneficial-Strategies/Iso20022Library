...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(EventIdentifier1Choice.EventIdentifier),
        nameof(EventIdentifier1Choice.EventIdentifier)
    )]
    [JsonDerivedType(
        typeof(EventIdentifier1Choice.PostTradeRiskReductionIdentifier),
        nameof(EventIdentifier1Choice.PostTradeRiskReductionIdentifier)
    )]
    [IsoId("_nfQOQPbfEeyInphUKJZxtQ")]
    [DisplayName("Event Identifier 1 Choice")]
    public abstract record EventIdentifier1Choice_ { }
}
