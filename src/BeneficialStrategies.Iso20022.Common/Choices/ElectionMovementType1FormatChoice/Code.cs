...
namespace BeneficialStrategies.Iso20022.Choices.ElectionMovementType1FormatChoice
{
    ...
    #else
    public partial class Code : ElectionMovementType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ElectionMovementType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ElectionMovementType1Code Value { get; init; } 
        #else
        public ElectionMovementType1Code Value { get; set; } 
        #endif
