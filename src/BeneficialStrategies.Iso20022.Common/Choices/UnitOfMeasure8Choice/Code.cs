...
namespace BeneficialStrategies.Iso20022.Choices.UnitOfMeasure8Choice
{
    ...
    #else
    public partial class Code : UnitOfMeasure8Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalUnitOfMeasure1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalUnitOfMeasure1Code Value { get; init; } 
        #else
        public ExternalUnitOfMeasure1Code Value { get; set; } 
        #endif
