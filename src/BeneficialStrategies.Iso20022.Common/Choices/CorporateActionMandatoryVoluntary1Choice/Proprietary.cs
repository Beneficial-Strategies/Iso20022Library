...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionMandatoryVoluntary1Choice
{
    ...
    /// </summary>
    [IsoId("_Q4g6Ydp-Ed-ak6NoX_4Aeg_832092077")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionMandatoryVoluntary1Choice_
    #else
    public partial class Proprietary : CorporateActionMandatoryVoluntary1Choice_
    #endif
    {
