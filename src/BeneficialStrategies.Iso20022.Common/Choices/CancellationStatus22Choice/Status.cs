...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus22Choice
{
    ...
    #else
    public partial class Status : CancellationStatus22Choice_
    #endif
    {
        ...
        /// </summary>
        public Status( OrderCancellationStatus2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public OrderCancellationStatus2Code Value { get; set; } 
        #endif
