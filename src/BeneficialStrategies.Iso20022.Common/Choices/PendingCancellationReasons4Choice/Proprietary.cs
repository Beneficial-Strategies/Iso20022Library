...
namespace BeneficialStrategies.Iso20022.Choices.PendingCancellationReasons4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingCancellationReasons4Choice_
    #else
    public partial class Proprietary : PendingCancellationReasons4Choice_
    #endif
    {
