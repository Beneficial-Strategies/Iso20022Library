...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(DetailedTransactionStatistics6Choice.DataSetAction),
        nameof(DetailedTransactionStatistics6Choice.DataSetAction)
    )]
    [JsonDerivedType(
        typeof(DetailedTransactionStatistics6Choice.DetailedStatistics),
        nameof(DetailedTransactionStatistics6Choice.DetailedStatistics)
    )]
    [IsoId("_x-ovZ1yGEe24CqbZJK5XxA")]
    [DisplayName("Detailed Transaction Statistics 6 Choice")]
    public abstract record DetailedTransactionStatistics6Choice_ { }
}
