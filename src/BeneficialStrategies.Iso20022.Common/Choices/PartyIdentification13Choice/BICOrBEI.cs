...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification13Choice
{
    ...
    /// </summary>
    [IsoId("_QQIEsdp-Ed-ak6NoX_4Aeg_-1176553373")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BICOrBEI : PartyIdentification13Choice_
    #else
    public partial class BICOrBEI : PartyIdentification13Choice_
    #endif
    {
