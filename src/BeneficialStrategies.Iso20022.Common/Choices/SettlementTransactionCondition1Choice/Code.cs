...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition1Choice
{
    ...
    #else
    public partial class Code : SettlementTransactionCondition1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementTransactionCondition2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementTransactionCondition2Code Value { get; init; } 
        #else
        public SettlementTransactionCondition2Code Value { get; set; } 
        #endif
