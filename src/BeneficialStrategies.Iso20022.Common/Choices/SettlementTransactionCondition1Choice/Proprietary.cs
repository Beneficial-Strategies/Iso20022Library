...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition1Choice
{
    ...
    /// </summary>
    [IsoId("_QwK2t9p-Ed-ak6NoX_4Aeg_554068390")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementTransactionCondition1Choice_
    #else
    public partial class Proprietary : SettlementTransactionCondition1Choice_
    #endif
    {
