...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UVfXmNp-Ed-ak6NoX_4Aeg_-1298289034")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PendingCancellation : ProcessingStatus1Choice_
    #else
    public partial class PendingCancellation : ProcessingStatus1Choice_
    #endif
    {
