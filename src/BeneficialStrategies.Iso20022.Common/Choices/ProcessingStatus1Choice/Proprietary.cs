...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UVpIkNp-Ed-ak6NoX_4Aeg_1370539418")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessingStatus1Choice_
    #else
    public partial class Proprietary : ProcessingStatus1Choice_
    #endif
    {
