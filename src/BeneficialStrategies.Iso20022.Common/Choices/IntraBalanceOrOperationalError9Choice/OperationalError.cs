...
namespace BeneficialStrategies.Iso20022.Choices.IntraBalanceOrOperationalError9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : IntraBalanceOrOperationalError9Choice_
    #else
    public partial class OperationalError : IntraBalanceOrOperationalError9Choice_
    #endif
    {
