...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStageFormat14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStageFormat14Choice_
    #else
    public partial class Proprietary : CorporateActionEventStageFormat14Choice_
    #endif
    {
