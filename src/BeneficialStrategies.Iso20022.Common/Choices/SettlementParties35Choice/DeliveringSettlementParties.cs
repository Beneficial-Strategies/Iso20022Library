...
namespace BeneficialStrategies.Iso20022.Choices.SettlementParties35Choice
{
    ...
    #else
    public partial class DeliveringSettlementParties : SettlementParties35Choice_
    #endif
    {
        ...
        /// </summary>
        public DeliveringSettlementParties( PartyIdentification239Choice_ reqDepository,PartyIdentificationAndAccount200 reqParty1 )
        {
