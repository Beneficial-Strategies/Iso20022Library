...
namespace BeneficialStrategies.Iso20022.Choices.BalanceFormat16Choice
{
    ...
    #else
    public partial class PartWayPeriodUnits : BalanceFormat16Choice_
    #endif
    {
        ...
        /// </summary>
        public PartWayPeriodUnits( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity36Choice_ reqQuantity )
        {
