...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification176Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification176Choice_
    #else
    public partial class NameAndAddress : PartyIdentification176Choice_
    #endif
    {
