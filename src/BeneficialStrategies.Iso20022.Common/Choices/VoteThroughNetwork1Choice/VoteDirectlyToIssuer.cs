...
namespace BeneficialStrategies.Iso20022.Choices.VoteThroughNetwork1Choice
{
    ...
    #else
    public partial class VoteDirectlyToIssuer : VoteThroughNetwork1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a VoteDirectlyToIssuer instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public VoteDirectlyToIssuer( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="VoteDrctlyToIssr")]
        #endif
