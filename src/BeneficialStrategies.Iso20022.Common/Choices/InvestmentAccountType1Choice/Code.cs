...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentAccountType1Choice
{
    ...
    #else
    public partial class Code : InvestmentAccountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FundCashAccount2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FundCashAccount2Code Value { get; init; } 
        #else
        public FundCashAccount2Code Value { get; set; } 
        #endif
