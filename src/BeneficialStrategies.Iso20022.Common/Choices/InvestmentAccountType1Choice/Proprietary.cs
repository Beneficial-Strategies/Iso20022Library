...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentAccountType1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InvestmentAccountType1Choice_
    #else
    public partial class Proprietary : InvestmentAccountType1Choice_
    #endif
    {
