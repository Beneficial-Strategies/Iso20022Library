...
namespace BeneficialStrategies.Iso20022.Choices.CashBalanceType3Choice
{
    ...
    #else
    public partial class Code : CashBalanceType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalBalanceType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalBalanceType1Code Value { get; init; } 
        #else
        public ExternalBalanceType1Code Value { get; set; } 
        #endif
