...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat2Choice
{
    ...
    /// </summary>
    [IsoId("_UNAJ8Np-Ed-ak6NoX_4Aeg_495676664")]
    [DisplayName("Rate")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rate : InterestRateUsedForPaymentFormat2Choice_
    #else
    public partial class Rate : InterestRateUsedForPaymentFormat2Choice_
    #endif
    {
