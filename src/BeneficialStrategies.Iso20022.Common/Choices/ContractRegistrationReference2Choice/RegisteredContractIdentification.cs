...
namespace BeneficialStrategies.Iso20022.Choices.ContractRegistrationReference2Choice
{
    ...
    #else
    public partial class RegisteredContractIdentification : ContractRegistrationReference2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RegisteredContractIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RegisteredContractIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
