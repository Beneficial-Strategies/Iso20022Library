...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat3Choice
{
    ...
    /// </summary>
    [IsoId("_Q10yxdp-Ed-ak6NoX_4Aeg_861159229")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AdditionalBusinessProcessFormat3Choice_
    #else
    public partial class Proprietary : AdditionalBusinessProcessFormat3Choice_
    #endif
    {
