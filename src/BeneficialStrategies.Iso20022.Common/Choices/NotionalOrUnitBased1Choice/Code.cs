...
namespace BeneficialStrategies.Iso20022.Choices.NotionalOrUnitBased1Choice
{
    ...
    #else
    public partial class Code : NotionalOrUnitBased1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( NotionalOrUnitBased1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public NotionalOrUnitBased1Code Value { get; init; } 
        #else
        public NotionalOrUnitBased1Code Value { get; set; } 
        #endif
