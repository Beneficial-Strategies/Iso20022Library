...
namespace BeneficialStrategies.Iso20022.Choices.PartyType1Choice
{
    ...
    /// Type of party.
    /// </summary>
    [IsoId("_92zi0nltEeG7BsjMvd1mEw_1857043507")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : PartyType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalTypeOfParty1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalTypeOfParty1Code Value { get; init; } 
        #else
        public ExternalTypeOfParty1Code Value { get; set; } 
        #endif
