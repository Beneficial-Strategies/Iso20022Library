...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType34Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType34Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType34Choice_
    #endif
    {
