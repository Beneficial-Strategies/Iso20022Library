...
namespace BeneficialStrategies.Iso20022.Choices.CardPaymentDataSetTransaction8Choice
{
    ...
    #else
    public partial class AuthorisationResponse : CardPaymentDataSetTransaction8Choice_
    #endif
    {
        ...
        /// </summary>
        public AuthorisationResponse( System.String reqTransactionSequenceCounter,CardPaymentEnvironment74 reqEnvironment,CardPaymentTransaction93 reqTransaction,CardPaymentTransaction94 reqTransactionResponse )
        {
