...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType12Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType12Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType11Code Value { get; init; } 
        #else
        public CorporateActionEventType11Code Value { get; set; } 
        #endif
