...
namespace BeneficialStrategies.Iso20022.Choices.CommissionType3Choice
{
    ...
    #else
    public partial class Code : CommissionType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CommissionType7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CommissionType7Code Value { get; init; } 
        #else
        public CommissionType7Code Value { get; set; } 
        #endif
