...
namespace BeneficialStrategies.Iso20022.Choices.AccountUsageType2Choice
{
    ...
    #else
    public partial class Code : AccountUsageType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AccountUsageType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AccountUsageType2Code Value { get; init; } 
        #else
        public AccountUsageType2Code Value { get; set; } 
        #endif
