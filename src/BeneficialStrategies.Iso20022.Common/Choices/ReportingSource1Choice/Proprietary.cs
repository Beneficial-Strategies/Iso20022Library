...
namespace BeneficialStrategies.Iso20022.Choices.ReportingSource1Choice
{
    ...
    /// </summary>
    [IsoId("_RqIkk9p-Ed-ak6NoX_4Aeg_-1706426860")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ReportingSource1Choice_
    #else
    public partial class Proprietary : ReportingSource1Choice_
    #endif
    {
