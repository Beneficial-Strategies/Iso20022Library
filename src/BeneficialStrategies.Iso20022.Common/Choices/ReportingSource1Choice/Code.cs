...
namespace BeneficialStrategies.Iso20022.Choices.ReportingSource1Choice
{
    ...
    #else
    public partial class Code : ReportingSource1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalReportingSource1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalReportingSource1Code Value { get; init; } 
        #else
        public ExternalReportingSource1Code Value { get; set; } 
        #endif
