...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification95Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification95Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification95Choice_
    #endif
    {
