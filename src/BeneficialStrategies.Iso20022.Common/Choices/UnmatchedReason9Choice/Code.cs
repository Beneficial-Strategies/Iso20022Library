...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason9Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason5Code Value { get; init; } 
        #else
        public UnmatchedReason5Code Value { get; set; } 
        #endif
