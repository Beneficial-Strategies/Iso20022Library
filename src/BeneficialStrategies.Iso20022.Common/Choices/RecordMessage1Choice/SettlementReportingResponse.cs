...
namespace BeneficialStrategies.Iso20022.Choices.RecordMessage1Choice
{
    ...
    #else
    public partial class SettlementReportingResponse : RecordMessage1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a SettlementReportingResponse instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public SettlementReportingResponse( System.Byte[] reqValue )
        {
            Value = reqValue;
        }
        #endif
