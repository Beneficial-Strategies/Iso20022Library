...
namespace BeneficialStrategies.Iso20022.Choices.RecordMessage1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RetrievalInitiation : RecordMessage1Choice_
    #else
    public partial class RetrievalInitiation : RecordMessage1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RetrievalInitiation instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RetrievalInitiation( System.Byte[] reqValue )
        {
            Value = reqValue;
        }
        #endif
