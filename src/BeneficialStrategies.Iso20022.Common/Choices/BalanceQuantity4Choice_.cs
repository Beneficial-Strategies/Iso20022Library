...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BalanceQuantity4Choice.Quantity),
        nameof(BalanceQuantity4Choice.Quantity)
    )]
    [JsonDerivedType(
        typeof(BalanceQuantity4Choice.Proprietary),
        nameof(BalanceQuantity4Choice.Proprietary)
    )]
    [IsoId("_QYeIatp-Ed-ak6NoX_4Aeg_-2105698154")]
    [DisplayName("Balance Quantity 4 Choice")]
    public abstract record BalanceQuantity4Choice_ { }
}
