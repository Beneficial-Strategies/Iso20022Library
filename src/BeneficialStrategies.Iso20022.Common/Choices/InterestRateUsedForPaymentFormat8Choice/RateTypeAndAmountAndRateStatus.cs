...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat8Choice
{
    ...
    #else
    public partial class RateTypeAndAmountAndRateStatus : InterestRateUsedForPaymentFormat8Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType33Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType33Choice_ RateType { get; init; } 
        #else
        public RateType33Choice_ RateType { get; set; } 
        #endif
