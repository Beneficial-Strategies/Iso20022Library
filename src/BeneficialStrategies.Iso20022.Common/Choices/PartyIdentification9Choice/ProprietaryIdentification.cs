...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification9Choice
{
    ...
    /// </summary>
    [IsoId("_QRUXiNp-Ed-ak6NoX_4Aeg_967985043")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification9Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification9Choice_
    #endif
    {
