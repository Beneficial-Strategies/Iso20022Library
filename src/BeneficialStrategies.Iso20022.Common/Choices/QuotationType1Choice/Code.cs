...
namespace BeneficialStrategies.Iso20022.Choices.QuotationType1Choice
{
    ...
    #else
    public partial class Code : QuotationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( QuotationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public QuotationType1Code Value { get; init; } 
        #else
        public QuotationType1Code Value { get; set; } 
        #endif
