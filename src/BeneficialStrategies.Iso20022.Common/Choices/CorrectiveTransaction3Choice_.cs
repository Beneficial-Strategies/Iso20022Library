...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorrectiveTransaction3Choice.Initiation),
        nameof(CorrectiveTransaction3Choice.Initiation)
    )]
    [JsonDerivedType(
        typeof(CorrectiveTransaction3Choice.Interbank),
        nameof(CorrectiveTransaction3Choice.Interbank)
    )]
    [IsoId("_88-Vca6UEeexrtTFgmVD3Q")]
    [DisplayName("Corrective Transaction 3 Choice")]
    public abstract record CorrectiveTransaction3Choice_ { }
}
