...
namespace BeneficialStrategies.Iso20022.Choices.MeetingTypeClassification2Choice
{
    ...
    #else
    public partial class Code : MeetingTypeClassification2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MeetingTypeClassification2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public MeetingTypeClassification2Code Value { get; set; } 
        #endif
