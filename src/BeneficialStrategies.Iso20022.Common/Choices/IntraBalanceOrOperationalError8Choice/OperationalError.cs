...
namespace BeneficialStrategies.Iso20022.Choices.IntraBalanceOrOperationalError8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : IntraBalanceOrOperationalError8Choice_
    #else
    public partial class OperationalError : IntraBalanceOrOperationalError8Choice_
    #endif
    {
