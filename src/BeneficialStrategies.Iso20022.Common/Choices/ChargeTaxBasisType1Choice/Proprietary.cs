...
namespace BeneficialStrategies.Iso20022.Choices.ChargeTaxBasisType1Choice
{
    ...
    /// </summary>
    [IsoId("_AdIdZNokEeC60axPepSq7g_-1388856080")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ChargeTaxBasisType1Choice_
    #else
    public partial class Proprietary : ChargeTaxBasisType1Choice_
    #endif
    {
