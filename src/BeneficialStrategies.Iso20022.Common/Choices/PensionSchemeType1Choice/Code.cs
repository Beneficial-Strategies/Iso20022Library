...
namespace BeneficialStrategies.Iso20022.Choices.PensionSchemeType1Choice
{
    ...
    #else
    public partial class Code : PensionSchemeType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PensionSchemeType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PensionSchemeType1Code Value { get; init; } 
        #else
        public PensionSchemeType1Code Value { get; set; } 
        #endif
