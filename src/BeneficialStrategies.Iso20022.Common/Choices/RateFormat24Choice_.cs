...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RateFormat24Choice.NotSpecifiedRate),nameof(RateFormat24Choice.NotSpecifiedRate))]
    ...
    public abstract partial record RateFormat24Choice_
    {
    }
}
