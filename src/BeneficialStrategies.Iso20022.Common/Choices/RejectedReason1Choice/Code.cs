...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason1Choice
{
    ...
    #else
    public partial class Code : RejectedReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason17Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason17Code Value { get; init; } 
        #else
        public RejectionReason17Code Value { get; set; } 
        #endif
