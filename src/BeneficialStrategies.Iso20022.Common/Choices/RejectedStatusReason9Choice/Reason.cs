...
namespace BeneficialStrategies.Iso20022.Choices.RejectedStatusReason9Choice
{
    ...
    #else
    public partial class Reason : RejectedStatusReason9Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( RejectedStatusReason9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public RejectedStatusReason9Code Value { get; set; } 
        #endif
