...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventProcessingType2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventProcessingType2Choice_
    #else
    public partial class Proprietary : CorporateActionEventProcessingType2Choice_
    #endif
    {
