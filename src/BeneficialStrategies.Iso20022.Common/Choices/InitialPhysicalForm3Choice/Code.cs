...
namespace BeneficialStrategies.Iso20022.Choices.InitialPhysicalForm3Choice
{
    ...
    #else
    public partial class Code : InitialPhysicalForm3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InitialPhysicalForm2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InitialPhysicalForm2Code Value { get; init; } 
        #else
        public InitialPhysicalForm2Code Value { get; set; } 
        #endif
