...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat9Choice
{
    ...
    /// </summary>
    [IsoId("_Q2Restp-Ed-ak6NoX_4Aeg_597547856")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountPricePerFinancialInstrumentQuantity : PriceFormat9Choice_
    #else
    public partial class AmountPricePerFinancialInstrumentQuantity : PriceFormat9Choice_
    #endif
    {
