...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedPrice : PriceFormat9Choice_
    #else
    public partial class NotSpecifiedPrice : PriceFormat9Choice_
    #endif
    {
        ...
        /// </summary>
        public NotSpecifiedPrice( PriceValueType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PriceValueType4Code Value { get; init; } 
        #else
        public PriceValueType4Code Value { get; set; } 
        #endif
