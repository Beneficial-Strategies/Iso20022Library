...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(IssuerJurisdiction1Choice.CountryCode),
        nameof(IssuerJurisdiction1Choice.CountryCode)
    )]
    [JsonDerivedType(
        typeof(IssuerJurisdiction1Choice.Other),
        nameof(IssuerJurisdiction1Choice.Other)
    )]
    [IsoId("_qFVoIIfXEeu9_PKSQNOmdg")]
    [DisplayName("Issuer Jurisdiction 1 Choice")]
    public abstract record IssuerJurisdiction1Choice_ { }
}
