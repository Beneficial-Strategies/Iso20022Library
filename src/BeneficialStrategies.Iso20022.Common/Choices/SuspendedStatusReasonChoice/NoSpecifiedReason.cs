...
namespace BeneficialStrategies.Iso20022.Choices.SuspendedStatusReasonChoice
{
    ...
    /// </summary>
    [IsoId("_RfQKQdp-Ed-ak6NoX_4Aeg_1235905146")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : SuspendedStatusReasonChoice_
    #else
    public partial class NoSpecifiedReason : SuspendedStatusReasonChoice_
    #endif
    {
