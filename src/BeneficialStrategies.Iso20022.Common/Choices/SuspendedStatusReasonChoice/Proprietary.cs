...
namespace BeneficialStrategies.Iso20022.Choices.SuspendedStatusReasonChoice
{
    ...
    /// </summary>
    [IsoId("_RfQKQNp-Ed-ak6NoX_4Aeg_1243294211")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SuspendedStatusReasonChoice_
    #else
    public partial class Proprietary : SuspendedStatusReasonChoice_
    #endif
    {
