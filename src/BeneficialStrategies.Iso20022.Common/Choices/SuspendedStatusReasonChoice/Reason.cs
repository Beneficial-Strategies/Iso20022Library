...
namespace BeneficialStrategies.Iso20022.Choices.SuspendedStatusReasonChoice
{
    ...
    #else
    public partial class Reason : SuspendedStatusReasonChoice_
    #endif
    {
        ...
        /// </summary>
        public Reason( SuspendedStatusReason3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SuspendedStatusReason3Code Value { get; init; } 
        #else
        public SuspendedStatusReason3Code Value { get; set; } 
        #endif
