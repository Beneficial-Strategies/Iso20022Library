...
namespace BeneficialStrategies.Iso20022.Choices.BasisPriceType1Choice
{
    ...
    #else
    public partial class Code : BasisPriceType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BasisPriceType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BasisPriceType1Code Value { get; init; } 
        #else
        public BasisPriceType1Code Value { get; set; } 
        #endif
