...
namespace BeneficialStrategies.Iso20022.Choices.InstructionCancellationRequestStatus9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Accepted : InstructionCancellationRequestStatus9Choice_
    #else
    public partial class Accepted : InstructionCancellationRequestStatus9Choice_
    #endif
    {
