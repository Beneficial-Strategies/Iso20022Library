...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat26Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat26Choice_
    #else
    public partial class Amount : GrossDividendRateFormat26Choice_
    #endif
    {
