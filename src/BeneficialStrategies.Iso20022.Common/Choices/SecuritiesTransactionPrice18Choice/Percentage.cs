...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionPrice18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Percentage : SecuritiesTransactionPrice18Choice_
    #else
    public partial class Percentage : SecuritiesTransactionPrice18Choice_
    #endif
    {
