...
namespace BeneficialStrategies.Iso20022.Choices.TradeQueryExecutionFrequency1Choice
{
    ...
    #else
    public partial class Weekly : TradeQueryExecutionFrequency1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Weekly instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Weekly( WeekDay2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public WeekDay2Code Value { get; init; } 
        #else
        public WeekDay2Code Value { get; set; } 
        #endif
