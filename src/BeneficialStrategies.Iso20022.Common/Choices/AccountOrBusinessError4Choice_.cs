...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountOrBusinessError4Choice.Account),
        nameof(AccountOrBusinessError4Choice.Account)
    )]
    [JsonDerivedType(
        typeof(AccountOrBusinessError4Choice.BusinessError),
        nameof(AccountOrBusinessError4Choice.BusinessError)
    )]
    [IsoId("_MtNQV249EeiU9cctagi5ow")]
    [DisplayName("Account Or Business Error 4 Choice")]
    public abstract record AccountOrBusinessError4Choice_ { }
}
