...
namespace BeneficialStrategies.Iso20022.Choices.RetrievalDeliveryMethod1Choice
{
    ...
    #else
    public partial class ActualDeliveryMethod : RetrievalDeliveryMethod1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ActualDeliveryMethod instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ActualDeliveryMethod( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
