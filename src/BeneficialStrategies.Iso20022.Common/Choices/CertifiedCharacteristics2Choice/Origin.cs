...
namespace BeneficialStrategies.Iso20022.Choices.CertifiedCharacteristics2Choice
{
    ...
    #else
    public partial class Origin : CertifiedCharacteristics2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Origin instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Origin( string reqValue )
        {
            Value = reqValue;
        }
        #endif
