...
namespace BeneficialStrategies.Iso20022.Choices.ExposureType1Choice
{
    ...
    #else
    public partial class Code : ExposureType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExposureType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExposureType1Code Value { get; init; } 
        #else
        public ExposureType1Code Value { get; set; } 
        #endif
