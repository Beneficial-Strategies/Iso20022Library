...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType14Choice_
    #else
    public partial class Proprietary : CorporateActionEventType14Choice_
    #endif
    {
