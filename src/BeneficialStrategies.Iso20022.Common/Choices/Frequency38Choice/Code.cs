...
namespace BeneficialStrategies.Iso20022.Choices.Frequency38Choice
{
    ...
    #else
    public partial class Code : Frequency38Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( EventFrequency12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public EventFrequency12Code Value { get; init; } 
        #else
        public EventFrequency12Code Value { get; set; } 
        #endif
