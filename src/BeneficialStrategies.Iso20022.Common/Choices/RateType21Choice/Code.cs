...
namespace BeneficialStrategies.Iso20022.Choices.RateType21Choice
{
    ...
    #else
    public partial class Code : RateType21Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( NetDividendRateType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public NetDividendRateType2Code Value { get; init; } 
        #else
        public NetDividendRateType2Code Value { get; set; } 
        #endif
