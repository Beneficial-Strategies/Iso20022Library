...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : OptionFeaturesFormat12Choice_
    #else
    public partial class Code : OptionFeaturesFormat12Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures5Code Value { get; init; } 
        #else
        public OptionFeatures5Code Value { get; set; } 
        #endif
