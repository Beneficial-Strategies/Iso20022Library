...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : OptionFeaturesFormat12Choice_
    #else
    public partial class Proprietary : OptionFeaturesFormat12Choice_
    #endif
    {
