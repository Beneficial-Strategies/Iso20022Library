...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason44Choice
{
    ...
    #else
    public partial class Code : RejectedReason44Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason65Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason65Code Value { get; init; } 
        #else
        public RejectionReason65Code Value { get; set; } 
        #endif
