...
namespace BeneficialStrategies.Iso20022.Choices.OptionNumber1Choice
{
    ...
    #else
    public partial class Code : OptionNumber1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionNumber1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionNumber1Code Value { get; init; } 
        #else
        public OptionNumber1Code Value { get; set; } 
        #endif
