...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesBalanceType3Choice
{
    ...
    /// </summary>
    [IsoId("_QtL0Idp-Ed-ak6NoX_4Aeg_434076106")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesBalanceType3Choice_
    #else
    public partial class Proprietary : SecuritiesBalanceType3Choice_
    #endif
    {
