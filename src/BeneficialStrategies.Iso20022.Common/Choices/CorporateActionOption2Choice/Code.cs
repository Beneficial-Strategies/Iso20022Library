...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption2Choice
{
    ...
    #else
    public partial class Code : CorporateActionOption2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOption2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOption2Code Value { get; init; } 
        #else
        public CorporateActionOption2Code Value { get; set; } 
        #endif
