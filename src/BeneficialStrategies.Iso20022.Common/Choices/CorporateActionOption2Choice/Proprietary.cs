...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption2Choice
{
    ...
    /// </summary>
    [IsoId("_Q0yQ89p-Ed-ak6NoX_4Aeg_1615049847")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption2Choice_
    #else
    public partial class Proprietary : CorporateActionOption2Choice_
    #endif
    {
