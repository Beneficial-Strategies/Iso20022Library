...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SecuritiesLendingType2Choice.Code),
        nameof(SecuritiesLendingType2Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SecuritiesLendingType2Choice.Proprietary),
        nameof(SecuritiesLendingType2Choice.Proprietary)
    )]
    [IsoId("_KZ4B0ZEkEeakHoV5BVecAQ")]
    [DisplayName("Securities Lending Type 2 Choice")]
    public abstract record SecuritiesLendingType2Choice_ { }
}
