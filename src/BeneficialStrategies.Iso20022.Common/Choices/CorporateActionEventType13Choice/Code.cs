...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType13Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType13Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType12Code Value { get; init; } 
        #else
        public CorporateActionEventType12Code Value { get; set; } 
        #endif
