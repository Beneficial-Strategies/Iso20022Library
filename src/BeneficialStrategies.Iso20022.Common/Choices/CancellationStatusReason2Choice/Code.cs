...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatusReason2Choice
{
    ...
    #else
    public partial class Code : CancellationStatusReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PaymentCancellationRejection2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PaymentCancellationRejection2Code Value { get; init; } 
        #else
        public PaymentCancellationRejection2Code Value { get; set; } 
        #endif
