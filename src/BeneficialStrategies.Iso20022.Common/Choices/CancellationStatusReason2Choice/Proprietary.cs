...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatusReason2Choice
{
    ...
    /// </summary>
    [IsoId("_t4cl8VkyEeGeoaLUQk__nA_238389866")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationStatusReason2Choice_
    #else
    public partial class Proprietary : CancellationStatusReason2Choice_
    #endif
    {
