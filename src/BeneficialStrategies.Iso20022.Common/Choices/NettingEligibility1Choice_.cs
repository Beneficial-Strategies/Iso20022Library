...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(NettingEligibility1Choice.Indicator),
        nameof(NettingEligibility1Choice.Indicator)
    )]
    [JsonDerivedType(
        typeof(NettingEligibility1Choice.Proprietary),
        nameof(NettingEligibility1Choice.Proprietary)
    )]
    [IsoId("_QvkZwdp-Ed-ak6NoX_4Aeg_-841042953")]
    [DisplayName("Netting Eligibility 1 Choice")]
    public abstract record NettingEligibility1Choice_ { }
}
