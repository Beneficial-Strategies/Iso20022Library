...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ProductCharacteristics1Choice.StructuredProductCharacteristics),
        nameof(ProductCharacteristics1Choice.StructuredProductCharacteristics)
    )]
    [JsonDerivedType(
        typeof(ProductCharacteristics1Choice.OtherProductCharacteristics),
        nameof(ProductCharacteristics1Choice.OtherProductCharacteristics)
    )]
    [IsoId("_RbrR09p-Ed-ak6NoX_4Aeg_-1771903850")]
    [DisplayName("Product Characteristics 1 Choice")]
    public abstract record ProductCharacteristics1Choice_ { }
}
