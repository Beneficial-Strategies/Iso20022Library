...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason54Choice
{
    ...
    #else
    public partial class Code : PendingReason54Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason19Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason19Code Value { get; init; } 
        #else
        public PendingReason19Code Value { get; set; } 
        #endif
