...
namespace BeneficialStrategies.Iso20022.Choices.OptionRight2Choice
{
    ...
    #else
    public partial class Code : OptionRight2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionRight1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionRight1Code Value { get; init; } 
        #else
        public OptionRight1Code Value { get; set; } 
        #endif
