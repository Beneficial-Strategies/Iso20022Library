...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason21Choice
{
    ...
    #else
    public partial class Code : UnmatchedReason21Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( UnmatchedReason11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public UnmatchedReason11Code Value { get; init; } 
        #else
        public UnmatchedReason11Code Value { get; set; } 
        #endif
