...
namespace BeneficialStrategies.Iso20022.Choices.SecuredCollateral2Choice
{
    ...
    #else
    public partial class SingleCollateral : SecuredCollateral2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a SingleCollateral instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public SingleCollateral( System.String reqISIN )
        {
            ISIN = reqISIN;
        }
        #endif
