...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType1FormatChoice
{
    ...
    #else
    public partial class Code : BeneficiaryCertificationType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( BeneficiaryCertificationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public BeneficiaryCertificationType1Code Value { get; set; } 
        #endif
