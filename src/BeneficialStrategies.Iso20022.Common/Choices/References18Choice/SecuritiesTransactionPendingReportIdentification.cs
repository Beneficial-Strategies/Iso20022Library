...
namespace BeneficialStrategies.Iso20022.Choices.References18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesTransactionPendingReportIdentification : References18Choice_
    #else
    public partial class SecuritiesTransactionPendingReportIdentification : References18Choice_
    #endif
    {
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="SctiesTxPdgRptId")]
        #endif
