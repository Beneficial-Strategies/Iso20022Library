...
namespace BeneficialStrategies.Iso20022.Choices.References18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionGenerationNotificationIdentification : References18Choice_
    #else
    public partial class SecuritiesSettlementTransactionGenerationNotificationIdentification : References18Choice_
    #endif
    {
