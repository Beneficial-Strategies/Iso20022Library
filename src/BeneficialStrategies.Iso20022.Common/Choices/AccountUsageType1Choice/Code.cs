...
namespace BeneficialStrategies.Iso20022.Choices.AccountUsageType1Choice
{
    ...
    #else
    public partial class Code : AccountUsageType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AccountUsageType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AccountUsageType1Code Value { get; init; } 
        #else
        public AccountUsageType1Code Value { get; set; } 
        #endif
