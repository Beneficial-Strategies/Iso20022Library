...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityAgricultural5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Dairy : AssetClassCommodityAgricultural5Choice_
    #else
    public partial class Dairy : AssetClassCommodityAgricultural5Choice_
    #endif
    {
