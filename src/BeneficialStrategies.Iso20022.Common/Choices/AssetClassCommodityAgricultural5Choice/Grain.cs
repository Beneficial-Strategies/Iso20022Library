...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityAgricultural5Choice
{
    ...
    #else
    public partial class Grain : AssetClassCommodityAgricultural5Choice_
    #endif
    {
        ...
        /// </summary>
        public Grain( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType5Code reqSubProduct,AssetClassDetailedSubProductType30Code reqAdditionalSubProduct )
        {
