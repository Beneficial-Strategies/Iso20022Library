...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityAgricultural5Choice
{
    ...
    #else
    public partial class Potato : AssetClassCommodityAgricultural5Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Potato instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Potato( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType45Code reqSubProduct )
        {
