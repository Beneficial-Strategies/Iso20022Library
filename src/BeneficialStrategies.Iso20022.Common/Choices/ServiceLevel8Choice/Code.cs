...
namespace BeneficialStrategies.Iso20022.Choices.ServiceLevel8Choice
{
    ...
    #else
    public partial class Code : ServiceLevel8Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalServiceLevel1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalServiceLevel1Code Value { get; init; } 
        #else
        public ExternalServiceLevel1Code Value { get; set; } 
        #endif
