...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification125Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification125Choice_
    #else
    public partial class NameAndAddress : PartyIdentification125Choice_
    #endif
    {
