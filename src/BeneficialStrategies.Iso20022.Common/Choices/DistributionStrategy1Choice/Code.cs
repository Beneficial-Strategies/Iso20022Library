...
namespace BeneficialStrategies.Iso20022.Choices.DistributionStrategy1Choice
{
    ...
    #else
    public partial class Code : DistributionStrategy1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestorType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestorType3Code Value { get; init; } 
        #else
        public InvestorType3Code Value { get; set; } 
        #endif
