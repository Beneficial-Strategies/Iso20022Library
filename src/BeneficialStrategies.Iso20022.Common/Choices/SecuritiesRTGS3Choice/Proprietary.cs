...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesRTGS3Choice
{
    ...
    /// </summary>
    [IsoId("_AZabA9okEeC60axPepSq7g_2011526282")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesRTGS3Choice_
    #else
    public partial class Proprietary : SecuritiesRTGS3Choice_
    #endif
    {
