...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus3Choice
{
    ...
    /// </summary>
    [IsoId("_UV8Dhtp-Ed-ak6NoX_4Aeg_952313343")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : ProcessingStatus3Choice_
    #else
    public partial class CancellationRequested : ProcessingStatus3Choice_
    #endif
    {
