...
namespace BeneficialStrategies.Iso20022.Choices.CardPaymentDataSetTransaction6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AuthorisationResponse : CardPaymentDataSetTransaction6Choice_
    #else
    public partial class AuthorisationResponse : CardPaymentDataSetTransaction6Choice_
    #endif
    {
        ...
        /// </summary>
        public AuthorisationResponse( System.String reqTransactionSequenceCounter,CardPaymentEnvironment69 reqEnvironment,CardPaymentTransaction78 reqTransaction,CardPaymentTransaction84 reqTransactionResponse )
        {
