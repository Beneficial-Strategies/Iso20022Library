...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityFertilizer4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : AssetClassCommodityFertilizer4Choice_
    #else
    public partial class Other : AssetClassCommodityFertilizer4Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType5Code reqBaseProduct )
        {
