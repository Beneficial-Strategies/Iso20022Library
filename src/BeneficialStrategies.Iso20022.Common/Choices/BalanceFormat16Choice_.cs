...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BalanceFormat16Choice.EligibleBalance),
        nameof(BalanceFormat16Choice.EligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat16Choice.NotEligibleBalance),
        nameof(BalanceFormat16Choice.NotEligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat16Choice.FullPeriodUnits),
        nameof(BalanceFormat16Choice.FullPeriodUnits)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat16Choice.PartWayPeriodUnits),
        nameof(BalanceFormat16Choice.PartWayPeriodUnits)
    )]
    [IsoId("_plN2Izi7Eeydid5dcNPKvg")]
    [DisplayName("Balance Format 16 Choice")]
    public abstract record BalanceFormat16Choice_ { }
}
