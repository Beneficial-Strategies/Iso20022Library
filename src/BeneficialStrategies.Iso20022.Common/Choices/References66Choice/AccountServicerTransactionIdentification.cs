...
namespace BeneficialStrategies.Iso20022.Choices.References66Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AccountServicerTransactionIdentification : References66Choice_
    #else
    public partial class AccountServicerTransactionIdentification : References66Choice_
    #endif
    {
