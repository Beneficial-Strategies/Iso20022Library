...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PledgeeFormat3Choice.TypeAndIdentification),
        nameof(PledgeeFormat3Choice.TypeAndIdentification)
    )]
    [JsonDerivedType(
        typeof(PledgeeFormat3Choice.Identification),
        nameof(PledgeeFormat3Choice.Identification)
    )]
    [JsonDerivedType(
        typeof(PledgeeFormat3Choice.Proprietary),
        nameof(PledgeeFormat3Choice.Proprietary)
    )]
    [IsoId("_8tov4TnZEeWV5sr121Fc8A")]
    [DisplayName("Pledgee Format 3 Choice")]
    public abstract record PledgeeFormat3Choice_ { }
}
