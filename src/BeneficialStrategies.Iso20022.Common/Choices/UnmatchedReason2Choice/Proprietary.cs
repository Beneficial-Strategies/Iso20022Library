...
namespace BeneficialStrategies.Iso20022.Choices.UnmatchedReason2Choice
{
    ...
    /// </summary>
    [IsoId("_UXSHVdp-Ed-ak6NoX_4Aeg_-1156614690")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : UnmatchedReason2Choice_
    #else
    public partial class Proprietary : UnmatchedReason2Choice_
    #endif
    {
