...
namespace BeneficialStrategies.Iso20022.Choices.References44Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesFinancingTransactionIdentification : References44Choice_
    #else
    public partial class SecuritiesFinancingTransactionIdentification : References44Choice_
    #endif
    {
