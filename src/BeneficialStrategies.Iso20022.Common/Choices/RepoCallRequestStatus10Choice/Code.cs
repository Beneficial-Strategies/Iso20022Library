...
namespace BeneficialStrategies.Iso20022.Choices.RepoCallRequestStatus10Choice
{
    ...
    #else
    public partial class Code : RepoCallRequestStatus10Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RepoCallRequestStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RepoCallRequestStatus1Code Value { get; init; } 
        #else
        public RepoCallRequestStatus1Code Value { get; set; } 
        #endif
