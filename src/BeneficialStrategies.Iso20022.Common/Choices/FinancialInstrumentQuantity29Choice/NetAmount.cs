...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity29Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NetAmount : FinancialInstrumentQuantity29Choice_
    #else
    public partial class NetAmount : FinancialInstrumentQuantity29Choice_
    #endif
    {
