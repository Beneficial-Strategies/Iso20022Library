...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason3Choice
{
    ...
    /// </summary>
    [IsoId("_UYBuNNp-Ed-ak6NoX_4Aeg_-707074174")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : PendingReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason3Code Value { get; init; } 
        #else
        public PendingReason3Code Value { get; set; } 
        #endif
