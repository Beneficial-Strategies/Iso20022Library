...
namespace BeneficialStrategies.Iso20022.Choices.BeneficialOwnership3Choice
{
    ...
    /// </summary>
    [IsoId("_AbDZw9okEeC60axPepSq7g_819003007")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficialOwnership3Choice_
    #else
    public partial class Proprietary : BeneficialOwnership3Choice_
    #endif
    {
