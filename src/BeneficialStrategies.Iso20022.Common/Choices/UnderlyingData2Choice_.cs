...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(UnderlyingData2Choice.Initiation),nameof(UnderlyingData2Choice.Initiation))]
    [JsonDerivedType(typeof(UnderlyingData2Choice.Interbank),nameof(UnderlyingData2Choice.Interbank))]
    [JsonDerivedType(typeof(UnderlyingData2Choice.Other),nameof(UnderlyingData2Choice.Other))]
    [JsonDerivedType(typeof(UnderlyingData2Choice.StatementEntry),nameof(UnderlyingData2Choice.StatementEntry))]
    [IsoId("_Dl5lwRZ7Ee6d6Ip1Ob2kaQ")]
    [DisplayName("Underlying Data2Choice")]
    public abstract partial record UnderlyingData2Choice_
    {
    }
}
