...
namespace BeneficialStrategies.Iso20022.Choices.BalanceFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PartWayPeriodUnits : BalanceFormat10Choice_
    #else
    public partial class PartWayPeriodUnits : BalanceFormat10Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PartWayPeriodUnits instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PartWayPeriodUnits( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
        {
