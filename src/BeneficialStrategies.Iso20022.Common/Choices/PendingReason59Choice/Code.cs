...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason59Choice
{
    ...
    #else
    public partial class Code : PendingReason59Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason22Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason22Code Value { get; init; } 
        #else
        public PendingReason22Code Value { get; set; } 
        #endif
