...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TradeReport22Choice.Modification),
        nameof(TradeReport22Choice.Modification)
    )]
    [JsonDerivedType(typeof(TradeReport22Choice.Error), nameof(TradeReport22Choice.Error))]
    [JsonDerivedType(
        typeof(TradeReport22Choice.EarlyTermination),
        nameof(TradeReport22Choice.EarlyTermination)
    )]
    [JsonDerivedType(
        typeof(TradeReport22Choice.PositionComponent),
        nameof(TradeReport22Choice.PositionComponent)
    )]
    [JsonDerivedType(
        typeof(TradeReport22Choice.CollateralUpdate),
        nameof(TradeReport22Choice.CollateralUpdate)
    )]
    [JsonDerivedType(
        typeof(TradeReport22Choice.Correction),
        nameof(TradeReport22Choice.Correction)
    )]
    [JsonDerivedType(
        typeof(TradeReport22Choice.ValuationUpdate),
        nameof(TradeReport22Choice.ValuationUpdate)
    )]
    [IsoId("_ztk1Ncg3EeuGrNSsxk3B0A")]
    [DisplayName("Trade Report 22 Choice")]
    public abstract record TradeReport22Choice_ { }
}
