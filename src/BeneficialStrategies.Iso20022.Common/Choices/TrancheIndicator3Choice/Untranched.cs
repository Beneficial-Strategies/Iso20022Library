...
namespace BeneficialStrategies.Iso20022.Choices.TrancheIndicator3Choice
{
    ...
    #else
    public partial class Untranched : TrancheIndicator3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Untranched instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Untranched( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
