...
namespace BeneficialStrategies.Iso20022.Choices.TaxCreditRateFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : TaxCreditRateFormat10Choice_
    #else
    public partial class NotSpecifiedRate : TaxCreditRateFormat10Choice_
    #endif
    {
