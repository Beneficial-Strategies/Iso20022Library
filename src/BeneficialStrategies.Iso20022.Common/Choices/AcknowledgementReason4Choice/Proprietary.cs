...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason4Choice
{
    ...
    /// </summary>
    [IsoId("_UZOBANp-Ed-ak6NoX_4Aeg_2065884601")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason4Choice_
    #else
    public partial class Proprietary : AcknowledgementReason4Choice_
    #endif
    {
