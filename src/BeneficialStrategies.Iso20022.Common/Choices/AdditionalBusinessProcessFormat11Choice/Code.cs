...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat11Choice
{
    ...
    #else
    public partial class Code : AdditionalBusinessProcessFormat11Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AdditionalBusinessProcess7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AdditionalBusinessProcess7Code Value { get; init; } 
        #else
        public AdditionalBusinessProcess7Code Value { get; set; } 
        #endif
