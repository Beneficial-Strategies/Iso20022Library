...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus20Choice
{
    ...
    #else
    public partial class Forwarded : PendingStatus20Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Forwarded instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Forwarded( NoReasonCode reqNoSpecifiedReason )
        {
