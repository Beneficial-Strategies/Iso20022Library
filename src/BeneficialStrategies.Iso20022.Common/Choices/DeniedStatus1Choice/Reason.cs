...
namespace BeneficialStrategies.Iso20022.Choices.DeniedStatus1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : DeniedStatus1Choice_
    #else
    public partial class Reason : DeniedStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( DeniedReason3Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        public DeniedReason3Choice_ Code { get; init; } 
        #else
        public DeniedReason3Choice_ Code { get; set; } 
        #endif
