...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingReason18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingProcessingReason18Choice_
    #else
    public partial class Proprietary : PendingProcessingReason18Choice_
    #endif
    {
