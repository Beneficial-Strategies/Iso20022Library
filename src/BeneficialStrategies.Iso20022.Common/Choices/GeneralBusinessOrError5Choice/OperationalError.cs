...
namespace BeneficialStrategies.Iso20022.Choices.GeneralBusinessOrError5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : GeneralBusinessOrError5Choice_
    #else
    public partial class OperationalError : GeneralBusinessOrError5Choice_
    #endif
    {
        ...
        /// </summary>
        public OperationalError( ErrorHandling2Choice_ reqError )
        {
            Error = reqError;
        }
        #endif
