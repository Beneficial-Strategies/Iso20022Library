...
namespace BeneficialStrategies.Iso20022.Choices.Reference3Choice
{
    ...
    #else
    public partial class TripartyAgentServiceProviderCollateralTransactionIdentification : Reference3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a TripartyAgentServiceProviderCollateralTransactionIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public TripartyAgentServiceProviderCollateralTransactionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
