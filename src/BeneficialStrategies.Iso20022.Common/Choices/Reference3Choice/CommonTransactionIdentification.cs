...
namespace BeneficialStrategies.Iso20022.Choices.Reference3Choice
{
    ...
    #else
    public partial class CommonTransactionIdentification : Reference3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a CommonTransactionIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public CommonTransactionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
