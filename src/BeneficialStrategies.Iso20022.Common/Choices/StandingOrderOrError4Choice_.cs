...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(StandingOrderOrError4Choice.StandingOrder),
        nameof(StandingOrderOrError4Choice.StandingOrder)
    )]
    [JsonDerivedType(
        typeof(StandingOrderOrError4Choice.BusinessError),
        nameof(StandingOrderOrError4Choice.BusinessError)
    )]
    [IsoId("_kIiN9RbvEeOy-PlRuFSUzQ")]
    [DisplayName("Standing Order Or Error 4 Choice")]
    public abstract record StandingOrderOrError4Choice_ { }
}
