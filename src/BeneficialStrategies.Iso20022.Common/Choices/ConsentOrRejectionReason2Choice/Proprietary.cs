...
namespace BeneficialStrategies.Iso20022.Choices.ConsentOrRejectionReason2Choice
{
    ...
    /// </summary>
    [IsoId("_0fzakQlIEeGATtfOBToyew_-406067479")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ConsentOrRejectionReason2Choice_
    #else
    public partial class Proprietary : ConsentOrRejectionReason2Choice_
    #endif
    {
