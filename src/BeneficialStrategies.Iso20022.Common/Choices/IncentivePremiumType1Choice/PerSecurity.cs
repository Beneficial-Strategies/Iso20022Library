...
namespace BeneficialStrategies.Iso20022.Choices.IncentivePremiumType1Choice
{
    ...
    #else
    public partial class PerSecurity : IncentivePremiumType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a PerSecurity instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public PerSecurity( System.UInt64 reqValue )
        {
            Value = reqValue;
        }
        #endif
