...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification71Choice
{
    ...
    /// </summary>
    [IsoId("_jLJCY-5NEeCisYr99QEiWA_-1075902987")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification71Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification71Choice_
    #endif
    {
