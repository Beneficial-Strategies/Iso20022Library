...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityFertilizer1Choice
{
    ...
    #else
    public partial class DiammoniumPhosphate : AssetClassCommodityFertilizer1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a DiammoniumPhosphate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public DiammoniumPhosphate( AssetClassProductType5Code reqBaseProduct,AssetClassSubProductType40Code reqSubProduct )
        {
