...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityFertilizer1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Urea : AssetClassCommodityFertilizer1Choice_
    #else
    public partial class Urea : AssetClassCommodityFertilizer1Choice_
    #endif
    {
        ...
        /// </summary>
        public Urea( AssetClassProductType5Code reqBaseProduct,AssetClassSubProductType43Code reqSubProduct )
        {
