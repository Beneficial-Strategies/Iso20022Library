...
namespace BeneficialStrategies.Iso20022.Choices.SolicitationFeeRateFormat5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : SolicitationFeeRateFormat5Choice_
    #else
    public partial class Amount : SolicitationFeeRateFormat5Choice_
    #endif
    {
