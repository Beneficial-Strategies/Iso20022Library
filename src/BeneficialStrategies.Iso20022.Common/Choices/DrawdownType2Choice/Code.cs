...
namespace BeneficialStrategies.Iso20022.Choices.DrawdownType2Choice
{
    ...
    #else
    public partial class Code : DrawdownType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DrawdownType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DrawdownType2Code Value { get; init; } 
        #else
        public DrawdownType2Code Value { get; set; } 
        #endif
