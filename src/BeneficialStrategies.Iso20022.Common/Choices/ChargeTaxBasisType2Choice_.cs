...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ChargeTaxBasisType2Choice.Code),
        nameof(ChargeTaxBasisType2Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ChargeTaxBasisType2Choice.Proprietary),
        nameof(ChargeTaxBasisType2Choice.Proprietary)
    )]
    [IsoId("_VKcMAZBhEeakHoV5BVecAQ")]
    [DisplayName("Charge Tax Basis Type 2 Choice")]
    public abstract record ChargeTaxBasisType2Choice_ { }
}
