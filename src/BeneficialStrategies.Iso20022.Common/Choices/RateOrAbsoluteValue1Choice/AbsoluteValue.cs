...
namespace BeneficialStrategies.Iso20022.Choices.RateOrAbsoluteValue1Choice
{
    ...
    #else
    public partial class AbsoluteValue : RateOrAbsoluteValue1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a AbsoluteValue instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public AbsoluteValue( System.UInt64 reqValue )
        {
            Value = reqValue;
        }
        #endif
