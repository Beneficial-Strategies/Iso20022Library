...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStage1Choice
{
    ...
    /// </summary>
    [IsoId("_Qsl-Qtp-Ed-ak6NoX_4Aeg_526490421")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStage1Choice_
    #else
    public partial class Proprietary : CorporateActionEventStage1Choice_
    #endif
    {
