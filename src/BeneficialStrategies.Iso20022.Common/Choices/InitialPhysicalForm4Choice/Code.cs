...
namespace BeneficialStrategies.Iso20022.Choices.InitialPhysicalForm4Choice
{
    ...
    #else
    public partial class Code : InitialPhysicalForm4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InitialPhysicalForm1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InitialPhysicalForm1Code Value { get; init; } 
        #else
        public InitialPhysicalForm1Code Value { get; set; } 
        #endif
