...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OtherIdentification1Choice.Code),
        nameof(OtherIdentification1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(OtherIdentification1Choice.Proprietary),
        nameof(OtherIdentification1Choice.Proprietary)
    )]
    [IsoId("_smxawBc0EeK5g-3oYI0_9Q")]
    [DisplayName("Other Identification 1 Choice")]
    public abstract record OtherIdentification1Choice_ { }
}
