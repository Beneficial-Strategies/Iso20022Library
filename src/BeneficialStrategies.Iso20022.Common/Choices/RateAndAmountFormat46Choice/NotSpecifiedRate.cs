...
namespace BeneficialStrategies.Iso20022.Choices.RateAndAmountFormat46Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RateAndAmountFormat46Choice_
    #else
    public partial class NotSpecifiedRate : RateAndAmountFormat46Choice_
    #endif
    {
