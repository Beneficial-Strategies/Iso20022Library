...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PaymentSchedule1Choice.DateRange),
        nameof(PaymentSchedule1Choice.DateRange)
    )]
    [JsonDerivedType(
        typeof(PaymentSchedule1Choice.SubSchedule),
        nameof(PaymentSchedule1Choice.SubSchedule)
    )]
    [IsoId("_BVaygdOAEeSQ_-lmj1tzfw")]
    [DisplayName("Payment Schedule 1 Choice")]
    public abstract record PaymentSchedule1Choice_ { }
}
