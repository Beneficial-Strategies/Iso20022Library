...
namespace BeneficialStrategies.Iso20022.Choices.CollateralFlag10Choice
{
    ...
    #else
    public partial class Uncollateralised : CollateralFlag10Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Uncollateralised instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Uncollateralised( NoReasonCode reqValue )
        {
            Value = reqValue;
        }
        #endif
