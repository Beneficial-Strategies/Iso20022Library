...
namespace BeneficialStrategies.Iso20022.Choices.DisputeResolutionType1Choice
{
    ...
    #else
    public partial class Code : DisputeResolutionType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DisputeResolutionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DisputeResolutionType1Code Value { get; init; } 
        #else
        public DisputeResolutionType1Code Value { get; set; } 
        #endif
