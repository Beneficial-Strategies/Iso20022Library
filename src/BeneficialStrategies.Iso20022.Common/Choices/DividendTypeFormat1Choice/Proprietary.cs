...
namespace BeneficialStrategies.Iso20022.Choices.DividendTypeFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q36ddNp-Ed-ak6NoX_4Aeg_-1076227874")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : DividendTypeFormat1Choice_
    #else
    public partial class Proprietary : DividendTypeFormat1Choice_
    #endif
    {
