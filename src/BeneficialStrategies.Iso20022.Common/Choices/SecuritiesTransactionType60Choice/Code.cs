...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType60Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType60Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType28Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType28Code Value { get; init; } 
        #else
        public SecuritiesTransactionType28Code Value { get; set; } 
        #endif
