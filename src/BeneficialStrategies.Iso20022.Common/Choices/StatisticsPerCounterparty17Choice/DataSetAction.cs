...
namespace BeneficialStrategies.Iso20022.Choices.StatisticsPerCounterparty17Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DataSetAction : StatisticsPerCounterparty17Choice_
    #else
    public partial class DataSetAction : StatisticsPerCounterparty17Choice_
    #endif
    {
