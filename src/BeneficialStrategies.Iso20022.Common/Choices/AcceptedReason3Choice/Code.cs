...
namespace BeneficialStrategies.Iso20022.Choices.AcceptedReason3Choice
{
    ...
    #else
    public partial class Code : AcceptedReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AcknowledgementReason7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AcknowledgementReason7Code Value { get; init; } 
        #else
        public AcknowledgementReason7Code Value { get; set; } 
        #endif
