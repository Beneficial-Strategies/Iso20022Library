...
namespace BeneficialStrategies.Iso20022.Choices.InterestComputationMethodFormat6Choice
{
    ...
    #else
    public partial class Code : InterestComputationMethodFormat6Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InterestComputationMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InterestComputationMethod1Code Value { get; init; } 
        #else
        public InterestComputationMethod1Code Value { get; set; } 
        #endif
