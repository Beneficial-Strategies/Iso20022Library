...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RejectedReason32Choice.Proprietary),nameof(RejectedReason32Choice.Proprietary))]
    #endif
    ...
    #else
    public abstract partial class RejectedReason32Choice_
    #endif
    {
    }
}
