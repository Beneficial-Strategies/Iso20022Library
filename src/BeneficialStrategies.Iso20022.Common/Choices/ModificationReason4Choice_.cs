...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ModificationReason4Choice.Code),
        nameof(ModificationReason4Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ModificationReason4Choice.Proprietary),
        nameof(ModificationReason4Choice.Proprietary)
    )]
    [IsoId("_DdDr2zq3EeWyoP0PbocV1Q")]
    [DisplayName("Modification Reason 4 Choice")]
    public abstract record ModificationReason4Choice_ { }
}
