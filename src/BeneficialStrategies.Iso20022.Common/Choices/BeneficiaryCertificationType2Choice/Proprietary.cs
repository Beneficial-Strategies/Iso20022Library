...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType2Choice
{
    ...
    /// </summary>
    [IsoId("_QzTDN9p-Ed-ak6NoX_4Aeg_-1271231621")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficiaryCertificationType2Choice_
    #else
    public partial class Proprietary : BeneficiaryCertificationType2Choice_
    #endif
    {
