...
namespace BeneficialStrategies.Iso20022.Choices.AllocationSatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UX39Mdp-Ed-ak6NoX_4Aeg_-2141684721")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AllocationSatus1Choice_
    #else
    public partial class Proprietary : AllocationSatus1Choice_
    #endif
    {
