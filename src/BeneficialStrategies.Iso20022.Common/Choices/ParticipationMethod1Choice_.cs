...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ParticipationMethod1Choice.Code),
        nameof(ParticipationMethod1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ParticipationMethod1Choice.Proprietary),
        nameof(ParticipationMethod1Choice.Proprietary)
    )]
    [IsoId("_X1CUoK31EemG7MmivSuE5g")]
    [DisplayName("Participation Method 1 Choice")]
    public abstract record ParticipationMethod1Choice_ { }
}
