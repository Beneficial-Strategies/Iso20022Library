...
namespace BeneficialStrategies.Iso20022.Choices.AwaitingCancellationReason2Choice
{
    ...
    #else
    public partial class Code : AwaitingCancellationReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AwaitingCancellationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AwaitingCancellationReason1Code Value { get; init; } 
        #else
        public AwaitingCancellationReason1Code Value { get; set; } 
        #endif
