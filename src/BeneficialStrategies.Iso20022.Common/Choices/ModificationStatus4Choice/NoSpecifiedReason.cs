...
namespace BeneficialStrategies.Iso20022.Choices.ModificationStatus4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : ModificationStatus4Choice_
    #else
    public partial class NoSpecifiedReason : ModificationStatus4Choice_
    #endif
    {
