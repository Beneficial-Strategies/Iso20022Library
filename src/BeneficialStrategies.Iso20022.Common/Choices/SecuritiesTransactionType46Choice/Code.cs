...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType46Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType46Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType22Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType22Code Value { get; init; } 
        #else
        public SecuritiesTransactionType22Code Value { get; set; } 
        #endif
