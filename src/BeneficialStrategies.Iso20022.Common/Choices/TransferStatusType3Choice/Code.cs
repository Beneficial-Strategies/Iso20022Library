...
namespace BeneficialStrategies.Iso20022.Choices.TransferStatusType3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : TransferStatusType3Choice_
    #else
    public partial class Code : TransferStatusType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TransferStatusType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransferStatusType2Code Value { get; init; } 
        #else
        public TransferStatusType2Code Value { get; set; } 
        #endif
