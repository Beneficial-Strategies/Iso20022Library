...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDateCode1Choice
{
    ...
    #else
    public partial class Code : SettlementDateCode1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementDate4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementDate4Code Value { get; init; } 
        #else
        public SettlementDate4Code Value { get; set; } 
        #endif
