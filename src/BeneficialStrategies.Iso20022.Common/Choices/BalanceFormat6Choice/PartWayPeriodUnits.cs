...
namespace BeneficialStrategies.Iso20022.Choices.BalanceFormat6Choice
{
    ...
    #else
    public partial class PartWayPeriodUnits : BalanceFormat6Choice_
    #endif
    {
        ...
        /// </summary>
        public PartWayPeriodUnits( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity1Choice_ reqQuantity )
        {
