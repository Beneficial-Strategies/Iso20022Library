...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionChangeType1FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RmHAMNp-Ed-ak6NoX_4Aeg_1068945798")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionChangeType1FormatChoice_
    #else
    public partial class Proprietary : CorporateActionChangeType1FormatChoice_
    #endif
    {
