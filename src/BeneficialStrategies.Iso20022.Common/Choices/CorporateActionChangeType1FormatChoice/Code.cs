...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionChangeType1FormatChoice
{
    ...
    /// </summary>
    [IsoId("_Rl9PN9p-Ed-ak6NoX_4Aeg_1068945859")]
    [DisplayName("Code")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : CorporateActionChangeType1FormatChoice_
    #else
    public partial class Code : CorporateActionChangeType1FormatChoice_
    #endif
    {
