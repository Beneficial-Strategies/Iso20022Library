...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AcknowledgementReason9Choice.Code),
        nameof(AcknowledgementReason9Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AcknowledgementReason9Choice.Proprietary),
        nameof(AcknowledgementReason9Choice.Proprietary)
    )]
    [IsoId("_0jOiAAlIEeGATtfOBToyew_843870273")]
    [DisplayName("Acknowledgement Reason 9 Choice")]
    public abstract record AcknowledgementReason9Choice_ { }
}
