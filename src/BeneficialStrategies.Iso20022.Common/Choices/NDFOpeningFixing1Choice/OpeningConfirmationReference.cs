...
namespace BeneficialStrategies.Iso20022.Choices.NDFOpeningFixing1Choice
{
    ...
    #else
    public partial class OpeningConfirmationReference : NDFOpeningFixing1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a OpeningConfirmationReference instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public OpeningConfirmationReference( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
