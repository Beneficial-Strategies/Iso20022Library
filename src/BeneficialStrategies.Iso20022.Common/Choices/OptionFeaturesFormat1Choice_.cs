...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OptionFeaturesFormat1Choice.Code),
        nameof(OptionFeaturesFormat1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(OptionFeaturesFormat1Choice.Proprietary),
        nameof(OptionFeaturesFormat1Choice.Proprietary)
    )]
    [IsoId("_Q1FL5Np-Ed-ak6NoX_4Aeg_-347103592")]
    [DisplayName("Option Features Format 1 Choice")]
    public abstract record OptionFeaturesFormat1Choice_ { }
}
