...
namespace BeneficialStrategies.Iso20022.Choices.PartyRole6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : PartyRole6Choice_
    #else
    public partial class Code : PartyRole6Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PartyRole2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PartyRole2Code Value { get; init; } 
        #else
        public PartyRole2Code Value { get; set; } 
        #endif
