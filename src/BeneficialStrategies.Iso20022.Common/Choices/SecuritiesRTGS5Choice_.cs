...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SecuritiesRTGS5Choice.Indicator),
        nameof(SecuritiesRTGS5Choice.Indicator)
    )]
    [JsonDerivedType(
        typeof(SecuritiesRTGS5Choice.Proprietary),
        nameof(SecuritiesRTGS5Choice.Proprietary)
    )]
    [IsoId("_5TJ_AZNLEeWGlc8L7oPDIg")]
    [DisplayName("Securities RTGS 5 Choice")]
    public abstract record SecuritiesRTGS5Choice_ { }
}
