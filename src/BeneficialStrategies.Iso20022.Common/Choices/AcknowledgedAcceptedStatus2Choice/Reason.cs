...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgedAcceptedStatus2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : AcknowledgedAcceptedStatus2Choice_
    #else
    public partial class Reason : AcknowledgedAcceptedStatus2Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( AcknowledgementReason3Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
        ...
        #else
        public AcknowledgementReason3Choice_ Code { get; set; } 
        #endif
