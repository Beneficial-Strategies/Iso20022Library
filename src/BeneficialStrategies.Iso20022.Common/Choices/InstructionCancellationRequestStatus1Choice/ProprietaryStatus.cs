...
namespace BeneficialStrategies.Iso20022.Choices.InstructionCancellationRequestStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_QyGwZ9p-Ed-ak6NoX_4Aeg_-1849747574")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : InstructionCancellationRequestStatus1Choice_
    #else
    public partial class ProprietaryStatus : InstructionCancellationRequestStatus1Choice_
    #endif
    {
