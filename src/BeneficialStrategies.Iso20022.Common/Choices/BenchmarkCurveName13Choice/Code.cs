...
namespace BeneficialStrategies.Iso20022.Choices.BenchmarkCurveName13Choice
{
    ...
    #else
    public partial class Code : BenchmarkCurveName13Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BenchmarkCurveName7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BenchmarkCurveName7Code Value { get; init; } 
        #else
        public BenchmarkCurveName7Code Value { get; set; } 
        #endif
