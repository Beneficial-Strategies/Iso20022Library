...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentNeed1Choice
{
    ...
    #else
    public partial class Code : InvestmentNeed1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestmentNeed1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestmentNeed1Code Value { get; init; } 
        #else
        public InvestmentNeed1Code Value { get; set; } 
        #endif
