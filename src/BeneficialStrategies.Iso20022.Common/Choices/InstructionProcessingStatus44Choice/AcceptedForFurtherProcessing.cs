...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus44Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AcceptedForFurtherProcessing : InstructionProcessingStatus44Choice_
    #else
    public partial class AcceptedForFurtherProcessing : InstructionProcessingStatus44Choice_
    #endif
    {
