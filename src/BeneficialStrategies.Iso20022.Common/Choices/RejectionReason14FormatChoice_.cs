...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RejectionReason14FormatChoice.Code),
        nameof(RejectionReason14FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(RejectionReason14FormatChoice.Proprietary),
        nameof(RejectionReason14FormatChoice.Proprietary)
    )]
    [IsoId("_RoMq5dp-Ed-ak6NoX_4Aeg_-1393087527")]
    [DisplayName("Rejection Reason 14 Format Choice")]
    public abstract record RejectionReason14FormatChoice_ { }
}
