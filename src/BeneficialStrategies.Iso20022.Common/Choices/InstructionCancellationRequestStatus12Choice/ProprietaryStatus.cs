...
namespace BeneficialStrategies.Iso20022.Choices.InstructionCancellationRequestStatus12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : InstructionCancellationRequestStatus12Choice_
    #else
    public partial class ProprietaryStatus : InstructionCancellationRequestStatus12Choice_
    #endif
    {
