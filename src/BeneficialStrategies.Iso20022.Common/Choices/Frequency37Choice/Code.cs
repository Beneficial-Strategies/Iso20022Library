...
namespace BeneficialStrategies.Iso20022.Choices.Frequency37Choice
{
    ...
    #else
    public partial class Code : Frequency37Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Frequency10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Frequency10Code Value { get; init; } 
        #else
        public Frequency10Code Value { get; set; } 
        #endif
