...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TrancheIndicator2Choice.Tranched),
        nameof(TrancheIndicator2Choice.Tranched)
    )]
    [JsonDerivedType(
        typeof(TrancheIndicator2Choice.Untranched),
        nameof(TrancheIndicator2Choice.Untranched)
    )]
    [IsoId("_5tB9YbyOEeaUov4jN5X9Qw")]
    [DisplayName("Tranche Indicator 2 Choice")]
    public abstract record TrancheIndicator2Choice_ { }
}
