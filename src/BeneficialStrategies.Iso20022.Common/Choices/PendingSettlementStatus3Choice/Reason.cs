...
namespace BeneficialStrategies.Iso20022.Choices.PendingSettlementStatus3Choice
{
    ...
    #else
    public partial class Reason : PendingSettlementStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingSettlementStatusReason2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public PendingSettlementStatusReason2Code Value { get; set; } 
        #endif
