...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification223Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record LegalPerson : PartyIdentification223Choice_
    #else
    public partial class LegalPerson : PartyIdentification223Choice_
    #endif
    {
