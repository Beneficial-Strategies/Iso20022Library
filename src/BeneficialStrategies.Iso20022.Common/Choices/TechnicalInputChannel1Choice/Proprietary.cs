...
namespace BeneficialStrategies.Iso20022.Choices.TechnicalInputChannel1Choice
{
    ...
    /// </summary>
    [IsoId("_Rpr4o9p-Ed-ak6NoX_4Aeg_-450061832")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TechnicalInputChannel1Choice_
    #else
    public partial class Proprietary : TechnicalInputChannel1Choice_
    #endif
    {
