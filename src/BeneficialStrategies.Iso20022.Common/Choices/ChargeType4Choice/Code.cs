...
namespace BeneficialStrategies.Iso20022.Choices.ChargeType4Choice
{
    ...
    #else
    public partial class Code : ChargeType4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ChargeType12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ChargeType12Code Value { get; init; } 
        #else
        public ChargeType12Code Value { get; set; } 
        #endif
