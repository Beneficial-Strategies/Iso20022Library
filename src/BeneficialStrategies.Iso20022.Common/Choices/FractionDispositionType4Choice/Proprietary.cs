...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType4Choice
{
    ...
    /// </summary>
    [IsoId("_Q08B8tp-Ed-ak6NoX_4Aeg_2018986331")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType4Choice_
    #else
    public partial class Proprietary : FractionDispositionType4Choice_
    #endif
    {
