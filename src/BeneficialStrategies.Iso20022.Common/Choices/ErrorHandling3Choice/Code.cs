...
namespace BeneficialStrategies.Iso20022.Choices.ErrorHandling3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : ErrorHandling3Choice_
    #else
    public partial class Code : ErrorHandling3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalSystemErrorHandling1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalSystemErrorHandling1Code Value { get; init; } 
        #else
        public ExternalSystemErrorHandling1Code Value { get; set; } 
        #endif
