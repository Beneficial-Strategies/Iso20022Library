...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodity5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : AssetClassCommodity5Choice_
    #else
    public partial class Other : AssetClassCommodity5Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType15Code reqBaseProduct )
        {
