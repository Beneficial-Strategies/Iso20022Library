...
namespace BeneficialStrategies.Iso20022.Choices.PaymentInstrument17Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PaymentCardDetails : PaymentInstrument17Choice_
    #else
    public partial class PaymentCardDetails : PaymentInstrument17Choice_
    #endif
    {
