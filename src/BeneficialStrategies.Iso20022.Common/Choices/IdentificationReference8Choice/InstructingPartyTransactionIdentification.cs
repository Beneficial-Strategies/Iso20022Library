...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationReference8Choice
{
    ...
    /// </summary>
    [IsoId("_AcF7ktokEeC60axPepSq7g_1236461558")]
    ...
    #else
    public partial class InstructingPartyTransactionIdentification : IdentificationReference8Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a InstructingPartyTransactionIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public InstructingPartyTransactionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
