...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType76Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType76Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType26Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType26Code Value { get; init; } 
        #else
        public CorporateActionEventType26Code Value { get; set; } 
        #endif
