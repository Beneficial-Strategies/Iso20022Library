...
namespace BeneficialStrategies.Iso20022.Choices.PartyOrOperationalError3Choice
{
    ...
    #else
    public partial class PartyReport : PartyOrOperationalError3Choice_
    #endif
    {
        ...
        /// </summary>
        public PartyReport( SystemPartyIdentification8 reqPartyIdentification,PartyOrBusinessError3Choice_ reqPartyOrError )
        {
