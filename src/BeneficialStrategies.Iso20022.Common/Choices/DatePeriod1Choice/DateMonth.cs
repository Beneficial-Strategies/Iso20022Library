...
namespace BeneficialStrategies.Iso20022.Choices.DatePeriod1Choice
{
    ...
    #else
    public partial class DateMonth : DatePeriod1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a DateMonth instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public DateMonth( System.UInt16 reqValue )
        {
            Value = reqValue;
        }
        #endif
