...
namespace BeneficialStrategies.Iso20022.Choices.References3Choice
{
    ...
    /// </summary>
    [IsoId("_USz3ANp-Ed-ak6NoX_4Aeg_-2006244843")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesBalanceCustodyReportIdentification : References3Choice_
    #else
    public partial class SecuritiesBalanceCustodyReportIdentification : References3Choice_
    #endif
    {
