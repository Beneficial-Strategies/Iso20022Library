...
namespace BeneficialStrategies.Iso20022.Choices.References3Choice
{
    ...
    /// </summary>
    [IsoId("_USz3Adp-Ed-ak6NoX_4Aeg_-1482725092")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IntraPositionMovementPostingReportIdentification : References3Choice_
    #else
    public partial class IntraPositionMovementPostingReportIdentification : References3Choice_
    #endif
    {
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="IntraPosMvmntPstngRptId")]
        #endif
