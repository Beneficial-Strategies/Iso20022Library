...
namespace BeneficialStrategies.Iso20022.Choices.References3Choice
{
    ...
    #else
    public partial class SecuritiesSettlementTransactionAllegementNotificationTransactionIdentification : References3Choice_
    #endif
    {
        ...
        /// </summary>
        public SecuritiesSettlementTransactionAllegementNotificationTransactionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        /// </summary>
        #if DECLARE_DATACONTRACT
        [DataMember(Name="SctiesSttlmTxAllgmtNtfctnTxId")]
        #endif
