...
namespace BeneficialStrategies.Iso20022.Choices.References3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesTransactionPendingReportIdentification : References3Choice_
    #else
    public partial class SecuritiesTransactionPendingReportIdentification : References3Choice_
    #endif
    {
