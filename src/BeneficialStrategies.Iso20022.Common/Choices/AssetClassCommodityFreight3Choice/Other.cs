...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityFreight3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Other : AssetClassCommodityFreight3Choice_
    #else
    public partial class Other : AssetClassCommodityFreight3Choice_
    #endif
    {
        ...
        /// </summary>
        public Other( AssetClassProductType4Code reqBaseProduct,AssetClassSubProductType49Code reqSubProduct )
        {
