...
namespace BeneficialStrategies.Iso20022.Choices.SettlementFrequency1Choice
{
    ...
    #else
    public partial class Code : SettlementFrequency1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( EventFrequency10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public EventFrequency10Code Value { get; init; } 
        #else
        public EventFrequency10Code Value { get; set; } 
        #endif
