...
namespace BeneficialStrategies.Iso20022.Choices.TaxCreditRateFormat9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : TaxCreditRateFormat9Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : TaxCreditRateFormat9Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType48Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType48Choice_ RateType { get; init; } 
        #else
        public RateType48Choice_ RateType { get; set; } 
        #endif
