...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat29Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat29Choice_
    #else
    public partial class Amount : GrossDividendRateFormat29Choice_
    #endif
    {
