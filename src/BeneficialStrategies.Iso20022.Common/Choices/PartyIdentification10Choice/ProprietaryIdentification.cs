...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification10Choice
{
    ...
    /// </summary>
    [IsoId("_QQR1t9p-Ed-ak6NoX_4Aeg_401125952")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification10Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification10Choice_
    #endif
    {
