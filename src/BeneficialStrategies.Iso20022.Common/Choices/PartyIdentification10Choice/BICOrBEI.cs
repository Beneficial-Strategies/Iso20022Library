...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification10Choice
{
    ...
    /// </summary>
    [IsoId("_QQR1ttp-Ed-ak6NoX_4Aeg_-1357980549")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BICOrBEI : PartyIdentification10Choice_
    #else
    public partial class BICOrBEI : PartyIdentification10Choice_
    #endif
    {
