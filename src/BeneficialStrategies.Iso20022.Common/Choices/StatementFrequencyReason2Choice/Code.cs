...
namespace BeneficialStrategies.Iso20022.Choices.StatementFrequencyReason2Choice
{
    ...
    #else
    public partial class Code : StatementFrequencyReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( EventFrequency9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public EventFrequency9Code Value { get; init; } 
        #else
        public EventFrequency9Code Value { get; set; } 
        #endif
