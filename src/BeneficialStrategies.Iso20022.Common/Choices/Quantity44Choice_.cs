...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Quantity44Choice.PercentageRate),
        nameof(Quantity44Choice.PercentageRate)
    )]
    [JsonDerivedType(typeof(Quantity44Choice.FaceAmount), nameof(Quantity44Choice.FaceAmount))]
    [JsonDerivedType(
        typeof(Quantity44Choice.AmortisedValue),
        nameof(Quantity44Choice.AmortisedValue)
    )]
    ...
    public abstract record Quantity44Choice_ { }
}
