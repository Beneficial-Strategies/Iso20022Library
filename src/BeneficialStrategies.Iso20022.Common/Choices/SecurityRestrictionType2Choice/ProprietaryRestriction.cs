...
namespace BeneficialStrategies.Iso20022.Choices.SecurityRestrictionType2Choice
{
    ...
    #else
    public partial class ProprietaryRestriction : SecurityRestrictionType2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ProprietaryRestriction instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ProprietaryRestriction( System.String reqIdentification,System.String reqIssuer )
        {
