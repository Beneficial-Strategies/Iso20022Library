...
namespace BeneficialStrategies.Iso20022.Choices.SecurityRestrictionType2Choice
{
    ...
    #else
    public partial class RestrictionType : SecurityRestrictionType2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RestrictionType instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RestrictionType( RestrictionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public RestrictionType1Code Value { get; set; } 
        #endif
