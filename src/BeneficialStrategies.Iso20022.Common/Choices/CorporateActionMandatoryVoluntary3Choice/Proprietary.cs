...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionMandatoryVoluntary3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionMandatoryVoluntary3Choice_
    #else
    public partial class Proprietary : CorporateActionMandatoryVoluntary3Choice_
    #endif
    {
