...
namespace BeneficialStrategies.Iso20022.Choices.IntermediaryRoleChoice1
{
    ...
    /// </summary>
    [IsoId("_RhC6CNp-Ed-ak6NoX_4Aeg_1630269527")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IntermediaryRoleChoice1_
    #else
    public partial class Proprietary : IntermediaryRoleChoice1_
    #endif
    {
