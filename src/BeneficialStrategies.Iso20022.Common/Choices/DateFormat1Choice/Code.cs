...
namespace BeneficialStrategies.Iso20022.Choices.DateFormat1Choice
{
    ...
    #else
    public partial class Code : DateFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementDate1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementDate1Code Value { get; init; } 
        #else
        public SettlementDate1Code Value { get; set; } 
        #endif
