...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason37Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason37Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason37Choice_
    #endif
    {
