...
namespace BeneficialStrategies.Iso20022.Choices.CRSForm1Choice
{
    ...
    #else
    public partial class Code : CRSForm1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CRSFormType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CRSFormType1Code Value { get; init; } 
        #else
        public CRSFormType1Code Value { get; set; } 
        #endif
