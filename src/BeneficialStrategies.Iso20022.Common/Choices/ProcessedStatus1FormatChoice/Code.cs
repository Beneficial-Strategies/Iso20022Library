...
namespace BeneficialStrategies.Iso20022.Choices.ProcessedStatus1FormatChoice
{
    ...
    #else
    public partial class Code : ProcessedStatus1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProcessedStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProcessedStatus1Code Value { get; init; } 
        #else
        public ProcessedStatus1Code Value { get; set; } 
        #endif
