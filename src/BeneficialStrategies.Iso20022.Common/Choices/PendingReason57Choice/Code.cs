...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason57Choice
{
    ...
    #else
    public partial class Code : PendingReason57Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason20Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason20Code Value { get; init; } 
        #else
        public PendingReason20Code Value { get; set; } 
        #endif
