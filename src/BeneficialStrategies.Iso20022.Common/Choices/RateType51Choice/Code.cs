...
namespace BeneficialStrategies.Iso20022.Choices.RateType51Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : RateType51Choice_
    #else
    public partial class Code : RateType51Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GrossDividendRateType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GrossDividendRateType3Code Value { get; init; } 
        #else
        public GrossDividendRateType3Code Value { get; set; } 
        #endif
