...
namespace BeneficialStrategies.Iso20022.Choices.SafekeepingPlaceFormat28Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Identification : SafekeepingPlaceFormat28Choice_
    #else
    public partial class Identification : SafekeepingPlaceFormat28Choice_
    #endif
    {
