...
namespace BeneficialStrategies.Iso20022.Choices.SolicitationFeeRateFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rate : SolicitationFeeRateFormat10Choice_
    #else
    public partial class Rate : SolicitationFeeRateFormat10Choice_
    #endif
    {
