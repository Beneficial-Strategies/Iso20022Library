...
namespace BeneficialStrategies.Iso20022.Choices.FractionDispositionType32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FractionDispositionType32Choice_
    #else
    public partial class Proprietary : FractionDispositionType32Choice_
    #endif
    {
