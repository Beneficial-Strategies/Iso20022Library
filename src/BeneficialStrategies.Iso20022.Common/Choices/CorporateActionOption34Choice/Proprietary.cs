...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption34Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption34Choice_
    #else
    public partial class Proprietary : CorporateActionOption34Choice_
    #endif
    {
