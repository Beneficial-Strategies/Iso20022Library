...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStageFormat15Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventStageFormat15Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventStage4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventStage4Code Value { get; init; } 
        #else
        public CorporateActionEventStage4Code Value { get; set; } 
        #endif
