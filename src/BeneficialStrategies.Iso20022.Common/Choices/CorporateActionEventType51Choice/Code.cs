...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType51Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType51Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType22Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType22Code Value { get; init; } 
        #else
        public CorporateActionEventType22Code Value { get; set; } 
        #endif
