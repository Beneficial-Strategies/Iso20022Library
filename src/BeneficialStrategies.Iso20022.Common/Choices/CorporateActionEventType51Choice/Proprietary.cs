...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType51Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType51Choice_
    #else
    public partial class Proprietary : CorporateActionEventType51Choice_
    #endif
    {
