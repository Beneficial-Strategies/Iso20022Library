...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AutomaticBorrowing7Choice.Code),
        nameof(AutomaticBorrowing7Choice.Code)
    )]
    [JsonDerivedType(
        typeof(AutomaticBorrowing7Choice.Proprietary),
        nameof(AutomaticBorrowing7Choice.Proprietary)
    )]
    [IsoId("_GG1RwTt4EeW638lNyHKv7A")]
    [DisplayName("Automatic Borrowing 7 Choice")]
    public abstract record AutomaticBorrowing7Choice_ { }
}
