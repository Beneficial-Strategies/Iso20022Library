...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat26Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : OptionFeaturesFormat26Choice_
    #else
    public partial class Code : OptionFeaturesFormat26Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures11Code Value { get; init; } 
        #else
        public OptionFeatures11Code Value { get; set; } 
        #endif
