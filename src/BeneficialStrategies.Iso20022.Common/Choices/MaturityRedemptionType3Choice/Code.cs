...
namespace BeneficialStrategies.Iso20022.Choices.MaturityRedemptionType3Choice
{
    ...
    #else
    public partial class Code : MaturityRedemptionType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MaturityRedemptionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MaturityRedemptionType1Code Value { get; init; } 
        #else
        public MaturityRedemptionType1Code Value { get; set; } 
        #endif
