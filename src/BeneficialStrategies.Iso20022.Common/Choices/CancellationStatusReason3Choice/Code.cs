...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatusReason3Choice
{
    ...
    #else
    public partial class Code : CancellationStatusReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalPaymentCancellationRejection1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalPaymentCancellationRejection1Code Value { get; init; } 
        #else
        public ExternalPaymentCancellationRejection1Code Value { get; set; } 
        #endif
