...
namespace BeneficialStrategies.Iso20022.Choices.AccountStatus1Choice
{
    ...
    #else
    public partial class Code : AccountStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AccountStatus4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AccountStatus4Code Value { get; init; } 
        #else
        public AccountStatus4Code Value { get; set; } 
        #endif
