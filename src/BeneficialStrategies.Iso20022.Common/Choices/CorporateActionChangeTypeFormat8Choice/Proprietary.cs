...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionChangeTypeFormat8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionChangeTypeFormat8Choice_
    #else
    public partial class Proprietary : CorporateActionChangeTypeFormat8Choice_
    #endif
    {
