...
namespace BeneficialStrategies.Iso20022.Choices.PensionSchemeType3Choice
{
    ...
    #else
    public partial class Code : PensionSchemeType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PensionSchemeType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PensionSchemeType3Code Value { get; init; } 
        #else
        public PensionSchemeType3Code Value { get; set; } 
        #endif
