...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ProcessingPosition10Choice.Code),
        nameof(ProcessingPosition10Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ProcessingPosition10Choice.Proprietary),
        nameof(ProcessingPosition10Choice.Proprietary)
    )]
    [IsoId("_chT0q5KQEeWHWpTQn1FFVg")]
    [DisplayName("Processing Position 10 Choice")]
    public abstract record ProcessingPosition10Choice_ { }
}
