...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStageFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q3dxhdp-Ed-ak6NoX_4Aeg_1469868586")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStageFormat1Choice_
    #else
    public partial class Proprietary : CorporateActionEventStageFormat1Choice_
    #endif
    {
