...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType1Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType1Code Value { get; init; } 
        #else
        public SecuritiesTransactionType1Code Value { get; set; } 
        #endif
