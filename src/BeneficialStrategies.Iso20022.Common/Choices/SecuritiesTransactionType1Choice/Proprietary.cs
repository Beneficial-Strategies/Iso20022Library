...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType1Choice
{
    ...
    /// </summary>
    [IsoId("_QuOV-Np-Ed-ak6NoX_4Aeg_-1516201919")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType1Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType1Choice_
    #endif
    {
