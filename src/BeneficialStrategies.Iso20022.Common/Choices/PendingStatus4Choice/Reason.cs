...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus4Choice
{
    ...
    /// </summary>
    [IsoId("_UYoLJNp-Ed-ak6NoX_4Aeg_212453211")]
    [DisplayName("Reason")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingStatus4Choice_
    #else
    public partial class Reason : PendingStatus4Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingReason2Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
