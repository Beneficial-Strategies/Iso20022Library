...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PartyIdentification72Choice.AnyBIC),
        nameof(PartyIdentification72Choice.AnyBIC)
    )]
    [JsonDerivedType(
        typeof(PartyIdentification72Choice.ProprietaryIdentification),
        nameof(PartyIdentification72Choice.ProprietaryIdentification)
    )]
    [IsoId("_3JsB7nHeEeG8t-w1mFnmhg_-1626691800")]
    [DisplayName("Party Identification 72 Choice")]
    public abstract record PartyIdentification72Choice_ { }
}
