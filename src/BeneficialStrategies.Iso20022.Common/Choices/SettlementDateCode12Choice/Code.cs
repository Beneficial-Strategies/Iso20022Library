...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDateCode12Choice
{
    ...
    #else
    public partial class Code : SettlementDateCode12Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementDate5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettlementDate5Code Value { get; init; } 
        #else
        public SettlementDate5Code Value { get; set; } 
        #endif
