...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OffMarket1Choice.OffMarketIndicator),
        nameof(OffMarket1Choice.OffMarketIndicator)
    )]
    [JsonDerivedType(
        typeof(OffMarket1Choice.SystematicInternaliser),
        nameof(OffMarket1Choice.SystematicInternaliser)
    )]
    [IsoId("_TCpPoNp-Ed-ak6NoX_4Aeg_2009784706")]
    [DisplayName("Off Market 1 Choice")]
    public abstract record OffMarket1Choice_ { }
}
