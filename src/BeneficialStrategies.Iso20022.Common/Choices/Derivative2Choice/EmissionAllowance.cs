...
namespace BeneficialStrategies.Iso20022.Choices.Derivative2Choice
{
    ...
    #else
    public partial class EmissionAllowance : Derivative2Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a EmissionAllowance instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public EmissionAllowance( EmissionAllowanceProductType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public EmissionAllowanceProductType1Code Value { get; set; } 
        #endif
