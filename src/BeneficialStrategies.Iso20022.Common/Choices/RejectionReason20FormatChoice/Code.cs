...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason20FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason20FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason20Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason20Code Value { get; init; } 
        #else
        public RejectionReason20Code Value { get; set; } 
        #endif
