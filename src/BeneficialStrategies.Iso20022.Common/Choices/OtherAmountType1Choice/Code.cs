...
namespace BeneficialStrategies.Iso20022.Choices.OtherAmountType1Choice
{
    ...
    #else
    public partial class Code : OtherAmountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OtherAmountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OtherAmountType1Code Value { get; init; } 
        #else
        public OtherAmountType1Code Value { get; set; } 
        #endif
