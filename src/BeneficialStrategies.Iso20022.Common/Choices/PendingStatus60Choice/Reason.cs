...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus60Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingStatus60Choice_
    #else
    public partial class Reason : PendingStatus60Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingReason56Choice_ reqReasonCode )
        {
