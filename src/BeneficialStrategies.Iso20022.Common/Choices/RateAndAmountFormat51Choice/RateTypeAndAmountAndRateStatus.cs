...
namespace BeneficialStrategies.Iso20022.Choices.RateAndAmountFormat51Choice
{
    ...
    #else
    public partial class RateTypeAndAmountAndRateStatus : RateAndAmountFormat51Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( DeemedRateType1Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
