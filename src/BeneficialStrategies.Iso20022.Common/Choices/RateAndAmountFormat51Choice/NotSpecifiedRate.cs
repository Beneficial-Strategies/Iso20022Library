...
namespace BeneficialStrategies.Iso20022.Choices.RateAndAmountFormat51Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RateAndAmountFormat51Choice_
    #else
    public partial class NotSpecifiedRate : RateAndAmountFormat51Choice_
    #endif
    {
