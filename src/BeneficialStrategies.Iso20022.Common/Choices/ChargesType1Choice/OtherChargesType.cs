...
namespace BeneficialStrategies.Iso20022.Choices.ChargesType1Choice
{
    ...
    #else
    public partial class OtherChargesType : ChargesType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a OtherChargesType instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public OtherChargesType( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
