...
namespace BeneficialStrategies.Iso20022.Choices.FATCAStatus1Choice
{
    ...
    #else
    public partial class Code : FATCAStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FATCAStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FATCAStatus1Code Value { get; init; } 
        #else
        public FATCAStatus1Code Value { get; set; } 
        #endif
