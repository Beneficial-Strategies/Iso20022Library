...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantityChoice
{
    ...
    /// </summary>
    [IsoId("_SoH20Np-Ed-ak6NoX_4Aeg_1583790695")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmortisedValue : FinancialInstrumentQuantityChoice_
    #else
    public partial class AmortisedValue : FinancialInstrumentQuantityChoice_
    #endif
    {
