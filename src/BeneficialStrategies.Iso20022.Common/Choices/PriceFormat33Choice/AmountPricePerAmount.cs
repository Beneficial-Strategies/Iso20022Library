...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat33Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountPricePerAmount : PriceFormat33Choice_
    #else
    public partial class AmountPricePerAmount : PriceFormat33Choice_
    #endif
    {
        ...
        /// </summary>
        public AmountPricePerAmount( AmountPriceType1Code reqAmountPriceType,ActiveCurrencyAnd13DecimalAmount reqPriceValue,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
