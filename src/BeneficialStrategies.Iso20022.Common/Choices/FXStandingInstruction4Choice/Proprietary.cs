...
namespace BeneficialStrategies.Iso20022.Choices.FXStandingInstruction4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : FXStandingInstruction4Choice_
    #else
    public partial class Proprietary : FXStandingInstruction4Choice_
    #endif
    {
