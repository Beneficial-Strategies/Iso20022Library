...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification38Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification38Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification38Choice_
    #endif
    {
