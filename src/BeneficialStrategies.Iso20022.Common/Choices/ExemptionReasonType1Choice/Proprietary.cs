...
namespace BeneficialStrategies.Iso20022.Choices.ExemptionReasonType1Choice
{
    ...
    /// </summary>
    [IsoId("_RgcdEdp-Ed-ak6NoX_4Aeg_685334280")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ExemptionReasonType1Choice_
    #else
    public partial class Proprietary : ExemptionReasonType1Choice_
    #endif
    {
