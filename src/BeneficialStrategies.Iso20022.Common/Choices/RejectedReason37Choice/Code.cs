...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason37Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : RejectedReason37Choice_
    #else
    public partial class Code : RejectedReason37Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason59Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason59Code Value { get; init; } 
        #else
        public RejectionReason59Code Value { get; set; } 
        #endif
