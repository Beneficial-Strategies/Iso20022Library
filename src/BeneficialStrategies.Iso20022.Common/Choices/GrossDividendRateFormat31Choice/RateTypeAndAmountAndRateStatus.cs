...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : GrossDividendRateFormat31Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : GrossDividendRateFormat31Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType72Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
        {
