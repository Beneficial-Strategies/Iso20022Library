...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : GrossDividendRateFormat31Choice_
    #else
    public partial class AmountAndRateStatus : GrossDividendRateFormat31Choice_
    #endif
    {
