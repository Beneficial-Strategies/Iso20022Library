...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ExpectedCollateral1Choice.ExpectedCollateralDetails),
        nameof(ExpectedCollateral1Choice.ExpectedCollateralDetails)
    )]
    [JsonDerivedType(
        typeof(ExpectedCollateral1Choice.SegregatedIndependentAmount),
        nameof(ExpectedCollateral1Choice.SegregatedIndependentAmount)
    )]
    [IsoId("_QmevMtp-Ed-ak6NoX_4Aeg_-1576167501")]
    [DisplayName("Expected Collateral 1 Choice")]
    public abstract record ExpectedCollateral1Choice_ { }
}
