...
namespace BeneficialStrategies.Iso20022.Choices.MeetingTypeClassification1Choice
{
    ...
    #else
    public partial class Code : MeetingTypeClassification1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MeetingTypeClassification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MeetingTypeClassification1Code Value { get; init; } 
        #else
        public MeetingTypeClassification1Code Value { get; set; } 
        #endif
