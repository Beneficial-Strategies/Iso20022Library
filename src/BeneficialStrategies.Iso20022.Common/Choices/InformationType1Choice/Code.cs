...
namespace BeneficialStrategies.Iso20022.Choices.InformationType1Choice
{
    ...
    #else
    public partial class Code : InformationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InformationType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InformationType1Code Value { get; init; } 
        #else
        public InformationType1Code Value { get; set; } 
        #endif
