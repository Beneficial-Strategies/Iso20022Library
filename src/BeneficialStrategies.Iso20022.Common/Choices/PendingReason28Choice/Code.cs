...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason28Choice
{
    ...
    #else
    public partial class Code : PendingReason28Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason6Code Value { get; init; } 
        #else
        public PendingReason6Code Value { get; set; } 
        #endif
