...
namespace BeneficialStrategies.Iso20022.Choices.AccountOrBusinessError5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BusinessError : AccountOrBusinessError5Choice_
    #else
    public partial class BusinessError : AccountOrBusinessError5Choice_
    #endif
    {
