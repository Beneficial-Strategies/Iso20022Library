...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : OptionFeaturesFormat2Choice_
    #else
    public partial class Code : OptionFeaturesFormat2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures2Code Value { get; init; } 
        #else
        public OptionFeatures2Code Value { get; set; } 
        #endif
