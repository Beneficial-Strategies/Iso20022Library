...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStageFormat6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStageFormat6Choice_
    #else
    public partial class Proprietary : CorporateActionEventStageFormat6Choice_
    #endif
    {
