...
namespace BeneficialStrategies.Iso20022.Choices.OptionFeaturesFormat1Choice
{
    ...
    #else
    public partial class Code : OptionFeaturesFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionFeatures1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionFeatures1Code Value { get; init; } 
        #else
        public OptionFeatures1Code Value { get; set; } 
        #endif
