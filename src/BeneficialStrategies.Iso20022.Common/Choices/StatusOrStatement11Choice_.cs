...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(StatusOrStatement11Choice.StatusAdvice),
        nameof(StatusOrStatement11Choice.StatusAdvice)
    )]
    [JsonDerivedType(
        typeof(StatusOrStatement11Choice.Statement),
        nameof(StatusOrStatement11Choice.Statement)
    )]
    [IsoId("_4dK-USgSEeym1_Zp1BTvEw")]
    [DisplayName("Status Or Statement 11 Choice")]
    public abstract record StatusOrStatement11Choice_ { }
}
