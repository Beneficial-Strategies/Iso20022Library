...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption41Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption41Choice_
    #else
    public partial class Proprietary : CorporateActionOption41Choice_
    #endif
    {
