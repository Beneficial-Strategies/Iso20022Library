...
namespace BeneficialStrategies.Iso20022.Choices.RatioFormat24Choice
{
    ...
    #else
    public partial class QuantityToAmount : RatioFormat24Choice_
    #endif
    {
        ...
        /// </summary>
        public QuantityToAmount( RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount,System.UInt64 reqQuantity )
        {
            Amount = reqAmount;
