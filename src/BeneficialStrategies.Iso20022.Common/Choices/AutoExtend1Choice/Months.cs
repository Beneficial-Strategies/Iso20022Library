...
namespace BeneficialStrategies.Iso20022.Choices.AutoExtend1Choice
{
    ...
    #else
    public partial class Months : AutoExtend1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Months instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Months( System.UInt64 reqValue )
        {
            Value = reqValue;
        }
        #endif
