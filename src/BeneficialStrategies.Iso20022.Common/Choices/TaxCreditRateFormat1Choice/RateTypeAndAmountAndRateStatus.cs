...
namespace BeneficialStrategies.Iso20022.Choices.TaxCreditRateFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_UOfXsNp-Ed-ak6NoX_4Aeg_465504276")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : TaxCreditRateFormat1Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : TaxCreditRateFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType10Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
