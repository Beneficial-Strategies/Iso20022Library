...
namespace BeneficialStrategies.Iso20022.Choices.TaxCreditRateFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_UOVmvtp-Ed-ak6NoX_4Aeg_465503286")]
    [DisplayName("Amount")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : TaxCreditRateFormat1Choice_
    #else
    public partial class Amount : TaxCreditRateFormat1Choice_
    #endif
    {
