...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesBalanceType6FormatChoice
{
    ...
    #else
    public partial class Code : SecuritiesBalanceType6FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesBalanceType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public SecuritiesBalanceType6Code Value { get; set; } 
        #endif
