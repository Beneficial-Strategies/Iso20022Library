...
namespace BeneficialStrategies.Iso20022.Choices.PriceRateType3FormatChoice
{
    ...
    #else
    public partial class Code : PriceRateType3FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( PriceRateType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PriceRateType3Code Value { get; init; } 
        #else
        public PriceRateType3Code Value { get; set; } 
        #endif
