...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus74Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : ProcessingStatus74Choice_
    #else
    public partial class CancellationRequested : ProcessingStatus74Choice_
    #endif
    {
