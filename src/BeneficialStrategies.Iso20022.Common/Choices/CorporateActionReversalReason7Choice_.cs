...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionReversalReason7Choice.Code),
        nameof(CorporateActionReversalReason7Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionReversalReason7Choice.Proprietary),
        nameof(CorporateActionReversalReason7Choice.Proprietary)
    )]
    [IsoId("_WfigTl99Ee262vCSVgjImg")]
    [DisplayName("Corporate Action Reversal Reason 7 Choice")]
    public abstract record CorporateActionReversalReason7Choice_ { }
}
