...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(UnderlyingTransaction2Choice.Initiation),
        nameof(UnderlyingTransaction2Choice.Initiation)
    )]
    [JsonDerivedType(
        typeof(UnderlyingTransaction2Choice.Interbank),
        nameof(UnderlyingTransaction2Choice.Interbank)
    )]
    [JsonDerivedType(
        typeof(UnderlyingTransaction2Choice.StatementEntry),
        nameof(UnderlyingTransaction2Choice.StatementEntry)
    )]
    [IsoId("_P3N9Vp9XEeGBX4a4yy-WHg_2030305441")]
    [DisplayName("Underlying Transaction 2 Choice")]
    public abstract record UnderlyingTransaction2Choice_ { }
}
