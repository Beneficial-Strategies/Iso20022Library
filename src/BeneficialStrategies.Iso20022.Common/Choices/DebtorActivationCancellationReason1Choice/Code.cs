...
namespace BeneficialStrategies.Iso20022.Choices.DebtorActivationCancellationReason1Choice
{
    ...
    #else
    public partial class Code : DebtorActivationCancellationReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalDebtorActivationCancellationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalDebtorActivationCancellationReason1Code Value { get; init; } 
        #else
        public ExternalDebtorActivationCancellationReason1Code Value { get; set; } 
        #endif
