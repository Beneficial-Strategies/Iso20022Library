...
namespace BeneficialStrategies.Iso20022.Choices.MandateClassification1Choice
{
    ...
    #else
    public partial class Code : MandateClassification1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MandateClassification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MandateClassification1Code Value { get; init; } 
        #else
        public MandateClassification1Code Value { get; set; } 
        #endif
