...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingPosition2Choice
{
    ...
    #else
    public partial class Code : ProcessingPosition2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProcessingPosition1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProcessingPosition1Code Value { get; init; } 
        #else
        public ProcessingPosition1Code Value { get; set; } 
        #endif
