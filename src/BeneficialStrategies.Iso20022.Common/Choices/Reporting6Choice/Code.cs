...
namespace BeneficialStrategies.Iso20022.Choices.Reporting6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Code : Reporting6Choice_
    #else
    public partial class Code : Reporting6Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Reporting2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Reporting2Code Value { get; init; } 
        #else
        public Reporting2Code Value { get; set; } 
        #endif
