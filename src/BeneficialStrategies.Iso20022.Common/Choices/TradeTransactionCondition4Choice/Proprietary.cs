...
namespace BeneficialStrategies.Iso20022.Choices.TradeTransactionCondition4Choice
{
    ...
    /// </summary>
    [IsoId("_AcingdokEeC60axPepSq7g_2039576794")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TradeTransactionCondition4Choice_
    #else
    public partial class Proprietary : TradeTransactionCondition4Choice_
    #endif
    {
