...
namespace BeneficialStrategies.Iso20022.Choices.TaxCreditRateFormat8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : TaxCreditRateFormat8Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : TaxCreditRateFormat8Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType37Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
