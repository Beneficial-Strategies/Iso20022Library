...
namespace BeneficialStrategies.Iso20022.Choices.CreditorEnrolmentStatusReason2Choice
{
    ...
    #else
    public partial class Code : CreditorEnrolmentStatusReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalCreditorEnrolmentStatusReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalCreditorEnrolmentStatusReason1Code Value { get; init; } 
        #else
        public ExternalCreditorEnrolmentStatusReason1Code Value { get; set; } 
        #endif
