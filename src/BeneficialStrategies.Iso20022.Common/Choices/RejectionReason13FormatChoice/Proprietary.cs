...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason13FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RoMq5Np-Ed-ak6NoX_4Aeg_331296633")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason13FormatChoice_
    #else
    public partial class Proprietary : RejectionReason13FormatChoice_
    #endif
    {
