...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason13FormatChoice
{
    ...
    #else
    public partial class Code : RejectionReason13FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason13Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason13Code Value { get; init; } 
        #else
        public RejectionReason13Code Value { get; set; } 
        #endif
