...
namespace BeneficialStrategies.Iso20022.Choices.TradingPartyCapacity5Choice
{
    ...
    #else
    public partial class Code : TradingPartyCapacity5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TradingCapacity7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TradingCapacity7Code Value { get; init; } 
        #else
        public TradingCapacity7Code Value { get; set; } 
        #endif
