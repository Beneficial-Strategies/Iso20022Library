...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason5Choice
{
    ...
    /// </summary>
    [IsoId("_UY7GGNp-Ed-ak6NoX_4Aeg_1816714698")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationReason5Choice_
    #else
    public partial class Proprietary : CancellationReason5Choice_
    #endif
    {
