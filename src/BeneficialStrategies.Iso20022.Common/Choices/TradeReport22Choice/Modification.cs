...
namespace BeneficialStrategies.Iso20022.Choices.TradeReport22Choice
{
    ...
    #else
    public partial class Modification : TradeReport22Choice_
    #endif
    {
        ...
        /// </summary>
        public Modification( CounterpartyData88 reqCounterpartySpecificData,ModificationLevel1Code reqLevelType )
        {
