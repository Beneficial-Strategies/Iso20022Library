...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason4Choice
{
    ...
    /// </summary>
    [IsoId("_UYUpINp-Ed-ak6NoX_4Aeg_-1933906644")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionReason4Choice_
    #else
    public partial class Proprietary : RejectionReason4Choice_
    #endif
    {
