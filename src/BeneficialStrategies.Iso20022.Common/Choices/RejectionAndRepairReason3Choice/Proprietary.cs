...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason3Choice
{
    ...
    /// </summary>
    [IsoId("_UWrqYdp-Ed-ak6NoX_4Aeg_-1938373773")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason3Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason3Choice_
    #endif
    {
