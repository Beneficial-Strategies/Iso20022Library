...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason3Choice
{
    ...
    #else
    public partial class Code : RejectionAndRepairReason3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason23Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason23Code Value { get; init; } 
        #else
        public RejectionReason23Code Value { get; set; } 
        #endif
