...
namespace BeneficialStrategies.Iso20022.Choices.ParticipationMethod1Choice
{
    ...
    #else
    public partial class Code : ParticipationMethod1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( VotingParticipationMethod1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public VotingParticipationMethod1Code Value { get; set; } 
        #endif
