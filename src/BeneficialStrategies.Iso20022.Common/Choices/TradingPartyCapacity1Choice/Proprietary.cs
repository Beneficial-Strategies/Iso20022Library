...
namespace BeneficialStrategies.Iso20022.Choices.TradingPartyCapacity1Choice
{
    ...
    /// </summary>
    [IsoId("_AXehUNokEeC60axPepSq7g_1535631051")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TradingPartyCapacity1Choice_
    #else
    public partial class Proprietary : TradingPartyCapacity1Choice_
    #endif
    {
