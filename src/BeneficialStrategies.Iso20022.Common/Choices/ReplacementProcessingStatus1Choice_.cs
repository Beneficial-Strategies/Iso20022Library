...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ReplacementProcessingStatus1Choice.Code),
        nameof(ReplacementProcessingStatus1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ReplacementProcessingStatus1Choice.Proprietary),
        nameof(ReplacementProcessingStatus1Choice.Proprietary)
    )]
    [IsoId("_UXSHUNp-Ed-ak6NoX_4Aeg_-220686671")]
    [DisplayName("Replacement Processing Status 1 Choice")]
    public abstract record ReplacementProcessingStatus1Choice_ { }
}
