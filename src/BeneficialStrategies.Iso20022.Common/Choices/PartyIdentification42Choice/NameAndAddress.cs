...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification42Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification42Choice_
    #else
    public partial class NameAndAddress : PartyIdentification42Choice_
    #endif
    {
