...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus23Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PendingCancellation : ProcessingStatus23Choice_
    #else
    public partial class PendingCancellation : ProcessingStatus23Choice_
    #endif
    {
