...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventStage3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventStage3Choice_
    #else
    public partial class Proprietary : CorporateActionEventStage3Choice_
    #endif
    {
