...
namespace BeneficialStrategies.Iso20022.Choices.ReservationStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_8JAUF6MgEeCJ6YNENx4h-w_493911419")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ReservationStatus1Choice_
    #else
    public partial class Proprietary : ReservationStatus1Choice_
    #endif
    {
