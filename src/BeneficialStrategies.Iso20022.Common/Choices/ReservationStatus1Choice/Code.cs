...
namespace BeneficialStrategies.Iso20022.Choices.ReservationStatus1Choice
{
    ...
    #else
    public partial class Code : ReservationStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ReservationStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ReservationStatus1Code Value { get; init; } 
        #else
        public ReservationStatus1Code Value { get; set; } 
        #endif
