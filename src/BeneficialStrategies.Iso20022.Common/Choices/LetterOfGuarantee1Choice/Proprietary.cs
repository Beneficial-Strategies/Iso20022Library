...
namespace BeneficialStrategies.Iso20022.Choices.LetterOfGuarantee1Choice
{
    ...
    /// </summary>
    [IsoId("_Qvaoxtp-Ed-ak6NoX_4Aeg_3419780")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : LetterOfGuarantee1Choice_
    #else
    public partial class Proprietary : LetterOfGuarantee1Choice_
    #endif
    {
