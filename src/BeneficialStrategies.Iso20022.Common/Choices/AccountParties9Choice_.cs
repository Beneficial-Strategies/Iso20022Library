...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountParties9Choice.PrimaryOwner),
        nameof(AccountParties9Choice.PrimaryOwner)
    )]
    ...
    [JsonDerivedType(
        typeof(AccountParties9Choice.JointOwner),
        nameof(AccountParties9Choice.JointOwner)
    )]
    [IsoId("_PD3vCSCBEeWhHbfCMWc1cw")]
    [DisplayName("Account Parties 9 Choice")]
    public abstract record AccountParties9Choice_ { }
}
