...
namespace BeneficialStrategies.Iso20022.Choices.OfferTypeFormat13Choice
{
    ...
    #else
    public partial class Code : OfferTypeFormat13Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OfferType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OfferType4Code Value { get; init; } 
        #else
        public OfferType4Code Value { get; set; } 
        #endif
