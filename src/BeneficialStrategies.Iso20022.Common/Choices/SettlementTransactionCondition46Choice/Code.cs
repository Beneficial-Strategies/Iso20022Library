...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition46Choice
{
    ...
    [IsoId("_mnUdpfHVEfChCaiL9q1LKg")]
    [DisplayName("Code")]
    public record Code : SettlementTransactionCondition46Choice_
    {
        /// <summary>Contains the main value for the container.</summary>
        [IsoXmlTag("Cd")]
        public required SettlementTransactionCondition22Code Value { get; init; }
    }
}
