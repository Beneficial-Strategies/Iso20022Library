...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Recipient11Choice.KeyTransport),
        nameof(Recipient11Choice.KeyTransport)
    )]
    [JsonDerivedType(typeof(Recipient11Choice.KEK), nameof(Recipient11Choice.KEK))]
    [JsonDerivedType(
        typeof(Recipient11Choice.KeyIdentifier),
        nameof(Recipient11Choice.KeyIdentifier)
    )]
    [IsoId("_6nK84VE0EeyApZmLzm74zA")]
    [DisplayName("Recipient 11 Choice")]
    public abstract record Recipient11Choice_ { }
}
