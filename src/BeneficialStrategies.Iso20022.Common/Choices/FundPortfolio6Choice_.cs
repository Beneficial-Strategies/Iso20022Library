...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(FundPortfolio6Choice.TaxEfficientProduct),
        nameof(FundPortfolio6Choice.TaxEfficientProduct)
    )]
    [JsonDerivedType(
        typeof(FundPortfolio6Choice.GeneralInvestment),
        nameof(FundPortfolio6Choice.GeneralInvestment)
    )]
    ...
    public abstract record FundPortfolio6Choice_ { }
}
