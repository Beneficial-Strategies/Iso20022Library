...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationType45Choice
{
    ...
    #else
    public partial class Code : IdentificationType45Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TypeOfIdentification4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TypeOfIdentification4Code Value { get; init; } 
        #else
        public TypeOfIdentification4Code Value { get; set; } 
        #endif
