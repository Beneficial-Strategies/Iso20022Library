...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Recipient15Choice.KeyIdentifier),
        nameof(Recipient15Choice.KeyIdentifier)
    )]
    [JsonDerivedType(
        typeof(Recipient15Choice.KeyTransport),
        nameof(Recipient15Choice.KeyTransport)
    )]
    [IsoId("_bTfzcY-QEe6oobnCtR50kw")]
    [DisplayName("Recipient15Choice")]
    public abstract record Recipient15Choice_ { }
}
