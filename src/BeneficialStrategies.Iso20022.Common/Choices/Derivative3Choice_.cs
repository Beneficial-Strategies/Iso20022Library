...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Derivative3Choice.InterestRate),
        nameof(Derivative3Choice.InterestRate)
    )]
    [JsonDerivedType(
        typeof(Derivative3Choice.ForeignExchange),
        nameof(Derivative3Choice.ForeignExchange)
    )]
    [JsonDerivedType(typeof(Derivative3Choice.Equity), nameof(Derivative3Choice.Equity))]
    [JsonDerivedType(
        typeof(Derivative3Choice.ContractForDifference),
        nameof(Derivative3Choice.ContractForDifference)
    )]
    [JsonDerivedType(typeof(Derivative3Choice.Credit), nameof(Derivative3Choice.Credit))]
    [JsonDerivedType(
        typeof(Derivative3Choice.EmissionAllowance),
        nameof(Derivative3Choice.EmissionAllowance)
    )]
    [IsoId("_w9mvYSe0Eei12pGEsJIAeQ")]
    [DisplayName("Derivative 3 Choice")]
    public abstract record Derivative3Choice_ { }
}
