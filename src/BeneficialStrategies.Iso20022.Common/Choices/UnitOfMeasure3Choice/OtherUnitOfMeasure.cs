...
namespace BeneficialStrategies.Iso20022.Choices.UnitOfMeasure3Choice
{
    ...
    #else
    public partial class OtherUnitOfMeasure : UnitOfMeasure3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a OtherUnitOfMeasure instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public OtherUnitOfMeasure( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
