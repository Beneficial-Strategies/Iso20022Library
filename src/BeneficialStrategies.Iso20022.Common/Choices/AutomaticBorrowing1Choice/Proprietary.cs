...
namespace BeneficialStrategies.Iso20022.Choices.AutomaticBorrowing1Choice
{
    ...
    /// </summary>
    [IsoId("_Qt7bB9p-Ed-ak6NoX_4Aeg_-2056259969")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AutomaticBorrowing1Choice_
    #else
    public partial class Proprietary : AutomaticBorrowing1Choice_
    #endif
    {
