...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Nominee : AccountParties5Choice_
    #else
    public partial class Nominee : AccountParties5Choice_
    #endif
    {
        ...
        /// </summary>
        public Nominee( Party23Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
