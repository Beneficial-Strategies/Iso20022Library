...
namespace BeneficialStrategies.Iso20022.Choices.Amount1Choice
{
    ...
    #else
    public partial class IncreaseAmount : Amount1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a IncreaseAmount instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public IncreaseAmount( System.String reqCurrency,System.Decimal reqAmount )
        {
