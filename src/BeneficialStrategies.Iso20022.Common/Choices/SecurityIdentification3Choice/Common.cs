...
namespace BeneficialStrategies.Iso20022.Choices.SecurityIdentification3Choice
{
    ...
    /// </summary>
    [IsoId("_Qd1wlNp-Ed-ak6NoX_4Aeg_1064399423")]
    [DisplayName("Common")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Common : SecurityIdentification3Choice_
    #else
    public partial class Common : SecurityIdentification3Choice_
    #endif
    {
