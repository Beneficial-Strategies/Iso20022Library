...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : CancellationStatus9Choice_
    #else
    public partial class NoSpecifiedReason : CancellationStatus9Choice_
    #endif
    {
