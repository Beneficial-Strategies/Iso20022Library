...
namespace BeneficialStrategies.Iso20022.Choices.SourceOfCash1Choice
{
    ...
    #else
    public partial class Code : SourceOfCash1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SourceOfCash1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SourceOfCash1Code Value { get; init; } 
        #else
        public SourceOfCash1Code Value { get; set; } 
        #endif
