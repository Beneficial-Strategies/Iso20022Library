...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason16Choice_
    #else
    public partial class Proprietary : AcknowledgementReason16Choice_
    #endif
    {
