...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventProcessingStatus3Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventProcessingStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventProcessingStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventProcessingStatus1Code Value { get; init; } 
        #else
        public CorporateActionEventProcessingStatus1Code Value { get; set; } 
        #endif
