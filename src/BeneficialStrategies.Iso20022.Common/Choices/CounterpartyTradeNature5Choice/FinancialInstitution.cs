...
namespace BeneficialStrategies.Iso20022.Choices.CounterpartyTradeNature5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record FinancialInstitution : CounterpartyTradeNature5Choice_
    #else
    public partial class FinancialInstitution : CounterpartyTradeNature5Choice_
    #endif
    {
