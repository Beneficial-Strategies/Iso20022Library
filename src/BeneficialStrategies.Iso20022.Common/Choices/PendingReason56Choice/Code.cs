...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason56Choice
{
    ...
    #else
    public partial class Code : PendingReason56Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingReason18Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingReason18Code Value { get; init; } 
        #else
        public PendingReason18Code Value { get; set; } 
        #endif
