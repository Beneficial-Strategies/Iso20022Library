...
namespace BeneficialStrategies.Iso20022.Choices.SafekeepingPlaceFormat2Choice
{
    ...
    /// </summary>
    [IsoId("_SfeRINp-Ed-ak6NoX_4Aeg_1792908647")]
    [DisplayName("Country")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Country : SafekeepingPlaceFormat2Choice_
    #else
    public partial class Country : SafekeepingPlaceFormat2Choice_
    #endif
    {
