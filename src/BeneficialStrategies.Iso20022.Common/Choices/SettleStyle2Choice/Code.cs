...
namespace BeneficialStrategies.Iso20022.Choices.SettleStyle2Choice
{
    ...
    #else
    public partial class Code : SettleStyle2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettleStyle1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SettleStyle1Code Value { get; init; } 
        #else
        public SettleStyle1Code Value { get; set; } 
        #endif
