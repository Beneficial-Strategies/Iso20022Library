...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CancellationReason20Choice.Code),
        nameof(CancellationReason20Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CancellationReason20Choice.Proprietary),
        nameof(CancellationReason20Choice.Proprietary)
    )]
    [IsoId("_Wk3goTqrEeWyoP0PbocV1Q")]
    [DisplayName("Cancellation Reason 20 Choice")]
    public abstract record CancellationReason20Choice_ { }
}
