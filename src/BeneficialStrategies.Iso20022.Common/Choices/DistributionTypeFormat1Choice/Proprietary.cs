...
namespace BeneficialStrategies.Iso20022.Choices.DistributionTypeFormat1Choice
{
    ...
    /// </summary>
    [IsoId("_Q3nih9p-Ed-ak6NoX_4Aeg_2019414521")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : DistributionTypeFormat1Choice_
    #else
    public partial class Proprietary : DistributionTypeFormat1Choice_
    #endif
    {
