...
namespace BeneficialStrategies.Iso20022.Choices.DividendTypeFormat10Choice
{
    ...
    #else
    public partial class Code : DividendTypeFormat10Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionFrequencyType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionFrequencyType5Code Value { get; init; } 
        #else
        public CorporateActionFrequencyType5Code Value { get; set; } 
        #endif
