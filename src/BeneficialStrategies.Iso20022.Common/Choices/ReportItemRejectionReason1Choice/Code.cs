...
namespace BeneficialStrategies.Iso20022.Choices.ReportItemRejectionReason1Choice
{
    ...
    #else
    public partial class Code : ReportItemRejectionReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( HoldingRejectionReason41Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public HoldingRejectionReason41Code Value { get; set; } 
        #endif
