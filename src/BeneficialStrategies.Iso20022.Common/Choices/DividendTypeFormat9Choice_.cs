...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(DividendTypeFormat9Choice.Code),
        nameof(DividendTypeFormat9Choice.Code)
    )]
    [JsonDerivedType(
        typeof(DividendTypeFormat9Choice.Proprietary),
        nameof(DividendTypeFormat9Choice.Proprietary)
    )]
    [IsoId("_x36OMUEFEeWVgfuHGaKtRQ")]
    [DisplayName("Dividend Type Format 9 Choice")]
    public abstract record DividendTypeFormat9Choice_ { }
}
