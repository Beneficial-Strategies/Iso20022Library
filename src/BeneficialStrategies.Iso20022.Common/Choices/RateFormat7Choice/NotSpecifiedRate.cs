...
namespace BeneficialStrategies.Iso20022.Choices.RateFormat7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RateFormat7Choice_
    #else
    public partial class NotSpecifiedRate : RateFormat7Choice_
    #endif
    {
        ...
        /// </summary>
        public NotSpecifiedRate( RateType10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public RateType10Code Value { get; set; } 
        #endif
