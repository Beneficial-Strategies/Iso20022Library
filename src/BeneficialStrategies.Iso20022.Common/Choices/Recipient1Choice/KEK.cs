...
namespace BeneficialStrategies.Iso20022.Choices.Recipient1Choice
{
    ...
    #else
    public partial class KEK : Recipient1Choice_
    #endif
    {
        ...
        /// </summary>
        public KEK( KEKIdentifier1 reqKEKIdentification,AlgorithmIdentification1 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
        {
