...
namespace BeneficialStrategies.Iso20022.Choices.CollateralAccountIdentificationType3Choice
{
    ...
    #else
    public partial class Type : CollateralAccountIdentificationType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Type( CollateralAccountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CollateralAccountType1Code Value { get; init; } 
        #else
        public CollateralAccountType1Code Value { get; set; } 
        #endif
