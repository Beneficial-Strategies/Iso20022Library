...
namespace BeneficialStrategies.Iso20022.Choices.PersonIdentificationSchemeName1Choice
{
    ...
    /// </summary>
    [IsoId("_P_4pRNp-Ed-ak6NoX_4Aeg_2056543161")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : PersonIdentificationSchemeName1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalPersonIdentification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalPersonIdentification1Code Value { get; init; } 
        #else
        public ExternalPersonIdentification1Code Value { get; set; } 
        #endif
