...
namespace BeneficialStrategies.Iso20022.Choices.RestrictionStatus1Choice
{
    ...
    #else
    public partial class Code : RestrictionStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RestrictionStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RestrictionStatus1Code Value { get; init; } 
        #else
        public RestrictionStatus1Code Value { get; set; } 
        #endif
