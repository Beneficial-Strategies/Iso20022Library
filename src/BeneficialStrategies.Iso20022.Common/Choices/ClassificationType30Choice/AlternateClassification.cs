...
namespace BeneficialStrategies.Iso20022.Choices.ClassificationType30Choice
{
    ...
    /// </summary>
    [IsoId("_AbpPpNokEeC60axPepSq7g_-739644230")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AlternateClassification : ClassificationType30Choice_
    #else
    public partial class AlternateClassification : ClassificationType30Choice_
    #endif
    {
