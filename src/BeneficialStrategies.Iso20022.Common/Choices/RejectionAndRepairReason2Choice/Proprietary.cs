...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason2Choice
{
    ...
    /// </summary>
    [IsoId("_UWrqZNp-Ed-ak6NoX_4Aeg_1851323792")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason2Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason2Choice_
    #endif
    {
