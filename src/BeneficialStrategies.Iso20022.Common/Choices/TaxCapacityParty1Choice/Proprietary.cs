...
namespace BeneficialStrategies.Iso20022.Choices.TaxCapacityParty1Choice
{
    ...
    /// </summary>
    [IsoId("_Qv3Uttp-Ed-ak6NoX_4Aeg_1224481840")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TaxCapacityParty1Choice_
    #else
    public partial class Proprietary : TaxCapacityParty1Choice_
    #endif
    {
