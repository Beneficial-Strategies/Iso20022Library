...
namespace BeneficialStrategies.Iso20022.Choices.RegistrationProcessingStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UYUpI9p-Ed-ak6NoX_4Aeg_170456913")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RegistrationProcessingStatus1Choice_
    #else
    public partial class Proprietary : RegistrationProcessingStatus1Choice_
    #endif
    {
