...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Derivative2Choice.InterestRate),
        nameof(Derivative2Choice.InterestRate)
    )]
    [JsonDerivedType(
        typeof(Derivative2Choice.ForeignExchange),
        nameof(Derivative2Choice.ForeignExchange)
    )]
    [JsonDerivedType(typeof(Derivative2Choice.Equity), nameof(Derivative2Choice.Equity))]
    [JsonDerivedType(
        typeof(Derivative2Choice.ContractForDifference),
        nameof(Derivative2Choice.ContractForDifference)
    )]
    [JsonDerivedType(typeof(Derivative2Choice.Credit), nameof(Derivative2Choice.Credit))]
    [JsonDerivedType(
        typeof(Derivative2Choice.EmissionAllowance),
        nameof(Derivative2Choice.EmissionAllowance)
    )]
    [IsoId("_BmdSAWkwEeaLAKoEUNsD9g")]
    [DisplayName("Derivative 2 Choice")]
    public abstract record Derivative2Choice_ { }
}
