...
namespace BeneficialStrategies.Iso20022.Choices.CentralCounterPartyEligibility5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CentralCounterPartyEligibility5Choice_
    #else
    public partial class Proprietary : CentralCounterPartyEligibility5Choice_
    #endif
    {
