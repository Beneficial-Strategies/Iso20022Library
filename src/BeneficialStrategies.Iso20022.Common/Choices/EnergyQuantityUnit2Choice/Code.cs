...
namespace BeneficialStrategies.Iso20022.Choices.EnergyQuantityUnit2Choice
{
    ...
    #else
    public partial class Code : EnergyQuantityUnit2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( EnergyQuantityUnit2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public EnergyQuantityUnit2Code Value { get; init; } 
        #else
        public EnergyQuantityUnit2Code Value { get; set; } 
        #endif
