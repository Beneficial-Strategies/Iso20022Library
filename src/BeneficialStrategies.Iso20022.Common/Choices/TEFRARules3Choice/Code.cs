...
namespace BeneficialStrategies.Iso20022.Choices.TEFRARules3Choice
{
    ...
    #else
    public partial class Code : TEFRARules3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TEFRARules1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TEFRARules1Code Value { get; init; } 
        #else
        public TEFRARules1Code Value { get; set; } 
        #endif
