...
namespace BeneficialStrategies.Iso20022.Choices.Reversible1Choice
{
    ...
    #else
    public partial class Code : Reversible1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Reversible1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Reversible1Code Value { get; init; } 
        #else
        public Reversible1Code Value { get; set; } 
        #endif
