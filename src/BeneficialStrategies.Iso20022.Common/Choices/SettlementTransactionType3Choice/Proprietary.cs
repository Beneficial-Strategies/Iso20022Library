...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionType3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementTransactionType3Choice_
    #else
    public partial class Proprietary : SettlementTransactionType3Choice_
    #endif
    {
