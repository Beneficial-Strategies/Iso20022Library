...
namespace BeneficialStrategies.Iso20022.Choices.CurrentYearType2Choice
{
    ...
    #else
    public partial class CurrentYearType : CurrentYearType2Choice_
    #endif
    {
        ...
        /// </summary>
        public CurrentYearType( ISAType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ISAType2Code Value { get; init; } 
        #else
        public ISAType2Code Value { get; set; } 
        #endif
