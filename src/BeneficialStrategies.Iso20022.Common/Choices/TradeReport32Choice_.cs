...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TradeReport32Choice.Modification),
        nameof(TradeReport32Choice.Modification)
    )]
    [JsonDerivedType(
        typeof(TradeReport32Choice.Correction),
        nameof(TradeReport32Choice.Correction)
    )]
    [JsonDerivedType(
        typeof(TradeReport32Choice.Termination),
        nameof(TradeReport32Choice.Termination)
    )]
    [JsonDerivedType(
        typeof(TradeReport32Choice.PositionComponent),
        nameof(TradeReport32Choice.PositionComponent)
    )]
    [JsonDerivedType(
        typeof(TradeReport32Choice.ValuationUpdate),
        nameof(TradeReport32Choice.ValuationUpdate)
    )]
    [JsonDerivedType(
        typeof(TradeReport32Choice.Compression),
        nameof(TradeReport32Choice.Compression)
    )]
    ...
    public abstract record TradeReport32Choice_ { }
}
