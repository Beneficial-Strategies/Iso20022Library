...
namespace BeneficialStrategies.Iso20022.Choices.StatusReason5Choice
{
    ...
    #else
    public partial class Code : StatusReason5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TransactionRejectReason7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TransactionRejectReason7Code Value { get; init; } 
        #else
        public TransactionRejectReason7Code Value { get; set; } 
        #endif
