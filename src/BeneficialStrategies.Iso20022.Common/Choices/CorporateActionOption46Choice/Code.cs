...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption46Choice
{
    ...
    #else
    public partial class Code : CorporateActionOption46Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOption15Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOption15Code Value { get; init; } 
        #else
        public CorporateActionOption15Code Value { get; set; } 
        #endif
