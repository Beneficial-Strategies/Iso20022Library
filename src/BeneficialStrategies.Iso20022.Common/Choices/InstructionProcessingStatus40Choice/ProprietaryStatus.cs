...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus40Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : InstructionProcessingStatus40Choice_
    #else
    public partial class ProprietaryStatus : InstructionProcessingStatus40Choice_
    #endif
    {
