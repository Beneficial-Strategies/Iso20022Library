...
namespace BeneficialStrategies.Iso20022.Choices.UndertakingType1Choice
{
    ...
    #else
    public partial class Code : UndertakingType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalUndertakingType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalUndertakingType1Code Value { get; init; } 
        #else
        public ExternalUndertakingType1Code Value { get; set; } 
        #endif
