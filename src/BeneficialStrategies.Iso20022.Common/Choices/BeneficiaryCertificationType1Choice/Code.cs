...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType1Choice
{
    ...
    #else
    public partial class Code : BeneficiaryCertificationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( BeneficiaryCertificationType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public BeneficiaryCertificationType2Code Value { get; init; } 
        #else
        public BeneficiaryCertificationType2Code Value { get; set; } 
        #endif
