...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType1Choice
{
    ...
    /// </summary>
    [IsoId("_Q0CqF9p-Ed-ak6NoX_4Aeg_274210631")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficiaryCertificationType1Choice_
    #else
    public partial class Proprietary : BeneficiaryCertificationType1Choice_
    #endif
    {
