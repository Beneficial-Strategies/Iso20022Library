...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity46Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Unit : FinancialInstrumentQuantity46Choice_
    #else
    public partial class Unit : FinancialInstrumentQuantity46Choice_
    #endif
    {
