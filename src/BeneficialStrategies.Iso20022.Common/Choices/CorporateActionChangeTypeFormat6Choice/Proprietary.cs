...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionChangeTypeFormat6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionChangeTypeFormat6Choice_
    #else
    public partial class Proprietary : CorporateActionChangeTypeFormat6Choice_
    #endif
    {
