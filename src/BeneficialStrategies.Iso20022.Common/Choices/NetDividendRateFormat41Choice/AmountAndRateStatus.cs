...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat41Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountAndRateStatus : NetDividendRateFormat41Choice_
    #else
    public partial class AmountAndRateStatus : NetDividendRateFormat41Choice_
    #endif
    {
