...
namespace BeneficialStrategies.Iso20022.Choices.SecurityOrOperationalError4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : SecurityOrOperationalError4Choice_
    #else
    public partial class OperationalError : SecurityOrOperationalError4Choice_
    #endif
    {
