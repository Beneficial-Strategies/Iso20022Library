...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType11Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType11Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType9Code Value { get; init; } 
        #else
        public SecuritiesTransactionType9Code Value { get; set; } 
        #endif
