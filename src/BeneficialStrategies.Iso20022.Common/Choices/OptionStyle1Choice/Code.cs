...
namespace BeneficialStrategies.Iso20022.Choices.OptionStyle1Choice
{
    ...
    #else
    public partial class Code : OptionStyle1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionStyle1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionStyle1Code Value { get; init; } 
        #else
        public OptionStyle1Code Value { get; set; } 
        #endif
