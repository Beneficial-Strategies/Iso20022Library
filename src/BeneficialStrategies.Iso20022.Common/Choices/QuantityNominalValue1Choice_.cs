...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(QuantityNominalValue1Choice.Quantity),
        nameof(QuantityNominalValue1Choice.Quantity)
    )]
    [JsonDerivedType(
        typeof(QuantityNominalValue1Choice.NominalValue),
        nameof(QuantityNominalValue1Choice.NominalValue)
    )]
    [IsoId("_kXBi4HaiEeavseMKyTsJEA")]
    [DisplayName("Quantity Nominal Value 1 Choice")]
    public abstract record QuantityNominalValue1Choice_ { }
}
