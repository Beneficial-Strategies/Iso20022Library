...
namespace BeneficialStrategies.Iso20022.Choices.CommissionType2Choice
{
    ...
    /// </summary>
    [IsoId("_Ac_TdNokEeC60axPepSq7g_220675124")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CommissionType2Choice_
    #else
    public partial class Proprietary : CommissionType2Choice_
    #endif
    {
