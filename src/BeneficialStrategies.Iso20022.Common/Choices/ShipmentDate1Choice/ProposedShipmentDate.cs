...
namespace BeneficialStrategies.Iso20022.Choices.ShipmentDate1Choice
{
    ...
    #else
    public partial class ProposedShipmentDate : ShipmentDate1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ProposedShipmentDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ProposedShipmentDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
