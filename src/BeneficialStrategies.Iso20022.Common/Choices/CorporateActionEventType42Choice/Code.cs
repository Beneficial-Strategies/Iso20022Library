...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType42Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType42Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType18Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType18Code Value { get; init; } 
        #else
        public CorporateActionEventType18Code Value { get; set; } 
        #endif
