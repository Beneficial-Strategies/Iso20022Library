...
namespace BeneficialStrategies.Iso20022.Choices.RequestType3Choice
{
    ...
    #else
    public partial class Code : RequestType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( StandingOrderQueryType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public StandingOrderQueryType1Code Value { get; init; } 
        #else
        public StandingOrderQueryType1Code Value { get; set; } 
        #endif
