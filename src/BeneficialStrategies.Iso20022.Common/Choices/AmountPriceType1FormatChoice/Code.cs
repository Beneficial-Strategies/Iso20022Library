...
namespace BeneficialStrategies.Iso20022.Choices.AmountPriceType1FormatChoice
{
    ...
    #else
    public partial class Code : AmountPriceType1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( AmountPriceType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AmountPriceType1Code Value { get; init; } 
        #else
        public AmountPriceType1Code Value { get; set; } 
        #endif
