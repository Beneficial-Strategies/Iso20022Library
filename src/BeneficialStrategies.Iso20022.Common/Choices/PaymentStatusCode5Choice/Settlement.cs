...
namespace BeneficialStrategies.Iso20022.Choices.PaymentStatusCode5Choice
{
    ...
    /// </summary>
    [IsoId("_72FYFqMgEeCJ6YNENx4h-w_-2109500893")]
    ...
    #else
    public partial class Settlement : PaymentStatusCode5Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Settlement instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Settlement( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
