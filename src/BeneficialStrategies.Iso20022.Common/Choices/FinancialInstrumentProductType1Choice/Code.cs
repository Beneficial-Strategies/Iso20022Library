...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentProductType1Choice
{
    ...
    #else
    public partial class Code : FinancialInstrumentProductType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProductType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProductType1Code Value { get; init; } 
        #else
        public ProductType1Code Value { get; set; } 
        #endif
