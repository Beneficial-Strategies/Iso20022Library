...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason2Choice
{
    ...
    /// </summary>
    [IsoId("_UXuzRtp-Ed-ak6NoX_4Aeg_2050242040")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason2Choice_
    #else
    public partial class Proprietary : AcknowledgementReason2Choice_
    #endif
    {
