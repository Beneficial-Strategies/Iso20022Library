...
namespace BeneficialStrategies.Iso20022.Choices.ProcessedStatus2FormatChoice
{
    ...
    /// </summary>
    [IsoId("_RnTTANp-Ed-ak6NoX_4Aeg_1809629766")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessedStatus2FormatChoice_
    #else
    public partial class Proprietary : ProcessedStatus2FormatChoice_
    #endif
    {
