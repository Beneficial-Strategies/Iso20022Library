...
namespace BeneficialStrategies.Iso20022.Choices.CollateralProposalResponse2Choice
{
    ...
    #else
    public partial class CollateralProposal : CollateralProposalResponse2Choice_
    #endif
    {
        ...
        /// </summary>
        public CollateralProposal( CollateralProposalResponseType2 reqVariationMargin )
        {
