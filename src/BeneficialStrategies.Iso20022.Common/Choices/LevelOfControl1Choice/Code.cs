...
namespace BeneficialStrategies.Iso20022.Choices.LevelOfControl1Choice
{
    ...
    #else
    public partial class Code : LevelOfControl1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( LevelOfControl1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public LevelOfControl1Code Value { get; init; } 
        #else
        public LevelOfControl1Code Value { get; set; } 
        #endif
