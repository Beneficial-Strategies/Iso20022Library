...
namespace BeneficialStrategies.Iso20022.Choices.InvestorCapacity3Choice
{
    ...
    /// </summary>
    [IsoId("_AeB1Q9okEeC60axPepSq7g_-124737448")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InvestorCapacity3Choice_
    #else
    public partial class Proprietary : InvestorCapacity3Choice_
    #endif
    {
