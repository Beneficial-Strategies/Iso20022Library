...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType7Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType8Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType8Code Value { get; init; } 
        #else
        public CorporateActionEventType8Code Value { get; set; } 
        #endif
