...
namespace BeneficialStrategies.Iso20022.Choices.Quantity57Choice
{
    ...
    #else
    public partial class SignedQuantity : Quantity57Choice_
    #endif
    {
        ...
        /// </summary>
        public SignedQuantity( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity36Choice_ reqQuantity )
        {
