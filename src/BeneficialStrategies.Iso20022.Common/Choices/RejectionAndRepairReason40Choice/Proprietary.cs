...
namespace BeneficialStrategies.Iso20022.Choices.RejectionAndRepairReason40Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RejectionAndRepairReason40Choice_
    #else
    public partial class Proprietary : RejectionAndRepairReason40Choice_
    #endif
    {
