...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason31Choice
{
    ...
    #else
    public partial class Code : CancellationReason31Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ConfirmationCancellationReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public ConfirmationCancellationReason1Code Value { get; set; } 
        #endif
