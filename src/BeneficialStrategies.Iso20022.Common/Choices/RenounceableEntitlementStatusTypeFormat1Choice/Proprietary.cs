...
namespace BeneficialStrategies.Iso20022.Choices.RenounceableEntitlementStatusTypeFormat1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RenounceableEntitlementStatusTypeFormat1Choice_
    #else
    public partial class Proprietary : RenounceableEntitlementStatusTypeFormat1Choice_
    #endif
    {
