...
namespace BeneficialStrategies.Iso20022.Choices.LumpSumType1Choice
{
    ...
    #else
    public partial class Code : LumpSumType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( LumpSumType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public LumpSumType1Code Value { get; init; } 
        #else
        public LumpSumType1Code Value { get; set; } 
        #endif
