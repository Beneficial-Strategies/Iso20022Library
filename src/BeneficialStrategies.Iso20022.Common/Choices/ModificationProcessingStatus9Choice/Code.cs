...
namespace BeneficialStrategies.Iso20022.Choices.ModificationProcessingStatus9Choice
{
    ...
    #else
    public partial class Code : ModificationProcessingStatus9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ModificationProcessingStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ModificationProcessingStatus1Code Value { get; init; } 
        #else
        public ModificationProcessingStatus1Code Value { get; set; } 
        #endif
