...
namespace BeneficialStrategies.Iso20022.Choices.LegIdentification1Choice
{
    ...
    #else
    public partial class RedemptionLegIdentification : LegIdentification1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RedemptionLegIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RedemptionLegIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
