...
namespace BeneficialStrategies.Iso20022.Choices.ConditionallyAcceptedStatusReason1Choice
{
    ...
    /// </summary>
    [IsoId("_RgmOE9p-Ed-ak6NoX_4Aeg_63608102")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : ConditionallyAcceptedStatusReason1Choice_
    #else
    public partial class NoSpecifiedReason : ConditionallyAcceptedStatusReason1Choice_
    #endif
    {
