...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption29Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption29Choice_
    #else
    public partial class Proprietary : CorporateActionOption29Choice_
    #endif
    {
