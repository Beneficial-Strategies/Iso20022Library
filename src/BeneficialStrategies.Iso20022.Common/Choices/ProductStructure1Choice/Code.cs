...
namespace BeneficialStrategies.Iso20022.Choices.ProductStructure1Choice
{
    ...
    #else
    public partial class Code : ProductStructure1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ProductStructure1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ProductStructure1Code Value { get; init; } 
        #else
        public ProductStructure1Code Value { get; set; } 
        #endif
