...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OptionFeaturesFormat2Choice.Code),
        nameof(OptionFeaturesFormat2Choice.Code)
    )]
    [JsonDerivedType(
        typeof(OptionFeaturesFormat2Choice.Proprietary),
        nameof(OptionFeaturesFormat2Choice.Proprietary)
    )]
    [IsoId("_Q0L0Bdp-Ed-ak6NoX_4Aeg_-1816334318")]
    [DisplayName("Option Features Format 2 Choice")]
    public abstract record OptionFeaturesFormat2Choice_ { }
}
