...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat49Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountPricePerFinancialInstrumentQuantity : PriceFormat49Choice_
    #else
    public partial class AmountPricePerFinancialInstrumentQuantity : PriceFormat49Choice_
    #endif
    {
