...
namespace BeneficialStrategies.Iso20022.Choices.AssetClassCommodityEnergy1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record InterEnergy : AssetClassCommodityEnergy1Choice_
    #else
    public partial class InterEnergy : AssetClassCommodityEnergy1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a InterEnergy instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public InterEnergy( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType26Code reqSubProduct )
        {
