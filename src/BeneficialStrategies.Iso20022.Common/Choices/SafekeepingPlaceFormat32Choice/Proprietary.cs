...
namespace BeneficialStrategies.Iso20022.Choices.SafekeepingPlaceFormat32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SafekeepingPlaceFormat32Choice_
    #else
    public partial class Proprietary : SafekeepingPlaceFormat32Choice_
    #endif
    {
