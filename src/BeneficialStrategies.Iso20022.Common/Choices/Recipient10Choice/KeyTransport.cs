...
namespace BeneficialStrategies.Iso20022.Choices.Recipient10Choice
{
    ...
    #else
    public partial class KeyTransport : Recipient10Choice_
    #endif
    {
        ...
        /// </summary>
        public KeyTransport( Recipient9Choice_ reqRecipientIdentification,AlgorithmIdentification19 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
        {
