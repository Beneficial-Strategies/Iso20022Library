...
namespace BeneficialStrategies.Iso20022.Choices.CancellationProcessingStatus7Choice
{
    ...
    #else
    public partial class Code : CancellationProcessingStatus7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancellationProcessingStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancellationProcessingStatus1Code Value { get; init; } 
        #else
        public CancellationProcessingStatus1Code Value { get; set; } 
        #endif
