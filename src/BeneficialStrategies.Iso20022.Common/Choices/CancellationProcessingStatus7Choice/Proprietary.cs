...
namespace BeneficialStrategies.Iso20022.Choices.CancellationProcessingStatus7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationProcessingStatus7Choice_
    #else
    public partial class Proprietary : CancellationProcessingStatus7Choice_
    #endif
    {
