...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CertificationTypeFormat3Choice.Code),
        nameof(CertificationTypeFormat3Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CertificationTypeFormat3Choice.Proprietary),
        nameof(CertificationTypeFormat3Choice.Proprietary)
    )]
    [IsoId("_bZ7v0UEGEeWVgfuHGaKtRQ")]
    [DisplayName("Certification Type Format 3 Choice")]
    public abstract record CertificationTypeFormat3Choice_ { }
}
