...
namespace BeneficialStrategies.Iso20022.Choices.SecurityIdentification1Choice
{
    ...
    /// </summary>
    [IsoId("_Vb-ekdp-Ed-ak6NoX_4Aeg_-1748201316")]
    [DisplayName("ISIN")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ISIN : SecurityIdentification1Choice_
    #else
    public partial class ISIN : SecurityIdentification1Choice_
    #endif
    {
