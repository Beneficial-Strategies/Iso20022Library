...
namespace BeneficialStrategies.Iso20022.Choices.AwaitingAffirmationReason1Choice
{
    ...
    /// </summary>
    [IsoId("_A6MM0tokEeC60axPepSq7g_1828180950")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AwaitingAffirmationReason1Choice_
    #else
    public partial class Proprietary : AwaitingAffirmationReason1Choice_
    #endif
    {
