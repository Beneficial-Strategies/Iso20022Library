...
namespace BeneficialStrategies.Iso20022.Choices.SecuredMarketReport3Choice
{
    ...
    #else
    public partial class Transaction : SecuredMarketReport3Choice_
    #endif
    {
