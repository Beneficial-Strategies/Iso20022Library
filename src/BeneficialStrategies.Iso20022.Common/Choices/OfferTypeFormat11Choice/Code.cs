...
namespace BeneficialStrategies.Iso20022.Choices.OfferTypeFormat11Choice
{
    ...
    #else
    public partial class Code : OfferTypeFormat11Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OfferType3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OfferType3Code Value { get; init; } 
        #else
        public OfferType3Code Value { get; set; } 
        #endif
