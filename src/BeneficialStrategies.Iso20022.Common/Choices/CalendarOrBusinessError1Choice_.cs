...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CalendarOrBusinessError1Choice.CalendarData),
        nameof(CalendarOrBusinessError1Choice.CalendarData)
    )]
    [JsonDerivedType(
        typeof(CalendarOrBusinessError1Choice.BusinessError),
        nameof(CalendarOrBusinessError1Choice.BusinessError)
    )]
    [IsoId("_dVcQ2Im7Eeipw6hHPgB4Sw")]
    [DisplayName("Calendar Or Business Error 1 Choice")]
    public abstract record CalendarOrBusinessError1Choice_ { }
}
