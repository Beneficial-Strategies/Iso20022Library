...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementDateCode8Choice.Code),
        nameof(SettlementDateCode8Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementDateCode8Choice.Proprietary),
        nameof(SettlementDateCode8Choice.Proprietary)
    )]
    [IsoId("_4U7hpztKEeWRTLSN0i0tng")]
    [DisplayName("Settlement Date Code 8 Choice")]
    public abstract record SettlementDateCode8Choice_ { }
}
