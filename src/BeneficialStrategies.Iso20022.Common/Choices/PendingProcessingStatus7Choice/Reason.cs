...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingProcessingStatus7Choice_
    #else
    public partial class Reason : PendingProcessingStatus7Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingProcessingReason5Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
