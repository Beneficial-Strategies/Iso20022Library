...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstitutionIdentification3Choice
{
    ...
    /// </summary>
    [IsoId("_QE8vcdp-Ed-ak6NoX_4Aeg_2089460192")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : FinancialInstitutionIdentification3Choice_
    #else
    public partial class NameAndAddress : FinancialInstitutionIdentification3Choice_
    #endif
    {
