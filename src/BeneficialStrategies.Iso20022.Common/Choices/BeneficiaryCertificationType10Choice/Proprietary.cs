...
namespace BeneficialStrategies.Iso20022.Choices.BeneficiaryCertificationType10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BeneficiaryCertificationType10Choice_
    #else
    public partial class Proprietary : BeneficiaryCertificationType10Choice_
    #endif
    {
