...
namespace BeneficialStrategies.Iso20022.Choices.CashAvailabilityDate1Choice
{
    ...
    #else
    public partial class ActualDate : CashAvailabilityDate1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ActualDate instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ActualDate( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
