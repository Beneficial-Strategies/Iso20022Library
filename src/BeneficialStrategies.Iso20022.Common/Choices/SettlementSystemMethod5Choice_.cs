...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(SettlementSystemMethod5Choice.Code),
        nameof(SettlementSystemMethod5Choice.Code)
    )]
    [JsonDerivedType(
        typeof(SettlementSystemMethod5Choice.Proprietary),
        nameof(SettlementSystemMethod5Choice.Proprietary)
    )]
    [IsoId("_5TKlQ5NLEeWGlc8L7oPDIg")]
    [DisplayName("Settlement System Method 5 Choice")]
    public abstract record SettlementSystemMethod5Choice_ { }
}
