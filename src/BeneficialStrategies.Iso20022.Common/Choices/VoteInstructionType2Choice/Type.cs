...
namespace BeneficialStrategies.Iso20022.Choices.VoteInstructionType2Choice
{
    ...
    #else
    public partial class Type : VoteInstructionType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Type( VoteInstruction7Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public VoteInstruction7Code Value { get; init; } 
        #else
        public VoteInstruction7Code Value { get; set; } 
        #endif
