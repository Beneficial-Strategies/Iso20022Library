...
namespace BeneficialStrategies.Iso20022.Choices.SystemStatus3Choice
{
    ...
    #else
    public partial class Code : SystemStatus3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SystemStatus3Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SystemStatus3Code Value { get; init; } 
        #else
        public SystemStatus3Code Value { get; set; } 
        #endif
