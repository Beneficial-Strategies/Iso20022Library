...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason3Choice
{
    ...
    /// </summary>
    [IsoId("_UXb4Utp-Ed-ak6NoX_4Aeg_-1471943891")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason3Choice_
    #else
    public partial class Proprietary : AcknowledgementReason3Choice_
    #endif
    {
