...
namespace BeneficialStrategies.Iso20022.Choices.EnergyQuantityUnit1Choice
{
    ...
    #else
    public partial class Code : EnergyQuantityUnit1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( EnergyQuantityUnit1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public EnergyQuantityUnit1Code Value { get; init; } 
        #else
        public EnergyQuantityUnit1Code Value { get; set; } 
        #endif
