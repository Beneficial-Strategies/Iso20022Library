...
namespace BeneficialStrategies.Iso20022.Choices.References45Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionIdentification : References45Choice_
    #else
    public partial class SecuritiesSettlementTransactionIdentification : References45Choice_
    #endif
    {
