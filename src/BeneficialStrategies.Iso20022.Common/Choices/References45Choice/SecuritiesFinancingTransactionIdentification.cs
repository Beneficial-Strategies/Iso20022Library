...
namespace BeneficialStrategies.Iso20022.Choices.References45Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesFinancingTransactionIdentification : References45Choice_
    #else
    public partial class SecuritiesFinancingTransactionIdentification : References45Choice_
    #endif
    {
