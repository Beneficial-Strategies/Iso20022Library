...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification33Choice
{
    ...
    /// </summary>
    [IsoId("_QPrYwNp-Ed-ak6NoX_4Aeg_1732722906")]
    [DisplayName("Any BIC")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AnyBIC : PartyIdentification33Choice_
    #else
    public partial class AnyBIC : PartyIdentification33Choice_
    #endif
    {
