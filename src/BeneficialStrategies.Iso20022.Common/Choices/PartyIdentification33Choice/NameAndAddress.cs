...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification33Choice
{
    ...
    /// </summary>
    [IsoId("_QPrYwtp-Ed-ak6NoX_4Aeg_672026909")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification33Choice_
    #else
    public partial class NameAndAddress : PartyIdentification33Choice_
    #endif
    {
