...
namespace BeneficialStrategies.Iso20022.Choices.SystemEventType1Choice
{
    ...
    /// </summary>
    [IsoId("_RD_Kk9p-Ed-ak6NoX_4Aeg_553100137")]
    ...
    #else
    public partial class ProprietaryEvent : SystemEventType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ProprietaryEvent instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ProprietaryEvent( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
