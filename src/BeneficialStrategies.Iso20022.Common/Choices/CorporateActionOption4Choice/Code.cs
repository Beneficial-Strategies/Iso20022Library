...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption4Choice
{
    ...
    #else
    public partial class Code : CorporateActionOption4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOption4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOption4Code Value { get; init; } 
        #else
        public CorporateActionOption4Code Value { get; set; } 
        #endif
