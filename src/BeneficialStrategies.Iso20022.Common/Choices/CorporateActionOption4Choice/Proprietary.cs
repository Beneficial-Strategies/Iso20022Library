...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption4Choice
{
    ...
    /// </summary>
    [IsoId("_Q0yQ9tp-Ed-ak6NoX_4Aeg_-2121440827")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption4Choice_
    #else
    public partial class Proprietary : CorporateActionOption4Choice_
    #endif
    {
