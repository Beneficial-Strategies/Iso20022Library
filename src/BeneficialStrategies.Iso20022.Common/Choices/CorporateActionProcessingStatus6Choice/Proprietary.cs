...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionProcessingStatus6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionProcessingStatus6Choice_
    #else
    public partial class Proprietary : CorporateActionProcessingStatus6Choice_
    #endif
    {
