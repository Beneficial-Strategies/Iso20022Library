...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus32Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Pending : InstructionProcessingStatus32Choice_
    #else
    public partial class Pending : InstructionProcessingStatus32Choice_
    #endif
    {
