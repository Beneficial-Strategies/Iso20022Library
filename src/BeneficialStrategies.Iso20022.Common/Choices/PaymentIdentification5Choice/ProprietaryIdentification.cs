...
namespace BeneficialStrategies.Iso20022.Choices.PaymentIdentification5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PaymentIdentification5Choice_
    #else
    public partial class ProprietaryIdentification : PaymentIdentification5Choice_
    #endif
    {
