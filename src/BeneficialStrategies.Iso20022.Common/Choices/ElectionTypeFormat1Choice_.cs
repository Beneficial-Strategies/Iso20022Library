...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(ElectionTypeFormat1Choice.Code),
        nameof(ElectionTypeFormat1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(ElectionTypeFormat1Choice.Proprietary),
        nameof(ElectionTypeFormat1Choice.Proprietary)
    )]
    [IsoId("_Q3K2ktp-Ed-ak6NoX_4Aeg_1718215958")]
    [DisplayName("Election Type Format 1 Choice")]
    public abstract record ElectionTypeFormat1Choice_ { }
}
