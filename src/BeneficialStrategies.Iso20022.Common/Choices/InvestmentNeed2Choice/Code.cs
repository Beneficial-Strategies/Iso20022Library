...
namespace BeneficialStrategies.Iso20022.Choices.InvestmentNeed2Choice
{
    ...
    #else
    public partial class Code : InvestmentNeed2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestmentNeed2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestmentNeed2Code Value { get; init; } 
        #else
        public InvestmentNeed2Code Value { get; set; } 
        #endif
