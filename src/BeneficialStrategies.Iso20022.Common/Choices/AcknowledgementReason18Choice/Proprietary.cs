...
namespace BeneficialStrategies.Iso20022.Choices.AcknowledgementReason18Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : AcknowledgementReason18Choice_
    #else
    public partial class Proprietary : AcknowledgementReason18Choice_
    #endif
    {
