...
namespace BeneficialStrategies.Iso20022.Choices.ClearingScheme1Choice
{
    ...
    #else
    public partial class Code : ClearingScheme1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalPurpose1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalPurpose1Code Value { get; init; } 
        #else
        public ExternalPurpose1Code Value { get; set; } 
        #endif
