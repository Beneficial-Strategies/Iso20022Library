...
namespace BeneficialStrategies.Iso20022.Choices.TimeFrame3Choice
{
    ...
    #else
    public partial class RenunciationMinus : TimeFrame3Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a RenunciationMinus instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public RenunciationMinus( System.UInt64 reqValue )
        {
            Value = reqValue;
        }
        #endif
