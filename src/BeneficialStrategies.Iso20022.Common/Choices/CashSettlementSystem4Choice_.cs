...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CashSettlementSystem4Choice.Code),
        nameof(CashSettlementSystem4Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CashSettlementSystem4Choice.Proprietary),
        nameof(CashSettlementSystem4Choice.Proprietary)
    )]
    [IsoId("_AF_qMTqHEeWVrPy0StzzSg")]
    [DisplayName("Cash Settlement System 4 Choice")]
    public abstract record CashSettlementSystem4Choice_ { }
}
