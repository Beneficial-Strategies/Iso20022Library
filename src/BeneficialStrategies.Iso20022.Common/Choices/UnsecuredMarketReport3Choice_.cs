...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(UnsecuredMarketReport3Choice.DataSetAction),
        nameof(UnsecuredMarketReport3Choice.DataSetAction)
    )]
    [JsonDerivedType(
        typeof(UnsecuredMarketReport3Choice.Transaction),
        nameof(UnsecuredMarketReport3Choice.Transaction)
    )]
    [IsoId("_Gm8z9aifEeWHO_l3hf2rlA")]
    [DisplayName("Unsecured Market Report 3 Choice")]
    public abstract record UnsecuredMarketReport3Choice_ { }
}
