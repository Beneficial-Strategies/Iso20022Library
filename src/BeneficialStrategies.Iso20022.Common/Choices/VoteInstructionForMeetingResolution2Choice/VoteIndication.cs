...
namespace BeneficialStrategies.Iso20022.Choices.VoteInstructionForMeetingResolution2Choice
{
    ...
    #else
    public partial class VoteIndication : VoteInstructionForMeetingResolution2Choice_
    #endif
    {
        ...
        /// </summary>
        public VoteIndication( VoteInstruction4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public VoteInstruction4Code Value { get; init; } 
        #else
        public VoteInstruction4Code Value { get; set; } 
        #endif
