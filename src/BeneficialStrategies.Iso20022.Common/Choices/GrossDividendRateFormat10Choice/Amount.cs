...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat10Choice_
    #else
    public partial class Amount : GrossDividendRateFormat10Choice_
    #endif
    {
