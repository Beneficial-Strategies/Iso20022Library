...
namespace BeneficialStrategies.Iso20022.Choices.IdentificationType40Choice
{
    ...
    /// </summary>
    [IsoId("_AeoSNNokEeC60axPepSq7g_1118922023")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IdentificationType40Choice_
    #else
    public partial class Proprietary : IdentificationType40Choice_
    #endif
    {
