...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UZXyBtp-Ed-ak6NoX_4Aeg_-662318656")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : PendingProcessingStatus1Choice_
    #else
    public partial class NoSpecifiedReason : PendingProcessingStatus1Choice_
    #endif
    {
