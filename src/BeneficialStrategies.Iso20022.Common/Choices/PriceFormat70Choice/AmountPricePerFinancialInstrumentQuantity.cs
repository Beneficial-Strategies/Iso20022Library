...
namespace BeneficialStrategies.Iso20022.Choices.PriceFormat70Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmountPricePerFinancialInstrumentQuantity : PriceFormat70Choice_
    #else
    public partial class AmountPricePerFinancialInstrumentQuantity : PriceFormat70Choice_
    #endif
    {
        ...
        /// </summary>
        public AmountPricePerFinancialInstrumentQuantity( AmountPriceType1Code reqAmountPriceType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqPriceValue,FinancialInstrumentQuantity36Choice_ reqFinancialInstrumentQuantity )
        {
