...
namespace BeneficialStrategies.Iso20022.Choices.Status27Choice
{
    ...
    #else
    public partial class Code : Status27Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TradeStatus6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TradeStatus6Code Value { get; init; } 
        #else
        public TradeStatus6Code Value { get; set; } 
        #endif
