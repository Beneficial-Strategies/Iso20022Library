...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification133Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : PartyIdentification133Choice_
    #else
    public partial class NameAndAddress : PartyIdentification133Choice_
    #endif
    {
