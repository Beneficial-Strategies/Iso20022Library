...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record JointOwner : AccountParties12Choice_
    #else
    public partial class JointOwner : AccountParties12Choice_
    #endif
    {
        ...
        /// </summary>
        public JointOwner( Party47Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
