...
namespace BeneficialStrategies.Iso20022.Choices.AccountParties12Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PrimaryOwner : AccountParties12Choice_
    #else
    public partial class PrimaryOwner : AccountParties12Choice_
    #endif
    {
        ...
        /// </summary>
        public PrimaryOwner( Party47Choice_ reqParty )
        {
            Party = reqParty;
        }
        #endif
