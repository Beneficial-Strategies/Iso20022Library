...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(TrancheIndicator3Choice.Tranched),
        nameof(TrancheIndicator3Choice.Tranched)
    )]
    [JsonDerivedType(
        typeof(TrancheIndicator3Choice.Untranched),
        nameof(TrancheIndicator3Choice.Untranched)
    )]
    [IsoId("_mq05QQ06EeuJ1fOEB4bQXA")]
    [DisplayName("Tranche Indicator 3 Choice")]
    public abstract record TrancheIndicator3Choice_ { }
}
