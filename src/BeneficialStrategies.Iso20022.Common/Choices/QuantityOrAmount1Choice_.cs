...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(QuantityOrAmount1Choice.Quantity),
        nameof(QuantityOrAmount1Choice.Quantity)
    )]
    [JsonDerivedType(
        typeof(QuantityOrAmount1Choice.Amount),
        nameof(QuantityOrAmount1Choice.Amount)
    )]
    [IsoId("_Q-K2cNp-Ed-ak6NoX_4Aeg_1028055556")]
    [DisplayName("Quantity Or Amount 1 Choice")]
    public abstract record QuantityOrAmount1Choice_ { }
}
