...
namespace BeneficialStrategies.Iso20022.Choices.GlobalNote2Choice
{
    ...
    #else
    public partial class Code : GlobalNote2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GlobalNote1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GlobalNote1Code Value { get; init; } 
        #else
        public GlobalNote1Code Value { get; set; } 
        #endif
