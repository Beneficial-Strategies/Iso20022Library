...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition30Choice
{
    ...
    #else
    public partial class Code : SettlementTransactionCondition30Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SettlementTransactionCondition11Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        #else
        public SettlementTransactionCondition11Code Value { get; set; } 
        #endif
