...
namespace BeneficialStrategies.Iso20022.Choices.InvestigationStatusChoice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AssignmentCancellationConfirmation : InvestigationStatusChoice_
    #else
    public partial class AssignmentCancellationConfirmation : InvestigationStatusChoice_
    #endif
    {
