...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity4Choice
{
    ...
    /// </summary>
    [IsoId("_VO3PmNp-Ed-ak6NoX_4Aeg_1801928825")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record GrossAmount : FinancialInstrumentQuantity4Choice_
    #else
    public partial class GrossAmount : FinancialInstrumentQuantity4Choice_
    #endif
    {
