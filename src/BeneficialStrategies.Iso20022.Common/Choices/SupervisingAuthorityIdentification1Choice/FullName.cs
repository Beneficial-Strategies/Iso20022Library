...
namespace BeneficialStrategies.Iso20022.Choices.SupervisingAuthorityIdentification1Choice
{
    ...
    #else
    public partial class FullName : SupervisingAuthorityIdentification1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a FullName instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public FullName( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
