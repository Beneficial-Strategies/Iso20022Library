...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesPaymentStatus2Choice
{
    ...
    /// </summary>
    [IsoId("_QvHt0tp-Ed-ak6NoX_4Aeg_-1729908324")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesPaymentStatus2Choice_
    #else
    public partial class Proprietary : SecuritiesPaymentStatus2Choice_
    #endif
    {
