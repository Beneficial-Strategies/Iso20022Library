...
namespace BeneficialStrategies.Iso20022.Choices.ResponseStatus9Choice
{
    ...
    #else
    public partial class Code : ResponseStatus9Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ResponseStatus2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ResponseStatus2Code Value { get; init; } 
        #else
        public ResponseStatus2Code Value { get; set; } 
        #endif
