...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDailyFailureReason1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DataSetAction : SettlementDailyFailureReason1Choice_
    #else
    public partial class DataSetAction : SettlementDailyFailureReason1Choice_
    #endif
    {
