...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus15Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : CancellationStatus15Choice_
    #else
    public partial class NoSpecifiedReason : CancellationStatus15Choice_
    #endif
    {
