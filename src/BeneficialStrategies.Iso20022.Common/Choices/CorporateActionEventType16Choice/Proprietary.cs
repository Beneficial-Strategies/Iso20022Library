...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType16Choice_
    #else
    public partial class Proprietary : CorporateActionEventType16Choice_
    #endif
    {
