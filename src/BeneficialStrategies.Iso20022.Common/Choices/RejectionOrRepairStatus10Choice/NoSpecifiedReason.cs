...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionOrRepairStatus10Choice_
    #else
    public partial class NoSpecifiedReason : RejectionOrRepairStatus10Choice_
    #endif
    {
