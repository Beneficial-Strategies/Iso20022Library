...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : NetDividendRateFormat9Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : NetDividendRateFormat9Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType21Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
