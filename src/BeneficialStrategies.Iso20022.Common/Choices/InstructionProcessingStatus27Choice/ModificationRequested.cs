...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus27Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ModificationRequested : InstructionProcessingStatus27Choice_
    #else
    public partial class ModificationRequested : InstructionProcessingStatus27Choice_
    #endif
    {
