...
namespace BeneficialStrategies.Iso20022.Choices.GeneralInvestmentAccountType1Choice
{
    ...
    #else
    public partial class Code : GeneralInvestmentAccountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( GeneralInvestmentAccountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public GeneralInvestmentAccountType1Code Value { get; init; } 
        #else
        public GeneralInvestmentAccountType1Code Value { get; set; } 
        #endif
