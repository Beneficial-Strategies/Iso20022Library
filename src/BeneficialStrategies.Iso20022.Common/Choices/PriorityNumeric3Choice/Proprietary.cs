...
namespace BeneficialStrategies.Iso20022.Choices.PriorityNumeric3Choice
{
    ...
    /// </summary>
    [IsoId("_AbWUsdokEeC60axPepSq7g_1822949260")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PriorityNumeric3Choice_
    #else
    public partial class Proprietary : PriorityNumeric3Choice_
    #endif
    {
