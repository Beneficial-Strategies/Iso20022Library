...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionOption11Choice_
    #else
    public partial class Proprietary : CorporateActionOption11Choice_
    #endif
    {
