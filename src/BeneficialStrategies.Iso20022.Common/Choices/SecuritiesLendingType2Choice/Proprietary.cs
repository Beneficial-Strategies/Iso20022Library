...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesLendingType2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesLendingType2Choice_
    #else
    public partial class Proprietary : SecuritiesLendingType2Choice_
    #endif
    {
