...
namespace BeneficialStrategies.Iso20022.Choices.PortfolioTransferStatus1Choice
{
    ...
    #else
    public partial class Code : PortfolioTransferStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AllegementStatus2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AllegementStatus2Code Value { get; init; } 
        #else
        public AllegementStatus2Code Value { get; set; } 
        #endif
