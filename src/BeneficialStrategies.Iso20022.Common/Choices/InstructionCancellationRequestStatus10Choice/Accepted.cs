...
namespace BeneficialStrategies.Iso20022.Choices.InstructionCancellationRequestStatus10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Accepted : InstructionCancellationRequestStatus10Choice_
    #else
    public partial class Accepted : InstructionCancellationRequestStatus10Choice_
    #endif
    {
