...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity19Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AmortisedValue : FinancialInstrumentQuantity19Choice_
    #else
    public partial class AmortisedValue : FinancialInstrumentQuantity19Choice_
    #endif
    {
