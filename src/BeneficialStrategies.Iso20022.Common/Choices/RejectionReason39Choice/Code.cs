...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason39Choice
{
    ...
    #else
    public partial class Code : RejectionReason39Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason62Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason62Code Value { get; init; } 
        #else
        public RejectionReason62Code Value { get; set; } 
        #endif
