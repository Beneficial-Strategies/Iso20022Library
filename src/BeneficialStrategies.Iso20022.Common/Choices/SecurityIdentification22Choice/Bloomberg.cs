...
namespace BeneficialStrategies.Iso20022.Choices.SecurityIdentification22Choice
{
    ...
    #else
    public partial class Bloomberg : SecurityIdentification22Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a Bloomberg instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public Bloomberg( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
