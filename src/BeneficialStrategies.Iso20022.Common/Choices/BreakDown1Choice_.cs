...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BreakDown1Choice.ByPurchaseOrder),
        nameof(BreakDown1Choice.ByPurchaseOrder)
    )]
    [JsonDerivedType(
        typeof(BreakDown1Choice.ByCommercialInvoice),
        nameof(BreakDown1Choice.ByCommercialInvoice)
    )]
    [IsoId("_tbfaMBrYEeOVR9VN6fAMUg")]
    [DisplayName("Break Down 1 Choice")]
    public abstract record BreakDown1Choice_ { }
}
