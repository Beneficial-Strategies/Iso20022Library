...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(RateAndAmountFormat45Choice.Rate),
        nameof(RateAndAmountFormat45Choice.Rate)
    )]
    [JsonDerivedType(
        typeof(RateAndAmountFormat45Choice.Amount),
        nameof(RateAndAmountFormat45Choice.Amount)
    )]
    [JsonDerivedType(
        typeof(RateAndAmountFormat45Choice.RateTypeAndRate),
        nameof(RateAndAmountFormat45Choice.RateTypeAndRate)
    )]
    [IsoId("_cj-HW5KQEeWHWpTQn1FFVg")]
    [DisplayName("Rate And Amount Format 45 Choice")]
    public abstract record RateAndAmountFormat45Choice_ { }
}
