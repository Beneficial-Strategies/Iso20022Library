...
namespace BeneficialStrategies.Iso20022.Choices.ReplacementProcessingStatus10Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Completed : ReplacementProcessingStatus10Choice_
    #else
    public partial class Completed : ReplacementProcessingStatus10Choice_
    #endif
    {
