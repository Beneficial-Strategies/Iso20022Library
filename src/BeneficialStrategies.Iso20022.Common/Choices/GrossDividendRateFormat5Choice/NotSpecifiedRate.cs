...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : GrossDividendRateFormat5Choice_
    #else
    public partial class NotSpecifiedRate : GrossDividendRateFormat5Choice_
    #endif
    {
