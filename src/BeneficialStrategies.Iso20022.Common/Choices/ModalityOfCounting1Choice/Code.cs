...
namespace BeneficialStrategies.Iso20022.Choices.ModalityOfCounting1Choice
{
    ...
    #else
    public partial class Code : ModalityOfCounting1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ModalityOfCounting1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ModalityOfCounting1Code Value { get; init; } 
        #else
        public ModalityOfCounting1Code Value { get; set; } 
        #endif
