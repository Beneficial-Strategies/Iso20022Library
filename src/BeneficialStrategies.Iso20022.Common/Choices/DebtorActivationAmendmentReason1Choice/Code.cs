...
namespace BeneficialStrategies.Iso20022.Choices.DebtorActivationAmendmentReason1Choice
{
    ...
    #else
    public partial class Code : DebtorActivationAmendmentReason1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalDebtorActivationAmendmentReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalDebtorActivationAmendmentReason1Code Value { get; init; } 
        #else
        public ExternalDebtorActivationAmendmentReason1Code Value { get; set; } 
        #endif
