...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountParties5Choice.PrimaryOwner),
        nameof(AccountParties5Choice.PrimaryOwner)
    )]
    [JsonDerivedType(typeof(AccountParties5Choice.Trustee), nameof(AccountParties5Choice.Trustee))]
    [JsonDerivedType(
        typeof(AccountParties5Choice.CustodianForMinor),
        nameof(AccountParties5Choice.CustodianForMinor)
    )]
    [JsonDerivedType(typeof(AccountParties5Choice.Nominee), nameof(AccountParties5Choice.Nominee))]
    [JsonDerivedType(
        typeof(AccountParties5Choice.JointOwner),
        nameof(AccountParties5Choice.JointOwner)
    )]
    [IsoId("_Ff6rBQhDEeSUPbC7DbLJpQ")]
    [DisplayName("Account Parties 5 Choice")]
    public abstract record AccountParties5Choice_ { }
}
