...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RejectedReason21Choice.Proprietary),nameof(RejectedReason21Choice.Proprietary))]
    #endif
    ...
    #else
    public abstract partial class RejectedReason21Choice_
    #endif
    {
    }
}
