...
namespace BeneficialStrategies.Iso20022.Choices.PartyOrBusinessError1Choice
{
    ...
    /// </summary>
    [IsoId("_knr45O5NEeCisYr99QEiWA_-128239750")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BusinessError : PartyOrBusinessError1Choice_
    #else
    public partial class BusinessError : PartyOrBusinessError1Choice_
    #endif
    {
