...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OptionFeatures1FormatChoice.Code),
        nameof(OptionFeatures1FormatChoice.Code)
    )]
    [JsonDerivedType(
        typeof(OptionFeatures1FormatChoice.Proprietary),
        nameof(OptionFeatures1FormatChoice.Proprietary)
    )]
    [IsoId("_Rm2nFdp-Ed-ak6NoX_4Aeg_741252058")]
    [DisplayName("Option Features 1 Format Choice")]
    public abstract record OptionFeatures1FormatChoice_ { }
}
