...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType7Choice
{
    ...
    #else
    public partial class Code : SecuritiesTransactionType7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType6Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType6Code Value { get; init; } 
        #else
        public SecuritiesTransactionType6Code Value { get; set; } 
        #endif
