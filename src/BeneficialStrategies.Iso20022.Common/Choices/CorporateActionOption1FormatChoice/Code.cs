...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionOption1FormatChoice
{
    ...
    #else
    public partial class Code : CorporateActionOption1FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionOptionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionOptionType1Code Value { get; init; } 
        #else
        public CorporateActionOptionType1Code Value { get; set; } 
        #endif
