...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionOption42Choice.Code),
        nameof(CorporateActionOption42Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionOption42Choice.Proprietary),
        nameof(CorporateActionOption42Choice.Proprietary)
    )]
    [IsoId("_BHW2aR9QEeuFz_FaCzCLgQ")]
    [DisplayName("Corporate Action Option 42 Choice")]
    public abstract record CorporateActionOption42Choice_ { }
}
