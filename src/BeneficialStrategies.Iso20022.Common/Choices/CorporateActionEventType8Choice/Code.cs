...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType8Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType8Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType9Code Value { get; init; } 
        #else
        public CorporateActionEventType9Code Value { get; set; } 
        #endif
