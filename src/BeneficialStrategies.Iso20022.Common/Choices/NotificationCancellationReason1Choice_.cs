...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(NotificationCancellationReason1Choice.Code),
        nameof(NotificationCancellationReason1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(NotificationCancellationReason1Choice.Proprietary),
        nameof(NotificationCancellationReason1Choice.Proprietary)
    )]
    [IsoId("_4LsqKSv_Eey3nPxW-HgLUw")]
    [DisplayName("Notification Cancellation Reason 1 Choice")]
    public abstract record NotificationCancellationReason1Choice_ { }
}
