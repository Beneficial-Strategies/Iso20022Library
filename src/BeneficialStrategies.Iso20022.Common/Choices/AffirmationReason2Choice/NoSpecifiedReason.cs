...
namespace BeneficialStrategies.Iso20022.Choices.AffirmationReason2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : AffirmationReason2Choice_
    #else
    public partial class NoSpecifiedReason : AffirmationReason2Choice_
    #endif
    {
