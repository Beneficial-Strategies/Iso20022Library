...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(AccountParties6Choice.PrimaryOwner),
        nameof(AccountParties6Choice.PrimaryOwner)
    )]
    [JsonDerivedType(typeof(AccountParties6Choice.Trustee), nameof(AccountParties6Choice.Trustee))]
    [JsonDerivedType(
        typeof(AccountParties6Choice.CustodianForMinor),
        nameof(AccountParties6Choice.CustodianForMinor)
    )]
    [JsonDerivedType(typeof(AccountParties6Choice.Nominee), nameof(AccountParties6Choice.Nominee))]
    [JsonDerivedType(
        typeof(AccountParties6Choice.JointOwner),
        nameof(AccountParties6Choice.JointOwner)
    )]
    [IsoId("_IhLclQhDEeSUPbC7DbLJpQ")]
    [DisplayName("Account Parties 6 Choice")]
    public abstract record AccountParties6Choice_ { }
}
