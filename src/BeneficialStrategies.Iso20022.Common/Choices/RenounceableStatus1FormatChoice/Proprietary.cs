...
namespace BeneficialStrategies.Iso20022.Choices.RenounceableStatus1FormatChoice
{
    ...
    /// </summary>
    [IsoId("_Roygwtp-Ed-ak6NoX_4Aeg_-576437361")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : RenounceableStatus1FormatChoice_
    #else
    public partial class Proprietary : RenounceableStatus1FormatChoice_
    #endif
    {
