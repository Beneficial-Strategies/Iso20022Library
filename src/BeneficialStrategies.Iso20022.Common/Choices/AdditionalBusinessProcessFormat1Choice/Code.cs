...
namespace BeneficialStrategies.Iso20022.Choices.AdditionalBusinessProcessFormat1Choice
{
    ...
    #else
    public partial class Code : AdditionalBusinessProcessFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AdditionalBusinessProcess1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AdditionalBusinessProcess1Code Value { get; init; } 
        #else
        public AdditionalBusinessProcess1Code Value { get; set; } 
        #endif
