...
namespace BeneficialStrategies.Iso20022.Choices.NetDividendRateFormat44Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : NetDividendRateFormat44Choice_
    #else
    public partial class NotSpecifiedRate : NetDividendRateFormat44Choice_
    #endif
    {
