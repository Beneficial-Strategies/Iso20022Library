...
namespace BeneficialStrategies.Iso20022.Choices.BalanceSubType1Choice
{
    ...
    #else
    public partial class Code : BalanceSubType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalBalanceSubType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalBalanceSubType1Code Value { get; init; } 
        #else
        public ExternalBalanceSubType1Code Value { get; set; } 
        #endif
