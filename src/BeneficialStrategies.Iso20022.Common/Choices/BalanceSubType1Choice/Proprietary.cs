...
namespace BeneficialStrategies.Iso20022.Choices.BalanceSubType1Choice
{
    ...
    /// </summary>
    [IsoId("_SYoCRdp-Ed-ak6NoX_4Aeg_771531004")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : BalanceSubType1Choice_
    #else
    public partial class Proprietary : BalanceSubType1Choice_
    #endif
    {
