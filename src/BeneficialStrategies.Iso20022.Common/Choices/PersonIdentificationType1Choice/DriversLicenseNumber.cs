...
namespace BeneficialStrategies.Iso20022.Choices.PersonIdentificationType1Choice
{
    ...
    #else
    public partial class DriversLicenseNumber : PersonIdentificationType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a DriversLicenseNumber instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public DriversLicenseNumber( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
