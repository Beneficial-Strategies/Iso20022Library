...
namespace BeneficialStrategies.Iso20022.Choices.PersonIdentificationType1Choice
{
    ...
    #else
    public partial class EmployerIdentificationNumber : PersonIdentificationType1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a EmployerIdentificationNumber instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public EmployerIdentificationNumber( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
