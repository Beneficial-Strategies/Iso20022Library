...
namespace BeneficialStrategies.Iso20022.Choices.OtherIdentification1Choice
{
    ...
    #else
    public partial class Code : OtherIdentification1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PersonIdentificationType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PersonIdentificationType5Code Value { get; init; } 
        #else
        public PersonIdentificationType5Code Value { get; set; } 
        #endif
