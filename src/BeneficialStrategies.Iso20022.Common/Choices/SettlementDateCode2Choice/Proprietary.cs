...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDateCode2Choice
{
    ...
    /// </summary>
    [IsoId("_QurB5tp-Ed-ak6NoX_4Aeg_-1955126920")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementDateCode2Choice_
    #else
    public partial class Proprietary : SettlementDateCode2Choice_
    #endif
    {
