...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDateCode2Choice
{
    ...
    /// </summary>
    [IsoId("_QurB5dp-Ed-ak6NoX_4Aeg_-1955127215")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : SettlementDateCode2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( DateType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public DateType4Code Value { get; init; } 
        #else
        public DateType4Code Value { get; set; } 
        #endif
