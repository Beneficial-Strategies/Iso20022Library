...
namespace BeneficialStrategies.Iso20022.Choices.ReplacementProcessingStatus9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ReplacementProcessingStatus9Choice_
    #else
    public partial class Proprietary : ReplacementProcessingStatus9Choice_
    #endif
    {
