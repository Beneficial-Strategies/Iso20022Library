...
namespace BeneficialStrategies.Iso20022.Choices.SettlementTransactionCondition16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementTransactionCondition16Choice_
    #else
    public partial class Proprietary : SettlementTransactionCondition16Choice_
    #endif
    {
