...
namespace BeneficialStrategies.Iso20022.Choices.RejectionReason48Choice
{
    ...
    #else
    public partial class Code : RejectionReason48Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason72Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason72Code Value { get; init; } 
        #else
        public RejectionReason72Code Value { get; set; } 
        #endif
