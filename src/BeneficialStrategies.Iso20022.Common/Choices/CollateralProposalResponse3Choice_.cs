...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CollateralProposalResponse3Choice.CollateralProposal),
        nameof(CollateralProposalResponse3Choice.CollateralProposal)
    )]
    [JsonDerivedType(
        typeof(CollateralProposalResponse3Choice.SegregatedIndependentAmount),
        nameof(CollateralProposalResponse3Choice.SegregatedIndependentAmount)
    )]
    [IsoId("_sO0cMYpDEeaNTaanBSMWmg")]
    [DisplayName("Collateral Proposal Response 3 Choice")]
    public abstract record CollateralProposalResponse3Choice_ { }
}
