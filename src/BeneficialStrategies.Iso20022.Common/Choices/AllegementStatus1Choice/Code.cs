...
namespace BeneficialStrategies.Iso20022.Choices.AllegementStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UakE0tp-Ed-ak6NoX_4Aeg_1621349991")]
    [DisplayName("Code")]
    ...
    #else
    public partial class Code : AllegementStatus1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AllegementStatus1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AllegementStatus1Code Value { get; init; } 
        #else
        public AllegementStatus1Code Value { get; set; } 
        #endif
