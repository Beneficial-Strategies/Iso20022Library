...
namespace BeneficialStrategies.Iso20022.Choices.TaxEfficientProductType1Choice
{
    ...
    #else
    public partial class Code : TaxEfficientProductType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxEfficientProductType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxEfficientProductType1Code Value { get; init; } 
        #else
        public TaxEfficientProductType1Code Value { get; set; } 
        #endif
