...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason30Choice
{
    ...
    #else
    public partial class Code : CancellationReason30Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancelledStatusReason12Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancelledStatusReason12Code Value { get; init; } 
        #else
        public CancelledStatusReason12Code Value { get; set; } 
        #endif
