...
namespace BeneficialStrategies.Iso20022.Choices.RejectionOrRepairStatus4Choice
{
    ...
    /// </summary>
    [IsoId("_UUmmw9p-Ed-ak6NoX_4Aeg_132777153")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : RejectionOrRepairStatus4Choice_
    #else
    public partial class NoSpecifiedReason : RejectionOrRepairStatus4Choice_
    #endif
    {
