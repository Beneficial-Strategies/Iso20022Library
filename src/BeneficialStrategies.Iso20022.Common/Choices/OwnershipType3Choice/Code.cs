...
namespace BeneficialStrategies.Iso20022.Choices.OwnershipType3Choice
{
    ...
    #else
    public partial class Code : OwnershipType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AccountOwnershipType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AccountOwnershipType5Code Value { get; init; } 
        #else
        public AccountOwnershipType5Code Value { get; set; } 
        #endif
