...
namespace BeneficialStrategies.Iso20022.Choices.References59Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record SecuritiesSettlementTransactionIdentification : References59Choice_
    #else
    public partial class SecuritiesSettlementTransactionIdentification : References59Choice_
    #endif
    {
        ...
        /// </summary>
        public SecuritiesSettlementTransactionIdentification( System.String reqTransactionIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
        {
