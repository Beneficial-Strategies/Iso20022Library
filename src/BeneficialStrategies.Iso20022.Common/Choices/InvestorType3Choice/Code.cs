...
namespace BeneficialStrategies.Iso20022.Choices.InvestorType3Choice
{
    ...
    #else
    public partial class Code : InvestorType3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestorType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestorType1Code Value { get; init; } 
        #else
        public InvestorType1Code Value { get; set; } 
        #endif
