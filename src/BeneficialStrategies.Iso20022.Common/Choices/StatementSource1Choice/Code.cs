...
namespace BeneficialStrategies.Iso20022.Choices.StatementSource1Choice
{
    ...
    #else
    public partial class Code : StatementSource1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( StatementSource1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public StatementSource1Code Value { get; init; } 
        #else
        public StatementSource1Code Value { get; set; } 
        #endif
