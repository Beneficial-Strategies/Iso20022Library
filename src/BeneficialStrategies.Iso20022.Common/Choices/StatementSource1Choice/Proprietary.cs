...
namespace BeneficialStrategies.Iso20022.Choices.StatementSource1Choice
{
    ...
    /// </summary>
    [IsoId("_m_xsdPNBEeCuA5Tr22BnwA_261285947")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : StatementSource1Choice_
    #else
    public partial class Proprietary : StatementSource1Choice_
    #endif
    {
