...
namespace BeneficialStrategies.Iso20022.Choices.References34Choice
{
    ...
    /// </summary>
    [IsoId("_jvDnyO5NEeCisYr99QEiWA_1789544906")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record IntraPositionMovementIdentification : References34Choice_
    #else
    public partial class IntraPositionMovementIdentification : References34Choice_
    #endif
    {
