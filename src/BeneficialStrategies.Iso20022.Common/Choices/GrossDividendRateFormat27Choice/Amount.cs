...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat27Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Amount : GrossDividendRateFormat27Choice_
    #else
    public partial class Amount : GrossDividendRateFormat27Choice_
    #endif
    {
