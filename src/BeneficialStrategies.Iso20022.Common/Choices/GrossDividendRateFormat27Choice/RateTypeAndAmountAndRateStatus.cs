...
namespace BeneficialStrategies.Iso20022.Choices.GrossDividendRateFormat27Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record RateTypeAndAmountAndRateStatus : GrossDividendRateFormat27Choice_
    #else
    public partial class RateTypeAndAmountAndRateStatus : GrossDividendRateFormat27Choice_
    #endif
    {
        ...
        /// </summary>
        public RateTypeAndAmountAndRateStatus( RateType68Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
        {
        ...
        public RateType68Choice_ RateType { get; init; } 
        #else
        public RateType68Choice_ RateType { get; set; } 
        #endif
