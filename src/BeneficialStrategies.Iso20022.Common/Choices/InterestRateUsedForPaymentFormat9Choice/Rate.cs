...
namespace BeneficialStrategies.Iso20022.Choices.InterestRateUsedForPaymentFormat9Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rate : InterestRateUsedForPaymentFormat9Choice_
    #else
    public partial class Rate : InterestRateUsedForPaymentFormat9Choice_
    #endif
    {
