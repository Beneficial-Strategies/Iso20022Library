...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(IntermediateSecuritiesDistributionTypeFormat2Choice.Code),
        nameof(IntermediateSecuritiesDistributionTypeFormat2Choice.Code)
    )]
    [JsonDerivedType(
        typeof(IntermediateSecuritiesDistributionTypeFormat2Choice.Proprietary),
        nameof(IntermediateSecuritiesDistributionTypeFormat2Choice.Proprietary)
    )]
    [IsoId("_Q0L0Atp-Ed-ak6NoX_4Aeg_-965201377")]
    [DisplayName("Intermediate Securities Distribution Type Format 2 Choice")]
    public abstract record IntermediateSecuritiesDistributionTypeFormat2Choice_ { }
}
