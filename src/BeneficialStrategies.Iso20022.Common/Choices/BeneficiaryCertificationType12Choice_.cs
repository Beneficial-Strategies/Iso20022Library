...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BeneficiaryCertificationType12Choice.Code),
        nameof(BeneficiaryCertificationType12Choice.Code)
    )]
    [JsonDerivedType(
        typeof(BeneficiaryCertificationType12Choice.Proprietary),
        nameof(BeneficiaryCertificationType12Choice.Proprietary)
    )]
    [IsoId("_cta-Q5KQEeWHWpTQn1FFVg")]
    [DisplayName("Beneficiary Certification Type 12 Choice")]
    public abstract record BeneficiaryCertificationType12Choice_ { }
}
