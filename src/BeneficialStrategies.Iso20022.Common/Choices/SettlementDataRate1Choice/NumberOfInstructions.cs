...
namespace BeneficialStrategies.Iso20022.Choices.SettlementDataRate1Choice
{
    ...
    #else
    public partial class NumberOfInstructions : SettlementDataRate1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a NumberOfInstructions instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public NumberOfInstructions( System.Decimal reqValue )
        {
            Value = reqValue;
        }
        #endif
