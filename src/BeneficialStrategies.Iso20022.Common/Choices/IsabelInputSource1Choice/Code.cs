...
namespace BeneficialStrategies.Iso20022.Choices.IsabelInputSource1Choice
{
    ...
    #else
    public partial class Code : IsabelInputSource1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InputSource1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InputSource1Code Value { get; init; } 
        #else
        public InputSource1Code Value { get; set; } 
        #endif
