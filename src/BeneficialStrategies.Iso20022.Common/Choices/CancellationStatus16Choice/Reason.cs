...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : CancellationStatus16Choice_
    #else
    public partial class Reason : CancellationStatus16Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( CancellationReason23Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
