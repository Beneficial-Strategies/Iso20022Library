...
namespace BeneficialStrategies.Iso20022.Choices.OtherAsset1Choice
{
    ...
    #else
    public partial class Code : OtherAsset1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OtherAsset1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OtherAsset1Code Value { get; init; } 
        #else
        public OtherAsset1Code Value { get; set; } 
        #endif
