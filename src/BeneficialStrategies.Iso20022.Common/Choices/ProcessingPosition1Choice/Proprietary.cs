...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingPosition1Choice
{
    ...
    /// </summary>
    [IsoId("_QzcNItp-Ed-ak6NoX_4Aeg_2047318744")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : ProcessingPosition1Choice_
    #else
    public partial class Proprietary : ProcessingPosition1Choice_
    #endif
    {
