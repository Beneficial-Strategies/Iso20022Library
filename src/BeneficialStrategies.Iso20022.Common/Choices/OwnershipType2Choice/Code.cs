...
namespace BeneficialStrategies.Iso20022.Choices.OwnershipType2Choice
{
    ...
    #else
    public partial class Code : OwnershipType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( AccountOwnershipType4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public AccountOwnershipType4Code Value { get; init; } 
        #else
        public AccountOwnershipType4Code Value { get; set; } 
        #endif
