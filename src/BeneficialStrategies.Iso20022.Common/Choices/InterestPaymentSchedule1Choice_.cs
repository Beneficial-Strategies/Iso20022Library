...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(InterestPaymentSchedule1Choice.DateRange),
        nameof(InterestPaymentSchedule1Choice.DateRange)
    )]
    [JsonDerivedType(
        typeof(InterestPaymentSchedule1Choice.SubSchedule),
        nameof(InterestPaymentSchedule1Choice.SubSchedule)
    )]
    [IsoId("_u7i5Q-FWEeSvv6t4Ka7B7A")]
    [DisplayName("Interest Payment Schedule 1 Choice")]
    public abstract record InterestPaymentSchedule1Choice_ { }
}
