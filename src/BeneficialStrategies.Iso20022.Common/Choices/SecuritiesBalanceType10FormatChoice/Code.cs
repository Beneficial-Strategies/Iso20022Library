...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesBalanceType10FormatChoice
{
    ...
    #else
    public partial class Code : SecuritiesBalanceType10FormatChoice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesBalanceType10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesBalanceType10Code Value { get; init; } 
        #else
        public SecuritiesBalanceType10Code Value { get; set; } 
        #endif
