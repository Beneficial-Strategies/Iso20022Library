...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingProcessingStatus16Choice_
    #else
    public partial class Reason : PendingProcessingStatus16Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingProcessingReason15Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
