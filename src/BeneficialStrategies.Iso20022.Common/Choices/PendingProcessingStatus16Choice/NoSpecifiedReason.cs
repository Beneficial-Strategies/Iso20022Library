...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : PendingProcessingStatus16Choice_
    #else
    public partial class NoSpecifiedReason : PendingProcessingStatus16Choice_
    #endif
    {
