...
namespace BeneficialStrategies.Iso20022.Choices.FundOrderType5Choice
{
    ...
    #else
    public partial class Code : FundOrderType5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( FundOrderType10Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public FundOrderType10Code Value { get; init; } 
        #else
        public FundOrderType10Code Value { get; set; } 
        #endif
