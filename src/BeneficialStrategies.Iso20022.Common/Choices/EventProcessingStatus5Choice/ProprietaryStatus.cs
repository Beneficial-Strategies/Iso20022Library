...
namespace BeneficialStrategies.Iso20022.Choices.EventProcessingStatus5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : EventProcessingStatus5Choice_
    #else
    public partial class ProprietaryStatus : EventProcessingStatus5Choice_
    #endif
    {
