...
namespace BeneficialStrategies.Iso20022.Choices.InformationTypeFormat5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : InformationTypeFormat5Choice_
    #else
    public partial class Proprietary : InformationTypeFormat5Choice_
    #endif
    {
