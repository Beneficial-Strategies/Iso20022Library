...
namespace BeneficialStrategies.Iso20022.Choices.DateTimePeriodChoice
{
    ...
    /// </summary>
    [IsoId("_T5xr-Np-Ed-ak6NoX_4Aeg_1215657173")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record FromDateTime : DateTimePeriodChoice_
    #else
    public partial class FromDateTime : DateTimePeriodChoice_
    #endif
    {
