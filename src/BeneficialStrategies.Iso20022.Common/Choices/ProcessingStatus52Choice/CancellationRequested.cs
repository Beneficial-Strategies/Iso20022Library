...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus52Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : ProcessingStatus52Choice_
    #else
    public partial class CancellationRequested : ProcessingStatus52Choice_
    #endif
    {
