...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason7Choice
{
    ...
    #else
    public partial class Code : RejectedReason7Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalRejectedReason1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalRejectedReason1Code Value { get; init; } 
        #else
        public ExternalRejectedReason1Code Value { get; set; } 
        #endif
