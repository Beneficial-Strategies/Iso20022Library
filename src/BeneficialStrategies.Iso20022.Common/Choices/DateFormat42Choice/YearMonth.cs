...
namespace BeneficialStrategies.Iso20022.Choices.DateFormat42Choice
{
    ...
    #else
    public partial class YearMonth : DateFormat42Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a YearMonth instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public YearMonth( System.UInt16 reqValue )
        {
            Value = reqValue;
        }
        #endif
