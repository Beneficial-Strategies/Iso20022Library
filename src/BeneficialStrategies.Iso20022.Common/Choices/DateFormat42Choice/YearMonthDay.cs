...
namespace BeneficialStrategies.Iso20022.Choices.DateFormat42Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record YearMonthDay : DateFormat42Choice_
    #else
    public partial class YearMonthDay : DateFormat42Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a YearMonthDay instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public YearMonthDay( System.DateOnly reqValue )
        {
            Value = reqValue;
        }
        #endif
