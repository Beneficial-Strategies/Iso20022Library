...
namespace BeneficialStrategies.Iso20022.Choices.RateFormat5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NotSpecifiedRate : RateFormat5Choice_
    #else
    public partial class NotSpecifiedRate : RateFormat5Choice_
    #endif
    {
        ...
        /// </summary>
        public NotSpecifiedRate( RateType9Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RateType9Code Value { get; init; } 
        #else
        public RateType9Code Value { get; set; } 
        #endif
