...
namespace BeneficialStrategies.Iso20022.Choices.SubBalanceQuantity3Choice
{
    ...
    /// </summary>
    [IsoId("_QYLNftp-Ed-ak6NoX_4Aeg_-1874662777")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SubBalanceQuantity3Choice_
    #else
    public partial class Proprietary : SubBalanceQuantity3Choice_
    #endif
    {
