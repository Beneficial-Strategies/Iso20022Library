...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CancellationReason1Choice.Code),
        nameof(CancellationReason1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CancellationReason1Choice.Proprietary),
        nameof(CancellationReason1Choice.Proprietary)
    )]
    [IsoId("_TO3Gs9p-Ed-ak6NoX_4Aeg_-748049495")]
    [DisplayName("Cancellation Reason 1 Choice")]
    public abstract record CancellationReason1Choice_ { }
}
