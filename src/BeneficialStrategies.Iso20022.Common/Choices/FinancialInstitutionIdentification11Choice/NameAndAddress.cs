...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstitutionIdentification11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NameAndAddress : FinancialInstitutionIdentification11Choice_
    #else
    public partial class NameAndAddress : FinancialInstitutionIdentification11Choice_
    #endif
    {
