...
namespace BeneficialStrategies.Iso20022.Choices.NarrativeType1Choice
{
    ...
    #else
    public partial class Code : NarrativeType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalNarrativeType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalNarrativeType1Code Value { get; init; } 
        #else
        public ExternalNarrativeType1Code Value { get; set; } 
        #endif
