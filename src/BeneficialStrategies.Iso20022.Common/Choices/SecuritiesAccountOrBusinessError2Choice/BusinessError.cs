...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesAccountOrBusinessError2Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record BusinessError : SecuritiesAccountOrBusinessError2Choice_
    #else
    public partial class BusinessError : SecuritiesAccountOrBusinessError2Choice_
    #endif
    {
