...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType90Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType90Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType29Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType29Code Value { get; init; } 
        #else
        public CorporateActionEventType29Code Value { get; set; } 
        #endif
