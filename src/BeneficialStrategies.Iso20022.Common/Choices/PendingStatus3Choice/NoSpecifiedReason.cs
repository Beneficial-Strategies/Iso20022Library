...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus3Choice
{
    ...
    /// </summary>
    [IsoId("_UZ0d99p-Ed-ak6NoX_4Aeg_845552574")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record NoSpecifiedReason : PendingStatus3Choice_
    #else
    public partial class NoSpecifiedReason : PendingStatus3Choice_
    #endif
    {
