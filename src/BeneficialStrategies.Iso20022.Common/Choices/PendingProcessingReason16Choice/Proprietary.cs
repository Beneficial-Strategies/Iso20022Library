...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingReason16Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingProcessingReason16Choice_
    #else
    public partial class Proprietary : PendingProcessingReason16Choice_
    #endif
    {
