...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType101Choice
{
    ...
    #else
    public partial class Code : CorporateActionEventType101Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CorporateActionEventType33Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CorporateActionEventType33Code Value { get; init; } 
        #else
        public CorporateActionEventType33Code Value { get; set; } 
        #endif
