...
namespace BeneficialStrategies.Iso20022.Choices.SettlementParties5Choice
{
    ...
    #else
    public partial class ReceivingSettlementParties : SettlementParties5Choice_
    #endif
    {
        ...
        /// </summary>
        public ReceivingSettlementParties( PartyIdentification102Choice_ reqDepository,PartyIdentificationAndAccount126 reqParty1 )
        {
