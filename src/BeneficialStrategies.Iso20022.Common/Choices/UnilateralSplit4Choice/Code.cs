...
namespace BeneficialStrategies.Iso20022.Choices.UnilateralSplit4Choice
{
    ...
    #else
    public partial class Code : UnilateralSplit4Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( SecuritiesTransactionType5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public SecuritiesTransactionType5Code Value { get; init; } 
        #else
        public SecuritiesTransactionType5Code Value { get; set; } 
        #endif
