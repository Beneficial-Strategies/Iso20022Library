...
namespace BeneficialStrategies.Iso20022.Choices.TradeTransactionCondition5Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TradeTransactionCondition5Choice_
    #else
    public partial class Proprietary : TradeTransactionCondition5Choice_
    #endif
    {
