...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionReversalReason6Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionReversalReason6Choice_
    #else
    public partial class Proprietary : CorporateActionReversalReason6Choice_
    #endif
    {
