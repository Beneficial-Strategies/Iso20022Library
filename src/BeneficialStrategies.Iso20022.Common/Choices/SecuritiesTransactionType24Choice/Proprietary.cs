...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType24Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType24Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType24Choice_
    #endif
    {
