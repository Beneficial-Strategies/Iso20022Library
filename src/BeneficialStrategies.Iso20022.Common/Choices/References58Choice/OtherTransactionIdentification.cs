...
namespace BeneficialStrategies.Iso20022.Choices.References58Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OtherTransactionIdentification : References58Choice_
    #else
    public partial class OtherTransactionIdentification : References58Choice_
    #endif
    {
