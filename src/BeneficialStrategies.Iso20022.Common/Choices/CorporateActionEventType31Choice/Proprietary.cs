...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionEventType31Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CorporateActionEventType31Choice_
    #else
    public partial class Proprietary : CorporateActionEventType31Choice_
    #endif
    {
