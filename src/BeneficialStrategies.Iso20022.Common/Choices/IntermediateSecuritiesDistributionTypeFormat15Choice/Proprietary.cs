...
namespace BeneficialStrategies.Iso20022.Choices.IntermediateSecuritiesDistributionTypeFormat15Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : IntermediateSecuritiesDistributionTypeFormat15Choice_
    #else
    public partial class Proprietary : IntermediateSecuritiesDistributionTypeFormat15Choice_
    #endif
    {
