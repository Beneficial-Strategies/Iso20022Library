...
namespace BeneficialStrategies.Iso20022.Choices.OptionEventType1Choice
{
    ...
    #else
    public partial class Code : OptionEventType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( OptionEventType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public OptionEventType1Code Value { get; init; } 
        #else
        public OptionEventType1Code Value { get; set; } 
        #endif
