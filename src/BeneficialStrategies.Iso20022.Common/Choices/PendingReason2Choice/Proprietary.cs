...
namespace BeneficialStrategies.Iso20022.Choices.PendingReason2Choice
{
    ...
    /// </summary>
    [IsoId("_UYeaJ9p-Ed-ak6NoX_4Aeg_-2106070709")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : PendingReason2Choice_
    #else
    public partial class Proprietary : PendingReason2Choice_
    #endif
    {
