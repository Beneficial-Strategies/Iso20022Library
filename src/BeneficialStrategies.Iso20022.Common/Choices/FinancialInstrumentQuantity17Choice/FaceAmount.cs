...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity17Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record FaceAmount : FinancialInstrumentQuantity17Choice_
    #else
    public partial class FaceAmount : FinancialInstrumentQuantity17Choice_
    #endif
    {
