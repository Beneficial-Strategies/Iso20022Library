...
namespace BeneficialStrategies.Iso20022.Choices.TaxIdentificationType1Choice
{
    ...
    #else
    public partial class Code : TaxIdentificationType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxIdentificationNumberType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxIdentificationNumberType1Code Value { get; init; } 
        #else
        public TaxIdentificationNumberType1Code Value { get; set; } 
        #endif
