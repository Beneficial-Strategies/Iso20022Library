...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity14Choice
{
    ...
    #else
    public partial class Code : FinancialInstrumentQuantity14Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( Quantity2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public Quantity2Code Value { get; init; } 
        #else
        public Quantity2Code Value { get; set; } 
        #endif
