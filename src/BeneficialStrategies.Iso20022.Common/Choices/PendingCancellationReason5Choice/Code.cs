...
namespace BeneficialStrategies.Iso20022.Choices.PendingCancellationReason5Choice
{
    ...
    #else
    public partial class Code : PendingCancellationReason5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PendingCancellationReason5Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PendingCancellationReason5Code Value { get; init; } 
        #else
        public PendingCancellationReason5Code Value { get; set; } 
        #endif
