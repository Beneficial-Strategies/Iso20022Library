...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceFormat9Choice.PercentagePrice),
        nameof(PriceFormat9Choice.PercentagePrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat9Choice.AmountPrice),
        nameof(PriceFormat9Choice.AmountPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat9Choice.NotSpecifiedPrice),
        nameof(PriceFormat9Choice.NotSpecifiedPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat9Choice.AmountPricePerFinancialInstrumentQuantity),
        nameof(PriceFormat9Choice.AmountPricePerFinancialInstrumentQuantity)
    )]
    [JsonDerivedType(
        typeof(PriceFormat9Choice.AmountPricePerAmount),
        nameof(PriceFormat9Choice.AmountPricePerAmount)
    )]
    [IsoId("_Q2IUz9p-Ed-ak6NoX_4Aeg_856668219")]
    [DisplayName("Price Format 9 Choice")]
    public abstract record PriceFormat9Choice_ { }
}
