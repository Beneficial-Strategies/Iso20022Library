...
namespace BeneficialStrategies.Iso20022.Choices.References76Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record AccountServicerTransactionIdentification : References76Choice_
    #else
    public partial class AccountServicerTransactionIdentification : References76Choice_
    #endif
    {
