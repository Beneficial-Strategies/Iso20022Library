...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : CancellationStatus7Choice_
    #else
    public partial class Reason : CancellationStatus7Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( CancellationReason12Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
