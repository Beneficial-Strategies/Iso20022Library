...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason2Choice
{
    ...
    /// </summary>
    [IsoId("_TPmtl9p-Ed-ak6NoX_4Aeg_-617774448")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationReason2Choice_
    #else
    public partial class Proprietary : CancellationReason2Choice_
    #endif
    {
