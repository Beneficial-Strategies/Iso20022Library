...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason2Choice
{
    ...
    #else
    public partial class Code : CancellationReason2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancellationReason4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancellationReason4Code Value { get; init; } 
        #else
        public CancellationReason4Code Value { get; set; } 
        #endif
