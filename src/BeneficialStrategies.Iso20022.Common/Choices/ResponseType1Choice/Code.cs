...
namespace BeneficialStrategies.Iso20022.Choices.ResponseType1Choice
{
    ...
    #else
    public partial class Code : ResponseType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( MarginCallResponse1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public MarginCallResponse1Code Value { get; init; } 
        #else
        public MarginCallResponse1Code Value { get; set; } 
        #endif
