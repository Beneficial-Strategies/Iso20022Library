...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(PriceFormat45Choice.PercentagePrice),
        nameof(PriceFormat45Choice.PercentagePrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat45Choice.AmountPrice),
        nameof(PriceFormat45Choice.AmountPrice)
    )]
    [JsonDerivedType(
        typeof(PriceFormat45Choice.NotSpecifiedPrice),
        nameof(PriceFormat45Choice.NotSpecifiedPrice)
    )]
    [IsoId("_c9r6Q0EJEeWVgfuHGaKtRQ")]
    [DisplayName("Price Format 45 Choice")]
    public abstract record PriceFormat45Choice_ { }
}
