...
namespace BeneficialStrategies.Iso20022.Choices.InstructionProcessingStatus7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryStatus : InstructionProcessingStatus7Choice_
    #else
    public partial class ProprietaryStatus : InstructionProcessingStatus7Choice_
    #endif
    {
