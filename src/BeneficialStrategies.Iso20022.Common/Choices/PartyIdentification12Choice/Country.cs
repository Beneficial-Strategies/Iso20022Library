...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification12Choice
{
    ...
    /// </summary>
    [IsoId("_QQ3rmdp-Ed-ak6NoX_4Aeg_1655680090")]
    [DisplayName("Country")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Country : PartyIdentification12Choice_
    #else
    public partial class Country : PartyIdentification12Choice_
    #endif
    {
