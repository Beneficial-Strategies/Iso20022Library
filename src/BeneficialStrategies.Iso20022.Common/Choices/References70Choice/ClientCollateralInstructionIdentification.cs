...
namespace BeneficialStrategies.Iso20022.Choices.References70Choice
{
    ...
    #else
    public partial class ClientCollateralInstructionIdentification : References70Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a ClientCollateralInstructionIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public ClientCollateralInstructionIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
