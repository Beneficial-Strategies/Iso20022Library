...
namespace BeneficialStrategies.Iso20022.Choices.CommissionBasis1Choice
{
    ...
    #else
    public partial class Code : CommissionBasis1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( TaxationBasis4Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public TaxationBasis4Code Value { get; init; } 
        #else
        public TaxationBasis4Code Value { get; set; } 
        #endif
