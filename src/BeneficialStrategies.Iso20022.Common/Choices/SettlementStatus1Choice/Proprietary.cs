...
namespace BeneficialStrategies.Iso20022.Choices.SettlementStatus1Choice
{
    ...
    /// </summary>
    [IsoId("_UYeaIdp-Ed-ak6NoX_4Aeg_-484320845")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SettlementStatus1Choice_
    #else
    public partial class Proprietary : SettlementStatus1Choice_
    #endif
    {
