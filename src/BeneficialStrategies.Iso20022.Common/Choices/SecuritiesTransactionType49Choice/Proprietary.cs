...
namespace BeneficialStrategies.Iso20022.Choices.SecuritiesTransactionType49Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : SecuritiesTransactionType49Choice_
    #else
    public partial class Proprietary : SecuritiesTransactionType49Choice_
    #endif
    {
