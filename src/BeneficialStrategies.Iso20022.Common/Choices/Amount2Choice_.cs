...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(Amount2Choice.AmountWithoutCurrency),
        nameof(Amount2Choice.AmountWithoutCurrency)
    )]
    [JsonDerivedType(
        typeof(Amount2Choice.AmountWithCurrency),
        nameof(Amount2Choice.AmountWithCurrency)
    )]
    [IsoId("_75DzlKMgEeCJ6YNENx4h-w_890446015")]
    [DisplayName("Amount 2 Choice")]
    public abstract record Amount2Choice_ { }
}
