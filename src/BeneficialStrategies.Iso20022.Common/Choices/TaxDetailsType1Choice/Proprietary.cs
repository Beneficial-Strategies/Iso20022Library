...
namespace BeneficialStrategies.Iso20022.Choices.TaxDetailsType1Choice
{
    ...
    /// Type of tax applied.
    /// </summary>
    [IsoId("_RfZ7Qdp-Ed-ak6NoX_4Aeg_-94117518")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : TaxDetailsType1Choice_
    #else
    public partial class Proprietary : TaxDetailsType1Choice_
    #endif
    {
