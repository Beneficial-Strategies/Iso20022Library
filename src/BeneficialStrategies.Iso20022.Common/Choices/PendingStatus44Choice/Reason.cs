...
namespace BeneficialStrategies.Iso20022.Choices.PendingStatus44Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingStatus44Choice_
    #else
    public partial class Reason : PendingStatus44Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingReason35Choice_ reqReasonCode )
        {
