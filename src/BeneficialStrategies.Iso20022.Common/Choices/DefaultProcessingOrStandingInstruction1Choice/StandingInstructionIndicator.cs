...
namespace BeneficialStrategies.Iso20022.Choices.DefaultProcessingOrStandingInstruction1Choice
{
    ...
    #else
    public partial class StandingInstructionIndicator : DefaultProcessingOrStandingInstruction1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a StandingInstructionIndicator instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public StandingInstructionIndicator( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
