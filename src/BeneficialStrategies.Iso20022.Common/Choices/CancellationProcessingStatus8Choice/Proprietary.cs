...
namespace BeneficialStrategies.Iso20022.Choices.CancellationProcessingStatus8Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CancellationProcessingStatus8Choice_
    #else
    public partial class Proprietary : CancellationProcessingStatus8Choice_
    #endif
    {
