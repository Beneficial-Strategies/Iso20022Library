...
namespace BeneficialStrategies.Iso20022.Choices.CancellationStatus14Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : CancellationStatus14Choice_
    #else
    public partial class Reason : CancellationStatus14Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( CancellationReason19Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
