...
namespace BeneficialStrategies.Iso20022.Choices.WarrantStyle3Choice
{
    ...
    #else
    public partial class Code : WarrantStyle3Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( WarrantStyle1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public WarrantStyle1Code Value { get; init; } 
        #else
        public WarrantStyle1Code Value { get; set; } 
        #endif
