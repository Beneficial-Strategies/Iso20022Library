...
namespace BeneficialStrategies.Iso20022.Choices.PensionSchemeType2Choice
{
    ...
    #else
    public partial class Code : PensionSchemeType2Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( PensionSchemeType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public PensionSchemeType2Code Value { get; init; } 
        #else
        public PensionSchemeType2Code Value { get; set; } 
        #endif
