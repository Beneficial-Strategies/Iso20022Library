...
namespace BeneficialStrategies.Iso20022.Choices.CorporateActionUnallocatedBalanceSD3Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record PendingDeliveryBalance : CorporateActionUnallocatedBalanceSD3Choice_
    #else
    public partial class PendingDeliveryBalance : CorporateActionUnallocatedBalanceSD3Choice_
    #endif
    {
