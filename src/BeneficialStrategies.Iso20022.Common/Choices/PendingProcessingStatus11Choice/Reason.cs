...
namespace BeneficialStrategies.Iso20022.Choices.PendingProcessingStatus11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Reason : PendingProcessingStatus11Choice_
    #else
    public partial class Reason : PendingProcessingStatus11Choice_
    #endif
    {
        ...
        /// </summary>
        public Reason( PendingProcessingReason10Choice_ reqCode )
        {
            Code = reqCode;
        }
        #endif
