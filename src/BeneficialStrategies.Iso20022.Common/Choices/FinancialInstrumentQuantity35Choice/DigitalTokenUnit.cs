...
namespace BeneficialStrategies.Iso20022.Choices.FinancialInstrumentQuantity35Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record DigitalTokenUnit : FinancialInstrumentQuantity35Choice_
    #else
    public partial class DigitalTokenUnit : FinancialInstrumentQuantity35Choice_
    #endif
    {
