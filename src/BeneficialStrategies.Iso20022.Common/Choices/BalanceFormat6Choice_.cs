...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(BalanceFormat6Choice.EligibleBalance),
        nameof(BalanceFormat6Choice.EligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat6Choice.NotEligibleBalance),
        nameof(BalanceFormat6Choice.NotEligibleBalance)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat6Choice.FullPeriodUnits),
        nameof(BalanceFormat6Choice.FullPeriodUnits)
    )]
    [JsonDerivedType(
        typeof(BalanceFormat6Choice.PartWayPeriodUnits),
        nameof(BalanceFormat6Choice.PartWayPeriodUnits)
    )]
    [IsoId("_k7YK1zq5EeWQ1Y7f8kds2A")]
    [DisplayName("Balance Format 6 Choice")]
    public abstract record BalanceFormat6Choice_ { }
}
