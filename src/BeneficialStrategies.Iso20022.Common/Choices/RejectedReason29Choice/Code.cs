...
namespace BeneficialStrategies.Iso20022.Choices.RejectedReason29Choice
{
    ...
    #else
    public partial class Code : RejectedReason29Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( RejectionReason51Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public RejectionReason51Code Value { get; init; } 
        #else
        public RejectionReason51Code Value { get; set; } 
        #endif
