...
namespace BeneficialStrategies.Iso20022.Choices.MatchingStatus9Choice
{
    ...
    /// </summary>
    [IsoId("_A4aEJNokEeC60axPepSq7g_1625799281")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record MatchedWithTolerance : MatchingStatus9Choice_
    #else
    public partial class MatchedWithTolerance : MatchingStatus9Choice_
    #endif
    {
