...
namespace BeneficialStrategies.Iso20022.Choices.PartyOrGroup1Choice
{
    ...
    #else
    public partial class GroupIdentification : PartyOrGroup1Choice_
    #endif
    {
        ...
        #else
        /// <summary>
        /// Constructs a GroupIdentification instance using the members the ISO20022 deems required.
        /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
        /// </summary>
        public GroupIdentification( System.String reqValue )
        {
            Value = reqValue;
        }
        #endif
