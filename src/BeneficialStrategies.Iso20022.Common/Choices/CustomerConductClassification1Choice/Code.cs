...
namespace BeneficialStrategies.Iso20022.Choices.CustomerConductClassification1Choice
{
    ...
    #else
    public partial class Code : CustomerConductClassification1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ConductClassification1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ConductClassification1Code Value { get; init; } 
        #else
        public ConductClassification1Code Value { get; set; } 
        #endif
