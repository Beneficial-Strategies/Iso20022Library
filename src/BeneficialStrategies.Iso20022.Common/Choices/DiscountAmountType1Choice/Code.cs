...
namespace BeneficialStrategies.Iso20022.Choices.DiscountAmountType1Choice
{
    ...
    #else
    public partial class Code : DiscountAmountType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ExternalDiscountAmountType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ExternalDiscountAmountType1Code Value { get; init; } 
        #else
        public ExternalDiscountAmountType1Code Value { get; set; } 
        #endif
