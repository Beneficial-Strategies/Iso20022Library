...
namespace BeneficialStrategies.Iso20022.Choices.SecurityIdentificationQuery4Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ISIN : SecurityIdentificationQuery4Choice_
    #else
    public partial class ISIN : SecurityIdentificationQuery4Choice_
    #endif
    {
