...
namespace BeneficialStrategies.Iso20022.Choices.ReturnExcessCash1Choice
{
    ...
    #else
    public partial class Code : ReturnExcessCash1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ReturnExcessCash1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ReturnExcessCash1Code Value { get; init; } 
        #else
        public ReturnExcessCash1Code Value { get; set; } 
        #endif
