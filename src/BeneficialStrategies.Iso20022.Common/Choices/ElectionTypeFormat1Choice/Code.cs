...
namespace BeneficialStrategies.Iso20022.Choices.ElectionTypeFormat1Choice
{
    ...
    #else
    public partial class Code : ElectionTypeFormat1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( ElectionMovementType2Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public ElectionMovementType2Code Value { get; init; } 
        #else
        public ElectionMovementType2Code Value { get; set; } 
        #endif
