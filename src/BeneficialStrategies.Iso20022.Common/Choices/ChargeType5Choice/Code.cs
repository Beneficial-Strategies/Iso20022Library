...
namespace BeneficialStrategies.Iso20022.Choices.ChargeType5Choice
{
    ...
    #else
    public partial class Code : ChargeType5Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( InvestmentFundFee1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public InvestmentFundFee1Code Value { get; init; } 
        #else
        public InvestmentFundFee1Code Value { get; set; } 
        #endif
