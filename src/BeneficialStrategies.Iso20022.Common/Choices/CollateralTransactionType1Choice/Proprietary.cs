...
namespace BeneficialStrategies.Iso20022.Choices.CollateralTransactionType1Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Proprietary : CollateralTransactionType1Choice_
    #else
    public partial class Proprietary : CollateralTransactionType1Choice_
    #endif
    {
