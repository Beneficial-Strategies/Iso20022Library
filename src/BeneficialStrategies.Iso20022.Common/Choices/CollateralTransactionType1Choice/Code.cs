...
namespace BeneficialStrategies.Iso20022.Choices.CollateralTransactionType1Choice
{
    ...
    #else
    public partial class Code : CollateralTransactionType1Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CollateralTransactionType1Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CollateralTransactionType1Code Value { get; init; } 
        #else
        public CollateralTransactionType1Code Value { get; set; } 
        #endif
