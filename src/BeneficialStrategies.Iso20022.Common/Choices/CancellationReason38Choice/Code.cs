...
namespace BeneficialStrategies.Iso20022.Choices.CancellationReason38Choice
{
    ...
    #else
    public partial class Code : CancellationReason38Choice_
    #endif
    {
        ...
        /// </summary>
        public Code( CancelledStatusReason17Code reqValue )
        {
            Value = reqValue;
        }
        #endif
        ...
        public CancelledStatusReason17Code Value { get; init; } 
        #else
        public CancelledStatusReason17Code Value { get; set; } 
        #endif
