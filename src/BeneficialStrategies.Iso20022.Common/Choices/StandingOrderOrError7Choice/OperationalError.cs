...
namespace BeneficialStrategies.Iso20022.Choices.StandingOrderOrError7Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record OperationalError : StandingOrderOrError7Choice_
    #else
    public partial class OperationalError : StandingOrderOrError7Choice_
    #endif
    {
