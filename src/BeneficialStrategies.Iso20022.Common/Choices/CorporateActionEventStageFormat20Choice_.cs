...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(CorporateActionEventStageFormat20Choice.Code),
        nameof(CorporateActionEventStageFormat20Choice.Code)
    )]
    [JsonDerivedType(
        typeof(CorporateActionEventStageFormat20Choice.Proprietary),
        nameof(CorporateActionEventStageFormat20Choice.Proprietary)
    )]
    [IsoId("_c5V6I5KQEeWHWpTQn1FFVg")]
    [DisplayName("Corporate Action Event Stage Format 20 Choice")]
    public abstract record CorporateActionEventStageFormat20Choice_ { }
}
