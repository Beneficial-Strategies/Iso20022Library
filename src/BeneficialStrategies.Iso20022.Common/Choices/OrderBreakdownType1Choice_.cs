...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(
        typeof(OrderBreakdownType1Choice.Code),
        nameof(OrderBreakdownType1Choice.Code)
    )]
    [JsonDerivedType(
        typeof(OrderBreakdownType1Choice.Proprietary),
        nameof(OrderBreakdownType1Choice.Proprietary)
    )]
    [IsoId("_uwnTwDhjEeamLZQeccJa7w")]
    [DisplayName("Order Breakdown Type 1 Choice")]
    public abstract record OrderBreakdownType1Choice_ { }
}
