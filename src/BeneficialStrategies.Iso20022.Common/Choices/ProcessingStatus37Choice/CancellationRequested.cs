...
namespace BeneficialStrategies.Iso20022.Choices.ProcessingStatus37Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record CancellationRequested : ProcessingStatus37Choice_
    #else
    public partial class CancellationRequested : ProcessingStatus37Choice_
    #endif
    {
