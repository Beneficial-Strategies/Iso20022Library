...
namespace BeneficialStrategies.Iso20022.Choices.InstructionCancellationRequestStatus11Choice
{
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record Rejected : InstructionCancellationRequestStatus11Choice_
    #else
    public partial class Rejected : InstructionCancellationRequestStatus11Choice_
    #endif
    {
