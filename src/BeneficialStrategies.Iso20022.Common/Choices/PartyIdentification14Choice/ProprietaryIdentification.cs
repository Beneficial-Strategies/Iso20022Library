...
namespace BeneficialStrategies.Iso20022.Choices.PartyIdentification14Choice
{
    ...
    /// </summary>
    [IsoId("_QP-6wNp-Ed-ak6NoX_4Aeg_171785389")]
    ...
    #endif
    #if NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public partial record ProprietaryIdentification : PartyIdentification14Choice_
    #else
    public partial class ProprietaryIdentification : PartyIdentification14Choice_
    #endif
    {
