...
public partial record VoteParameters7
{
    ...
    #else
    /// <summary>
    /// Constructs a VoteParameters7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public VoteParameters7( System.String reqPartialVoteAllowed,System.String reqSplitVoteAllowed )
    {
    ...
    public VoteMethods4? VoteMethods { get; init; } 
    #else
    public VoteMethods4? VoteMethods { get; set; } 
    #endif
