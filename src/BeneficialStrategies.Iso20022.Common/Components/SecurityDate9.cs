...
public partial record SecurityDate9
{
    ...
    #else
    /// <summary>
    /// Constructs a SecurityDate9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecurityDate9( DateFormat19Choice_ reqPaymentDate )
    {
    ...
    public DateFormat19Choice_? LastTradingDate { get; init; } 
    #else
    public DateFormat19Choice_? LastTradingDate { get; set; } 
    #endif
