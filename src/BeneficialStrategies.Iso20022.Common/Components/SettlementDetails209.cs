...
public partial record SettlementDetails209
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails209 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails209( SecuritiesTransactionType55Choice_ reqSecuritiesTransactionType )
    {
