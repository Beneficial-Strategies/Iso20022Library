...
public partial record SubAccountIdentification45
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification45 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification45( SecuritiesAccount34 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalanceInformation32? BalanceForSubAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalanceInformation32? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation32? BalanceForSubAccount { get; set; } 
    #endif
