...
public partial record PaymentInstruction20
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentInstruction20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction20( System.String reqPaymentInformationIdentification,PaymentMethod3Code reqPaymentMethod,System.DateOnly reqRequestedExecutionDate,PartyIdentification43 reqDebtor,CashAccount24 reqDebtorAccount,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent )
    {
    ...
    /// </summary>
    [IsoId("_21xJhzq4EeWZFYSPlduMhw")]
    [DisplayName("Credit Transfer Transaction Information")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="CdtTrfTxInf")]
    #endif
    [IsoXmlTag("CdtTrfTxInf")]
    public ValueList<CreditTransferTransaction26> CreditTransferTransactionInformation { get; init; } = new ValueList<CreditTransferTransaction26>(){}; // Warning: Don't know multiplicity.
