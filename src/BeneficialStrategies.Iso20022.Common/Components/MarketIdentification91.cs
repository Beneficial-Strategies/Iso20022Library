...
public partial record MarketIdentification91
{
    ...
    #else
    /// <summary>
    /// Constructs a MarketIdentification91 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MarketIdentification91( MarketType17Choice_ reqType )
    {
        Type = reqType;
    }
    #endif
    ...
    public required MarketType17Choice_ Type { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MarketType17Choice_ Type { get; init; } 
    #else
    public MarketType17Choice_ Type { get; set; } 
    #endif
