...
public partial record ISATransfer27
{
    ...
    #else
    /// <summary>
    /// Constructs a ISATransfer27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ISATransfer27( System.String reqTransferIdentification )
    {
    ...
    public FinancialInstrument50? FinancialInstrumentAssetForTransfer { get; init; } 
    #else
    public FinancialInstrument50? FinancialInstrumentAssetForTransfer { get; set; } 
    #endif
