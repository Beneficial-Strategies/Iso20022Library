...
public partial record PendingStatusReason7
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason7( PendingReason24Choice_ reqReasonCode )
    {
    ...
    public PendingReason24Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason24Choice_ ReasonCode { get; set; } 
    #endif
