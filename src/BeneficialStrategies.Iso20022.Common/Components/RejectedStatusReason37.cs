...
public partial record RejectedStatusReason37
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason37 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason37( RejectedReason39Choice_ reqReasonCode )
    {
    ...
    public RejectedReason39Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason39Choice_ ReasonCode { get; set; } 
    #endif
