...
/// <summary>
/// Corporate Action Option SD16.
/// </summary>
[IsoId("_UwK-YYbrEe--EK81FcmyRA")]
[DisplayName("Corporate Action Option SD16")]
public partial record CorporateActionOptionSD16
{
    #nullable enable
    ...
    public ValueList<ExtendedOptionFeature2Code> ExtendedOptionFeatures { get; init; } = [];
