...
public partial record PendingStatusReason23
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason23( PendingReason61Choice_ reqReasonCode )
    {
