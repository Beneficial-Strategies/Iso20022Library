...
public partial record GenericOrganisationIdentification2
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericOrganisationIdentification2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericOrganisationIdentification2( System.String reqIdentification )
    {
    ...
    public OrganisationIdentificationSchemeName2Choice_? SchemeName { get; init; } 
    #else
    public OrganisationIdentificationSchemeName2Choice_? SchemeName { get; set; } 
    #endif
