...
public partial record FinancialInstrument5
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrument5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrument5( SecurityIdentification1Choice_ reqIdentification,System.String reqDualFundIndicator )
    {
