...
public partial record FinancialInstrumentDetails20
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentDetails20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentDetails20( SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    #endif
    [IsoXmlTag("Tx")]
    public ValueList<Transaction46> Transaction { get; init; } = new ValueList<Transaction46>(){}; // Warning: Don't know multiplicity.
