...
public partial record AccountAndBalance16
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountAndBalance16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountAndBalance16( System.String reqSafekeepingAccount,CorporateActionBalanceDetails11 reqBalance )
    {
    ...
    public required CorporateActionBalanceDetails11 Balance { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionBalanceDetails11 Balance { get; init; } 
    #else
    public CorporateActionBalanceDetails11 Balance { get; set; } 
    #endif
