...
public partial record CreditTransferTransaction38
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction38( System.String reqCreditIdentification,BranchAndFinancialInstitutionIdentification6 reqCreditor )
    {
    ...
    public ValueList<DirectDebitTransactionInformation25> DirectDebitTransactionInformation { get; init; } = new ValueList<DirectDebitTransactionInformation25>(){}; // Warning: Don't know multiplicity.
