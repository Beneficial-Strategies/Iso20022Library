...
public partial record ATMContext19
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMContext19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMContext19( ATMService23 reqService )
    {
        Service = reqService;
    }
    #endif
    ...
    #else
    public ATMService23 Service { get; set; } 
    #endif
