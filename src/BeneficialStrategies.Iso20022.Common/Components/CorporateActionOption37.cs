...
public record CorporateActionOption37
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption26> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption18> CashMovementDetails { get; init; } = [];
}
