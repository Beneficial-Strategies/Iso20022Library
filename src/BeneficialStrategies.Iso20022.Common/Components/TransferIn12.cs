...
public partial record TransferIn12
{
    ...
    #else
    /// <summary>
    /// Constructs a TransferIn12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransferIn12( InvestmentAccount40 reqAccountDetails )
    {
