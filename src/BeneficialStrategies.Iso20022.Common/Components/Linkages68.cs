...
public partial record Linkages68
{
    ...
    #else
    /// <summary>
    /// Constructs a Linkages68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Linkages68( References78Choice_ reqReference )
    {
    ...
    public required References78Choice_ Reference { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public References78Choice_ Reference { get; init; } 
    #else
    public References78Choice_ Reference { get; set; } 
    #endif
