...
public partial record InvestmentAccount75
{
    ...
    #if DECLARE_DATACONTRACT
    [DataMember(Name="AcctStsUpdInstr")]
    #endif
    ...
    #if DECLARE_DATACONTRACT
    [DataMember(Name="ModfdFinInstrmDtls")]
    #endif
    [IsoXmlTag("ModfdFinInstrmDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public ModificationScope42? ModifiedFinancialInstrumentDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ModificationScope42? ModifiedFinancialInstrumentDetails { get; init; } 
    #else
    public ModificationScope42? ModifiedFinancialInstrumentDetails { get; set; } 
    #endif
    ...
    #if DECLARE_DATACONTRACT
    [DataMember(Name="ModfdInvstrPrfl")]
    #endif
    [IsoXmlTag("ModfdInvstrPrfl")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public ModificationScope46? ModifiedInvestorProfile { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ModificationScope46? ModifiedInvestorProfile { get; init; } 
    #else
    public ModificationScope46? ModifiedInvestorProfile { get; set; } 
    #endif
