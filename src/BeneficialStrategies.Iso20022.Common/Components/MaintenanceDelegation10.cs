...
public partial record MaintenanceDelegation10
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegation10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegation10( TerminalManagementAction3Code reqDelegationType )
    {
    ...
    #endif
    [IsoXmlTag("MntncSvc")]
    public SimpleValueList<DataSetCategory15Code> MaintenanceService { get; init; } = new SimpleValueList<DataSetCategory15Code>(){}; // Warning: Don't know multiplicity.
    ...
    public MaintenanceDelegateAction5? DelegatedAction { get; init; } 
    #else
    public MaintenanceDelegateAction5? DelegatedAction { get; set; } 
    #endif
    ...
    public AcceptorConfigurationDataSet1? ParameterDataSet { get; init; } 
    #else
    public AcceptorConfigurationDataSet1? ParameterDataSet { get; set; } 
    #endif
