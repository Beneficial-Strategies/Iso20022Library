...
public partial record CorporateActionGeneralInformation55
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation55 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation55( System.String reqCorporateActionEventIdentification,CorporateActionEventType11Choice_ reqEventType )
    {
