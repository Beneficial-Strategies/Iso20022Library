...
public partial record TransactionIdentifications3
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications3( System.String reqAccountOwnerTransactionIdentification )
    {
