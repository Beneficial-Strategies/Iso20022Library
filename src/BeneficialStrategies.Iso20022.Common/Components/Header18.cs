...
public partial record Header18
{
    ...
    #else
    /// <summary>
    /// Constructs a Header18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Header18( MessageFunction6Code reqMessageFunction,MessageFunction6Code reqOriginalMessageFunction,System.String reqProtocolVersion,System.String reqExchangeIdentification,System.DateTime reqCreationDateTime,GenericIdentification73 reqInitiatingParty )
    {
        MessageFunction = reqMessageFunction;
        OriginalMessageFunction = reqOriginalMessageFunction;
