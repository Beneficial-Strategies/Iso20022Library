...
public partial record UnderlyingPaymentTransaction4
{
    ...
    #else
    /// <summary>
    /// Constructs a UnderlyingPaymentTransaction4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnderlyingPaymentTransaction4( ActiveOrHistoricCurrencyAndAmount reqOriginalInterbankSettlementAmount,System.DateOnly reqOriginalInterbankSettlementDate )
    {
