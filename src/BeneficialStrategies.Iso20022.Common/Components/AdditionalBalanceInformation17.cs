...
public partial record AdditionalBalanceInformation17
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalBalanceInformation17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalBalanceInformation17( SubBalanceType14Choice_ reqSubBalanceType,Balance13 reqQuantity )
    {
