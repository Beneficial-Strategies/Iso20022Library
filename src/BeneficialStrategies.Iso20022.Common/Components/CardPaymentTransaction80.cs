...
public partial record CardPaymentTransaction80
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction80 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction80( System.String reqTransactionCapture,TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails45 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails45 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails45 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails45 TransactionDetails { get; set; } 
    #endif
