...
public partial record RejectedStatusReason29
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason29( RejectedReason30Choice_ reqReasonCode )
    {
    ...
    public RejectedReason30Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason30Choice_ ReasonCode { get; set; } 
    #endif
