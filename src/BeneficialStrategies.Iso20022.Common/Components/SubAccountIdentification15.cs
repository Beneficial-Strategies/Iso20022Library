...
public partial record SubAccountIdentification15
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification15( SecuritiesAccount14 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
