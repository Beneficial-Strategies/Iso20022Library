...
public partial record CardPaymentDataSetTransaction34
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction34( System.String reqTransactionSequenceCounter,CardPaymentEnvironment77 reqEnvironment,CardPaymentTransaction103 reqTransaction )
    {
