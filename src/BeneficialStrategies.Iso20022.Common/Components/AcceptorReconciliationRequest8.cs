...
public partial record AcceptorReconciliationRequest8
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequest8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequest8( CardPaymentEnvironment74 reqEnvironment,TransactionReconciliation4 reqTransaction )
    {
