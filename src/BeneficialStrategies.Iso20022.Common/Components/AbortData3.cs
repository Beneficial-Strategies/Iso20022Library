...
public partial record AbortData3
{
    ...
    #else
    /// <summary>
    /// Constructs a AbortData3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AbortData3( System.String reqExchangeIdentification,System.String reqAbortReason )
    {
