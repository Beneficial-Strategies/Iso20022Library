...
public partial record SecuritiesOption24
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption24( FinancialInstrumentAttributes34 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate5 reqDateDetails )
    {
    ...
    public CorporateActionPrice26? PriceDetails { get; init; } 
    #else
    public CorporateActionPrice26? PriceDetails { get; set; } 
    #endif
