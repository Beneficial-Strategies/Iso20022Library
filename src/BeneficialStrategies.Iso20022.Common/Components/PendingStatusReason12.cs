...
public partial record PendingStatusReason12
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason12( PendingReason35Choice_ reqReasonCode )
    {
    ...
    public PendingReason35Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason35Choice_ ReasonCode { get; set; } 
    #endif
