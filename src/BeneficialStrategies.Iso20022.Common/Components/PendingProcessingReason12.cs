...
public partial record PendingProcessingReason12
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingProcessingReason12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingProcessingReason12( PendingProcessingReason14Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public PendingProcessingReason14Choice_ Code { get; init; } 
    #else
    public PendingProcessingReason14Choice_ Code { get; set; } 
    #endif
