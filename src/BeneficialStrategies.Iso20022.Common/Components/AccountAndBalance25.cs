...
public partial record AccountAndBalance25
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountAndBalance25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountAndBalance25( System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionBalanceDetails21? Balance { get; init; } 
    #else
    public CorporateActionBalanceDetails21? Balance { get; set; } 
    #endif
