...
public partial record OriginalNotification13
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalNotification13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalNotification13( System.String reqOriginalMessageIdentification,System.String reqOriginalNotificationIdentification )
    {
    ...
    public OriginalNotificationReference11? OriginalNotificationReference { get; init; } 
    #else
    public OriginalNotificationReference11? OriginalNotificationReference { get; set; } 
    #endif
