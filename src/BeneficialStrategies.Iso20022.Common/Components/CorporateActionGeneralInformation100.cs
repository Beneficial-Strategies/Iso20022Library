...
public partial record CorporateActionGeneralInformation100
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation100 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation100( System.String reqCorporateActionEventIdentification,CorporateActionEventType42Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes70 reqUnderlyingSecurity )
    {
