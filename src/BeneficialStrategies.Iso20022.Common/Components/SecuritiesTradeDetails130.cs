...
public partial record SecuritiesTradeDetails130
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails130 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails130( SettlementDate20Choice_ reqSettlementDate )
    {
