...
public partial record ISATransfer10
{
    ...
    #else
    /// <summary>
    /// Constructs a ISATransfer10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ISATransfer10( System.String reqTransferConfirmationIdentification,System.String reqTransferInstructionReference,System.DateOnly reqActualTransferDate,ISAPortfolio2Choice_ reqPortfolio,System.String reqAllOtherCash )
    {
    ...
    public FinancialInstrument33? FinancialInstrumentAssetForTransfer { get; init; } 
    #else
    public FinancialInstrument33? FinancialInstrumentAssetForTransfer { get; set; } 
    #endif
