...
public partial record SubAccountIdentification23
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification23( SecuritiesAccount14 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation17? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation17? BalanceForSubAccount { get; set; } 
    #endif
