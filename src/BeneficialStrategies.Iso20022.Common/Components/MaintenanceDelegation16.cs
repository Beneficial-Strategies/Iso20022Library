...
public partial record MaintenanceDelegation16
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegation16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegation16( Response2Code reqResponse,TerminalManagementAction3Code reqDelegationType )
    {
