...
public partial record TransactionIdentifications34
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications34( System.String reqAccountOwnerTransactionIdentification )
    {
