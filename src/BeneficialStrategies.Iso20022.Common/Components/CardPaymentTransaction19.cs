...
public partial record CardPaymentTransaction19
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction19( System.String reqTransactionCapture,TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails10 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails10 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails10 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails10 TransactionDetails { get; set; } 
    #endif
