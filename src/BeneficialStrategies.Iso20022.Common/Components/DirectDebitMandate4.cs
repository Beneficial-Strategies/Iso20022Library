...
public partial record DirectDebitMandate4
{
    ...
    #else
    /// <summary>
    /// Constructs a DirectDebitMandate4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DirectDebitMandate4( AccountIdentificationAndName3 reqDebtorAccount,FinancialInstitutionIdentification3Choice_ reqDebtorAgent )
    {
