...
public partial record CreditTransferTransaction41
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction41( PaymentIdentification6 reqPaymentIdentification,ActiveCurrencyAndAmount reqAmount,BranchAndFinancialInstitutionIdentification6 reqCreditorAgent )
    {
