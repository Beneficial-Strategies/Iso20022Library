...
public record CorporateActionRate92
{
    /// <summary>
    ...
    public ValueList<GrossDividendRateFormat31Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat33Choice_> NetDividendRate { get; init; } = [];
