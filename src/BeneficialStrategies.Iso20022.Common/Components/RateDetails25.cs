...
public record RateDetails25
{
    ...
    public ValueList<GrossDividendRateFormat26Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat28Choice_> NetDividendRate { get; init; } = [];
    ...
    public ValueList<TaxCreditRateFormat10Choice_> TaxCreditRate { get; init; } = [];
