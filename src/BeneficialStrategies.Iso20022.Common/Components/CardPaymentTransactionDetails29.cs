...
public partial record CardPaymentTransactionDetails29
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransactionDetails29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransactionDetails29( string reqCurrency,ImpliedCurrencyAndAmount reqTotalAmount )
    {
