...
public partial record ISATransfer7
{
    ...
    #else
    /// <summary>
    /// Constructs a ISATransfer7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ISATransfer7( System.String reqTransferIdentification,ISAPortfolio1Choice_ reqPortfolio,System.String reqAllOtherCash )
    {
    ...
    public FinancialInstrument31? FinancialInstrumentAssetForTransfer { get; init; } 
    #else
    public FinancialInstrument31? FinancialInstrumentAssetForTransfer { get; set; } 
    #endif
