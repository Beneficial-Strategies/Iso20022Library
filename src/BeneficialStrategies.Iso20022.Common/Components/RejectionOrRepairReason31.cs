...
public partial record RejectionOrRepairReason31
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionOrRepairReason31 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionOrRepairReason31( RejectionAndRepairReason31Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
