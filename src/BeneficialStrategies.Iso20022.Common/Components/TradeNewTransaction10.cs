...
public partial record TradeNewTransaction10
{
    ...
    #else
    /// <summary>
    /// Constructs a TradeNewTransaction10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TradeNewTransaction10( CommonTradeDataReport38 reqCommonTradeData )
    {
