...
public partial record TransactionDetails28
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails28 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails28( SecurityIdentification14 reqFinancialInstrumentIdentification,SettlementDate1Choice_ reqSettlementDate,Quantity6Choice_ reqSettlementQuantity )
    {
    ...
    public SettlementParties12? DeliveringSettlementParties { get; init; } 
    #else
    public SettlementParties12? DeliveringSettlementParties { get; set; } 
    #endif
    ...
    public SettlementParties12? ReceivingSettlementParties { get; init; } 
    #else
    public SettlementParties12? ReceivingSettlementParties { get; set; } 
    #endif
