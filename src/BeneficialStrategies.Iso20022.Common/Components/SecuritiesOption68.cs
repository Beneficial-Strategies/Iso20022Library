...
public partial record SecuritiesOption68
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption68( FinancialInstrumentAttributes83 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate18 reqDateDetails )
    {
