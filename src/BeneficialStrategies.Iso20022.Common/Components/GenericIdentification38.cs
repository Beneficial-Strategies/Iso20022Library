...
public partial record GenericIdentification38
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification38( System.String reqIdentification,System.String reqIssuer )
    {
