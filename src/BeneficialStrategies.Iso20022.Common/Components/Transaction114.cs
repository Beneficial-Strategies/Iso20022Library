...
public partial record Transaction114
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction114 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction114( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails132? TransactionDetails { get; init; } 
    #else
    public TransactionDetails132? TransactionDetails { get; set; } 
    #endif
