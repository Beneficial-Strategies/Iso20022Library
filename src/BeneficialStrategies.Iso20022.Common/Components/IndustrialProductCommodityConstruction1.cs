...
public partial record IndustrialProductCommodityConstruction1
{
    ...
    #else
    /// <summary>
    /// Constructs a IndustrialProductCommodityConstruction1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IndustrialProductCommodityConstruction1( AssetClassProductType6Code reqBaseProduct )
    {
