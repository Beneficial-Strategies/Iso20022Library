...
public partial record SubBalanceInformation23
{
    ...
    #else
    /// <summary>
    /// Constructs a SubBalanceInformation23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubBalanceInformation23( SubBalanceType13Choice_ reqSubBalanceType,SubBalanceQuantity9Choice_ reqQuantity )
    {
    ...
    public AdditionalBalanceInformation23? AdditionalBalanceBreakdownDetails { get; init; } 
    #else
    public AdditionalBalanceInformation23? AdditionalBalanceBreakdownDetails { get; set; } 
    #endif
