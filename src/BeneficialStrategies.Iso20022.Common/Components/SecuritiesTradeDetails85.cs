...
public partial record SecuritiesTradeDetails85
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails85 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails85( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate20Choice_ reqSettlementDate,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount71 reqQuantityAndAccountDetails,SettlementDetails153 reqSettlementParameters )
    {
    ...
    public required QuantityAndAccount71 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount71 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount71 QuantityAndAccountDetails { get; set; } 
    #endif
