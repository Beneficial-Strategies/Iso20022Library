...
public partial record TradeTransactionOther6
{
    ...
    #else
    /// <summary>
    /// Constructs a TradeTransactionOther6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TradeTransactionOther6( CommonTradeDataReport37 reqCommonTradeData )
    {
