...
public partial record TransactionDetails158
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails158 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails158( SecurityIdentification20 reqFinancialInstrumentIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity54Choice_ reqSettlementQuantity,SettlementDate32Choice_ reqSettlementDate )
    {
