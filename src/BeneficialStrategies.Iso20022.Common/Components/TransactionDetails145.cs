...
public partial record TransactionDetails145
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails145 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails145( TransactionActivity4Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity10Choice_ reqPostingQuantity,DateAndDateTime2Choice_ reqEffectiveSettlementDate )
    {
