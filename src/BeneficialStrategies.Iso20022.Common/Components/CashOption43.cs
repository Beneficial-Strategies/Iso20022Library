...
public partial record CashOption43
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption43 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption43( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate47 reqDateDetails )
    {
