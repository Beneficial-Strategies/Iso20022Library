...
public partial record QuantityAndAccount104
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount104 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount104( Quantity54Choice_ reqSettlementQuantity )
    {
