...
public record CorporateActionNarrative51
{
    ...
    [IsoXmlTag("AddtlTxt")]
    public ValueList<UpdatedAdditionalInformation13> AdditionalText { get; init; } = [];
    ...
    [IsoXmlTag("NrrtvVrsn")]
    public ValueList<UpdatedAdditionalInformation13> NarrativeVersion { get; init; } = [];
    ...
    [IsoXmlTag("InfConds")]
    public ValueList<UpdatedAdditionalInformation13> InformationConditions { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> InformationToComplyWith { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> TaxationConditions { get; init; } = [];
    ...
    [IsoXmlTag("Dsclmr")]
    public ValueList<UpdatedAdditionalInformation13> Disclaimer { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> PartyContactNarrative { get; init; } = [];
    ...
    [IsoXmlTag("RegnDtls")]
    public ValueList<UpdatedAdditionalInformation13> RegistrationDetails { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> BasketOrIndexInformation { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> CertificationBreakdown { get; init; } = [];
    ...
    public ValueList<UpdatedAdditionalInformation13> ProcessingTextForNextIntermediary { get; init; } =
        [];
}
