...
public partial record ApplicationParameters4
{
    ...
    #else
    /// <summary>
    /// Constructs a ApplicationParameters4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ApplicationParameters4( System.String reqApplicationIdentification,System.String reqVersion )
    {
