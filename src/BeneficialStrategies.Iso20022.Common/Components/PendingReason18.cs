...
public partial record PendingReason18
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingReason18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingReason18( PendingReason31Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public PendingReason31Choice_ Code { get; init; } 
    #else
    public PendingReason31Choice_ Code { get; set; } 
    #endif
