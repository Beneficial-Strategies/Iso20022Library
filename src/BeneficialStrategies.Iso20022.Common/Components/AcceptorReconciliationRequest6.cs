...
public partial record AcceptorReconciliationRequest6
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequest6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequest6( CardPaymentEnvironment67 reqEnvironment,TransactionReconciliation4 reqTransaction )
    {
    ...
    public CardPaymentEnvironment67 Environment { get; init; } 
    #else
    public CardPaymentEnvironment67 Environment { get; set; } 
    #endif
