...
/// Rate46.
/// </summary>
[IsoId("_l6ZbOpt3Ee-wQIOX0djF2w")]
[DisplayName("Rate46")]
public partial record Rate46
{
    #nullable enable
    ...
    [IsoXmlTag("ChrgsFees")]
    public RateAndAmountFormat69Choice_? ChargesFees { get; init; } 
    ...
    [IsoXmlTag("DmdRate")]
    public ValueList<RateAndAmountFormat71Choice_> DeemedRate { get; init; } = [];
    ...
    public SolicitationFeeRateFormat14Choice_? EarlySolicitationFeeRate { get; init; } 
    ...
    public SolicitationFeeRateFormat14Choice_? SolicitationFeeRate { get; init; } 
    ...
    public RateFormat29Choice_? TaxCreditRate { get; init; } 
    ...
    public RateFormat29Choice_? ThirdPartyIncentiveRate { get; init; } 
