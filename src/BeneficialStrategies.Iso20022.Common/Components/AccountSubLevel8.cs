...
public partial record AccountSubLevel8
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSubLevel8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSubLevel8( SecuritiesAccount19 reqAccountIdentification,PartyIdentification100 reqAccountOwner,PartyIdentification100 reqAccountServicer )
    {
    ...
    public AccountSubLevel9? AccountSubLevel9 { get; init; } 
    #else
    public AccountSubLevel9? AccountSubLevel9 { get; set; } 
    #endif
