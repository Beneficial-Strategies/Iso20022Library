...
public partial record PendingStatusReason17
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason17( PendingReason53Choice_ reqReasonCode )
    {
    ...
    public PendingReason53Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason53Choice_ ReasonCode { get; set; } 
    #endif
