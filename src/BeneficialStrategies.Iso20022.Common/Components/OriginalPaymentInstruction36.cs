...
public partial record OriginalPaymentInstruction36
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction36 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction36( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    [IsoXmlTag("TxInf")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction124? TransactionInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction124? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction124? TransactionInformation { get; set; } 
    #endif
