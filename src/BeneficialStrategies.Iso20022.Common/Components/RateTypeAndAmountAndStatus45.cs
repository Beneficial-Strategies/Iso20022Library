...
public partial record RateTypeAndAmountAndStatus45
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus45 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus45( RateType75Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
    {
