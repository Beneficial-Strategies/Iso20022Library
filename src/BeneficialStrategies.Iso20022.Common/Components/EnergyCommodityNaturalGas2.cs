...
public partial record EnergyCommodityNaturalGas2
{
    ...
    #else
    /// <summary>
    /// Constructs a EnergyCommodityNaturalGas2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EnergyCommodityNaturalGas2( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType7Code reqSubProduct,AssetClassDetailedSubProductType31Code reqAdditionalSubProduct )
    {
