...
public partial record InvestmentAccount70
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccount70 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccount70( System.String reqAccountIdentification )
    {
    ...
    public PartyIdentification139? OwnerIdentification { get; init; } 
    #else
    public PartyIdentification139? OwnerIdentification { get; set; } 
    #endif
    
    /// <summary>
    /// Unique and unambiguous identification for the account between the account owner and the account servicer.
    /// </summary>
    [IsoId("_BlKUVZEFEem7fvtoGpNpow")]
