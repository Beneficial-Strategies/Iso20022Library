...
public record CorporateActionRate85
{
    /// <summary>
    ...
    public ValueList<GrossDividendRateFormat23Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat25Choice_> NetDividendRate { get; init; } = [];
