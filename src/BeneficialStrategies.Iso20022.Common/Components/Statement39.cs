...
public partial record Statement39
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement39 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement39( DateAndDateTimeChoice_ reqStatementDateTime,System.String reqActivityIndicator )
    {
