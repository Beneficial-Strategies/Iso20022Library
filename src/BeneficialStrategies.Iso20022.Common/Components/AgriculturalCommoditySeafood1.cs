...
public partial record AgriculturalCommoditySeafood1
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommoditySeafood1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommoditySeafood1( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType23Code reqSubProduct )
    {
