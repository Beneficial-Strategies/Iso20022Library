...
public partial record CorporateActionGeneralInformation90
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation90 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation90( System.String reqCorporateActionEventIdentification,CorporateActionEventType32Choice_ reqEventType )
    {
