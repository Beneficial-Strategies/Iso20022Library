...
public partial record ForeignExchangeTerms17
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTerms17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTerms17( string reqUnitCurrency,string reqQuotedCurrency,System.Decimal reqExchangeRate,ActiveCurrencyAndAmount reqResultingAmount )
    {
