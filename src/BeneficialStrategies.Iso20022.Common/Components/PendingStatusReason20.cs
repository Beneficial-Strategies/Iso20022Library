...
public partial record PendingStatusReason20
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason20( PendingReason56Choice_ reqReasonCode )
    {
    ...
    public PendingReason56Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason56Choice_ ReasonCode { get; set; } 
    #endif
