...
public partial record Transaction64
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction64 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction64( System.String reqAccountOwnerTransactionIdentification )
    {
