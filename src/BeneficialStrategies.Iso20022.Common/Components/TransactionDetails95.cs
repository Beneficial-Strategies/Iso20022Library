...
public partial record TransactionDetails95
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails95 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails95( TransactionActivity3Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity6Choice_ reqPostingQuantity,DateAndDateTimeChoice_ reqEffectiveSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent19Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent19Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    ...
    public SettlementDetails126? SettlementParameters { get; init; } 
    #else
    public SettlementDetails126? SettlementParameters { get; set; } 
    #endif
