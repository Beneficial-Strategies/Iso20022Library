...
public partial record AgriculturalCommodityLiveStock1
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommodityLiveStock1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommodityLiveStock1( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType22Code reqSubProduct )
    {
