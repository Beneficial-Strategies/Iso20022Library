...
public partial record AcknowledgementReason21
{
    ...
    #else
    /// <summary>
    /// Constructs a AcknowledgementReason21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcknowledgementReason21( AcknowledgementReason24Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public AcknowledgementReason24Choice_ Code { get; init; } 
    #else
    public AcknowledgementReason24Choice_ Code { get; set; } 
    #endif
