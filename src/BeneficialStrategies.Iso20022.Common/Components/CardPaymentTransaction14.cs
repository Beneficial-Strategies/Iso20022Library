...
public partial record CardPaymentTransaction14
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction14( TransactionIdentifier1 reqTransactionIdentification,System.String reqTransactionSuccess,CardPaymentTransactionDetails4 reqTransactionDetails )
    {
