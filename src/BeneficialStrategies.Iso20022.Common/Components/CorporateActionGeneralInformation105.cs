...
public partial record CorporateActionGeneralInformation105
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation105 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation105( System.String reqCorporateActionEventIdentification,CorporateActionEventType51Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes79 reqUnderlyingSecurity )
    {
