...
public partial record Linkages42
{
    ...
    #else
    /// <summary>
    /// Constructs a Linkages42 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Linkages42( References50Choice_ reqReference )
    {
