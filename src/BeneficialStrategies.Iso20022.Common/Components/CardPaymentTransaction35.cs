...
public partial record CardPaymentTransaction35
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction35( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails6 reqTransactionDetails )
    {
