...
public partial record AccountIdentification41
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification41( System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionEventAndBalance12? CorporateActionEventAndBalance { get; init; } 
    #else
    public CorporateActionEventAndBalance12? CorporateActionEventAndBalance { get; set; } 
    #endif
