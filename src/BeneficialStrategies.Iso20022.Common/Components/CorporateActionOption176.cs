...
public partial record CorporateActionOption176
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption176 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption176( System.String reqOptionNumber,CorporateActionOption36Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CorporateActionRate103? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate103? RateAndAmountDetails { get; set; } 
    #endif
