...
public partial record RejectionOrRepairReason33
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionOrRepairReason33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionOrRepairReason33( RejectionAndRepairReason33Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
