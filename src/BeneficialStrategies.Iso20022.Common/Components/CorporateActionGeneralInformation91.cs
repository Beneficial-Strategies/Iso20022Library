...
public partial record CorporateActionGeneralInformation91
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation91 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation91( System.String reqCorporateActionEventIdentification,CorporateActionEventType32Choice_ reqEventType )
    {
