...
public partial record PaymentTerminalParameters5
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentTerminalParameters5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentTerminalParameters5( TerminalManagementAction3Code reqActionType )
    {
