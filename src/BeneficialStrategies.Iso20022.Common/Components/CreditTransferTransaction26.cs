...
public partial record CreditTransferTransaction26
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction26( PaymentIdentification1 reqPaymentIdentification,AmountType4Choice_ reqAmount )
    {
