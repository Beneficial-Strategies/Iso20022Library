...
public partial record IntraPositionDetails63
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionDetails63 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionDetails63( SecuritiesBalanceType8Choice_ reqBalanceFrom )
    {
