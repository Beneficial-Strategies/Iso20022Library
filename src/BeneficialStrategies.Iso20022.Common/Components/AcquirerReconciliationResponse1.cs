...
public partial record AcquirerReconciliationResponse1
{
    ...
    #else
    /// <summary>
    /// Constructs a AcquirerReconciliationResponse1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcquirerReconciliationResponse1( CardTransactionEnvironment5 reqEnvironment,CardTransaction10 reqTransaction )
    {
    ...
    public required CardTransaction10 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardTransaction10 Transaction { get; init; } 
    #else
    public CardTransaction10 Transaction { get; set; } 
    #endif
