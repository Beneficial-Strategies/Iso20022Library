...
public partial record Transaction71
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction71 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction71( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails123? TransactionDetails { get; init; } 
    #else
    public TransactionDetails123? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Status and reason for the transaction.
    /// </summary>
    [IsoId("_iE4cW_fZEeiNZp_PtLohLw")]
