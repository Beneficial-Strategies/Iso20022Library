...
public partial record VerificationResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a VerificationResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public VerificationResponse2( Environment32 reqEnvironment,Context13 reqContext,Transaction140 reqTransaction,ProcessingResult18 reqProcessingResult )
    {
    ...
    public Environment32 Environment { get; init; } 
    #else
    public Environment32 Environment { get; set; } 
    #endif
    ...
    public required Transaction140 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction140 Transaction { get; init; } 
    #else
    public Transaction140 Transaction { get; set; } 
    #endif
    ...
    public required ProcessingResult18 ProcessingResult { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ProcessingResult18 ProcessingResult { get; init; } 
    #else
    public ProcessingResult18 ProcessingResult { get; set; } 
    #endif
