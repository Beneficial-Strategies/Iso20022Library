...
[DataContract]
#endif
public partial record PaymentInstruction9
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a PaymentInstruction9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction9( System.String reqPaymentInformationIdentification,PaymentMethod3Code reqPaymentMethod,System.DateOnly reqRequestedExecutionDate,PartyIdentification43 reqDebtor,CashAccount24 reqDebtorAccount,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent )
    {
    ...
    /// </summary>
    [IsoId("_QmOKjSHQEeKGep4bhmamiA")]
    [DisplayName("Credit Transfer Transaction Information")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="CdtTrfTxInf")]
    #endif
    [IsoXmlTag("CdtTrfTxInf")]
    public ValueList<CreditTransferTransaction6> CreditTransferTransactionInformation { get; init; } = new ValueList<CreditTransferTransaction6>(){}; // Warning: Don't know multiplicity.
    // ID for the above is _QmOKjSHQEeKGep4bhmamiA
