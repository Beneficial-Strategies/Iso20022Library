...
public partial record CancelledStatusReason13
{
    ...
    #else
    /// <summary>
    /// Constructs a CancelledStatusReason13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CancelledStatusReason13( CancelledReason10Choice_ reqReasonCode )
    {
