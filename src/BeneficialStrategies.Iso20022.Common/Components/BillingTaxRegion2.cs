...
public partial record BillingTaxRegion2
{
    ...
    #else
    /// <summary>
    /// Constructs a BillingTaxRegion2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BillingTaxRegion2( System.String reqRegionNumber,System.String reqRegionName,System.String reqCustomerTaxIdentification,AmountAndDirection34 reqSettlementAmount,AmountAndDirection34 reqTaxDueToRegion )
    {
    ...
    public BillingTaxIdentification2? SendingFinancialInstitution { get; init; } 
    #else
    public BillingTaxIdentification2? SendingFinancialInstitution { get; set; } 
    #endif
