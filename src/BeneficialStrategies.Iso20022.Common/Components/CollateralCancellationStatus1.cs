...
public partial record CollateralCancellationStatus1
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralCancellationStatus1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralCancellationStatus1( Status4Code reqCollateralStatusCode )
    {
    ...
    public RejectionStatus2? RejectionDetails { get; init; } 
    #else
    public RejectionStatus2? RejectionDetails { get; set; } 
    #endif
