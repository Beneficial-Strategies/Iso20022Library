...
public partial record Transaction53
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction53 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction53( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    [IsoXmlTag("TxDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public TransactionDetails96? TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionDetails96? TransactionDetails { get; init; } 
    #else
    public TransactionDetails96? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Status and reason for the transaction.
    /// </summary>
    [IsoId("_yFrUQXAnEeaxWKxOD2aB-w")]
