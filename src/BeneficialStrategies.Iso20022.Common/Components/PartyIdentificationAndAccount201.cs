...
public partial record PartyIdentificationAndAccount201
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount201 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount201( PartyIdentification240Choice_ reqIdentification )
    {
