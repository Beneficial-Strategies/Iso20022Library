...
public partial record ModificationScope22
{
    ...
    #else
    /// <summary>
    /// Constructs a ModificationScope22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModificationScope22( DataModification1Code reqModificationScopeIndication,DocumentToSend2 reqServiceLevelAgreement )
    {
    ...
    public required DocumentToSend2 ServiceLevelAgreement { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DocumentToSend2 ServiceLevelAgreement { get; init; } 
    #else
    public DocumentToSend2 ServiceLevelAgreement { get; set; } 
    #endif
