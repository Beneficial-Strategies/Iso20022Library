...
public partial record AllegmentMatchingReason1
{
    ...
    #else
    /// <summary>
    /// Constructs a AllegmentMatchingReason1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AllegmentMatchingReason1( AllegmentReason1Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
