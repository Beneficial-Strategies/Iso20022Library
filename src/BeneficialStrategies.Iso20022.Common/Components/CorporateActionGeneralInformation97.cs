...
public partial record CorporateActionGeneralInformation97
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation97 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation97( System.String reqCorporateActionEventIdentification,CorporateActionEventType36Choice_ reqEventType )
    {
    ...
    public FinancialInstrumentAttributes69? UnderlyingSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes69? UnderlyingSecurity { get; set; } 
    #endif
