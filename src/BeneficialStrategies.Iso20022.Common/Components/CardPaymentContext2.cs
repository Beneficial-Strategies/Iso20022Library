...
public partial record CardPaymentContext2
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentContext2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentContext2( PaymentContext2 reqPaymentContext )
    {
    ...
    public PaymentContext2 PaymentContext { get; init; } 
    #else
    public PaymentContext2 PaymentContext { get; set; } 
    #endif
