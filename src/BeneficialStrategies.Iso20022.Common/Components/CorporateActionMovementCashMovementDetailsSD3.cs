...
public partial record CorporateActionMovementCashMovementDetailsSD3
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementCashMovementDetailsSD3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementCashMovementDetailsSD3( System.String reqPlaceAndName,CreditDebitCode reqCreditDebitIndicator,DTCCPayoutType3Code reqPayoutType )
    {
