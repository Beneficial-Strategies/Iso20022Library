...
public partial record OriginalPaymentInstruction44
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction44 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction44( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction140? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction140? TransactionInformation { get; set; } 
    #endif
