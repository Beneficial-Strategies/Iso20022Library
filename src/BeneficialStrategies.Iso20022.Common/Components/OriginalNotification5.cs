...
public partial record OriginalNotification5
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalNotification5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalNotification5( System.String reqOriginalMessageIdentification,System.String reqOriginalNotificationIdentification )
    {
    ...
    public OriginalNotificationReference3? OriginalNotificationReference { get; init; } 
    #else
    public OriginalNotificationReference3? OriginalNotificationReference { get; set; } 
    #endif
