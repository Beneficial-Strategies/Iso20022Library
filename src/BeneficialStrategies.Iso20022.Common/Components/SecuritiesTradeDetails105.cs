...
public partial record SecuritiesTradeDetails105
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails105 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails105( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate20Choice_ reqSettlementDate,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount89 reqQuantityAndAccountDetails,SettlementDetails174 reqSettlementParameters )
    {
    ...
    public required QuantityAndAccount89 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount89 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount89 QuantityAndAccountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Details of the closing of the securities financing transaction.
    /// </summary>
    [IsoId("_kL7GY_fXEeiNZp_PtLohLw")]
