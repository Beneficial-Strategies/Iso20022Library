...
public partial record MessageStatusResponse6
{
    ...
    #else
    /// <summary>
    /// Constructs a MessageStatusResponse6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MessageStatusResponse6( CardPaymentEnvironment78 reqEnvironment,CardPaymentContext29 reqContext,MessageStatusResponseData6 reqMessageStatusResponseData,ResponseType11 reqResponse )
    {
    ...
    public required MessageStatusResponseData6 MessageStatusResponseData { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MessageStatusResponseData6 MessageStatusResponseData { get; init; } 
    #else
    public MessageStatusResponseData6 MessageStatusResponseData { get; set; } 
    #endif
