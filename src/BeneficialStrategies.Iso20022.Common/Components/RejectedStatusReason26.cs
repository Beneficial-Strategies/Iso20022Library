...
public partial record RejectedStatusReason26
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason26( RejectedReason27Choice_ reqReasonCode )
    {
    ...
    public RejectedReason27Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason27Choice_ ReasonCode { get; set; } 
    #endif
