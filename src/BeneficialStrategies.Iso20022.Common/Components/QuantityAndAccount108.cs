...
public partial record QuantityAndAccount108
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount108 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount108( Quantity54Choice_ reqSettledQuantity )
    {
    ...
    public Quantity54Choice_ SettledQuantity { get; init; } 
    #else
    public Quantity54Choice_ SettledQuantity { get; set; } 
    #endif
    ...
    public QuantityBreakdown75? QuantityBreakdown { get; init; } 
    #else
    public QuantityBreakdown75? QuantityBreakdown { get; set; } 
    #endif
