...
public partial record FinancialInstrumentAttributes107
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentAttributes107 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentAttributes107( SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public FinancialInstrumentQuantity33Choice_? MinimumQuantityToInstruct { get; init; } 
    #else
    public FinancialInstrumentQuantity33Choice_? MinimumQuantityToInstruct { get; set; } 
    #endif
    ...
    public FinancialInstrumentQuantity33Choice_? MinimumMultipleQuantityToInstruct { get; init; } 
    #else
    public FinancialInstrumentQuantity33Choice_? MinimumMultipleQuantityToInstruct { get; set; } 
    #endif
