...
public partial record TransactionIdentifications29
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications29( System.String reqAccountOwnerTransactionIdentification )
    {
