...
public partial record SettlementDetails24
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails24( SecuritiesTransactionType3Choice_ reqSecuritiesTransactionType )
    {
