...
public partial record CorporateActionOption180
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption180 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption180( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption40Choice_ reqOptionType,SecuritiesQuantityOrAmount4Choice_ reqSecuritiesQuantityOrInstructedAmount )
    {
