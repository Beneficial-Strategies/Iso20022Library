...
public partial record PaperCommodityPulp1
{
    ...
    #else
    /// <summary>
    /// Constructs a PaperCommodityPulp1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaperCommodityPulp1( AssetClassProductType8Code reqBaseProduct )
    {
