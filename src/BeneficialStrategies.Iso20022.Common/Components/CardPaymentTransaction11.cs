...
public partial record CardPaymentTransaction11
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction11( System.String reqTransactionCapture,CardPaymentServiceType4Code reqTransactionType,System.String reqMerchantCategoryCode,TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails1 reqTransactionDetails )
    {
