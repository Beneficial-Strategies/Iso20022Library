...
public partial record CorporateActionOption148
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption148 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption148( System.String reqOptionNumber,CorporateActionOption23Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CashOption61? CashMovementDetails { get; init; } 
    #else
    public CashOption61? CashMovementDetails { get; set; } 
    #endif
