...
public partial record CorporateActionGeneralInformation25
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation25( System.String reqCorporateActionEventIdentification,CorporateActionEventType3Choice_ reqEventType,CorporateActionMandatoryVoluntary1Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification14 reqUnderlyingSecurityIdentification )
    {
