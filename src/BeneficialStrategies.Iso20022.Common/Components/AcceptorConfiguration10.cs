...
public partial record AcceptorConfiguration10
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorConfiguration10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorConfiguration10( GenericIdentification176 reqTerminalManagerIdentification )
    {
    ...
    /// </summary>
    [IsoId("_uKs1oy1vEeuZtpnZJ4v-5Q")]
    [DisplayName("Data Set")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="DataSet")]
    #endif
    [IsoXmlTag("DataSet")]
    public ValueList<AcceptorConfigurationDataSet2> DataSet { get; init; } = new ValueList<AcceptorConfigurationDataSet2>(){}; // Warning: Don't know multiplicity.
