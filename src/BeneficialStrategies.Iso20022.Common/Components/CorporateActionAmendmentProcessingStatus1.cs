...
public partial record CorporateActionAmendmentProcessingStatus1
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionAmendmentProcessingStatus1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionAmendmentProcessingStatus1( ProcessedStatus5FormatChoice_ reqStatus )
    {
        Status = reqStatus;
    }
    #endif
