...
public partial record Action2
{
    ...
    #else
    /// <summary>
    /// Constructs a Action2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Action2( ActionType2Code reqActionType )
    {
    ...
    public ActionType2Code ActionType { get; init; } 
    #else
    public ActionType2Code ActionType { get; set; } 
    #endif
