...
public partial record Intermediary25
{
    ...
    #else
    /// <summary>
    /// Constructs a Intermediary25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Intermediary25( PartyIdentification2Choice_ reqIdentification )
    {
    ...
    public Account14? Account { get; init; } 
    #else
    public Account14? Account { get; set; } 
    #endif
