...
public record CorporateActionOption101
{
    /// <summary>
    ...
    public ValueList<OptionFeaturesFormat12Choice_> OptionFeatures { get; init; } = [];
    ...
    public ValueList<CashOption32> CashMovementDetails { get; init; } = [];
