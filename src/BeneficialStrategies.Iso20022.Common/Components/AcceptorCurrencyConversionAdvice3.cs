...
public partial record AcceptorCurrencyConversionAdvice3
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionAdvice3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionAdvice3( CardPaymentEnvironment69 reqEnvironment,CardPaymentTransaction88 reqTransaction )
    {
