...
public partial record CardPaymentTransaction120
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction120 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction120( CardPaymentServiceType5Code reqTransactionType,TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails51 reqTransactionDetails )
    {
    ...
    public CardPaymentTransaction123? OriginalTransaction { get; init; } 
    #else
    public CardPaymentTransaction123? OriginalTransaction { get; set; } 
    #endif
