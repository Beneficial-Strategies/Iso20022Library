...
public partial record Action10
{
    ...
    #else
    /// <summary>
    /// Constructs a Action10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Action10( ActionType9Code reqActionType )
    {
    ...
    public ActionMessage7? MessageToPresent { get; init; } 
    #else
    public ActionMessage7? MessageToPresent { get; set; } 
    #endif
