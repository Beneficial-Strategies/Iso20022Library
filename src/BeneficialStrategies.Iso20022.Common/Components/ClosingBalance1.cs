...
public partial record ClosingBalance1
{
    ...
    #else
    /// <summary>
    /// Constructs a ClosingBalance1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ClosingBalance1( ShortLong1Code reqShortLongIndicator,ClosingBalance1Choice_ reqClosingBalance )
    {
    ...
    public required ClosingBalance1Choice_ ClosingBalance { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ClosingBalance1Choice_ ClosingBalance { get; init; } 
    #else
    public ClosingBalance1Choice_ ClosingBalance { get; set; } 
    #endif
