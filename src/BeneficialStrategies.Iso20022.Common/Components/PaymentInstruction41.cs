...
public partial record PaymentInstruction41
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentInstruction41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction41( PaymentMethod7Code reqPaymentMethod,DateAndDateTime2Choice_ reqRequestedExecutionDate,PartyIdentification135 reqDebtor,BranchAndFinancialInstitutionIdentification6 reqDebtorAgent )
    {
    ...
    /// </summary>
    [IsoId("_fb4CDdcZEeqRFcf2R4bPBw")]
    [DisplayName("Credit Transfer Transaction")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="CdtTrfTx")]
    #endif
    [IsoXmlTag("CdtTrfTx")]
    public ValueList<CreditTransferTransaction55> CreditTransferTransaction { get; init; } = new ValueList<CreditTransferTransaction55>(){}; // Warning: Don't know multiplicity.
