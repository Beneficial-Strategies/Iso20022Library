...
public partial record PaymentTransaction107
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentTransaction107 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentTransaction107( OriginalGroupInformation29 reqOriginalGroupInformation )
    {
