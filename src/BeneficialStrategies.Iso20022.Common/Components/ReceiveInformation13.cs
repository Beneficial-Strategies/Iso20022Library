...
/// </summary>
[IsoId("_d1EogRYCEeOBE-jZfcm4KQ")]
[DisplayName("Receive Information")]
public record ReceiveInformation13
{
    /// <summary>
    /// Date and time at which the securities are to be exchanged at the International Central Securities Depository (ICSD) or Central Securities Depository (CSD).
    /// </summary>
    [IsoId("_eV8g-RYCEeOBE-jZfcm4KQ")]
    ...
    /// </summary>
    [IsoId("_eV8hBRYCEeOBE-jZfcm4KQ")]
    [DisplayName("Commission Details")]
    [IsoXmlTag("ComssnDtls")]
    public ValueList<Commission17> CommissionDetails { get; init; } = [];

    /// <summary>
    /// Tax related to the transfer of a financial instrument.
    /// </summary>
    [IsoId("_eV8hBxYCEeOBE-jZfcm4KQ")]
    [DisplayName("Tax Details")]
    [IsoXmlTag("TaxDtls")]
    public ValueList<Tax21> TaxDetails { get; init; } = [];

    /// <summary>
    /// Specifies foreign exchange details applied to the payment of charges, taxes and commissions as a result of the transfer.
    /// </summary>
    [IsoId("_g1SRMRYCEeOBE-jZfcm4KQ")]
