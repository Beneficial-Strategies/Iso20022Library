...
public partial record TransactionDetails108
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails108 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails108( SettlementTypeAndIdentification22 reqAccountOwnerTransactionIdentification,SecuritiesAccount30 reqSafekeepingAccount )
    {
    ...
    public TransactionDetails109? TransactionDetails { get; init; } 
    #else
    public TransactionDetails109? TransactionDetails { get; set; } 
    #endif
