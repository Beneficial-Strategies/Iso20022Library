...
public record CorporateActionOption36
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption25> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption17> CashMovementDetails { get; init; } = [];
