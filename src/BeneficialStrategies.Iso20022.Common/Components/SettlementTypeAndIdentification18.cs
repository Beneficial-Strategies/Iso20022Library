...
public partial record SettlementTypeAndIdentification18
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementTypeAndIdentification18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementTypeAndIdentification18( System.String reqTransactionIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
