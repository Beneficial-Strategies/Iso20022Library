...
public partial record SignedQuantityFormat13
{
    ...
    #else
    /// <summary>
    /// Constructs a SignedQuantityFormat13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SignedQuantityFormat13( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity36Choice_ reqQuantity )
    {
