...
public partial record CommonTradeDataReport35
{
    ...
    #else
    /// <summary>
    /// Constructs a CommonTradeDataReport35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CommonTradeDataReport35( TradeTransaction26 reqTransactionData )
    {
    ...
    public required TradeTransaction26 TransactionData { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TradeTransaction26 TransactionData { get; init; } 
    #else
    public TradeTransaction26 TransactionData { get; set; } 
    #endif
