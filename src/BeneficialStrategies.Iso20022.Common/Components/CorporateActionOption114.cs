...
public partial record CorporateActionOption114
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption114 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption114( System.String reqOptionNumber,CorporateActionOption18Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public OptionFeaturesFormat16Choice_? OptionFeatures { get; init; } 
    #else
    public OptionFeaturesFormat16Choice_? OptionFeatures { get; set; } 
    #endif
    ...
    public CorporateActionRate68? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate68? RateAndAmountDetails { get; set; } 
    #endif
    ...
    public CashOption43? CashMovementDetails { get; init; } 
    #else
    public CashOption43? CashMovementDetails { get; set; } 
    #endif
