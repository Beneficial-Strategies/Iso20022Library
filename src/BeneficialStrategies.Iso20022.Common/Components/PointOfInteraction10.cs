...
public partial record PointOfInteraction10
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteraction10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteraction10( GenericIdentification177 reqIdentification )
    {
    ...
    public PointOfInteractionComponent10? Component { get; init; } 
    #else
    public PointOfInteractionComponent10? Component { get; set; } 
    #endif
