...
public partial record CurrencyConversion3
{
    ...
    #else
    /// <summary>
    /// Constructs a CurrencyConversion3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CurrencyConversion3( CurrencyConversionResponse1Code reqResult )
    {
        Result = reqResult;
    }
    #endif
    ...
    public CurrencyConversion2? Conversion { get; init; } 
    #else
    public CurrencyConversion2? Conversion { get; set; } 
    #endif
