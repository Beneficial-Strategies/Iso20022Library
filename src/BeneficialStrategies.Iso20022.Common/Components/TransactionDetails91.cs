...
public partial record TransactionDetails91
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails91 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails91( TransactionActivity4Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity10Choice_ reqPostingQuantity,DateAndDateTimeChoice_ reqEffectiveSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent16Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent16Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    ...
    public SettlementDetails117? SettlementParameters { get; init; } 
    #else
    public SettlementDetails117? SettlementParameters { get; set; } 
    #endif
