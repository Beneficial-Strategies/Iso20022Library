...
public partial record TransactionIdentifications48
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications48 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications48( References44Choice_ reqAccountOwnerTransactionIdentification )
    {
