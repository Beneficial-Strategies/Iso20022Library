...
public partial record CancelledStatusReason8
{
    ...
    #else
    /// <summary>
    /// Constructs a CancelledStatusReason8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CancelledStatusReason8( CancelledReason5Choice_ reqReasonCode )
    {
    ...
    public CancelledReason5Choice_ ReasonCode { get; init; } 
    #else
    public CancelledReason5Choice_ ReasonCode { get; set; } 
    #endif
