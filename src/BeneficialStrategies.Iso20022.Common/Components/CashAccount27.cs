...
public partial record CashAccount27
{
    ...
    #else
    /// <summary>
    /// Constructs a CashAccount27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashAccount27( AccountIdentification4Choice_ reqIdentification )
    {
    ...
    public PartyIdentification41? Owner { get; init; } 
    #else
    public PartyIdentification41? Owner { get; set; } 
    #endif
