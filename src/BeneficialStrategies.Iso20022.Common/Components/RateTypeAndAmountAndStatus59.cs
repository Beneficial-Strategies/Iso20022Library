...
public partial record RateTypeAndAmountAndStatus59
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus59 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus59( RateType80Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
    {
