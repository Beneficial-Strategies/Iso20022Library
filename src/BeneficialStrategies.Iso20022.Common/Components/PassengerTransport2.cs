...
public record PassengerTransport2
{
    ...
    [IsoXmlTag("TripLeg")]
    public ValueList<TripLeg2> TripLeg { get; init; } = [];
    ...
    public ValueList<AncillaryPurchase2> AncillaryPurchase { get; init; } = [];
    ...
    public ValueList<HiredVehicle2> HiredVehicleDetails { get; init; } = [];
}
