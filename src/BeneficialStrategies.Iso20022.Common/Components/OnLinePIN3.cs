...
public partial record OnLinePIN3
{
    ...
    #else
    /// <summary>
    /// Constructs a OnLinePIN3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OnLinePIN3( ContentInformationType7 reqEncryptedPINBlock,PINFormat3Code reqPINFormat )
    {
    ...
    public ContentInformationType7 EncryptedPINBlock { get; init; } 
    #else
    public ContentInformationType7 EncryptedPINBlock { get; set; } 
    #endif
