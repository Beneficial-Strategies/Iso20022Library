...
public partial record CorporateActionGeneralInformation49
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation49 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation49( System.String reqCorporateActionEventIdentification,CorporateActionEventType11Choice_ reqEventType )
    {
