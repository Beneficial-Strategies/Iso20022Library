...
public partial record SettlementReportingResponse1
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementReportingResponse1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementReportingResponse1( Environment9 reqEnvironment,Transaction84 reqTransaction,ProcessingResult3 reqProcessingResult )
    {
    ...
    public required Transaction84 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction84 Transaction { get; init; } 
    #else
    public Transaction84 Transaction { get; set; } 
    #endif
