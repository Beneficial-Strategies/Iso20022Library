...
public partial record QuantityAndAccount107
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount107 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount107( FinancialInstrumentQuantity36Choice_ reqSettlementQuantity )
    {
