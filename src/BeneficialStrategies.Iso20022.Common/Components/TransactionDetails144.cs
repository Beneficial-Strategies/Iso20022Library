...
public partial record TransactionDetails144
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails144 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails144( TransactionActivity4Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SecurityIdentification20 reqFinancialInstrumentIdentification,Quantity10Choice_ reqPostingQuantity,SettlementDate32Choice_ reqSettlementDate )
    {
