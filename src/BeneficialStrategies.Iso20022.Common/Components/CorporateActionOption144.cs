...
public partial record CorporateActionOption144
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption144 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption144( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption22Choice_ reqOptionType )
    {
