...
public partial record AgriculturalCommodityForestry1
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommodityForestry1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommodityForestry1( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType21Code reqSubProduct )
    {
