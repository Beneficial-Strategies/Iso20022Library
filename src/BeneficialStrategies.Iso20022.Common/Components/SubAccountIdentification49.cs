...
public partial record SubAccountIdentification49
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification49 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification49( SecuritiesAccount25 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
