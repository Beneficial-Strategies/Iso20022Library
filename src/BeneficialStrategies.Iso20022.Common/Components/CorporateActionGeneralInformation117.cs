...
public partial record CorporateActionGeneralInformation117
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation117 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation117( System.String reqCorporateActionEventIdentification,CorporateActionEventType61Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes85 reqUnderlyingSecurity )
    {
    ...
    public required CorporateActionEventType61Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType61Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType61Choice_ EventType { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies whether the event is mandatory, mandatory with options or voluntary.
    /// </summary>
    [IsoId("_x52mBpwsEeazcsnODTksnQ")]
