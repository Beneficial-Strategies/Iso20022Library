...
public partial record StatusReportDataSetRequest4
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReportDataSetRequest4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReportDataSetRequest4( DataSetIdentification10 reqIdentification,StatusReportContent12 reqContent )
    {
    ...
    public required StatusReportContent12 Content { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusReportContent12 Content { get; init; } 
    #else
    public StatusReportContent12 Content { get; set; } 
    #endif
