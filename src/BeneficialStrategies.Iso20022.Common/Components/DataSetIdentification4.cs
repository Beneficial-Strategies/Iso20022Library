...
public partial record DataSetIdentification4
{
    ...
    #else
    /// <summary>
    /// Constructs a DataSetIdentification4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DataSetIdentification4( DataSetCategory4Code reqType )
    {
        Type = reqType;
    }
    #endif
    ...
    public required DataSetCategory4Code Type { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DataSetCategory4Code Type { get; init; } 
    #else
    public DataSetCategory4Code Type { get; set; } 
    #endif
