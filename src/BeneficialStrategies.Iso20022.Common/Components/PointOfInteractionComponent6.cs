...
public partial record PointOfInteractionComponent6
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteractionComponent6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteractionComponent6( POIComponentType4Code reqType,PointOfInteractionComponentIdentification1 reqIdentification )
    {
        Type = reqType;
