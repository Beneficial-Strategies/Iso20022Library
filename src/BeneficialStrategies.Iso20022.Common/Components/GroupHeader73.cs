...
public partial record GroupHeader73
{
    ...
    #else
    /// <summary>
    /// Constructs a GroupHeader73 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GroupHeader73( System.String reqMessageIdentification,System.DateTime reqCreationDateTime )
    {
    ...
    public PartyIdentification125? MessageRecipient { get; init; } 
    #else
    public PartyIdentification125? MessageRecipient { get; set; } 
    #endif
