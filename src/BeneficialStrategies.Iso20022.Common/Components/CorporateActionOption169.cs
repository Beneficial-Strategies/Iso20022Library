...
public partial record CorporateActionOption169
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption169 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption169( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption34Choice_ reqOptionType )
    {
    ...
    public required CorporateActionOption34Choice_ OptionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption34Choice_ OptionType { get; init; } 
    #else
    public CorporateActionOption34Choice_ OptionType { get; set; } 
    #endif
