...
public partial record SecuritiesOption92
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption92 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption92( FinancialInstrumentAttributes107 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate20 reqDateDetails )
    {
    ...
    public required SecurityDate20 DateDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecurityDate20 DateDetails { get; init; } 
    #else
    public SecurityDate20 DateDetails { get; set; } 
    #endif
    ...
    public CorporateActionRate112? RateDetails { get; init; } 
    #else
    public CorporateActionRate112? RateDetails { get; set; } 
    #endif
