...
public partial record TransactionDetails114
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails114 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails114( TransactionActivity3Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity6Choice_ reqPostingQuantity,DateAndDateTime2Choice_ reqEffectiveSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent26Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent26Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies if the movement on a securities account results from a deliver or a receive instruction.
    /// </summary>
    [IsoId("_eA1QodEfEeiO-eodGv5iKQ")]
