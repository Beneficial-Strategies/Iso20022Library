...
public partial record StatusAndReason7
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason7( Status2Choice_ reqStatusAndReason )
    {
    ...
    [IsoXmlTag("Tx")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public Transaction14? Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction14? Transaction { get; init; } 
    #else
    public Transaction14? Transaction { get; set; } 
    #endif
