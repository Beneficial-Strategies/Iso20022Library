...
public partial record PriceInformation18
{
    ...
    #else
    /// <summary>
    /// Constructs a PriceInformation18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PriceInformation18( TypeOfPrice30Choice_ reqType,YieldedOrValueType1Choice_ reqValueType,PriceRateOrAmountOrUnknown2Choice_ reqValue )
    {
        Type = reqType;
