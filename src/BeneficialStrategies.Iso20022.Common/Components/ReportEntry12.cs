...
public partial record ReportEntry12
{
    ...
    #else
    /// <summary>
    /// Constructs a ReportEntry12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReportEntry12( ActiveOrHistoricCurrencyAndAmount reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus1Choice_ reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
    ...
    [IsoXmlTag("NtryDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public EntryDetails11? EntryDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public EntryDetails11? EntryDetails { get; init; } 
    #else
    public EntryDetails11? EntryDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Further details of the entry.
    /// </summary>
    [IsoId("_M7ACxytvEeysar7zFstVmw")]
