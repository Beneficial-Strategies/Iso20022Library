...
public partial record FinancialInstrumentDetails33
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentDetails33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentDetails33( SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
    ...
    #endif
    [IsoXmlTag("Tx")]
    public ValueList<Transaction72> Transaction { get; init; } = new ValueList<Transaction72>(){}; // Warning: Don't know multiplicity.
