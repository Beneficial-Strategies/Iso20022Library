...
public partial record Compensation1
{
    ...
    /// </summary>
    public Compensation1( ActiveCurrencyAndAmount reqAmount,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent,BranchAndFinancialInstitutionIdentification5 reqCreditorAgent,CompensationReason1Choice_ reqReason )
    {
        Amount = reqAmount;
