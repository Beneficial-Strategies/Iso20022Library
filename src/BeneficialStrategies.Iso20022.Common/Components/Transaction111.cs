...
public partial record Transaction111
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction111 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction111( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails130? TransactionDetails { get; init; } 
    #else
    public TransactionDetails130? TransactionDetails { get; set; } 
    #endif
