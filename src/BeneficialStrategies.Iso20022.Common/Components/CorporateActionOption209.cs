...
public record CorporateActionOption209
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption92> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption84> CashMovementDetails { get; init; } = [];
