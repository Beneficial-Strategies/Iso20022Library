...
public partial record CorporateActionOption209
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption209 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption209( System.String reqOptionNumber,CorporateActionOption37Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CashOption84? CashMovementDetails { get; init; } 
    #else
    public CashOption84? CashMovementDetails { get; set; } 
    #endif
