...
public partial record SettlementTypeAndIdentification10
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementTypeAndIdentification10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementTypeAndIdentification10( System.String reqAccountOwnerTransactionIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
