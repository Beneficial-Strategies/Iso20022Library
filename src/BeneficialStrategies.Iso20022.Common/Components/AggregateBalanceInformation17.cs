...
public partial record AggregateBalanceInformation17
{
    ...
    #else
    /// <summary>
    /// Constructs a AggregateBalanceInformation17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AggregateBalanceInformation17( SecurityIdentification14 reqFinancialInstrumentIdentification,Balance1 reqAggregateBalance,BalanceAmounts1 reqAccountBaseCurrencyAmounts )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalancePerSafekeepingPlace16? BalanceAtSafekeepingPlace { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalancePerSafekeepingPlace16? BalanceAtSafekeepingPlace { get; init; } 
    #else
    public AggregateBalancePerSafekeepingPlace16? BalanceAtSafekeepingPlace { get; set; } 
    #endif
