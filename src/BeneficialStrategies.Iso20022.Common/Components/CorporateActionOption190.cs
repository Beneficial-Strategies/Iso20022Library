...
public partial record CorporateActionOption190
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption190 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption190( System.String reqOptionNumber,CorporateActionOption46Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
