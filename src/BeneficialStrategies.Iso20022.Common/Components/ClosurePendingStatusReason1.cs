...
public partial record ClosurePendingStatusReason1
{
    ...
    #else
    /// <summary>
    /// Constructs a ClosurePendingStatusReason1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ClosurePendingStatusReason1( ClosurePendingStatusReason2Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
