...
public partial record QuantityAndAvailability2
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAvailability2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAvailability2( FinancialInstrumentQuantity15Choice_ reqQuantity,System.String reqAvailabilityIndicator )
    {
