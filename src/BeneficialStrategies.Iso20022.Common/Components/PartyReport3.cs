...
public partial record PartyReport3
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyReport3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyReport3( SystemPartyIdentification8 reqPartyIdentification,PartyOrBusinessError3Choice_ reqPartyOrError )
    {
    ...
    public required PartyOrBusinessError3Choice_ PartyOrError { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PartyOrBusinessError3Choice_ PartyOrError { get; init; } 
    #else
    public PartyOrBusinessError3Choice_ PartyOrError { get; set; } 
    #endif
