...
public partial record ATMContext13
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMContext13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMContext13( ATMService14 reqService )
    {
        Service = reqService;
    }
    #endif
    ...
    public required ATMService14 Service { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ATMService14 Service { get; init; } 
    #else
    public ATMService14 Service { get; set; } 
    #endif
