...
public partial record Transaction40
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction40 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction40( System.String reqAccountOwnerTransactionIdentification )
    {
