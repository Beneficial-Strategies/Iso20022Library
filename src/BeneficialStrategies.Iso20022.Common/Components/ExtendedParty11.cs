...
public partial record ExtendedParty11
{
    ...
    #else
    /// <summary>
    /// Constructs a ExtendedParty11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ExtendedParty11( System.String reqExtendedPartyRole,InvestmentAccountOwnershipInformation14 reqOtherPartyDetails )
    {
    ...
    public required InvestmentAccountOwnershipInformation14 OtherPartyDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation14 OtherPartyDetails { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation14 OtherPartyDetails { get; set; } 
    #endif
