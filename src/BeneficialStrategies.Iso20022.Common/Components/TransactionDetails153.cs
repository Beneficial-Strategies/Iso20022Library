...
public partial record TransactionDetails153
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails153 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails153( SecurityIdentification19 reqFinancialInstrumentIdentification,SettlementDate17Choice_ reqSettlementDate,Quantity51Choice_ reqSettlementQuantity )
    {
