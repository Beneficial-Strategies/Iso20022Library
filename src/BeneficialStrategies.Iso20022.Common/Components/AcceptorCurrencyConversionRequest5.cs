...
public partial record AcceptorCurrencyConversionRequest5
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionRequest5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionRequest5( CardPaymentEnvironment68 reqEnvironment,CardPaymentTransaction85 reqTransaction )
    {
    ...
    public required CardPaymentTransaction85 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransaction85 Transaction { get; init; } 
    #else
    public CardPaymentTransaction85 Transaction { get; set; } 
    #endif
