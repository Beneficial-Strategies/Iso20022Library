...
public partial record CardPaymentTransactionDetails9
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransactionDetails9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransactionDetails9( ImpliedCurrencyAndAmount reqTotalAmount )
    {
