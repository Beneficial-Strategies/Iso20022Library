...
public partial record CorporateActionGeneralInformation165
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation165 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation165( System.String reqCorporateActionEventIdentification,CorporateActionEventType84Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes108 reqUnderlyingSecurity )
    {
    ...
    public required FinancialInstrumentAttributes108 UnderlyingSecurity { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FinancialInstrumentAttributes108 UnderlyingSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes108 UnderlyingSecurity { get; set; } 
    #endif
