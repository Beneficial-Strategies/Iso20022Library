...
public partial record InstructionProcessingStatus3
{
    ...
    #else
    /// <summary>
    /// Constructs a InstructionProcessingStatus3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InstructionProcessingStatus3( Status7Code reqStatus )
    {
        Status = reqStatus;
    }
    #endif
    ...
    public Status7Code Status { get; init; } 
    #else
    public Status7Code Status { get; set; } 
    #endif
