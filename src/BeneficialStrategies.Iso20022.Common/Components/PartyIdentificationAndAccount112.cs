...
public partial record PartyIdentificationAndAccount112
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount112 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount112( PartyIdentification94Choice_ reqIdentification )
    {
