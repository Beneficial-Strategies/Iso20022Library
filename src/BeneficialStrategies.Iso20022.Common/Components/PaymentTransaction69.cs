...
public partial record PaymentTransaction69
{
    ...
    public OriginalTransactionReference23? OriginalTransactionReference { get; init; } 
    #else
    public OriginalTransactionReference23? OriginalTransactionReference { get; set; } 
    #endif
