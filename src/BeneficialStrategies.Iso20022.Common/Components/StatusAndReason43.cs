...
public partial record StatusAndReason43
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason43 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason43( Status33Choice_ reqStatusAndReason )
    {
    ...
    public Transaction117? Transaction { get; init; } 
    #else
    public Transaction117? Transaction { get; set; } 
    #endif
