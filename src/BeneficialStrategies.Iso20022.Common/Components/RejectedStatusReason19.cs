...
public partial record RejectedStatusReason19
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason19( RejectedReason18Choice_ reqReasonCode )
    {
    ...
    public RejectedReason18Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason18Choice_ ReasonCode { get; set; } 
    #endif
