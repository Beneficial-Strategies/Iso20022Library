...
public partial record PartyIdentification249
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification249 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification249( PartyIdentification237Choice_ reqIdentification )
    {
    ...
    public PartyIdentification237Choice_ Identification { get; init; } 
    #else
    public PartyIdentification237Choice_ Identification { get; set; } 
    #endif
