...
public record CorporateActionOption149
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption69> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption62> CashMovementDetails { get; init; } = [];
}
