...
public partial record AmountPricePerAmount2
{
    ...
    /// </summary>
    public AmountPricePerAmount2( AmountPriceType1Code reqAmountPriceType,ActiveCurrencyAnd13DecimalAmount reqPriceValue,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
