...
public partial record TransactionIdentifications11
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications11( References22Choice_ reqAccountOwnerTransactionIdentification )
    {
