...
public partial record SecuritiesTradeDetails107
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails107 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails107( SettlementDate20Choice_ reqSettlementDate )
    {
