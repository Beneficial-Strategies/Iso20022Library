...
public partial record SecuritiesFinancingTransactionDetails8
{
    ...
    public SettlementDetails29? SettlementParameters { get; init; } 
    #else
    public SettlementDetails29? SettlementParameters { get; set; } 
    #endif
