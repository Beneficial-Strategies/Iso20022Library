...
public partial record TradeRecurrentQuery3
{
    ...
    #else
    /// <summary>
    /// Constructs a TradeRecurrentQuery3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TradeRecurrentQuery3( System.String reqQueryType,TradeQueryExecutionFrequency1Choice_ reqFrequency,System.DateOnly reqValidUntil )
    {
