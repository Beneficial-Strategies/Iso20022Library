...
public partial record ATMDepositCompletionAcknowledgement1
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMDepositCompletionAcknowledgement1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMDepositCompletionAcknowledgement1( AutomatedTellerMachine3 reqATM,ATMContext12 reqContext,ATMTransaction18 reqTransaction )
    {
        ATM = reqATM;
        Context = reqContext;
