...
public partial record PartyIdentificationAndAccount18
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount18( PartyIdentification30Choice_ reqIdentification )
    {
    ...
    public PartyIdentification30Choice_ Identification { get; init; } 
    #else
    public PartyIdentification30Choice_ Identification { get; set; } 
    #endif
