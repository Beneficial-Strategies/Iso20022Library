...
public partial record FileActionResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a FileActionResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FileActionResponse2( Environment22 reqEnvironment,Transaction158 reqTransaction,ResultData9 reqProcessingResult )
    {
    ...
    public required Transaction158 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction158 Transaction { get; init; } 
    #else
    public Transaction158 Transaction { get; set; } 
    #endif
