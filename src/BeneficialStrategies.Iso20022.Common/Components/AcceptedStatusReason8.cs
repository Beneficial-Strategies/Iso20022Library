...
public partial record AcceptedStatusReason8
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptedStatusReason8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptedStatusReason8( AcceptedReason9Choice_ reqReasonCode )
    {
