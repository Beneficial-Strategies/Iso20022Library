...
public partial record CardPaymentTransaction38
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction38( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails20 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails20 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails20 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails20 TransactionDetails { get; set; } 
    #endif
