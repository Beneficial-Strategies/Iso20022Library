...
public partial record RejectedStatusReason38
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason38( RejectedReason40Choice_ reqReasonCode )
    {
    ...
    public RejectedReason40Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason40Choice_ ReasonCode { get; set; } 
    #endif
