...
public partial record Balance21
{
    ...
    #else
    /// <summary>
    /// Constructs a Balance21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Balance21( SubBalanceQuantity8Choice_ reqQuantity )
    {
