...
public partial record AgriculturalCommodityPotato2
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommodityPotato2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommodityPotato2( AssetClassProductType1Code reqBaseProduct )
    {
