...
/// <summary>
/// Subscription Multiple Execution6.
/// </summary>
[IsoId("_4epUjxwMEe6O0NdiBuX__w")]
[DisplayName("Subscription Multiple Execution6")]
public partial record SubscriptionMultipleExecution6
{
    #nullable enable
    ...
    public PaymentTransaction162? BulkCashSettlementDetails { get; init; } 
    ...
    public ValueList<SubscriptionExecution14> IndividualExecutionDetails { get; init; } = [];
