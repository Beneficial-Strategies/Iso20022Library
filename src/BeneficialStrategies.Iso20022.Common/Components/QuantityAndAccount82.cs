...
public partial record QuantityAndAccount82
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount82 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount82( FinancialInstrumentQuantity1Choice_ reqSettlementQuantity,SecuritiesAccount19 reqSafekeepingAccount )
    {
