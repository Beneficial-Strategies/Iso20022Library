...
public partial record ExtendedParty8
{
    ...
    #else
    /// <summary>
    /// Constructs a ExtendedParty8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ExtendedParty8( System.String reqExtendedPartyRole,InvestmentAccountOwnershipInformation11 reqOtherPartyDetails )
    {
    ...
    public required InvestmentAccountOwnershipInformation11 OtherPartyDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation11 OtherPartyDetails { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation11 OtherPartyDetails { get; set; } 
    #endif
