...
public partial record CardPaymentTransactionDetails47
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransactionDetails47 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransactionDetails47( ImpliedCurrencyAndAmount reqTotalAmount )
    {
    ...
    public IndustryData1? AdditionalInformation { get; init; } 
    #else
    public IndustryData1? AdditionalInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Data related to an integrated circuit card application.
    /// </summary>
    [IsoId("_8pAHP9baEeiI3ZFGjth3Cw")]
