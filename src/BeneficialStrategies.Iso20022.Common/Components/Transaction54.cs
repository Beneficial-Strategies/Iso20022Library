...
public partial record Transaction54
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction54 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction54( System.String reqAccountOwnerTransactionIdentification )
    {
