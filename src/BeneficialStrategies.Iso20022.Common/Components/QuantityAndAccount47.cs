...
public partial record QuantityAndAccount47
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount47 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount47( Quantity10Choice_ reqSettlementQuantity,SecuritiesAccount30 reqSafekeepingAccount )
    {
