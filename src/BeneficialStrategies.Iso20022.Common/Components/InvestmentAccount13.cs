...
public partial record InvestmentAccount13
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccount13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccount13( AccountIdentification1 reqAccountIdentification )
    {
