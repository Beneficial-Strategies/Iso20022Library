...
public partial record SecuritiesFinancingTransactionDetails35
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesFinancingTransactionDetails35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesFinancingTransactionDetails35( SecuritiesAccount19 reqSafekeepingAccount,SecurityIdentification19 reqFinancialInstrumentIdentification,Quantity6Choice_ reqSettlementQuantity,SettlementDate10Choice_ reqOpeningSettlementDate,SecuritiesFinancingTransactionType2Code reqSecuritiesFinancingTransactionType,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
