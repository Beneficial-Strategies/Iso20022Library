...
public partial record DeliveringPartiesAndAccount11
{
    ...
    #else
    /// <summary>
    /// Constructs a DeliveringPartiesAndAccount11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DeliveringPartiesAndAccount11( PartyIdentification34Choice_ reqDepository,PartyIdentificationAndAccount102 reqParty1 )
    {
