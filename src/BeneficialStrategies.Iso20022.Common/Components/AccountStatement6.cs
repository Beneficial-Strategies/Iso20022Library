...
public partial record AccountStatement6
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountStatement6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountStatement6( System.String reqIdentification,System.DateTime reqCreationDateTime,CashAccount25 reqAccount )
    {
    ...
    /// </summary>
    [IsoId("_VKlhyTqwEeWZFYSPlduMhw")]
    [DisplayName("Balance")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="Bal")]
    #endif
    [IsoXmlTag("Bal")]
    public ValueList<CashBalance7> Balance { get; init; } = new ValueList<CashBalance7>(){}; // Warning: Don't know multiplicity.
    // ID for the above is _VKlhyTqwEeWZFYSPlduMhw
    
    /// <summary>
    /// Provides summary information on entries.
    /// </summary>
    [IsoId("_VKlhyzqwEeWZFYSPlduMhw")]
