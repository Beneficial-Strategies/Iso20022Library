...
public partial record SubAccountIdentification2
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification2( AccountIdentificationFormatChoice_ reqIdentification,System.String reqFungibleIndicator,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation2? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation2? BalanceForSubAccount { get; set; } 
    #endif
