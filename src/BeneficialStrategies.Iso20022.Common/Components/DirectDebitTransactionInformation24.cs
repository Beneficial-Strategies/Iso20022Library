...
public partial record DirectDebitTransactionInformation24
{
    ...
    #else
    /// <summary>
    /// Constructs a DirectDebitTransactionInformation24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DirectDebitTransactionInformation24( PaymentIdentification7 reqPaymentIdentification,ActiveCurrencyAndAmount reqInterbankSettlementAmount,ChargeBearerType1Code reqChargeBearer,PartyIdentification135 reqCreditor,BranchAndFinancialInstitutionIdentification6 reqCreditorAgent,PartyIdentification135 reqDebtor,CashAccount38 reqDebtorAccount,BranchAndFinancialInstitutionIdentification6 reqDebtorAgent )
    {
