...
/// <summary>
/// Securities Option115.
/// </summary>
[IsoId("_kv6k-Zt3Ee-wQIOX0djF2w")]
[DisplayName("Securities Option115")]
public partial record SecuritiesOption115
{
    #nullable enable
    ...
    public SettlementParties130? DeliveringSettlementParties { get; init; } 
    ...
    [IsoXmlTag("PricDtls")]
    public CorporateActionPrice93? PriceDetails { get; init; } 
    ...
    [IsoXmlTag("RateDtls")]
    public CorporateActionRate132? RateDetails { get; init; } 
    ...
    public SettlementParties130? ReceivingSettlementParties { get; init; } 
    ...
    [IsoXmlTag("SfkpgPlc")]
    public SafekeepingPlaceFormat50Choice_? SafekeepingPlace { get; init; } 
