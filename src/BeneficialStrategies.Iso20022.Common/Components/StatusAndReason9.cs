...
public partial record StatusAndReason9
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason9( Status9Choice_ reqStatusAndReason )
    {
    ...
    public Transaction20? Transaction { get; init; } 
    #else
    public Transaction20? Transaction { get; set; } 
    #endif
