...
public partial record DocumentNumber5
{
    ...
    #else
    /// <summary>
    /// Constructs a DocumentNumber5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DocumentNumber5( DocumentNumber1Choice_ reqNumber )
    {
        Number = reqNumber;
    }
    #endif
    ...
    #endif
    [IsoXmlTag("Refs")]
    public ValueList<Identification6> References { get; init; } = new ValueList<Identification6>(){}; // Warning: Don't know multiplicity.
