...
public partial record CorporateActionOption123
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption123 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption123( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption25Choice_ reqOptionType,SecuritiesOption54 reqSecuritiesQuantity )
    {
    ...
    public required CorporateActionOption25Choice_ OptionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionOption25Choice_ OptionType { get; init; } 
    #else
    public CorporateActionOption25Choice_ OptionType { get; set; } 
    #endif
    ...
    public required SecuritiesOption54 SecuritiesQuantity { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesOption54 SecuritiesQuantity { get; init; } 
    #else
    public SecuritiesOption54 SecuritiesQuantity { get; set; } 
    #endif
