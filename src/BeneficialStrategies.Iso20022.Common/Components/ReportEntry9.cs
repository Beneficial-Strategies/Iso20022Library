...
public partial record ReportEntry9
{
    ...
    #else
    /// <summary>
    /// Constructs a ReportEntry9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReportEntry9( ActiveOrHistoricCurrencyAndAmount reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus1Choice_ reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
    ...
    public CardEntry3? CardTransaction { get; init; } 
    #else
    public CardEntry3? CardTransaction { get; set; } 
    #endif
    ...
    public EntryDetails8? EntryDetails { get; init; } 
    #else
    public EntryDetails8? EntryDetails { get; set; } 
    #endif
