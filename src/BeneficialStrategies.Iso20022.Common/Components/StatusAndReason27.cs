...
public partial record StatusAndReason27
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason27( Status18Choice_ reqStatusAndReason )
    {
    ...
    public Transaction45? Transaction { get; init; } 
    #else
    public Transaction45? Transaction { get; set; } 
    #endif
