...
public partial record Transaction110
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction110 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction110( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    [IsoXmlTag("TxDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public TransactionDetails129? TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TransactionDetails129? TransactionDetails { get; init; } 
    #else
    public TransactionDetails129? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_ei7WOemrEemUgrefIx730g")]
