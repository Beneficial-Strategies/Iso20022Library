...
public partial record IntraPositionDetails19
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionDetails19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionDetails19( SecuritiesAccount13 reqSafekeepingAccount,SecurityIdentification14 reqFinancialInstrumentIdentification,FinancialInstrumentQuantity1Choice_ reqSettlementQuantity,DateAndDateTimeChoice_ reqSettlementDate )
    {
