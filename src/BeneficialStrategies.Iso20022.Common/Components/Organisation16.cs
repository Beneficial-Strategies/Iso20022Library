...
public partial record Organisation16
{
    ...
    #else
    /// <summary>
    /// Constructs a Organisation16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Organisation16( System.String reqName )
    {
        Name = reqName;
    }
    #endif
