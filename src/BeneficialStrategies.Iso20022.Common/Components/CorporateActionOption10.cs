...
public partial record CorporateActionOption10
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption10( System.String reqOptionNumber,CorporateActionOption2Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public SecuritiesOption4? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOption4? SecuritiesMovementDetails { get; set; } 
    #endif
    ...
    public CashOption3? CashMovementDetails { get; init; } 
    #else
    public CashOption3? CashMovementDetails { get; set; } 
    #endif
