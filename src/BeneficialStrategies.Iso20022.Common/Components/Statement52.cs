...
public partial record Statement52
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement52 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement52( DateAndDateTimeChoice_ reqStatementDateTime,Frequency34Choice_ reqFrequency,UpdateType16Choice_ reqUpdateType,StatementBasis9Choice_ reqStatementBasis,System.String reqActivityIndicator,System.String reqSubAccountIndicator )
    {
