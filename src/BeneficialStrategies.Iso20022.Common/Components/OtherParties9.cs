...
public partial record OtherParties9
{
    ...
    public PartyIdentificationAndAccount36? Investor { get; init; } 
    #else
    public PartyIdentificationAndAccount36? Investor { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount37? QualifiedForeignIntermediary { get; init; } 
    #else
    public PartyIdentificationAndAccount37? QualifiedForeignIntermediary { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount37? StockExchange { get; init; } 
    #else
    public PartyIdentificationAndAccount37? StockExchange { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount37? TradeRegulator { get; init; } 
    #else
    public PartyIdentificationAndAccount37? TradeRegulator { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount37? TripartyAgent { get; init; } 
    #else
    public PartyIdentificationAndAccount37? TripartyAgent { get; set; } 
    #endif
