...
public partial record StatusAndReason45
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason45 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason45( Status39Choice_ reqStatusAndReason )
    {
    ...
    public Transaction127? Transaction { get; init; } 
    #else
    public Transaction127? Transaction { get; set; } 
    #endif
