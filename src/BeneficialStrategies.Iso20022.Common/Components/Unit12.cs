...
public partial record Unit12
{
    ...
    #else
    /// <summary>
    /// Constructs a Unit12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Unit12( System.UInt64 reqUnitsNumber )
    {
    ...
    public TotalFeesAndTaxes42? TransactionOverhead { get; init; } 
    #else
    public TotalFeesAndTaxes42? TransactionOverhead { get; set; } 
    #endif
