...
public partial record TMSEvent1
{
    ...
    #else
    /// <summary>
    /// Constructs a TMSEvent1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TMSEvent1( System.DateTime reqTimeStamp,TerminalManagementActionResult1Code reqResult,TMSActionIdentification1 reqActionIdentification )
    {
    ...
    public required TMSActionIdentification1 ActionIdentification { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TMSActionIdentification1 ActionIdentification { get; init; } 
    #else
    public TMSActionIdentification1 ActionIdentification { get; set; } 
    #endif
