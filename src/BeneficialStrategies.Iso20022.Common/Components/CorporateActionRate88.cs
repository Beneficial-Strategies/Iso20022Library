...
public record CorporateActionRate88
{
    /// <summary>
    ...
    public ValueList<GrossDividendRateFormat28Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat30Choice_> NetDividendRate { get; init; } = [];
