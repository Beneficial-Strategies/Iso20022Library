...
public partial record CorporateActionRate88
{
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public GrossDividendRateFormat28Choice_? GrossDividendRate { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public GrossDividendRateFormat28Choice_? GrossDividendRate { get; init; } 
    #else
    public GrossDividendRateFormat28Choice_? GrossDividendRate { get; set; } 
    #endif
    
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [IsoId("_0HiS5Zb7Eee8S7xwGG7Veg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public NetDividendRateFormat30Choice_? NetDividendRate { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public NetDividendRateFormat30Choice_? NetDividendRate { get; init; } 
    #else
    public NetDividendRateFormat30Choice_? NetDividendRate { get; set; } 
    #endif
    
    /// <summary>
    /// Public index rate applied to the amount paid to adjust it to inflation.
    /// </summary>
    [IsoId("_0HiS55b7Eee8S7xwGG7Veg")]
    ...
    public RateAndAmountFormat39Choice_? IndexFactor { get; init; } 
    #else
    public RateAndAmountFormat39Choice_? IndexFactor { get; set; } 
    #endif
    
    /// <summary>
    /// Actual interest rate used for the payment of the interest for the specified interest period.
    /// </summary>
    [IsoId("_0HiS75b7Eee8S7xwGG7Veg")]
