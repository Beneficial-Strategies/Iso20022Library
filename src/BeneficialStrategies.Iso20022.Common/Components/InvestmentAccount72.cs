...
public partial record InvestmentAccount72
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccount72 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccount72( System.String reqAccountIdentification )
    {
