...
public partial record CorporateAction68
{
    ...
    public CorporateActionDate83? DateDetails { get; init; } 
    #else
    public CorporateActionDate83? DateDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the periods related to a corporate action event.
    /// </summary>
    [IsoId("_A0iljzN7Ee2hpemV2j5yOw")]
