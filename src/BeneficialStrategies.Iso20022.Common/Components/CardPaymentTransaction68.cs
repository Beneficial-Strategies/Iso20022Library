...
public partial record CardPaymentTransaction68
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction68( AuthorisationResult12 reqAuthorisationResult )
    {
