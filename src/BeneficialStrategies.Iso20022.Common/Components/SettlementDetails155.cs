...
public partial record SettlementDetails155
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails155 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails155( SecuritiesTransactionType41Choice_ reqSecuritiesTransactionType )
    {
    ...
    public required SecuritiesTransactionType41Choice_ SecuritiesTransactionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTransactionType41Choice_ SecuritiesTransactionType { get; init; } 
    #else
    public SecuritiesTransactionType41Choice_ SecuritiesTransactionType { get; set; } 
    #endif
