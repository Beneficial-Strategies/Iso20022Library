...
public partial record AuthorisationResult19
{
    ...
    #else
    /// <summary>
    /// Constructs a AuthorisationResult19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AuthorisationResult19( ResponseType10 reqResponseToAuthorisation )
    {
