...
public partial record QuantityAndAccount25
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount25( Quantity6Choice_ reqSettlementQuantity,SecuritiesAccount13 reqSafekeepingAccount )
    {
