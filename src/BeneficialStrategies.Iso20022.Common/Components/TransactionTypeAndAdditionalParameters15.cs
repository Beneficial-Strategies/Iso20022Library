...
public partial record TransactionTypeAndAdditionalParameters15
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionTypeAndAdditionalParameters15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionTypeAndAdditionalParameters15( SecuritiesFinancingTransactionType2Code reqSecuritiesFinancingTransactionType,DeliveryReceiptType2Code reqPayment )
    {
