...
public partial record PartyIdentificationAndAccount50
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount50 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount50( PartyIdentification38Choice_ reqIdentification )
    {
    ...
    public PartyIdentification38Choice_ Identification { get; init; } 
    #else
    public PartyIdentification38Choice_ Identification { get; set; } 
    #endif
    
    /// <summary>
    /// Alternate identification for a party.
    /// </summary>
    [IsoId("_6VaZU-aQEd-q8fx_Zl_34A")]
