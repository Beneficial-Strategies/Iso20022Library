...
public partial record ModificationScope8
{
    ...
    #else
    /// <summary>
    /// Constructs a ModificationScope8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModificationScope8( DataModification1Code reqModificationScopeIndication,InvestmentPlan5 reqInvestmentPlan )
    {
    ...
    #else
    public InvestmentPlan5 InvestmentPlan { get; set; } 
    #endif
