...
public partial record PartyIdentification148
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification148 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification148( PartyIdentification122Choice_ reqIdentification )
    {
