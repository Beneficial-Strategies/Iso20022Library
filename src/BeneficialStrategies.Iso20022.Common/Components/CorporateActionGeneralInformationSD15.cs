...
public partial record CorporateActionGeneralInformationSD15
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD15( System.String reqPlaceAndName )
    {
