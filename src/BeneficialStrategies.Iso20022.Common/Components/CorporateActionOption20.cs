...
public record CorporateActionOption20
{
    ...
    public ValueList<OptionFeaturesFormat6Choice_> OptionFeatures { get; init; } = [];
    ...
    public ValueList<SecuritiesOption13> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption11> CashMovementDetails { get; init; } = [];
