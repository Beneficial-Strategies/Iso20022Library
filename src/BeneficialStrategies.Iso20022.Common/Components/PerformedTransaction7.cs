...
/// <summary>
/// Performed Transaction7.
/// </summary>
[IsoId("_2O7nsaEXEe-MRKYsaX6JDg")]
[DisplayName("Performed Transaction7")]
public partial record PerformedTransaction7
{
    #nullable enable
    ...
    [IsoXmlTag("PmtRslt")]
    public RetailerPaymentResult7? PaymentResult { get; init; } 
