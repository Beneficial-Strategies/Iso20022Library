...
public partial record GroupHeader43
{
    ...
    #else
    /// <summary>
    /// Constructs a GroupHeader43 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GroupHeader43( System.String reqMessageIdentification,System.DateTime reqCreationDateTime )
    {
    ...
    public Party7Choice_? MessageSender { get; init; } 
    #else
    public Party7Choice_? MessageSender { get; set; } 
    #endif
