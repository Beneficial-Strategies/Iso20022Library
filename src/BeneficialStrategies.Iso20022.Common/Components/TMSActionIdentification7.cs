...
public partial record TMSActionIdentification7
{
    ...
    #else
    /// <summary>
    /// Constructs a TMSActionIdentification7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TMSActionIdentification7( TerminalManagementAction5Code reqActionType )
    {
