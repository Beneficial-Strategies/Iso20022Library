...
public partial record FinancialInstrumentDetails41
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentDetails41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentDetails41( SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public OpeningBalance5? OpeningBalance { get; init; } 
    #else
    public OpeningBalance5? OpeningBalance { get; set; } 
    #endif
    ...
    public ClosingBalance5? ClosingBalance { get; init; } 
    #else
    public ClosingBalance5? ClosingBalance { get; set; } 
    #endif
    ...
    #endif
    [IsoXmlTag("Tx")]
    public ValueList<Transaction123> Transaction { get; init; } = new ValueList<Transaction123>(){}; // Warning: Don't know multiplicity.
