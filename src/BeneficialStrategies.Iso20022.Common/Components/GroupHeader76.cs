...
public partial record GroupHeader76
{
    ...
    #else
    /// <summary>
    /// Constructs a GroupHeader76 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GroupHeader76( System.String reqMessageIdentification,System.DateTime reqCreationDateTime )
    {
    ...
    public Party35Choice_? MessageSender { get; init; } 
    #else
    public Party35Choice_? MessageSender { get; set; } 
    #endif
