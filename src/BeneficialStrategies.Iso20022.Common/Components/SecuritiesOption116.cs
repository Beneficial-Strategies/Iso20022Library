...
/// <summary>
/// Securities Option116.
/// </summary>
[IsoId("_l6VJ25t3Ee-wQIOX0djF2w")]
[DisplayName("Securities Option116")]
public partial record SecuritiesOption116
{
    #nullable enable
    ...
    [IsoXmlTag("PricDtls")]
    public CorporateActionPrice95? PriceDetails { get; init; } 
    ...
    [IsoXmlTag("RateDtls")]
    public CorporateActionRate134? RateDetails { get; init; } 
    ...
    [IsoXmlTag("SfkpgPlc")]
    public SafekeepingPlaceFormat53Choice_? SafekeepingPlace { get; init; } 
    ...
    [IsoXmlTag("SctyDtls")]
    public required FinancialInstrumentAttributes135 SecurityDetails { get; init; } 
