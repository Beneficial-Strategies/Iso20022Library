...
[DataContract]
#endif
public partial record SubAccountIdentification58
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification58 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification58( SecuritiesAccount34 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation39? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation39? BalanceForSubAccount { get; set; } 
    #endif
