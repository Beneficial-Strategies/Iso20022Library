...
public partial record PaymentTransaction136
{
    ...
    public OriginalTransactionReference37? OriginalTransactionReference { get; init; } 
    #else
    public OriginalTransactionReference37? OriginalTransactionReference { get; set; } 
    #endif
