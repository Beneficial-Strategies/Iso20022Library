...
/// </summary>
[IsoId("_QyZrWdp-Ed-ak6NoX_4Aeg_37416622")]
...
public partial record RejectedStatusReason8
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason8( RejectedReason1Choice_ reqReasonCode )
    {
