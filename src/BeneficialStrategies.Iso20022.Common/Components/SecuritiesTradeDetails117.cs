...
public partial record SecuritiesTradeDetails117
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails117 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails117( SettlementDate17Choice_ reqSettlementDate )
    {
