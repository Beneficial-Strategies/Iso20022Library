...
public partial record PendingReason16
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingReason16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingReason16( PendingReason28Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public PendingReason28Choice_ Code { get; init; } 
    #else
    public PendingReason28Choice_ Code { get; set; } 
    #endif
