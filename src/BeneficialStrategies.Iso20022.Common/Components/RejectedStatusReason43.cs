...
public partial record RejectedStatusReason43
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason43 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason43( RejectedReason47Choice_ reqReasonCode )
    {
    ...
    public RejectedReason47Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason47Choice_ ReasonCode { get; set; } 
    #endif
