...
public partial record Header61
{
    ...
    #else
    /// <summary>
    /// Constructs a Header61 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Header61( MessageFunction20Code reqMessageFunction,System.String reqProtocolVersion,System.DateTime reqCreationDateTime,GenericIdentification183 reqInitiatingParty )
    {
