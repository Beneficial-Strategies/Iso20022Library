...
public partial record OtherCollateral4
{
    ...
    #else
    /// <summary>
    /// Constructs a OtherCollateral4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OtherCollateral4( ActiveCurrencyAndAmount reqCollateralValue )
    {
