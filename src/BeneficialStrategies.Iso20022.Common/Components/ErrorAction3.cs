...
public partial record ErrorAction3
{
    ...
    #else
    /// <summary>
    /// Constructs a ErrorAction3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ErrorAction3( TerminalManagementErrorAction2Code reqActionToProcess )
    {
    ...
    #endif
    [IsoXmlTag("ActnRslt")]
    public SimpleValueList<TerminalManagementActionResult3Code> ActionResult { get; init; } = new SimpleValueList<TerminalManagementActionResult3Code>(){}; // Warning: Don't know multiplicity.
