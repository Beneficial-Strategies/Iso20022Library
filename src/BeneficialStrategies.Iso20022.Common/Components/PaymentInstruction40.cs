...
public partial record PaymentInstruction40
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentInstruction40 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction40( System.String reqPaymentInformationIdentification,PaymentMethod3Code reqPaymentMethod,DateAndDateTime2Choice_ reqRequestedExecutionDate,PartyIdentification135 reqDebtor,CashAccount40 reqDebtorAccount,BranchAndFinancialInstitutionIdentification6 reqDebtorAgent )
    {
    ...
    public ValueList<CreditTransferTransaction54> CreditTransferTransactionInformation { get; init; } = new ValueList<CreditTransferTransaction54>(){}; // Warning: Don't know multiplicity.
