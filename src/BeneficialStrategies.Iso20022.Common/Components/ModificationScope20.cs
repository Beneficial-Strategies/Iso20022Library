...
public partial record ModificationScope20
{
    ...
    #else
    /// <summary>
    /// Constructs a ModificationScope20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModificationScope20( DataModification1Code reqModificationScopeIndication,Intermediary24 reqIntermediary )
    {
    ...
    public required Intermediary24 Intermediary { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Intermediary24 Intermediary { get; init; } 
    #else
    public Intermediary24 Intermediary { get; set; } 
    #endif
