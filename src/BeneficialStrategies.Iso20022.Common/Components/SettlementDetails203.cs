...
public partial record SettlementDetails203
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails203 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails203( SecuritiesTransactionType43Choice_ reqSecuritiesTransactionType )
    {
