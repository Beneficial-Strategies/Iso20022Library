...
public partial record CardPaymentTransaction117
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction117 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction117( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails50 reqTransactionDetails )
    {
