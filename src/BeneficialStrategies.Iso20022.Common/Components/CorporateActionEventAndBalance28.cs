...
/// </summary>
[IsoId("_HUkn8a8wEfCx2aBifPEdRg")]
[DisplayName("Corporate Action Event And Balance28")]
public record CorporateActionEventAndBalance28
{
    /// <summary>
    /// Provides general information related to a corporate action event.
    /// </summary>
    [IsoId("_HbiLka8wEfCx2aBifPEdRg")]
    ...
    /// </summary>
    [IsoId("_HbiLm68wEfCx2aBifPEdRg")]
    [DisplayName("Balance")]
    [IsoXmlTag("Bal")]
    public CorporateActionBalance52? Balance { get; init; }

    /// <summary>
    /// Provides additional information related to the event and the balance of the corporate action.
    /// </summary>
    [IsoId("_HbiLo68wEfCx2aBifPEdRg")]
