...
public partial record Mandate18
{
    ...
    #else
    /// <summary>
    /// Constructs a Mandate18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Mandate18( System.String reqMandateIdentification,System.String reqTrackingIndicator )
    {
