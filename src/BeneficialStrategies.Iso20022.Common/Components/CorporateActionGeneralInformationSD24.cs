...
public partial record CorporateActionGeneralInformationSD24
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD24( System.String reqPlaceAndName )
    {
