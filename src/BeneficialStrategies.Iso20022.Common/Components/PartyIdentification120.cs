...
public partial record PartyIdentification120
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification120 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification120( PartyIdentification58Choice_ reqIdentification )
    {
