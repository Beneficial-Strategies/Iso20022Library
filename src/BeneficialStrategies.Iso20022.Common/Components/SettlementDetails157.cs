...
public partial record SettlementDetails157
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails157 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails157( SecuritiesTransactionType42Choice_ reqSecuritiesTransactionType )
    {
