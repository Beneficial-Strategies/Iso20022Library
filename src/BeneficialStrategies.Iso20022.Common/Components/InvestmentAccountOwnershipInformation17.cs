...
public partial record InvestmentAccountOwnershipInformation17
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccountOwnershipInformation17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccountOwnershipInformation17( Party48Choice_ reqParty )
    {
        Party = reqParty;
    }
    #endif
    ...
    #else
    public Party48Choice_ Party { get; set; } 
    #endif
