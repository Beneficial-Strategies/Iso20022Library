...
public partial record AlgorithmIdentification20
{
    ...
    #else
    /// <summary>
    /// Constructs a AlgorithmIdentification20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AlgorithmIdentification20( Algorithm19Code reqAlgorithm )
    {
    ...
    public Algorithm19Code Algorithm { get; init; } 
    #else
    public Algorithm19Code Algorithm { get; set; } 
    #endif
