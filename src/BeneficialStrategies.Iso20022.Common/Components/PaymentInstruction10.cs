...
public partial record PaymentInstruction10
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentInstruction10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction10( System.String reqPaymentInformationIdentification,PaymentMethod2Code reqPaymentMethod,System.DateOnly reqRequestedCollectionDate,PartyIdentification43 reqCreditor,CashAccount24 reqCreditorAccount,BranchAndFinancialInstitutionIdentification5 reqCreditorAgent )
    {
    ...
    public ValueList<DirectDebitTransactionInformation13> DirectDebitTransactionInformation { get; init; } = new ValueList<DirectDebitTransactionInformation13>(){}; // Warning: Don't know multiplicity.
