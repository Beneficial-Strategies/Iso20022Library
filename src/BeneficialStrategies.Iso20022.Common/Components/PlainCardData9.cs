...
public partial record PlainCardData9
{
    ...
    #else
    /// <summary>
    /// Constructs a PlainCardData9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PlainCardData9( System.String reqPAN,System.String reqExpiryDate )
    {
        PAN = reqPAN;
