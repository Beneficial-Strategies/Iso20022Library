...
public partial record CardPaymentDataSet20
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSet20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSet20( System.String reqTransactionSequenceCounter,ResponseType1 reqTransactionResponse,CardPaymentEnvironment69 reqEnvironment,CardPaymentTransactionAdviceResponse5 reqTransaction )
    {
