...
public partial record SettlementDetails210
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails210 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails210( SecuritiesTransactionType52Choice_ reqSecuritiesTransactionType )
    {
