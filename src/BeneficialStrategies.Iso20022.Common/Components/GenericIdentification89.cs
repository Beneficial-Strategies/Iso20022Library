...
public partial record GenericIdentification89
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification89 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification89( GenericIdentification47 reqType )
    {
        Type = reqType;
    }
    #endif
