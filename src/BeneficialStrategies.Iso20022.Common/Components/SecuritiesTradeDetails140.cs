...
[DataContract]
#endif
public partial record SecuritiesTradeDetails140
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails140 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails140( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate20Choice_ reqSettlementDate,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount107 reqQuantityAndAccountDetails,SettlementDetails174 reqSettlementParameters )
    {
    ...
    public required QuantityAndAccount107 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount107 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount107 QuantityAndAccountDetails { get; set; } 
    #endif
