...
public partial record PendingStatusReason13
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason13( PendingReason48Choice_ reqReasonCode )
    {
    ...
    public PendingReason48Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason48Choice_ ReasonCode { get; set; } 
    #endif
