...
public partial record SecuritiesOption71
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption71 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption71( FinancialInstrumentAttributes80 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate16 reqDateDetails )
    {
