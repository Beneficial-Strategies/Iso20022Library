...
public partial record QuantityAndAccount16
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount16( FinancialInstrumentQuantity1Choice_ reqSettlementQuantity,SecuritiesAccount13 reqSafekeepingAccount )
    {
