...
public partial record CorporateActionGeneralInformation87
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation87 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation87( System.String reqCorporateActionEventIdentification,CorporateActionEventType34Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
