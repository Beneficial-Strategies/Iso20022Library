...
public partial record Transaction36
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction36 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction36( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails63? TransactionDetails { get; init; } 
    #else
    public TransactionDetails63? TransactionDetails { get; set; } 
    #endif
