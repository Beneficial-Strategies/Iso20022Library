...
public partial record CorporateActionGeneralInformation128
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation128 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation128( System.String reqCorporateActionEventIdentification,CorporateActionEventType75Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes79 reqUnderlyingSecurity )
    {
