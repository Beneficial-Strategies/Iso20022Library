...
public partial record TransactionDetails132
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails132 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails132( TransactionActivity3Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity6Choice_ reqPostingQuantity,DateAndDateTime2Choice_ reqEffectiveSettlementDate )
    {
