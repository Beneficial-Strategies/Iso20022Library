...
public partial record CorporateActionOption189
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption189 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption189( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption39Choice_ reqOptionType )
    {
