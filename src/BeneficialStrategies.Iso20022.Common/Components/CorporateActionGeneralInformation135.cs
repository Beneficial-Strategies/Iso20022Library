...
public partial record CorporateActionGeneralInformation135
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation135 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation135( System.String reqCorporateActionEventIdentification,CorporateActionEventType84Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
