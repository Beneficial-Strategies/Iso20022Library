...
public partial record ReportEntry11
{
    ...
    /// </summary>
    public ReportEntry11( ActiveOrHistoricCurrencyAndAmount reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus1Choice_ reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
