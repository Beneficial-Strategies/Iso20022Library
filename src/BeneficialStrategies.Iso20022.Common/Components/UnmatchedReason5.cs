...
public partial record UnmatchedReason5
{
    ...
    #else
    /// <summary>
    /// Constructs a UnmatchedReason5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnmatchedReason5( UnmatchedReason7Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public UnmatchedReason7Choice_ Code { get; init; } 
    #else
    public UnmatchedReason7Choice_ Code { get; set; } 
    #endif
