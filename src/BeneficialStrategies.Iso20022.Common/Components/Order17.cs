...
public partial record Order17
{
    ...
    #else
    /// <summary>
    /// Constructs a Order17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Order17( Side3Code reqSide,TradeDate4Choice_ reqTradeDate,SettlementDate8Choice_ reqSettlementDate,Quantity6Choice_ reqConfirmationQuantity,Price4 reqDealPrice )
    {
        Side = reqSide;
