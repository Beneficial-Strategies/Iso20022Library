...
public partial record SettlementReportingResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementReportingResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementReportingResponse2( Environment27 reqEnvironment,Transaction139 reqTransaction,ProcessingResult13 reqProcessingResult )
    {
    ...
    public required Transaction139 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction139 Transaction { get; init; } 
    #else
    public Transaction139 Transaction { get; set; } 
    #endif
    
    /// <summary>
    /// Processing results of the settlement service.
    /// </summary>
    [IsoId("_KkHp54wFEeugeuahCxXQ-Q")]
