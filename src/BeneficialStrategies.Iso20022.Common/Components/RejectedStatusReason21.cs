...
public partial record RejectedStatusReason21
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason21( RejectedReason22Choice_ reqReasonCode )
    {
    ...
    public RejectedReason22Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason22Choice_ ReasonCode { get; set; } 
    #endif
