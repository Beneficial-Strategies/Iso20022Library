...
public partial record CashCollateral2
{
    ...
    #else
    /// <summary>
    /// Constructs a CashCollateral2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashCollateral2( ActiveCurrencyAndAmount reqCollateralValue )
    {
    ...
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public System.String? ReturnExcess { get; init; } 
    #else
    public System.String? ReturnExcess { get; set; } 
    #endif
