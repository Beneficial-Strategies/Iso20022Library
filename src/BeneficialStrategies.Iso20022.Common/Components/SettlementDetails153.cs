...
public partial record SettlementDetails153
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails153 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails153( SecuritiesTransactionType39Choice_ reqSecuritiesTransactionType )
    {
    ...
    public required SecuritiesTransactionType39Choice_ SecuritiesTransactionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTransactionType39Choice_ SecuritiesTransactionType { get; init; } 
    #else
    public SecuritiesTransactionType39Choice_ SecuritiesTransactionType { get; set; } 
    #endif
