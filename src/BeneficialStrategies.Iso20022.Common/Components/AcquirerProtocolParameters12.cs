...
public partial record AcquirerProtocolParameters12
{
    ...
    #else
    /// <summary>
    /// Constructs a AcquirerProtocolParameters12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcquirerProtocolParameters12( TerminalManagementAction3Code reqActionType,System.String reqVersion,System.String reqProtectCardData )
    {
    ...
    [IsoXmlTag("Hst")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AcquirerHostConfiguration6? Host { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AcquirerHostConfiguration6? Host { get; init; } 
    #else
    public AcquirerHostConfiguration6? Host { get; set; } 
    #endif
