...
public partial record OriginalNotification14
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalNotification14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalNotification14( System.String reqOriginalMessageIdentification,System.String reqOriginalNotificationIdentification )
    {
    ...
    public OriginalNotificationReference12? OriginalNotificationReference { get; init; } 
    #else
    public OriginalNotificationReference12? OriginalNotificationReference { get; set; } 
    #endif
