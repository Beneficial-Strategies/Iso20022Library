...
public partial record AccountSubLevel16
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSubLevel16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSubLevel16( SecuritiesAccount19 reqAccountIdentification,PartyIdentification100 reqAccountOwner,PartyIdentification100 reqAccountServicer )
    {
    ...
    public AccountSubLevel17? AccountSubLevel7 { get; init; } 
    #else
    public AccountSubLevel17? AccountSubLevel7 { get; set; } 
    #endif
