...
public partial record MessageAndBusinessReference7
{
    ...
    #else
    /// <summary>
    /// Constructs a MessageAndBusinessReference7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MessageAndBusinessReference7( System.String reqTransferReference )
    {
    ...
    public References39Choice_? Reference { get; init; } 
    #else
    public References39Choice_? Reference { get; set; } 
    #endif
    ...
    public InvestmentAccount40? InvestmentAccountDetails { get; init; } 
    #else
    public InvestmentAccount40? InvestmentAccountDetails { get; set; } 
    #endif
