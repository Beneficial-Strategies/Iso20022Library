...
public partial record CorporateActionOption174
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption174 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption174( System.String reqOptionNumber,CorporateActionOption36Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CorporateActionRate102? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate102? RateAndAmountDetails { get; set; } 
    #endif
    ...
    public CashOption74? CashMovementDetails { get; init; } 
    #else
    public CashOption74? CashMovementDetails { get; set; } 
    #endif
