...
public partial record Charge19
{
    ...
    #else
    /// <summary>
    /// Constructs a Charge19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Charge19( ChargeType11Code reqType,System.String reqExtendedType,ActiveCurrencyAnd13DecimalAmount reqAmount,System.Decimal reqRate )
    {
        Type = reqType;
