...
public partial record GroupHeader95
{
    ...
    #else
    /// <summary>
    /// Constructs a GroupHeader95 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GroupHeader95( System.String reqMessageIdentification,System.DateTime reqCreationDateTime,System.String reqNumberOfTransactions,PartyIdentification135 reqInitiatingParty )
    {
    ...
    /// </summary>
    [IsoId("_RS7BwMQKEemsic1bQcEtLA")]
    [DisplayName("Initiation Source")]
    #if DECLARE_DATACONTRACT
    [DataMember(Name="InitnSrc")]
    #endif
    [IsoXmlTag("InitnSrc")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    ...
    public PaymentInitiationSource1? InitiationSource { get; init; } 
    #else
    public PaymentInitiationSource1? InitiationSource { get; set; } 
    #endif
