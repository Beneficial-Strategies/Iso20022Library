...
public partial record PaymentInstruction31
{
    ...
    #endif
    [IsoXmlTag("CdtTrfTx")]
    public ValueList<CreditTransferTransaction35> CreditTransferTransaction { get; init; } = new ValueList<CreditTransferTransaction35>(){}; // Warning: Don't know multiplicity.
