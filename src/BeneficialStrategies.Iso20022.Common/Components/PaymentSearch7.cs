...
public record PaymentSearch7
{
    ...
    [IsoXmlTag("PmtId")]
    public ValueList<PaymentIdentification5Choice_> PaymentIdentification { get; init; } = [];
    ...
    [DisplayName("Status")]
    [IsoXmlTag("Sts")]
    public ValueList<InstructionStatusSearch4> Status { get; init; } = [];
    ...
    [IsoXmlTag("Prty")]
    public ValueList<PriorityCode3Choice_> Priority { get; init; } = [];
