...
public record AcceptorConfigurationContent6
{
    ...
    public ValueList<TMSProtocolParameters2> TMSProtocolParameters { get; init; } = [];
    ...
    public ValueList<AcquirerProtocolParameters10> AcquirerProtocolParameters { get; init; } = [];
    ...
    public ValueList<MerchantConfigurationParameters3> MerchantParameters { get; init; } = [];
    ...
    public ValueList<PaymentTerminalParameters4> TerminalParameters { get; init; } = [];
    ...
    public ValueList<ApplicationParameters6> ApplicationParameters { get; init; } = [];
    ...
    public ValueList<HostCommunicationParameter4> HostCommunicationParameters { get; init; } = [];
    ...
    public ValueList<SecurityParameters6> SecurityParameters { get; init; } = [];
}
