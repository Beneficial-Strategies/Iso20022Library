...
public partial record CardPaymentTransaction78
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction78 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction78( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails32 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails32 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails32 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails32 TransactionDetails { get; set; } 
    #endif
