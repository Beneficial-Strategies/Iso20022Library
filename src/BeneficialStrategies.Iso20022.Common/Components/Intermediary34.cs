...
public partial record Intermediary34
{
    ...
    #else
    /// <summary>
    /// Constructs a Intermediary34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Intermediary34( PartyIdentification70Choice_ reqIdentification )
    {
