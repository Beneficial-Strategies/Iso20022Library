...
public partial record CorporateActionGeneralInformation129
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation129 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation129( System.String reqCorporateActionEventIdentification,CorporateActionEventType77Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
