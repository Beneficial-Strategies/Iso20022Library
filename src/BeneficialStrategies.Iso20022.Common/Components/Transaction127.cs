...
public partial record Transaction127
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction127 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction127( System.String reqAccountOwnerTransactionIdentification )
    {
