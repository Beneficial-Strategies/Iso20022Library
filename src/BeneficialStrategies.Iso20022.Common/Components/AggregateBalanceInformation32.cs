...
public record AggregateBalanceInformation32
{
    ...
    [IsoXmlTag("QtyBrkdwn")]
    public ValueList<QuantityBreakdown39> QuantityBreakdown { get; init; } = [];
    ...
    public ValueList<AggregateBalancePerSafekeepingPlace30> BalanceAtSafekeepingPlace { get; init; } =
        [];
