...
public partial record RejectionOrRepairReason25
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionOrRepairReason25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionOrRepairReason25( RejectionAndRepairReason25Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
