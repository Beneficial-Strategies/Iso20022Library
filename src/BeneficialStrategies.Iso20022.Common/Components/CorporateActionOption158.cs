...
public partial record CorporateActionOption158
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption158 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption158( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption29Choice_ reqOptionType,SecuritiesQuantityOrAmount5Choice_ reqSecuritiesQuantityOrInstructedAmount )
    {
