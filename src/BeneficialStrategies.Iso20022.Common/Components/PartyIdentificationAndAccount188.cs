...
public partial record PartyIdentificationAndAccount188
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount188 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount188( PartyIdentification137Choice_ reqIdentification )
    {
