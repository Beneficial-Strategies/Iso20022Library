...
public partial record ExternallyDefinedData1
{
    ...
    #else
    /// <summary>
    /// Constructs a ExternallyDefinedData1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ExternallyDefinedData1( System.String reqIdentification )
    {
    ...
    public ContentInformationType23? ProtectedValue { get; init; } 
    #else
    public ContentInformationType23? ProtectedValue { get; set; } 
    #endif
