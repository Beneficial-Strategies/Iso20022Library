...
public partial record AccountStatement12
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountStatement12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountStatement12( System.String reqIdentification,CashAccount41 reqAccount )
    {
