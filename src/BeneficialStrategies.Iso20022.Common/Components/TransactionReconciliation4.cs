...
public partial record TransactionReconciliation4
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionReconciliation4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionReconciliation4( TransactionIdentifier1 reqReconciliationTransactionIdentification,System.String reqReconciliationIdentification )
    {
