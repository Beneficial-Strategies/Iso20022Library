...
public partial record AccountReport22
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountReport22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountReport22( System.String reqIdentification,CashAccount36 reqAccount )
    {
