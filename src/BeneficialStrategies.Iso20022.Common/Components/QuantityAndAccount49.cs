...
public partial record QuantityAndAccount49
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount49 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount49( FinancialInstrumentQuantity15Choice_ reqSettlementQuantity,SecuritiesAccount27 reqSafekeepingAccount )
    {
