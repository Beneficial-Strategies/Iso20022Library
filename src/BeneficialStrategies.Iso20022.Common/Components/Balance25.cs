...
[DataContract]
#endif
public partial record Balance25
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a Balance25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Balance25( BalanceQuantity17Choice_ reqQuantity )
    {
    ...
    public required BalanceQuantity17Choice_ Quantity { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public BalanceQuantity17Choice_ Quantity { get; init; } 
    #else
    public BalanceQuantity17Choice_ Quantity { get; set; } 
    #endif
