...
public partial record CorporateActionOption124
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption124 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption124( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption26Choice_ reqOptionType )
    {
    ...
    public CorporateActionRate74? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate74? RateAndAmountDetails { get; set; } 
    #endif
    ...
    public SecuritiesOption55? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOption55? SecuritiesMovementDetails { get; set; } 
    #endif
    ...
    public CashOption46? CashMovementDetails { get; init; } 
    #else
    public CashOption46? CashMovementDetails { get; set; } 
    #endif
