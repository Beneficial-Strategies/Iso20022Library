...
public partial record GenericIdentification74
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification74 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification74( System.String reqIdentification,PartyType10Code reqType )
    {
    ...
    public required PartyType10Code Type { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PartyType10Code Type { get; init; } 
    #else
    public PartyType10Code Type { get; set; } 
    #endif
    ...
    public PartyType10Code? Issuer { get; init; } 
    #else
    public PartyType10Code? Issuer { get; set; } 
    #endif
