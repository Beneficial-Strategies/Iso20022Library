...
public partial record CardPaymentTransaction32
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction32 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction32( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails17 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails17 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails17 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails17 TransactionDetails { get; set; } 
    #endif
