...
public partial record PartyIdentificationAndAccount37
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount37 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount37( PartyIdentification49Choice_ reqIdentification )
    {
