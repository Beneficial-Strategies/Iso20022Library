...
public partial record PartyIdentificationAndAccount121
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount121 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount121( PartyIdentification94Choice_ reqIdentification )
    {
    ...
    public PartyIdentification94Choice_ Identification { get; init; } 
    #else
    public PartyIdentification94Choice_ Identification { get; set; } 
    #endif
