...
public partial record CorporateActionGeneralInformationSD9
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD9( System.String reqPlaceAndName )
    {
