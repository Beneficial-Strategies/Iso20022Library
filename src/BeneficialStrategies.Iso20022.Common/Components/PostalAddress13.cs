...
public partial record PostalAddress13
{
    ...
    #else
    /// <summary>
    /// Constructs a PostalAddress13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PostalAddress13( System.String reqPostCode,System.String reqTownName,string reqCountry )
    {
