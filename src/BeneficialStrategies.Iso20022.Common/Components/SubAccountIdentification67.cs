...
public partial record SubAccountIdentification67
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification67 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification67( System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation42? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation42? BalanceForSubAccount { get; set; } 
    #endif
