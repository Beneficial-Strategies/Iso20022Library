...
public partial record ForeignExchangeTerms31
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTerms31 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTerms31( string reqUnitCurrency,string reqQuotedCurrency,System.Decimal reqExchangeRate )
    {
    ...
    public PartyIdentification104Choice_? QuotingInstitution { get; init; } 
    #else
    public PartyIdentification104Choice_? QuotingInstitution { get; set; } 
    #endif
