...
public partial record CardTransaction4
{
    ...
    #else
    /// <summary>
    /// Constructs a CardTransaction4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardTransaction4( CardPaymentServiceType7Code reqTransactionType,System.DateTime reqAcceptorTransactionDateTime,System.String reqInitiatorTransactionIdentification,CardTransactionDetail2 reqTransactionDetails )
    {
    ...
    public required CardTransactionDetail2 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardTransactionDetail2 TransactionDetails { get; init; } 
    #else
    public CardTransactionDetail2 TransactionDetails { get; set; } 
    #endif
