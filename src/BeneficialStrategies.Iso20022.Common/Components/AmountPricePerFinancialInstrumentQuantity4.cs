...
public partial record AmountPricePerFinancialInstrumentQuantity4
{
    ...
    #else
    /// <summary>
    /// Constructs a AmountPricePerFinancialInstrumentQuantity4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AmountPricePerFinancialInstrumentQuantity4( AmountPriceType1Code reqAmountPriceType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqPriceValue,FinancialInstrumentQuantity15Choice_ reqFinancialInstrumentQuantity )
    {
