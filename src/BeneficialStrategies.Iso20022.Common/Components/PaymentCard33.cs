...
public partial record PaymentCard33
{
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public ContentInformationType35? ProtectedCardData { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ContentInformationType35? ProtectedCardData { get; init; } 
    #else
    public ContentInformationType35? ProtectedCardData { get; set; } 
    #endif
    
    /// <summary>
    /// Replacement of the message element PlainCardData by a private envelope.
    /// </summary>
    [IsoId("_7wmJ43DYEe2MCaKO5AtGsA")]
