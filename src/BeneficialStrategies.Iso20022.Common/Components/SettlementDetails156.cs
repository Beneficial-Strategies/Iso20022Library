...
public partial record SettlementDetails156
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails156 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails156( SecuritiesTransactionType42Choice_ reqSecuritiesTransactionType )
    {
    ...
    #else
    public SecuritiesTransactionType42Choice_ SecuritiesTransactionType { get; set; } 
    #endif
    
    /// <summary>
    /// Conditions under which the order/trade is to be settled.
    /// </summary>
    [IsoId("_KuGTH830Eee5nJBZsW8MFQ")]
