...
public partial record SecuritiesOption85
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption85 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption85( FinancialInstrumentAttributes115 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate18 reqDateDetails )
    {
