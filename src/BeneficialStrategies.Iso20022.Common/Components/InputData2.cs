...
public partial record InputData2
{
    ...
    #else
    /// <summary>
    /// Constructs a InputData2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InputData2( SaleCapabilities2Code reqDeviceType,InformationQualify1Code reqInformationQualifier,InputCommand1Code reqInputCommand,System.String reqNotifyCardInputFlag )
    {
    ...
    public ActionMessage7? InputText { get; init; } 
    #else
    public ActionMessage7? InputText { get; set; } 
    #endif
