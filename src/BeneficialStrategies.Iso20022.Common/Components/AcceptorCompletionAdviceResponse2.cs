...
public partial record AcceptorCompletionAdviceResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCompletionAdviceResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCompletionAdviceResponse2( CardPaymentEnvironment11 reqEnvironment,CardPaymentTransactionAdviceResponse3 reqTransaction )
    {
