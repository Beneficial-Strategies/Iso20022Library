...
public partial record RateTypeAndAmountAndStatus34
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus34( RateType48Choice_ reqRateType,RestrictedFINActiveCurrencyAnd13DecimalAmount reqAmount )
    {
