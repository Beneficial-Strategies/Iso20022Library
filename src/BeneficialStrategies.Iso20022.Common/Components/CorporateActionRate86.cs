...
public record CorporateActionRate86
{
    /// <summary>
    ...
    public ValueList<GrossDividendRateFormat27Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat29Choice_> NetDividendRate { get; init; } = [];
