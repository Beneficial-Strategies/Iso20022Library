...
public partial record CashOption72
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption72 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption72( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate62 reqDateDetails )
    {
