...
public partial record CreditTransferTransaction32
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction32 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction32( PartyIdentification125 reqDebtor,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent,BranchAndFinancialInstitutionIdentification5 reqCreditorAgent,PartyIdentification125 reqCreditor )
    {
        Debtor = reqDebtor;
