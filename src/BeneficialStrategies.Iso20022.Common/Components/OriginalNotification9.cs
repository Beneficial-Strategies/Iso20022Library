...
public partial record OriginalNotification9
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalNotification9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalNotification9( System.String reqOriginalMessageIdentification,System.String reqOriginalNotificationIdentification )
    {
    ...
    public OriginalNotificationReference7? OriginalNotificationReference { get; init; } 
    #else
    public OriginalNotificationReference7? OriginalNotificationReference { get; set; } 
    #endif
