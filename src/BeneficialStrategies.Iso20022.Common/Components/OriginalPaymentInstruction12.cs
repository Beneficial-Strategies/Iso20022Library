...
public partial record OriginalPaymentInstruction12
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction12( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction57? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction57? TransactionInformationAndStatus { get; set; } 
    #endif
