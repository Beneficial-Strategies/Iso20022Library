...
public partial record AuthorisationInitiation2
{
    ...
    #else
    /// <summary>
    /// Constructs a AuthorisationInitiation2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AuthorisationInitiation2( Environment17 reqEnvironment,Context10 reqContext,Transaction142 reqTransaction )
    {
