...
public partial record QuantityAndAccount56
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount56 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount56( Quantity10Choice_ reqSettlementQuantity,SecuritiesAccount30 reqSafekeepingAccount )
    {
