...
public record CorporateActionOption136
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption63> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption55> CashMovementDetails { get; init; } = [];
}
