...
public partial record ReconciliationResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a ReconciliationResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReconciliationResponse2( Environment3 reqEnvironment,Transaction94 reqTransaction,ProcessingResult4 reqProcessingResult )
    {
    ...
    public required Transaction94 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction94 Transaction { get; init; } 
    #else
    public Transaction94 Transaction { get; set; } 
    #endif
