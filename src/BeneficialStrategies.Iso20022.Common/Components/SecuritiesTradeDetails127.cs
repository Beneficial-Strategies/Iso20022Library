...
public partial record SecuritiesTradeDetails127
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails127 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails127( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate20Choice_ reqSettlementDate,SecurityIdentification20 reqFinancialInstrumentIdentification,QuantityAndAccount89 reqQuantityAndAccountDetails,SettlementDetails174 reqSettlementParameters )
    {
