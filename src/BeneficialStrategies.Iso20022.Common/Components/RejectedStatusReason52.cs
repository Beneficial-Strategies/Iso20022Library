...
public partial record RejectedStatusReason52
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason52 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason52( RejectedReason55Choice_ reqReasonCode )
    {
