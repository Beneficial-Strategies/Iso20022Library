...
public partial record GroupHeader50
{
    ...
    #else
    /// <summary>
    /// Constructs a GroupHeader50 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GroupHeader50( System.String reqMessageIdentification,System.DateTime reqCreationDateTime,System.String reqNumberOfTransactions,SettlementInstruction2 reqSettlementInformation )
    {
    ...
    public required SettlementInstruction2 SettlementInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementInstruction2 SettlementInformation { get; init; } 
    #else
    public SettlementInstruction2 SettlementInformation { get; set; } 
    #endif
