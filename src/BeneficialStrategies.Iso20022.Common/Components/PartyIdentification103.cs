...
public partial record PartyIdentification103
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification103 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification103( PartyIdentification58Choice_ reqIdentification )
    {
