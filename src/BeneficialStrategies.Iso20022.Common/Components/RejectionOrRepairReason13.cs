...
public partial record RejectionOrRepairReason13
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionOrRepairReason13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionOrRepairReason13( RejectionAndRepairReason13Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
