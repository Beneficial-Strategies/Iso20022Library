...
public partial record CorporateActionOption130
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption130 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption130( System.String reqOptionNumber,CorporateActionOption18Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CorporateActionRate80? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate80? RateAndAmountDetails { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CashOption50? CashMovementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CashOption50? CashMovementDetails { get; init; } 
    #else
    public CashOption50? CashMovementDetails { get; set; } 
    #endif
