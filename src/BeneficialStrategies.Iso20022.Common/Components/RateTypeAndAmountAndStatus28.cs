...
public partial record RateTypeAndAmountAndStatus28
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus28 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus28( RateType38Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
    ...
    public RateType38Choice_ RateType { get; init; } 
    #else
    public RateType38Choice_ RateType { get; set; } 
    #endif
