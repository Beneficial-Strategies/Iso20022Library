...
public partial record RateTypeAndAmountAndStatus56
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus56 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus56( RateType77Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
    ...
    public RateType77Choice_ RateType { get; init; } 
    #else
    public RateType77Choice_ RateType { get; set; } 
    #endif
