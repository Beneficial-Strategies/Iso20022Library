...
public partial record IntraPositionDetails47
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionDetails47 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionDetails47( FinancialInstrumentQuantity15Choice_ reqSettledQuantity,DateAndDateTime2Choice_ reqSettlementDate,SecuritiesSubBalanceTypeAndQuantityBreakdown4 reqBalanceFrom,SecuritiesSubBalanceTypeAndQuantityBreakdown4 reqBalanceTo )
    {
