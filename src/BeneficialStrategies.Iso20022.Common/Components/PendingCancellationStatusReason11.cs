...
public partial record PendingCancellationStatusReason11
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingCancellationStatusReason11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingCancellationStatusReason11( PendingCancellationReason8Choice_ reqReasonCode )
    {
