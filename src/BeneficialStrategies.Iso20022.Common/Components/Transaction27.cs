...
public partial record Transaction27
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction27( System.String reqAccountOwnerTransactionIdentification )
    {
