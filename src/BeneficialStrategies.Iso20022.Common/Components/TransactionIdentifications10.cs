...
public partial record TransactionIdentifications10
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionIdentifications10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionIdentifications10( System.String reqAccountOwnerTransactionIdentification )
    {
