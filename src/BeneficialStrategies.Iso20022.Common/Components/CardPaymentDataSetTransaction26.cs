...
public partial record CardPaymentDataSetTransaction26
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction26( System.String reqTransactionSequenceCounter,CardPaymentEnvironment69 reqEnvironment,CardPaymentTransaction90 reqTransaction,CardPaymentTransaction84 reqTransactionResponse )
    {
