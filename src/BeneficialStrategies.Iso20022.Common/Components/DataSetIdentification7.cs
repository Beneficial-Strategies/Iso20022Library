...
public partial record DataSetIdentification7
{
    ...
    #else
    /// <summary>
    /// Constructs a DataSetIdentification7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DataSetIdentification7( DataSetCategory12Code reqType )
    {
        Type = reqType;
    }
    #endif
    ...
    public required DataSetCategory12Code Type { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public DataSetCategory12Code Type { get; init; } 
    #else
    public DataSetCategory12Code Type { get; set; } 
    #endif
