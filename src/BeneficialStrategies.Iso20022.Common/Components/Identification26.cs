...
public partial record Identification26
{
    ...
    #else
    /// <summary>
    /// Constructs a Identification26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Identification26( System.String reqAccountOwnerTransactionIdentification )
    {
