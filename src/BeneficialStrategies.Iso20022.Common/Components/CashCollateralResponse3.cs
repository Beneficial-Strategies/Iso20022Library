...
public partial record CashCollateralResponse3
{
    ...
    #else
    /// <summary>
    /// Constructs a CashCollateralResponse3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashCollateralResponse3( Status4Code reqResponseType )
    {
