...
public partial record QuantityAndAccount63
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount63 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount63( FinancialInstrumentQuantity1Choice_ reqSettlementQuantity,SecuritiesAccount19 reqSafekeepingAccount )
    {
