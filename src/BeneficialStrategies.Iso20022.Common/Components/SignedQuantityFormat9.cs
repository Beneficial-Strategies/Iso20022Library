...
public partial record SignedQuantityFormat9
{
    ...
    #else
    /// <summary>
    /// Constructs a SignedQuantityFormat9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SignedQuantityFormat9( ShortLong1Code reqShortLongPosition,FinancialInstrumentQuantity15Choice_ reqQuantity )
    {
