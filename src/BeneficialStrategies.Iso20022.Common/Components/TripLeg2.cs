...
public partial record TripLeg2
{
    ...
    public AmountDetails2? TripLegAmount { get; init; } 
    #else
    public AmountDetails2? TripLegAmount { get; set; } 
    #endif
