...
public partial record PartyIdentification215
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification215 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification215( System.String reqName,PartyIdentification195Choice_ reqIdentification )
    {
        Name = reqName;
