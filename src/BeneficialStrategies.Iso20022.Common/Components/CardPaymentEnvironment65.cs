...
public partial record CardPaymentEnvironment65
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentEnvironment65 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentEnvironment65( GenericIdentification32 reqPOIIdentification )
    {
