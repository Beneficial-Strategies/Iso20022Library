...
public partial record InvestmentAccountOwnershipInformation10
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccountOwnershipInformation10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccountOwnershipInformation10( Party23Choice_ reqParty )
    {
        Party = reqParty;
    }
    #endif
