...
public partial record CorporateActionOption206
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption206 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption206( System.String reqOptionNumber,CorporateActionOption46Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CashOption81? CashMovementDetails { get; init; } 
    #else
    public CashOption81? CashMovementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information about the corporate action movement.
    /// </summary>
    [IsoId("_ptGnoTi7Eeydid5dcNPKvg")]
