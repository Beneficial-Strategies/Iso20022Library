...
public partial record PaymentTransaction81
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentTransaction81 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentTransaction81( ActiveCurrencyAndAmount reqReversedInterbankSettlementAmount )
    {
