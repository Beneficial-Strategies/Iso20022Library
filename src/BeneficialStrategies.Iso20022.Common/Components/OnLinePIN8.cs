...
public partial record OnLinePIN8
{
    ...
    #else
    /// <summary>
    /// Constructs a OnLinePIN8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OnLinePIN8( ContentInformationType28 reqEncryptedPINBlock,PINFormat3Code reqPINFormat )
    {
    ...
    public ContentInformationType28 EncryptedPINBlock { get; init; } 
    #else
    public ContentInformationType28 EncryptedPINBlock { get; set; } 
    #endif
    
    /// <summary>
    /// PIN (Personal Identification Number) format before encryption.
    /// </summary>
    [IsoId("_zml_My8zEeu125Ip9zFcsQ")]
