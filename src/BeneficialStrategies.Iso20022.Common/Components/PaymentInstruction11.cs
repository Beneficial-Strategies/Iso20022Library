...
public partial record PaymentInstruction11
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentInstruction11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentInstruction11( PaymentMethod7Code reqPaymentMethod,System.DateOnly reqRequestedExecutionDate,PartyIdentification43 reqDebtor,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent )
    {
    ...
    #endif
    [IsoXmlTag("CdtTrfTx")]
    public ValueList<CreditTransferTransaction10> CreditTransferTransaction { get; init; } = new ValueList<CreditTransferTransaction10>(){}; // Warning: Don't know multiplicity.
