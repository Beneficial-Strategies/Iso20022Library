...
public partial record AccountAndBalance33
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountAndBalance33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountAndBalance33( System.String reqSafekeepingAccount )
    {
