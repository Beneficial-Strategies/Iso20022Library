...
public partial record PortfolioTransfer3
{
    ...
    #else
    /// <summary>
    /// Constructs a PortfolioTransfer3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PortfolioTransfer3( System.String reqTransferIdentification )
    {
    ...
    public FundPortfolio3Choice_? Portfolio { get; init; } 
    #else
    public FundPortfolio3Choice_? Portfolio { get; set; } 
    #endif
    ...
    public FinancialInstrument69? FinancialInstrumentAssetForTransfer { get; init; } 
    #else
    public FinancialInstrument69? FinancialInstrumentAssetForTransfer { get; set; } 
    #endif
