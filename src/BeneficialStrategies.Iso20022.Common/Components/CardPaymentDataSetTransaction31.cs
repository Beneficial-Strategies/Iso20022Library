...
public partial record CardPaymentDataSetTransaction31
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction31 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction31( System.String reqTransactionSequenceCounter,CardPaymentEnvironment74 reqEnvironment,CardPaymentTransaction95 reqTransaction )
    {
