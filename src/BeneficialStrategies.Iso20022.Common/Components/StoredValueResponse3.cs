...
public partial record StoredValueResponse3
{
    ...
    #else
    /// <summary>
    /// Constructs a StoredValueResponse3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StoredValueResponse3( TransactionIdentifier1 reqPOITransactionIdentification )
    {
    ...
    public StoredValueData3? Result { get; init; } 
    #else
    public StoredValueData3? Result { get; set; } 
    #endif
