...
public partial record CancelledStatusReason4
{
    ...
    #else
    /// <summary>
    /// Constructs a CancelledStatusReason4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CancelledStatusReason4( CancelledReason1Choice_ reqReasonCode )
    {
    ...
    public CancelledReason1Choice_ ReasonCode { get; init; } 
    #else
    public CancelledReason1Choice_ ReasonCode { get; set; } 
    #endif
