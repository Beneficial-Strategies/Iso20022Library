...
public partial record IntraPositionDetails50
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionDetails50 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionDetails50( SecuritiesAccount30 reqSafekeepingAccount,SecurityIdentification20 reqFinancialInstrumentIdentification,FinancialInstrumentQuantity1Choice_ reqSettlementQuantity,DateAndDateTime2Choice_ reqSettlementDate )
    {
