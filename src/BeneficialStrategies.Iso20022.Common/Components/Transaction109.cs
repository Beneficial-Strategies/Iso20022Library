...
public partial record Transaction109
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction109 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction109( System.String reqAccountOwnerTransactionIdentification )
    {
