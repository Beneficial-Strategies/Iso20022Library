...
public partial record CardPaymentDataSetTransaction6
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction6( System.String reqTransactionSequenceCounter,CardPaymentEnvironment27 reqEnvironment,CardPaymentTransaction29 reqTransaction )
    {
