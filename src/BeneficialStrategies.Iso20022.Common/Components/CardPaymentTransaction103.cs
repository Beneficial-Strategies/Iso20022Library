...
public partial record CardPaymentTransaction103
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction103 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction103( TransactionIdentifier1 reqTransactionIdentification,System.String reqTransactionSuccess,CardPaymentTransactionDetails49 reqTransactionDetails )
    {
    ...
    public AuthorisationResult15? AuthorisationResult { get; init; } 
    #else
    public AuthorisationResult15? AuthorisationResult { get; set; } 
    #endif
