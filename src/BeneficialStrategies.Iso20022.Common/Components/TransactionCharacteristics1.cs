...
/// <summary>
/// Transaction Characteristics1.
/// </summary>
[IsoId("_V-4PIWxlEe6wzr2RagRERg")]
[DisplayName("Transaction Characteristics1")]
public partial record TransactionCharacteristics1
{
    #nullable enable
    ...
    public ValueList<IsoMax35Text> OtherTransactionAttribute { get; init; } = [];
