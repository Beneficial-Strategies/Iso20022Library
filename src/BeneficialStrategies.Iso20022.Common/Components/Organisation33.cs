...
public record Organisation33
{
    ...
    public ValueList<PartyIdentification137> RepresentativeOfficer { get; init; } = [];
    ...
    public ValueList<PartyIdentification137> MainMandateHolder { get; init; } = [];
    ...
    [DisplayName("Sender")]
    [IsoXmlTag("Sndr")]
    public ValueList<PartyIdentification137> Sender { get; init; } = [];
    ...
    [IsoXmlTag("LglRprtv")]
    public ValueList<PartyIdentification137> LegalRepresentative { get; init; } = [];
}
