...
public partial record SecuritiesTradeDetails95
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails95 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails95( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate17Choice_ reqSettlementDate,SecurityIdentification19 reqFinancialInstrumentIdentification,QuantityAndAccount84 reqQuantityAndAccountDetails,SettlementDetails168 reqSettlementParameters )
    {
