...
public partial record OriginalPaymentInstruction42
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction42 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction42( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction136? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction136? TransactionInformationAndStatus { get; set; } 
    #endif
