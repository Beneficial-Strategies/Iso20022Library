...
public partial record InvestmentAccountOwnershipInformation16
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccountOwnershipInformation16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccountOwnershipInformation16( Party47Choice_ reqParty )
    {
        Party = reqParty;
    }
    #endif
