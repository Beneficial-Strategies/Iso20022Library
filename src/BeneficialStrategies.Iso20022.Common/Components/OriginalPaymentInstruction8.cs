...
public partial record OriginalPaymentInstruction8
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction8( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction47? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction47? TransactionInformation { get; set; } 
    #endif
