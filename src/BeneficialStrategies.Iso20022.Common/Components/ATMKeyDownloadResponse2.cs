...
public partial record ATMKeyDownloadResponse2
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMKeyDownloadResponse2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMKeyDownloadResponse2( ATMEnvironment7 reqEnvironment,ATMSecurityContext2 reqATMSecurityContext,SecurityParameters5 reqHostSecurityParameters )
    {
