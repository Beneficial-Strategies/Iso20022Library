...
/// Rate47.
/// </summary>
[IsoId("_nLnMQ5t3Ee-wQIOX0djF2w")]
[DisplayName("Rate47")]
public partial record Rate47
{
    #nullable enable
    ...
    [IsoXmlTag("ChrgsFees")]
    public RateAndAmountFormat72Choice_? ChargesFees { get; init; } 
    ...
    [IsoXmlTag("DmdRate")]
    public ValueList<RateAndAmountFormat77Choice_> DeemedRate { get; init; } = [];
    ...
    public SolicitationFeeRateFormat15Choice_? EarlySolicitationFeeRate { get; init; } 
    ...
    public ValueList<RateAndAmountFormat76Choice_> SecondLevelTax { get; init; } = [];
    ...
    public SolicitationFeeRateFormat15Choice_? SolicitationFeeRate { get; init; } 
    ...
    public RateFormat30Choice_? TaxCreditRate { get; init; } 
    ...
    public RateFormat30Choice_? ThirdPartyIncentiveRate { get; init; } 
    ...
    public ValueList<RateAndAmountFormat76Choice_> WithholdingTaxRate { get; init; } = [];
