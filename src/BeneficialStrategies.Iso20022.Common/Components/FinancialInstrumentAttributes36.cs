...
/// </summary>
[IsoId("_ilYFof_iEeCcv6nahBzk1w")]
[DisplayName("Financial Instrument Attributes")]
public record FinancialInstrumentAttributes36
{
    /// <summary>
    /// Market(s) on which the security is listed.
    /// </summary>
    [IsoId("_ilYFs__iEeCcv6nahBzk1w")]
    ...
    /// </summary>
    [IsoId("_ilYG1f_iEeCcv6nahBzk1w")]
    [DisplayName("Quantity Breakdown")]
    [IsoXmlTag("QtyBrkdwn")]
    public ValueList<QuantityBreakdown15> QuantityBreakdown { get; init; } = [];

    /// <summary>
    /// Indicates whether the interest rate of an interest bearing instrument is reset periodically.
    /// </summary>
    [IsoId("_ilYG2f_iEeCcv6nahBzk1w")]
