...
public partial record CorporateActionGeneralInformation26
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation26( System.String reqCorporateActionEventIdentification,CorporateActionEventType3Choice_ reqEventType )
    {
