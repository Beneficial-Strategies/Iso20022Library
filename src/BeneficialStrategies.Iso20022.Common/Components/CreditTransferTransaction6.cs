...
public partial record CreditTransferTransaction6
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction6( PaymentIdentification1 reqPaymentIdentification,AmountType3Choice_ reqAmount )
    {
