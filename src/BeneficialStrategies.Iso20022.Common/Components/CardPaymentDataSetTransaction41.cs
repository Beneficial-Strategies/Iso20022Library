...
public partial record CardPaymentDataSetTransaction41
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction41( System.String reqTransactionSequenceCounter,CardPaymentEnvironment78 reqEnvironment,CardPaymentTransaction118 reqTransaction )
    {
