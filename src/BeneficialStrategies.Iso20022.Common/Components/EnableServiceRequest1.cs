...
public partial record EnableServiceRequest1
{
    ...
    #else
    /// <summary>
    /// Constructs a EnableServiceRequest1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EnableServiceRequest1( TransactionAction1Code reqTransactionAction )
    {
