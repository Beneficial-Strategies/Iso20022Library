...
public record AggregateBalanceInformation8
{
    /// <summary>
    ...
    [IsoXmlTag("QtyBrkdwn")]
    public ValueList<QuantityBreakdown4> QuantityBreakdown { get; init; } = [];
    ...
    public ValueList<AggregateBalancePerSafekeepingPlace7> BalanceAtSafekeepingPlace { get; init; } =
        [];
