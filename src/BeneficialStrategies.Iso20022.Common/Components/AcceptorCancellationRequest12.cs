...
public partial record AcceptorCancellationRequest12
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationRequest12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationRequest12( CardPaymentEnvironment79 reqEnvironment,CardPaymentContext30 reqContext,CardPaymentTransaction115 reqTransaction )
    {
