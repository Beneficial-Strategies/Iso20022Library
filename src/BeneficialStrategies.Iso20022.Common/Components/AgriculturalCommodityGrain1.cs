...
public partial record AgriculturalCommodityGrain1
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommodityGrain1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommodityGrain1( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType5Code reqSubProduct )
    {
