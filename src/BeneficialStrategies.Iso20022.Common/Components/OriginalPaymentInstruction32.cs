...
public partial record OriginalPaymentInstruction32
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction32 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction32( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction105? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction105? TransactionInformationAndStatus { get; set; } 
    #endif
