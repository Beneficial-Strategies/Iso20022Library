...
public partial record CorporateActionOption177
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption177 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption177( System.String reqOptionNumber,CorporateActionOption37Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CorporateActionPrice70? PriceDetails { get; init; } 
    #else
    public CorporateActionPrice70? PriceDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about securities quantity linked to a corporate action option.
    /// </summary>
    [IsoId("_L1hQUe29Eeqc-LCjwLsUVg")]
