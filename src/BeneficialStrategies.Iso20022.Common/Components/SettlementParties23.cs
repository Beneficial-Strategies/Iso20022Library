...
public partial record SettlementParties23
{
    ...
    public PartyIdentification55? Depository { get; init; } 
    #else
    public PartyIdentification55? Depository { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount34? Party1 { get; init; } 
    #else
    public PartyIdentificationAndAccount34? Party1 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount34? Party2 { get; init; } 
    #else
    public PartyIdentificationAndAccount34? Party2 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount34? Party3 { get; init; } 
    #else
    public PartyIdentificationAndAccount34? Party3 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount34? Party4 { get; init; } 
    #else
    public PartyIdentificationAndAccount34? Party4 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount34? Party5 { get; init; } 
    #else
    public PartyIdentificationAndAccount34? Party5 { get; set; } 
    #endif
