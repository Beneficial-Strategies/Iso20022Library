...
public partial record OriginalTransactionReference33
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalTransactionReference33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalTransactionReference33( BranchAndFinancialInstitutionIdentification6 reqCreditorAgent,PartyIdentification135 reqCreditor )
    {
