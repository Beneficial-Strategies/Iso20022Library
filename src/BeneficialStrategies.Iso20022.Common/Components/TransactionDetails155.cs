...
public partial record TransactionDetails155
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails155 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails155( SecurityIdentification19 reqFinancialInstrumentIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity51Choice_ reqSettlementQuantity,SettlementDate19Choice_ reqSettlementDate )
    {
