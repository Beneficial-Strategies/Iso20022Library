...
public partial record LiquidityDebitTransfer2
{
    ...
    #else
    /// <summary>
    /// Constructs a LiquidityDebitTransfer2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public LiquidityDebitTransfer2( Amount2Choice_ reqTransferredAmount )
    {
