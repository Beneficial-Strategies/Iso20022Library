...
public partial record CorporateActionOption160
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption160 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption160( System.String reqOptionNumber,CorporateActionOption23Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CorporateActionDate76? DateDetails { get; init; } 
    #else
    public CorporateActionDate76? DateDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the periods related to a corporate action option.
    /// </summary>
    [IsoId("_cs4QmffSEeiNZp_PtLohLw")]
    ...
    public CorporateActionRate94? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate94? RateAndAmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the prices related to a corporate action option.
    /// </summary>
    [IsoId("_cs4QqffSEeiNZp_PtLohLw")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CashOption68? CashMovementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CashOption68? CashMovementDetails { get; init; } 
    #else
    public CashOption68? CashMovementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information about the corporate action movement.
    /// </summary>
    [IsoId("_cs4QyffSEeiNZp_PtLohLw")]
