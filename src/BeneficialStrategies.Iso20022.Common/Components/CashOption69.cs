...
public partial record CashOption69
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption69 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption69( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate72 reqDateDetails )
    {
    ...
    public CorporateActionAmounts53? AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts53? AmountDetails { get; set; } 
    #endif
