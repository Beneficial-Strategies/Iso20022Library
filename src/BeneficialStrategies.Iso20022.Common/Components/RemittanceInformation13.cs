...
public partial record RemittanceInformation13
{
    ...
    #else
    /// <summary>
    /// Constructs a RemittanceInformation13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RemittanceInformation13( OriginalPaymentInformation7 reqOriginalPaymentInformation )
    {
    ...
    public required OriginalPaymentInformation7 OriginalPaymentInformation { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OriginalPaymentInformation7 OriginalPaymentInformation { get; init; } 
    #else
    public OriginalPaymentInformation7 OriginalPaymentInformation { get; set; } 
    #endif
