...
public partial record CorporateActionInstructedBalanceOptionBalanceSD3
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionInstructedBalanceOptionBalanceSD3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionInstructedBalanceOptionBalanceSD3( OptionNumber1Choice_ reqOptionNumber )
    {
