...
public partial record TransactionDetails74
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails74 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails74( SecurityIdentification19 reqFinancialInstrumentIdentification,SettlementDate9Choice_ reqSettlementDate,Quantity6Choice_ reqSettlementQuantity )
    {
