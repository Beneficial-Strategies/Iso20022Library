...
/// </summary>
[IsoId("_0jYTBAlIEeGATtfOBToyew_91884885")]
...
public partial record ConsentReason2
{
    ...
    #else
    /// <summary>
    /// Constructs a ConsentReason2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ConsentReason2( ConsentOrRejectionReason2Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
