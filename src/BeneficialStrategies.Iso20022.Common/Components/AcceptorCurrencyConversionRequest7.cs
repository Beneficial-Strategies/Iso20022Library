...
public partial record AcceptorCurrencyConversionRequest7
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionRequest7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionRequest7( CardPaymentEnvironment74 reqEnvironment,CardPaymentTransaction100 reqTransaction )
    {
    ...
    public required CardPaymentTransaction100 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransaction100 Transaction { get; init; } 
    #else
    public CardPaymentTransaction100 Transaction { get; set; } 
    #endif
