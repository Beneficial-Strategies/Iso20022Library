...
public partial record Transaction126
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction126 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction126( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails165? TransactionDetails { get; init; } 
    #else
    public TransactionDetails165? TransactionDetails { get; set; } 
    #endif
