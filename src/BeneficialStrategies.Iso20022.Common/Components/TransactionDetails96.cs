...
public partial record TransactionDetails96
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails96 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails96( TransactionActivity3Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SecurityIdentification19 reqFinancialInstrumentIdentification,Quantity6Choice_ reqPostingQuantity,SettlementDate10Choice_ reqSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent17Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent17Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    ...
    public SettlementDetails127? SettlementParameters { get; init; } 
    #else
    public SettlementDetails127? SettlementParameters { get; set; } 
    #endif
