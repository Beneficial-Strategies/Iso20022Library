...
public partial record SettlementDetails163
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails163 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails163( SecuritiesTransactionType46Choice_ reqSecuritiesTransactionType )
    {
