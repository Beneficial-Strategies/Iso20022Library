...
public partial record InvestmentAccountOwnershipInformation12
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccountOwnershipInformation12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccountOwnershipInformation12( Party31Choice_ reqParty )
    {
        Party = reqParty;
    }
    #endif
