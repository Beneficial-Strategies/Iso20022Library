...
public partial record ContentInformationType22
{
    ...
    #else
    /// <summary>
    /// Constructs a ContentInformationType22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ContentInformationType22( ContentType2Code reqContentType,EnvelopedData7 reqEnvelopedData )
    {
