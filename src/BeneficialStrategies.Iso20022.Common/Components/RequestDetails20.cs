...
public partial record RequestDetails20
{
    ...
    #else
    /// <summary>
    /// Constructs a RequestDetails20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RequestDetails20( References23 reqReference )
    {
    ...
    public Linkages53? Linkages { get; init; } 
    #else
    public Linkages53? Linkages { get; set; } 
    #endif
