...
public partial record SubAccountIdentification38
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification38( SecuritiesAccount14 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation26? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation26? BalanceForSubAccount { get; set; } 
    #endif
