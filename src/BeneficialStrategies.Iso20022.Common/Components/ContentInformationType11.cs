...
public partial record ContentInformationType11
{
    ...
    #else
    /// <summary>
    /// Constructs a ContentInformationType11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ContentInformationType11( ContentType2Code reqContentType )
    {
