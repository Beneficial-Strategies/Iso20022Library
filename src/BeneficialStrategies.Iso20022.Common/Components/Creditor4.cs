...
public partial record Creditor4
{
    ...
    #else
    /// <summary>
    /// Constructs a Creditor4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Creditor4( PartyIdentification178Choice_ reqCreditor )
    {
    ...
    public PartyIdentification178Choice_ Creditor { get; init; } 
    #else
    public PartyIdentification178Choice_ Creditor { get; set; } 
    #endif
