...
public partial record AccountReport30
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountReport30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountReport30( System.String reqIdentification,CashAccount41 reqAccount )
    {
