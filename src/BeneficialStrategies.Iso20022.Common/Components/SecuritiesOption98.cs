...
public partial record SecuritiesOption98
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption98 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption98( FinancialInstrumentAttributes115 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate24 reqDateDetails )
    {
    ...
    public required SecurityDate24 DateDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecurityDate24 DateDetails { get; init; } 
    #else
    public SecurityDate24 DateDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the rates related to securities movement.
    /// </summary>
    [IsoId("_YXgTl199Ee262vCSVgjImg")]
    ...
    public CorporateActionRate116? RateDetails { get; init; } 
    #else
    public CorporateActionRate116? RateDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the prices related to securities movement.
    /// </summary>
    [IsoId("_YXgTn199Ee262vCSVgjImg")]
