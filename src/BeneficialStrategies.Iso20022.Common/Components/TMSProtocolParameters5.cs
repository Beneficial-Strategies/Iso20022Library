...
public partial record TMSProtocolParameters5
{
    ...
    #else
    /// <summary>
    /// Constructs a TMSProtocolParameters5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TMSProtocolParameters5( TerminalManagementAction3Code reqActionType,GenericIdentification176 reqTerminalManagerIdentification,System.String reqVersion,System.String reqHostIdentification )
    {
