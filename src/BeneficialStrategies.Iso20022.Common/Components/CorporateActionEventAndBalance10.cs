...
public partial record CorporateActionEventAndBalance10
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventAndBalance10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventAndBalance10( EventInformation8 reqGeneralInformation,SecurityIdentification20 reqUnderlyingSecurity )
    {
    ...
    public EventInformation8 GeneralInformation { get; init; } 
    #else
    public EventInformation8 GeneralInformation { get; set; } 
    #endif
