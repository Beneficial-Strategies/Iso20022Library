...
public partial record Proxy8
{
    ...
    #else
    /// <summary>
    /// Constructs a Proxy8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Proxy8( ProxyType2Code reqProxyType )
    {
    ...
    public IndividualPerson40? PersonDetails { get; init; } 
    #else
    public IndividualPerson40? PersonDetails { get; set; } 
    #endif
