...
public partial record PendingStatusReason24
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason24( PendingReason62Choice_ reqReasonCode )
    {
