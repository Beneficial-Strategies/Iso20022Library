...
public partial record Linkages66
{
    ...
    #else
    /// <summary>
    /// Constructs a Linkages66 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Linkages66( References76Choice_ reqReference )
    {
    ...
    public required References76Choice_ Reference { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public References76Choice_ Reference { get; init; } 
    #else
    public References76Choice_ Reference { get; set; } 
    #endif
    
    /// <summary>
    /// Party that generates the reference.
    /// </summary>
    [IsoId("_diXSXzi8Eeydid5dcNPKvg")]
