...
public partial record RateTypeAndAmountAndStatus26
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus26( RateType36Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
    ...
    public RateType36Choice_ RateType { get; init; } 
    #else
    public RateType36Choice_ RateType { get; set; } 
    #endif
