...
public partial record SecuritiesTradeDetails17
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails17( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate1Choice_ reqSettlementDate,SecurityIdentification14 reqFinancialInstrumentIdentification,QuantityAndAccount14 reqQuantityAndAccountDetails,SettlementDetails25 reqSettlementParameters )
    {
    ...
    public required QuantityAndAccount14 QuantityAndAccountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public QuantityAndAccount14 QuantityAndAccountDetails { get; init; } 
    #else
    public QuantityAndAccount14 QuantityAndAccountDetails { get; set; } 
    #endif
