...
/// <summary>
/// Corporate Action Option232.
/// </summary>
[IsoId("_HZt3sYFmEe-L4fccMJVoAw")]
[DisplayName("Corporate Action Option232")]
public partial record CorporateActionOption232
{
    #nullable enable
    ...
    public ValueList<CashOption104> CashMovementDetails { get; init; } = [];
    ...
    public CorporateActionRate119? RateAndAmountDetails { get; init; } 
    ...
    public ValueList<SecuritiesOption110> SecuritiesMovementDetails { get; init; } = [];
