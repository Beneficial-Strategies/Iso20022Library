...
public partial record RateDetails7
{
    ...
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public System.Decimal? EarlySolicitationFeeRate { get; init; } 
    #else
    public System.Decimal? EarlySolicitationFeeRate { get; set; } 
    #endif
