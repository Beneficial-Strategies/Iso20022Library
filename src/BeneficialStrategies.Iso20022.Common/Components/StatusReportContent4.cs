...
public partial record StatusReportContent4
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReportContent4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReportContent4( System.DateTime reqPOIDateTime )
    {
    ...
    public PointOfInteractionCapabilities3? POICapabilities { get; init; } 
    #else
    public PointOfInteractionCapabilities3? POICapabilities { get; set; } 
    #endif
    ...
    public TerminalManagementDataSet12? DataSetRequired { get; init; } 
    #else
    public TerminalManagementDataSet12? DataSetRequired { get; set; } 
    #endif
    ...
    public TMSEvent3? Event { get; init; } 
    #else
    public TMSEvent3? Event { get; set; } 
    #endif
