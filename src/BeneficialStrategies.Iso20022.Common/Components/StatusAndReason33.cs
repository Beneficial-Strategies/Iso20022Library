...
public partial record StatusAndReason33
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason33( Status23Choice_ reqStatusAndReason )
    {
    ...
    public Transaction56? Transaction { get; init; } 
    #else
    public Transaction56? Transaction { get; set; } 
    #endif
