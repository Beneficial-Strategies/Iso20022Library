...
public record CurrentAndDefaultReservation3
{
    /// <summary>
    ...
    [IsoXmlTag("CurRsvatn")]
    public ValueList<ReservationReport5> CurrentReservation { get; init; } = [];
    ...
    public ValueList<ReservationReport5> DefaultReservation { get; init; } = [];
}
