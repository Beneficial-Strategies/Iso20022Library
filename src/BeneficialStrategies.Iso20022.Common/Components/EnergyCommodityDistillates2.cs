...
public partial record EnergyCommodityDistillates2
{
    ...
    #else
    /// <summary>
    /// Constructs a EnergyCommodityDistillates2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EnergyCommodityDistillates2( AssetClassProductType2Code reqBaseProduct )
    {
