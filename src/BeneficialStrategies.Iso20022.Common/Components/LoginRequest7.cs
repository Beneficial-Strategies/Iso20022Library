...
/// Login Request7.
/// </summary>
[IsoId("_ovFdsZ9yEe-nbM0aSPcoiQ")]
[DisplayName("Login Request7")]
public partial record LoginRequest7
{
    #nullable enable
    ...
    [IsoXmlTag("SaleSftwr")]
    public ValueList<PointOfInteractionComponent17> SaleSoftware { get; init; } = [];
