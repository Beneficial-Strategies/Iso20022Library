...
public partial record RejectionReason19
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason19( RejectionReason17Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public RejectionReason17Choice_ Code { get; init; } 
    #else
    public RejectionReason17Choice_ Code { get; set; } 
    #endif
