...
public partial record QuantityAndAccount46
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount46 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount46( Quantity10Choice_ reqSettledQuantity,SecuritiesAccount30 reqSafekeepingAccount )
    {
