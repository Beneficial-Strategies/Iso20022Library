...
public partial record PartyIdentificationAndAccount181
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount181 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount181( PartyIdentification137Choice_ reqIdentification )
    {
