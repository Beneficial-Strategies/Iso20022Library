...
public partial record PartyIdentification236
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification236 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification236( PartyIdentification229Choice_ reqOwnerIdentification,FinancialInstrumentQuantity1Choice_ reqOwnedSecuritiesQuantity )
    {
