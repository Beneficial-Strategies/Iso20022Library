...
public partial record SecuritiesOption64
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption64 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption64( FinancialInstrumentAttributes80 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate16 reqDateDetails )
    {
