...
public partial record Statement8
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement8( System.String reqReference,DatePeriodDetails reqStatementPeriod,StatementUpdateTypeCode reqUpdateType,System.String reqActivityIndicator )
    {
