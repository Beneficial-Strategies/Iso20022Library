...
public partial record SettlementTypeAndIdentification27
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementTypeAndIdentification27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementTypeAndIdentification27( System.String reqAccountOwnerTransactionIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
