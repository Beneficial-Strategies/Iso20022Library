...
public partial record CorporateActionGeneralInformation110
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation110 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation110( System.String reqCorporateActionEventIdentification,CorporateActionEventType52Choice_ reqEventType )
    {
