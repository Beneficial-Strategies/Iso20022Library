...
public partial record CardPaymentTransaction90
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction90 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction90( TransactionIdentifier1 reqTransactionIdentification,CardPaymentTransactionDetails47 reqTransactionDetails )
    {
