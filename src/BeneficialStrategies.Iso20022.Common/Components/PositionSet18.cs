...
public partial record PositionSet18
{
    ...
    #else
    /// <summary>
    /// Constructs a PositionSet18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PositionSet18( PositionSetDimensions14 reqDimensions,PositionSetMetrics12 reqMetrics )
    {
    ...
    #else
    public PositionSetMetrics12 Metrics { get; set; } 
    #endif
