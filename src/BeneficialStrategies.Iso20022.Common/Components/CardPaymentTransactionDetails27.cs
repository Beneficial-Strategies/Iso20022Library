...
public partial record CardPaymentTransactionDetails27
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransactionDetails27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransactionDetails27( string reqCurrency,ImpliedCurrencyAndAmount reqTotalAmount )
    {
