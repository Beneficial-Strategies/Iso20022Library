...
/// </summary>
[IsoId("_caaLszi8Eeydid5dcNPKvg")]
[DisplayName("Financial Instrument Attributes")]
public record FinancialInstrumentAttributes119
{
    /// <summary>
    /// Market(s) on which the security is listed.
    /// </summary>
    [IsoId("_caaLuzi8Eeydid5dcNPKvg")]
    ...
    /// </summary>
    [IsoId("_caaMlTi8Eeydid5dcNPKvg")]
    [DisplayName("Quantity Breakdown")]
    [IsoXmlTag("QtyBrkdwn")]
    public ValueList<QuantityBreakdown64> QuantityBreakdown { get; init; } = [];

    /// <summary>
    /// Indicates whether the interest rate of an interest bearing instrument is reset periodically.
    /// </summary>
    [IsoId("_caaMlzi8Eeydid5dcNPKvg")]
