...
public partial record CorporateActionGeneralInformation142
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation142 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation142( System.String reqCorporateActionEventIdentification,CorporateActionEventType87Choice_ reqEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
