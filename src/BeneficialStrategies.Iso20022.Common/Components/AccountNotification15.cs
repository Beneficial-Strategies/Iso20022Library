...
public partial record AccountNotification15
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountNotification15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountNotification15( System.String reqIdentification,CashAccount36 reqAccount )
    {
