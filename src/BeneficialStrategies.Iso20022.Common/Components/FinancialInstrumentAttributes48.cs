...
public partial record FinancialInstrumentAttributes48
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentAttributes48 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentAttributes48( SecurityIdentification14 reqFinancialInstrumentIdentification )
    {
