...
public partial record CorporateActionGeneralInformation163
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation163 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation163( System.String reqCorporateActionEventIdentification,CorporateActionEventType86Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes108 reqUnderlyingSecurity )
    {
