...
public partial record QuantityAndAccount69
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount69 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount69( Quantity10Choice_ reqSettlementQuantity,SecuritiesAccount30 reqSafekeepingAccount )
    {
