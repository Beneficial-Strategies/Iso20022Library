...
public partial record StatusAndReason25
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason25( Status15Choice_ reqStatusAndReason )
    {
    ...
    public Transaction40? Transaction { get; init; } 
    #else
    public Transaction40? Transaction { get; set; } 
    #endif
