...
[DataContract]
#endif
public partial record TMSAction11
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a TMSAction11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TMSAction11( TerminalManagementAction5Code reqType,TerminalManagementActionTrigger1Code reqTrigger )
    {
        Type = reqType;
        Trigger = reqTrigger;
    }
    ...
    public DataSetCategory18Code? ComponentType { get; init; } 
    #else
    public DataSetCategory18Code? ComponentType { get; set; } 
    #endif
