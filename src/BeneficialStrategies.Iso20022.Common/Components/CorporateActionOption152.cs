...
public partial record CorporateActionOption152
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption152 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption152( System.String reqOptionNumber,CorporateActionOption18Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public CashOption65? CashMovementDetails { get; init; } 
    #else
    public CashOption65? CashMovementDetails { get; set; } 
    #endif
