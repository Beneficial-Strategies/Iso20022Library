...
public partial record TransactionDetails142
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails142 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails142( SecuritiesAccount30 reqSafekeepingAccount,SecurityIdentification20 reqFinancialInstrumentIdentification,Quantity10Choice_ reqSettlementQuantity,SettlementDate32Choice_ reqSettlementDate,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDetails196 reqSettlementParameters )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required SettlementDetails196 SettlementParameters { get; init; } 
    #elif NET7_0_OR_GREATER // C# 11 Records, required members
    public required SettlementDetails196 SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails196 SettlementParameters { get; init; } 
    #else
    public SettlementDetails196 SettlementParameters { get; set; } 
    #endif
    
    /// <summary>
    /// Identifies the chain of receiving settlement parties.
    /// </summary>
    [IsoId("_qTHfcSAdEeuyDZ-ukt4YRg")]
