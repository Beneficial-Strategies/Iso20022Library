...
public partial record Statement21
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement21( DateAndDateTimeChoice_ reqStatementDateTime,Frequency4Choice_ reqFrequency,UpdateType2Choice_ reqUpdateType,StatementBasis3Choice_ reqStatementBasis,System.String reqActivityIndicator,System.String reqSubAccountIndicator )
    {
