...
public partial record CorporateActionOption146
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption146 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption146( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption29Choice_ reqOptionType,SecuritiesQuantityOrAmount1Choice_ reqSecuritiesQuantityOrInstructedAmount )
    {
