...
public partial record AmountPrice3
{
    ...
    #else
    /// <summary>
    /// Constructs a AmountPrice3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AmountPrice3( AmountPriceType1Code reqAmountPriceType,ActiveCurrencyAnd13DecimalAmount reqPriceValue )
    {
