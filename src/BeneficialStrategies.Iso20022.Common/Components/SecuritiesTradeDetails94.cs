...
public partial record SecuritiesTradeDetails94
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails94 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails94( SettlementDate17Choice_ reqSettlementDate )
    {
