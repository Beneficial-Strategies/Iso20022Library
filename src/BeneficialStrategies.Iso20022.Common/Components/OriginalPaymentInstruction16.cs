...
public partial record OriginalPaymentInstruction16
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction16( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction64? TransactionInformation { get; init; } 
    #else
    public PaymentTransaction64? TransactionInformation { get; set; } 
    #endif
