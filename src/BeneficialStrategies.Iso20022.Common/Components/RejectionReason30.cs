...
public partial record RejectionReason30
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason30( RejectionReason27Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public RejectionReason27Choice_ Code { get; init; } 
    #else
    public RejectionReason27Choice_ Code { get; set; } 
    #endif
