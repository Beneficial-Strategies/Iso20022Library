...
public partial record InstructedBalance17
{
    ...
    #else
    /// <summary>
    /// Constructs a InstructedBalance17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InstructedBalance17( BalanceFormat14Choice_ reqTotalInstructedBalance )
    {
    ...
    public BalanceFormat14Choice_ TotalInstructedBalance { get; init; } 
    #else
    public BalanceFormat14Choice_ TotalInstructedBalance { get; set; } 
    #endif
    ...
    public SignedQuantityFormat13? TotalAcceptedInstructionBalance { get; init; } 
    #else
    public SignedQuantityFormat13? TotalAcceptedInstructionBalance { get; set; } 
    #endif
    ...
    public SignedQuantityFormat13? TotalCancelledInstructionBalance { get; init; } 
    #else
    public SignedQuantityFormat13? TotalCancelledInstructionBalance { get; set; } 
    #endif
    ...
    public SignedQuantityFormat13? TotalPendingInstructionBalance { get; init; } 
    #else
    public SignedQuantityFormat13? TotalPendingInstructionBalance { get; set; } 
    #endif
    ...
    public SignedQuantityFormat13? TotalRejectedInstructionBalance { get; init; } 
    #else
    public SignedQuantityFormat13? TotalRejectedInstructionBalance { get; set; } 
    #endif
    ...
    public SignedQuantityFormat13? TotalProtectInstructionBalance { get; init; } 
    #else
    public SignedQuantityFormat13? TotalProtectInstructionBalance { get; set; } 
    #endif
    ...
    public InstructedCorporateActionOption18? OptionDetails { get; init; } 
    #else
    public InstructedCorporateActionOption18? OptionDetails { get; set; } 
    #endif
