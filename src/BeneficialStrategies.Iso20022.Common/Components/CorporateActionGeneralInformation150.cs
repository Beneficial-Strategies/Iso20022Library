...
public partial record CorporateActionGeneralInformation150
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation150 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation150( System.String reqCorporateActionEventIdentification,CorporateActionEventType97Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
