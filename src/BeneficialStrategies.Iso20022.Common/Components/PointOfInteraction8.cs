...
public partial record PointOfInteraction8
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteraction8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteraction8( GenericIdentification53 reqIdentification )
    {
    ...
    public PointOfInteractionCapabilities6? Capabilities { get; init; } 
    #else
    public PointOfInteractionCapabilities6? Capabilities { get; set; } 
    #endif
    ...
    [IsoXmlTag("Cmpnt")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PointOfInteractionComponent8? Component { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PointOfInteractionComponent8? Component { get; init; } 
    #else
    public PointOfInteractionComponent8? Component { get; set; } 
    #endif
