...
public partial record IntraPositionMovementDetails9
{
    ...
    #else
    /// <summary>
    /// Constructs a IntraPositionMovementDetails9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IntraPositionMovementDetails9( FinancialInstrumentQuantity1Choice_ reqSettledQuantity,SecuritiesBalanceType3Choice_ reqBalanceTo,DateAndDateTimeChoice_ reqSettlementDate )
    {
