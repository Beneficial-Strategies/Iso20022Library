...
public partial record PendingCancellationStatusReason7
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingCancellationStatusReason7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingCancellationStatusReason7( PendingCancellationReason5Choice_ reqReasonCode )
    {
    ...
    public PendingCancellationReason5Choice_ ReasonCode { get; init; } 
    #else
    public PendingCancellationReason5Choice_ ReasonCode { get; set; } 
    #endif
