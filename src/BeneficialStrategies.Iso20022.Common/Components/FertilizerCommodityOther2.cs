...
public partial record FertilizerCommodityOther2
{
    ...
    #else
    /// <summary>
    /// Constructs a FertilizerCommodityOther2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FertilizerCommodityOther2( AssetClassProductType5Code reqBaseProduct )
    {
