...
public partial record TerminalManagementDataSet30
{
    ...
    #else
    /// <summary>
    /// Constructs a TerminalManagementDataSet30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TerminalManagementDataSet30( DataSetIdentification8 reqIdentification )
    {
    ...
    public ManagementPlanContent9? Content { get; init; } 
    #else
    public ManagementPlanContent9? Content { get; set; } 
    #endif
