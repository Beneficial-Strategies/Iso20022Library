...
public partial record SecurityDate14
{
    ...
    #else
    /// <summary>
    /// Constructs a SecurityDate14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecurityDate14( DateFormat34Choice_ reqPaymentDate )
    {
    ...
    public DateFormat34Choice_? AvailableDate { get; init; } 
    #else
    public DateFormat34Choice_? AvailableDate { get; set; } 
    #endif
    ...
    public DateFormat34Choice_? DividendRankingDate { get; init; } 
    #else
    public DateFormat34Choice_? DividendRankingDate { get; set; } 
    #endif
    ...
    public DateFormat34Choice_? PariPassuDate { get; init; } 
    #else
    public DateFormat34Choice_? PariPassuDate { get; set; } 
    #endif
    ...
    public DateFormat34Choice_? LastTradingDate { get; init; } 
    #else
    public DateFormat34Choice_? LastTradingDate { get; set; } 
    #endif
