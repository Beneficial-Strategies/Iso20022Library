...
public partial record CorporateActionGeneralInformationSD17
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD17( System.String reqPlaceAndName,SecurityIdentification15 reqSecurityIdentification,System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionUnallocatedDetailsSD3? UnallocatedDetails { get; init; } 
    #else
    public CorporateActionUnallocatedDetailsSD3? UnallocatedDetails { get; set; } 
    #endif
