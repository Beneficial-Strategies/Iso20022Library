...
public partial record Transaction122
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction122 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction122( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails147? TransactionDetails { get; init; } 
    #else
    public TransactionDetails147? TransactionDetails { get; set; } 
    #endif
