...
public partial record CardPaymentContext5
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentContext5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentContext5( PaymentContext5 reqPaymentContext )
    {
    ...
    public PaymentContext5 PaymentContext { get; init; } 
    #else
    public PaymentContext5 PaymentContext { get; set; } 
    #endif
