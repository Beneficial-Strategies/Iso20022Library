...
public partial record ForeignExchangeTerms13
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTerms13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTerms13( string reqUnitCurrency,string reqQuotedCurrency,System.Decimal reqExchangeRate )
    {
