...
public partial record InvestmentAccount68
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccount68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccount68( System.String reqAccountIdentification )
    {
    ...
    public Intermediary42? IntermediaryInformation { get; init; } 
    #else
    public Intermediary42? IntermediaryInformation { get; set; } 
    #endif
    
    /// <summary>
    /// Form, that is, ownership, of the security, that is, registered or bearer.
    /// </summary>
    [IsoId("_G4TlgYfuEeevKP8c-ilVhA")]
