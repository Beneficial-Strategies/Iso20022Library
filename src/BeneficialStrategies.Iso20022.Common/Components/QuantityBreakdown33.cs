...
public partial record QuantityBreakdown33
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityBreakdown33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityBreakdown33( GenericIdentification39 reqLotNumber )
    {
