...
public record CorporateActionNarrative14
{
    ...
    public SimpleValueList<IsoRestrictedFINXMax350Text> DeclarationDetails { get; init; } = [];
    ...
    [IsoXmlTag("InfConds")]
    public SimpleValueList<IsoRestrictedFINXMax350Text> InformationConditions { get; init; } = [];
