...
public partial record SecuritiesTradeDetails131
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails131 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails131( SettlementDate20Choice_ reqSettlementDate )
    {
