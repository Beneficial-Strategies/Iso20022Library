...
public partial record PointOfInteraction5
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteraction5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteraction5( GenericIdentification32 reqIdentification )
    {
    ...
    [IsoXmlTag("Cmpnt")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PointOfInteractionComponent6? Component { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PointOfInteractionComponent6? Component { get; init; } 
    #else
    public PointOfInteractionComponent6? Component { get; set; } 
    #endif
