...
public partial record CashOptionSD7
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOptionSD7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOptionSD7( System.String reqPlaceAndName )
    {
