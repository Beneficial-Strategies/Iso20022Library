...
public partial record AcceptorReconciliationRequest9
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequest9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequest9( CardPaymentEnvironment77 reqEnvironment,TransactionReconciliation5 reqTransaction )
    {
