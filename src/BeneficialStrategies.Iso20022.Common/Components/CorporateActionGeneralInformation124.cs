...
public partial record CorporateActionGeneralInformation124
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation124 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation124( System.String reqCorporateActionEventIdentification,CorporateActionEventType76Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public required CorporateActionEventType76Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType76Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType76Choice_ EventType { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies whether the event is mandatory, mandatory with options or voluntary.
    /// </summary>
    [IsoId("_b3VHVZSeEeeh5JjedkaA_g")]
