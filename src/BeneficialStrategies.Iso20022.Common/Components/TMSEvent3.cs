...
public partial record TMSEvent3
{
    ...
    #else
    /// <summary>
    /// Constructs a TMSEvent3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TMSEvent3( System.DateTime reqTimeStamp,TerminalManagementActionResult1Code reqResult,TMSActionIdentification3 reqActionIdentification )
    {
    ...
    #else
    public TMSActionIdentification3 ActionIdentification { get; set; } 
    #endif
