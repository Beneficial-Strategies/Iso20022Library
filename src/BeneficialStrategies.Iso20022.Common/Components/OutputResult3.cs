...
/// </summary>
[IsoId("_EnZNwc-iEfCjWv7IQMnzMg")]
[DisplayName("Output Result3")]
public record OutputResult3
{
    /// <summary>
    /// Logical device located on a Sale Terminal or a POI Terminal, in term of class of information to output.
    /// </summary>
    [IsoId("_EoO7Rc-iEfCjWv7IQMnzMg")]
    [DisplayName("Device Type")]
    [IsoXmlTag("DvcTp")]
    public required UserInterface9Code DeviceType { get; init; }

    /// <summary>
    /// Qualification of the information to sent to an output logical device.
    /// </summary>
    [IsoId("_EoO7S8-iEfCjWv7IQMnzMg")]
