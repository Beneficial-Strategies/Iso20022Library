...
public partial record CorporateActionOption125
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption125 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption125( System.String reqOptionNumber,CorporateActionOption23Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public OptionFeaturesFormat20Choice_? OptionFeatures { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OptionFeaturesFormat20Choice_? OptionFeatures { get; init; } 
    #else
    public OptionFeaturesFormat20Choice_? OptionFeatures { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies the type of intermediates securities distribution.
    /// </summary>
    [IsoId("_ctaXP5KQEeWHWpTQn1FFVg")]
    ...
    public CorporateActionRate76? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate76? RateAndAmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the prices related to a corporate action option.
    /// </summary>
    [IsoId("_ctaXuZKQEeWHWpTQn1FFVg")]
    ...
    public SecuritiesOption57? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOption57? SecuritiesMovementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [IsoId("_ctaX0ZKQEeWHWpTQn1FFVg")]
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CashOption47? CashMovementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CashOption47? CashMovementDetails { get; init; } 
    #else
    public CashOption47? CashMovementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information about the corporate action movement.
    /// </summary>
    [IsoId("_ctaX2ZKQEeWHWpTQn1FFVg")]
