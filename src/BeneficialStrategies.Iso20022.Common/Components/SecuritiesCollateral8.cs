...
public partial record SecuritiesCollateral8
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesCollateral8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesCollateral8( SecurityIdentification19 reqSecurityIdentification,FinancialInstrumentQuantity1Choice_ reqQuantity,SafekeepingPlaceFormat10Choice_ reqSafekeepingPlace )
    {
    ...
    public SettlementDetails118? SettlementParameters { get; init; } 
    #else
    public SettlementDetails118? SettlementParameters { get; set; } 
    #endif
