...
public partial record CorporateActionOption213
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption213 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption213( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption39Choice_ reqOptionType )
    {
    ...
    public CorporateActionDate91? DateDetails { get; init; } 
    #else
    public CorporateActionDate91? DateDetails { get; set; } 
    #endif
    ...
    public SecuritiesOption95? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOption95? SecuritiesMovementDetails { get; set; } 
    #endif
    ...
    public CashOption87? CashMovementDetails { get; init; } 
    #else
    public CashOption87? CashMovementDetails { get; set; } 
    #endif
