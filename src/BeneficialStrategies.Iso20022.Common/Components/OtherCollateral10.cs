...
public partial record OtherCollateral10
{
    ...
    #else
    /// <summary>
    /// Constructs a OtherCollateral10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OtherCollateral10( ActiveCurrencyAndAmount reqCollateralValue )
    {
