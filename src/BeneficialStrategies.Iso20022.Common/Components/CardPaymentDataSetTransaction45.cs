...
public partial record CardPaymentDataSetTransaction45
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction45 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction45( System.String reqTransactionSequenceCounter,CardPaymentEnvironment79 reqEnvironment,CardPaymentTransaction129 reqTransaction,CardPaymentTransaction128 reqTransactionResponse )
    {
