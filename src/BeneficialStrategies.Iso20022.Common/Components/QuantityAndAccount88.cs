...
public partial record QuantityAndAccount88
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount88 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount88( FinancialInstrumentQuantity15Choice_ reqSettlementQuantity,SecuritiesAccount30 reqSafekeepingAccount )
    {
