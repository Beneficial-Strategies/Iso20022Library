...
public partial record TransactionDetails24
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails24 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails24( TransactionActivity1Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity6Choice_ reqPostingQuantity,DateAndDateTimeChoice_ reqEffectiveSettlementDate )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public SettlementDetails27? SettlementParameters { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementDetails27? SettlementParameters { get; init; } 
    #else
    public SettlementDetails27? SettlementParameters { get; set; } 
    #endif
