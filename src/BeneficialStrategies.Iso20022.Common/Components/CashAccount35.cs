...
/// </summary>
[IsoId("_fowVdZ-WEee28J7y9KlTWg")]
[DisplayName("Cash Account")]
public record CashAccount35
{
    /// <summary>
    ...
    [IsoXmlTag("MulBal")]
    public ValueList<CashBalance10> MultilateralBalance { get; init; } = [];
    ...
    [IsoXmlTag("CurBilLmt")]
    public ValueList<BilateralLimit2> CurrentBilateralLimit { get; init; } = [];
    ...
    [IsoXmlTag("StgOrdr")]
    public ValueList<StandingOrder2> StandingOrder { get; init; } = [];
}
