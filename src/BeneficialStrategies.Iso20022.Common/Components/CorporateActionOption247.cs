...
/// <summary>
/// Corporate Action Option247.
/// </summary>
[IsoId("_nLhsA5t3Ee-wQIOX0djF2w")]
[DisplayName("Corporate Action Option247")]
public partial record CorporateActionOption247
{
    #nullable enable
    ...
    [IsoXmlTag("AddtlInf")]
    public CorporateActionNarrative64? AdditionalInformation { get; init; } 
    ...
    [IsoXmlTag("BidRgTp")]
    public BidRangeType2Choice_? BidRangeType { get; init; } 
    ...
    public ValueList<CashOption113> CashMovementDetails { get; init; } = [];
    ...
    public ValueList<BeneficiaryCertificationType15Choice_> CertificationBreakdownType { get; init; } = [];
    ...
    [IsoXmlTag("DtDtls")]
    public CorporateActionDate108? DateDetails { get; init; } 
    ...
    public ValueList<OptionFeaturesFormat31Choice_> OptionFeatures { get; init; } = [];
    ...
    [IsoXmlTag("PricDtls")]
    public CorporateActionPrice97? PriceDetails { get; init; } 
    ...
    public ProrationBelowMinimumQuantity1Choice_? ProrationBelowMinimumQuantity { get; init; } 
    ...
    public CorporateActionRate136? RateAndAmountDetails { get; init; } 
    ...
    public ValueList<SecuritiesOption117> SecuritiesMovementDetails { get; init; } = [];
