...
public partial record SettlementDetails108
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails108 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails108( SecuritiesTransactionType22Choice_ reqSecuritiesTransactionType )
    {
    ...
    public required SecuritiesTransactionType22Choice_ SecuritiesTransactionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTransactionType22Choice_ SecuritiesTransactionType { get; init; } 
    #else
    public SecuritiesTransactionType22Choice_ SecuritiesTransactionType { get; set; } 
    #endif
