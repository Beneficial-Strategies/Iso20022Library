...
public partial record CardPaymentTransaction59
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction59 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction59( System.String reqMerchantCategoryCode,TransactionIdentifier1 reqTransactionIdentification,System.String reqTransactionSuccess,CardPaymentTransactionDetails34 reqTransactionDetails )
    {
