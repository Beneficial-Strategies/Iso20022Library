...
public partial record AccountIdentification33
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification33 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification33( System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionEventAndBalance9? CorporateActionEventAndBalance { get; init; } 
    #else
    public CorporateActionEventAndBalance9? CorporateActionEventAndBalance { get; set; } 
    #endif
