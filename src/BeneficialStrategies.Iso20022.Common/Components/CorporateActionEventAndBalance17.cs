...
public partial record CorporateActionEventAndBalance17
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventAndBalance17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventAndBalance17( EventInformation13 reqGeneralInformation,SecurityIdentification19 reqUnderlyingSecurity )
    {
    ...
    public EventInformation13 GeneralInformation { get; init; } 
    #else
    public EventInformation13 GeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionBalance41? Balance { get; init; } 
    #else
    public CorporateActionBalance41? Balance { get; set; } 
    #endif
