...
public partial record References25
{
    ...
    #else
    /// <summary>
    /// Constructs a References25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public References25( System.String reqAccountServicerTransactionIdentification )
    {
