...
public partial record AwaitingCancellationReason2
{
    ...
    #else
    /// <summary>
    /// Constructs a AwaitingCancellationReason2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AwaitingCancellationReason2( AwaitingCancellationReason2Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
