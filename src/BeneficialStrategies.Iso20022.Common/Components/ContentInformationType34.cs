...
public partial record ContentInformationType34
{
    ...
    #else
    /// <summary>
    /// Constructs a ContentInformationType34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ContentInformationType34( ContentType2Code reqContentType )
    {
