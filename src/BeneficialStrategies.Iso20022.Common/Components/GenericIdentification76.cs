...
public partial record GenericIdentification76
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification76 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification76( System.String reqIdentification,PartyType3Code reqType )
    {
