...
public partial record CardPaymentDataSet17
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSet17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSet17( System.String reqTransactionSequenceCounter,ResponseType1 reqTransactionResponse,CardPaymentEnvironment65 reqEnvironment,CardPaymentTransactionAdviceResponse5 reqTransaction )
    {
