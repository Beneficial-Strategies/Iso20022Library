...
public partial record PriceDetails24
{
    ...
    public PriceFormat56Choice_? GenericCashPriceReceivedPerProduct { get; init; } 
    #else
    public PriceFormat56Choice_? GenericCashPriceReceivedPerProduct { get; set; } 
    #endif
