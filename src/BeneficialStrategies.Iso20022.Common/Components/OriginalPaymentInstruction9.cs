...
public partial record OriginalPaymentInstruction9
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction9( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PaymentTransaction49? TransactionInformationAndStatus { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PaymentTransaction49? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction49? TransactionInformationAndStatus { get; set; } 
    #endif
