...
public record CorporateActionOption194
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption77> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption78> CashMovementDetails { get; init; } = [];
