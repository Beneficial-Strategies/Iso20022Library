...
public partial record AccountIdentificationAndName7
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentificationAndName7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentificationAndName7( CashAccountIdentification8Choice_ reqIdentification )
    {
    ...
    public CashAccountIdentification8Choice_ Identification { get; init; } 
    #else
    public CashAccountIdentification8Choice_ Identification { get; set; } 
    #endif
