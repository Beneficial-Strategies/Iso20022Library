...
public partial record MandateCancellationReason1
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateCancellationReason1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateCancellationReason1( MandateReason1Choice_ reqReason )
    {
        Reason = reqReason;
    }
    #endif
