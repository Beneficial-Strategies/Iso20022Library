...
public partial record CorporateActionGeneralInformation138
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation138 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation138( System.String reqCorporateActionEventIdentification,CorporateActionEventType85Choice_ reqEventType )
    {
    ...
    public FinancialInstrumentAttributes81? UnderlyingSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes81? UnderlyingSecurity { get; set; } 
    #endif
