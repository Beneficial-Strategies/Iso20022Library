...
public partial record PointOfInteractionComponent11
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteractionComponent11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteractionComponent11( POIComponentType6Code reqType,PointOfInteractionComponentIdentification2 reqIdentification )
    {
        Type = reqType;
    ...
    [IsoXmlTag("Chrtcs")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PointOfInteractionComponentCharacteristics7? Characteristics { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PointOfInteractionComponentCharacteristics7? Characteristics { get; init; } 
    #else
    public PointOfInteractionComponentCharacteristics7? Characteristics { get; set; } 
    #endif
    
    /// <summary>
    /// Assessments for the component of the point of interaction.
    /// </summary>
    [IsoId("_2_1EXS8REeu125Ip9zFcsQ")]
    ...
    [IsoXmlTag("Packg")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public PackageType2? Package { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PackageType2? Package { get; init; } 
    #else
    public PackageType2? Package { get; set; } 
    #endif
