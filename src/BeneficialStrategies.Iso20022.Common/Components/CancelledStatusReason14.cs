...
public partial record CancelledStatusReason14
{
    ...
    #else
    /// <summary>
    /// Constructs a CancelledStatusReason14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CancelledStatusReason14( CancelledReason11Choice_ reqReasonCode )
    {
    ...
    public CancelledReason11Choice_ ReasonCode { get; init; } 
    #else
    public CancelledReason11Choice_ ReasonCode { get; set; } 
    #endif
