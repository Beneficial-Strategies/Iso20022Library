...
public partial record ErrorAction5
{
    ...
    #else
    /// <summary>
    /// Constructs a ErrorAction5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ErrorAction5( TerminalManagementErrorAction2Code reqActionToProcess )
    {
    ...
    #endif
    [IsoXmlTag("ActnRslt")]
    public SimpleValueList<TerminalManagementActionResult5Code> ActionResult { get; init; } = new SimpleValueList<TerminalManagementActionResult5Code>(){}; // Warning: Don't know multiplicity.
