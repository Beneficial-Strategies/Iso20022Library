...
public partial record CashOption10
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption10( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate17 reqDateDetails )
    {
    ...
    public CorporateActionAmounts10? AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts10? AmountDetails { get; set; } 
    #endif
