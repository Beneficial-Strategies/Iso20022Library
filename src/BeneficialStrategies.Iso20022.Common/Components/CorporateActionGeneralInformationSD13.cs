...
public partial record CorporateActionGeneralInformationSD13
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD13( System.String reqPlaceAndName )
    {
