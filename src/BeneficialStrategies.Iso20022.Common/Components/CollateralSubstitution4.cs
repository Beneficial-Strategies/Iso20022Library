...
public partial record CollateralSubstitution4
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralSubstitution4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralSubstitution4( CollateralSubstitutionSequence1Code reqCollateralSubstitutionSequence,ActiveCurrencyAndAmount reqSubstitutionRequirement,CollateralSubstitutionType1Code reqCollateralSubstitutionType )
    {
