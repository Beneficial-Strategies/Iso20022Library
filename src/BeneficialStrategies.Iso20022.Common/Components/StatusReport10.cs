...
public partial record StatusReport10
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReport10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReport10( GenericIdentification176 reqPOIIdentification,GenericIdentification176 reqTerminalManagerIdentification,StatusReportDataSetRequest2 reqDataSet )
    {
    ...
    public required StatusReportDataSetRequest2 DataSet { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusReportDataSetRequest2 DataSet { get; init; } 
    #else
    public StatusReportDataSetRequest2 DataSet { get; set; } 
    #endif
