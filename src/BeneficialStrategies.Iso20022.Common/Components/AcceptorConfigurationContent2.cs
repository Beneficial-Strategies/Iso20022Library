...
public record AcceptorConfigurationContent2
{
    ...
    public ValueList<AcquirerProtocolParameters3> AcquirerProtocolParameters { get; init; } = [];
    ...
    public SimpleValueList<IsoMax10000Binary> TerminalParameters { get; init; } = [];
    ...
    public ValueList<ApplicationParameters2> ApplicationParameters { get; init; } = [];
    ...
    public ValueList<SecurityParameters1> SecurityParameters { get; init; } = [];
}
