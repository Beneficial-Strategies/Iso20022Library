...
public partial record AccountSubLevel17
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountSubLevel17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountSubLevel17( SecuritiesAccount19 reqAccountIdentification,PartyIdentification100 reqAccountOwner,PartyIdentification100 reqAccountServicer )
    {
    ...
    public AccountSubLevel18? AccountSubLevel8 { get; init; } 
    #else
    public AccountSubLevel18? AccountSubLevel8 { get; set; } 
    #endif
    ...
    #if DECLARE_DATACONTRACT
    [DataMember(Name="AcctSubLvl8Diff")]
    #endif
