...
public record AccountSubLevel17
{
    /// <summary>
    ...
    public ValueList<AccountSubLevel18> AccountSubLevel8 { get; init; } = [];
    ...
    public ValueList<AggregateHoldingBalance2> AccountSubLevel8Difference { get; init; } = [];
