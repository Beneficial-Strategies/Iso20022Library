...
public partial record TerminalManagementDataSet5
{
    ...
    #else
    /// <summary>
    /// Constructs a TerminalManagementDataSet5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TerminalManagementDataSet5( DataSetIdentification3 reqIdentification )
    {
    ...
    public ManagementPlanContent2? Content { get; init; } 
    #else
    public ManagementPlanContent2? Content { get; set; } 
    #endif
