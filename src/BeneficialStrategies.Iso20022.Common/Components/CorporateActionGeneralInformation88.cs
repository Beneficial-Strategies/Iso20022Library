...
public partial record CorporateActionGeneralInformation88
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation88 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation88( System.String reqCorporateActionEventIdentification,CorporateActionEventType32Choice_ reqEventType )
    {
    ...
    public FinancialInstrumentAttributes65? UnderlyingSecurity { get; init; } 
    #else
    public FinancialInstrumentAttributes65? UnderlyingSecurity { get; set; } 
    #endif
