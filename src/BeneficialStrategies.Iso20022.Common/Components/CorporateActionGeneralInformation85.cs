...
public partial record CorporateActionGeneralInformation85
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation85 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation85( System.String reqCorporateActionEventIdentification,CorporateActionEventType33Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes66 reqUnderlyingSecurity )
    {
