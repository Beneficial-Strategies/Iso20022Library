...
public partial record DirectDebitMandate5
{
    ...
    #else
    /// <summary>
    /// Constructs a DirectDebitMandate5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DirectDebitMandate5( AccountIdentificationAndName5 reqDebtorAccount,FinancialInstitutionIdentification7Choice_ reqDebtorAgent )
    {
