...
public partial record CashOption81
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption81 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption81( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate72 reqDateDetails )
    {
    ...
    public CorporateActionAmounts58? AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts58? AmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the dates related to a cash movement.
    /// </summary>
    [IsoId("_ptOjQzi7Eeydid5dcNPKvg")]
