...
public partial record TransactionDetails8
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails8( TransactionActivity1Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SecurityIdentification11 reqFinancialInstrumentIdentification,Quantity6Choice_ reqPostingQuantity,AmountAndDirection8 reqPostingAmount,SettlementDate2Choice_ reqSettlementDate )
    {
