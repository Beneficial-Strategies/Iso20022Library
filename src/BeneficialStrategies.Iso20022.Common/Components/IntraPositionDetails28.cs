...
public partial record IntraPositionDetails28
{
    ...
    public ValueList<IntraPositionMovementDetails9> IntraPositionMovement { get; init; } = new ValueList<IntraPositionMovementDetails9>(){}; // Warning: Don't know multiplicity.
