...
public partial record AcceptorReconciliationRequest5
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequest5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequest5( CardPaymentEnvironment50 reqEnvironment,TransactionReconciliation4 reqTransaction )
    {
    ...
    public CardPaymentEnvironment50 Environment { get; init; } 
    #else
    public CardPaymentEnvironment50 Environment { get; set; } 
    #endif
