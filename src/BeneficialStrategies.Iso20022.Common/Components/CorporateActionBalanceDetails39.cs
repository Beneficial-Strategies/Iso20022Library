...
public partial record CorporateActionBalanceDetails39
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionBalanceDetails39 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionBalanceDetails39( Quantity17Choice_ reqTotalEligibleBalance,BalanceFormat5Choice_ reqUninstructedBalance,InstructedBalanceDetails9 reqTotalInstructedBalanceDetails )
    {
    ...
    public required InstructedBalanceDetails9 TotalInstructedBalanceDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InstructedBalanceDetails9 TotalInstructedBalanceDetails { get; init; } 
    #else
    public InstructedBalanceDetails9 TotalInstructedBalanceDetails { get; set; } 
    #endif
