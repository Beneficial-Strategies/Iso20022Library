...
public partial record OriginalPaymentInstruction23
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction23( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction82? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction82? TransactionInformationAndStatus { get; set; } 
    #endif
