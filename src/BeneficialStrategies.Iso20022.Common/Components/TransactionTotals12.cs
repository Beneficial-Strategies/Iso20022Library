...
public partial record TransactionTotals12
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionTotals12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionTotals12( TypeTransactionTotals2Code reqType,System.UInt64 reqTotalNumber,ImpliedCurrencyAndAmount reqCumulativeAmount )
    {
        Type = reqType;
