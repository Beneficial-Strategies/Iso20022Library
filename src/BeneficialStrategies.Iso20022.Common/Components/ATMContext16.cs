...
public partial record ATMContext16
{
    ...
    #else
    /// <summary>
    /// Constructs a ATMContext16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ATMContext16( ATMService20 reqService )
    {
        Service = reqService;
    }
    #endif
    ...
    public required ATMService20 Service { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ATMService20 Service { get; init; } 
    #else
    public ATMService20 Service { get; set; } 
    #endif
