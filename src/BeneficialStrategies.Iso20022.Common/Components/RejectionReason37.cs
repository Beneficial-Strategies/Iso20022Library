...
public partial record RejectionReason37
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason37 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason37( RejectionReason31Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
