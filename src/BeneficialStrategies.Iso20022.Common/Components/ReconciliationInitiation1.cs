...
public partial record ReconciliationInitiation1
{
    ...
    #else
    /// <summary>
    /// Constructs a ReconciliationInitiation1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReconciliationInitiation1( Environment3 reqEnvironment,Transaction94 reqTransaction )
    {
