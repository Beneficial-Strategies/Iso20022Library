...
public partial record Statement63
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement63 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement63( DateAndDateTime2Choice_ reqStatementDateTime,System.String reqActivityIndicator )
    {
