...
public partial record PartyAndSignature2
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyAndSignature2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyAndSignature2( PartyIdentification43 reqParty,ProprietaryData3 reqSignature )
    {
        Party = reqParty;
