...
public partial record SubAccountIdentification56
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification56 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification56( SecuritiesAccount25 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation37? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation37? BalanceForSubAccount { get; set; } 
    #endif
