...
public partial record AlgorithmIdentification27
{
    ...
    #else
    /// <summary>
    /// Constructs a AlgorithmIdentification27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AlgorithmIdentification27( Algorithm7Code reqAlgorithm )
    {
