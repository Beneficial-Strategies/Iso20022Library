...
public partial record CashOptionSD10
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOptionSD10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOptionSD10( System.String reqPlaceAndName,DTCCPayoutType5Code reqPayoutType )
    {
