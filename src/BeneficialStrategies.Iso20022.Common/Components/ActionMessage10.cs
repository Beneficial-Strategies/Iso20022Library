...
public partial record ActionMessage10
{
    ...
    #else
    /// <summary>
    /// Constructs a ActionMessage10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ActionMessage10( UserInterface4Code reqMessageDestination )
    {
    ...
    public ContentInformationType33? MessageContentSignature { get; init; } 
    #else
    public ContentInformationType33? MessageContentSignature { get; set; } 
    #endif
    ...
    public OutputBarcode2? OutputBarcode { get; init; } 
    #else
    public OutputBarcode2? OutputBarcode { get; set; } 
    #endif
