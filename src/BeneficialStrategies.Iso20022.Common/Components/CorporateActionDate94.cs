...
public partial record CorporateActionDate94
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionDate94 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionDate94( DateFormat41Choice_ reqPaymentDate )
    {
