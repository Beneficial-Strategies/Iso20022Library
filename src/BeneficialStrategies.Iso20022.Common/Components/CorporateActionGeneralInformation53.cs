...
public partial record CorporateActionGeneralInformation53
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation53 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation53( System.String reqCorporateActionEventIdentification,CorporateActionEventType14Choice_ reqEventType,CorporateActionMandatoryVoluntary1Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification14 reqFinancialInstrumentIdentification )
    {
