...
public partial record PaymentReceipt1
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentReceipt1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentReceipt1( DocumentType7Code reqDocumentQualifier,ActionMessage6 reqOutputContent )
    {
