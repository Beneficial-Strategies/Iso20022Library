...
public partial record TransactionDetails112
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails112 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails112( TransactionActivity4Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity10Choice_ reqPostingQuantity,DateAndDateTime2Choice_ reqEffectiveSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent25Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent25Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    ...
    public SettlementDetails162? SettlementParameters { get; init; } 
    #else
    public SettlementDetails162? SettlementParameters { get; set; } 
    #endif
