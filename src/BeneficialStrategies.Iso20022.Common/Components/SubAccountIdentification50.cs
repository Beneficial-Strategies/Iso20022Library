...
public partial record SubAccountIdentification50
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification50 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification50( SecuritiesAccount34 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
