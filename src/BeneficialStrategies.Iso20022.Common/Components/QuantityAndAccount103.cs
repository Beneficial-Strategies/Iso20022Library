...
public partial record QuantityAndAccount103
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount103 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount103( Quantity54Choice_ reqSettledQuantity )
    {
