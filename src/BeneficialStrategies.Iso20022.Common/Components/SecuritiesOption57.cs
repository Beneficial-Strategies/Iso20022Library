...
public partial record SecuritiesOption57
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption57 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption57( FinancialInstrumentAttributes71 reqSecurityDetails,CreditDebitCode reqCreditDebitIndicator,SecurityDate14 reqDateDetails )
    {
    ...
    public FinancialInstrumentAttributes71 SecurityDetails { get; init; } 
    #else
    public FinancialInstrumentAttributes71 SecurityDetails { get; set; } 
    #endif
