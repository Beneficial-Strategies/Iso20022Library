...
public partial record CreditTransferTransaction57
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransferTransaction57 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransferTransaction57( PaymentIdentification6 reqPaymentIdentification,AmountType4Choice_ reqAmount,ChargeBearerType1Code reqChargeBearer,BranchAndFinancialInstitutionIdentification6 reqCreditorAgent,PartyIdentification135 reqCreditor )
    {
    ...
    public Cheque16? ChequeInstruction { get; init; } 
    #else
    public Cheque16? ChequeInstruction { get; set; } 
    #endif
