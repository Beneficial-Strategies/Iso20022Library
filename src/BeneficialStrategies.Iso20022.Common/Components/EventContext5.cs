...
public partial record EventContext5
{
    ...
    #else
    /// <summary>
    /// Constructs a EventContext5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EventContext5( RetailerService1Code reqServiceType )
    {
    ...
    public PointOfInteractionComponent14? ComponentIdentification { get; init; } 
    #else
    public PointOfInteractionComponent14? ComponentIdentification { get; set; } 
    #endif
