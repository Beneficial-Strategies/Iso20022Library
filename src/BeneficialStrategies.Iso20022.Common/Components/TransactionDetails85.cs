...
public partial record TransactionDetails85
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails85 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails85( SettlementTypeAndIdentification22 reqAccountOwnerTransactionIdentification,SecuritiesAccount30 reqSafekeepingAccount )
    {
