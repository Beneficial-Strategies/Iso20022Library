...
public partial record TransactionTotals3
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionTotals3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionTotals3( TypeTransactionTotals2Code reqType,System.UInt64 reqTotalNumber,ImpliedCurrencyAndAmount reqCumulativeAmount )
    {
        Type = reqType;
