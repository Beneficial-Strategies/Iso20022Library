...
public partial record CardPaymentDataSet8
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSet8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSet8( System.String reqTransactionSequenceCounter,ResponseType1 reqTransactionResponse,CardPaymentEnvironment21 reqEnvironment,CardPaymentTransactionAdviceResponse5 reqTransaction )
    {
