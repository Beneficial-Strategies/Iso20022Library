...
public partial record PaymentTerminalParameters3
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentTerminalParameters3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentTerminalParameters3( TerminalManagementAction3Code reqActionType,System.String reqVersion )
    {
