...
public partial record AccountIdentification34
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification34( System.String reqSafekeepingAccount )
    {
