...
public partial record ProprietaryParty4
{
    ...
    #else
    /// <summary>
    /// Constructs a ProprietaryParty4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ProprietaryParty4( System.String reqType,Party35Choice_ reqParty )
    {
        Type = reqType;
        Party = reqParty;
    }
    ...
    public required Party35Choice_ Party { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Party35Choice_ Party { get; init; } 
    #else
    public Party35Choice_ Party { get; set; } 
    #endif
