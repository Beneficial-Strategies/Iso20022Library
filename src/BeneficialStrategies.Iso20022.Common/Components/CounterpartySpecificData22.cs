...
public partial record CounterpartySpecificData22
{
    ...
    #else
    /// <summary>
    /// Constructs a CounterpartySpecificData22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CounterpartySpecificData22( TradeCounterpartyReport9 reqCounterparty,System.DateTime reqReportingDateTime )
    {
