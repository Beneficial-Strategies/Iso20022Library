...
public partial record CorporateActionGeneralInformation37
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation37 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation37( System.String reqCorporateActionEventIdentification,CorporateActionEventType7Choice_ reqEventType,CorporateActionMandatoryVoluntary1Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes33 reqUnderlyingSecurity )
    {
