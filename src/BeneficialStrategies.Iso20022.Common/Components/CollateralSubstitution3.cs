...
public partial record CollateralSubstitution3
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralSubstitution3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralSubstitution3( CollateralSubstitutionSequence1Code reqCollateralSubstitutionSequence,ActiveCurrencyAndAmount reqSubstitutionRequirement,CollateralSubstitutionType1Code reqCollateralSubstitutionType )
    {
