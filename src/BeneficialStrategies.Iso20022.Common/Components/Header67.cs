...
public partial record Header67
{
    ...
    #else
    /// <summary>
    /// Constructs a Header67 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Header67( MessageFunction45Code reqMessageFunction,System.String reqProtocolVersion,System.DateTime reqCreationDateTime,GenericIdentification183 reqInitiatingParty )
    {
    ...
    public MessageFunction45Code MessageFunction { get; init; } 
    #else
    public MessageFunction45Code MessageFunction { get; set; } 
    #endif
