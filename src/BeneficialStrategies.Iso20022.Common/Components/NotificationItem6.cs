...
public partial record NotificationItem6
{
    ...
    #else
    /// <summary>
    /// Constructs a NotificationItem6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public NotificationItem6( System.String reqIdentification,ActiveOrHistoricCurrencyAndAmount reqAmount )
    {
