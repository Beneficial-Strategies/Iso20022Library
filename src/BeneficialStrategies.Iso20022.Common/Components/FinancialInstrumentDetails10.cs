...
public partial record FinancialInstrumentDetails10
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentDetails10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentDetails10( SecurityIdentification14 reqFinancialInstrumentIdentification )
    {
    ...
    #endif
    [IsoXmlTag("SubBal")]
    public ValueList<IntraPositionDetails20> SubBalance { get; init; } = new ValueList<IntraPositionDetails20>(){}; // Warning: Don't know multiplicity.
