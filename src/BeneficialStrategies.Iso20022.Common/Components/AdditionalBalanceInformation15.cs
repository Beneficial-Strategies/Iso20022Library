...
public partial record AdditionalBalanceInformation15
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalBalanceInformation15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalBalanceInformation15( SubBalanceType12Choice_ reqSubBalanceType,Balance9 reqQuantity )
    {
