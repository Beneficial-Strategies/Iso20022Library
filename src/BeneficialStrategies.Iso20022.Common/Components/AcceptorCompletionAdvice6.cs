...
public partial record AcceptorCompletionAdvice6
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCompletionAdvice6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCompletionAdvice6( CardPaymentEnvironment60 reqEnvironment,CardPaymentTransaction69 reqTransaction )
    {
    ...
    public CardPaymentEnvironment60 Environment { get; init; } 
    #else
    public CardPaymentEnvironment60 Environment { get; set; } 
    #endif
    ...
    public CardPaymentContext21? Context { get; init; } 
    #else
    public CardPaymentContext21? Context { get; set; } 
    #endif
    ...
    public required CardPaymentTransaction69 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransaction69 Transaction { get; init; } 
    #else
    public CardPaymentTransaction69 Transaction { get; set; } 
    #endif
