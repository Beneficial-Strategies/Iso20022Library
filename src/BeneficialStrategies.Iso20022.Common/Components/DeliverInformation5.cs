...
public partial record DeliverInformation5
{
    ...
    #else
    /// <summary>
    /// Constructs a DeliverInformation5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DeliverInformation5( DeliveringPartiesAndAccount8 reqSettlementPartiesDetails )
    {
