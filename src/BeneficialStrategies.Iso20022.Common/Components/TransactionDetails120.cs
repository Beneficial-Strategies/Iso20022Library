...
public partial record TransactionDetails120
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails120 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails120( SecurityIdentification20 reqFinancialInstrumentIdentification,SettlementDate20Choice_ reqSettlementDate,Quantity10Choice_ reqSettlementQuantity )
    {
