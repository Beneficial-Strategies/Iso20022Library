...
public partial record AdditionalBalanceInformation18
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalBalanceInformation18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalBalanceInformation18( SubBalanceType12Choice_ reqSubBalanceType,Balance9 reqQuantity )
    {
