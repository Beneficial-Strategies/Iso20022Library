...
public partial record SettlementDetails180
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails180 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails180( SecuritiesTransactionType55Choice_ reqSecuritiesTransactionType )
    {
    ...
    public required SecuritiesTransactionType55Choice_ SecuritiesTransactionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTransactionType55Choice_ SecuritiesTransactionType { get; init; } 
    #else
    public SecuritiesTransactionType55Choice_ SecuritiesTransactionType { get; set; } 
    #endif
    
    /// <summary>
    /// Conditions under which the order/trade was to be settled.
    /// </summary>
    [IsoId("_qIKqA_fYEeiNZp_PtLohLw")]
