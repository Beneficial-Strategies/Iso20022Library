...
public partial record CorporateActionGeneralInformation154
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation154 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation154( System.String reqCorporateActionEventIdentification,CorporateActionEventType102Choice_ reqEventType )
    {
