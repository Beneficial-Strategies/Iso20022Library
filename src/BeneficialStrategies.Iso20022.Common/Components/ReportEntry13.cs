...
public partial record ReportEntry13
{
    ...
    #else
    /// <summary>
    /// Constructs a ReportEntry13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReportEntry13( ActiveOrHistoricCurrencyAndAmount reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus1Choice_ reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
    ...
    [IsoXmlTag("NtryDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public EntryDetails12? EntryDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public EntryDetails12? EntryDetails { get; init; } 
    #else
    public EntryDetails12? EntryDetails { get; set; } 
    #endif
