...
public partial record RejectedStatusReason27
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason27 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason27( RejectedReason28Choice_ reqReasonCode )
    {
