...
public partial record CreditTransfer6
{
    ...
    #else
    /// <summary>
    /// Constructs a CreditTransfer6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CreditTransfer6( FinancialInstitutionIdentification3Choice_ reqCreditorAgent,AccountIdentificationAndName3 reqCreditorAccount )
    {
