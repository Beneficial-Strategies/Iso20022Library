...
public partial record AcknowledgementReason2
{
    ...
    #else
    /// <summary>
    /// Constructs a AcknowledgementReason2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcknowledgementReason2( AcknowledgementReason3Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
