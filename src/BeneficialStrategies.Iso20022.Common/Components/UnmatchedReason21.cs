...
public partial record UnmatchedReason21
{
    ...
    #else
    /// <summary>
    /// Constructs a UnmatchedReason21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnmatchedReason21( UnmatchedReason30Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public UnmatchedReason30Choice_ Code { get; init; } 
    #else
    public UnmatchedReason30Choice_ Code { get; set; } 
    #endif
