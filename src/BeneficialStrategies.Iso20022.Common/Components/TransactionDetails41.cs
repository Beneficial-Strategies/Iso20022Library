...
public partial record TransactionDetails41
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails41( SettlementTypeAndIdentification3 reqAccountOwnerTransactionIdentification,SecuritiesAccount13 reqSafekeepingAccount )
    {
