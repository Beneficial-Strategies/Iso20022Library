...
public partial record PartyIdentificationAndAccount160
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount160 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount160( PartyIdentification104Choice_ reqIdentification )
    {
