...
public record Margin2
{
    ...
    /// <summary>
    /// Total margin requirement that must be provided by the clearing member to the central counterparty.
    /// </summary>
    ...
    /// <summary>
    /// Margin required for absorbing future market price fluctuations occurring between the default of a member and close-out of unsettled securities positions by the central counterparty.
    /// </summary>
    ...
    /// <summary>
    /// Additional amount that the clearing member will have to provide to cover a risk increase.
    /// </summary>
