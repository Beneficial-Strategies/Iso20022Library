...
public partial record InvestmentPlan8
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentPlan8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentPlan8( Frequency20Choice_ reqFrequency,UnitsOrAmount1Choice_ reqQuantity )
    {
