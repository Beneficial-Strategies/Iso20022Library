...
public partial record DevicePrintRequest4
{
    ...
    #else
    /// <summary>
    /// Constructs a DevicePrintRequest4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DevicePrintRequest4( DocumentType7Code reqDocumentQualifier,ResponseMode2Code reqResponseMode,ActionMessage9 reqOutputContent )
    {
