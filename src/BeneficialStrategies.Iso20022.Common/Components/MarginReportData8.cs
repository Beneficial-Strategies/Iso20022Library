...
public partial record MarginReportData8
{
    ...
    #else
    /// <summary>
    /// Constructs a MarginReportData8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MarginReportData8( TradeCounterpartyReport20 reqCounterpartyIdentification,MarginCollateralReport4 reqCollateral )
    {
    ...
    public ContractModification8? ContractModification { get; init; } 
    #else
    public ContractModification8? ContractModification { get; set; } 
    #endif
