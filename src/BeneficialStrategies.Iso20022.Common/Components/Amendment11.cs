...
public partial record Amendment11
{
    ...
    #else
    /// <summary>
    /// Constructs a Amendment11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Amendment11( Environment3 reqEnvironment,Transaction102 reqTransaction )
    {
