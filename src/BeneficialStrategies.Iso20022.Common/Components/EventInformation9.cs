...
public partial record EventInformation9
{
    ...
    #else
    /// <summary>
    /// Constructs a EventInformation9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EventInformation9( System.String reqCorporateActionEventIdentification,CorporateActionEventType52Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType )
    {
