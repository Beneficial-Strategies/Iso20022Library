...
[DataContract]
#endif
public partial record CorporateActionGeneralInformation120
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation120 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation120( System.String reqCorporateActionEventIdentification,CorporateActionEventType57Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
    ...
    public required CorporateActionEventType57Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType57Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType57Choice_ EventType { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies whether the event is mandatory, mandatory with options or voluntary.
    /// </summary>
    [IsoId("_lA9Kf5wtEeazcsnODTksnQ")]
