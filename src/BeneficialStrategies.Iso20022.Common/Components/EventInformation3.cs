...
public partial record EventInformation3
{
    ...
    #else
    /// <summary>
    /// Constructs a EventInformation3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EventInformation3( System.String reqCorporateActionEventIdentification,CorporateActionEventType7Choice_ reqEventType,CorporateActionMandatoryVoluntary1Choice_ reqMandatoryVoluntaryEventType )
    {
