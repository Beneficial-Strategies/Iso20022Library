...
public partial record AlternatePartyIdentification2
{
    ...
    #else
    /// <summary>
    /// Constructs a AlternatePartyIdentification2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AlternatePartyIdentification2( IdentificationType4Choice_ reqIdentificationType,string reqCountry,System.String reqAlternateIdentification )
    {
    ...
    public IdentificationType4Choice_ IdentificationType { get; init; } 
    #else
    public IdentificationType4Choice_ IdentificationType { get; set; } 
    #endif
