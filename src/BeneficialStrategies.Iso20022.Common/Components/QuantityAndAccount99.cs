...
public partial record QuantityAndAccount99
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount99 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount99( FinancialInstrumentQuantity33Choice_ reqSettlementQuantity )
    {
