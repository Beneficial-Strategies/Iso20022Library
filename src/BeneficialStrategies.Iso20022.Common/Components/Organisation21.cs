...
public partial record Organisation21
{
    ...
    #else
    /// <summary>
    /// Constructs a Organisation21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Organisation21( System.String reqName,PostalAddress1 reqCorporateInvestorAddress )
    {
        Name = reqName;
