...
/// </summary>
[IsoId("_VVXQEFr2EeWN79Bl6BUd3g")]
[DisplayName("Fertilizer Commodity Diammonium Phosphate")]
...
public partial record FertilizerCommodityDiammoniumPhosphate1
{
    ...
    #else
    /// <summary>
    /// Constructs a FertilizerCommodityDiammoniumPhosphate1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FertilizerCommodityDiammoniumPhosphate1( AssetClassProductType5Code reqBaseProduct,AssetClassSubProductType40Code reqSubProduct )
    {
    ...
    #else
    public AssetClassSubProductType40Code SubProduct { get; set; } 
    #endif
