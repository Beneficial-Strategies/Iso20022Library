...
public partial record CorporateActionGeneralInformation89
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation89 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation89( System.String reqCorporateActionEventIdentification,CorporateActionEventType31Choice_ reqEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public required CorporateActionEventType31Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType31Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType31Choice_ EventType { get; set; } 
    #endif
    
    /// <summary>
    /// Identification of the security concerned by the corporate action.
    /// </summary>
    [IsoId("_lYaJ2UGLEeWqy4niLuXETA")]
