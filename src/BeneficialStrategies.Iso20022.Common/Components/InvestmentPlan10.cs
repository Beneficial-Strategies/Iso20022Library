...
public partial record InvestmentPlan10
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentPlan10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentPlan10( Frequency20Choice_ reqFrequency,UnitsOrAmount1Choice_ reqQuantity )
    {
