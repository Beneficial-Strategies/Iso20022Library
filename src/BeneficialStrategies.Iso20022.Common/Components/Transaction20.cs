...
public partial record Transaction20
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction20( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails39? TransactionDetails { get; init; } 
    #else
    public TransactionDetails39? TransactionDetails { get; set; } 
    #endif
