...
public partial record CryptographicKey15
{
    ...
    #else
    /// <summary>
    /// Constructs a CryptographicKey15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CryptographicKey15( System.String reqIdentification,System.String reqVersion )
    {
    ...
    public ContentInformationType26? KeyValue { get; init; } 
    #else
    public ContentInformationType26? KeyValue { get; set; } 
    #endif
