...
public partial record CorporateActionGeneralInformationSD18
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD18( System.String reqPlaceAndName )
    {
