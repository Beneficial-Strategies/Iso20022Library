...
public partial record Header66
{
    ...
    #else
    /// <summary>
    /// Constructs a Header66 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Header66( MessageFunction29Code reqMessageFunction,System.String reqProtocolVersion,System.DateTime reqCreationDateTime,GenericIdentification183 reqInitiatingParty )
    {
    ...
    public MessageFunction29Code MessageFunction { get; init; } 
    #else
    public MessageFunction29Code MessageFunction { get; set; } 
    #endif
    
    /// <summary>
    /// Version of the acquirer to issuer protocol specifications.
    /// </summary>
    [IsoId("_aYUb0xynEeyVgKPonV4SjQ")]
