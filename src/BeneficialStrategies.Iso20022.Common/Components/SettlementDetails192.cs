...
public partial record SettlementDetails192
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails192 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails192( SecuritiesTransactionType51Choice_ reqSecuritiesTransactionType )
    {
