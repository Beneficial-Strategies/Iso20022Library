...
public partial record SessionManagementResponse4
{
    ...
    #else
    /// <summary>
    /// Constructs a SessionManagementResponse4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SessionManagementResponse4( CardPaymentEnvironment77 reqEnvironment,CardPaymentContext28 reqContext,RetailerService5Code reqServiceContent,ResponseType11 reqResponse )
    {
    ...
    public LoginResponse3? LoginResponse { get; init; } 
    #else
    public LoginResponse3? LoginResponse { get; set; } 
    #endif
    ...
    public DiagnosisResponse3? DiagnosisResponse { get; init; } 
    #else
    public DiagnosisResponse3? DiagnosisResponse { get; set; } 
    #endif
