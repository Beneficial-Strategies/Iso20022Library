...
public partial record RateTypeAndAmountAndStatus38
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus38( RateType68Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
