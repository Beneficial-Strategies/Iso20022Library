...
public partial record CardPaymentDataSetTransaction19
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction19( System.String reqTransactionSequenceCounter,CardPaymentEnvironment61 reqEnvironment,CardPaymentTransaction75 reqTransaction )
    {
