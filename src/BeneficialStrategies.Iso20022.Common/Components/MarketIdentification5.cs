...
public partial record MarketIdentification5
{
    ...
    #else
    /// <summary>
    /// Constructs a MarketIdentification5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MarketIdentification5( MarketType2Choice_ reqType )
    {
        Type = reqType;
    }
    #endif
    ...
    public required MarketType2Choice_ Type { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MarketType2Choice_ Type { get; init; } 
    #else
    public MarketType2Choice_ Type { get; set; } 
    #endif
