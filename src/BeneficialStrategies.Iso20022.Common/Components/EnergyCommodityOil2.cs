...
public partial record EnergyCommodityOil2
{
    ...
    #else
    /// <summary>
    /// Constructs a EnergyCommodityOil2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EnergyCommodityOil2( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType8Code reqSubProduct,AssetClassDetailedSubProductType32Code reqAdditionalSubProduct )
    {
