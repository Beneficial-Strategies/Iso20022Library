...
public partial record SecuritiesOption55
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption55 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption55( SecurityIdentification20 reqFinancialInstrumentIdentification,CreditDebitCode reqCreditDebitIndicator,Quantity10Choice_ reqPostingQuantity,SecurityDate13 reqDateDetails )
    {
    ...
    public required SecurityDate13 DateDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecurityDate13 DateDetails { get; init; } 
    #else
    public SecurityDate13 DateDetails { get; set; } 
    #endif
    ...
    public CorporateActionRate75? RateDetails { get; init; } 
    #else
    public CorporateActionRate75? RateDetails { get; set; } 
    #endif
    ...
    public SettlementParties43? ReceivingSettlementParties { get; init; } 
    #else
    public SettlementParties43? ReceivingSettlementParties { get; set; } 
    #endif
    ...
    public SettlementParties43? DeliveringSettlementParties { get; init; } 
    #else
    public SettlementParties43? DeliveringSettlementParties { get; set; } 
    #endif
