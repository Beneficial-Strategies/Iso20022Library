...
public partial record CaseAssignmentRejectionJustification2
{
    ...
    #else
    /// <summary>
    /// Constructs a CaseAssignmentRejectionJustification2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CaseAssignmentRejectionJustification2( CaseAssignmentRejection2Code reqRejectionReason )
    {
    ...
    public CaseAssignmentRejection2Code RejectionReason { get; init; } 
    #else
    public CaseAssignmentRejection2Code RejectionReason { get; set; } 
    #endif
