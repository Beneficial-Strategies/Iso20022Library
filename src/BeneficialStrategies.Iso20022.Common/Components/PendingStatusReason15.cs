...
public partial record PendingStatusReason15
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingStatusReason15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingStatusReason15( PendingReason49Choice_ reqReasonCode )
    {
    ...
    public PendingReason49Choice_ ReasonCode { get; init; } 
    #else
    public PendingReason49Choice_ ReasonCode { get; set; } 
    #endif
