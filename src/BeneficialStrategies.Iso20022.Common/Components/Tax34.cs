...
public partial record Tax34
{
    ...
    #else
    /// <summary>
    /// Constructs a Tax34 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Tax34( TaxType1Choice_ reqType,ActiveCurrencyAndAmount reqAmount,System.String reqExemptionIndicator )
    {
        Type = reqType;
        Amount = reqAmount;
