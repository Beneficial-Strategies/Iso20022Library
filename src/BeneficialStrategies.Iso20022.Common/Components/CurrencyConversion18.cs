...
public partial record CurrencyConversion18
{
    ...
    #else
    /// <summary>
    /// Constructs a CurrencyConversion18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CurrencyConversion18( CurrencyConversionResponse3Code reqResult )
    {
        Result = reqResult;
    }
    #endif
    ...
    public CurrencyConversion19? ConversionDetails { get; init; } 
    #else
    public CurrencyConversion19? ConversionDetails { get; set; } 
    #endif
