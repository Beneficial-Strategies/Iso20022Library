...
public partial record StatusAndReason41
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason41 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason41( Status30Choice_ reqStatusAndReason )
    {
    ...
    public Transaction111? Transaction { get; init; } 
    #else
    public Transaction111? Transaction { get; set; } 
    #endif
