...
public partial record SettlementDetails26
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails26( SecuritiesTransactionType3Choice_ reqSecuritiesTransactionType )
    {
    ...
    public ExposureType5Choice_? ExposureType { get; init; } 
    #else
    public ExposureType5Choice_? ExposureType { get; set; } 
    #endif
