...
/// <summary>
/// Original Notification Reference13.
/// </summary>
[IsoId("_8gGkYTEsEe6GxLzpkVnWYg")]
[DisplayName("Original Notification Reference13")]
public partial record OriginalNotificationReference13
{
    #nullable enable
    ...
    /// <summary>
    /// Original Item And Status.
    /// </summary>
    [DisplayName("Original Item And Status")]
    [IsoXmlTag("OrgnlItmAndSts")]
    public ValueList<OriginalItemAndStatus8> OriginalItemAndStatus { get; init; } = [];
