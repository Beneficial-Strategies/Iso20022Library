...
public partial record SecuritiesOption87
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption87 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption87( SecurityIdentification20 reqFinancialInstrumentIdentification,CreditDebitCode reqCreditDebitIndicator,Quantity54Choice_ reqPostingQuantity,SecurityDate17 reqDateDetails )
    {
