...
public partial record SettlementDetails42
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails42 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails42( SecuritiesTransactionType9Choice_ reqSecuritiesTransactionType )
    {
