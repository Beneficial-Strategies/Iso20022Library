...
public partial record CardPaymentContext15
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentContext15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentContext15( PaymentContext15 reqPaymentContext )
    {
    ...
    public PaymentContext15 PaymentContext { get; init; } 
    #else
    public PaymentContext15 PaymentContext { get; set; } 
    #endif
