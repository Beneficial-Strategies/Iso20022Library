...
public partial record CardPaymentTransaction52
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction52 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction52( TransactionIdentifier1 reqTransactionIdentification,CardPaymentServiceType5Code reqTransactionType )
    {
