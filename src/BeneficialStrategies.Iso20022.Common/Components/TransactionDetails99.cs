...
public partial record TransactionDetails99
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails99 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails99( TransactionActivity4Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SecurityIdentification20 reqFinancialInstrumentIdentification,Quantity10Choice_ reqPostingQuantity,SettlementDate15Choice_ reqSettlementDate )
    {
    ...
    public SettlementOrCorporateActionEvent21Choice_? SettlementTransactionOrCorporateActionEventType { get; init; } 
    #else
    public SettlementOrCorporateActionEvent21Choice_? SettlementTransactionOrCorporateActionEventType { get; set; } 
    #endif
    ...
    public SettlementDetails130? SettlementParameters { get; init; } 
    #else
    public SettlementDetails130? SettlementParameters { get; set; } 
    #endif
