...
public partial record CashOption68
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption68( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate72 reqDateDetails )
    {
    ...
    [IsoXmlTag("AmtDtls")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionAmounts52? AmountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionAmounts52? AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts52? AmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the dates related to a cash movement.
    /// </summary>
    [IsoId("_cs_ksffSEeiNZp_PtLohLw")]
