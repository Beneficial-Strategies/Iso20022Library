...
public partial record QuantityAndAccount2
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount2( Quantity6Choice_ reqSettledQuantity,SecuritiesAccount13 reqSafekeepingAccount )
    {
