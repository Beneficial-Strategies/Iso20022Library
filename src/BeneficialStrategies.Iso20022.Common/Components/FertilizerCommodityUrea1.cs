...
public partial record FertilizerCommodityUrea1
{
    ...
    #else
    /// <summary>
    /// Constructs a FertilizerCommodityUrea1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FertilizerCommodityUrea1( AssetClassProductType5Code reqBaseProduct,AssetClassSubProductType43Code reqSubProduct )
    {
