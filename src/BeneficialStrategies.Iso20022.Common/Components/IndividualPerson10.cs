...
public partial record IndividualPerson10
{
    ...
    #else
    /// <summary>
    /// Constructs a IndividualPerson10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public IndividualPerson10( System.String reqGivenName,System.String reqName,System.DateOnly reqBirthDate )
    {
    ...
    [MinLength(0)]
    [MaxLength(10)]
    public ValueList<GenericIdentification9> OtherIdentification { get; init; } = new ValueList<GenericIdentification9>(){};
