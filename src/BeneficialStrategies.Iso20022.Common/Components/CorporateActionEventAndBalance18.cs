...
public partial record CorporateActionEventAndBalance18
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionEventAndBalance18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionEventAndBalance18( EventInformation14 reqGeneralInformation,SecurityIdentification20 reqUnderlyingSecurity )
    {
    ...
    public EventInformation14 GeneralInformation { get; init; } 
    #else
    public EventInformation14 GeneralInformation { get; set; } 
    #endif
    ...
    public CorporateActionBalance42? Balance { get; init; } 
    #else
    public CorporateActionBalance42? Balance { get; set; } 
    #endif
