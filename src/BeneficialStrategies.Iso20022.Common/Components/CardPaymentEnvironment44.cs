...
public partial record CardPaymentEnvironment44
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentEnvironment44 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentEnvironment44( PointOfInteraction4 reqPOI,PaymentCard9 reqCard )
    {
        POI = reqPOI;
        Card = reqCard;
    }
