...
public partial record CorporateActionDate74
{
    ...
    public DateFormat49Choice_? CourtApprovalDate { get; init; } 
    #else
    public DateFormat49Choice_? CourtApprovalDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? EffectiveDate { get; init; } 
    #else
    public DateFormat49Choice_? EffectiveDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? EqualisationDate { get; init; } 
    #else
    public DateFormat49Choice_? EqualisationDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? NewMaturityDate { get; init; } 
    #else
    public DateFormat49Choice_? NewMaturityDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? MarginFixingDate { get; init; } 
    #else
    public DateFormat49Choice_? MarginFixingDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? ProrationDate { get; init; } 
    #else
    public DateFormat49Choice_? ProrationDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? UnconditionalDate { get; init; } 
    #else
    public DateFormat49Choice_? UnconditionalDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? WhollyUnconditionalDate { get; init; } 
    #else
    public DateFormat49Choice_? WhollyUnconditionalDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? SpecialExDate { get; init; } 
    #else
    public DateFormat49Choice_? SpecialExDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? GuaranteedParticipationDate { get; init; } 
    #else
    public DateFormat49Choice_? GuaranteedParticipationDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? LapsedDate { get; init; } 
    #else
    public DateFormat49Choice_? LapsedDate { get; set; } 
    #endif
    ...
    public DateFormat49Choice_? MarketClaimTrackingEndDate { get; init; } 
    #else
    public DateFormat49Choice_? MarketClaimTrackingEndDate { get; set; } 
    #endif
