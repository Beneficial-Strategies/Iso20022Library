...
public partial record CashOption52
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption52 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption52( CreditDebitCode reqCreditDebitIndicator,CorporateActionAmounts37 reqAmountDetails,CorporateActionDate24 reqDateDetails )
    {
    ...
    public RateDetails27? RateAndAmountDetails { get; init; } 
    #else
    public RateDetails27? RateAndAmountDetails { get; set; } 
    #endif
