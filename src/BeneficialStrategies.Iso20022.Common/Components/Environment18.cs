...
public partial record Environment18
{
    ...
    #else
    /// <summary>
    /// Constructs a Environment18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Environment18( PartyIdentification263 reqAcquirer,PartyIdentification255 reqAcceptor )
    {
