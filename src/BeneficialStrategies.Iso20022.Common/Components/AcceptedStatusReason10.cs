...
public partial record AcceptedStatusReason10
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptedStatusReason10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptedStatusReason10( AcceptedReason11Choice_ reqReasonCode )
    {
    ...
    public AcceptedReason11Choice_ ReasonCode { get; init; } 
    #else
    public AcceptedReason11Choice_ ReasonCode { get; set; } 
    #endif
