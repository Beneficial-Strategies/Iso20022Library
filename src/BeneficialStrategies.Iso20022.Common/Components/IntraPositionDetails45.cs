...
public partial record IntraPositionDetails45
{
    ...
    public ValueList<IntraPositionMovementDetails15> IntraPositionMovement { get; init; } = new ValueList<IntraPositionMovementDetails15>(){}; // Warning: Don't know multiplicity.
