...
public partial record AcquirerProtocolParameters10
{
    ...
    #else
    /// <summary>
    /// Constructs a AcquirerProtocolParameters10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcquirerProtocolParameters10( TerminalManagementAction3Code reqActionType,System.String reqVersion,System.String reqProtectCardData )
    {
    ...
    public AcquirerHostConfiguration4? Host { get; init; } 
    #else
    public AcquirerHostConfiguration4? Host { get; set; } 
    #endif
