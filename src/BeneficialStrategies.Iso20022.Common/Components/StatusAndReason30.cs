...
public partial record StatusAndReason30
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason30( Status23Choice_ reqStatusAndReason )
    {
    ...
    public Transaction48? Transaction { get; init; } 
    #else
    public Transaction48? Transaction { get; set; } 
    #endif
