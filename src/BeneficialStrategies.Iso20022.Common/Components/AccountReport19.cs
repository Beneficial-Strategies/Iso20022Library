...
public partial record AccountReport19
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountReport19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountReport19( System.String reqIdentification,System.DateTime reqCreationDateTime,CashAccount25 reqAccount )
    {
    ...
    public CashBalance7? Balance { get; init; } 
    #else
    public CashBalance7? Balance { get; set; } 
    #endif
