...
public partial record AdditionalInformation14
{
    ...
    public PartyIdentification111? Investor { get; init; } 
    #else
    public PartyIdentification111? Investor { get; set; } 
    #endif
    
    /// <summary>
    /// Party that, in a settlement chain interacts with the depository.
    /// </summary>
    [IsoId("_BZe6B5w0EeazcsnODTksnQ")]
    ...
    public PartyIdentificationAndAccount146? DeliveringParty1 { get; init; } 
    #else
    public PartyIdentificationAndAccount146? DeliveringParty1 { get; set; } 
    #endif
    
    /// <summary>
    /// Party that, in a settlement chain interacts with the depository.
    /// </summary>
    [IsoId("_BZe6C5w0EeazcsnODTksnQ")]
    ...
    public PartyIdentificationAndAccount146? ReceivingParty1 { get; init; } 
    #else
    public PartyIdentificationAndAccount146? ReceivingParty1 { get; set; } 
    #endif
