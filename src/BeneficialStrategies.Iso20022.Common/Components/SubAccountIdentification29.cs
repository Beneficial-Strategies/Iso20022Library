...
public partial record SubAccountIdentification29
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification29( SecuritiesAccount14 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    public AggregateBalanceInformation22? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation22? BalanceForSubAccount { get; set; } 
    #endif
