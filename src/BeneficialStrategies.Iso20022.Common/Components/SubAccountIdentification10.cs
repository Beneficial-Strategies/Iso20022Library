...
public partial record SubAccountIdentification10
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification10( SecuritiesAccount14 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AggregateBalanceInformation8? BalanceForSubAccount { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AggregateBalanceInformation8? BalanceForSubAccount { get; init; } 
    #else
    public AggregateBalanceInformation8? BalanceForSubAccount { get; set; } 
    #endif
