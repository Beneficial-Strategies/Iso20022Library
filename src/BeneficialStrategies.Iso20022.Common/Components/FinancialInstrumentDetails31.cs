...
public partial record FinancialInstrumentDetails31
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentDetails31 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentDetails31( SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
    ...
    public PriceInformation19? PriceDetails { get; init; } 
    #else
    public PriceInformation19? PriceDetails { get; set; } 
    #endif
    ...
    #endif
    [IsoXmlTag("Tx")]
    public ValueList<Transaction65> Transaction { get; init; } = new ValueList<Transaction65>(){}; // Warning: Don't know multiplicity.
