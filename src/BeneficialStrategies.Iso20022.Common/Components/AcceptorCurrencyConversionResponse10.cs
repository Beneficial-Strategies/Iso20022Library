...
public partial record AcceptorCurrencyConversionResponse10
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCurrencyConversionResponse10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCurrencyConversionResponse10( CardPaymentEnvironment79 reqEnvironment,CardPaymentTransaction129 reqTransaction,CurrencyConversion28 reqCurrencyConversionResult )
    {
    ...
    public required CurrencyConversion28 CurrencyConversionResult { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CurrencyConversion28 CurrencyConversionResult { get; init; } 
    #else
    public CurrencyConversion28 CurrencyConversionResult { get; set; } 
    #endif
