...
public partial record CardPaymentDataSet30
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSet30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSet30( System.String reqTransactionSequenceCounter,ResponseType10 reqTransactionResponse,CardPaymentEnvironment78 reqEnvironment,CardPaymentTransactionAdviceResponse5 reqTransaction )
    {
