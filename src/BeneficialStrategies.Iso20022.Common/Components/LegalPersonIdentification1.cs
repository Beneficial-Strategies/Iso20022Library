...
public partial record LegalPersonIdentification1
{
    ...
    #else
    /// <summary>
    /// Constructs a LegalPersonIdentification1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public LegalPersonIdentification1( OrganisationIdentification15Choice_ reqIdentification )
    {
