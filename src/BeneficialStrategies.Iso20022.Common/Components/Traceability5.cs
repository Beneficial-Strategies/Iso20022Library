...
public partial record Traceability5
{
    ...
    #else
    /// <summary>
    /// Constructs a Traceability5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Traceability5( GenericIdentification76 reqRelayIdentification,System.DateTime reqTraceDateTimeIn,System.DateTime reqTraceDateTimeOut )
    {
