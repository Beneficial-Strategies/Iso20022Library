...
public partial record SettlementDetails145
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails145 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails145( SecuritiesTransactionType37Choice_ reqSecuritiesTransactionType )
    {
    ...
    #else
    public SecuritiesTransactionType37Choice_ SecuritiesTransactionType { get; set; } 
    #endif
    
    /// <summary>
    /// Conditions under which the order/trade is to be settled.
    /// </summary>
    [IsoId("_utKfdaz1EeeBIMhGLpLUsQ")]
