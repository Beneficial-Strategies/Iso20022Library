...
public record CorporateActionOption205
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption87> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption80> CashMovementDetails { get; init; } = [];
}
