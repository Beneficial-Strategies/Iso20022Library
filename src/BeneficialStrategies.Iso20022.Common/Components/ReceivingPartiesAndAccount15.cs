...
public partial record ReceivingPartiesAndAccount15
{
    ...
    #else
    /// <summary>
    /// Constructs a ReceivingPartiesAndAccount15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReceivingPartiesAndAccount15( PartyIdentification102Choice_ reqDepository,PartyIdentificationAndAccount126 reqParty1 )
    {
