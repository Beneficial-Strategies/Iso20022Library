...
public partial record SecuritiesTradeDetails119
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails119 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails119( SettlementDate17Choice_ reqSettlementDate )
    {
