...
public partial record AggregateBalanceInformation37
{
    ...
    #else
    /// <summary>
    /// Constructs a AggregateBalanceInformation37 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AggregateBalanceInformation37( SecurityIdentification19 reqFinancialInstrumentIdentification,Balance6 reqAggregateBalance,BalanceAmounts1 reqAccountBaseCurrencyAmounts )
    {
    ...
    public AggregateBalancePerSafekeepingPlace34? BalanceAtSafekeepingPlace { get; init; } 
    #else
    public AggregateBalancePerSafekeepingPlace34? BalanceAtSafekeepingPlace { get; set; } 
    #endif
