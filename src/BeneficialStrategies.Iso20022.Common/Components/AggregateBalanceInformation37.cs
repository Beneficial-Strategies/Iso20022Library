...
public record AggregateBalanceInformation37
{
    ...
    [IsoXmlTag("QtyBrkdwn")]
    public ValueList<QuantityBreakdown53> QuantityBreakdown { get; init; } = [];
    ...
    public ValueList<AggregateBalancePerSafekeepingPlace34> BalanceAtSafekeepingPlace { get; init; } =
        [];
