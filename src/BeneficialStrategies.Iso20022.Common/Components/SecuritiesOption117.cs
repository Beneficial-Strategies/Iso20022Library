...
/// <summary>
/// Securities Option117.
/// </summary>
[IsoId("_nLkILZt3Ee-wQIOX0djF2w")]
[DisplayName("Securities Option117")]
public partial record SecuritiesOption117
{
    #nullable enable
    ...
    [IsoXmlTag("PricDtls")]
    public CorporateActionPrice98? PriceDetails { get; init; } 
    ...
    [IsoXmlTag("RateDtls")]
    public CorporateActionRate137? RateDetails { get; init; } 
    ...
    [IsoXmlTag("SfkpgPlc")]
    public SafekeepingPlaceFormat56Choice_? SafekeepingPlace { get; init; } 
    ...
    [IsoXmlTag("SctyDtls")]
    public required FinancialInstrumentAttributes137 SecurityDetails { get; init; } 
