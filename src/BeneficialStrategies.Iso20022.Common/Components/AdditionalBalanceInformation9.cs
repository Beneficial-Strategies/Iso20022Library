...
public partial record AdditionalBalanceInformation9
{
    ...
    #else
    /// <summary>
    /// Constructs a AdditionalBalanceInformation9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdditionalBalanceInformation9( SubBalanceType6Choice_ reqSubBalanceType,SubBalanceQuantity3Choice_ reqQuantity )
    {
