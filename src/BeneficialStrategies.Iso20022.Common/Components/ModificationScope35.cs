...
public partial record ModificationScope35
{
    ...
    #else
    /// <summary>
    /// Constructs a ModificationScope35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModificationScope35( DataModification1Code reqModificationScopeIndication )
    {
    ...
    #endif
    [IsoXmlTag("AddtlInf")]
    public ValueList<AdditiononalInformation12> AdditionalInformation { get; init; } = new ValueList<AdditiononalInformation12>(){}; // Warning: Don't know multiplicity.
