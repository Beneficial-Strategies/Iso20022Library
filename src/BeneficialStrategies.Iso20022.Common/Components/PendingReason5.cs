...
public partial record PendingReason5
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingReason5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingReason5( PendingReason13Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
