...
public partial record Transaction62
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction62 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction62( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails103? TransactionDetails { get; init; } 
    #else
    public TransactionDetails103? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_wdL50aOAEeeDTpy0mhI4TQ")]
