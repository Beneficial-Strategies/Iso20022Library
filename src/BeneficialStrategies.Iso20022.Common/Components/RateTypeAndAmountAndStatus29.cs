...
public partial record RateTypeAndAmountAndStatus29
{
    ...
    #else
    /// <summary>
    /// Constructs a RateTypeAndAmountAndStatus29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RateTypeAndAmountAndStatus29( RateType39Choice_ reqRateType,ActiveCurrencyAnd13DecimalAmount reqAmount )
    {
