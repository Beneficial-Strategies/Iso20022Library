...
public partial record BlockChainAddressWallet9
{
    ...
    #else
    /// <summary>
    /// Constructs a BlockChainAddressWallet9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BlockChainAddressWallet9( System.String reqIdentification )
    {
