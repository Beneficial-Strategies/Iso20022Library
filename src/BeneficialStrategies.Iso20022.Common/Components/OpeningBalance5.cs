...
public partial record OpeningBalance5
{
    ...
    #else
    /// <summary>
    /// Constructs a OpeningBalance5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OpeningBalance5( ShortLong1Code reqShortLongIndicator,OpeningBalance6Choice_ reqOpeningBalance )
    {
    ...
    public required OpeningBalance6Choice_ OpeningBalance { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OpeningBalance6Choice_ OpeningBalance { get; init; } 
    #else
    public OpeningBalance6Choice_ OpeningBalance { get; set; } 
    #endif
