...
public partial record FailingReason1
{
    ...
    #else
    /// <summary>
    /// Constructs a FailingReason1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FailingReason1( FailingReason1Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public FailingReason1Choice_ Code { get; init; } 
    #else
    public FailingReason1Choice_ Code { get; set; } 
    #endif
