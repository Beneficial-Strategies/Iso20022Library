...
public partial record PartyIdentificationAndAccount35
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount35( PartyIdentification49Choice_ reqIdentification )
    {
