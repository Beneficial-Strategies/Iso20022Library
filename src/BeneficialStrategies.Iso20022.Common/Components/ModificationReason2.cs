...
public partial record ModificationReason2
{
    ...
    #else
    /// <summary>
    /// Constructs a ModificationReason2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ModificationReason2( ModificationReason2Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public ModificationReason2Choice_ Code { get; init; } 
    #else
    public ModificationReason2Choice_ Code { get; set; } 
    #endif
