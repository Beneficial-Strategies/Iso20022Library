...
public partial record CashOption53
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption53 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption53( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate56 reqDateDetails )
    {
