...
public partial record CorporateActionMovementSecuritiesMovementDetailsSD3
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionMovementSecuritiesMovementDetailsSD3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionMovementSecuritiesMovementDetailsSD3( System.String reqPlaceAndName,CreditDebitCode reqCreditDebitIndicator,DTCCPayoutType4Code reqPayoutType )
    {
