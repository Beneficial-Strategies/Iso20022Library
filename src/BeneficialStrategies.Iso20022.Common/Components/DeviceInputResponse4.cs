...
public partial record DeviceInputResponse4
{
    ...
    #else
    /// <summary>
    /// Constructs a DeviceInputResponse4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DeviceInputResponse4( InputResult4 reqInputResult )
    {
    ...
    public required InputResult4 InputResult { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InputResult4 InputResult { get; init; } 
    #else
    public InputResult4 InputResult { get; set; } 
    #endif
