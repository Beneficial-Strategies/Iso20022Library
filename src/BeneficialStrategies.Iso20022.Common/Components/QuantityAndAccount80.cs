...
public partial record QuantityAndAccount80
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityAndAccount80 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityAndAccount80( Quantity6Choice_ reqSettledQuantity,SecuritiesAccount19 reqSafekeepingAccount )
    {
