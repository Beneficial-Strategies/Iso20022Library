...
public partial record ProprietaryReference1
{
    ...
    #else
    /// <summary>
    /// Constructs a ProprietaryReference1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ProprietaryReference1( System.String reqType,System.String reqReference )
    {
        Type = reqType;
