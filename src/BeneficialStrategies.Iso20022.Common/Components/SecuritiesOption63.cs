...
public partial record SecuritiesOption63
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption63 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption63( SecurityIdentification20 reqFinancialInstrumentIdentification,CreditDebitCode reqCreditDebitIndicator,Quantity10Choice_ reqPostingQuantity,SecurityDate13 reqDateDetails )
    {
    ...
    public SettlementParties61? ReceivingSettlementParties { get; init; } 
    #else
    public SettlementParties61? ReceivingSettlementParties { get; set; } 
    #endif
    ...
    public SettlementParties61? DeliveringSettlementParties { get; init; } 
    #else
    public SettlementParties61? DeliveringSettlementParties { get; set; } 
    #endif
