...
public partial record PaymentContext10
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentContext10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentContext10( CardDataReading1Code reqCardDataEntryMode )
    {
