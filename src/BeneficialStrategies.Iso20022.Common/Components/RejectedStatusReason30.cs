...
public partial record RejectedStatusReason30
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectedStatusReason30 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectedStatusReason30( RejectedReason31Choice_ reqReasonCode )
    {
    ...
    public RejectedReason31Choice_ ReasonCode { get; init; } 
    #else
    public RejectedReason31Choice_ ReasonCode { get; set; } 
    #endif
