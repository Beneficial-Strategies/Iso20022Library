...
public partial record OriginalPaymentInstruction6
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalPaymentInstruction6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalPaymentInstruction6( System.String reqOriginalPaymentInformationIdentification )
    {
    ...
    public PaymentTransaction46? TransactionInformationAndStatus { get; init; } 
    #else
    public PaymentTransaction46? TransactionInformationAndStatus { get; set; } 
    #endif
