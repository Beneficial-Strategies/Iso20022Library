...
public record UnderlyingTransaction9
{
    ...
    public ValueList<OriginalPaymentInstruction10> OriginalPaymentInformationAndStatus { get; init; } =
        [];
    ...
    public ValueList<PaymentTransaction53> TransactionInformationAndStatus { get; init; } = [];
}
