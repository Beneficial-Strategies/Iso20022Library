...
public partial record Tax21
{
    ...
    /// </summary>
    public Tax21( TaxType1Choice_ reqType,ActiveOrHistoricCurrencyAnd13DecimalAmount reqAmount,TaxBasis1Choice_ reqBasis,System.String reqExemptionIndicator )
    {
        Type = reqType;
        Amount = reqAmount;
        Basis = reqBasis;
