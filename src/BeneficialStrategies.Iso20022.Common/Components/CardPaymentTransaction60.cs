...
public partial record CardPaymentTransaction60
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction60 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction60( TransactionIdentifier1 reqTransactionIdentification,System.String reqTransactionSuccess,CardPaymentTransactionDetails30 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails30 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails30 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails30 TransactionDetails { get; set; } 
    #endif
