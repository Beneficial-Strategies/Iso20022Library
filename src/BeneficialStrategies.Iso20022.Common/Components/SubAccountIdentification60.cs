...
public partial record SubAccountIdentification60
{
    ...
    #else
    /// <summary>
    /// Constructs a SubAccountIdentification60 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubAccountIdentification60( SecuritiesAccount25 reqSafekeepingAccount,System.String reqActivityIndicator )
    {
