...
public record AccountSubLevel13
{
    /// <summary>
    ...
    public ValueList<AccountSubLevel14> AccountSubLevel4 { get; init; } = [];
    ...
    public ValueList<AggregateHoldingBalance2> AccountSubLevel4Difference { get; init; } = [];
