...
public partial record SimpleIdentificationInformation1
{
    ...
    #else
    /// <summary>
    /// Constructs a SimpleIdentificationInformation1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SimpleIdentificationInformation1( System.String reqIdentification )
    {
