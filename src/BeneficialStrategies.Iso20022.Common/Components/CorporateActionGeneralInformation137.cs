...
public partial record CorporateActionGeneralInformation137
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation137 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation137( System.String reqCorporateActionEventIdentification,CorporateActionEventType85Choice_ reqEventType )
    {
