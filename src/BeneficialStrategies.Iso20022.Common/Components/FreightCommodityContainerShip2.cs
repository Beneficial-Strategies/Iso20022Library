...
public partial record FreightCommodityContainerShip2
{
    ...
    #else
    /// <summary>
    /// Constructs a FreightCommodityContainerShip2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FreightCommodityContainerShip2( AssetClassProductType4Code reqBaseProduct )
    {
