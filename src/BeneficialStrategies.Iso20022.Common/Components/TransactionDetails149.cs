...
public partial record TransactionDetails149
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails149 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails149( SecurityIdentification19 reqFinancialInstrumentIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity51Choice_ reqSettlementQuantity,SettlementDate19Choice_ reqSettlementDate )
    {
