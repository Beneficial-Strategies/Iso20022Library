...
public partial record PartyIdentificationAndAccount221
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount221 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount221( PartyIdentification240Choice_ reqIdentification )
    {
