...
public partial record Header43
{
    ...
    #else
    /// <summary>
    /// Constructs a Header43 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Header43( MessageFunction23Code reqMessageFunction,System.String reqProtocolVersion,System.DateTime reqCreationDateTime,GenericIdentification172 reqInitiatingParty )
    {
    ...
    public MessageFunction23Code MessageFunction { get; init; } 
    #else
    public MessageFunction23Code MessageFunction { get; set; } 
    #endif
    
    /// <summary>
    /// Version of the acquirer to issuer protocol specifications.
    /// </summary>
    [IsoId("_qMpwU1ULEeetiruPyDPo0Q")]
