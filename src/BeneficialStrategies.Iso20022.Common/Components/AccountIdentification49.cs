...
public partial record AccountIdentification49
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification49 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification49( System.String reqSafekeepingAccount )
    {
    ...
    public SafekeepingPlaceFormat34Choice_? SafekeepingPlace { get; init; } 
    #else
    public SafekeepingPlaceFormat34Choice_? SafekeepingPlace { get; set; } 
    #endif
