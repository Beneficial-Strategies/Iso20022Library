...
public partial record MandateInformation2
{
    ...
    #else
    /// <summary>
    /// Constructs a MandateInformation2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MandateInformation2( System.String reqMandateRequestIdentification,PartyIdentification32 reqCreditor,PartyIdentification32 reqDebtor,BranchAndFinancialInstitutionIdentification4 reqDebtorAgent )
    {
