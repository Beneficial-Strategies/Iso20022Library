...
public partial record SecuritiesOption67
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesOption67 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesOption67( SecurityIdentification20 reqFinancialInstrumentIdentification,CreditDebitCode reqCreditDebitIndicator,Quantity10Choice_ reqPostingQuantity,SecurityDate17 reqDateDetails )
    {
