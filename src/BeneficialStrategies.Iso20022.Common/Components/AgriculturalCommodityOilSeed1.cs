...
public partial record AgriculturalCommodityOilSeed1
{
    ...
    #else
    /// <summary>
    /// Constructs a AgriculturalCommodityOilSeed1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AgriculturalCommodityOilSeed1( AssetClassProductType1Code reqBaseProduct,AssetClassSubProductType1Code reqSubProduct,AssetClassDetailedSubProductType1Code reqAdditionalSubProduct )
    {
