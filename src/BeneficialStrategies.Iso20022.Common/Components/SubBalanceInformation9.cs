...
public partial record SubBalanceInformation9
{
    ...
    #else
    /// <summary>
    /// Constructs a SubBalanceInformation9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SubBalanceInformation9( SubBalanceType5Choice_ reqSubBalanceType,SubBalanceQuantity3Choice_ reqQuantity )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public AdditionalBalanceInformation9? AdditionalBalanceBreakdownDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AdditionalBalanceInformation9? AdditionalBalanceBreakdownDetails { get; init; } 
    #else
    public AdditionalBalanceInformation9? AdditionalBalanceBreakdownDetails { get; set; } 
    #endif
