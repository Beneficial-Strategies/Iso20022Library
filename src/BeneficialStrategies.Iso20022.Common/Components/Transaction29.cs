...
public partial record Transaction29
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction29( System.String reqAccountOwnerTransactionIdentification )
    {
    ...
    public TransactionDetails57? TransactionDetails { get; init; } 
    #else
    public TransactionDetails57? TransactionDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Additional information that cannot be captured in the structured elements and/or any other specific block.
    /// </summary>
    [IsoId("_lIiugxG-EeKHC-9MYSJwtQ")]
