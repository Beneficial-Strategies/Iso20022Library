...
public partial record CardPaymentContext23
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentContext23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentContext23( PaymentContext23 reqPaymentContext )
    {
    ...
    public PaymentContext23 PaymentContext { get; init; } 
    #else
    public PaymentContext23 PaymentContext { get; set; } 
    #endif
