...
public partial record ReuseDataReportCorrection9
{
    ...
    #else
    /// <summary>
    /// Constructs a ReuseDataReportCorrection9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReuseDataReportCorrection9( CounterpartyData46 reqCounterpartyData,CollateralType12 reqCollateralComponent,System.DateOnly reqEventDay,System.DateTime reqReportingDateTime,ContractModification3 reqContractModification )
    {
