...
public partial record TransactionDetails138
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails138 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails138( SecurityIdentification19 reqFinancialInstrumentIdentification,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,Quantity6Choice_ reqSettlementQuantity,SecuritiesAccount19 reqSafekeepingAccount,SettlementDate19Choice_ reqSettlementDate )
    {
