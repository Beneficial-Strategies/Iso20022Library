...
public partial record SecuritiesReferenceDataReport6
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesReferenceDataReport6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesReferenceDataReport6( SecurityInstrumentDescription9 reqFinancialInstrumentGeneralAttributes,System.String reqIssuer )
    {
