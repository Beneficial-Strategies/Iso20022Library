...
public partial record GenericIdentification163
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification163 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification163( System.String reqIdentification,System.String reqIssuer )
    {
