...
public partial record PartyIdentification155
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification155 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification155( PartyIdentification145Choice_ reqIdentification )
    {
