...
public partial record PaymentCancellationReason1
{
    ...
    #else
    /// <summary>
    /// Constructs a PaymentCancellationReason1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PaymentCancellationReason1( MandateReason1Choice_ reqReason )
    {
        Reason = reqReason;
    }
    #endif
