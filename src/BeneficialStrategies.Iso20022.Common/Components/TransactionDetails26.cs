...
public partial record TransactionDetails26
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionDetails26 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionDetails26( TransactionActivity1Choice_ reqTransactionActivity,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SecurityIdentification14 reqFinancialInstrumentIdentification,Quantity6Choice_ reqPostingQuantity,SettlementDate2Choice_ reqSettlementDate )
    {
