...
public record Rate36
{
    ...
    public ValueList<GrossDividendRateFormat38Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat39Choice_> NetDividendRate { get; init; } = [];
