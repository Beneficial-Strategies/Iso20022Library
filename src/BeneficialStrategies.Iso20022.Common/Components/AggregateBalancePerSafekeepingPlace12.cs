...
public partial record AggregateBalancePerSafekeepingPlace12
{
    ...
    #else
    /// <summary>
    /// Constructs a AggregateBalancePerSafekeepingPlace12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AggregateBalancePerSafekeepingPlace12( SafekeepingPlaceFormat3Choice_ reqSafekeepingPlace,Balance1 reqAggregateBalance,BalanceAmounts1 reqAccountBaseCurrencyAmounts )
    {
