...
public partial record AcceptorReconciliationResponse4
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationResponse4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationResponse4( CardPaymentEnvironment38 reqEnvironment,ResponseType5 reqTransactionResponse,TransactionReconciliation4 reqTransaction )
    {
