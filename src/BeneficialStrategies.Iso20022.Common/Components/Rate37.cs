...
public record Rate37
{
    ...
    public ValueList<GrossDividendRateFormat40Choice_> GrossDividendRate { get; init; } = [];
    ...
    public ValueList<NetDividendRateFormat42Choice_> NetDividendRate { get; init; } = [];
