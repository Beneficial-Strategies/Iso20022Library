...
public partial record QuantityBreakdown31
{
    ...
    #else
    /// <summary>
    /// Constructs a QuantityBreakdown31 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public QuantityBreakdown31( GenericIdentification37 reqLotNumber )
    {
