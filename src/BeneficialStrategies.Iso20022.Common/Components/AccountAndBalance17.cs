...
public partial record AccountAndBalance17
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountAndBalance17 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountAndBalance17( System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionBalanceDetails12? Balance { get; init; } 
    #else
    public CorporateActionBalanceDetails12? Balance { get; set; } 
    #endif
