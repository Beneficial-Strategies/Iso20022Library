...
public partial record RejectionReason49
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason49 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason49( RejectionReason37Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public RejectionReason37Choice_ Code { get; init; } 
    #else
    public RejectionReason37Choice_ Code { get; set; } 
    #endif
