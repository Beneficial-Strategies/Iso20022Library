...
public partial record OtherC10CommodityDeliverable2
{
    ...
    #else
    /// <summary>
    /// Constructs a OtherC10CommodityDeliverable2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OtherC10CommodityDeliverable2( AssetClassProductType11Code reqBaseProduct )
    {
