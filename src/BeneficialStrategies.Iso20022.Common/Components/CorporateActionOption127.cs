...
public partial record CorporateActionOption127
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption127 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption127( System.String reqOptionNumber,CorporateActionOption23Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    public OptionFeaturesFormat21Choice_? OptionFeatures { get; init; } 
    #else
    public OptionFeaturesFormat21Choice_? OptionFeatures { get; set; } 
    #endif
    ...
    public CorporateActionRate79? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate79? RateAndAmountDetails { get; set; } 
    #endif
    ...
    public CashOption49? CashMovementDetails { get; init; } 
    #else
    public CashOption49? CashMovementDetails { get; set; } 
    #endif
