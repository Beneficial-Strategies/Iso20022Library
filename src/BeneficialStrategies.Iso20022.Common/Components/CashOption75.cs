...
public partial record CashOption75
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption75 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption75( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate72 reqDateDetails )
    {
