...
public partial record CashOption66
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption66 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption66( CreditDebitCode reqCreditDebitIndicator,CorporateActionDate62 reqDateDetails )
    {
    ...
    public CorporateActionAmounts49? AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts49? AmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the dates related to a cash movement.
    /// </summary>
    [IsoId("_VErNj7XVEeiTob_PrFFUxA")]
