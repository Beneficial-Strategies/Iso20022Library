...
public partial record SettlementParties59
{
    ...
    public PartyIdentification118? Depository { get; init; } 
    #else
    public PartyIdentification118? Depository { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount155? Party1 { get; init; } 
    #else
    public PartyIdentificationAndAccount155? Party1 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount155? Party2 { get; init; } 
    #else
    public PartyIdentificationAndAccount155? Party2 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount155? Party3 { get; init; } 
    #else
    public PartyIdentificationAndAccount155? Party3 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount155? Party4 { get; init; } 
    #else
    public PartyIdentificationAndAccount155? Party4 { get; set; } 
    #endif
    ...
    public PartyIdentificationAndAccount155? Party5 { get; init; } 
    #else
    public PartyIdentificationAndAccount155? Party5 { get; set; } 
    #endif
