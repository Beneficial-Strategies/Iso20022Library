...
public partial record GenericIdentification178
{
    ...
    #else
    /// <summary>
    /// Constructs a GenericIdentification178 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public GenericIdentification178( System.String reqIdentification )
    {
