...
public partial record CorporateActionOption153
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption153 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption153( System.String reqOptionNumber,CorporateActionOption18Choice_ reqOptionType,DefaultProcessingOrStandingInstruction1Choice_ reqDefaultProcessingOrStandingInstruction )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CashOption66? CashMovementDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CashOption66? CashMovementDetails { get; init; } 
    #else
    public CashOption66? CashMovementDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides additional information about the corporate action movement.
    /// </summary>
    [IsoId("_cgYP37XDEeiTob_PrFFUxA")]
