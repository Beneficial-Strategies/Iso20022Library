...
public partial record AlternatePartyIdentification10
{
    ...
    #else
    /// <summary>
    /// Constructs a AlternatePartyIdentification10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AlternatePartyIdentification10( IdentificationType42Choice_ reqTypeOfIdentification,string reqCountry,System.String reqAlternateIdentification )
    {
    ...
    public IdentificationType42Choice_ TypeOfIdentification { get; init; } 
    #else
    public IdentificationType42Choice_ TypeOfIdentification { get; set; } 
    #endif
