...
public partial record CompareCollateralQualityType2
{
    ...
    public CollateralQualityType1Code? Value1 { get; init; } 
    #else
    public CollateralQualityType1Code? Value1 { get; set; } 
    #endif
    
    /// <summary>
    /// Information for the second side of the transaction.
    /// </summary>
    [IsoId("_BRitQ9R7EemZdYGWu384Zw")]
    [DisplayName("Value")]
    #if DECLARE_DATACONTRACT
    ...
    public CollateralQualityType1Code? Value2 { get; init; } 
    #else
    public CollateralQualityType1Code? Value2 { get; set; } 
    #endif
