...
public partial record SecuritiesTradeDetails108
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails108 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails108( SettlementDate20Choice_ reqSettlementDate )
    {
