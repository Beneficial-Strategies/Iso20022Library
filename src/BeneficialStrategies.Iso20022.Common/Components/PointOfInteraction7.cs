...
public partial record PointOfInteraction7
{
    ...
    #else
    /// <summary>
    /// Constructs a PointOfInteraction7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PointOfInteraction7( GenericIdentification32 reqIdentification )
    {
    ...
    public PointOfInteractionComponent7? Component { get; init; } 
    #else
    public PointOfInteractionComponent7? Component { get; set; } 
    #endif
