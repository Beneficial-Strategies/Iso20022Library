...
public partial record CorporateActionOption39
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption39 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption39( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption11Choice_ reqOptionType )
    {
    ...
    public SecuritiesOption27? SecuritiesMovementDetails { get; init; } 
    #else
    public SecuritiesOption27? SecuritiesMovementDetails { get; set; } 
    #endif
    ...
    public CashOption19? CashMovementDetails { get; init; } 
    #else
    public CashOption19? CashMovementDetails { get; set; } 
    #endif
