...
public partial record CardPaymentTransactionDetails38
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransactionDetails38 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransactionDetails38( ImpliedCurrencyAndAmount reqTotalAmount )
    {
