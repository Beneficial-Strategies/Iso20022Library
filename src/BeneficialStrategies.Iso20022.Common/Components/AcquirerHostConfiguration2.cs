...
public partial record AcquirerHostConfiguration2
{
    ...
    #else
    /// <summary>
    /// Constructs a AcquirerHostConfiguration2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcquirerHostConfiguration2( System.String reqHostIdentification )
    {
    ...
    public MessageFunction3Code? MessageToSend { get; init; } 
    #else
    public MessageFunction3Code? MessageToSend { get; set; } 
    #endif
