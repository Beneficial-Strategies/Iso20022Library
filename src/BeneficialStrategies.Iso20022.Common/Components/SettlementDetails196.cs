...
public partial record SettlementDetails196
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails196 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails196( SecuritiesTransactionType52Choice_ reqSecuritiesTransactionType )
    {
