...
public partial record AccountNotification20
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountNotification20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountNotification20( System.String reqIdentification,CashAccount41 reqAccount )
    {
