...
public partial record RejectionReason28
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason28 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason28( RejectionReason26Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
    ...
    public RejectionReason26Choice_ Code { get; init; } 
    #else
    public RejectionReason26Choice_ Code { get; set; } 
    #endif
