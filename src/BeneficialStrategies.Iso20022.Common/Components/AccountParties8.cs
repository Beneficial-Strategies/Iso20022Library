...
public partial record AccountParties8
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountParties8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountParties8( DataModification1Code reqModificationScopeIndication )
    {
    ...
    public AccountParties3Choice_? PrincipalAccountParty { get; init; } 
    #else
    public AccountParties3Choice_? PrincipalAccountParty { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public InvestmentAccountOwnershipInformation8? SecondaryOwner { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation8? SecondaryOwner { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? SecondaryOwner { get; set; } 
    #endif
    ...
    [IsoXmlTag("Bnfcry")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public InvestmentAccountOwnershipInformation8? Beneficiary { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation8? Beneficiary { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? Beneficiary { get; set; } 
    #endif
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public InvestmentAccountOwnershipInformation8? PowerOfAttorney { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation8? PowerOfAttorney { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? PowerOfAttorney { get; set; } 
    #endif
    ...
    [IsoXmlTag("LglGuardn")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public InvestmentAccountOwnershipInformation8? LegalGuardian { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation8? LegalGuardian { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? LegalGuardian { get; set; } 
    #endif
    ...
    public InvestmentAccountOwnershipInformation8? SuccessorOnDeath { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? SuccessorOnDeath { get; set; } 
    #endif
    ...
    [IsoXmlTag("Admstr")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public InvestmentAccountOwnershipInformation8? Administrator { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public InvestmentAccountOwnershipInformation8? Administrator { get; init; } 
    #else
    public InvestmentAccountOwnershipInformation8? Administrator { get; set; } 
    #endif
    ...
    [IsoXmlTag("OthrPty")]
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public ExtendedParty5? OtherParty { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ExtendedParty5? OtherParty { get; init; } 
    #else
    public ExtendedParty5? OtherParty { get; set; } 
    #endif
