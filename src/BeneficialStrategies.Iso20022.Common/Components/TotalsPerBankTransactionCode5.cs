...
public partial record TotalsPerBankTransactionCode5
{
    ...
    #else
    /// <summary>
    /// Constructs a TotalsPerBankTransactionCode5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TotalsPerBankTransactionCode5( BankTransactionCodeStructure4 reqBankTransactionCode )
    {
    ...
    public NumberAndSumOfTransactions1? CreditEntries { get; init; } 
    #else
    public NumberAndSumOfTransactions1? CreditEntries { get; set; } 
    #endif
    ...
    public NumberAndSumOfTransactions1? DebitEntries { get; init; } 
    #else
    public NumberAndSumOfTransactions1? DebitEntries { get; set; } 
    #endif
