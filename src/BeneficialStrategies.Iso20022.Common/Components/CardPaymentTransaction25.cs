...
public partial record CardPaymentTransaction25
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction25 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction25( CardPaymentServiceType5Code reqTransactionType,System.String reqMerchantCategoryCode,TransactionIdentifier1 reqTransactionIdentification,System.String reqTransactionSuccess,CardPaymentTransactionDetails14 reqTransactionDetails )
    {
    ...
    public required CardPaymentTransactionDetails14 TransactionDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardPaymentTransactionDetails14 TransactionDetails { get; init; } 
    #else
    public CardPaymentTransactionDetails14 TransactionDetails { get; set; } 
    #endif
