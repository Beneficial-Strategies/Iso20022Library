...
public partial record SettlementDetails204
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails204 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails204( SecuritiesTransactionType44Choice_ reqSecuritiesTransactionType )
    {
