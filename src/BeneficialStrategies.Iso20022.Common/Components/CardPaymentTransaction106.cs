...
public partial record CardPaymentTransaction106
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentTransaction106 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentTransaction106( TransactionIdentifier1 reqTransactionIdentification,CardPaymentServiceType12Code reqTransactionType )
    {
