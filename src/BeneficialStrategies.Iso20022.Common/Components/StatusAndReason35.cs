...
public partial record StatusAndReason35
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusAndReason35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusAndReason35( Status23Choice_ reqStatusAndReason )
    {
    ...
    public Transaction63? Transaction { get; init; } 
    #else
    public Transaction63? Transaction { get; set; } 
    #endif
