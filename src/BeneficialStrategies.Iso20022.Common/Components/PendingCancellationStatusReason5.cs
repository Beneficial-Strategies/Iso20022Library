...
public partial record PendingCancellationStatusReason5
{
    ...
    #else
    /// <summary>
    /// Constructs a PendingCancellationStatusReason5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PendingCancellationStatusReason5( PendingCancellationReason3Choice_ reqReasonCode )
    {
    ...
    public PendingCancellationReason3Choice_ ReasonCode { get; init; } 
    #else
    public PendingCancellationReason3Choice_ ReasonCode { get; set; } 
    #endif
