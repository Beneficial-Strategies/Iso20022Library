...
public partial record InvestmentAccount62
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccount62 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccount62( System.String reqIdentification )
    {
