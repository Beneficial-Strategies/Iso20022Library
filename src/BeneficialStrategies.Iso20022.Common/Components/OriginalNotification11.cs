...
public partial record OriginalNotification11
{
    ...
    #else
    /// <summary>
    /// Constructs a OriginalNotification11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OriginalNotification11( System.String reqOriginalMessageIdentification,System.String reqOriginalNotificationIdentification )
    {
    ...
    public OriginalNotificationReference9? OriginalNotificationReference { get; init; } 
    #else
    public OriginalNotificationReference9? OriginalNotificationReference { get; set; } 
    #endif
