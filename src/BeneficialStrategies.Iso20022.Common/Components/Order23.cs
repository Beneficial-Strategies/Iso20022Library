...
public partial record Order23
{
    ...
    #else
    /// <summary>
    /// Constructs a Order23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Order23( SecurityIdentification19 reqFinancialInstrumentIdentification,Side3Code reqSide,TradeDate7Choice_ reqTradeDate,SettlementDate16Choice_ reqSettlementDate,Quantity6Choice_ reqConfirmationQuantity,Price14 reqDealPrice )
    {
    ...
    public Commission25? Commission { get; init; } 
    #else
    public Commission25? Commission { get; set; } 
    #endif
