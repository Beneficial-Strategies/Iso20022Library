...
public partial record AccountAndBalance11
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountAndBalance11 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountAndBalance11( System.String reqSafekeepingAccount,CorporateActionBalanceDetails2 reqBalance )
    {
