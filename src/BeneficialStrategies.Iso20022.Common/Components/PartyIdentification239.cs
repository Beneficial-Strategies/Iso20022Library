...
public partial record PartyIdentification239
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification239 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification239( PartyIdentification233Choice_ reqIdentification )
    {
    ...
    public PartyIdentification233Choice_ Identification { get; init; } 
    #else
    public PartyIdentification233Choice_ Identification { get; set; } 
    #endif
