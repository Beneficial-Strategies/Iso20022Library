...
public partial record Price3
{
    ...
    #else
    /// <summary>
    /// Constructs a Price3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Price3( YieldedOrValueType1Choice_ reqType,PriceRateOrAmount1Choice_ reqValue )
    {
        Type = reqType;
        Value = reqValue;
    }
