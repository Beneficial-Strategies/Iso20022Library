...
public partial record CollateralValuation5
{
    ...
    #else
    /// <summary>
    /// Constructs a CollateralValuation5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CollateralValuation5( CollateralType1Code reqCollateralType,SettlementStatus2Code reqSettlementStatus,System.UInt64 reqNumberOfDaysAccrued,CollateralAmount1 reqValuationAmounts,InterestComputationMethod2Code reqDayCountBasis )
    {
    ...
    public SecuritiesCollateral6? SecuritiesCollateral { get; init; } 
    #else
    public SecuritiesCollateral6? SecuritiesCollateral { get; set; } 
    #endif
    ...
    public OtherCollateral6? OtherCollateral { get; init; } 
    #else
    public OtherCollateral6? OtherCollateral { get; set; } 
    #endif
