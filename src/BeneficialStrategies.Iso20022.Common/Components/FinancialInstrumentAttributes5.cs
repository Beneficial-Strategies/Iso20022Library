...
public partial record FinancialInstrumentAttributes5
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInstrumentAttributes5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInstrumentAttributes5( SecurityIdentification11 reqSecurityIdentification )
    {
    ...
    public PriceFormat11Choice_? IssuePrice { get; init; } 
    #else
    public PriceFormat11Choice_? IssuePrice { get; set; } 
    #endif
