...
public partial record DocumentToSend3
{
    ...
    #else
    /// <summary>
    /// Constructs a DocumentToSend3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DocumentToSend3( System.String reqType,PartyIdentification70Choice_ reqRecipient,CommunicationMethod3Choice_ reqMethodOfTransmission )
    {
        Type = reqType;
    ...
    public required PartyIdentification70Choice_ Recipient { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public PartyIdentification70Choice_ Recipient { get; init; } 
    #else
    public PartyIdentification70Choice_ Recipient { get; set; } 
    #endif
