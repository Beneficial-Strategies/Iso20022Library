...
public partial record SecuritiesCollateral4
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesCollateral4 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesCollateral4( SecurityIdentification14 reqSecurityIdentification,FinancialInstrumentQuantity1Choice_ reqQuantity,SafekeepingPlaceFormat7Choice_ reqSafekeepingPlace )
    {
