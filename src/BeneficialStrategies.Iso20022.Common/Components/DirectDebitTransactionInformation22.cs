...
public partial record DirectDebitTransactionInformation22
{
    ...
    #else
    /// <summary>
    /// Constructs a DirectDebitTransactionInformation22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public DirectDebitTransactionInformation22( PaymentIdentification1 reqPaymentIdentification,ActiveOrHistoricCurrencyAndAmount reqInstructedAmount,BranchAndFinancialInstitutionIdentification5 reqDebtorAgent,PartyIdentification43 reqDebtor,CashAccount24 reqDebtorAccount )
    {
