...
public partial record MaintenanceDelegationRequest3
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationRequest3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationRequest3( GenericIdentification72 reqTMIdentification )
    {
    ...
    #endif
    [IsoXmlTag("ReqdDlgtn")]
    public ValueList<MaintenanceDelegation5> RequestedDelegation { get; init; } = new ValueList<MaintenanceDelegation5>(){}; // Warning: Don't know multiplicity.
