...
public partial record CorporateActionGeneralInformationSD22
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD22 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD22( System.String reqPlaceAndName )
    {
    ...
    public ExtendedEventType3Code? EventType { get; init; } 
    #else
    public ExtendedEventType3Code? EventType { get; set; } 
    #endif
    ...
    public DTCCSubEventType4Code? SubEventType { get; init; } 
    #else
    public DTCCSubEventType4Code? SubEventType { get; set; } 
    #endif
