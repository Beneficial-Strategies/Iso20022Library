...
public partial record CashAccount29
{
    ...
    #else
    /// <summary>
    /// Constructs a CashAccount29 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashAccount29( CashAccountIdentification1Choice_ reqIdentification )
    {
