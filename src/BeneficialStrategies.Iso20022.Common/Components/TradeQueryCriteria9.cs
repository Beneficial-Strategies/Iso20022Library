...
public partial record TradeQueryCriteria9
{
    ...
    #else
    /// <summary>
    /// Constructs a TradeQueryCriteria9 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TradeQueryCriteria9( System.String reqTradeLifeCycleHistory,System.String reqOutstandingTradeIndicator )
    {
