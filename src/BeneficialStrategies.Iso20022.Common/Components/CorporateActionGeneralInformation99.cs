...
public partial record CorporateActionGeneralInformation99
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation99 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation99( System.String reqCorporateActionEventIdentification,CorporateActionEventType42Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification20 reqFinancialInstrumentIdentification )
    {
    ...
    public required CorporateActionEventType42Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType42Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType42Choice_ EventType { get; set; } 
    #endif
