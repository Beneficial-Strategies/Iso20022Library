...
public partial record SettlementDetails186
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementDetails186 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementDetails186( SecuritiesTransactionType43Choice_ reqSecuritiesTransactionType )
    {
    ...
    public required SecuritiesTransactionType43Choice_ SecuritiesTransactionType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SecuritiesTransactionType43Choice_ SecuritiesTransactionType { get; init; } 
    #else
    public SecuritiesTransactionType43Choice_ SecuritiesTransactionType { get; set; } 
    #endif
    
    /// <summary>
    /// Conditions under which the order/trade was to be settled.
    /// </summary>
    [IsoId("_W-wezQllEeuQ1MenzX1l-g")]
