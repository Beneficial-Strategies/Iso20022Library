...
public partial record Transaction112
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction112 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction112( System.String reqAccountOwnerTransactionIdentification )
    {
