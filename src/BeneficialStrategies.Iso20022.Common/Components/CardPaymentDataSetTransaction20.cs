...
public partial record CardPaymentDataSetTransaction20
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentDataSetTransaction20 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentDataSetTransaction20( System.String reqTransactionSequenceCounter,CardPaymentEnvironment62 reqEnvironment,CardPaymentTransaction71 reqTransaction )
    {
