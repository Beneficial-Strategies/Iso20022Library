...
public partial record CardPaymentEnvironment57
{
    ...
    #else
    /// <summary>
    /// Constructs a CardPaymentEnvironment57 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardPaymentEnvironment57( PointOfInteraction7 reqPOI,PaymentCard21 reqCard )
    {
        POI = reqPOI;
        Card = reqCard;
    }
