...
public partial record PartyIdentificationAndAccount109
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount109 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount109( PartyIdentification71Choice_ reqIdentification )
    {
