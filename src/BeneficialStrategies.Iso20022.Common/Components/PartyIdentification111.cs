...
public partial record PartyIdentification111
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification111 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification111( PartyIdentification104Choice_ reqIdentification )
    {
