...
public partial record ReconciliationRequest6
{
    ...
    #else
    /// <summary>
    /// Constructs a ReconciliationRequest6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReconciliationRequest6( CardPaymentEnvironment79 reqEnvironment,CardPaymentContext30 reqContext,ReconciliationRequestData1 reqReconciliationRequestData )
    {
