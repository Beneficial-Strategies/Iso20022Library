...
public partial record SessionManagementResponse6
{
    ...
    #else
    /// <summary>
    /// Constructs a SessionManagementResponse6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SessionManagementResponse6( CardPaymentEnvironment79 reqEnvironment,CardPaymentContext30 reqContext,RetailerService5Code reqServiceContent,ResponseType11 reqResponse )
    {
    ...
    public LoginResponse5? LoginResponse { get; init; } 
    #else
    public LoginResponse5? LoginResponse { get; set; } 
    #endif
    ...
    public DiagnosisResponse5? DiagnosisResponse { get; init; } 
    #else
    public DiagnosisResponse5? DiagnosisResponse { get; set; } 
    #endif
