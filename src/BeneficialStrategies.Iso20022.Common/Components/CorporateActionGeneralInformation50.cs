...
public partial record CorporateActionGeneralInformation50
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation50 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation50( System.String reqCorporateActionEventIdentification,CorporateActionEventType12Choice_ reqEventType,SecurityIdentification14 reqFinancialInstrumentIdentification )
    {
