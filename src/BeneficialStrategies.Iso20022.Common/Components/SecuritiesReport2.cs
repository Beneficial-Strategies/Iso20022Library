...
public partial record SecuritiesReport2
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesReport2 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesReport2( SettlementQueryType1Code reqQueryType,System.String reqActivityIndicator )
    {
    ...
    public required SettlementQueryType1Code QueryType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public SettlementQueryType1Code QueryType { get; init; } 
    #else
    public SettlementQueryType1Code QueryType { get; set; } 
    #endif
