...
public partial record Statement68
{
    ...
    #else
    /// <summary>
    /// Constructs a Statement68 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Statement68( DateAndDateTime2Choice_ reqStatementDateTime,System.String reqActivityIndicator )
    {
