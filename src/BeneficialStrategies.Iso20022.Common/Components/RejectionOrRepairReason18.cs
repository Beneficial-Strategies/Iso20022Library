...
public partial record RejectionOrRepairReason18
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionOrRepairReason18 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionOrRepairReason18( RejectionAndRepairReason18Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
