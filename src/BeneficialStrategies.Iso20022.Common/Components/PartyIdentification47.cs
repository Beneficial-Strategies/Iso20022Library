...
public partial record PartyIdentification47
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification47 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification47( PartyIdentification39Choice_ reqIdentification )
    {
    ...
    public PartyIdentification39Choice_ Identification { get; init; } 
    #else
    public PartyIdentification39Choice_ Identification { get; set; } 
    #endif
