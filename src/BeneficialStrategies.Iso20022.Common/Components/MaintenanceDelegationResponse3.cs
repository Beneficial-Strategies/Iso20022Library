...
public partial record MaintenanceDelegationResponse3
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationResponse3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationResponse3( GenericIdentification72 reqTMIdentification )
    {
    ...
    #endif
    [IsoXmlTag("DlgtnRspn")]
    public ValueList<MaintenanceDelegation6> DelegationResponse { get; init; } = new ValueList<MaintenanceDelegation6>(){}; // Warning: Don't know multiplicity.
