...
public partial record PartyIdentification216
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentification216 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentification216( NameAndAddress17 reqNameAndAddress,PartyIdentification198Choice_ reqIdentification )
    {
