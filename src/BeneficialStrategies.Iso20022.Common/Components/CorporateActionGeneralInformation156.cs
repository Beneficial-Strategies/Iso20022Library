...
public partial record CorporateActionGeneralInformation156
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation156 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation156( System.String reqCorporateActionEventIdentification,CorporateActionEventType102Choice_ reqEventType )
    {
