...
public partial record CorporateActionBalanceDetails35
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionBalanceDetails35 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionBalanceDetails35( BalanceFormat7Choice_ reqConfirmedBalance )
    {
