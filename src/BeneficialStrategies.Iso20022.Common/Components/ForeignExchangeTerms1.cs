...
public partial record ForeignExchangeTerms1
{
    ...
    #else
    /// <summary>
    /// Constructs a ForeignExchangeTerms1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ForeignExchangeTerms1( string reqUnitCurrency,string reqQuotedCurrency,System.Decimal reqExchangeRate )
    {
    ...
    public PartyIdentification10Choice_? QuotingInstitution { get; init; } 
    #else
    public PartyIdentification10Choice_? QuotingInstitution { get; set; } 
    #endif
