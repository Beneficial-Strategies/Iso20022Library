...
public partial record AcceptorCancellationAdvice8
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorCancellationAdvice8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorCancellationAdvice8( CardPaymentEnvironment68 reqEnvironment,CardPaymentTransaction83 reqTransaction )
    {
