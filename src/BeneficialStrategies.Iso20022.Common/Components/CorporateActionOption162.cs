...
public partial record CorporateActionOption162
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionOption162 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionOption162( OptionNumber1Choice_ reqOptionNumber,CorporateActionOption33Choice_ reqOptionType )
    {
    ...
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public CorporateActionRate98? RateAndAmountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionRate98? RateAndAmountDetails { get; init; } 
    #else
    public CorporateActionRate98? RateAndAmountDetails { get; set; } 
    #endif
    
    /// <summary>
    /// Provides information about the prices related to a corporate action option.
    /// </summary>
    [IsoId("_BgTvY-XsEemEj48jhmlA0Q")]
    ...
    public CashOption70? CashMovementDetails { get; init; } 
    #else
    public CashOption70? CashMovementDetails { get; set; } 
    #endif
