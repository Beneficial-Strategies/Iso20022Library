...
public partial record OpeningBalance3
{
    ...
    #else
    /// <summary>
    /// Constructs a OpeningBalance3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public OpeningBalance3( ShortLong1Code reqShortLongIndicator,OpeningBalance4Choice_ reqOpeningBalance )
    {
    ...
    public required OpeningBalance4Choice_ OpeningBalance { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public OpeningBalance4Choice_ OpeningBalance { get; init; } 
    #else
    public OpeningBalance4Choice_ OpeningBalance { get; set; } 
    #endif
