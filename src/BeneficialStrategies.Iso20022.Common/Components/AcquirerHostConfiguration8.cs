...
public partial record AcquirerHostConfiguration8
{
    ...
    #else
    /// <summary>
    /// Constructs a AcquirerHostConfiguration8 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcquirerHostConfiguration8( System.String reqHostIdentification )
    {
