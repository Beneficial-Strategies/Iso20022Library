...
public partial record EnergyCommodityOther1
{
    ...
    #else
    /// <summary>
    /// Constructs a EnergyCommodityOther1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EnergyCommodityOther1( AssetClassProductType2Code reqBaseProduct,AssetClassSubProductType49Code reqSubProduct )
    {
