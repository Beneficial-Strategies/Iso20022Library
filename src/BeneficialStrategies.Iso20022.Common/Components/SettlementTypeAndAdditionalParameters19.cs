...
public partial record SettlementTypeAndAdditionalParameters19
{
    ...
    #else
    /// <summary>
    /// Constructs a SettlementTypeAndAdditionalParameters19 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SettlementTypeAndAdditionalParameters19( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
