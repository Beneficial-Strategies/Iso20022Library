...
public partial record EventInformation16
{
    ...
    #else
    /// <summary>
    /// Constructs a EventInformation16 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public EventInformation16( System.String reqCorporateActionEventIdentification,CorporateActionEventType103Choice_ reqEventType,CorporateActionMandatoryVoluntary4Choice_ reqMandatoryVoluntaryEventType )
    {
