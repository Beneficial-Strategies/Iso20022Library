...
public record CorporateActionOption216
{
    /// <summary>
    ...
    public ValueList<SecuritiesOption98> SecuritiesMovementDetails { get; init; } = [];
    ...
    public ValueList<CashOption90> CashMovementDetails { get; init; } = [];
