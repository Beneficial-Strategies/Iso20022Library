...
public partial record SecuritiesTradeDetails77
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails77 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails77( DateAndDateTime2Choice_ reqOpeningSettlementDate )
    {
