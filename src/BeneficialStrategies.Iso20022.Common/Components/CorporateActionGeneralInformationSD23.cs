...
public partial record CorporateActionGeneralInformationSD23
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformationSD23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformationSD23( System.String reqPlaceAndName )
    {
