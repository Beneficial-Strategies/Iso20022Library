...
public partial record FraudReportingInitiation1
{
    ...
    #else
    /// <summary>
    /// Constructs a FraudReportingInitiation1 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FraudReportingInitiation1( Environment10 reqEnvironment,Transaction79 reqTransaction )
    {
    ...
    public required Transaction79 Transaction { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Transaction79 Transaction { get; init; } 
    #else
    public Transaction79 Transaction { get; set; } 
    #endif
