...
public partial record StatusReport5
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReport5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReport5( GenericIdentification71 reqPOIIdentification,GenericIdentification71 reqTerminalManagerIdentification,TerminalManagementDataSet16 reqDataSet )
    {
    ...
    public required TerminalManagementDataSet16 DataSet { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TerminalManagementDataSet16 DataSet { get; init; } 
    #else
    public TerminalManagementDataSet16 DataSet { get; set; } 
    #endif
