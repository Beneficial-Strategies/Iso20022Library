...
public partial record CashOption67
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption67 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption67( CreditDebitCode reqCreditDebitIndicator,CorporateActionAmounts51 reqAmountDetails,CorporateActionDate65 reqDateDetails )
    {
    ...
    public required CorporateActionAmounts51 AmountDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionAmounts51 AmountDetails { get; init; } 
    #else
    public CorporateActionAmounts51 AmountDetails { get; set; } 
    #endif
