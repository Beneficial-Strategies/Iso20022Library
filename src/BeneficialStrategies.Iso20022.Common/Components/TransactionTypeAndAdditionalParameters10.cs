...
public partial record TransactionTypeAndAdditionalParameters10
{
    ...
    #else
    /// <summary>
    /// Constructs a TransactionTypeAndAdditionalParameters10 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public TransactionTypeAndAdditionalParameters10( System.String reqAccountOwnerTransactionIdentification,SecuritiesFinancingTransactionType1Code reqSecuritiesFinancingTransactionType,ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment )
    {
