...
public partial record UnmatchedReason15
{
    ...
    #else
    /// <summary>
    /// Constructs a UnmatchedReason15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public UnmatchedReason15( UnmatchedReason21Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
