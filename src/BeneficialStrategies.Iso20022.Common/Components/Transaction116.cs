...
public partial record Transaction116
{
    ...
    #else
    /// <summary>
    /// Constructs a Transaction116 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Transaction116( System.String reqAccountOwnerTransactionIdentification )
    {
