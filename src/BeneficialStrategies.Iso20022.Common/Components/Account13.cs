...
public partial record Account13
{
    ...
    #else
    /// <summary>
    /// Constructs a Account13 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Account13( AccountIdentification26 reqIdentification )
    {
