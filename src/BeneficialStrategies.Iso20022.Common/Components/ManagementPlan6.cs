...
public partial record ManagementPlan6
{
    ...
    #else
    /// <summary>
    /// Constructs a ManagementPlan6 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ManagementPlan6( GenericIdentification71 reqTerminalManagerIdentification,TerminalManagementDataSet22 reqDataSet )
    {
    ...
    public required TerminalManagementDataSet22 DataSet { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public TerminalManagementDataSet22 DataSet { get; init; } 
    #else
    public TerminalManagementDataSet22 DataSet { get; set; } 
    #endif
