...
public partial record AccountIdentification15
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification15 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification15( System.String reqSafekeepingAccount )
    {
