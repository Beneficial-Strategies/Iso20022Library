...
public partial record RejectionReason40
{
    ...
    #else
    /// <summary>
    /// Constructs a RejectionReason40 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public RejectionReason40( ConsentOrRejectionReason5Choice_ reqCode )
    {
        Code = reqCode;
    }
    #endif
