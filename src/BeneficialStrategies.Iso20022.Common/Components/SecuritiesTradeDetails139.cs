...
public partial record SecuritiesTradeDetails139
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails139 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails139( ReceiveDelivery1Code reqSecuritiesMovementType,DeliveryReceiptType2Code reqPayment,SettlementDate20Choice_ reqSettlementDate,SecurityIdentification20 reqFinancialInstrumentIdentification,Quantity49 reqQuantityDetails )
    {
    ...
    public required Quantity49 QuantityDetails { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public Quantity49 QuantityDetails { get; init; } 
    #else
    public Quantity49 QuantityDetails { get; set; } 
    #endif
    ...
    public SettlementParties104? DeliveringSettlementParties { get; init; } 
    #else
    public SettlementParties104? DeliveringSettlementParties { get; set; } 
    #endif
    ...
    public SettlementParties104? ReceivingSettlementParties { get; init; } 
    #else
    public SettlementParties104? ReceivingSettlementParties { get; set; } 
    #endif
