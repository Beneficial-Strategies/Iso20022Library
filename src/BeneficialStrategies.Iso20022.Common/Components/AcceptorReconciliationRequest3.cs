...
public partial record AcceptorReconciliationRequest3
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorReconciliationRequest3 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorReconciliationRequest3( CardPaymentEnvironment25 reqEnvironment,TransactionReconciliation2 reqTransaction )
    {
    ...
    public CardPaymentEnvironment25 Environment { get; init; } 
    #else
    public CardPaymentEnvironment25 Environment { get; set; } 
    #endif
