...
public partial record Account21
{
    ...
    #else
    /// <summary>
    /// Constructs a Account21 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Account21( AccountIdentification4 reqIdentification )
    {
    ...
    public PartyIdentification104Choice_? AccountServicer { get; init; } 
    #else
    public PartyIdentification104Choice_? AccountServicer { get; set; } 
    #endif
