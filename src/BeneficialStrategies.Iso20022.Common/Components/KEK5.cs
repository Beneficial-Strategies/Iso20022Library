...
public partial record KEK5
{
    ...
    #else
    /// <summary>
    /// Constructs a KEK5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public KEK5( KEKIdentifier2 reqKEKIdentification,AlgorithmIdentification23 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
    {
    ...
    public required AlgorithmIdentification23 KeyEncryptionAlgorithm { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public AlgorithmIdentification23 KeyEncryptionAlgorithm { get; init; } 
    #else
    public AlgorithmIdentification23 KeyEncryptionAlgorithm { get; set; } 
    #endif
