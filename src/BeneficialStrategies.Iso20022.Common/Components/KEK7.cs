...
public partial record KEK7
{
    ...
    #else
    /// <summary>
    /// Constructs a KEK7 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public KEK7( KEKIdentifier2 reqKEKIdentification,AlgorithmIdentification29 reqKeyEncryptionAlgorithm,System.Byte[] reqEncryptedKey )
    {
