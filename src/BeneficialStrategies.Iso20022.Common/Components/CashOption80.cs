...
public partial record CashOption80
{
    ...
    #else
    /// <summary>
    /// Constructs a CashOption80 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CashOption80( CreditDebitCode reqCreditDebitIndicator,CorporateActionAmounts57 reqAmountDetails,CorporateActionDate65 reqDateDetails )
    {
    ...
    public PriceDetails30? PriceDetails { get; init; } 
    #else
    public PriceDetails30? PriceDetails { get; set; } 
    #endif
