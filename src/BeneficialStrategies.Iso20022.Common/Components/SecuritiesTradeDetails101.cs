...
public partial record SecuritiesTradeDetails101
{
    ...
    #else
    /// <summary>
    /// Constructs a SecuritiesTradeDetails101 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public SecuritiesTradeDetails101( SettlementDate22Choice_ reqEffectiveSettlementDate )
    {
