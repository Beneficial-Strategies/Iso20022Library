...
public partial record CorporateActionGeneralInformation125
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation125 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation125( System.String reqCorporateActionEventIdentification,CorporateActionEventType76Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,FinancialInstrumentAttributes79 reqUnderlyingSecurity )
    {
