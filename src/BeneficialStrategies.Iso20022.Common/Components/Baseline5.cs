...
public partial record Baseline5
{
    ...
    #else
    /// <summary>
    /// Constructs a Baseline5 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public Baseline5( DocumentIdentification1 reqSubmitterBaselineIdentification,TradeFinanceService2Code reqServiceCode,DocumentIdentification7 reqPurchaseOrderReference,PartyIdentification26 reqBuyer,PartyIdentification26 reqSeller,BICIdentification1 reqBuyerBank,BICIdentification1 reqSellerBank,LineItem13 reqGoods,RequiredSubmission2 reqCommercialDataSetRequired,System.String reqIntentToPayExpected )
    {
    ...
    public required LineItem13 Goods { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public LineItem13 Goods { get; init; } 
    #else
    public LineItem13 Goods { get; set; } 
    #endif
    ...
    public RequiredSubmission6? OtherCertificateDataSetRequired { get; init; } 
    #else
    public RequiredSubmission6? OtherCertificateDataSetRequired { get; set; } 
    #endif
