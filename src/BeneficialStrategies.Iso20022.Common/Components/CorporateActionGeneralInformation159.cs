...
public partial record CorporateActionGeneralInformation159
{
    ...
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation159 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation159( System.String reqCorporateActionEventIdentification,CorporateActionEventType103Choice_ reqEventType )
    {
