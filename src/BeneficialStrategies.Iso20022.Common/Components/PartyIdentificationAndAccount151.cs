...
public partial record PartyIdentificationAndAccount151
{
    ...
    #else
    /// <summary>
    /// Constructs a PartyIdentificationAndAccount151 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public PartyIdentificationAndAccount151( PartyIdentification117Choice_ reqIdentification )
    {
