...
public partial record InvestmentAccountOwnershipInformation14
{
    ...
    #else
    /// <summary>
    /// Constructs a InvestmentAccountOwnershipInformation14 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public InvestmentAccountOwnershipInformation14( Party32Choice_ reqParty )
    {
        Party = reqParty;
    }
    #endif
    ...
    public Party32Choice_ Party { get; init; } 
    #else
    public Party32Choice_ Party { get; set; } 
    #endif
