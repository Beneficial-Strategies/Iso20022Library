...
[DataContract]
#endif
public partial record CorporateActionGeneralInformation108
{
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    // No constructor needed for NET8 and above.
    #else
    /// <summary>
    /// Constructs a CorporateActionGeneralInformation108 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CorporateActionGeneralInformation108( System.String reqCorporateActionEventIdentification,CorporateActionEventType51Choice_ reqEventType,CorporateActionMandatoryVoluntary3Choice_ reqMandatoryVoluntaryEventType,SecurityIdentification19 reqFinancialInstrumentIdentification )
    {
    ...
    public required CorporateActionEventType51Choice_ EventType { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CorporateActionEventType51Choice_ EventType { get; init; } 
    #else
    public CorporateActionEventType51Choice_ EventType { get; set; } 
    #endif
    
    /// <summary>
    /// Specifies whether the event is mandatory, mandatory with options or voluntary.
    /// </summary>
    [IsoId("_6qI_tYruEeaNFeVGetd6Xw")]
