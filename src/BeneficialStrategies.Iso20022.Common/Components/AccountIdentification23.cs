...
public partial record AccountIdentification23
{
    ...
    #else
    /// <summary>
    /// Constructs a AccountIdentification23 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AccountIdentification23( System.String reqSafekeepingAccount )
    {
    ...
    public CorporateActionEventAndBalance5? CorporateActionEventAndBalance { get; init; } 
    #else
    public CorporateActionEventAndBalance5? CorporateActionEventAndBalance { get; set; } 
    #endif
