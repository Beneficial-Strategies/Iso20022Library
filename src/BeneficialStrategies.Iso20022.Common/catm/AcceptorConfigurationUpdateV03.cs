...
public partial record AcceptorConfigurationUpdateV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AcceptorConfigurationUpdateV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AcceptorConfigurationUpdateV03( Header4 reqHeader,AcceptorConfiguration3 reqAcceptorConfiguration,ContentInformationType9 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    #else
    public AcceptorConfiguration3 AcceptorConfiguration { get; set; } 
    #endif
