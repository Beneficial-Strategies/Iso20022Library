...
public partial record ManagementPlanReplacementV09 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ManagementPlanReplacementV09 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ManagementPlanReplacementV09( TMSHeader1 reqHeader,ManagementPlan9 reqManagementPlan )
    {
        Header = reqHeader;
    ...
    public required ManagementPlan9 ManagementPlan { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ManagementPlan9 ManagementPlan { get; init; } 
    #else
    public ManagementPlan9 ManagementPlan { get; set; } 
    #endif
...
// Since ManagementPlanReplacementV09Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to ManagementPlanReplacementV09.
