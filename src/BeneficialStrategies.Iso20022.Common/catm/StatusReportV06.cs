...
public partial record StatusReportV06 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReportV06 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReportV06( Header27 reqHeader,StatusReport6 reqStatusReport )
    {
        Header = reqHeader;
    ...
    #else
    public StatusReport6 StatusReport { get; set; } 
    #endif
