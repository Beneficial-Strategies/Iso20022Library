...
public partial record MaintenanceDelegationRequestV05 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationRequestV05( MaintenanceDelegationRequest5 reqMaintenanceDelegationRequest,ContentInformationType18 reqSecurityTrailer )
    {
    ...
    public required MaintenanceDelegationRequest5 MaintenanceDelegationRequest { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MaintenanceDelegationRequest5 MaintenanceDelegationRequest { get; init; } 
    #else
    public MaintenanceDelegationRequest5 MaintenanceDelegationRequest { get; set; } 
    #endif
