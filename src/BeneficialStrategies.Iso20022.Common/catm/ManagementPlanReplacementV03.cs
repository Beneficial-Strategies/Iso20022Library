...
public partial record ManagementPlanReplacementV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ManagementPlanReplacementV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ManagementPlanReplacementV03( Header4 reqHeader,ManagementPlan3 reqManagementPlan,ContentInformationType9 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    public required ManagementPlan3 ManagementPlan { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ManagementPlan3 ManagementPlan { get; init; } 
    #else
    public ManagementPlan3 ManagementPlan { get; set; } 
    #endif
