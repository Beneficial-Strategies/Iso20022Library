...
/// <summary>
/// This record is an implementation of the catm.007.001.05 ISO standard message type.
...
public partial record CertificateManagementRequestV05 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "catm.007.001.05";
    ...
    #else
    /// <summary>
    /// Constructs a CertificateManagementRequestV05 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CertificateManagementRequestV05( TMSHeader1 reqHeader,CertificateManagementRequest2 reqCertificateManagementRequest )
    {
        Header = reqHeader;
...
// Since CertificateManagementRequestV05Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CertificateManagementRequestV05.
