...
public partial record MaintenanceDelegationResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a MaintenanceDelegationResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public MaintenanceDelegationResponseV01( Header16 reqHeader,MaintenanceDelegationResponse1 reqMaintenanceDelegationResponse,ContentInformationType12 reqSecurityTrailer )
    {
        Header = reqHeader;
    ...
    #else
    public Header16 Header { get; set; } 
    #endif
    ...
    public required MaintenanceDelegationResponse1 MaintenanceDelegationResponse { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public MaintenanceDelegationResponse1 MaintenanceDelegationResponse { get; init; } 
    #else
    public MaintenanceDelegationResponse1 MaintenanceDelegationResponse { get; set; } 
    #endif
...
// Since MaintenanceDelegationResponseV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to MaintenanceDelegationResponseV01.
