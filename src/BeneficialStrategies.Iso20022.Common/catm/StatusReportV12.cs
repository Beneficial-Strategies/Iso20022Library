...
public partial record StatusReportV12 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a StatusReportV12 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public StatusReportV12( TMSHeader1 reqHeader,StatusReport12 reqStatusReport )
    {
        Header = reqHeader;
    ...
    public required StatusReport12 StatusReport { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public StatusReport12 StatusReport { get; init; } 
    #else
    public StatusReport12 StatusReport { get; set; } 
    #endif
