...
/// <summary>
/// This record is an implementation of the cain.023.001.02 ISO standard message type.
...
public partial record CardManagementInitiationV02 : IOuterRecord
{
    ...
    /// </summary>
    public const string IsoIdentifier = "cain.023.001.02";
    ...
    #else
    /// <summary>
    /// Constructs a CardManagementInitiationV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardManagementInitiationV02( Header60 reqHeader,CardManagementInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    #else
    public CardManagementInitiation2 Body { get; set; } 
    #endif
...
// Since CardManagementInitiationV02Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to CardManagementInitiationV02.
