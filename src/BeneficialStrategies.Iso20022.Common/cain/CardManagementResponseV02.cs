...
public partial record CardManagementResponseV02 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a CardManagementResponseV02 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public CardManagementResponseV02( Header60 reqHeader,CardManagementResponse2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required CardManagementResponse2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public CardManagementResponse2 Body { get; init; } 
    #else
    public CardManagementResponse2 Body { get; set; } 
    #endif
