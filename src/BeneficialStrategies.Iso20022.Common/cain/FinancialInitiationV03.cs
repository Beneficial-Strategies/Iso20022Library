...
public partial record FinancialInitiationV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a FinancialInitiationV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public FinancialInitiationV03( Header62 reqHeader,FinancialInitiation2 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required FinancialInitiation2 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public FinancialInitiation2 Body { get; init; } 
    #else
    public FinancialInitiation2 Body { get; set; } 
    #endif
