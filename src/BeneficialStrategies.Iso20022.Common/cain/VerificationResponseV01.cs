...
public partial record VerificationResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a VerificationResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public VerificationResponseV01( Header39 reqHeader,VerificationResponse1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required VerificationResponse1 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public VerificationResponse1 Body { get; init; } 
    #else
    public VerificationResponse1 Body { get; set; } 
    #endif
