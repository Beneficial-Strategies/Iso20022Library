...
public partial record ReconciliationResponseV03 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a ReconciliationResponseV03 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public ReconciliationResponseV03( Header60 reqHeader,ReconciliationResponse7 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    public required ReconciliationResponse7 Body { get; init; } 
    #elif NET5_0_OR_GREATER // C# 9 Records, init-only setters, data annotations native
    public ReconciliationResponse7 Body { get; init; } 
    #else
    public ReconciliationResponse7 Body { get; set; } 
    #endif
