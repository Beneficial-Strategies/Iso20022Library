...
public partial record BatchTransferResponseV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a BatchTransferResponseV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public BatchTransferResponseV01( Header39 reqHeader,BatchTransferResponse1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    #else
    public BatchTransferResponse1 Body { get; set; } 
    #endif
