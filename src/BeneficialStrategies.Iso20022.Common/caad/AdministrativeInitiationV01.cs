...
public partial record AdministrativeInitiationV01 : IOuterRecord
{
    ...
    #else
    /// <summary>
    /// Constructs a AdministrativeInitiationV01 instance using the members the ISO20022 deems required.
    /// It is higly recommended that you update to .NET 8 or above so you can use required initialization syntax instead
    /// </summary>
    public AdministrativeInitiationV01( Header66 reqHeader,AdministrativeInitiation1 reqBody )
    {
        Header = reqHeader;
        Body = reqBody;
    }
    ...
    #else
    public AdministrativeInitiation1 Body { get; set; } 
    #endif
...
// Since AdministrativeInitiationV01Document is not really part of the logical business domain model, 
// and only existed to facilitate implementation details of serialization, it has been appropriately removed.
// Some of the constants previously declared there have been relocated to AdministrativeInitiationV01.
